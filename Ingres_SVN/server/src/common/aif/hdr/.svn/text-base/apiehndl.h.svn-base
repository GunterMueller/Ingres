...
II_EXTERN II_VOID		IIapi_createDbevCB( IIAPI_CONNHNDL *connHndl,
						    IIAPI_GCA_BUFF *gcaBuff );

II_EXTERN II_VOID		IIapi_processDbevCB( IIAPI_CONNHNDL *connHndl );
...
II_EXTERN II_VOID		IIapi_abortDbevHndl( IIAPI_DBEVHNDL *dbevHndl,
						     II_LONG errorCode,
						     char *SQLState,
						     IIAPI_STATUS status );

II_EXTERN II_BOOL		IIapi_isDbevHndl( IIAPI_DBEVHNDL *dbevHndl );

II_EXTERN IIAPI_DBEVHNDL 	*IIapi_getDbevHndl( IIAPI_HNDL *handle );
