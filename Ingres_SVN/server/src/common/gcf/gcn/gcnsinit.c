...
gcn_srv_init( VOID  )
{
    ...
    */
    ...
    GCusername( IIGCn_static.username, sizeof( IIGCn_static.username ) );
    ...
    gcn_get_pmsym( "!.default_server_class", GCN_INGRES, 
		   IIGCn_static.svr_type, sizeof( IIGCn_static.svr_type ) );

    gcn_get_pmsym( "!.local_vnode", IIGCn_static.hostname, 
		   IIGCn_static.lcl_vnode, sizeof( IIGCn_static.lcl_vnode ) );

    gcn_get_pmsym( "!.remote_vnode", "", 
		   IIGCn_static.rmt_vnode, sizeof( IIGCn_static.rmt_vnode ) );

    gcn_get_pmsym( "!.remote_mechanism", "", tmp, sizeof( tmp ) );
    if ( *tmp )  STcopy( tmp, IIGCn_static.rmt_mech );
