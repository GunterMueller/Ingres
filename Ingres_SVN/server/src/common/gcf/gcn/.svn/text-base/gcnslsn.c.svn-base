...
#define	NCB_SHUTDOWN	0x0400
    ...
    STATUS		*statusp;
    i4			req_proto;
    char		username[ GCN_UID_MAX_LEN + 1 ];
    char		account[ GCN_UID_MAX_LEN + 1 ];
...
# define	NSA_IF_ADMIN	20	/* monitor command */
# define	NSA_IF_SERVER	21	/* If server registration */
# define	NSA_IF_SHUT	22	/* if SHUTDOWN requested */
# define	NSA_IF_ACK	23	/* if message is GCA_ACK */
# define	NSA_IF_OPER	24	/* if message is GCN_NS_OPER */
# define	NSA_IF_AUTH	25	/* if message is GCN_NS_AUTHORIZE */
# define	NSA_IF_AUTHID	26	/* if GCN_NS_AUTHORIZE user ID */
# define	NSA_IF_RESOLVE	27	/* if message is GCN_NS[2]_RESOLVE */
# define	NSA_IF_RELEASE  28	/* if message is GCA_RELEASE */
# define	NSA_IF_IP	29	/* get installation password */
# define	NSA_IF_DIRECT	30	/* if direct connection */
# define	NSA_LISTEN	31	/* post a listen */
# define	NSA_LS_RESUME	32	/* resume a listen */
# define	NSA_LS_DONE	33	/* complete a listen */
# define	NSA_REPOST	34	/* repost listen */
# define	NSA_RQRESP	35	/* respond to listen */
# define	NSA_REQUEST	36	/* issue GCA_REQUEST */
# define	NSA_RQ_RESUME	37	/* resume GCA_REQUEST */
# define	NSA_RQ_DONE	38	/* complete GCA_REQUEST */
# define	NSA_ATTRIB	39	/* issue GCA_ATTRIBS */
# define	NSA_FS_INIT	40	/* initialize FASTSELECT parms */
# define	NSA_FS_BEDCHK	41	/* set BEDCHECK flag in FS parms */
# define	NSA_FASTSELECT	42	/* issue GCA_FASTSELECT */
# define	NSA_FS_RESUME	43	/* resume GCA_FASTSELECT */
# define	NSA_FS_DONE	44	/* complete GCA_FASTSELECT */
# define	NSA_RECEIVE	45	/* post a receive */
# define	NSA_RV_DONE	46	/* receive completed */
# define	NSA_SEND	47	/* post a send */
# define	NSA_SD_DONE	48	/* send completed */
# define	NSA_DISASSOC	49	/* disassociate */
# define	NSA_DA_RESUME	50	/* finish a disassoc */
# define	NSA_SET_SHUT	51	/* prepare for GCN SHUTDOWN */
# define	NSA_SRV_START	52	/* Server start-up */
# define	NSA_SRV_EXIT	53	/* Server exit */
# define	NSA_DO_UPD	54	/* Update server stats */
# define	NSA_ADM_SESS	55	/* execute monitor command*/
# define	NSA_ADM_RLS	56	/* format release msg */
# define	NSA_FMT_RLS	57	/* format GCA_RELEASE */
# define	NSA_DO_OPER	58	/* process GCN_NS_OPER */
# define	NSA_DO_AUTH	59	/* do GCN_NS_AUTHORIZE */
# define	NSA_RESOLVE	60	/* do GCN_NS[2]_RESOLVE */
# define	NSA_RSLV_DONE	61	/* format GCN_RESOLVED */
# define	NSA_RSLV_ERR	62	/* error during RSLV */
# define	NSA_USE_AUTH	63	/* use a ticket for password */
# define	NSA_GET_AUTH	64	/* format GCN_NS_AUTHORIZE message */
# define	NSA_GOT_AUTH	65	/* parse GCN_AUTHORIZED */
# define	NSA_IP_PROTO	66	/* check AUTH protocol level */
# define	NSA_DIRECT	67	/* format GCN_RESOLVE message */
# define	NSA_RESOLVED	68	/* process GCN2_RESOLVED message */
# define	NSA_DC_PROTO	69	/* check direct connect proto level */
# define	NSA_DC_ERROR	70	/* direct connect error */
# define	NSA_OPER_BCHK	71	/* do bedcheck before OPER */
# define	NSA_BEDCHECK	72	/* ininitalize bedchecking */
# define	NSA_BCHK_NEXT	73	/* bedcheck next server */
# define	NSA_BCHK_CHECK	74	/* check results of bedcheck */
# define	NSA_COMPRESS	75	/* compress name queue files */
# define	NSA_EXPIRE	76	/* expire tickets */
# define	NSA_DO_REG	77	/* Check registry status */
# define	NSA_GET_COMSVR	78	/* Load Comm Server addresses */
# define	NSA_CHK_MASTER	79	/* Build info to check master NS */
# define	NSA_REG_ERROR	80	/* Check for error response */
# define	NSA_GET_MASTER	81	/* Extract info on current master NS */
# define	NSA_REGISTER	82	/* Build info to register with master */
# define	NSA_IF_SLAVE	83	/* Check if slave installation */
# define	NSA_BE_MASTER	84	/* Build info to be master NS */
# define	NSA_REG_RETRY	85	/* Check if need to retry registry */
# define	NSA_CLEAR_REG	86	/* Clear registry retry */
...
static	char	*gcn_ns_names[] = 
{
  ...
  "NSA_IF_CLOSED",  "NSA_IF_ADMIN",     "NSA_IF_SERVER",    "NSA_IF_SHUT",    
...
# define	LBL_SRV_EXIT	13
# define	LBL_READ	14
# define	LBL_NOOP	15
# define	LBL_OPER	16
# define	LBL_DO_OPER	17
# define	LBL_AUTH	18
# define	LBL_RESOLVE	19
# define	LBL_RSLV_DONE	20
# define	LBL_RSLV_ERR	21
# define	LBL_USE_AUTH	22
# define	LBL_AUTH_ERR	23
# define	LBL_GET_AUTH	24
# define	LBL_REM_ERR	25
# define	LBL_CONN_ERR	26
# define	LBL_DIRECT	27
# define	LBL_DIRECT_ERR	28
# define	LBL_REM_ERR1	29
# define	LBL_CONN_ERR1	30
# define	LBL_DONE	31
# define	LBL_EXIT	32
# define	LBL_EXIT1	33
# define	LBL_RESPONSE	34
# define	LBL_DC_ERROR	35
# define	LBL_BEDCHECK	36
# define	LBL_BCHK_NEXT	37
# define	LBL_BCHK_DONE	38
# define	LBL_REGISTRY	39
# define	LBL_REG_DONE	40
# define	LBL_BE_MASTER	41
# define	LBL_CONNECT	42
# define	LBL_REQUEST	43
# define	LBL_RQ_CHK	44
# define	LBL_RQ_RESUME	45
# define	LBL_FASTSELECT	46
# define	LBL_FS_CHK	47
# define	LBL_FS_RESUME	48
# define	LBL_RECEIVE	49
# define	LBL_SEND	50
# define	LBL_DISCONN	51
# define	LBL_DA_CHK	52
# define	LBL_DA_RESUME	53
# define	LBL_RETURN	54
...
} gcn_states[] = 
{
	...
	*/
	...
	NSA_LABEL,	LBL_SRV_READ,
		...
		NSA_IF_ERROR,	LBL_SRV_EXIT,
		NSA_CLEAR_ERR,	LBL_NONE,
		NSA_IF_RELEASE, LBL_SRV_EXIT,	/* if message is RELEASE */
...
top:
	...
	case NSA_FREE :
	    ...
	    */
	    ...
	    if ( ncb->grcb.deleg_len )  gcn_release_deleg( ncb, TRUE );
	...
	case NSA_LS_DONE :
	    ...
	    */
		...
		STzapblank( ncb->parms.gca_ls_parms.gca_user_name, 
			    ncb->username);
		STzapblank( ncb->parms.gca_ls_parms.gca_account_name, 
			    ncb->account);
		...
		*/
		while( ncb->parms.gca_ls_parms.gca_l_aux_data > 0 )
		{
			...
			*/
			...
			ncb->grcb.deleg_len = aux_len;

			if ( ! (ncb->grcb.deleg = 
				MEreqmem(0, aux_len, FALSE, NULL)) )
			{
			    ncb->grcb.deleg = aux_data;
			    gcn_release_deleg( ncb, FALSE );
			}
			else
			    MEcopy( (PTR)aux_data, aux_len, 
				    ncb->grcb.deleg );
			break;
		    }
...
# ifdef NT_GENERIC
            GCpasswd_prompt( ncb->grcb.user_out, 
			     ncb->grcb.passwd_out, ncb->grcb.vnode );
# endif
	...
	case NSA_GET_COMSVR :
		...
		*/
		IIGCn_static.flags &= ~GCN_REG_ACTIVE;
		STcopy( IIGCn_static.listen_addr, IIGCn_static.registry_addr );
		STcopy( IIGCn_static.install_id, IIGCn_static.registry_id );
		branch = TRUE;
	    }
	    break;
...
gcn_release_deleg( GCN_NCB *ncb, bool free )
{
    ...
    rel.length = ncb->grcb.deleg_len;
    rel.token = ncb->grcb.deleg;
    ...
    if ( free )  MEfree( ncb->grcb.deleg );
    ncb->grcb.deleg = NULL;
    ncb->grcb.deleg_len = 0;
...
gcn_sess_info( PTR info, i4 sess_flag   )
{
	...
	if ( (state = ncb->state) != 0 )
	{
		...
		STcopy( ncb->username, sess->user_id);
		sess->is_system = is_system;
                if( is_system && (ncb->srv.class) )
                {
	           STcopy( ncb->srv.class, sess->svr_class);
	           STcopy( ncb->srv.addr, sess->svr_addr);
		}
