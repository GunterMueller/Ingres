...
**	DRV_CNF_EMPTY_DATE	Empty date replacement.
**
...
DrvConst
{
    ...
    */
    ...
    int		DRV_MAJOR_VERSION	= 3;
    int		DRV_MINOR_VERSION	= 4;
    int		DRV_PATCH_VERSION	= 0;
    String	DRV_JDBC_VERSION	= "JDBC 3.0";
    int		DRV_JDBC_MAJ_VERS	= 3;
