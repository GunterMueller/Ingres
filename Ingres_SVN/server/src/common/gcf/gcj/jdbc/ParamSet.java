...
**
**	The messaging protocol currently does not provide support 
**	for BOOLEAN, so the alternate storage format is always used.  
**
    ...
    throws SqlEx
{
    ...
    */
	...
	case Types.BOOLEAN :
		...
		*/
		type = (short)Types.TINYINT;	// TODO: support BOOLEAN
		dbms = DBMS_TYPE_INT;
		length = 1;
	    }
	    break;
    ...
    throws SqlEx
{
	...
	case Types.BOOLEAN :
	    ...
	    else  if ( value.isNull() )		// TODO: support BOOLEAN
		msg.write( (byte)0 );
	    else
	    {
		msg.write( (byte)1 );
		msg.write( (byte)(value.getBoolean() ? 1 : 0) );
	    }
	    break;
