...
protected void
setScale( int scale ) throws SqlEx
{ 
    return; 
} // setScale
    ...
    throws SqlEx
{
    ...
    case Types.BINARY :		setBytes( (byte[])value );		break;
...
public void 
setBoolean( boolean value ) throws SqlEx
{ throw SqlEx.get( ERR_GC401A_CONVERSION_ERR ); }

public void 
setByte( byte value ) throws SqlEx
{ throw SqlEx.get( ERR_GC401A_CONVERSION_ERR ); }

public void 
setShort( short value ) throws SqlEx
{ throw SqlEx.get( ERR_GC401A_CONVERSION_ERR ); }

public void 
setInt( int value ) throws SqlEx
{ throw SqlEx.get( ERR_GC401A_CONVERSION_ERR ); }

public void 
setLong( long value ) throws SqlEx
{ throw SqlEx.get( ERR_GC401A_CONVERSION_ERR ); }

public void 
setFloat( float value ) throws SqlEx
{ throw SqlEx.get( ERR_GC401A_CONVERSION_ERR ); }

public void 
setDouble( double value ) throws SqlEx
{ throw SqlEx.get( ERR_GC401A_CONVERSION_ERR ); }

public void 
setBigDecimal( BigDecimal value ) throws SqlEx
{ throw SqlEx.get( ERR_GC401A_CONVERSION_ERR ); }

public void 
setString( String value ) throws SqlEx
{ throw SqlEx.get( ERR_GC401A_CONVERSION_ERR ); }

public void 
setBytes( byte value[] ) throws SqlEx
{ throw SqlEx.get( ERR_GC401A_CONVERSION_ERR ); }

public void 
setDate( Date value, TimeZone tz ) throws SqlEx
{ throw SqlEx.get( ERR_GC401A_CONVERSION_ERR ); }

public void 
setTime( Time value, TimeZone tz ) throws SqlEx
{ throw SqlEx.get( ERR_GC401A_CONVERSION_ERR ); }

public void 
setTimestamp( Timestamp value, TimeZone tz ) throws SqlEx
{ throw SqlEx.get( ERR_GC401A_CONVERSION_ERR ); }

public void 
setBinaryStream( InputStream value ) throws SqlEx
{ throw SqlEx.get( ERR_GC401A_CONVERSION_ERR ); }

public void 
setAsciiStream( InputStream value ) throws SqlEx
{ throw SqlEx.get( ERR_GC401A_CONVERSION_ERR ); }

public void 
setUnicodeStream( InputStream value ) throws SqlEx
{ throw SqlEx.get( ERR_GC401A_CONVERSION_ERR ); }

public void 
setCharacterStream( Reader value ) throws SqlEx
{ throw SqlEx.get( ERR_GC401A_CONVERSION_ERR ); }

public void 
setBlob( Blob value ) throws SqlEx
{ throw SqlEx.get( ERR_GC401A_CONVERSION_ERR ); }

public void 
setClob( Clob value ) throws SqlEx
{ throw SqlEx.get( ERR_GC401A_CONVERSION_ERR ); }
...
public boolean 
getBoolean() throws SqlEx
{ throw SqlEx.get( ERR_GC401A_CONVERSION_ERR ); }

public byte 
getByte() throws SqlEx
{ throw SqlEx.get( ERR_GC401A_CONVERSION_ERR ); }

public short 
getShort() throws SqlEx
{ throw SqlEx.get( ERR_GC401A_CONVERSION_ERR ); }
...
public long 
getLong() throws SqlEx
{ throw SqlEx.get( ERR_GC401A_CONVERSION_ERR ); }

public float 
getFloat() throws SqlEx
{ throw SqlEx.get( ERR_GC401A_CONVERSION_ERR ); }

public double 
getDouble() throws SqlEx
{ throw SqlEx.get( ERR_GC401A_CONVERSION_ERR ); }

public BigDecimal 
getBigDecimal() throws SqlEx
{ throw SqlEx.get( ERR_GC401A_CONVERSION_ERR ); }

public String 
getString() throws SqlEx
{ throw SqlEx.get( ERR_GC401A_CONVERSION_ERR ); }

public byte[] 
getBytes() throws SqlEx
{ throw SqlEx.get( ERR_GC401A_CONVERSION_ERR ); }

public Date 
getDate( TimeZone tz ) throws SqlEx
{  throw SqlEx.get( ERR_GC401A_CONVERSION_ERR ); }

public Time 
getTime( TimeZone tz ) throws SqlEx
{ throw SqlEx.get( ERR_GC401A_CONVERSION_ERR ); }

public Timestamp 
getTimestamp( TimeZone tz ) throws SqlEx
{ throw SqlEx.get( ERR_GC401A_CONVERSION_ERR ); }

public InputStream 
getBinaryStream() throws SqlEx
{ throw SqlEx.get( ERR_GC401A_CONVERSION_ERR ); }

public InputStream 
getAsciiStream() throws SqlEx
{ throw SqlEx.get( ERR_GC401A_CONVERSION_ERR ); }
...
public Reader 
getCharacterStream() throws SqlEx
{ throw SqlEx.get( ERR_GC401A_CONVERSION_ERR ); }

public Blob
getBlob() throws SqlEx
{ throw SqlEx.get( ERR_GC401A_CONVERSION_ERR ); }

public Clob
getClob() throws SqlEx
{ throw SqlEx.get( ERR_GC401A_CONVERSION_ERR ); }

public Object 
getObject() throws SqlEx
{ throw SqlEx.get( ERR_GC401A_CONVERSION_ERR ); }
...
public void 
setBigDecimal( BigDecimal value, int scale ) throws SqlEx
{ setBigDecimal( value ); }

public void 
setObject( Object value ) throws SqlEx
{ setObject( value, false, 0 ); }

public void 
setObject( Object value, int scale ) throws SqlEx
{ setObject( value, true, scale ); }

public BigDecimal 
getBigDecimal( int scale ) throws SqlEx
{ BigDecimal bd = getBigDecimal();
  return((bd == null) ? null : bd.setScale(scale, BigDecimal.ROUND_HALF_UP)); }

public String
getString( int limit ) throws SqlEx
{ return( getString() ); }

public byte[]
getBytes( int limit ) throws SqlEx
{ return( getBytes() ); }

public Object
getObject( int limit ) throws SqlEx
{ return( getObject() ); }
