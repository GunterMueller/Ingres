...
MsgConst
{
    ...
    byte	MSG_PROTO_DFLT		= MSG_PROTO_6;
    ...
    */
    ...
    IdMap	msgMap[] =
    {
	new IdMap( MSG_CONNECT,	"CONNECT" ),
	new IdMap( MSG_DISCONN,	"DISCONN" ),
	new IdMap( MSG_XACT,	"XACT" ),
	new IdMap( MSG_QUERY,	"QUERY" ),
	new IdMap( MSG_CURSOR,	"CURSOR" ),
	new IdMap( MSG_DESC,	"DESC" ),
	new IdMap( MSG_DATA,	"DATA" ),
	new IdMap( MSG_ERROR,	"ERROR" ),
	new IdMap( MSG_RESULT,	"RESULT" ),
	new IdMap( MSG_REQUEST,	"REQUEST" ),
	new IdMap( MSG_INFO,	"INFO" ),
    };
