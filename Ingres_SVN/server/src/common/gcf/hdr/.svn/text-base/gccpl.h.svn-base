...
# define GCC_L_CHAR_SET 256
# define GCC_L16_CHAR_SET 65536
...
# define THIRD_CLASS	3	/* mappings to NSCS */
	...
	u_char	l2n[ GCC_L_CHAR_SET ];	/* local to net mapping */
	u_char	n2l[ GCC_L_CHAR_SET ];	/* net to local mapping */

	u_i2	*l2n16;		/* doublebyte mappings */
	u_i2	*n2l16;		/* doublebyte mappings */
