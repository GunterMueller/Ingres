...
# define OP_JZ		0x06	/* pop top-of-stack; branch if zero */
# define OP_DJNZ	0x07	/* if !top-of-stack pop, else decr & branch */
...
# define OP_RETURN	0x0D	/* return from program call */

# define OP_PUSH_LIT	0x0E	/* push 2 byte signed quanity */
# define OP_PUSH_I4	0x0F	/* push i4 from data stream */
# define OP_PUSH_I2	0x10	/* push i2 from data stream */
# define OP_PUSH_VCH	0x11	/* compute varchar padding length */

# define OP_CV_I1	0x12	/* convert i1s */
# define OP_CV_I2	0x13	/* convert i2s */
# define OP_CV_I4	0x14	/* convert i4s */
# define OP_CV_I8	0x15	/* convert i8s */
# define OP_CV_F4	0x16	/* convert f4s */
# define OP_CV_F8	0x17	/* convert f8s */
# define OP_CV_BYTE	0x18	/* convert bytes */
# define OP_CV_CHAR	0x19	/* convert characters */
# define OP_CV_PAD	0x1A	/* convert varchar pad */

# define OP_MSG_BEGIN	0x1B	/* begin message */
# define OP_COPY_MSG	0x1C	/* Copy input to output */
# define OP_IMP_BEGIN	0x1D	/* begin VARIMPAR */
# define OP_MARK	0x1E	/* save current processing state */
# define OP_REWIND	0x1F	/* backup to saved processing state */
# define OP_VAR_BEGIN	0x20	/* begin VAREXPAR */
# define OP_VAR_END	0x21	/* end VAREXPAR */
# define OP_DV_BEGIN	0x22	/* begin GCA_DATA_VALUE value */
# define OP_DV_END	0x23	/* end GCA_DATA_VALUE value */
# define OP_DV_ADJUST	0x24	/* Adjust buffer space for GCA_DATA_VALUE */

# define OP_PAD_ALIGN	0x25	/* allow for alignment pad */
# define OP_DIVIDE	0x26	/* Divide stack by argument */
# define OP_BREAK	0x27	/* indicate break in tuple stream */
...
*/
# define OP_CHAR_TYPE	0xF0	/* indicates type of character data */
# define OP_DATA_LEN	0xF1	/* indicates next long is a data value len */
# define OP_OBJ_DESC	0xF2	/* indicates a GCA_TO_DESCR is next */
# define OP_OBJ_DESC_DONE	0xF3	/* indicates a GCA_TO_DESCR is done */
...
# define GCO_DT_LKEY		80	/* Logical key */
# define GCO_DT_LKEY_N		81
# define GCO_DT_TKEY		82	/* Table key */
# define GCO_DT_TKEY_N		83
# define GCO_DT_SECL		84	/* Security label */
# define GCO_DT_SECL_N		85
...
# ifdef DOUBLEBYTE
GLOBALREF	GCA_OBJECT_DESC *gco_od_obj_desc;
# endif /* #ifdef DOUBLEBYTE */
...
#ifdef DOUBLEBYTE
FUNC_EXTERN	VOID	gco_do_16src( u_i2 *, u_char **, i4 *, u_char **, i4 *,
				      i4 *, i4 *, i4, i4 *, i1 * );
#endif /* ifdef DOUBLEBYTE */
