...
/* # line 1791 "iibrowse.sc" */	/* host code */
    if ( *username  &&  *password )
    {
/* # line 1793 "iibrowse.sc" */	/* connect */
  {
    IIsqInit(&sqlca);
    IIsqConnect(0,target,(char *)"-remote_system_user",username,(char *)
"-remote_system_password",password,(char *)0, (char *)0, (char *)0, 
    (char *)0, (char *)0, (char *)0, (char *)0, (char *)0, (char *)0);
    if (sqlca.sqlcode < 0) 
      IIsqPrint(&sqlca);
  }
/* # line 1796 "iibrowse.sc" */	/* host code */
    }
    else
    {
/* # line 1799 "iibrowse.sc" */	/* connect */
  {
    IIsqInit(&sqlca);
    IIsqConnect(0,target,(char *)0, (char *)0, (char *)0, (char *)0, 
    (char *)0, (char *)0, (char *)0, (char *)0, (char *)0, (char *)0, 
    (char *)0, (char *)0, (char *)0);
    if (sqlca.sqlcode < 0) 
      IIsqPrint(&sqlca);
  }
/* # line 1800 "iibrowse.sc" */	/* host code */
    }
/* # line 1802 "iibrowse.sc" */	/* select */
  {
    IIsqInit(&sqlca);
    IIwritio(0,(short *)0,1,32,0,(char *)"select name, own from iidata\
base");
    IIretinit((char *)0,0);
    if (IIerrtest() != 0) goto IIrtE1;
IIrtB1:
    while (IInextget() != 0) {
      IIgetdomio((short *)0,1,32,32,name);
      IIgetdomio((short *)0,1,32,32,own);
      if (IIerrtest() != 0) goto IIrtB1;
/* # line 1804 "iibrowse.sc" */	/* host code */
	STtrmwhite( name );
	STtrmwhite( own );
	SIprintf( "%-8s\t%s\n", name, own );
    } /* IInextget */
...
/* # line 1810 "iibrowse.sc" */	/* disconnect */
  {
    IIsqInit(&sqlca);
    IIsqDisconnect();
    if (sqlca.sqlcode < 0) 
...
/* # line 1814 "iibrowse.sc" */	/* host code */
    return;
}
