...
typedef struct _GCM_MSG_WORK GCM_MSG_WORK;
    ...
    struct _GCM_MON_DESCR
    {
        ...
        i4      trap_handle;
        i4      l_trap_address;
        char    trap_address[GCN_EXTNAME_MAX_LEN];
        i4      element_count;
	...
	bool		started;
        ...
        i4         async_id;
        i4         async_flag;
        char            target[GCN_EXTNAME_MAX_LEN];
        char            *data_area;
...
)
{
    ...
    */
	...
	in_l_trap_address = ( in_l_trap_address < GCN_EXTNAME_MAX_LEN ) ? 
		in_l_trap_address : GCN_EXTNAME_MAX_LEN;
    }
	...
	case GCM_SET_TRAP:
	    ...
	    */
	    ...
	    MEcopy(in_trap_address, in_l_trap_address, mon_descr->trap_address);
