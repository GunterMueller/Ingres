...
using Ca.Ingres.ProviderInternals;

//using Microsoft.Win32;

namespace Ca.Ingres.Client.Design
{
	/*
	...
	*/
	...
	internal class ConnectionEditorForm : System.Windows.Forms.Form
	{
		...
		protected const string bitmapName   =
			"Ca.Ingres.Client.Design.install_block.bmp";
		private const string ApplicationDataFileName =
			"ConnectionEditor";
		...
		private void InitializeComponent()
		{
			...
			this.buttonCancel.Location = new System.Drawing.Point(528, 360);
			...
			this.buttonTest.Location = new System.Drawing.Point(24, 250);
			...
			this.tabs.Size = new System.Drawing.Size(600, 336);
			...
			this.checkPersistSecurityInfo.TabIndex = 20;
			...
			this.timeoutUpDown.TabIndex = 18;
			// 
			// timeoutLabel
			// 
			...
			this.checkConnectionPooling.TabIndex = 16;
			...
			this.groupCredentials.Size = new System.Drawing.Size(432, 96);
			...
			this.rolePwdBox.TabIndex = 1;
			this.rolePwdBox.Text = "";
			this.rolePwdBox.TextChanged += new System.EventHandler(this.rolePwdBox_TextChanged);
			// 
			// groupLabel
			// 
			this.groupLabel.Location = new System.Drawing.Point(16, 56);
			...
			// groupBox
			// 
			this.groupBox.Location = new System.Drawing.Point(80, 56);
			this.groupBox.Name = "groupBox";
			this.groupBox.TabIndex = 1;
			this.groupBox.TextChanged += new System.EventHandler(this.textBox2_TextChanged);
			// 
		...
		private void databaseLabel_Click(object sender, System.EventArgs e)
		{
		
		}

		private string GetValueOfKeyword(NameValueCollection nv, string strKey)
		{
		...
		private string GetValueOfKeyword(
		...
		private decimal GetValueOfKeyword(
		...
		private Boolean GetValueOfKeyword(
		...
		private void SetStringValueOfKeyword(
			NameValueCollection nv,
			string strKey,
			Control ctrl)
		{
		...
		private XmlTextReader OpenApplicationDataFileReader(string filename)
		{
		...
		private XmlTextReader CloseApplicationDataFileReader(
			XmlTextReader xmlreader)
		{
			if (xmlreader == null)
				return null;
		...
		private XmlTextWriter OpenApplicationDataFileWriter(
		...
		private XmlTextWriter CloseApplicationDataFileWriter(
			XmlTextWriter xmlwriter)
		{
			if (xmlwriter == null)
				return null;
		...
		private void LoadValuesFromApplicationDataFolder(
		...
		private void SaveValuesToApplicationDataFolder(
			NamedArrayList[] arrayOfArrayList, string filename)
		{
			if (arrayOfArrayList == null  ||  arrayOfArrayList.Length == 0)
				return;
		...
		private NamedArrayList UpdateDropDownList(
