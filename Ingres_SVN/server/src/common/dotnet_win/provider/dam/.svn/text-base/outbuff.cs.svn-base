	...
	*/
	...
	class OutBuff : IoBuff
	{
		...
		*/
		...
		public OutBuff(System.IO.Stream outputStream, int id, int size)
			:base(outputStream, System.IO.FileAccess.Write)
		{
			title = "OutBuff[" + id + "]";
		...
		*/
		...
		/// <returns></returns>
		public virtual short write(System.IO.Stream inputStream)
		{
			int length = avail();
