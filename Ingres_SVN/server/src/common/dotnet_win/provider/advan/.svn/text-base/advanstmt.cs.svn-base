	...
	*/
		...
		AdvanStmt : DrvObj, Timer.ICallback
	{
		...
		*/
		...
		protected const String   crsr_prefix = "JDBC_CRSR_";
		protected const String   stmt_prefix = "JDBC_STMT_";
		...
		*/
			...
			getUpdateCount()
		{
			int count = (resultSet != null  ||  ! rslt_rowcount) ?
				-1 : rslt_val_rows;
			if ( trace.enabled() )
				trace.log( title + ".getUpdateCount(): " + count );
			return( count );
		} // getUpdateCount
...
//		} // getGeneratedKeys
		...
		*/
		...
		{
			SqlParse	parser = new SqlParse( text, timeLiteralsInGMT() );
