...
namespace Ca.Ingres.Utility
{
	...
	**		MSG_XP_XA_FRMT, MSG_XP_XA_GTID, MSG_ZP_XA_BQUAL
	**
	**	    Query parameters:
	...
	**	MSG_RESULT		Message Type: request completed.
	...
	**	MSG_DSC_PIN		Procedure param: input.
	**	MSG_DSC_POUT		Procedure param: output.
	...
	*/
	...
	internal class MsgConst : DbmsConst
	{
		...
		public const byte MSG_PROTO_DFLT = MSG_PROTO_3;
		...
		*/
		...
		public const short MSG_CP_BLANKDATE   = -3;
		...
		*/
		...
		public const short MSG_XACT_SAVEPOINT = 0x07; // Savepoint.
		...
		** Query flags
		*/
		public const ushort MSG_QF_READONLY    = 0x0001; // READONLY cursor
		public const ushort MSG_QF_AUTO_CLOSE  = 0x0002; // Close statement.
		public const ushort MSG_QF_FETCH_FIRST = 0x0004; // Fetch first rows.
		public const ushort MSG_QF_FETCH_ALL   = 0x0008; // Fetch all rows.
		...
		*/
		...
		public const byte MSG_DSC_PIN        = 0x02; // Procedure param: input
		public const byte MSG_DSC_POUT       = 0x04; // Procedure param: output
