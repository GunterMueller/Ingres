	...
	*/
	...
	internal class CharSet
	{
		...
		*/
		...
		private static Object[][] csInfo =
		{
			...
			new Object[]{"ISO88592",       "iso-8859_2", false, null, 0x0002},
			new Object[]{"ISO88595",       "iso-8859_5", false, null, 0x0005},
			new Object[]{"ISO88599",       "iso-8859_9", false, null, 0x0009},
			new Object[]{"IS885915",       "iso-8859_15",false, null, 0x000F},
			...
			new Object[]{"ARABIC",         "cp420",      false, null, 0x0050},
			...
			new Object[]{"CHINESES",       "cp1383",     true,  null, 0x0200},
			...
			new Object[]{"CHTEUC",         "cns11643",   true,  null, 0x0206},
			new Object[]{"CHTHP",          "cns11643",   true,  null, 0x0207},
	...
	/*
		...
		*/
		...
		public virtual System.IO.StreamWriter getOSW(System.IO.Stream stream)
		{
			System.IO.StreamWriter osw;
			
			if (encoding == null)
				osw = new System.IO.StreamWriter(stream);
			else
				osw = new System.IO.StreamWriter(stream);
		...
		**
		** Description:
		**	Find the .NET character set encoding corresponding to an
		**	Ingres installation character set.
		**
		** Input:
		**	charset	    Ingres installation character set.
		**
		** Output:
		**	None.
		**
		...
		*/
		...
		public static System.Text.Encoding getEncoding(String charset)
		{
			...
			*/
			if ((encodingName = (String) csMap[charset]) == null)
			...
			*/
			...
			{
				try {encoding = System.Text.Encoding.GetEncoding("iso-8859-1");}
				catch  (NotSupportedException)
				{
...
internal class CharArrayReader : System.IO.StreamReader
{
