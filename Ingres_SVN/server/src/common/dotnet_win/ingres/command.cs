...
public sealed class IngresCommand : Component, IDbCommand, IDisposable, ICloneable
{
	/// <summary>
	...
	*/
	...
	[Editor(
		 typeof(Ca.Ingres.Client.Design.QueryDesignerUITypeEditor),
	...
	*/
	...
	public IngresDataReader ExecuteReader(CommandBehavior behavior)
	{
			...
			(CommandBehavior.KeyInfo | CommandBehavior.SchemaOnly)) != 0)
		{
			...
			keyInfoMetaData = Connection.GetKeyInfoMetaData( CommandText );
		}
		...
		System.Drawing.Design.UITypeEditor
	{
			...
			object                 value)
		{
			...
			Type t = assemDesign.GetType(
				"Ca.Ingres.Client.Design.QueryDesignerUITypeEditor");
			if (t == null)
				return null;
