...
//	 IngresDataAdapter when dragged from the toolbox onto a design surface.
	[Designer(typeof(Ca.Ingres.Client.Design.GenDataSetDesigner))]
	[ToolboxItem(typeof(Ca.Ingres.Client.Design.IngresDataAdapterToolboxItem))]
	public sealed class IngresDataAdapter : DbDataAdapter, IDbDataAdapter, ICloneable
{
	...
	*/
	...
	public IngresCommand SelectCommand 
	{
	...
	public IngresCommand InsertCommand 
	{
	...
	[DefaultValue(null)]
	[CategoryAttribute("Update")]
	public IngresCommand UpdateCommand 
	{
	...
	[DefaultValue(null)]
	[CategoryAttribute("Update")]
	public IngresCommand DeleteCommand 
	{
	...
	/// </summary>
	[Editor(
		typeof(Ca.Ingres.Client.Design.TableMappingsUITypeEditor),
		...
		System.ComponentModel.Design.ComponentDesigner
	{
		...
		private void OnGenerate(object sender, EventArgs e)
		{
			...
			Type t = assemDesign.GetType(
				"Ca.Ingres.Client.Design.GenDataSetDesigner");
			if (t == null)
				return;
		...
		System.Drawing.Design.ToolboxItem
	{
		...
		*/
			...
			CreateComponentsCore(System.ComponentModel.Design.IDesignerHost host)
		{
			...
			Type t = assemDesign.GetType(
				"Ca.Ingres.Client.Design.IngresDataAdapterToolboxItem");
			if (t == null)
				return null;
			object o = Activator.CreateInstance(t);
		...
		internal static string GetDesignAssembly()
		{
			...
			// Ca.Ingres.VSDesign,Version=1.1.0.0,Culture=neutral,PublicKeyToken=..."
			string designAssembly =
				"Ca.Ingres.VSDesign" + fullnameExecuting.Substring( index );
	...
	*/
		...
		System.Drawing.Design.UITypeEditor
	{
			...
			object                 value)  // DataTableMappingCollection object
		{
			...
			Type t = assemDesign.GetType(
				"Ca.Ingres.Client.Design.TableMappingsUITypeEditor");
			if (t == null)
				return null;
			object o = Activator.CreateInstance(t);
