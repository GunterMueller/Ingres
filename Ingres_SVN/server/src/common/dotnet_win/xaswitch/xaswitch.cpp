...
#using <mscorlib.dll>
#using "Ca.Ingres.Client.dll"
using namespace System;
using namespace Ca::Ingres::ProviderInternals;
using namespace System::Runtime::InteropServices;

#pragma message( "warning LNK4243 for Ca.Ingres.Support may be safely ignored \
...
{
public:
	static Ca::Ingres::ProviderInternals::XASwitch*  xasw;
};

typedef DWORD XA_SWITCH_FLAGS;

Ca::Ingres::ProviderInternals::AdvanXID* newAdvanXID(XID * xid);
Ca::Ingres::ProviderInternals::XAXID*         newXid(XID * xid);
void CopyAdvanXidToXID(
	Ca::Ingres::ProviderInternals::AdvanXID* advanXID, XID * xid);
	...
	XA_SWITCH_FLAGS XaSwitchFlags,  struct xa_switch_t** ppXaSwitch)
{
	...
	*ppXaSwitch = &xa_switch;   // table of functions within this module
	XAProvider::xasw = new Ca::Ingres::ProviderInternals::XASwitch();
...
Ca::Ingres::ProviderInternals::AdvanXID* newAdvanXID(XID * xid)
{
	...
	Ca::Ingres::ProviderInternals::AdvanXID* advanXID =
		new Ca::Ingres::ProviderInternals::AdvanXID(formatID, gtridBytes, bqualBytes);
	return advanXID;
}
...
Ca::Ingres::ProviderInternals::XAXID* newXid(XID * xid)
{
	...
	Ca::Ingres::ProviderInternals::XAXID* Xid =
		new Ca::Ingres::ProviderInternals::XAXID(
			formatID, gtridLength, bqualLength, dataBytes);
	return Xid;
}


void CopyAdvanXidToXID(Ca::Ingres::ProviderInternals::AdvanXID* advanXID, XID * xid)
{
