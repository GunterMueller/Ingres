...
**                                      exceeded.
**	    E_AD5510_BAD_DTID_FOR_ESCAPE    The sole operand for ADE_ESC_CHAR
**					must be "char".
**	    E_AD5511_BAD_DTLEN_FOR_ESCAPE   The sole operand's length for
**					ADE_ESC_CHAR must be 1.
**
**	Exceptions:
**	    none
**
...
#define	    AD_NULLABLE           1  /* output is nullabe */
	...
	case ADE_ESC_CHAR:
	    if (ade_nops != 1)
		status = E_AD5502_WRONG_NUM_OPRS;
	    else if (ade_ops[0].opr_dt != DB_CHA_TYPE)
		status = E_AD5510_BAD_DTID_FOR_ESCAPE;
	    else if (ade_ops[0].opr_len != 1)
			...
			*/
			if ( dptr )
			{
			    ...
			    */
			    j = cxseg->seg_n;
			    tptr = NULL;
			    tptr1 = (ADE_INSTRUCTION *) (ade_cx + cxseg->seg_1st_offset);
