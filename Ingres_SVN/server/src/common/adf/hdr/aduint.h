...
FUNC_EXTERN ADU_NORM2_FUNC adu_atrim;       /* Same as adu_trim , only using 
					    ...
					    ** LEADING, TRAILING, BOTH options).
                                            */
FUNC_EXTERN ADU_NORM1_FUNC adu_2datetodate; /* This routine converts a date 
                                            ** value into a date value.
                                            ** This is used for copying a date
                                            ** data value into a tuple buffer.
                                            */
FUNC_EXTERN ADU_NORM1_FUNC adu_14strtodate; /* Routine to coerce a string data
                                            ** value into a date data value.
                                            */
FUNC_EXTERN ADU_NORM1_FUNC adu_21ansi_strtodt; /* Routine to coerce a 
					    ** ANSI string data
                                            ** value into a date data value.
                                            */
FUNC_EXTERN ADU_NORM1_FUNC adu_6datetostr;  /* Routine to coerce a date datatype
...
FUNC_EXTERN ADU_NORM1_FUNC adu_1mnytonum;   /* This routine converts a money
                                            ...
                                            */
FUNC_EXTERN ADU_NORM1_FUNC adu_9mnytostr;   /* Routine to coerce a money data
...
FUNC_EXTERN ADU_NORM1_FUNC adu_numtomny;    /* This routine converts a number
                                            ...
                                            ** a money data value.
                                            */
FUNC_EXTERN ADU_NORM1_FUNC adu_2strtomny;   /* This routine converts a string
                                            ** data value into a money data
                                            ** value.
                                            */
...
FUNC_EXTERN ADU_KEYBLD_FUNC adu_nvchbld_key; /* Routine to build a key for the
                                             ...
                                             */
FUNC_EXTERN ADU_KEYBLD_FUNC adu_utf8cbldkey; /* Routine to build a key for the
					     ** char, varchar, text, or c 
					     ** datatypes on a UTF8 install.
					     */
