...

{
	...
	{
	  if (atr_len > sizeof(temp_dv1))
	  {
	    dv1data = (char *)MEreqmem(0, atr_len, FALSE, &stat);
	...
	{
	  if (atr_len > sizeof(temp_dv2))
	  {
	    dv2data = (char *)MEreqmem(0, atr_len, FALSE, &stat);
