...
# define DU_LANG_FLAG ""
# define DU_MAXDBCMPTLVL 4
# define DU_RMSTAIL "/rms"
# define DU_STARTAIL "/star"
# define DU_SLASHD "/d"
# define DU_INGTAIL "/ingres"
...
{
    char	    du_dbname[DB_MAXNAME];  /* The database name. */
...
# define DU_GLOBAL 1
# define DU_RES_DDB 2
# define DU_DESTROYDB 4
# define DU_CREATEDB 8
# define DU_OPERATIVE 16
# define DU_CONVERTING 32
# define DU_UPGRADING 64
# define DU_MLSDB 128
# define DU_DESTROYDBNOWAIT 256
# define DU_PRODUCTION 512
# define DU_NOBACKUP 1024
# define DU_RDONLY 2048
...
# define DU_1SER_DDB 1
# define DU_2SER_CDB 2
...
# define DU_UTYPES_ALLOWED 2147483648
					...
					** allowed in database
					*/
    char	    du_dbcmptlvl[DU_MAXDBCMPTLVL]; /* Database compatibility
						** level.
						*/
/* Note that these versions have equivalent statistics values in dbdbms.h */
# define DU_0DBV60 "6.0"
# define DU_1DBV61A "6.1a"
# define DU_2DBV62 "6.2"
# define DU_3DBV63 "6.3"
# define DU_4DBV70 "7.0"
# define DU_5DBV634 "6.34"
# define DU_6DBV80 "8.0"
# define DU_6DBV85 "8.5"
# define DU_6DBV86 "8.6"
# define DU_6DBV865 "9.0"
# define DU_6DBV902 "9.02"
# define DU_6DBV904 "9.04"
# define DU_6DBV910 "9.10"
# define DU_6DBV920 "9.20"
# define DU_CUR_DBCMPTLVL "9.04"
/* The below must be kept equal to DU_CUR_DBCMPTLVL, 4 chars exactly! */
#define			DU_CUR_DBCMPTLVL_CHARS '9', '.', '0', '4'
...
typedef struct _DU_DBACCESS
{
    DB_OWN_NAME     du_usrname;         /* The Ingres user name of someone who
					...
					*/
    char	    du_dbname[DB_MAXNAME]; /* The name of an Ingres database. */
    char	    du_xtra[DB_MAXNAME]; /* Extra space for futures. */
}   DU_DBACCESS;
/*}
...
typedef struct _DU_EXTEND
{
    ...
    char	    du_lname[DB_MAXNAME]; /* A database's location name. */
    i2		    du_d_length;	/* Length of database's name. */
    char	    du_dname[DB_MAXNAME];   /* Database name. */
...
#define		DU_RDONLY_LOC	0x2000	/* Besides above: READONLY */
    ...
    char	    du_lname[DB_MAXNAME]; /* A location name. */
