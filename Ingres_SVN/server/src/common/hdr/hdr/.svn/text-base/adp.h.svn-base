...
# define		ADP_P_LOC_L_UNK 5   /* Locator, length unknown */
	...
	ADP_LOCATOR	    val_locator; /* the locator */
	char		    val_value[1];
...
# define                ADW_STOP            6
# define		ADW_FLSH_SEG_NOFIT_LIND	7
# define		ADW_FLUSH_INCOMPLETE_SEGMENT	8
...
#define                 ADP_ADW_ASCII_ID CV_C_CONST_MACRO('#', 'L', 'O', 'W')
	/* EO Standard header */
    PTR             adw_filter_space;   /* storage for filter function */
