		...
		SqlDates : GcfErr
	{
		...
		*/
		...
		parseOffset( String tzOffset )
		{
			...
			*/
			...
			int hours =
				Convert.ToInt32(tzOffset[1]) * 10 +
				Convert.ToInt32(tzOffset[2]);
			int minutes =
				Convert.ToInt32(tzOffset[4]) * 10 +
				Convert.ToInt32(tzOffset[5]);
		...
		*/
		...
		getTZ( String tzOffset )
		{
			...
			*/
			TimeZone tz = (TimeZone)tzCache[ tzOffset ];
		...
		*/
		...
		{
			return (datetime.Millisecond * 1000000);
		}
