...
**	10-May-91 (seiwald)
**	    Removed GCcprcnm() - the process name is now set in GCregister.
**      16-jul-93 (ed)
**	    added gl.h
**	12-feb-01 (kinte01)
**	    Removed redundant external definition of GCpinit. Already
**	    defined in GCCCL.H
**	29-aug-2003 (abbjo03)
...
/*
**      Following are miscellaneous constants used internally by the VMS CL
**	implementation. 
*/

#define                 GCC_AST_PND     0x8000
...
**	returns a status of FAIL to its caller.
**
**
** Inputs:
...
**      07-Nov-89 (ham)
**          Use EXinterrupt call instead of sys$setast, EXinterrupt
**	    uses sys$setast but keeps track of whether the ast were
**	    previously enabled or disabled by another call.
*/
STATUS
GCcinit( generic_status, system_status)
STATUS		    *generic_status;
CL_SYS_ERR	    *system_status;
{
    /* Prevent AST delivery until initialization is complete		    */
...
**					CL_SYS_ERR *, and all return STATUS.
**
** Outputs:
**      generic_status			Pointer to an element of type STATUS.
**	system_status			Pointer to an element of type
