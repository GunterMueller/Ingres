...
/*
** Unfortunately, sbrk() isn't defined in any system header of RS6000.
** Add to this list if your machine doesn't have sbrk() defined anywhere.
*/
#if defined(ris_us5)
extern char *sbrk();
#endif /* ris_us5 */
...
#if defined(sun_u42) || defined(su4_us5) || defined(ds3_ulx) || defined(pyr_us5) || defined(xCL_075_SYS_V_IPC_EXISTS) || defined(sui_us5)
#define SYS_V_SHMEM
#endif
