...
FUNC_EXTERN STATUS CS_create_sys_segment();    /* create sys cntrl block seg */
FUNC_EXTERN STATUS CS_map_sys_segment();       /* map system cntrl block seg */
FUNC_EXTERN STATUS CS_alloc_serv_segment();    /* create serv shared mem seg */
FUNC_EXTERN STATUS CS_map_serv_segment();      /* map serv shared mem seg. */
FUNC_EXTERN STATUS CS_destroy_serv_segment();  /* destroy serv shared mem seg */
