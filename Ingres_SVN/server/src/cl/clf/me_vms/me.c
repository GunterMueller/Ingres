...
/*
** VMS definitions for memory allocation.  These are not avilable in a c
** include file
*/
globalvalue 	LIB$K_VM_FIRST_FIT;
globalvalue 	LIB$K_VM_QUICK_FIT;
globalvalue 	LIB$K_VM_FREQ_SIZES;
globalvalue 	LIB$K_VM_FIXED;
globalvalue	LIB$M_VM_BOUNDARY_TAGS;
	...
	PTR	block)
{
	...
	** length, and a maigc number.  Check for the magic number to see if
