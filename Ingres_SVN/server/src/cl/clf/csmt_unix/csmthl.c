...
# if (defined(xCL_077_BSD_MMAP) || defined(rs4_us5) || defined(ris_u64)) && !defined(USE_IDLE_THREAD) && !defined(LNX)
...
CSMT_admin_task()
{
	...
	{
	    /* Shutdown, and all threads, including the IdleThread, have ended */
	    return OK;
	}
