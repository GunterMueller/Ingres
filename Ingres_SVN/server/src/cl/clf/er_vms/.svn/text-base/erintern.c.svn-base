...
i4	    langcode;
{
    ...
    STATUS	status;
    CL_SYS_ERR  err_code;		/* error structer of system call */
...
**
** Outputs:
**	CL_SYS_ERR *err_code		if error happen, code is set to this.
**	Returns:
...
**
** Outputs:
**	CL_SYS_ERR *err_code	pointer of error code structer
**	Returns:
**		OK	    scucess
**
**		ER_BADREAD
