...
register LOCATION	*loc;
{
	...
	ITEMLIST	itemlist[2];	/* Itemlist for logical name setting */
	...
	*/                                               
	...
	itemlist[0].length = pstruct.pnam.nam$b_dev;
	itemlist[0].code = LNM$_STRING;
	itemlist[0].buffer = pstruct.pnam.nam$l_dev;
	itemlist[0].retlen = NULL;
	itemlist[1].length = itemlist[1].code = 0;
