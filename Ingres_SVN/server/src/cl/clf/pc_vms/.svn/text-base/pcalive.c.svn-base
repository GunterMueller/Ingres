/*
**    Copyright (c) 1992, 2003 Ingres Corporation
*/
#include    <compat.h>
#include    <gl.h>
#include    <pc.h>
...
PCis_alive(PID pid)
{
    ...
    i4		    efn_status;
    static  II_VMS_EF_NUMBER    efn;
    static  i4	    first_time = 1;
    ...
    jpiget[0].bufadr = (PTR)&process_state;

    i = sys$getjpiw(efn, &pid, 0, jpiget, 0, 0, 0);
