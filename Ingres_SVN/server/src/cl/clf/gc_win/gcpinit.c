/*
** Copyright (c) 1987, 2006 Computer Associates International, Inc.
*/
...
CL_ERR_DESC *system_status;
{
	...
	*/
	GCTRACE(4)("GCpinit: Creating Completeion Q Mutex ...\n");
	if ( ( hMutexGccCompleteQ = CreateMutex(&sa, FALSE, NULL ) ) == NULL )
	{
	    status = FAIL;
	    goto end_pinit;
	}
...
# endif /* MCT */
	...
	{
	    CloseHandle( hMutexGccCompleteQ );
	    status = FAIL;
	    goto end_pinit;
	}
