...
# if defined(POSIX_THREADS) && defined(hp8_us5)
# include	<netdb.h>
...
# elif defined(POSIX_THREADS) && defined(hp8_us5)
...
# if defined(POSIX_THREADS) && defined(hp8_us5) && !defined(i64_hpu)
	hostbuf.current = NULL;
# endif /* POSIX_THREADS && hp8_us5 */

# if defined(rs4_us5) || defined(ris_u64) || defined(i64_aix)
	MEfill( sizeof(hostbuf), 0, &hostbuf );
# endif /* defined(rs4_us5) */
