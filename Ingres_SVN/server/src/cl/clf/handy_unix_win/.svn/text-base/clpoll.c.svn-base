...
#if 0
/*
** Temporary commented-out change to relieve the 1024 fd limit on Linux.
**
** - to activate this code change the "#if 0" above to "#if defined(LNX)"
**   and change the #if logic at the top of clfd.c to assign a value of
**   8192 to CL_FD_SETSIZE for LNX.
**
