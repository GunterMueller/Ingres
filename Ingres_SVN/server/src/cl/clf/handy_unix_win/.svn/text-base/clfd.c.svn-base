...
#include    <errno.h>
    ...
    defined(su9_us5) || defined(a64_sol)
# define    CL_FD_SETSIZE  8192  
  static i4 max_count = 0;
#endif /* rs4_us5 || ris_u64 || su4_us5 || su9_us5 || a64_sol */
...
#if defined(rs4_us5) || defined(ris_u64) || defined(su4_us5) || \
    defined(su9_us5) || defined(LNX) || defined(OSX) || defined(a64_sol)
...
#endif /* rs4_us5 || ris_u64 || su4_us5 || su9_us5 || LNX || OSX || a64_sol */
