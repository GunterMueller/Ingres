...
typedef struct _GC_RQ_ASSOC1
{
    ...
    GC_RQ_ASSOC	rq_assoc0;
    i4		flags;

#define	GC_RQ_REMOTE		0x01	/* Direct remote connection */
...
#define GC_IS_REMOTE	0x04		/* Is remote access allowed?? */
    ...
    union 
    {
	GC_RQ_ASSOC	rq_assoc;	/* Association info: version 0 */
	GC_RQ_ASSOC1	rq_assoc1;	/* Association info: Version 1 */
