...
static READONLY char edt_name[] 	= ERx("+EDT");
static READONLY char edt_image[] 	= ERx("EDTSHR");
static READONLY char edt_symbol[] 	= ERx("EDT$EDIT");
static $DESCRIPTOR( edt_image_desc, edt_image);
static $DESCRIPTOR( edt_symbol_desc, edt_symbol);

static READONLY char tpu_name[] 	= ERx("+TPU");
static READONLY char tpu_image[] 	= ERx("TPUSHR");
static READONLY char tpu_symbol[] 	= ERx("TPU$EDIT");
static $DESCRIPTOR( tpu_image_desc, tpu_image);
static $DESCRIPTOR( tpu_symbol_desc, tpu_symbol);

static READONLY char lse_name[] 	= ERx("+LSE");
static READONLY char lse_image[] 	= ERx("LSESHR");
static READONLY char lse_symbol[] 	= ERx("LSE$EDIT");
