...
# if defined(hpb_us5) || defined(LNX) || defined(OSX)
...
# if defined (xCL_077_BSD_MMAP) || defined(rs4_us5) || defined(ris_u64)
    ...
    */
#   if defined(su4_us5) || defined(axp_osf) || defined(hpb_us5) || defined(dgi_us5) || \
...
# if defined(sqs_ptx) || defined(axp_osf) || defined(sos_us5) || \
     defined(hp8_us5) || defined(i64_aix) || defined(LNX) || \
     defined(rs4_us5) || defined (dgi_us5) || defined(OSX)
    {
         sigset_t mask;
...
# if defined(su4_us5) || defined(hpb_us5)
	{
...
{
# if defined(su4_us5) || defined(hpb_us5) || defined(axp_osf) || \
