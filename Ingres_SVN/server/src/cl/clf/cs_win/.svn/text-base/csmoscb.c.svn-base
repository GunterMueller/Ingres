		...
		char *userbuf)
{
	...
	scb->cs_inkernel = kernelcpu;

	return (MOlongout(MO_VALUE_TRUNCATED, usercpu, luserbuf, userbuf));
}
		...
		char *userbuf)
{
	...
	scb->cs_cputime = kernelcpu + usercpu;
	scb->cs_inkernel = kernelcpu;
