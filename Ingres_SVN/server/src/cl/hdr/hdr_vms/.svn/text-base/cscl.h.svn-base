...
**
**	Currently this is for System V threads only
*/
...
# ifdef POSIX_THREADS
#    define	CP_SYNCH		pthread_mutex_t
...
#    define	CS_SYNCH		CP_SYNCH
#    define	CS_synch_init(synchptr) pthread_mutex_init(synchptr,&pthread_mutexattr_default)
#    define	CS_synch_destroy	pthread_mutex_lock(sptr)
#    define	CS_synch_lock	pthread_mutex_trylock(sptr)
#    define	CS_synch_unlock	pthread_mutex_unlock(sptr)
/* Cross-process synch objects */
...
# define USE_BOUND_THREADS   /* comment this line for unbound threads */
...
#   define CS_thread_kill(tid,sig)      pthread_kill(tid,sig)
