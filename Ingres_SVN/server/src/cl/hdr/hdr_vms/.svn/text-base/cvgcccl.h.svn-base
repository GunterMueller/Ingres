...
# if defined(VAX) && !defined(ALPHA) || defined (vax_ulx)

# define CV_INT_TYPE	CV_LH3232_INT
# define CV_FLT_TYPE	CV_VAX_FLT
...
/*
**	Since VAX/VMS and VAX/ULX have identical data types, a test on
**	ifdef VAX is sufficient for both systems.
*/
#if defined(VAX) && !defined(ALPHA) || defined(vax_ulx)
...
typedef struct {
	...
	unsigned repexp : 8;
	unsigned repsign : 1;
	unsigned repmant2 : 16;
	unsigned repmant1 : 16;
	unsigned repmant0 : 16;
} DOUBLEREP;

# define LOCEXPBIAS	128	/* The native exponent bias */
# define BIASDIFF	(LOCEXPBIAS - CV_EXPBIAS)

# define F4SIGN(f4ptr)	( ((FLOATREP *)(f4ptr))->repsign )
# define F4EXP(f4ptr)	( (((FLOATREP *)(f4ptr))->repexp == 0) ? 0 :	\
			  ((FLOATREP *)(f4ptr))->repexp - BIASDIFF )
# define F4MANT(f4ptr)	( (((FLOATREP *)(f4ptr))->repmant1 << 25) |	\
			  (((FLOATREP *)(f4ptr))->repmant0 << 9) )

# define F8SIGN(f8ptr)	( ((DOUBLEREP *)(f8ptr))->repsign )
# define F8EXP(f8ptr)	( (((DOUBLEREP *)(f8ptr))->repexp == 0) ? 0 :	\
			((DOUBLEREP *)(f8ptr))->repexp - BIASDIFF )
# define F8MANTHI(f8ptr) ( ((DOUBLEREP *)(f8ptr))->repmant3 << 25 |	\
			((DOUBLEREP *)(f8ptr))->repmant2 << 9 |		\
			HIBITS( ((DOUBLEREP *)(f8ptr))->repmant1, 9, 16 ) )
# define F8MANTLO(f8ptr) ( ((DOUBLEREP *)(f8ptr))->repmant1 << 25 |	\
			   ((DOUBLEREP *)(f8ptr))->repmant0 << 9 )
...
# define MKF4(sign, exp, mant, f4ptr)					\
	( ((exp) == 0) ?						\
	  ...
	  ((exp) + BIASDIFF <= 0) ?					\
		  ...
		  ((FLOATREP *)(f4ptr))->repmant1 = 0,			\
		  ((FLOATREP *)(f4ptr))->repmant0 = 0 ) :		\
	  ((exp) + BIASDIFF > 255) 					\
	      ? ( ((FLOATREP *)(f4ptr))->repsign = (sign),		\
		  ((FLOATREP *)(f4ptr))->repexp = 255,			\
		  ((FLOATREP *)(f4ptr))->repmant1 = 0x7F,		\
		  ((FLOATREP *)(f4ptr))->repmant0 = 0xFFFF )		\
	      : ( ((FLOATREP *)(f4ptr))->repsign = (sign),		\
		  ((FLOATREP *)(f4ptr))->repexp = (exp) + BIASDIFF,	\
		  ((FLOATREP *)(f4ptr))->repmant1 = HIBITS(mant,7,32),	\
		  ((FLOATREP *)(f4ptr))->repmant0 = HIBITS(mant,16,25) ) )
...
# define MKF8(sign, exp, manthi, mantlo, f8ptr)				\
	( ((exp) == 0) ?						\
	  ...
	  ((exp) + BIASDIFF <= 0) ?					\
		  ...
		  ((DOUBLEREP *)(f8ptr))->repmant3 = 0,			\
		  ((DOUBLEREP *)(f8ptr))->repmant2 = 0,			\
		  ((DOUBLEREP *)(f8ptr))->repmant1 = 0,			\
		  ((DOUBLEREP *)(f8ptr))->repmant0 = 0 ) :		\
	  ((exp) + BIASDIFF > 255)					\
	      ? ( ((DOUBLEREP *)(f8ptr))->repsign = (sign),		\
		  ((DOUBLEREP *)(f8ptr))->repexp = 255,			\
		  ((DOUBLEREP *)(f8ptr))->repmant3 = 0x7F,		\
		  ((DOUBLEREP *)(f8ptr))->repmant2 = 0xFFFF,		\
		  ((DOUBLEREP *)(f8ptr))->repmant1 = 0xFFFF,		\
		  ((DOUBLEREP *)(f8ptr))->repmant0 = 0xFFFF )		\
	      : ( ((DOUBLEREP *)(f8ptr))->repsign = (sign),		\
		  ((DOUBLEREP *)(f8ptr))->repexp = (exp) + BIASDIFF,	\
		  ((DOUBLEREP *)(f8ptr))->repmant3 = HIBITS(manthi,7,32),\
		  ((DOUBLEREP *)(f8ptr))->repmant2 = HIBITS(manthi,16,25),\
		  ((DOUBLEREP *)(f8ptr))->repmant1 =			\
			LOBITS(manthi,9) << 7 | HIBITS(mantlo,7,32),	\
		  ((DOUBLEREP *)(f8ptr))->repmant0 = HIBITS(mantlo,16,25) ) )
