/*
** Copyright (c) 1991, 2001 Ingres Corporation
*/
...
# define	EX_CONTINUES	(E_CL_MASK + E_EX_MASK + 0xFE) 
...
/* Next line from decc$library:[include]setjmp.h to avoid nested include   */

typedef __int64  jmp_buf [68];	/* 68 quadwords - a standard invo cntxt block */
...
#ifndef EXgetctx
FUNC_EXTERN int    EXgetctx(
);
#endif
#ifndef EXunsave_handler
