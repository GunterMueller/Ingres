...
# ifdef __ALPHA
/*
**   hack alert! - temporarily redefining certain SYNCHRONOUS system service
**   calls to call jacket routines so that a dummy iosb is used when NO iosb
**   is passed in.  This works around an Alpha VMS bug.
*/
#  define sys$getjpiw iisys_getjpiw
#  define sys$getdviw iisys_getdviw
#  define sys$getsyiw iisys_getsyiw
#  define sys$getlkiw iisys_getlkiw
#  define sys$qiow iisys_qiow
