...
/* # line 647 "iicxxa.sc" */	/* disconnect */
  {
    IIsqInit(&sqlca);
    IILQsidSessID(free_session);
    IIsqDisconnect();
  }
/* # line 648 "iicxxa.sc" */	/* host code */
	if (sqlca.sqlcode < 0)
        {
/* # line 650 "iicxxa.sc" */	/* inquire_sql */
  {
    IILQisInqSqlio((short *)0,1,30,4,&err_number,2);
  }
/* # line 651 "iicxxa.sc" */	/* host code */
            STprintf(ebuf,
...
/* # line 1454 "iicxxa.sc" */	/* inquire_sql */
  {
    IILQisInqSqlio((short *)0,1,30,4,&curr_session,11);
  }
/* # line 1455 "iicxxa.sc" */	/* host code */
    if (curr_session == 0)
    {
	/* no chance */
	return (E_DB_OK);
