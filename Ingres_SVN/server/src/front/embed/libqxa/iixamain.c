...
** xa_call, the flags passed in, XID (if not null) and rmid (if not null).
...
#define	OUTPUT_TRACE_HEADER(xc,fl,xid,rmid) \
	output_trace_header( xc, fl, xid, rmid )
          ...
          long      flags)
{
	...
	*/
    ...
    {
        char	outbuf[300];
    	OUTPUT_TRACE_HEADER( IIXA_OPEN_CALL, flags, (XID *)0, &rmid);
           ...
           long      flags)
{
    ...
    if(IIcx_fe_thread_main_cb->fe_main_flags & IICX_XA_MAIN_TRACE_XA)
    {
        ...
        OUTPUT_TRACE_HEADER( IIXA_CLOSE_CALL, flags, (XID *)0, &rmid);
        /* output xa_info string */
           ...
           long      flags)
{
  ...
  char xid_str[IIXA_XID_STRING_LENGTH];
    ...
    {
	/* output trace header info if tracing on...*/
    	OUTPUT_TRACE_HEADER( IIXA_START_CALL, flags, xid, &rmid);
    }
    /*
...
/* # line 1598 "iixamain.sc" */	/* set_sql */
  {
    IILQssSetSqlio(11,(short *)0,1,30,4,&reuse_session);
  }
/* # line 1599 "iixamain.sc" */	/* host code */
  ...
  i4 resume_session;
	    ...
	    */
		...
		return(XAER_RMERR);
            ...
            fe_thread_cb_p->ingres_state = IICX_XA_T_ING_INTERNAL;
/* # line 1683 "iixamain.sc" */	/* set_sql */
  {
    IILQssSetSqlio(11,(short *)0,1,30,4,&resume_session);
  }
/* # line 1684 "iixamain.sc" */	/* inquire_sql */
  {
    IILQisInqSqlio((short *)0,1,30,4,&current_session,11);
  }
/* # line 1685 "iixamain.sc" */	/* host code */
         ...
         long      flags)
{
  ...
  i4                 next_xn_branch_assoc_state;
    ...
    {
	/* output trace header info if tracing on...*/
	OUTPUT_TRACE_HEADER( IIXA_END_CALL, flags, xid, &rmid);
    }
             ...
             long      flags)
{
    ...
    if(IIcx_fe_thread_main_cb->fe_main_flags & IICX_XA_MAIN_TRACE_XA)
    {
        char outbuf[80];
	/* output trace header info if tracing on...*/
	OUTPUT_TRACE_HEADER( IIXA_RECOVER_CALL, flags, (XID *)0, &rmid);
            ...
            long      flags)
{
    ...
    {
        /* output trace header info if tracing on...*/
        OUTPUT_TRACE_HEADER( IIXA_FORGET_CALL, flags, xid, &rmid);
	IIxa_fe_qry_trace_handler( (PTR) 0,
              ...
              long      flags)
{
    ...
    {
        /* output trace header info if tracing on...*/
        OUTPUT_TRACE_HEADER( IIXA_COMPLETE_CALL, flags, (XID *)0, &rmid);
	IIxa_fe_qry_trace_handler( (PTR) 0,
	    ERx("\tWARNING:  This call is not supported (yet)\n"), TRUE);
    }
    IIxa_error( GE_LOGICAL_ERROR, E_LQ00D1_XA_USER_OR_TM_ERR, 1,
...
{
  i4 internal_session = IIsqconSysGen;
  char *dbname_p;
  char *flags[12];
  char err_msg[256];
  i4 err_number;
...
/* # line 3527 "iixamain.sc" */	/* connect */
  {
    IIsqInit(&sqlca);
    IILQsidSessID(internal_session);
    IIsqConnect(0,dbname_p,flags[0],flags[1],flags[2],flags[3],flags[4],
    flags[5],flags[6],flags[7],flags[8],flags[9],flags[10],flags[11],(char *)0);
  }
/* # line 3530 "iixamain.sc" */	/* host code */
    }
    else
    {
...
/* # line 3543 "iixamain.sc" */	/* connect */
  {
    ...
    IIsqConnect(0,dbname_p,flags[0],flags[1],flags[2],flags[3],flags[4],
    flags[5],flags[6],flags[7],flags[8],flags[9],flags[10],flags[11],(char *)0);
    IIsqParms(0,(char *)"xa_xid",32,xid_str,0);
    IIsqParms(2,(char *)0,0,(char *)0,0);
  }
/* # line 3547 "iixamain.sc" */	/* host code */
    }
/* # line 3549 "iixamain.sc" */	/* inquire_sql */
  {
    IILQisInqSqlio((short *)0,1,30,4,&err_number,2);
  }
/* # line 3551 "iixamain.sc" */	/* host code */
    if (err_number)
    {
    ...
    {
/* # line 3562 "iixamain.sc" */	/* inquire_sql */
  {
    IILQisInqSqlio((short *)0,1,30,4,&internal_session,11);
  }
/* # line 3563 "iixamain.sc" */	/* host code */
	...
	save_ingres_state = fe_thread_cb_p->ingres_state; 
	fe_thread_cb_p->ingres_state = IICX_XA_T_ING_INTERNAL;
/* # line 3596 "iixamain.sc" */	/* select */
  {
    IIsqInit(&sqlca);
    IIsqMods(1);
    IIwritio(0,(short *)0,1,32,0,(char *)"select dbmsinfo('ima_server'\
)");
    IIretinit((char *)0,0);
    if (IInextget() != 0) {
      IIgetdomio((short *)0,1,32,DB_MAXNAME * 2-1,tmp_server_name);
    } /* IInextget */
    IIsqFlush((char *)0,0);
  }
/* # line 3597 "iixamain.sc" */	/* host code */
	if(IIcx_fe_thread_main_cb->fe_main_flags & IICX_XA_MAIN_TRACE_XA)
	    IIxa_fe_qry_trace_handler( (PTR) 0, ERx("select dbmsinfo ...\n"),
			    TRUE);
/* # line 3601 "iixamain.sc" */	/* inquire_sql */
  {
    IILQisInqSqlio((short *)0,1,30,4,&err_number,2);
  }
/* # line 3603 "iixamain.sc" */	/* host code */
	/*
	...
	*/
	if (!err_number)
	{
/* # line 3610 "iixamain.sc" */	/* commit */
  {
    IIsqInit(&sqlca);
    IIxact(3);
  }
/* # line 3611 "iixamain.sc" */	/* inquire_sql */
  {
    IILQisInqSqlio((short *)0,1,30,4,&err_number,2);
  }
/* # line 3612 "iixamain.sc" */	/* host code */
	}
	fe_thread_cb_p->ingres_state = save_ingres_state;
	if (err_number)
	{
		        ...
		        i4              branch_flag)
{
  ...
  bool		     rollbackonly = FALSE;
    ...
    if(IIcx_fe_thread_main_cb->fe_main_flags & IICX_XA_MAIN_TRACE_XA)
    {
    	OUTPUT_TRACE_HEADER( xa_call, flags, xid, &rmid);
        /* output xa_info string */
    }
    /* Unsupported options/flags */
    if (flags & TMASYNC)
...
/* # line 4017 "iixamain.sc" */	/* set_sql */
  {
    IILQssSetSqlio(11,(short *)0,1,30,4,&reuse_session);
  }
/* # line 4018 "iixamain.sc" */	/* host code */
		fe_thread_cb_p->ingres_state = save_ingres_state;
	    }
	}
	else
		...
		IITUX_XN_ENTRY    *xn_entry)
{
  ...
  char area[10];
    save_ingres_state = fe_thread_cb_p->ingres_state; 
    fe_thread_cb_p->ingres_state = IICX_XA_T_ING_INTERNAL;
/* # line 4253 "iixamain.sc" */	/* inquire_sql */
  {
    IILQisInqSqlio((short *)0,1,30,4,&current_session,11);
  }
/* # line 4254 "iixamain.sc" */	/* host code */
    if(IIcx_fe_thread_main_cb->fe_main_flags & IICX_XA_MAIN_TRACE_XA)
    {
       char outbuf[200];
        STprintf(outbuf,
...
/* # line 4281 "iixamain.sc" */	/* set_sql */
  {
    IILQssSetSqlio(11,(short *)0,1,30,4,&current_session);
  }
/* # line 4283 "iixamain.sc" */	/* host code */
	/* the most reliable way to check for error here */
/* # line 4284 "iixamain.sc" */	/* inquire_sql */
  {
    IILQisInqSqlio((short *)0,1,30,4,&current_session,11);
  }
/* # line 4285 "iixamain.sc" */	/* host code */
        if (current_session != xa_xn_cb_p->xa_sid)
	{
            fe_thread_cb_p->ingres_state = IICX_XA_T_ING_IDLE;
	    return (XAER_RMERR);
    ...
    {
/* # line 4298 "iixamain.sc" */	/* inquire_sql */
  {
    IILQisInqSqlio((short *)0,1,30,4,&in_a_transaction,73);
  }
/* # line 4299 "iixamain.sc" */	/* host code */
    }
    if ( (!in_a_transaction) && 
	 (xa_xn_cb_p->xa_state != IICX_XA_X_ROLLBACK_ONLY))
    {
	...
	IICXformat_xa_extd_xid(branch_seqnum, branch_flag, xid_str);
	    ...
	    */
        ...
        else
        {
    	    if ( (!in_a_transaction) && 
	       (xa_xn_cb_p->xa_state == IICX_XA_X_ROLLBACK_ONLY))
/* # line 4354 "iixamain.sc" */	/* set */
  {
    IIsqInit(&sqlca);
    IIwritio(0,(short *)0,1,32,0,(char *)"set TRACE POINT qe40");
    IIsyncup((char *)0,0);
  }
/* # line 4356 "iixamain.sc" */	/* host code */
	    /*
	    ** this should be ESQL, but for now use libq calls.
    ...
    else  /* Not TUXEDO */
    {
	    ...
	    */
        ...
        {
/* # line 4391 "iixamain.sc" */	/* commit */
  {
    IIsqInit(&sqlca);
    IIxact(3);
  }
/* # line 4392 "iixamain.sc" */	/* host code */
        }
        else
        {
/* # line 4395 "iixamain.sc" */	/* rollback */
  {
    IIsqInit(&sqlca);
    IIxact(2);
  }
/* # line 4396 "iixamain.sc" */	/* host code */
        }
        if (sqlca.sqlcode < 0)
        {
	    xa_ret_value = XAER_RMERR;
...
/* # line 4415 "iixamain.sc" */	/* set_sql */
  {
    IILQssSetSqlio(11,(short *)0,1,30,4,&save_session);
  }
/* # line 4416 "iixamain.sc" */	/* host code */
        /* the most reliable way to check for error here */
/* # line 4417 "iixamain.sc" */	/* inquire_sql */
  {
    IILQisInqSqlio((short *)0,1,30,4,&current_session,11);
  }
/* # line 4418 "iixamain.sc" */	/* host code */
                              ...
                              )
{
  ...
  i4 err_number;
    ...
    old_ingres_state = fe_thread_cb_p->ingres_state;
    fe_thread_cb_p->ingres_state = IICX_XA_T_ING_INTERNAL;
/* # line 4487 "iixamain.sc" */	/* inquire_sql */
  {
    IILQisInqSqlio((short *)0,1,30,4,&save_rec_session,11);
  }
/* # line 4489 "iixamain.sc" */	/* host code */
...
/* # line 4513 "iixamain.sc" */	/* set_sql */
  {
    IILQssSetSqlio(11,(short *)0,1,30,4,&rec_session);
  }
/* # line 4515 "iixamain.sc" */	/* inquire_sql */
  {
    IILQisInqSqlio((short *)0,1,30,4,&current_rec_session,11);
  }
/* # line 4516 "iixamain.sc" */	/* host code */
...
/* # line 4550 "iixamain.sc" */	/* connect */
  {
    IIsqInit(&sqlca);
    IILQsidSessID(rec_session);
    IIsqConnect(0,iidbdbname,(char *)0, (char *)0, (char *)0, (char *)0, 
    (char *)0, (char *)0, (char *)0, (char *)0, (char *)0, (char *)0, 
    (char *)0, (char *)0, (char *)0);
  }
/* # line 4552 "iixamain.sc" */	/* inquire_sql */
  {
    IILQisInqSqlio((short *)0,1,30,4,&err_number,2);
  }
/* # line 4553 "iixamain.sc" */	/* host code */
        if (err_number)
        {
...
/* # line 4561 "iixamain.sc" */	/* inquire_sql */
  {
    IILQisInqSqlio((short *)0,1,30,4,&rec_session,11);
  }
/* # line 4563 "iixamain.sc" */	/* host code */
...
/* # line 4628 "iixamain.sc" */	/* host code */
    if( flags & TMSTARTRSCAN)
    {
	if (fe_thread_cb_p->rec_scan_in_progress)
	{
	    /* start the scan over */
/* # line 4633 "iixamain.sc" */	/* close */
  {
    IIsqInit(&sqlca);
    IIcsClose((char *)"IIXA_REC_CURSOR",6547,10587);
  }
/* # line 4634 "iixamain.sc" */	/* host code */
	}
        /* open a cursor here */
/* # line 4637 "iixamain.sc" */	/* open */
  {
    IIsqInit(&sqlca);
    IIcsOpen((char *)"IIXA_REC_CURSOR",6547,10587);
    IIwritio(0,(short *)0,1,32,0,(char *)
"select trim(xa_dis_tran_id)from lgmo_xa_dis_tran_ids where xa_databas\
e_name=");
    IIputdomio((short *)0,1,32,0,tmp_dbname_p);
    IIwritio(0,(short *)0,1,32,0,(char *)"and xa_seqnum=0");
    IIwritio(0,(short *)0,1,32,0,(char *)" for readonly ");
    IIcsQuery((char *)"IIXA_REC_CURSOR",6547,10587);
  }
/* # line 4639 "iixamain.sc" */	/* host code */
        if (sqlca.sqlcode < 0)
        {
	    fe_thread_cb_p->rec_scan_in_progress = FALSE;
            fe_thread_cb_p->ingres_state = old_ingres_state;
...
i4        branch_seqnum;         /* These fields would be checked to */
    ...
    for ( next_xid = xids, xid_count = 0;
          ...
          xid_count++, next_xid++ )
    {
/* # line 4682 "iixamain.sc" */	/* fetch */
  {
    IIsqInit(&sqlca);
    if (IIcsRetScroll((char *)"IIXA_REC_CURSOR",6547,10587,-1,-1) != 0) {
      IIcsGetio((short *)0,1,32,IIXA_XID_STRING_LENGTH-1,xid_str);
      IIcsERetrieve();
    } /* IIcsRetrieve */
  }
/* # line 4684 "iixamain.sc" */	/* host code */
          if (sqlca.sqlcode != 0)
              break;
          if(IIcx_fe_thread_main_cb->fe_main_flags & IICX_XA_MAIN_TRACE_XA)
          {
...
/* # line 4720 "iixamain.sc" */	/* disconnect */
  {
    IIsqInit(&sqlca);
    IIsqDisconnect();
  }
/* # line 4721 "iixamain.sc" */	/* host code */
    ...
    {
/* # line 4729 "iixamain.sc" */	/* close */
  {
    IIsqInit(&sqlca);
    IIcsClose((char *)"IIXA_REC_CURSOR",6547,10587);
  }
/* # line 4731 "iixamain.sc" */	/* disconnect */
  {
    IIsqInit(&sqlca);
    IIsqDisconnect();
  }
/* # line 4733 "iixamain.sc" */	/* host code */
        xa_rmi_cb_p->rec_sid = 0;
    }
    fe_thread_cb_p->ingres_state = old_ingres_state;
    return( xid_count );
...
i4     	save_ingres_state;
    ...
    fe_thread_cb_p->ingres_state = IICX_XA_T_ING_INTERNAL;
    IICXlock_cb( fe_thread_cx_cb_p );
/* # line 5510 "iixamain.sc" */	/* set_sql */
  {
    IILQssSetSqlio(11,(short *)0,1,30,4,&reuse_session);
  }
/* # line 5512 "iixamain.sc" */	/* host code */
    /*
    ...
    */
/* # line 5523 "iixamain.sc" */	/* set */
  {
    IIsqInit(&sqlca);
    IIwritio(0,(short *)0,1,32,0,(char *)"set NOTRACE POINT qe40");
    IIsyncup((char *)0,0);
  }
/* # line 5524 "iixamain.sc" */	/* host code */
    fe_thread_cb_p->ingres_state = save_ingres_state;
    IICXunlock_cb( fe_thread_cx_cb_p );
    IICXunlock_cb( xa_xn_cx_cb_p );
