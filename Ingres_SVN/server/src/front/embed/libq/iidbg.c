...
dbg_add( II_LBQ_CB *IIlbqcb, DB_DATA_VALUE *dbv )
{
    ...
    ** money, float, or decimal number conversion to ascii: make it 
    ** big enough to fit maximum decimal precision plus decimal point,
    ** sign, and a 2 byte length indicator.
    */
    ALIGN_RESTRICT	buf[((DB_MAX_DECPREC+4) / sizeof(ALIGN_RESTRICT)) + 1];
