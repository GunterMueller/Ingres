...
*/
# define  IICGC_ADEF_BYTES	8192	/* Default number of bytes into which
					** size of message buffer should be
					** divided to calculate number of rows
					** that can be pre-fetched into an
					** alternate stream.  This default
					** corresponds to the maximum size
					** buffer on any system.
					*/
# define  IICGC_AMAX_BYTES	150000	/* Maximum number of bytes that the
					** system will pre-fetch into the
					** alternate stream in response to
					** a user setting of PREFETCHROWS.
					** This number translates into about
					** 200 VMS message buffers.
					*/
