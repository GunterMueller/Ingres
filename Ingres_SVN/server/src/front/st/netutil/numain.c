...
# include "/home/ingres/SANDBOX/Ingres_SVN/server/install/build/ingres/files/eqsqlda.h"
  static i4 nodet_row = 1;
  static i4 connt_row = 1;
  static i4 autht_row = 1;
  static i4 attrib_row = 1;
  static i4 whichtable;
  GLOBALDEF char username[MAX_TXT];
  GLOBALDEF char *hostname = NULL;
  static char local_host[MAX_TXT];
  static char local_username[MAX_TXT];
  static char *control_file_list = NULL;
  GLOBALDEF char private_word[MAX_TXT];
  GLOBALDEF char global_word[MAX_TXT];
  GLOBALDEF bool edit_global;
  GLOBALDEF bool cancel_on_vnodetype;
  GLOBALDEF char *def_protocol;
  static char topFormName[ MAX_TXT ];
  static char controlFormName[ MAX_TXT ];
  static char *control_menuitem;
  static i4 nodet_offset = 0;
  static i4 call_from_vw = 0;
  static bool original_type;
...
*/
/* # line 413 "numain.sc" */	/* display */
  {
    if (IIdispfrm(topFormName,(char *)"f") == 0) goto IIfdE1;
    goto IImuI1;
IIfdI1:;
    if (IIfsetio((char *)0) == 0) goto IIfdE1;
/* # line 417 "numain.sc" */	/* host code */
	{
    char userinfo_txt[MAX_TXT];
	    STprintf(userinfo_txt, "%s: %s", 
		ERget(S_ST0037_user_tag), username);
/* # line 423 "numain.sc" */	/* putform */
    {
      if (IIfsetio(topFormName) != 0) {
        IIputfldio((char *)"userinfo",(short *)0,1,32,0,userinfo_txt);
      } /* IIfsetio */
    }
/* # line 424 "numain.sc" */	/* host code */
	    if (hostname == NULL)
	    {
/* # line 426 "numain.sc" */	/* set_frs */
    {
      if (IIiqset(2,0,topFormName,(char *)0, (char *)0) != 0) {
        IIstfsio(54,(char *)"remote_host_name",0,(short *)0,1,30,sizeof(1),
        (void *)IILQint(1));
      } /* IIiqset */
    }
/* # line 428 "numain.sc" */	/* host code */
	    }
	    else
	    {
/* # line 431 "numain.sc" */	/* putform */
    {
      if (IIfsetio(topFormName) != 0) {
        IIputfldio((char *)"remote_host_name",(short *)0,1,32,0,hostname);
      } /* IIfsetio */
    }
/* # line 432 "numain.sc" */	/* set_frs */
    {
      if (IIiqset(2,0,topFormName,(char *)0, (char *)0) != 0) {
        IIstfsio(54,(char *)"remote_host_name",0,(short *)0,1,30,sizeof(0),
        (void *)IILQint(0));
      } /* IIiqset */
    }
/* # line 434 "numain.sc" */	/* host code */
	    }
	}
IIfdB1:
    while (IIrunform() != 0) {
		     ...
		     */
		     if( original_type )
		        ...
		        edit_global = TRUE;
                    ...
                    {
/* # line 461 "numain.sc" */	/* clear */
        {
          IIfldclear((char *)"nodetable");
        }
/* # line 462 "numain.sc" */	/* host code */
        ...
        if (enough_rows())   
			...
			if (nodet_row >= vnode_rows)
			    nodet_row--;
                    ...
                    break;
                case CONN_TBL:
/* # line 506 "numain.sc" */	/* getrow */
        {
          if (IItbsetio(2,topFormName,(char *)"conntable",-2) != 0) {
            IItcogetio((short *)0,1,32,MAX_TXT-1,type,(char *)"connt_t\
ype");
            IItcogetio((short *)0,1,32,MAX_TXT-1,prot,(char *)
"connt_protocol");
            IItcogetio((short *)0,1,32,MAX_TXT-1,list,(char *)
"connt_listen");
            IItcogetio((short *)0,1,32,MAX_TXT-1,addr,(char *)
"connt_address");
            IITBceColEnd();
          } /* IItbsetio */
        }
/* # line 509 "numain.sc" */	/* host code */
			...
			if (connt_row >= conn_rows)
			    connt_row--;
                    ...
                    break;
                case AUTH_TBL:
/* # line 522 "numain.sc" */	/* getrow */
        {
          if (IItbsetio(2,topFormName,(char *)"authtable",-2) != 0) {
            IItcogetio((short *)0,1,32,MAX_TXT-1,privglob,(char *)"typ\
e");
            IItcogetio((short *)0,1,32,MAX_TXT-1,login,(char *)"login");
            IITBceColEnd();
          } /* IItbsetio */
        }
/* # line 524 "numain.sc" */	/* host code */
...
/* # line 560 "numain.sc" */	/* host code */
                    if (OK == edit_conn(vnode,type,addr,list,prot))
                        display_detail_conn(vnode, topFormName);
                    break;
                case AUTH_TBL:
/* # line 564 "numain.sc" */	/* getrow */
        {
          if (IItbsetio(2,topFormName,(char *)"authtable",-2) != 0) {
            IItcogetio((short *)0,1,32,MAX_TXT-1,login,(char *)"login");
            IItcogetio((short *)0,1,32,MAX_TXT-1,privglob,(char *)"typ\
...
/* # line 566 "numain.sc" */	/* host code */
	...
	if( vnode_rows > 0 )
	{
/* # line 579 "numain.sc" */	/* inquire_frs */
        {
          if (IIiqset(3,0,topFormName,(char *)0, (char *)0) != 0) {
            IIiqfsio((short *)0,1,30,4,&cnt,31,(char *)"nodetable",0);
          } /* IIiqset */
        }
/* # line 580 "numain.sc" */	/* inquire_frs */
        {
          if (IIiqset(3,0,topFormName,(char *)0, (char *)0) != 0) {
            IIiqfsio((short *)0,1,30,4,&row_no,29,(char *)"nodetable",0);
          } /* IIiqset */
        }
/* # line 581 "numain.sc" */	/* getrow */
        {
          if (IItbsetio(2,topFormName,(char *)"nodetable",-2) != 0) {
            IItcogetio((short *)0,1,30,4,&nodet_row,(char *)"_record");
            IITBceColEnd();
          } /* IItbsetio */
        }
/* # line 582 "numain.sc" */	/* host code */
...
/* # line 607 "numain.sc" */	/* breakdisplay */
        {
          if (1) goto IIfdE1;
        }
      } else if (IIretval() == 9) {
/* # line 612 "numain.sc" */	/* host code */
        whichtable = NODE_TBL;  
	/* Activate the follwing menu items back on the node_table */
/* # line 615 "numain.sc" */	/* set_frs */
        {
          if (IIiqset(7,0,(char *)"",(char *)0, (char *)0) != 0) {
...
/* # line 618 "numain.sc" */	/* host code */
	if (vnode_rows > 0)     
	{
/* # line 620 "numain.sc" */	/* getrow */
        {
          if (IItbsetio(2,topFormName,(char *)"nodetable",-2) != 0) {
            IItcogetio((short *)0,1,32,MAX_TXT-1,new_vnode,(char *)"na\
me");
            IItcogetio((short *)0,1,30,4,&nodet_row,(char *)"_record");
            IITBceColEnd();
          } /* IItbsetio */
        }
/* # line 623 "numain.sc" */	/* host code */
	...
	else
	{
	    autht_row = connt_row = 1;
	    STcopy(ERx("''"), emptymsg);
/* # line 634 "numain.sc" */	/* putform */
        {
          if (IIfsetio(topFormName) != 0) {
            IIputfldio((char *)"auth_vnode",(short *)0,1,32,0,emptymsg);
            IIputfldio((char *)"conn_vnode",(short *)0,1,32,0,emptymsg);
          } /* IIfsetio */
        }
/* # line 636 "numain.sc" */	/* inittable */
        {
          if (IItbinit(topFormName,(char *)"authtable",(char *)"r") != 0) {
            IItfill();
          } /* IItbinit */
        }
/* # line 637 "numain.sc" */	/* inittable */
        {
          if (IItbinit(topFormName,(char *)"conntable",(char *)"r") != 0) {
            IItfill();
          } /* IItbinit */
        }
/* # line 638 "numain.sc" */	/* host code */
	}
/* # line 639 "numain.sc" */	/* set_frs */
        {
          if (IIiqset(7,0,(char *)"",(char *)0, (char *)0) != 0) {
...
/* # line 640 "numain.sc" */	/* set_frs */
        {
          if (IIiqset(7,0,(char *)"",(char *)0, (char *)0) != 0) {
            IIstfsio(67,ERget(FE_Attributes),0,(short *)0,1,30,sizeof(1),
            (void *)IILQint(1));
          } /* IIiqset */
        }
      } else if (IIretval() == 10) {
/* # line 645 "numain.sc" */	/* host code */
        whichtable = AUTH_TBL;
/* # line 646 "numain.sc" */	/* scroll */
        {
          if (IItbsetio(1,topFormName,(char *)"nodetable",-3) != 0) {
            IItbsmode((char *)"to");
            if (IItscroll(0,nodet_row) != 0) {
            } /* IItscroll */
          } /* IItbsetio */
        }
/* # line 647 "numain.sc" */	/* host code */
	if (auth_rows > 1)
/* # line 648 "numain.sc" */	/* getrow */
        {
          if (IItbsetio(2,topFormName,(char *)"authtable",-2) != 0) {
            IItcogetio((short *)0,1,30,4,&autht_row,(char *)"_record");
            IITBceColEnd();
          } /* IItbsetio */
        }
/* # line 649 "numain.sc" */	/* host code */
	else
	    autht_row = 1;
/* # line 652 "numain.sc" */	/* set_frs */
        {
          if (IIiqset(7,0,(char *)"",(char *)0, (char *)0) != 0) {
...
/* # line 653 "numain.sc" */	/* set_frs */
        {
          if (IIiqset(7,0,(char *)"",(char *)0, (char *)0) != 0) {
            IIstfsio(67,ERget(FE_Attributes),0,(short *)0,1,30,sizeof(0),
            (void *)IILQint(0));
          } /* IIiqset */
        }
      } else if (IIretval() == 11) {
/* # line 658 "numain.sc" */	/* host code */
        whichtable = CONN_TBL;
/* # line 659 "numain.sc" */	/* scroll */
        {
          if (IItbsetio(1,topFormName,(char *)"nodetable",-3) != 0) {
            IItbsmode((char *)"to");
            if (IItscroll(0,nodet_row) != 0) {
...
/* # line 660 "numain.sc" */	/* host code */
	if (conn_rows > 1)
/* # line 661 "numain.sc" */	/* getrow */
        {
          if (IItbsetio(2,topFormName,(char *)"conntable",-2) != 0) {
            IItcogetio((short *)0,1,30,4,&connt_row,(char *)"_record");
            IITBceColEnd();
          } /* IItbsetio */
        }
/* # line 662 "numain.sc" */	/* host code */
	else
	    connt_row = 1;
/* # line 665 "numain.sc" */	/* set_frs */
        {
          if (IIiqset(7,0,(char *)"",(char *)0, (char *)0) != 0) {
            IIstfsio(67,ERget(FE_Test),0,(short *)0,1,30,sizeof(0),
            (void *)IILQint(0));
...
/* # line 671 "numain.sc" */	/* host code */
        whichtable = ATTR_TBL;
/* # line 672 "numain.sc" */	/* scroll */
        {
          if (IItbsetio(1,topFormName,(char *)"nodetable",-3) != 0) {
            IItbsmode((char *)"to");
            if (IItscroll(0,nodet_row) != 0) {
...
/* # line 673 "numain.sc" */	/* host code */
	if (attrib_rows > 1)
/* # line 674 "numain.sc" */	/* getrow */
        {
          if (IItbsetio(2,topFormName,(char *)"attribtable",-2) != 0) {
            IItcogetio((short *)0,1,30,4,&attrib_row,(char *)"_record");
            IITBceColEnd();
          } /* IItbsetio */
        }
/* # line 675 "numain.sc" */	/* host code */
	else
	    connt_row = 1;
/* # line 678 "numain.sc" */	/* set_frs */
        {
          if (IIiqset(7,0,(char *)"",(char *)0, (char *)0) != 0) {
            IIstfsio(67,ERget(FE_Test),0,(short *)0,1,30,sizeof(0),
            (void *)IILQint(0));
...
IImuI1:
    ...
    if (IInmuact(ERget(FE_Attributes),(char *)0,2,0,4) == 0) goto IIfdE1;
    if (IInmuact(ERget(FE_Test),(char *)0,2,0,5) == 0) goto IIfdE1;
    if (IInmuact(control_menuitem,(char *)0,2,2,6) == 0) goto IIfdE1;
    ...
    if (IITBcaClmAct((char *)"nodetable",(char *)"all",1,9) == 0) goto IIfdE1;
    if (IITBcaClmAct((char *)"authtable",(char *)"all",1,10) == 0) goto IIfdE1;
    if (IITBcaClmAct((char *)"conntable",(char *)"all",1,11) == 0) goto IIfdE1;
    if (IITBcaClmAct((char *)"attribtable",(char *)"all",1,12) == 0) goto 
    IIfdE1;
...
**  Beginning of display loop.
*/
/* # line 732 "numain.sc" */	/* display */
  {
    if (IIdispfrm(controlFormName,(char *)"f") == 0) goto IIfdE2;
    goto IImuI2;
IIfdI2:;
    if (IIfsetio((char *)0) == 0) goto IIfdE2;
/* # line 736 "numain.sc" */	/* host code */
	adjust_control_menu();  /* Set "...All" items active or inactive. */
IIfdB2:
    while (IIrunform() != 0) {
      if (IIretval() == 1) {
/* # line 741 "numain.sc" */	/* getrow */
        {
          if (IItbsetio(2,controlFormName,(char *)"svr_tbl",-2) != 0) {
            IItcogetio((short *)0,1,32,MAX_TXT-1,csid,(char *)"svr_id");
            IItcogetio((short *)0,1,32,MAX_TXT-1,type,(char *)"svr_typ\
e");
            IITBceColEnd();
          } /* IItbsetio */
        }
/* # line 743 "numain.sc" */	/* host code */
	if (shutdown_svr( TRUE, csid ))
	{
/* # line 745 "numain.sc" */	/* deleterow */
        {
          if (IItbsetio(4,controlFormName,(char *)"svr_tbl",-2) != 0) {
            if (IItdelrow(0) != 0) {
            } /* IItdelrow */
          } /* IItbsetio */
        }
/* # line 746 "numain.sc" */	/* host code */
	    if (!adjust_control_menu())
/* # line 747 "numain.sc" */	/* breakdisplay */
        {
          if (1) goto IIfdE2;
        }
/* # line 748 "numain.sc" */	/* host code */
	}
      } else if (IIretval() == 2) {
	if (shutdown_svr(TRUE, NULL ))
	{
            ...
            for (i=1; i <= svr_cnt; i++)
            {
/* # line 759 "numain.sc" */	/* getrow */
        {
          if (IItbsetio(2,controlFormName,(char *)"svr_tbl",1) != 0) {
            IItcogetio((short *)0,1,32,MAX_TXT-1,csid,(char *)"svr_id");
            IItcogetio((short *)0,1,32,MAX_TXT-1,type,(char *)"svr_typ\
e");
            IITBceColEnd();
...
/* # line 761 "numain.sc" */	/* host code */
                   if (OK == nu_shutdown( TRUE, csid ))
                   {
/* # line 763 "numain.sc" */	/* deleterow */
        {
          if (IItbsetio(4,controlFormName,(char *)"svr_tbl",1) != 0) {
            if (IItdelrow(0) != 0) {
            } /* IItdelrow */
          } /* IItbsetio */
        }
/* # line 764 "numain.sc" */	/* host code */
                      adjust_control_menu();
                   }
            }
/* # line 767 "numain.sc" */	/* breakdisplay */
        {
          if (1) goto IIfdE2;
        }
/* # line 768 "numain.sc" */	/* host code */
        }
/* # line 769 "numain.sc" */	/* resume */
        {
          IIresnext();
          if (1) goto IIfdB2;
        }
      } else if (IIretval() == 3) {
/* # line 774 "numain.sc" */	/* getrow */
        {
          if (IItbsetio(2,controlFormName,(char *)"svr_tbl",-2) != 0) {
            IItcogetio((short *)0,1,32,MAX_TXT-1,csid,(char *)"svr_id");
            IItcogetio((short *)0,1,32,MAX_TXT-1,type,(char *)"svr_typ\
...
/* # line 776 "numain.sc" */	/* host code */
	if (shutdown_svr(FALSE, csid ))
	{
/* # line 778 "numain.sc" */	/* deleterow */
        {
          if (IItbsetio(4,controlFormName,(char *)"svr_tbl",-2) != 0) {
            if (IItdelrow(0) != 0) {
            } /* IItdelrow */
...
/* # line 779 "numain.sc" */	/* host code */
	    if (!adjust_control_menu())
/* # line 780 "numain.sc" */	/* breakdisplay */
        {
          if (1) goto IIfdE2;
        }
/* # line 781 "numain.sc" */	/* host code */
	}
      } else if (IIretval() == 4) {
...
/* # line 793 "numain.sc" */	/* host code */
		if( ! STcompare(GCA_COMSVR_CLASS, type ) )
		{
                    if (OK == nu_shutdown( TRUE, csid ))
                    {
/* # line 797 "numain.sc" */	/* deleterow */
        {
          if (IItbsetio(4,controlFormName,(char *)"svr_tbl",1) != 0) {
            if (IItdelrow(0) != 0) {
            } /* IItdelrow */
...
/* # line 798 "numain.sc" */	/* host code */
                        adjust_control_menu();
                    }
		}
            }
/* # line 802 "numain.sc" */	/* breakdisplay */
        {
          if (1) goto IIfdE2;
        }
/* # line 803 "numain.sc" */	/* host code */
        }
/* # line 804 "numain.sc" */	/* resume */
        {
          IIresnext();
          if (1) goto IIfdB2;
        }
      } else if (IIretval() == 5) {
/* # line 809 "numain.sc" */	/* host code */
	FEhelp(ERx("nucomsvr.hlp"), msg); 
      } else if (IIretval() == 6) {
/* # line 814 "numain.sc" */	/* breakdisplay */
        {
          if (1) goto IIfdE2;
        }
      } else {
...
IImuI2:
    ...
    if (IInmuact(ERget(F_ST0043_quiesce_menuitem),(char *)0,2,2,1) == 0) goto 
    IIfdE2;
    if (IInmuact(ERget(F_ST0044_quiesce_all_menuitem),(char *)0,2,2,2) == 0) 
    goto IIfdE2;
    if (IInmuact(ERget(F_ST0045_stop_menuitem),(char *)0,2,2,3) == 0) goto 
    IIfdE2;
    if (IInmuact(ERget(F_ST0046_stop_all_menuitem),(char *)0,2,2,4) == 0) 
    goto IIfdE2;
...
{
  i4 cnt, act;
/* # line 830 "numain.sc" */	/* inquire_frs */
  {
    if (IIiqset(3,0,controlFormName,(char *)0, (char *)0) != 0) {
      IIiqfsio((short *)0,1,30,4,&cnt,31,(char *)"svr_tbl",0);
    } /* IIiqset */
  }
/* # line 832 "numain.sc" */	/* host code */
    if (cnt)
    {
	act = (cnt > 1);
/* # line 836 "numain.sc" */	/* set_frs */
  {
    if (IIiqset(7,0,controlFormName,(char *)0, (char *)0) != 0) {
      IIstfsio(67,ERget(F_ST0046_stop_all_menuitem),0,(short *)0,1,30,4,&act);
    } /* IIiqset */
  }
/* # line 838 "numain.sc" */	/* set_frs */
  {
    if (IIiqset(7,0,controlFormName,(char *)0, (char *)0) != 0) {
      IIstfsio(67,ERget(F_ST0044_quiesce_all_menuitem),0,(short *)0,1,30,4,&
      act);
    } /* IIiqset */
  }
/* # line 840 "numain.sc" */	/* host code */
    }
    return cnt;
}
/*
...
/* # line 913 "numain.sc" */	/* putform */
  {
    if (IIfsetio(form) != 0) {
      IIputfldio((char *)"auth_vnode",(short *)0,1,32,0,msg);
      IIputfldio((char *)"conn_vnode",(short *)0,1,32,0,msg);
    } /* IIfsetio */
  }
/* # line 914 "numain.sc" */	/* host code */
    }
/* # line 915 "numain.sc" */	/* inittable */
  {
    if (IItbinit(form,(char *)"authtable",(char *)"r") != 0) {
      IItfill();
    } /* IItbinit */
  }
/* # line 916 "numain.sc" */	/* host code */
...
/* # line 924 "numain.sc" */	/* loadtable */
  {
    if (IItbact(form,(char *)"authtable",1) != 0) {
      IItcoputio((char *)"login",(short *)0,1,32,0,glogin);
      IItcoputio((char *)"type",(short *)0,1,32,0,global_word);
      IItcoputio((char *)"scope",(short *)0,1,32,0,msg);
      IITBceColEnd();
    } /* IItbact */
  }
/* # line 926 "numain.sc" */	/* host code */
	auth_rows++;
    }
    if (plogin != NULL)   /* Is there a private login? */
    {
	STprintf(msg,ERget(S_ST0006_user_only),uid);
/* # line 932 "numain.sc" */	/* loadtable */
  {
    if (IItbact(form,(char *)"authtable",1) != 0) {
      IItcoputio((char *)"login",(short *)0,1,32,0,plogin);
      IItcoputio((char *)"type",(short *)0,1,32,0,private_word);
      IItcoputio((char *)"scope",(short *)0,1,32,0,msg);
      IITBceColEnd();
    } /* IItbact */
  }
/* # line 934 "numain.sc" */	/* host code */
	auth_rows++;
    }
    /* Leave the cursor where it was... */
/* # line 938 "numain.sc" */	/* scroll */
  {
    if (IItbsetio(1,form,(char *)"authtable",-3) != 0) {
      IItbsmode((char *)"to");
      if (IItscroll(0,autht_row) != 0) {
      } /* IItscroll */
    } /* IItbsetio */
  }
/* # line 939 "numain.sc" */	/* host code */
}
/*
**  display_detail_conn()
**
...
display_detail_conn(char *vnode, char *formname)
{
  ...
  char *form;
    ...
    bool flag;
    form = formname;
/* # line 963 "numain.sc" */	/* inittable */
  {
    if (IItbinit(form,(char *)"conntable",(char *)"r") != 0) {
      IItfill();
    } /* IItbinit */
  }
/* # line 965 "numain.sc" */	/* host code */
...
/* # line 970 "numain.sc" */	/* loadtable */
  {
    if (IItbact(form,(char *)"conntable",1) != 0) {
      IItcoputio((char *)"connt_address",(short *)0,1,32,0,address);
      IItcoputio((char *)"connt_type",(short *)0,1,32,0,type);
      IItcoputio((char *)"connt_protocol",(short *)0,1,32,0,protocol);
      IItcoputio((char *)"connt_listen",(short *)0,1,32,0,listen);
      IITBceColEnd();
    } /* IItbact */
  }
/* # line 975 "numain.sc" */	/* host code */
    }
    /* Leave the cursor where it was... */
/* # line 978 "numain.sc" */	/* scroll */
  {
    if (IItbsetio(1,form,(char *)"conntable",-3) != 0) {
      IItbsmode((char *)"to");
      if (IItscroll(0,connt_row) != 0) {
      } /* IItscroll */
    } /* IItbsetio */
  }
/* # line 979 "numain.sc" */	/* host code */
}
/*
...
display_detail_attr( char *vnode, char *formname )
{
  ...
  char *attr_name, *attr_value;
    i4  	private;
    bool 	flag;
/* # line 1013 "numain.sc" */	/* inittable */
  {
    if (IItbinit(form,(char *)"attribtable",(char *)"r") != 0) {
      IItfill();
    } /* IItbinit */
  }
/* # line 1015 "numain.sc" */	/* host code */
    ...
    {
	type = private==1? private_word: global_word;
/* # line 1020 "numain.sc" */	/* loadtable */
  {
    if (IItbact(form,(char *)"attribtable",1) != 0) {
      IItcoputio((char *)"type",(short *)0,1,32,0,type);
      IItcoputio((char *)"name",(short *)0,1,32,0,attr_name);
      IItcoputio((char *)"value",(short *)0,1,32,0,attr_value);
      IITBceColEnd();
    } /* IItbact */
  }
/* # line 1024 "numain.sc" */	/* host code */
    }
    /* Leave the cursor where it was... */
/* # line 1027 "numain.sc" */	/* scroll */
  {
    if (IItbsetio(1,form,(char *)"attribtable",-3) != 0) {
      IItbsmode((char *)"to");
      if (IItscroll(0,attrib_row) != 0) {
      } /* IItscroll */
    } /* IItbsetio */
  }
/* # line 1029 "numain.sc" */	/* host code */
}
/*
**  get_node_name()
**
...
edit_vnode(char *vnode, char *new_vnode)
{
  ...
  char lis[128];
    ...
    /* Grab all login information, and note whether there's a global
       login entry.  */
/* # line 1135 "numain.sc" */	/* unloadtable */
  {
    if (IItbact(topFormName,(char *)"authtable",0) == 0) goto IItbE1;
    while (IItunload() != 0) {
      IItcogetio((short *)0,1,32,MAX_TXT-1,log,(char *)"login");
      IItcogetio((short *)0,1,32,MAX_TXT-1,typ,(char *)"type");
      IITBceColEnd();
/* # line 1137 "numain.sc" */	/* host code */
	if (OK != (rtn = nu_authedit(AUTH_EDITPW, vnode, log, gpassw, typ)))
/* # line 1138 "numain.sc" */	/* endloop */
      {
        if (1) goto IItbE1;
      }
/* # line 1139 "numain.sc" */	/* host code */
...
/* # line 1150 "numain.sc" */	/* unloadtable */
  {
    if (IItbact(topFormName,(char *)"authtable",0) == 0) goto IItbE2;
    while (IItunload() != 0) {
      IItcogetio((short *)0,1,32,MAX_TXT-1,log,(char *)"login");
      IItcogetio((short *)0,1,32,MAX_TXT-1,typ,(char *)"type");
      IITBceColEnd();
/* # line 1152 "numain.sc" */	/* host code */
    {
	bool priv = nu_is_private(typ);
	if (OK == (rtn = nv_del_auth(priv, vnode, log)))
	    rtn = nv_add_auth(priv, new_vnode, log, priv? ppassw: gpassw);
	if (rtn != OK)
/* # line 1157 "numain.sc" */	/* endloop */
      {
        if (1) goto IItbE2;
      }
/* # line 1158 "numain.sc" */	/* host code */
    }
    } /* IItunload */
IItbE2:
    IItunend();
...
/* # line 1169 "numain.sc" */	/* unloadtable */
  {
    if (IItbact(topFormName,(char *)"conntable",0) == 0) goto IItbE3;
    while (IItunload() != 0) {
      IItcogetio((short *)0,1,32,MAX_TXT-1,typ,(char *)"connt_type");
      IItcogetio((short *)0,1,32,MAX_TXT-1,pro,(char *)"connt_protocol");
      IItcogetio((short *)0,1,32,MAX_TXT-1,adr,(char *)"connt_address");
      IItcogetio((short *)0,1,32,127,lis,(char *)"connt_listen");
      IITBceColEnd();
/* # line 1173 "numain.sc" */	/* host code */
    {
	bool priv = nu_is_private(typ);
	if (OK == (rtn = nv_del_node(priv, vnode, pro, adr, lis)))
	    rtn = nv_merge_node(priv, new_vnode, pro, adr, lis);
	if (rtn != OK)
/* # line 1178 "numain.sc" */	/* endloop */
      {
        if (1) goto IItbE3;
      }
/* # line 1179 "numain.sc" */	/* host code */
    }
    } /* IItunload */
IItbE3:
    IItunend();
...
/* # line 1226 "numain.sc" */	/* unloadtable */
  {
    if (IItbact(form,(char *)"authtable",0) == 0) goto IItbE4;
    while (IItunload() != 0) {
      IItcogetio((short *)0,1,32,MAX_TXT-1,type,(char *)"type");
      IItcogetio((short *)0,1,32,MAX_TXT-1,login,(char *)"login");
      IITBceColEnd();
/* # line 1228 "numain.sc" */	/* host code */
   	if (*login != EOS)
   	{
    	    if (OK != (rtn = nv_del_auth(nu_is_private(type), vnode, login)))
    	    {
	   	IIUGerr(rtn, 0, 0);
/* # line 1233 "numain.sc" */	/* endloop */
      {
        if (1) goto IItbE4;
      }
/* # line 1234 "numain.sc" */	/* host code */
	    }
	}
    } /* IItunload */
IItbE4:
...
/* # line 1243 "numain.sc" */	/* unloadtable */
  {
    if (IItbact(form,(char *)"attribtable",0) == 0) goto IItbE5;
    while (IItunload() != 0) {
      IItcogetio((short *)0,1,32,MAX_TXT-1,type,(char *)"type");
      IItcogetio((short *)0,1,32,0,attr_name,(char *)"name");
      IItcogetio((short *)0,1,32,0,attr_value,(char *)"value");
      IITBceColEnd();
/* # line 1246 "numain.sc" */	/* host code */
	if ( OK != 
	     	(rtn = nv_del_attr( nu_is_private(type), vnode, attr_name,
							attr_value ) ) )
	    {
	    	IIUGerr(rtn, 0, 0);
/* # line 1251 "numain.sc" */	/* endloop */
      {
        if (1) goto IItbE5;
      }
/* # line 1252 "numain.sc" */	/* host code */
	    }
    } /* IItunload */
IItbE5:
    IItunend();
...
/* # line 1259 "numain.sc" */	/* unloadtable */
  {
    if (IItbact(form,(char *)"conntable",0) == 0) goto IItbE6;
    while (IItunload() != 0) {
      IItcogetio((short *)0,1,32,MAX_TXT-1,type,(char *)"connt_type");
      IItcogetio((short *)0,1,32,MAX_TXT-1,prot,(char *)"connt_protoco\
l");
      IItcogetio((short *)0,1,32,MAX_TXT-1,addr,(char *)"connt_address");
      IItcogetio((short *)0,1,32,MAX_TXT-1,list,(char *)"connt_listen");
      IITBceColEnd();
/* # line 1263 "numain.sc" */	/* host code */
	if ( OK != (rtn = nv_del_node(nu_is_private(type),
				vnode, prot, addr, list)) )
	{
	    IIUGerr(rtn, 0, 0);
/* # line 1267 "numain.sc" */	/* endloop */
      {
        if (1) goto IItbE6;
      }
/* # line 1268 "numain.sc" */	/* host code */
	}
    } /* IItunload */
IItbE6:
    IItunend();
...
/* # line 1408 "numain.sc" */	/* unloadtable */
  {
    if (IItbact(topFormName,(char *)"authtable",0) == 0) goto IItbE7;
    while (IItunload() != 0) {
      IItcogetio((short *)0,1,32,MAX_TXT-1,temptype,(char *)"type");
      IITBceColEnd();
/* # line 1410 "numain.sc" */	/* host code */
...
display_vnode_list(char *selected_vnode, char *formname )
{
  ...
  char *form;
        form = formname; 
/* # line 1663 "numain.sc" */	/* inittable */
  {
    if (IItbinit(form,(char *)"nodetable",(char *)"r") != 0) {
      IItfill();
    } /* IItbinit */
  }
/* # line 1664 "numain.sc" */	/* host code */
        for ( flag=TRUE, vnode_rows=0; 
	      NULL != (vnode_name = nu_vnode_list(flag)); 
	      flag=FALSE, vnode_rows++ )
	{
/* # line 1668 "numain.sc" */	/* loadtable */
  {
    if (IItbact(form,(char *)"nodetable",1) != 0) {
      IItcoputio((char *)"name",(short *)0,1,32,0,vnode_name);
      IITBceColEnd();
    } /* IItbact */
  }
/* # line 1669 "numain.sc" */	/* host code */
...
/* # line 1676 "numain.sc" */	/* scroll */
  {
    if (IItbsetio(1,form,(char *)"nodetable",-3) != 0) {
      IItbsmode((char *)"to");
      if (IItscroll(0,nodet_row) != 0) {
      } /* IItscroll */
    } /* IItbsetio */
  }
/* # line 1677 "numain.sc" */	/* host code */
}
/*
...
display_svr_list()
{
  ...
  char comsvr[6];
  char brgsvr[6];
/* # line 1695 "numain.sc" */	/* inittable */
  {
    if (IItbinit(controlFormName,(char *)"svr_tbl",(char *)"r") != 0) {
      IItfill();
    } /* IItbinit */
  }
/* # line 1697 "numain.sc" */	/* host code */
    ...
    {
	STtrmwhite(svrnam);
/* # line 1704 "numain.sc" */	/* loadtable */
  {
    if (IItbact(controlFormName,(char *)"svr_tbl",1) != 0) {
      IItcoputio((char *)"svr_id",(short *)0,1,32,0,svrnam);
      IItcoputio((char *)"svr_type",(short *)0,1,32,0,comsvr);
      IITBceColEnd();
    } /* IItbact */
  }
/* # line 1706 "numain.sc" */	/* host code */
    }
    ...
    {
	STtrmwhite(svrnam);
/* # line 1713 "numain.sc" */	/* loadtable */
  {
    if (IItbact(controlFormName,(char *)"svr_tbl",1) != 0) {
      IItcoputio((char *)"svr_id",(short *)0,1,32,0,svrnam);
      IItcoputio((char *)"svr_type",(short *)0,1,32,0,brgsvr);
      IITBceColEnd();
    } /* IItbact */
  }
/* # line 1715 "numain.sc" */	/* host code */
    }
    if( !  n_comm_svr ) 
        if( ! n_brdg_svr )
	  return FAIL;
/* # line 1721 "numain.sc" */	/* scroll */
  {
    if (IItbsetio(1,controlFormName,(char *)"svr_tbl",-3) != 0) {
      IItbsmode((char *)"to");
      if (IItscroll(0,1) != 0) {
      } /* IItscroll */
    } /* IItbsetio */
  }
/* # line 1722 "numain.sc" */	/* host code */
    return OK;
}
/*
**  enough_rows() 
...
**  Beginning of display loop.
*/
/* # line 1927 "numain.sc" */	/* display */
  {
    if (IIdispfrm((char *)"attribform",(char *)"f") == 0) goto IIfdE3;
    goto IImuI3;
IIfdI3:;
    if (IIfsetio((char *)0) == 0) goto IIfdE3;
/* # line 1930 "numain.sc" */	/* host code */
	{
    char userinfo_txt[MAX_TXT];
	    STprintf( userinfo_txt, "%s: %s", 
		ERget( S_ST0037_user_tag ), username );
/* # line 1937 "numain.sc" */	/* putform */
    {
      if (IIfsetio((char *)"attribform") != 0) {
        IIputfldio((char *)"userinfo",(short *)0,1,32,0,userinfo_txt);
      } /* IIfsetio */
    }
/* # line 1939 "numain.sc" */	/* host code */
	    /* Maintain the scroll position when you go from
	    ** loginform to attribform.
	    */
/* # line 1942 "numain.sc" */	/* scroll */
    {
      if (IItbsetio(1,(char *)"attribform",(char *)"nodetable",-3) != 0) {
        IItbsmode((char *)"to");
        if (IItscroll(0,nodet_offset) != 0) {
        } /* IItscroll */
      } /* IItbsetio */
    }
/* # line 1943 "numain.sc" */	/* scroll */
    {
      if (IItbsetio(1,(char *)"attribform",(char *)"nodetable",-3) != 0) {
        IItbsmode((char *)"to");
        if (IItscroll(0,nodet_row) != 0) {
...
/* # line 1945 "numain.sc" */	/* host code */
	    if ( hostname == NULL )
	    {
/* # line 1947 "numain.sc" */	/* set_frs */
    {
      if (IIiqset(2,0,(char *)"attribform",(char *)0, (char *)0) != 0) {
        IIstfsio(54,(char *)"remote_host_name",0,(short *)0,1,30,sizeof(1),
        (void *)IILQint(1));
      } /* IIiqset */
    }
/* # line 1949 "numain.sc" */	/* host code */
	    }
	    else
	    {
/* # line 1952 "numain.sc" */	/* putform */
    {
      if (IIfsetio((char *)"attribform") != 0) {
        IIputfldio((char *)"remote_host_name",(short *)0,1,32,0,hostname);
      } /* IIfsetio */
    }
/* # line 1953 "numain.sc" */	/* set_frs */
    {
      if (IIiqset(2,0,(char *)"attribform",(char *)0, (char *)0) != 0) {
        IIstfsio(54,(char *)"remote_host_name",0,(short *)0,1,30,sizeof(0),
        (void *)IILQint(0));
      ...
      if (IIretval() == 1) {
        ...
        if ( enough_rows() )   
			...
			/* Update loginform also . */
                    ...
                    break;
                case CONN_TBL:
/* # line 2030 "numain.sc" */	/* getrow */
        {
          if (IItbsetio(2,(char *)"attribform",(char *)"conntable",-2) != 0) 
          {
            IItcogetio((short *)0,1,32,MAX_TXT-1,type,(char *)"connt_t\
ype");
            IItcogetio((short *)0,1,32,MAX_TXT-1,prot,(char *)
...
/* # line 2034 "numain.sc" */	/* host code */
			...
			/* Update loginform also . */
                    ...
                    break;
                case ATTR_TBL:
/* # line 2049 "numain.sc" */	/* getrow */
        {
          if (IItbsetio(2,(char *)"attribform",(char *)"attribtable",-2) != 0
          ) {
            IItcogetio((short *)0,1,32,MAX_TXT-1,privglob,(char *)"typ\
e");
            IItcogetio((short *)0,1,32,0,attr_name,(char *)"name");
...
/* # line 2105 "numain.sc" */	/* host code */
	...
	if( vnode_rows > 0 )
	{
/* # line 2122 "numain.sc" */	/* inquire_frs */
        {
          if (IIiqset(3,0,(char *)"attribform",(char *)0, (char *)0) != 0) {
            IIiqfsio((short *)0,1,30,4,&cnt,31,(char *)"nodetable",0);
          } /* IIiqset */
        }
/* # line 2123 "numain.sc" */	/* inquire_frs */
        {
          if (IIiqset(3,0,(char *)"attribform",(char *)0, (char *)0) != 0) {
            IIiqfsio((short *)0,1,30,4,&row_no,29,(char *)"nodetable",0);
          } /* IIiqset */
        }
/* # line 2124 "numain.sc" */	/* getrow */
        {
          if (IItbsetio(2,(char *)"attribform",(char *)"nodetable",-2) != 0) 
          {
            IItcogetio((short *)0,1,30,4,&nodet_row,(char *)"_record");
            IITBceColEnd();
          } /* IItbsetio */
        }
/* # line 2125 "numain.sc" */	/* host code */
	    nodet_offset = nodet_row + ( cnt - row_no );
/* # line 2126 "numain.sc" */	/* scroll */
        {
          if (IItbsetio(1,topFormName,(char *)"nodetable",-3) != 0) {
            IItbsmode((char *)"to");
            if (IItscroll(0,nodet_offset) != 0) {
...
/* # line 2128 "numain.sc" */	/* host code */
	}
/* # line 2129 "numain.sc" */	/* breakdisplay */
        {
          if (1) goto IIfdE3;
        }
      } else if (IIretval() == 5) {
/* # line 2134 "numain.sc" */	/* host code */
	if ( !vnode_rows )
	    IIUGerr( E_ST0018_no_vnode_rows, 0, 0 );
	else
	    test_connection( vnode );
...
/* # line 2152 "numain.sc" */	/* clear */
        {
          IIclrscr();
        }
/* # line 2153 "numain.sc" */	/* host code */
    	FEendforms();
	PCexit(OK);
      } else if (IIretval() == 9) {
        whichtable = NODE_TBL;   
	/* Activate the following menu items back on the node_table */
/* # line 2162 "numain.sc" */	/* set_frs */
        {
          if (IIiqset(7,0,(char *)"",(char *)0, (char *)0) != 0) {
            IIstfsio(67,ERget(FE_Create),0,(short *)0,1,30,sizeof(1),
            (void *)IILQint(1));
...
/* # line 2165 "numain.sc" */	/* host code */
	if ( vnode_rows > 0 )     
	{
   	    char 	msg[ MAX_TXT+3 ];
/* # line 2168 "numain.sc" */	/* getrow */
        {
          if (IItbsetio(2,(char *)"attribform",(char *)"nodetable",-2) != 0) 
          {
            IItcogetio((short *)0,1,32,MAX_TXT-1,new_vnode,(char *)"na\
...
/* # line 2170 "numain.sc" */	/* host code */
	    ...
	    STpolycat( 3, ERx("'"), vnode, ERx("'"), msg );
/* # line 2176 "numain.sc" */	/* putform */
        {
          if (IIfsetio((char *)"attribform") != 0) {
            IIputfldio((char *)"attr_connvnode",(short *)0,1,32,0,msg);
            IIputfldio((char *)"attr_vnode",(short *)0,1,32,0,msg);
          } /* IIfsetio */
        }
/* # line 2178 "numain.sc" */	/* host code */
	...
	else
	{
	    connt_row = attrib_row = 1;
	    STcopy( ERx("''"), emptymsg );
/* # line 2184 "numain.sc" */	/* putform */
        {
          if (IIfsetio((char *)"attribform") != 0) {
            IIputfldio((char *)"attr_connvnode",(short *)0,1,32,0,emptymsg);
            IIputfldio((char *)"attr_vnode",(short *)0,1,32,0,emptymsg);
          } /* IIfsetio */
        }
/* # line 2186 "numain.sc" */	/* inittable */
        {
          if (IItbinit((char *)"attribform",(char *)"conntable",(char *)"\
r") != 0) {
            IItfill();
          } /* IItbinit */
        }
/* # line 2187 "numain.sc" */	/* inittable */
        {
          if (IItbinit((char *)"attribform",(char *)"attribtable",(char *)"\
r") != 0) {
            IItfill();
          } /* IItbinit */
        }
/* # line 2188 "numain.sc" */	/* host code */
	}
/* # line 2189 "numain.sc" */	/* set_frs */
        {
          if (IIiqset(7,0,(char *)"",(char *)0, (char *)0) != 0) {
            IIstfsio(67,ERget( FE_Test ),0,(short *)0,1,30,sizeof(1),
            (void *)IILQint(1));
...
/* # line 2190 "numain.sc" */	/* set_frs */
        {
          if (IIiqset(7,0,(char *)"",(char *)0, (char *)0) != 0) {
            IIstfsio(67,ERget( FE_Login ),0,(short *)0,1,30,sizeof(1),
            (void *)IILQint(1));
          } /* IIiqset */
        }
      } else if (IIretval() == 10) {
/* # line 2195 "numain.sc" */	/* host code */
        whichtable = ATTR_TBL;
/* # line 2196 "numain.sc" */	/* scroll */
        {
          if (IItbsetio(1,(char *)"attribform",(char *)"nodetable",-3) != 0) 
          {
            IItbsmode((char *)"to");
...
/* # line 2197 "numain.sc" */	/* host code */
	if ( attrib_rows > 1 )
/* # line 2198 "numain.sc" */	/* getrow */
        {
          if (IItbsetio(2,(char *)"attribform",(char *)"attribtable",-2) != 0
          ) {
            IItcogetio((short *)0,1,30,4,&attrib_row,(char *)"_record");
...
/* # line 2199 "numain.sc" */	/* host code */
	else
	    attrib_row = 1;
/* # line 2201 "numain.sc" */	/* set_frs */
        {
          if (IIiqset(7,0,(char *)"",(char *)0, (char *)0) != 0) {
            IIstfsio(67,ERget( FE_Test ),0,(short *)0,1,30,sizeof(0),
            (void *)IILQint(0));
...
/* # line 2202 "numain.sc" */	/* set_frs */
        {
          if (IIiqset(7,0,(char *)"",(char *)0, (char *)0) != 0) {
            IIstfsio(67,ERget( FE_Login),0,(short *)0,1,30,sizeof(0),
            (void *)IILQint(0));
          } /* IIiqset */
        }
      } else if (IIretval() == 11) {
/* # line 2207 "numain.sc" */	/* host code */
        whichtable = CONN_TBL;
/* # line 2208 "numain.sc" */	/* scroll */
        {
          if (IItbsetio(1,(char *)"attribform",(char *)"nodetable",-3) != 0) 
          {
            IItbsmode((char *)"to");
...
/* # line 2209 "numain.sc" */	/* host code */
	if( conn_rows > 1 )
/* # line 2210 "numain.sc" */	/* getrow */
        {
          if (IItbsetio(2,(char *)"attribform",(char *)"conntable",-2) != 0) 
          {
            IItcogetio((short *)0,1,30,4,&connt_row,(char *)"_record");
...
/* # line 2211 "numain.sc" */	/* host code */
	else
	    connt_row = 1;
/* # line 2213 "numain.sc" */	/* set_frs */
        {
          if (IIiqset(7,0,(char *)"",(char *)0, (char *)0) != 0) {
            IIstfsio(67,ERget( FE_Test ),0,(short *)0,1,30,sizeof(0),
            (void *)IILQint(0));
...
IImuI3:
    ...
    if (IInmuact(ERget( FE_Create ),(char *)0,2,2,1) == 0) goto IIfdE3;
    if (IInmuact(ERget( FE_Destroy ),(char *)0,2,2,2) == 0) goto IIfdE3;
    if (IInmuact(ERget( FE_Edit ),(char *)0,2,2,3) == 0) goto IIfdE3;
    if (IInmuact(ERget( FE_Login ),(char *)0,2,0,4) == 0) goto IIfdE3;
    if (IInmuact(ERget( FE_Test ),(char *)0,2,0,5) == 0) goto IIfdE3;
    if (IInmuact(control_menuitem,(char *)0,2,2,6) == 0) goto IIfdE3;
    if (IInmuact(ERget( FE_Help ),(char *)0,2,2,7) == 0) goto IIfdE3;
    IIFRInternal(0);
    if (IInfrskact(1,(char *)0,2,2,7) == 0) goto IIfdE3;
    if (IInmuact(ERget( FE_End ),(char *)0,2,2,8) == 0) goto IIfdE3;
    IIFRInternal(0);
    if (IInfrskact(3,(char *)0,2,2,8) == 0) goto IIfdE3;
    if (IITBcaClmAct((char *)"nodetable",(char *)"all",1,9) == 0) goto IIfdE3;
    if (IITBcaClmAct((char *)"attribtable",(char *)"all",1,10) == 0) goto 
    IIfdE3;
    if (IITBcaClmAct((char *)"conntable",(char *)"all",1,11) == 0) goto IIfdE3;
    if (IIendmu() == 0) goto IIfdE3;
    goto IIfdI3;
IIfdE3:;
    IIendfrm();
  }
/* # line 2217 "numain.sc" */	/* host code */
}
/*
