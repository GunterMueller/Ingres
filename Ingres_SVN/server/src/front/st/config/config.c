...
/* # line 366 "config.sc" */	/* inittable */
  {
    if (IItbinit(form_name,(char *)"text",(char *)"r") != 0) {
      IItfill();
    } /* IItbinit */
  }
/* # line 368 "config.sc" */	/* display */
  {
...
/* # line 374 "config.sc" */	/* clear */
    {
      IIfldclear((char *)"text");
    }
/* # line 376 "config.sc" */	/* host code */
		while( SIgetrec( buf, SI_MAX_TXT_REC, fp ) == OK )
		{
			buf[ MAX_COL ] = EOS;
/* # line 379 "config.sc" */	/* loadtable */
    {
      if (IItbact(form_name,(char *)"text",1) != 0) {
        IItcoputio((char *)"line",(short *)0,1,32,0,buf);
        IITBceColEnd();
      } /* IItbact */
    }
/* # line 382 "config.sc" */	/* host code */
			++lines;
		}
		(void) SIclose(fp);
		if( end )
		{
			cur = lines;
			top = FALSE;
/* # line 390 "config.sc" */	/* scroll */
    {
      if (IItbsetio(1,form_name,(char *)"text",-3) != 0) {
        IItbsmode((char *)"to");
        if (IItscroll(0,cur) != 0) {
        } /* IItscroll */
      } /* IItbsetio */
    }
/* # line 391 "config.sc" */	/* host code */
		}	
		if( lines <= MAX_ROW )
		{
			...
			while( TRUE )
			{
/* # line 398 "config.sc" */	/* redisplay */
    {
      IIredisp();
    }
/* # line 400 "config.sc" */	/* submenu */
    {
      goto IImuI2;
IIfdB2:
      IIrunmu(0);
      if (IIretval() == 1) {
/* # line 406 "config.sc" */	/* breakdisplay */
        {
          if (1) goto IIfdE1;
        }
      } else {
...
IImuI2:
      ...
      if (IInmuact(ERget( FE_End ),(char *)0,2,2,1) == 0) goto IIfdE2;
      IIFRInternal(0);
...
/* # line 409 "config.sc" */	/* host code */
		...
		else
		{
			while( TRUE )
			{
/* # line 415 "config.sc" */	/* redisplay */
    {
      IIredisp();
    }
/* # line 417 "config.sc" */	/* submenu */
    {
      goto IImuI3;
IIfdB3:
      IIrunmu(0);
      if (IIretval() == 1) {
/* # line 424 "config.sc" */	/* host code */
					if( top )
						--cur;
					else
					{
...
/* # line 501 "config.sc" */	/* host code */
					cur = 1;
					top = TRUE;
/* # line 503 "config.sc" */	/* scroll */
        {
          if (IItbsetio(1,form_name,(char *)"text",-3) != 0) {
            IItbsmode((char *)"to");
            if (IItscroll(0,cur) != 0) {
...
/* # line 513 "config.sc" */	/* host code */
					cur = lines;
					top = FALSE;
/* # line 515 "config.sc" */	/* scroll */
        {
          if (IItbsetio(1,form_name,(char *)"text",-3) != 0) {
            IItbsmode((char *)"to");
            if (IItscroll(0,cur) != 0) {
...
/* # line 524 "config.sc" */	/* breakdisplay */
        {
          if (1) goto IIfdE1;
        }
      } else {
...
IImuI3:
      ...
      if (IInmuact(ERget( S_ST035D_scroll_up_menu ),(char *)0,2,2,1) == 0) 
      goto IIfdE3;
      IIFRInternal(0);
      if (IInfrskact(18,(char *)0,2,2,1) == 0) goto IIfdE3;
      if (IInmuact(ERget( S_ST035E_scroll_down_menu ),(char *)0,2,2,2) == 0) 
      goto IIfdE3;
      IIFRInternal(0);
      if (IInfrskact(12,(char *)0,2,2,2) == 0) goto IIfdE3;
      if (IInmuact(ERget( S_ST0349_page_up_menu ),(char *)0,2,2,3) == 0) goto 
      IIfdE3;
      IIFRInternal(0);
      if (IInfrskact(19,(char *)0,2,2,3) == 0) goto IIfdE3;
      if (IInmuact(ERget( S_ST034A_page_down_menu ),(char *)0,2,2,4) == 0) 
      goto IIfdE3;
      IIFRInternal(0);
      if (IInfrskact(13,(char *)0,2,2,4) == 0) goto IIfdE3;
      if (IInmuact(ERget( S_ST034B_top_menu ),(char *)0,2,2,5) == 0) goto 
      IIfdE3;
      IIFRInternal(0);
      if (IInfrskact(17,(char *)0,2,2,5) == 0) goto IIfdE3;
      if (IInmuact(ERget( S_ST034C_bottom_menu ),(char *)0,2,2,6) == 0) goto 
      IIfdE3;
      IIFRInternal(0);
      if (IInfrskact(11,(char *)0,2,2,6) == 0) goto IIfdE3;
      if (IInmuact(ERget( FE_End ),(char *)0,2,2,7) == 0) goto IIfdE3;
      IIFRInternal(0);
      if (IInfrskact(3,(char *)0,2,2,7) == 0) goto IIfdE3;
      if (IIendmu() == 0) goto IIfdE3;
      goto IIfdB3;
IIfdE3:;
    }
/* # line 527 "config.sc" */	/* host code */
			}
		}
IIfdB1:
    while (IIrunform() != 0) {
...
set_resource( char *name, char *value )
{
  ...
  char *warnmsg;
	...
	bool syscheck_required = FALSE;
        char tmp_buf[1024];
/* # line 560 "config.sc" */	/* message */
  {
    IImessage(ERget( S_ST0324_validating ));
  }
/* # line 562 "config.sc" */	/* host code */
...
/* # line 593 "config.sc" */	/* redisplay */
  {
    IIredisp();
  }
/* # line 595 "config.sc" */	/* host code */
...
/* # line 676 "config.sc" */	/* message */
  {
    IImessage(ERget( S_ST0311_recalculating ));
  }
/* # line 678 "config.sc" */	/* host code */
	/* set resources and write changes to config.log */
        if (warnmsg = CRsetPMval( name, value, change_log_fp, FALSE, TRUE ))
/* # line 680 "config.sc" */	/* message */
  {
    IIFRgpcontrol(1,0);
...
/* # line 690 "config.sc" */	/* redisplay */
  {
    IIredisp();
  }
/* # line 692 "config.sc" */	/* host code */
	/* call system resource checker if one exists */ 
	if( syscheck_required )
	{
/* # line 695 "config.sc" */	/* message */
  {
    IImessage(ERget( S_ST0316_cbf_syscheck_message ));
  }
/* # line 696 "config.sc" */	/* host code */
		if( PCcmdline( NULL, syscheck_command, PC_WAIT, NULL,
			&cl_err ) != OK )
		{
			/* report syscheck failure */
/* # line 700 "config.sc" */	/* prompt */
  {
    IIFRgpcontrol(1,0);
    IIFRgpsetio(6,(short *)0,1,30,sizeof(301),(void *)IILQint(301));
    IIFRgpcontrol(2,0);
    IIprmptio(0,ERget( S_ST0317_syscheck_failure ),(short *)0,1,32,BIG_ENOUGH
    -1,in_buf);
  }
/* # line 705 "config.sc" */	/* host code */
...
/* # line 715 "config.sc" */	/* message */
  {
    IImessage(ERget( S_ST031B_restoring_settings ));
  }
/* # line 718 "config.sc" */	/* host code */
...
/* # line 1270 "config.sc" */	/* inquire_frs */
  {
    if (IIiqset(0,0,(char *)0, (char *)0, (char *)0) != 0) {
      IIiqfsio((short *)0,1,32,MAX_LOC+1-1,tty_type,0,(char *)0,0);
    } /* IIiqset */
  }
/* # line 1271 "config.sc" */	/* host code */
		if (STbcompare(tty_type, 2, ERx("vt"), 2, TRUE) == 0) {
			NMloc( FILES, FILENAME, ERx( "cbf.map" ), 
				&key_map_file);
			STcopy(key_map_file.string,key_map_filename);
/* # line 1275 "config.sc" */	/* set_frs */
  {
    if (IIiqset(0,0,(char *)0, (char *)0, (char *)0) != 0) {
      IIstfsio(10,(char *)0,0,(short *)0,1,32,0,key_map_filename);
    } /* IIiqset */
  }
/* # line 1276 "config.sc" */	/* host code */
		}
	}
	else
	{
		STlcopy(ii_keymap,key_map_filename, sizeof(key_map_filename)-1);
/* # line 1282 "config.sc" */	/* set_frs */
  {
    if (IIiqset(0,0,(char *)0, (char *)0, (char *)0) != 0) {
      IIstfsio(10,(char *)0,0,(short *)0,1,32,0,key_map_filename);
    } /* IIiqset */
  }
/* # line 1283 "config.sc" */	/* host code */
	}
/* # line 1284 "config.sc" */	/* set_frs */
  {
    if (IIiqset(0,0,(char *)0, (char *)0, (char *)0) != 0) {
      IIstfsio(68,(char *)0,0,(short *)0,1,30,sizeof(0),(void *)IILQint(0));
    } /* IIiqset */
  }
/* # line 1286 "config.sc" */	/* host code */
	/* get name of syscheck program if available */
	STprintf( tmp_buf, ERx( "%s.*.cbf.syscheck_command" ),
	          SystemCfgPrefix );
	(void) PMmGet( config_data, tmp_buf, &syscheck_command );
		...
		ValueIsBoolTrue( value ) )
	{
		...
		** amount of them. 
		*/ 
/* # line 1307 "config.sc" */	/* message */
  {
    IImessage(ERget( S_ST0316_cbf_syscheck_message ));
  }
/* # line 1308 "config.sc" */	/* host code */
		if( PCcmdline( NULL, syscheck_command, PC_WAIT, NULL,
			&cl_err ) != OK )
		{
			STprintf( tmp_buf, ERget( S_ST0327_syscheck_disabled ),
				  SystemProductName );
/* # line 1313 "config.sc" */	/* message */
  {
    IIFRgpcontrol(1,0);
    IIFRgpsetio(6,(short *)0,1,30,sizeof(301),(void *)IILQint(301));
    IIFRgpcontrol(2,0);
...
/* # line 1316 "config.sc" */	/* host code */
	...
	startup_config_form();	
/* # line 1378 "config.sc" */	/* clear */
  {
    IIclrscr();
  }
/* # line 1380 "config.sc" */	/* host code */
	FEendforms();
	EXdelete();
	PCexit( OK );
}
