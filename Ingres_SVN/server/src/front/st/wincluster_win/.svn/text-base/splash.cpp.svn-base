...
*/
#define SPLASH_WIDTH	485	/* Splash screen width */
#define SPLASH_HEIGHT	385	/* Splash screen height */
#define CP_X		 39	/* X coordination of coyright box */
#define CP_Y		368	/* Y coordination of coyright box */
...
CSplashWnd::Create(CWnd* pParentWnd)
{
    ...
    */
    ...
    lf.lfHeight = -11;			/* Request a 10-pixel-high font */
...
CSplashWnd::OnCtlColor(CDC* pDC, CWnd* pWnd, UINT nCtlColor) 
{
    ...
    /* This is used to change the background color to use white color. */
