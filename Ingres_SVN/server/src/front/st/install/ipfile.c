...
ip_cmdline( char *cmdline, ER_MSGID errmsg )
{
	...
	*locBuf = EOS;
		...
		!= OK )
	{
		...
		if( !batchMode )
		{
/* # line 653 "ipfile.sc" */	/* clear */
  {
    IIclrscr();
  }
/* # line 654 "ipfile.sc" */	/* redisplay */
  {
    IIredisp();
  }
/* # line 655 "ipfile.sc" */	/* host code */
		}
		ip_display_msg( err );
	}
	/* remove existing errorfile (SystemCfgPrefix"build.err" if it exists */
	...
	else 
	{
		...
		else
		{
		  ...
		  /* clear the screen before running a setup program */
			if( !batchMode )
/* # line 956 "ipfile.sc" */	/* clear */
  {
    IIclrscr();
  }
/* # line 957 "ipfile.sc" */	/* host code */
			ip_forms( FALSE );
		}
		IPCLclearTmpEnv();
...
path_ok( void )
{
	...
	if( init ) 
	{
		...
		else
		{
			...
			if( !batchMode )
			{
/* # line 1013 "ipfile.sc" */	/* clear */
  {
    IIclrscr();
  }
/* # line 1014 "ipfile.sc" */	/* redisplay */
  {
    IIredisp();
  }
/* # line 1015 "ipfile.sc" */	/* host code */
			}
			path_ok = FALSE;
		}
		init = FALSE;
...
/* # line 2287 "ipfile.sc" */	/* redisplay */
  {
    IIredisp();
  }
/* # line 2288 "ipfile.sc" */	/* host code */
	return( rtn );
}
/*
...
/* # line 3427 "ipfile.sc" */	/* host code */
STprintf( msg, "%s->selected=%d", dpkg->feature, dpkg->selected ); 
/* # line 3428 "ipfile.sc" */	/* message */
  {
    IIFRgpcontrol(1,0);
    IIFRgpsetio(6,(short *)0,1,30,sizeof(301),(void *)IILQint(301));
    IIFRgpcontrol(2,0);
