...
DUT_ERRCB   *dut_errcb;
{
	...
	case E_DU_UERROR:
		...
		FALSE);
/* # line 148 "duterr.sc" */	/* disconnect */
  {
    IIsqInit(&sqlca);
    IIsqDisconnect();
  }
/* # line 149 "duterr.sc" */	/* host code */
...
/* # line 386 "duterr.sc" */	/* copy sqlerror */
  {
    IIeqiqio((short *)0,1,32,DB_ERR_SIZE-1,errbuf,(char *)"errortext");
  }
/* # line 388 "duterr.sc" */	/* host code */
...
/* # line 403 "duterr.sc" */	/* clear */
  {
    IIclrscr();
  }
/* # line 404 "duterr.sc" */	/* endforms */
  {
    IIendforms();
  }
/* # line 405 "duterr.sc" */	/* host code */
	    PCexit(errstatus);
	}
...
/* # line 422 "duterr.sc" */	/* clear */
  {
    IIclrscr();
  }
/* # line 423 "duterr.sc" */	/* endforms */
  {
    IIendforms();
  }
/* # line 424 "duterr.sc" */	/* host code */
	    PCexit(errstatus);
	}
	else
	{
...
/* # line 430 "duterr.sc" */	/* clear */
  {
    IIclrscr();
  }
/* # line 431 "duterr.sc" */	/* endforms */
  {
    IIendforms();
  }
/* # line 432 "duterr.sc" */	/* host code */
	    PCexit(errstatus);
	}
    }
    else
