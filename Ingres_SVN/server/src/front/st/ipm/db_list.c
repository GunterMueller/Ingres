...
IIrtB1:
    while (IInextget() != 0) {
      IIgetdomio((short *)0,1,32,FE_MAXNAME + 1-1,dn);
      IIgetdomio((short *)0,1,30,4,&db_id);
      if (IIerrtest() != 0) goto IIrtB1;
      {
/* # line 150 "db_list.qsc" */	/* host code */
...
/* # line 160 "db_list.qsc" */	/* host code */
...
** When the end of the list is encountered, NULL is returned.
*/
i4
get_nextdb(db_name)
PTR db_name;
