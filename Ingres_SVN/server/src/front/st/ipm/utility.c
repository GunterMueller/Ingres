...
char *process_name;
{
    ...
    */
    for (;;) 
    {
	status = sys$getjpiw(0, &pid, 0, &jpiinfo, iosb, 0, 0);
...
PTR devname;
{
    ...
    */
    status = sys$getdviw(0, 0, &term_name, &dviinfo, iosb, 0, 0, 0);
    if (status != SS$_NORMAL)
    {
...
clean_up()
{
    ...
    if (forms_on) 
    {
/* # line 392 "utility.qsc" */	/* clear */
  {
    IIclrscr();
  }
/* # line 393 "utility.qsc" */	/* endforms */
  {
    IIendforms();
  }
/* # line 394 "utility.qsc" */	/* host code */
    }
    /*
...
/* # line 596 "utility.qsc" */	/* host code */
		break;
	    }
	    default:
	    {
		msgsleep = (int)sleeptime;
/* # line 602 "utility.qsc" */	/* message */
  {
    IImessage(msg);
  }
/* # line 603 "utility.qsc" */	/* sleep */
  {
    IIsleep(msgsleep);
  }
/* # line 604 "utility.qsc" */	/* host code */
	    }
	}
    }
    else
...
IIrtB1:
    while (IInextget() != 0) {
      IIgetdomio((short *)0,1,32,19,ver_string);
      if (IIerrtest() != 0) goto IIrtB1;
    } /* IInextget */
    IIflush((char *)0,0);
IIrtE1:;
  }
/* # line 740 "utility.qsc" */	/* host code */
  ...
  char *title;
{
 ...
 could not open help file %s", title, fullpath);
	...
	if (!fd_forms_added)
	{
/* # line 797 "utility.qsc" */	/* addform */
  {
    IIaddform(fmyhelp);
  }
/* # line 798 "utility.qsc" */	/* inittable */
  {
    if (IItbinit(Fmyhelp,(char *)"disbox",(char *)"r") != 0) {
      IItfill();
    } /* IItbinit */
  }
/* # line 799 "utility.qsc" */	/* host code */
		fd_forms_added = TRUE;
	}
/* # line 802 "utility.qsc" */	/* display */
  {
    if (IIdispfrm(Fmyhelp,(char *)"r") == 0) goto IIfdE1;
    goto IImuI1;
IIfdI1:;
    if (IIfsetio((char *)0) == 0) goto IIfdE1;
    {
/* # line 805 "utility.qsc" */	/* clear */
      {
        IIclrflds();
      }
/* # line 806 "utility.qsc" */	/* putform */
      {
        if (IIfsetio((char *)0) != 0) {
          IIputfldio((char *)"title",(short *)0,1,32,0,title);
        } /* IIfsetio */
      }
/* # line 807 "utility.qsc" */	/* host code */
		while (SIgetrec(in_line, MAXMAXLEN, fp) != ENDFILE)
		{
			in_line[MAXLEN] = EOS;
/* # line 810 "utility.qsc" */	/* loadtable */
      {
        if (IItbact(Fmyhelp,(char *)"disbox",1) != 0) {
          IItcoputio((char *)"disline",(short *)0,1,32,0,in_line);
          IITBceColEnd();
        } /* IItbact */
      }
/* # line 811 "utility.qsc" */	/* host code */
			++linect;
		}
		SIclose(fp);
		target = MAXHEIGHT;
		...
		while (!e_xit)
		{
/* # line 819 "utility.qsc" */	/* scroll */
      {
        if (IItbsetio(1,Fmyhelp,(char *)"disbox",-3) != 0) {
          IItbsmode((char *)"to");
          if (IItscroll(0,target) != 0) {
          } /* IItscroll */
        } /* IItbsetio */
      }
/* # line 820 "utility.qsc" */	/* host code */
			currow = target;
/* # line 821 "utility.qsc" */	/* redisplay */
      {
        IIredisp();
      }
/* # line 822 "utility.qsc" */	/* submenu */
      {
        goto IImuI2;
IIfdB2:
        IIrunmu(0);
        if (IIretval() == 1) {
          {
/* # line 825 "utility.qsc" */	/* host code */
				if (currow < linect)
				{
          ...
          {
/* # line 837 "utility.qsc" */	/* host code */
				if (currow > 1)
				{
					target = currow - (MAXHEIGHT - 2);
					if (forward)
          ...
          {
/* # line 849 "utility.qsc" */	/* host code */
				target = 1;
				forward = FALSE;
          }
        } else if (IIretval() == 4) {
          {
/* # line 854 "utility.qsc" */	/* host code */
				target = linect;
				forward = TRUE;
          }
        } else if (IIretval() == 5) {
          {
/* # line 859 "utility.qsc" */	/* host code */
				e_xit = TRUE;
/* # line 860 "utility.qsc" */	/* breakdisplay */
            {
              if (1) goto IIfdE1;
            }
          }
...
IImuI2:
        ...
        if (IInmuact((char *)"NextPage",(char *)0,2,2,1) == 0) goto IIfdE2;
        if (IInmuact((char *)"PrevPage",(char *)0,2,2,2) == 0) goto IIfdE2;
        if (IInmuact((char *)"Top",(char *)0,2,2,3) == 0) goto IIfdE2;
        if (IInmuact((char *)"Bottom",(char *)0,2,2,4) == 0) goto IIfdE2;
...
/* # line 862 "utility.qsc" */	/* host code */
		}
    }
IIfdB1:
    while (IIrunform() != 0) {
...
/* # line 865 "utility.qsc" */	/* host code */
}
/* refresh_status: display whether we're in autorefresh mode.
  ...
  char *formname;
{
  char refresh_msg[40];
    if (visible)
    {
/* # line 878 "utility.qsc" */	/* set_frs */
  {
    if (IIiqset(2,0,formname,(char *)0, (char *)0) != 0) {
      IIstfsio(54,(char *)"autorefresh",0,(short *)0,1,30,sizeof(0),
      (void *)IILQint(0));
    } /* IIiqset */
  }
/* # line 879 "utility.qsc" */	/* host code */
    }
    else
    {
/* # line 882 "utility.qsc" */	/* set_frs */
  {
    if (IIiqset(2,0,formname,(char *)0, (char *)0) != 0) {
      IIstfsio(54,(char *)"autorefresh",0,(short *)0,1,30,sizeof(1),
      (void *)IILQint(1));
    } /* IIiqset */
  }
/* # line 883 "utility.qsc" */	/* host code */
...
/* # line 890 "utility.qsc" */	/* putform */
  {
    if (IIfsetio(formname) != 0) {
      IIputfldio((char *)"autorefresh",(short *)0,1,32,0,refresh_msg);
    } /* IIfsetio */
  }
/* # line 891 "utility.qsc" */	/* host code */
    } 
    else 
    {
/* # line 894 "utility.qsc" */	/* putform */
  {
    if (IIfsetio(formname) != 0) {
      IIputfldio((char *)"autorefresh",(short *)0,1,32,0,(char *)"Disa\
bled");
    } /* IIfsetio */
  }
/* # line 895 "utility.qsc" */	/* host code */
    }
}
