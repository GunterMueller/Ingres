...
#define CHECK_PKGNAME_VALID( f, s ) \
		( s != NULL && f != NULL && \
			strcmp(new_pkgs_info.format, s ) == 0 && \
			strncmp(new_pkgs_info.pkg_basename, f, \
				strlen( new_pkgs_info.pkg_basename ) ) == 0 )
...
#define PKG_BASENAME "ingres2006"
