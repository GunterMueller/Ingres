...
# endif
	...
	*/
	i = 0;
/* # line 227 "fssetup.qsc" */	/* unloadtable */
  {
    if (IItbact(formname,tblfldname,0) == 0) goto IItbE1;
    while (IItunload() != 0) {
      IItcogetio((short *)0,1,32,BFRSIZE-1,bfr,colname);
      IITBceColEnd();
      {
/* # line 229 "fssetup.qsc" */	/* host code */
		if (++i <= nmrows)
		{
			if ( STtrmwhite(bfr) > 0 && bfr[0] != EOS )
			{
				...
				else    /* Query buffer full - increase it */
				{
					if(FSqbfull(qb) != OK)
					{
						...
						qryfull = TRUE;
/* # line 266 "fssetup.qsc" */	/* endloop */
        {
          if (1) goto IItbE1;
        }
/* # line 267 "fssetup.qsc" */	/* host code */
					}
					else
					{
						STcopy(bfr, qb->qb_char);
...
/* # line 281 "fssetup.qsc" */	/* host code */
  ...
  char *colnm;
{
  ...
  char bf[BFRSIZE];
  i4 r_state;
/* # line 314 "fssetup.qsc" */	/* unloadtable */
  {
    if (IItbact(frmnm,tblnm,0) == 0) goto IItbE2;
    while (IItunload() != 0) {
      IItcogetio((short *)0,1,32,BFRSIZE-1,bf,colnm);
      IItcogetio((short *)0,1,30,4,&r_state,(char *)"_STATE");
      IITBceColEnd();
      {
/* # line 316 "fssetup.qsc" */	/* host code */
...
/* # line 324 "fssetup.qsc" */	/* host code */
