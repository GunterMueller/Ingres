...
register QRB	*qrb;
{
	...
	i4		token;
	char		towner[FE_MAXNAME+1];	/* for qrtblowner */
...
doset(
	...
	extern void FEset_date_format(char*);
	extern void FEset_money_format(char*);
	char tmp_format[255];
