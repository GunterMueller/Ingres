...
/* # line 99 "qrerror.sc" */	/* inquire_ingres */
  {
    IILQisInqSqlio((short *)0,1,32,ER_MAX_LEN+3-1,errbuf,63);
  }
/* # line 100 "qrerror.sc" */	/* host code */
	STcat(errbuf, ERx("\n"));
	QRqrb->errmsg = errbuf;
...
IIQRdehDbEventHdlr()
{
  ...
  char ev_time[DB_DTE_LEN];
    ev_text[0] = EOS;
/* # line 237 "qrerror.sc" */	/* inquire_sql */
  {
    IILQisInqSqlio((short *)0,1,32,DB_MAXNAME+1-1,ev_name,74);
    IILQisInqSqlio((short *)0,1,32,70,ev_text,78);
    IILQisInqSqlio((short *)0,1,32,DB_MAXNAME+1-1,ev_ownr,75);
    IILQisInqSqlio((short *)0,1,32,DB_MAXNAME+1-1,ev_dbnm,76);
    IILQisInqSqlio((short *)0,1,32,DB_DTE_LEN-1,ev_time,77);
  }
/* # line 240 "qrerror.sc" */	/* host code */
    if (ev_text[0] == EOS)
    {
	STprintf(errbuf,
           "\nEVENT NAME: %s\nOWNER:      %s\nDATABASE:   %s\nDATE:       %s\n\n",
...
IIQRpmhProcMsgHdlr()
{
  ...
  char msgbuf[ER_MAX_LEN +2];
    msgbuf[0] = EOS;
/* # line 295 "qrerror.sc" */	/* inquire_sql */
  {
    IILQisInqSqlio((short *)0,1,30,4,&msgno,68);
    IILQisInqSqlio((short *)0,1,32,ER_MAX_LEN +2-1,msgbuf,69);
  }
/* # line 296 "qrerror.sc" */	/* host code */
    STcat(msgbuf,ERx("\n"));
...
bool active;
{
	if (active)
	{
/* # line 332 "qrerror.sc" */	/* set_sql */
  {
    IILQshSetHandler(4,IIQRdehDbEventHdlr);
  }
/* # line 333 "qrerror.sc" */	/* set_sql */
  {
    IILQshSetHandler(5,IIQRpmhProcMsgHdlr);
  }
/* # line 334 "qrerror.sc" */	/* host code */
	}
	else
	{
/* # line 337 "qrerror.sc" */	/* set_sql */
  {
    IILQshSetHandler(4,(int (*)())0);
  }
/* # line 338 "qrerror.sc" */	/* set_sql */
  {
    IILQshSetHandler(5,(int (*)())0);
  }
/* # line 339 "qrerror.sc" */	/* host code */
	}
}
