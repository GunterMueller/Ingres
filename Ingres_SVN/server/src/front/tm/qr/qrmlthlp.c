...
FUNC_EXTERN     PTR     loop_init_obj();
static	char	pobjname[FE_UNRML_MAXNAME]; /* Used for help comment column */
...
qrendtrans( QRB *qrb )
{
    if (qrb->endtrans)
    {
/* # line 573 "qrmlthlp.sc" */	/* commit */
  {
    IIsqInit((char *)0);
    IIxact(3);
  }
/* # line 574 "qrmlthlp.sc" */	/* host code */
	qrb->endtrans = FALSE;
    }
    return;
}
...
FE_RSLV_NAME  *objectp;
    ...
    objectp = (FE_RSLV_NAME *) loop_init_obj(object, &ename1);
