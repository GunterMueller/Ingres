	...
	*/
	if ( type != NULL )
	{
	    ...
	    */
	    oldt = t;
	    t = type;
/* # line 223 "qrloghlp.sc" */	/* repeated select */
  {
    IIsexec();
    while (IInexec() == 0) {
      IIsqInit((char *)0);
      IIexExec(1,(char *)"qrloghlp1",7489,25463);
      IIputdomio((short *)0,1,32,0,oldt);
      IIputdomio((short *)0,1,32,0,town);
      IIretinit((char *)0,0);
      if (IInexec() == 0) {
        IIsqInit((char *)0);
        IIexDefine(1,(char *)"qrloghlp1",7489,25463);
        IIwritio(0,(short *)0,1,32,0,(char *)
"select table_owner from iisynonyms where synonym_name=");
        IIwritio(0,(short *)0,1,32,0,(char *)" $0=");
        IIputdomio((short *)0,1,32,0,oldt);
        IIwritio(0,(short *)0,1,32,0,(char *)"and synonym_owner=");
        IIwritio(0,(short *)0,1,32,0,(char *)" $1=");
        IIputdomio((short *)0,1,32,0,town);
        IIexDefine(0,(char *)"qrloghlp1",7489,25463);
        if (IIerrtest() == 0) {
          IIsexec();
        } /* IIerrtest */
      } /* IInexec */
...
IIrtB1:
    while (IInextget() != 0) {
      IIgetdomio((short *)0,1,32,FE_MAXNAME + 1-1,btabown);
      if (IIerrtest() != 0) goto IIrtB1;
    } /* IInextget */
    IIflush((char *)0,0);
IIrtE1:;
  }
/* # line 230 "qrloghlp.sc" */	/* host code */
	    oldo = town;
	    town = btabown;
    	}
	/*
	...
	*/
	...
	{
/* # line 247 "qrloghlp.sc" */	/* repeated select */
  {
    IIsexec();
    while (IInexec() == 0) {
      IIsqInit((char *)0);
      IIexExec(1,(char *)"qrloghlp2",7490,25319);
      ...
      if (IInexec() == 0) {
        IIsqInit((char *)0);
        IIsqMods(1);
        IIexDefine(1,(char *)"qrloghlp2",7490,25319);
        IIwritio(0,(short *)0,1,32,0,(char *)
"select create_date, table_type, table_subtype, table_version, system_\
use, phys_partitions from iitables where table_name=");
        IIwritio(0,(short *)0,1,32,0,(char *)" $0=");
        IIputdomio((short *)0,1,32,0,t);
        IIwritio(0,(short *)0,1,32,0,(char *)"and table_owner=");
        IIwritio(0,(short *)0,1,32,0,(char *)" $1=");
        IIputdomio((short *)0,1,32,0,town);
        IIexDefine(0,(char *)"qrloghlp2",7490,25319);
        if (IIerrtest() == 0) {
          IIsexec();
        } /* IIerrtest */
      } /* IInexec */
    ...
    if (IInextget() != 0) {
      ...
      IIgetdomio((short *)0,1,32,8,ttype);
      IIgetdomio((short *)0,1,32,8,tstype);
      IIgetdomio((short *)0,1,32,8,tversion);
      IIgetdomio((short *)0,1,32,1,sysuse);
      IIgetdomio((short *)0,1,30,2,&phys_partitions);
    } /* IInextget */
    IIsqFlush((char *)0,0);
  }
/* # line 253 "qrloghlp.sc" */	/* host code */
	}
	else
	{
/* # line 257 "qrloghlp.sc" */	/* repeated select */
  {
    IIsexec();
    while (IInexec() == 0) {
      IIsqInit((char *)0);
      IIexExec(1,(char *)"qrloghlp3",7491,24746);
      IIputdomio((short *)0,1,32,0,t);
      IIputdomio((short *)0,1,32,0,town);
      IIretinit((char *)0,0);
      if (IInexec() == 0) {
        IIsqInit((char *)0);
        IIsqMods(1);
        IIexDefine(1,(char *)"qrloghlp3",7491,24746);
        IIwritio(0,(short *)0,1,32,0,(char *)
"select create_date, table_type, table_subtype, table_version, system_\
use from iitables where table_name=");
        IIwritio(0,(short *)0,1,32,0,(char *)" $0=");
        IIputdomio((short *)0,1,32,0,t);
        IIwritio(0,(short *)0,1,32,0,(char *)"and table_owner=");
        IIwritio(0,(short *)0,1,32,0,(char *)" $1=");
        IIputdomio((short *)0,1,32,0,town);
        IIexDefine(0,(char *)"qrloghlp3",7491,24746);
        if (IIerrtest() == 0) {
          IIsexec();
        } /* IIerrtest */
      } /* IInexec */
...
/* # line 263 "qrloghlp.sc" */	/* host code */
	}
	if (FEinqerr())
	{
