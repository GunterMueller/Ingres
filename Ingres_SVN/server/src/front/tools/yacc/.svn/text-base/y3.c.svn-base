 ...
 *    1) Added compat.h include statement for WindowsNT.
 *    2) Changed stdout declaration for WindowsNT.
 *	  3) Added int declarations where missing to satisfy WindowsNT compiler.
 *	06-apr-94 (leighb)
 *		added void to functions that don't return anything to keep the
 *		compiler warning police happy.
 *	09-may-94 (zaki,leighb)
 *              Adding defines for stdin, stdout and stderr since they were
