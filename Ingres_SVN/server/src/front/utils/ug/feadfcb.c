...
static ADF_CB  cb = {
	...
	{ E_AD0000_OK, 0, 0, 0, 0, 0, NULL },	/* adf_errcb */
...
void
FEset_date_format(char *date_format)
{
    FEapply_date_format(FEadfcb(),date_format);
}
...
void
FEset_money_format(char *money_format)
{
    FEapply_money_format(FEadfcb(),money_format);
}
...
void
FEset_money_prec(char *money_prec)
{
    FEapply_money_prec(FEadfcb(),money_prec);
}
...
void
FEset_decimal(char *decimal)
{
    FEapply_decimal(FEadfcb(),decimal);
}
...
void
FEset_null(char *null)
{
    FEapply_null(FEadfcb(),null);
}
