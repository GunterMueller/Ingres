...
/* # line 128 "chckdict.sc" */	/* select */
  {
    IIsqInit((char *)0);
    IIsqMods(1);
    IIwritio(0,(short *)0,1,32,0,(char *)
"select count(*)from ii_client_dep_mod where client_name=");
    IIputdomio((short *)0,1,32,0,client_name);
    IIwritio(0,(short *)0,1,32,0,(char *)"and client_version=");
    IIputdomio((short *)0,1,30,4,&client_version);
    IIretinit((char *)0,0);
    if (IInextget() != 0) {
      IIgetdomio((short *)0,1,30,4,&count1);
    } /* IInextget */
    IIsqFlush((char *)0,0);
  }
/* # line 138 "chckdict.sc" */	/* inquire_ingres */
  {
    IILQisInqSqlio((short *)0,1,30,4,&local_errno,2);
  }
/* # line 139 "chckdict.sc" */	/* host code */
    if (local_errno != 0)
    {
...
/* # line 157 "chckdict.sc" */	/* select */
  {
    IIsqInit((char *)0);
    IIsqMods(1);
    IIwritio(0,(short *)0,1,32,0,(char *)
"select count(*)from ii_client_dep_mod, ii_dict_modules where client_n\
ame=");
    IIputdomio((short *)0,1,32,0,client_name);
    IIwritio(0,(short *)0,1,32,0,(char *)"and client_version=");
    IIputdomio((short *)0,1,30,4,&client_version);
    IIwritio(0,(short *)0,1,32,0,(char *)
"and ii_client_dep_mod.module_name=ii_dict_modules.module_name and ii_\
client_dep_mod.module_version=ii_dict_modules.module_version");
    IIretinit((char *)0,0);
    if (IInextget() != 0) {
      IIgetdomio((short *)0,1,30,4,&count2);
    } /* IInextget */
    IIsqFlush((char *)0,0);
  }
/* # line 171 "chckdict.sc" */	/* inquire_ingres */
  {
    IILQisInqSqlio((short *)0,1,30,4,&local_errno,2);
  }
/* # line 172 "chckdict.sc" */	/* host code */
    if (local_errno != 0)
    {
