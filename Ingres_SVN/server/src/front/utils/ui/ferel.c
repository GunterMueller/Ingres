    ...
    register FE_REL_INFO *relinfoptr;
{
  ...
  FE_REL_SOURCE relsrc[3];
    ...
    {
/* # line 485 "ferel.sc" */	/* repeated select */
  {
    IIsexec();
    while (IInexec() == 0) {
      IIsqInit((char *)0);
      IIexExec(1,(char *)"ferel1",6504,26028);
      ...
      if (IInexec() == 0) {
        IIsqInit((char *)0);
        IIexDefine(1,(char *)"ferel1",6504,26028);
        IIwritio(0,(short *)0,1,32,0,(char *)
"select table_name, table_owner, create_date, alter_date, table_type, \
table_version, system_use, unique_rule from iitables where table_name=");
        ...
        IIputdomio((short *)0,1,32,0,uidbdata->catowner);
        IIwritio(0,(short *)0,1,32,0,(char *)")");
        IIexDefine(0,(char *)"ferel1",6504,26028);
        if (IIerrtest() == 0) {
          IIsexec();
        } /* IIerrtest */
      } /* IInexec */
...
IIrtB1:
    while (IInextget() != 0) {
      IIgetdomio((short *)0,1,32,FE_MAXNAME + 1-1,
      relsrc[relsrc_idx].table_name);
      IIgetdomio((short *)0,1,32,FE_MAXNAME + 1-1,
      relsrc[relsrc_idx].table_owner);
      IIgetdomio((short *)0,1,32,25,relsrc[relsrc_idx].create_date);
      IIgetdomio((short *)0,1,32,25,relsrc[relsrc_idx].alter_date);
      IIgetdomio((short *)0,1,32,8,relsrc[relsrc_idx].table_type);
      IIgetdomio((short *)0,1,32,8,relsrc[relsrc_idx].version);
      IIgetdomio((short *)0,1,32,1,relsrc[relsrc_idx].system_use);
      IIgetdomio((short *)0,1,32,1,relsrc[relsrc_idx].unique_rule);
      if (IIerrtest() != 0) goto IIrtB1;
/* # line 510 "ferel.sc" */	/* host code */
		...
		if  (++relsrc_idx == 3)
		{
/* # line 519 "ferel.sc" */	/* endselect */
      {
        IIbreak();
        if (1) goto IIrtE1;
      }
/* # line 520 "ferel.sc" */	/* host code */
		} 
    } /* IInextget */
    IIflush((char *)0,0);
IIrtE1:;
...
/* # line 538 "ferel.sc" */	/* repeated select */
  {
    IIsexec();
    while (IInexec() == 0) {
      IIsqInit((char *)0);
      IIexExec(1,(char *)"ferel2",6505,8418);
      IIputdomio((short *)0,1,32,0,relname_buf);
      IIputdomio((short *)0,1,32,0,relowner_buf);
      IIretinit((char *)0,0);
      if (IInexec() == 0) {
        IIsqInit((char *)0);
        IIexDefine(1,(char *)"ferel2",6505,8418);
        IIwritio(0,(short *)0,1,32,0,(char *)
"select table_name, table_owner, create_date, alter_date, table_type, \
table_version, system_use, unique_rule from iitables where table_name=");
        IIwritio(0,(short *)0,1,32,0,(char *)" $0=");
        ...
        IIwritio(0,(short *)0,1,32,0,(char *)" $1=");
        IIputdomio((short *)0,1,32,0,relowner_buf);
        IIexDefine(0,(char *)"ferel2",6505,8418);
        if (IIerrtest() == 0) {
          IIsexec();
        } /* IIerrtest */
      } /* IInexec */
...
/* # line 561 "ferel.sc" */	/* host code */
		...
		if  (++relsrc_idx == 3)
		{
/* # line 576 "ferel.sc" */	/* endselect */
      {
        IIbreak();
        if (1) goto IIrtE2;
      }
/* # line 577 "ferel.sc" */	/* host code */
		} 
    } /* IInextget */
    IIflush((char *)0,0);
IIrtE2:;
