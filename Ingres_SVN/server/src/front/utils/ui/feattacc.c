...
*/
  typedef struct {
    ...
    char column_datatype[FE_MAXNAME + 1];
    i4 column_length;
    i4 column_scale;
    char column_nulls[2];
...
/* # line 239 "feattacc.sc" */	/* repeated select */
  {
    IIsexec();
    while (IInexec() == 0) {
      IIsqInit((char *)0);
      IIexExec(1,(char *)"feattacc1",6506,8940);
      IIputdomio((short *)0,1,32,0,table_name);
      IIputdomio((short *)0,1,32,0,table_owner);
      IIputdomio((short *)0,1,32,0,attr_name);
      IIputdomio((short *)0,1,32,0,attr_name);
      IIretinit((char *)0,0);
      if (IInexec() == 0) {
        IIsqInit((char *)0);
        IIexDefine(1,(char *)"feattacc1",6506,8940);
        IIwritio(0,(short *)0,1,32,0,(char *)
"select column_name, column_datatype, column_length, column_scale, col\
umn_nulls, column_defaults, column_sequence, key_sequence, sort_direct\
ion, column_ingdatatype from iicolumns where table_name=");
...
e");
        IIexDefine(0,(char *)"feattacc1",6506,8940);
        if (IIerrtest() == 0) {
          IIsexec();
        } /* IIerrtest */
      } /* IInexec */
...
IIrtB1:
    while (IInextget() != 0) {
      IIgetdomio(&nulli[2],1,32,FE_MAXNAME + 1-1,atti.column_name);
      IIgetdomio(&nulli[3],1,32,FE_MAXNAME + 1-1,atti.column_datatype);
      IIgetdomio(&nulli[4],1,30,4,&atti.column_length);
      IIgetdomio(&nulli[5],1,30,4,&atti.column_scale);
      IIgetdomio(&nulli[6],1,32,1,atti.column_nulls);
      IIgetdomio(&nulli[7],1,32,1,atti.column_defaults);
      IIgetdomio(&nulli[8],1,30,4,&atti.column_sequence);
      IIgetdomio(&nulli[9],1,30,4,&atti.key_sequence);
      IIgetdomio(&nulli[10],1,32,1,atti.sort_direction);
      IIgetdomio(&nulli[11],1,30,2,&atti.column_ingdatatype);
      if (IIerrtest() != 0) goto IIrtB1;
/* # line 268 "feattacc.sc" */	/* host code */
...
IIrtE1:;
		...
		{ /* logical key support, but before 6.5 */
			/* EXEC SQL DECLARE iiatt_fetch CURSOR FOR ... */
/* # line 289 "feattacc.sc" */	/* repeated select */
  {
    IIsexec();
    while (IInexec() == 0) {
      IIsqInit((char *)0);
      IIexExec(1,(char *)"feattacc2",6507,11509);
      IIputdomio((short *)0,1,32,0,table_name);
      IIputdomio((short *)0,1,32,0,table_owner);
      IIputdomio((short *)0,1,32,0,attr_name);
      IIputdomio((short *)0,1,32,0,attr_name);
      ...
      if (IInexec() == 0) {
        IIsqInit((char *)0);
        IIexDefine(1,(char *)"feattacc2",6507,11509);
        IIwritio(0,(short *)0,1,32,0,(char *)
"select column_name, column_datatype, column_length, column_scale, col\
umn_nulls, column_defaults, column_sequence, key_sequence, sort_direct\
ion, column_ingdatatype, column_internal_datatype, column_internal_len\
gth, column_internal_ingtype, ");
        IIwritio(0,(short *)0,1,32,0,(char *)
"column_system_maintained from iicolumns where table_name=");
        IIwritio(0,(short *)0,1,32,0,(char *)" $0=");
        IIputdomio((short *)0,1,32,0,table_name);
        IIwritio(0,(short *)0,1,32,0,(char *)"and table_owner=");
        IIwritio(0,(short *)0,1,32,0,(char *)" $1=");
        ...
        IIwritio(0,(short *)0,1,32,0,(char *)")order by column_sequenc\
e");
        IIexDefine(0,(char *)"feattacc2",6507,11509);
        if (IIerrtest() == 0) {
          IIsexec();
        } /* IIerrtest */
      } /* IInexec */
...
IIrtB2:
    while (IInextget() != 0) {
      ...
      IIgetdomio(&nulli[10],1,32,1,atti.sort_direction);
      IIgetdomio(&nulli[11],1,30,2,&atti.column_ingdatatype);
      IIgetdomio(&nulli[12],1,32,FE_MAXNAME + 1-1,
      atti.column_internal_datatype);
      IIgetdomio(&nulli[13],1,30,2,&atti.column_internal_length);
      IIgetdomio(&nulli[14],1,30,2,&atti.column_internal_ingtype);
      IIgetdomio(&nulli[15],1,32,1,atti.column_system_maintained);
      if (IIerrtest() != 0) goto IIrtB2;
/* # line 326 "feattacc.sc" */	/* host code */
				/* EXEC SQL OPEN ii_attfetch FOR READONLY; */
				blk->status = STATUS_OPEN;
		 		nulli[16] = nulli[17] = DB_EMB_NULL;
				goto process;
		_63compat:
		 	nulli[16] = nulli[17] = 
				DB_EMB_NULL;
...
IIrtE2:;
		...
		{
/* # line 338 "feattacc.sc" */	/* repeated select */
  {
    IIsexec();
    while (IInexec() == 0) {
      IIsqInit((char *)0);
      IIexExec(1,(char *)"feattacc3",6508,9969);
      IIputdomio((short *)0,1,32,0,table_name);
      IIputdomio((short *)0,1,32,0,table_owner);
      IIputdomio((short *)0,1,32,0,attr_name);
      IIputdomio((short *)0,1,32,0,attr_name);
      ...
      if (IInexec() == 0) {
        IIsqInit((char *)0);
        IIexDefine(1,(char *)"feattacc3",6508,9969);
        IIwritio(0,(short *)0,1,32,0,(char *)
"select column_name, column_datatype, column_length, column_scale, col\
umn_nulls, column_defaults, column_sequence, key_sequence, sort_direct\
ion, column_ingdatatype, column_internal_datatype, column_internal_len\
gth, column_internal_ingtype, ");
        IIwritio(0,(short *)0,1,32,0,(char *)
"column_system_maintained, column_has_default, column_default_val from\
 iicolumns where table_name=");
        ...
        IIwritio(0,(short *)0,1,32,0,(char *)")order by column_sequenc\
e");
        IIexDefine(0,(char *)"feattacc3",6508,9969);
        if (IIerrtest() == 0) {
          IIsexec();
        } /* IIerrtest */
      } /* IInexec */
...
IIrtB3:
    while (IInextget() != 0) {
      ...
      IIgetdomio(&nulli[14],1,30,2,&atti.column_internal_ingtype);
      IIgetdomio(&nulli[15],1,32,1,atti.column_system_maintained);
      IIgetdomio(&nulli[16],1,32,1,atti.column_has_default);
      IIgetdomio(&nulli[17],1,32,DB_MAX_COLUMN_DEFAULT_LENGTH + 1-1,
      atti.big_default);
      if (IIerrtest() != 0) goto IIrtB3;
/* # line 378 "feattacc.sc" */	/* host code */
                        /* EXEC SQL OPEN ii_attfetch FOR READONLY; */
                        blk->status = STATUS_OPEN;
                        goto process;
		_65compat:
...
*/
VOID
IIUIgdt_GetDefaultType(source, nullind, has_default, nulls, default_type)
char	*source;
i4	nullind;
char	*has_default;
char	*nulls;
