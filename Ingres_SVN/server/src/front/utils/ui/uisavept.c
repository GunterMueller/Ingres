...
/* # line 192 "uisavept.sc" */	/* execute */
  {
    IIsqInit((char *)0);
    IIsqExImmed(stmt_buffer);
    IIsyncup((char *)0,0);
  }
/* # line 193 "uisavept.sc" */	/* host code */
	if ((ret = FEinqerr()) != OK)
	{
		/* 
...
*/
VOID
IIUIasp_abortSP(sp, mytrans, no_op)
char	*sp;
bool	mytrans;
bool 	no_op;
{
	...
	else
	{
		STcopy("ROLLBACK WORK TO ", stmt_buffer);
	    	STcat(stmt_buffer, sp);
/* # line 310 "uisavept.sc" */	/* execute */
  {
    IIsqInit((char *)0);
    IIsqExImmed(stmt_buffer);
    IIsyncup((char *)0,0);
  }
/* # line 311 "uisavept.sc" */	/* host code */
	}
}
