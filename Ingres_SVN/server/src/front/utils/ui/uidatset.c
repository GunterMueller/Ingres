...
/* # line 333 "uidatset.sc" */	/* inquire_ingres */
  {
    IILQisInqSqlio((short *)0,1,32,UI_SAVEBUF_SIZE-1,glob_buffer,10);
  }
/* # line 334 "uidatset.sc" */	/* host code */
...
/* # line 483 "uidatset.sc" */	/* set_ingres */
  {
    IILQssSetSqlio(10,(short *)0,1,32,0,glob_buffer);
  }
/* # line 484 "uidatset.sc" */	/* host code */
}
/*{
...
"select user_name, dba_name from iidbconstants");
    IIretinit((char *)0,0);
    if (IInextget() != 0) {
      IIgetdomio((short *)0,1,32,FE_MAXNAME+1-1,uidbdata->user);
      IIgetdomio((short *)0,1,32,FE_MAXNAME+1-1,uidbdata->dba);
    } /* IInextget */
    IIsqFlush((char *)0,0);
  }
/* # line 557 "uidatset.sc" */	/* host code */
	}
	else
	{ /* Gateway */
	    if ( (rval = FEinqerr()) == OK )
...
"select user_name, dba_name, system_owner from iidbconstants");
    ...
    if (IInextget() != 0) {
      IIgetdomio((short *)0,1,32,FE_MAXNAME+1-1,uidbdata->user);
      IIgetdomio((short *)0,1,32,FE_MAXNAME+1-1,uidbdata->dba);
      IIgetdomio((short *)0,1,32,FE_MAXNAME+1-1,uidbdata->catowner);
    } /* IInextget */
    IIsqFlush((char *)0,0);
  }
/* # line 571 "uidatset.sc" */	/* host code */
		    }
		    else
		    {
			...
			*/
/* # line 585 "uidatset.sc" */	/* select */
  {
    IIsqInit((char *)0);
    IIsqMods(1);
    IIwritio(0,(short *)0,1,32,0,(char *)
"select table_owner, user_name, dba_name from iitables, iidbconstants \
where table_name=");
    IIputdomio((short *)0,1,32,0,cat_name);
    IIretinit((char *)0,0);
    if (IInextget() != 0) {
      IIgetdomio((short *)0,1,32,FE_MAXNAME+1-1,uidbdata->catowner);
      IIgetdomio((short *)0,1,32,FE_MAXNAME+1-1,uidbdata->user);
...
/* # line 590 "uidatset.sc" */	/* host code */
