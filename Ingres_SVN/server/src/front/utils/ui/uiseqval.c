...
/* Argument names */
static READONLY char ARGincrement[] = ERx("increment");
static READONLY char ARGstart_value[] = ERx("start_value");
/* {
...
/* # line 152 "uiseqval.sc" */	/* repeated update */
  {
    IIsexec();
    while (IInexec() == 0) {
      IIsqInit((char *)0);
      IIexExec(1,(char *)"uiseqval1",6497,14038);
      IIputdomio((short *)0,1,30,4,&increment);
      ...
      if (IInexec() == 0) {
        IIsqInit((char *)0);
        IIexDefine(1,(char *)"uiseqval1",6497,14038);
        IIwritio(0,(short *)0,1,32,0,(char *)
"update ii_sequence_values set sequence_value=sequence_value +");
        IIwritio(0,(short *)0,1,32,0,(char *)" $0=");
        IIputdomio((short *)0,1,30,4,&increment);
        IIwritio(0,(short *)0,1,32,0,(char *)"where sequence_owner=");
        IIwritio(0,(short *)0,1,32,0,(char *)" $1=");
        IIputdomio((short *)0,1,32,0,owner);
        IIwritio(0,(short *)0,1,32,0,(char *)"and sequence_table=");
        IIwritio(0,(short *)0,1,32,0,(char *)" $2=");
        IIputdomio((short *)0,1,32,0,table_name);
        IIwritio(0,(short *)0,1,32,0,(char *)"and sequence_column=");
        IIwritio(0,(short *)0,1,32,0,(char *)" $3=");
        IIputdomio((short *)0,1,32,0,column_name);
        IIexDefine(0,(char *)"uiseqval1",6497,14038);
        if (IIerrtest() == 0) {
          IIsexec();
        } /* IIerrtest */
      } /* IInexec */
...
/* # line 157 "uiseqval.sc" */	/* host code */
	if ( FEinqerr() != OK )
	{
		db_err = TRUE;
		goto ret;
	...
	{
		/* read the data back */
/* # line 165 "uiseqval.sc" */	/* select */
  {
    IIsqInit((char *)0);
    IIsqMods(1);
    IIwritio(0,(short *)0,1,32,0,(char *)
"select sequence_value from ii_sequence_values where sequence_owner=");
    IIputdomio((short *)0,1,32,0,owner);
    IIwritio(0,(short *)0,1,32,0,(char *)"and sequence_table=");
    IIputdomio((short *)0,1,32,0,table_name);
    IIwritio(0,(short *)0,1,32,0,(char *)"and sequence_column=");
    ...
    IIretinit((char *)0,0);
    if (IInextget() != 0) {
      IIgetdomio((short *)0,1,30,4,&value);
    } /* IInextget */
    IIsqFlush((char *)0,0);
  }
/* # line 170 "uiseqval.sc" */	/* host code */
	...
	else
	{
		...
		value += increment;
/* # line 186 "uiseqval.sc" */	/* insert */
  {
    IIsqInit((char *)0);
    IIwritio(0,(short *)0,1,32,0,(char *)
"insert into ii_sequence_values(sequence_owner, sequence_table, sequen\
ce_column, sequence_value)values(");
    IIputdomio((short *)0,1,32,0,owner);
    IIwritio(0,(short *)0,1,32,0,(char *)", ");
    IIputdomio((short *)0,1,32,0,table_name);
    IIwritio(0,(short *)0,1,32,0,(char *)", ");
...
/* # line 190 "uiseqval.sc" */	/* host code */
		if ( FEinqerr() != OK || FEinqrows() == 0 )
		{
			db_err = TRUE;
			goto ret;
...
/* # line 305 "uiseqval.sc" */	/* prepare */
  {
    IIsqInit((char *)0);
    IIsqPrepare(0,(char *)"s1",(char *)0,0,qtext);
  }
/* # line 306 "uiseqval.sc" */	/* host code */
	if (FEinqerr() != OK)
	{
		goto error;
	}
/* # line 310 "uiseqval.sc" */	/* describe */
  {
    IIsqInit((char *)0);
    IIsqDescribe(0,(char *)"s1",p_sqlda,0);
  }
/* # line 311 "uiseqval.sc" */	/* host code */
	if (FEinqerr() != OK)
	{
		goto error;
	}
...
/* # line 332 "uiseqval.sc" */	/* host code */
	if (FEinqerr() != OK)
	{
		goto error;
	}
