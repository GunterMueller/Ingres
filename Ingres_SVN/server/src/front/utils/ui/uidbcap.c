...
IIrtB1:
    while (IInextget() != 0) {
      IIgetdomio((short *)0,1,32,FE_MAXNAME+1-1,value);
      IIgetdomio((short *)0,1,32,FE_MAXNAME+1-1,capability);
      if (IIerrtest() != 0) goto IIrtB1;
/* # line 222 "uidbcap.sc" */	/* host code */
