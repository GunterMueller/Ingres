...
PTR	a10;
{
  ...
  char response[FE_PROMPTSIZE+1];
	...
	if ( _COLS == 0 || _ROWS == 0 )
	{
/* # line 134 "ufask.qsc" */	/* inquire_frs */
  {
    if (IIiqset(0,0,(char *)0, (char *)0, (char *)0) != 0) {
      IIiqfsio((short *)0,1,30,4,&_COLS,45,(char *)0,0);
      IIiqfsio((short *)0,1,30,4,&_ROWS,44,(char *)0,0);
    } /* IIiqset */
  }
/* # line 135 "ufask.qsc" */	/* host code */
	}
	...
	*/
	...
	{
		if ( !noecho && nopopup )
/* # line 191 "ufask.qsc" */	/* prompt */
  {
    IIprmptio(0,pptr,(short *)0,1,32,FE_PROMPTSIZE+1-1,response);
  }
/* # line 192 "ufask.qsc" */	/* host code */
		else if ( !noecho )
/* # line 193 "ufask.qsc" */	/* prompt */
  {
    IIFRgpcontrol(1,0);
    IIFRgpsetio(6,(short *)0,1,30,sizeof(301),(void *)IILQint(301));
    IIFRgpsetio(4,(short *)0,1,30,4,&cols);
    IIFRgpsetio(1,(short *)0,1,30,4,&row);
    IIFRgpsetio(2,(short *)0,1,30,4,&col);
    IIFRgpcontrol(2,0);
    IIprmptio(0,pptr,(short *)0,1,32,FE_PROMPTSIZE+1-1,response);
  }
/* # line 198 "ufask.qsc" */	/* host code */
		else
/* # line 199 "ufask.qsc" */	/* prompt */
  {
    IIFRgpcontrol(1,0);
    IIFRgpsetio(6,(short *)0,1,30,sizeof(301),(void *)IILQint(301));
    IIFRgpsetio(4,(short *)0,1,30,4,&cols);
    ...
    IIFRgpsetio(2,(short *)0,1,30,4,&col);
    IIFRgpcontrol(2,0);
    IIprmptio(1,pptr,(short *)0,1,32,FE_PROMPTSIZE+1-1,response);
  }
/* # line 205 "ufask.qsc" */	/* host code */
