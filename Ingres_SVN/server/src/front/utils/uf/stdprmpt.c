...
static READONLY	CONF_VAR	_confVar[]
= {
...
BOXPROMPT *bp;
  {
	...
	return FALSE;
    lfadd = (PTR) lf;
/* # line 410 "stdprmpt.qsc" */	/* addform */
    {
      IIaddform(lfadd);
    }
/* # line 412 "stdprmpt.qsc" */	/* host code */
    val =  ( bp->initbuf != NULL ) ? bp->initbuf : ERx("");
/* # line 413 "stdprmpt.qsc" */	/* putform */
    {
      if (IIfsetio(name) != 0) {
        IIputfldio((char *)"promptarea",(short *)0,1,32,0,val);
      } /* IIfsetio */
    }
/* # line 415 "stdprmpt.qsc" */	/* host code */
...
/* # line 425 "stdprmpt.qsc" */	/* display */
    {
      ...
      IIFRgpcontrol(2,0);
      if (IIdispfrm(name,(char *)"f") == 0) goto IIfdE1;
      goto IImuI1;
IIfdI1:;
IIfdB1:
      while (IIrunform() != 0) {
        if (IIretval() == 1) {
          {
/* # line 429 "stdprmpt.qsc" */	/* host code */
	val = bp->buffer;
/* # line 430 "stdprmpt.qsc" */	/* getform */
            {
              if (IIfsetio(name) != 0) {
                IIgetfldio((short *)0,1,32,0,val,(char *)"promptarea");
              } /* IIfsetio */
            }
/* # line 431 "stdprmpt.qsc" */	/* host code */
	_VOID_ IIFRkeystroke((FUNCPTR)NULL);
	if (bp->vfn == NULL || (*(bp->vfn))(val,bp->len))
	{
	    rval = TRUE;
/* # line 435 "stdprmpt.qsc" */	/* enddisplay */
            {
              if (1) goto IIfdF1;
            }
/* # line 436 "stdprmpt.qsc" */	/* host code */
	}
	...
	On_menu = FALSE;
          ...
          {
/* # line 444 "stdprmpt.qsc" */	/* host code */
	rval = FALSE;
/* # line 445 "stdprmpt.qsc" */	/* enddisplay */
            {
              if (1) goto IIfdF1;
            }
          }
          ...
          {
/* # line 451 "stdprmpt.qsc" */	/* host code */
	if ( bp->hfile != NULL )
	{
		_VOID_ IIFRkeystroke((FUNCPTR)NULL);
		...
		On_menu = FALSE;
          ...
          {
/* # line 462 "stdprmpt.qsc" */	/* host code */
	val = bp->buffer;
/* # line 463 "stdprmpt.qsc" */	/* getform */
            {
              if (IIfsetio(name) != 0) {
                IIgetfldio((short *)0,1,32,0,val,(char *)"promptarea");
              } /* IIfsetio */
            }
/* # line 464 "stdprmpt.qsc" */	/* host code */
	_VOID_ IIFRkeystroke((FUNCPTR)NULL);
	if ((*(bp->lfn))(val,bp->len))
	{
	    rval = TRUE;
/* # line 468 "stdprmpt.qsc" */	/* enddisplay */
            {
              if (1) goto IIfdF1;
            }
/* # line 469 "stdprmpt.qsc" */	/* host code */
	}
	_VOID_ IIFRkeystroke(keycatch);
	On_menu = FALSE;
          }
...
IImuI1:
      ...
      if (IInmuact(ERget(FE_Cancel),ERget(_CancelExpl),2,2,2) == 0) goto IIfdE1;
      IIFRInternal(0);
      if (IInfrskact(9,ERget(_CancelExpl),2,2,2) == 0) goto IIfdE1;
      if (IInmuact(hitem,ERget(_HelpExpl ),2,2,3) == 0) goto IIfdE1;
      IIFRInternal(0);
      if (IInfrskact(1,ERget(_HelpExpl),2,2,3) == 0) goto IIfdE1;
      if (IInmuact(lchoice,(char *)0,2,2,4) == 0) goto IIfdE1;
      if (IIendmu() == 0) goto IIfdE1;
      goto IIfdI1;
IIfdE1:;
      IIendfrm();
    }
/* # line 474 "stdprmpt.qsc" */	/* host code */
