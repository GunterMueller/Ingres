...
*/
bool
IIRTdohelp ( name, subject, menu, submu, vfrfiq, fld_hlp )
char	*name;
  char *subject;
MENU	menu;
bool	submu;
...
VOID	(*fld_hlp)();
{
  ...
  char *fldmenu;
  char *hfilenam;
  char tform[FE_MAXNAME+1], tfield[FE_MAXNAME+1], tcolumn[FE_MAXNAME+1];
		...
		if ( IIisfrm() )
  {
    ...
    char _[]= ERx("");
    char _mode[10];
/* # line 371 "rthelp.qsc" */	/* inquire_frs */
    {
      if (IIiqset(1,0,(char *)0, (char *)0, (char *)0) != 0) {
        IIiqfsio((short *)0,1,32,FE_MAXNAME+1-1,tform,19,(char *)0,0);
        IIiqfsio((short *)0,1,32,FE_MAXNAME+1-1,tfield,22,(char *)0,0);
        IIiqfsio((short *)0,1,32,9,_mode,21,(char *)0,0);
      } /* IIiqset */
    }
/* # line 375 "rthelp.qsc" */	/* host code */
			if ( STtrmwhite(tfield) > 0 && !STequal(_mode, _Read) )
    {
      i4 istable;
/* # line 379 "rthelp.qsc" */	/* inquire_frs */
      {
        if (IIiqset(2,0,_,(char *)0, (char *)0) != 0) {
          IIiqfsio((short *)0,1,30,4,&istable,28,(char *)0,0);
          IIiqfsio((short *)0,1,32,9,_mode,21,(char *)0,0);
        } /* IIiqset */
      }
/* # line 382 "rthelp.qsc" */	/* host code */
				if ( istable == 1 )
				{ /* it is a table field */
/* # line 384 "rthelp.qsc" */	/* inquire_frs */
      {
        if (IIiqset(3,0,_,(char *)0, (char *)0) != 0) {
          IIiqfsio((short *)0,1,32,9,_mode,21,(char *)0,0);
        } /* IIiqset */
      }
/* # line 386 "rthelp.qsc" */	/* host code */
					if ( !STequal(_mode, _Read) )
					{ /* Table is updatable */
/* # line 388 "rthelp.qsc" */	/* inquire_frs */
      {
        if (IIiqset(4,0,_,_,(char *)0) != 0) {
          IIiqfsio((short *)0,1,32,FE_MAXNAME+1-1,tcolumn,19,(char *)0,0);
          IIiqfsio((short *)0,1,32,9,_mode,21,(char *)0,0);
        } /* IIiqset */
      }
/* # line 393 "rthelp.qsc" */	/* host code */
						if ( !STequal(_mode, _Read) )
						{ /* Updatable */
...
IImuI1:
    ...
    if (IInmuact(ERget(F_UF000C_WhatToDo),(char *)0,2,2,1) == 0) goto IIfdE1;
    if (IInmuact(ERget(F_UF000D_Keys),(char *)0,2,2,2) == 0) goto IIfdE1;
    if (IInmuact(fldmenu,(char *)0,2,2,3) == 0) goto IIfdE1;
...
/* # line 553 "rthelp.qsc" */	/* clear */
  {
    IIclrscr();
  }
/* # line 554 "rthelp.qsc" */	/* host code */
	}
	else
	{ /* Called from EQUEL or general FEs */
		if (submu)
		{
			i4	(*oldproc)();
			IIrebld();
/* # line 562 "rthelp.qsc" */	/* clear */
  {
    IIclrscr();
  }
/* # line 563 "rthelp.qsc" */	/* host code */
			oldproc = IIseterr(errproc);
/* # line 564 "rthelp.qsc" */	/* redisplay */
  {
    IIredisp();
  }
/* # line 565 "rthelp.qsc" */	/* host code */
			IIseterr(oldproc);
		}
	}
	return FALSE;
