...
static READONLY
  char _FileForm[]= ERx("uffile"), _PrintForm[]= ERx("ufprint"), _blank[]= ERx("")
  , _filename[]= ERx("filename"), _printer[]= ERx("printer"), _copies[]= ERx("copies")
  , _FileHelp[]= ERx("uffile.hlp"), _PrintHelp[]= ERx("ufprint.hlp");
/*
...
/* # line 373 "ufbrsave.qsc" */	/* inquire_frs */
      {
        if (IIiqset(1,0,(char *)0, (char *)0, (char *)0) != 0) {
          IIiqfsio((short *)0,1,30,4,&xsize,45,_FileForm,0);
          IIiqfsio((short *)0,1,30,4,&ysize,44,_FileForm,0);
        } /* IIiqset */
      }
/* # line 375 "ufbrsave.qsc" */	/* host code */
		xput = min(xpos, bcb->mx_cols - xsize - 1);
		yput = min(ypos, bcb->mx_rows - ysize - 1); /* account for menu line */
/* # line 377 "ufbrsave.qsc" */	/* display */
      {
        IIFRgpcontrol(1,0);
        IIFRgpsetio(6,(short *)0,1,30,sizeof(301),(void *)IILQint(301));
        IIFRgpsetio(2,(short *)0,1,30,4,&xput);
        IIFRgpsetio(1,(short *)0,1,30,4,&yput);
        IIFRgpcontrol(2,0);
        if (IIdispfrm(_FileForm,(char *)"f") == 0) goto IIfdE1;
        goto IImuI1;
IIfdI1:;
        if (IIfsetio((char *)0) == 0) goto IIfdE1;
        IIputfldio((char *)"title",(short *)0,1,32,0,file_title);
IIfdB1:
        while (IIrunform() != 0) {
          if (IIretval() == 1) {
            {
              i2 null_file;
/* # line 386 "ufbrsave.qsc" */	/* getform */
              {
                if (IIfsetio((char *)0) != 0) {
                  IIgetfldio(&null_file,1,32,MAX_LOC+1-1,filebuf,_filename);
                } /* IIfsetio */
              }
/* # line 387 "ufbrsave.qsc" */	/* host code */
			if ( null_file == DB_EMB_NULL )
			{
				IIUGerr(E_UF0056_no_filename, 0, 0);
/* # line 390 "ufbrsave.qsc" */	/* resume */
              {
                IIresfld(_filename);
                if (1) goto IIfdB1;
              }
/* # line 391 "ufbrsave.qsc" */	/* host code */
			}
			else if ( _ValidFilename(filebuf, &loc) != OK )
			{
/* # line 394 "ufbrsave.qsc" */	/* resume */
              {
                IIresfld(_filename);
                if (1) goto IIfdB1;
              }
/* # line 395 "ufbrsave.qsc" */	/* host code */
			}
			if (!bcb->req_complete)
			{
				/*
			   ...
			   IIUFbot_Bottom(bcb);
/* # line 413 "ufbrsave.qsc" */	/* breakdisplay */
              {
                if (1) goto IIfdE1;
              }
            }
            ...
            {
/* # line 419 "ufbrsave.qsc" */	/* host code */
			break_fl = TRUE;
/* # line 420 "ufbrsave.qsc" */	/* breakdisplay */
              {
                if (1) goto IIfdE1;
              }
            }
            ...
            {
              i2 null_file;
/* # line 427 "ufbrsave.qsc" */	/* getform */
              {
                if (IIfsetio((char *)0) != 0) {
                  IIgetfldio(&null_file,1,32,MAX_LOC+1-1,filebuf,_filename);
                } /* IIfsetio */
              }
/* # line 428 "ufbrsave.qsc" */	/* host code */
			if ( null_file == DB_EMB_NULL )
			{
				IIUGerr(E_UF0056_no_filename, 0, 0);
/* # line 431 "ufbrsave.qsc" */	/* resume */
              {
                IIresfld(_filename);
                if (1) goto IIfdB1;
              }
/* # line 432 "ufbrsave.qsc" */	/* host code */
			}
			else if ( _ValidFilename(filebuf, &loc) != OK )
			{
/* # line 435 "ufbrsave.qsc" */	/* resume */
              {
                IIresfld(_filename);
                if (1) goto IIfdB1;
              }
/* # line 436 "ufbrsave.qsc" */	/* host code */
			}
/* # line 437 "ufbrsave.qsc" */	/* breakdisplay */
              {
                if (1) goto IIfdE1;
              }
            }
            ...
            {
/* # line 443 "ufbrsave.qsc" */	/* host code */
...
IImuI1:
        ...
        if (IInmuact(ERget(FE_OK),ERget(F_UF007B_ExplFileOK),2,2,1) == 0) 
        goto IIfdE1;
        IIFRInternal(0);
        ...
        if (IInmuact(file_partial,ERget(F_UF007C_ExplFilePartial),2,2,3) == 0
        ) goto IIfdE1;
...
/* # line 446 "ufbrsave.qsc" */	/* host code */
...
#ifdef DGC_AOS
/* # line 495 "ufbrsave.qsc" */	/* clear */
  {
    IIclrscr();
  }
/* # line 496 "ufbrsave.qsc" */	/* host code */
#endif /* DGC_AOS */
# endif /* hp9_mpe */
	if ( retstat != OK )
	{ /* Could not open file */
...
QRB	*qrb;
{
  ...
  i4 putx, puty;
	...
	*/
	/* Get the size of the popup */
/* # line 767 "ufbrsave.qsc" */	/* inquire_frs */
  {
    if (IIiqset(1,0,(char *)0, (char *)0, (char *)0) != 0) {
      IIiqfsio((short *)0,1,30,4,&sizex,45,_PrintForm,0);
      IIiqfsio((short *)0,1,30,4,&sizey,44,_PrintForm,0);
    } /* IIiqset */
  }
/* # line 768 "ufbrsave.qsc" */	/* host code */
	putx = min(posx, bcb->mx_cols - sizex - 1);
	puty = min(posy, bcb->mx_rows - sizey - 1); /* account for menu line */
/* # line 771 "ufbrsave.qsc" */	/* display */
  {
    IIFRgpcontrol(1,0);
    IIFRgpsetio(6,(short *)0,1,30,sizeof(301),(void *)IILQint(301));
    IIFRgpsetio(2,(short *)0,1,30,4,&putx);
    IIFRgpsetio(1,(short *)0,1,30,4,&puty);
    IIFRgpcontrol(2,0);
    if (IIdispfrm(_PrintForm,(char *)"f") == 0) goto IIfdE2;
    goto IImuI2;
IIfdI2:;
    if (IIfsetio((char *)0) == 0) goto IIfdE2;
    IIputfldio((char *)"title",(short *)0,1,32,0,print_title);
    {
/* # line 775 "ufbrsave.qsc" */	/* getform */
      {
        if (IIfsetio((char *)0) != 0) {
          IIgetfldio((short *)0,1,32,MAX_LOC+1-1,default_str,_printer);
        } /* IIfsetio */
      }
    }
IIfdB2:
      ...
      if (IIretval() == 1) {
        {
          ...
          i2 null_file;
          i2 null_copies;
/* # line 784 "ufbrsave.qsc" */	/* getform */
          {
            if (IIfsetio((char *)0) != 0) {
              IIgetfldio(&null_printer,1,32,MAX_LOC+1-1,printbuf,_printer);
              IIgetfldio(&null_copies,1,30,4,&copies,_copies);
              IIgetfldio(&null_file,1,32,MAX_LOC+1-1,filbuf,_filename);
            } /* IIfsetio */
          }
/* # line 788 "ufbrsave.qsc" */	/* host code */
		if ( null_printer == DB_EMB_NULL )
		{
			IIUGerr(E_UF0059_no_printer, 0, 0);
/* # line 791 "ufbrsave.qsc" */	/* putform */
          {
            if (IIfsetio((char *)0) != 0) {
              IIputfldio(_printer,(short *)0,1,32,0,default_str);
            } /* IIfsetio */
          }
/* # line 792 "ufbrsave.qsc" */	/* resume */
          {
            IIresfld(_printer);
            if (1) goto IIfdB2;
          }
/* # line 793 "ufbrsave.qsc" */	/* host code */
		}
		else if ( null_copies == DB_EMB_NULL )
		{
			IIUGerr(E_UF0053_no_copy, 0, 0);
/* # line 797 "ufbrsave.qsc" */	/* putform */
          {
            if (IIfsetio((char *)0) != 0) {
              IIputfldio(_copies,(short *)0,1,30,sizeof(1),(void *)IILQint(1));
            } /* IIfsetio */
          }
/* # line 798 "ufbrsave.qsc" */	/* resume */
          {
            IIresfld(_copies);
            if (1) goto IIfdB2;
          }
/* # line 799 "ufbrsave.qsc" */	/* host code */
		}
		else if ( null_file == DB_EMB_NULL )
		{
			IIUGerr(E_UF0056_no_filename, 0, 0);
/* # line 803 "ufbrsave.qsc" */	/* resume */
          {
            IIresfld(_filename);
            if (1) goto IIfdB2;
          }
/* # line 804 "ufbrsave.qsc" */	/* host code */
		}
		else if ( _ValidFilename(filbuf, &loc) != OK )
		{
/* # line 807 "ufbrsave.qsc" */	/* resume */
          {
            IIresfld(_filename);
            if (1) goto IIfdB2;
          }
/* # line 808 "ufbrsave.qsc" */	/* host code */
		}
...
/* # line 827 "ufbrsave.qsc" */	/* breakdisplay */
          {
            if (1) goto IIfdE2;
          }
        }
        ...
        {
/* # line 833 "ufbrsave.qsc" */	/* host code */
		break_fl = TRUE;
/* # line 834 "ufbrsave.qsc" */	/* breakdisplay */
          {
            if (1) goto IIfdE2;
          }
        }
...
/* # line 848 "ufbrsave.qsc" */	/* host code */
		if ( null_printer == DB_EMB_NULL )
		{
			IIUGerr(E_UF0059_no_printer, 0, 0);
/* # line 851 "ufbrsave.qsc" */	/* putform */
          {
            if (IIfsetio((char *)0) != 0) {
              IIputfldio(_printer,(short *)0,1,32,0,default_str);
            } /* IIfsetio */
          }
/* # line 852 "ufbrsave.qsc" */	/* resume */
          {
            IIresfld(_printer);
            if (1) goto IIfdB2;
          }
/* # line 853 "ufbrsave.qsc" */	/* host code */
		}
		else if ( null_copies == DB_EMB_NULL )
		{
			IIUGerr(E_UF0053_no_copy, 0, 0);
/* # line 857 "ufbrsave.qsc" */	/* resume */
          {
            IIresfld(_copies);
            if (1) goto IIfdB2;
          }
/* # line 858 "ufbrsave.qsc" */	/* host code */
		}
		else if ( null_file == DB_EMB_NULL )
		{
			IIUGerr(E_UF0056_no_filename, 0, 0);
/* # line 862 "ufbrsave.qsc" */	/* resume */
          {
            IIresfld(_filename);
            if (1) goto IIfdB2;
          }
/* # line 863 "ufbrsave.qsc" */	/* host code */
		}
		else if ( _ValidFilename(filbuf, &loc) != OK )
		{
/* # line 866 "ufbrsave.qsc" */	/* resume */
          {
            IIresfld(_filename);
            if (1) goto IIfdB2;
          }
/* # line 867 "ufbrsave.qsc" */	/* host code */
		}
		u_print = ( STbcompare(printbuf, 0, default_str, 0, TRUE) == 0 )
				? NULL : printbuf;
/* # line 871 "ufbrsave.qsc" */	/* breakdisplay */
          {
            if (1) goto IIfdE2;
          }
        }
        ...
        {
/* # line 877 "ufbrsave.qsc" */	/* host code */
...
IImuI2:
    ...
    if (IInmuact(ERget(FE_OK),ERget(F_UF007D_ExplPrintOK),2,2,1) == 0) goto 
    IIfdE2;
    IIFRInternal(0);
    ...
    goto IIfdE2;
    IIFRInternal(0);
    if (IInfrskact(9,(char *)0,0,0,2) == 0) goto IIfdE2;
    if (IInmuact(print_partial,ERget(F_UF007E_ExplPrintPartial),2,2,3) == 0) 
    goto IIfdE2;
    if (IInmuact(ERget(FE_Help),ERget(F_FE0100_ExplFrameHelp),0,2,4) == 0) 
    goto IIfdE2;
    IIFRInternal(0);
...
/* # line 880 "ufbrsave.qsc" */	/* host code */
	IIMTlf(FALSE);	/* Turn off popup on scrollable output */
	if (break_fl)
		return retstat;
