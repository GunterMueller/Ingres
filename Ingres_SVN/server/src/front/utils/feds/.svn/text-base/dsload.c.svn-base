...
# elif defined(ris_us5) || defined(rs4_us5) || defined(sgi_us5) || \
       defined(ris_u64)
...
# if defined(ris_us5) || defined(rs4_us5) || defined(sgi_us5) || \
     defined(ris_u64) || defined(i64_win) || defined(a64_win)
				*ptr = (char *)save_off;
# else
				*ptr = save_off;
# endif /* ris_us5 rs4_us5 sgi_us5 ris_u64 i64_win a64_win */
				continue;
			}
...
# if defined(rs4_us5) || defined(i64_aix)
                        TRdisplay("");
# endif /* rs4_us5 */
