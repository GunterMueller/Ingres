...
#define R_PAGES         6
      { TRUE, ERx("rows"), ERx("")},		
#define R_ROWS          7
      { TRUE, ERx("journaled"), ERx("")},	
#define R_JOURNALED     8
      { TRUE, ERx("stostru_bastab"), ERx("")},
#define R_STOSTRU_BASTAB 9			
      { TRUE, ERx("ovpag_basown"), ERx("")},	
#define R_OVPAG_BASOWN  10			
};
...
/* # line 413 "tutabinf.qsc" */	/* set_frs */
    {
      if (IIiqset(2,0,frm,(char *)0, (char *)0) != 0) {
        IIstfsio(54,p_tblinfo->form_fldname,0,(short *)0,1,30,sizeof(0),
        (void *)IILQint(0));
      } /* IIiqset */
    }
/* # line 415 "tutabinf.qsc" */	/* putform */
    {
      if (IIfsetio(frm) != 0) {
        IIputfldio(p_tblinfo->form_fldname,(short *)0,1,32,0,p_tblinfo->value);
      } /* IIfsetio */
    }
/* # line 417 "tutabinf.qsc" */	/* host code */
	    /* make certain fields invisible */
	    if (p_tblinfo->disp == FALSE)
	    {
/* # line 420 "tutabinf.qsc" */	/* set_frs */
    {
      if (IIiqset(2,0,frm,(char *)0, (char *)0) != 0) {
        IIstfsio(54,p_tblinfo->form_fldname,0,(short *)0,1,30,sizeof(1),
        (void *)IILQint(1));
      } /* IIiqset */
    }
/* # line 421 "tutabinf.qsc" */	/* host code */
	    }
	}
  }
