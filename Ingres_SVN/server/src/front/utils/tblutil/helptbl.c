...
FUNC_EXTERN	i2	FEgettag();
FUNC_EXTERN	PTR	FEreqmem();
FUNC_EXTERN	STATUS	FEfree();
...
char	*twidth;
{
  ...
  i4 key_id = 0;
	...
	*/
	...
	{
		rval = OK;
/* # line 149 "helptbl.sc" */	/* repeated select */
  {
    IIsexec();
    while (IInexec() == 0) {
      IIsqInit((char *)0);
      IIexExec(1,(char *)"helptbl1",6478,3818);
      IIputdomio((short *)0,1,32,0,table_name);
      IIputdomio((short *)0,1,32,0,table_owner);
      IIretinit((char *)0,0);
      if (IInexec() == 0) {
        IIsqInit((char *)0);
        IIexDefine(1,(char *)"helptbl1",6478,3818);
        IIwritio(0,(short *)0,1,32,0,(char *)
"select key_sequence, column_name from iicolumns where table_name=");
        ...
        IIexDefine(0,(char *)"helptbl1",6478,3818);
        if (IIerrtest() == 0) {
          IIsexec();
        } /* IIerrtest */
      } /* IInexec */
...
IIrtB1:
    while (IInextget() != 0) {
      IIgetdomio((short *)0,1,30,4,&keyed);
      IIgetdomio((short *)0,1,32,FE_UNRML_MAXNAME+1-1,colname);
      if (IIerrtest() != 0) goto IIrtB1;
/* # line 156 "helptbl.sc" */	/* host code */
			numkeys++;
			...
			if (rval != OK)
			{
/* # line 162 "helptbl.sc" */	/* endselect */
      {
        IIbreak();
        if (1) goto IIrtE1;
      }
/* # line 163 "helptbl.sc" */	/* host code */
			}
			new->next = keylist;
			new->keynum = keyed;
			STtrmwhite(colname);
...
IIrtE1:;
		...
		if (numkeys == 0) /* no keys in iicolumns; check iialt_columns*/
		{
			...
			** Fixed 9/12/89 (pete).
			*/
/* # line 190 "helptbl.sc" */	/* select */
  {
    IIsqInit((char *)0);
    IIwritio(0,(short *)0,1,32,0,(char *)
"select key_sequence, column_name, key_id from iialt_columns where tab\
le_name=");
    IIputdomio((short *)0,1,32,0,table_name);
    IIwritio(0,(short *)0,1,32,0,(char *)"and table_owner=");
    IIputdomio((short *)0,1,32,0,table_owner);
...
IIrtB2:
    while (IInextget() != 0) {
      IIgetdomio((short *)0,1,30,4,&keyed);
      IIgetdomio((short *)0,1,32,FE_UNRML_MAXNAME+1-1,colname);
      IIgetdomio((short *)0,1,30,4,&key_id);
      if (IIerrtest() != 0) goto IIrtB2;
/* # line 197 "helptbl.sc" */	/* host code */
				...
				{
/* # line 203 "helptbl.sc" */	/* endselect */
      {
        IIbreak();
        if (1) goto IIrtE2;
      }
/* # line 204 "helptbl.sc" */	/* host code */
				}
				numkeys++;
 				new= (struct TU_KEYSTRUCT *)FEreqmem((u_i4)tag,
 					(u_i4)sizeof(struct TU_KEYSTRUCT),
				...
				if (rval != OK)
				{
/* # line 211 "helptbl.sc" */	/* endselect */
      {
        IIbreak();
        if (1) goto IIrtE2;
      }
/* # line 212 "helptbl.sc" */	/* host code */
				}
				new->next = keylist;
				new->keynum = keyed;
				STtrmwhite(colname);
...
IIrtE2:;
  ...
  i4 dkey = 0;
			...
			*/
			...
			attrcount ++;
/* # line 434 "helptbl.qsc" */	/* loadtable */
  {
    if (IItbact(formname,formtbl,1) != 0) {
      IItcoputio((char *)"name",(short *)0,1,32,0,colname);
      IItcoputio((char *)"datafmt",(short *)0,1,32,0,typename);
      IItcoputio((char *)"key",(short *)0,1,32,0,isindex);
      IItcoputio((char *)"nullable",(short *)0,1,32,0,null_value);
      IItcoputio((char *)"defable",(short *)0,1,32,0,def_value);
      IItcoputio((char *)"default_lkey",(short *)0,1,30,4,&dkey);
      IITBceColEnd();
    } /* IItbact */
  }
/* # line 441 "helptbl.qsc" */	/* host code */
		}	/* end while loop */
