...
char	*args[];
{
  ...
  char reply[80];
    ...
    */
    ...
    if (testing)
    {
	status = UTexe(UT_WAIT, err_locp, (ModDictDesc *) NULL, NULL, subsys,
...
#ifndef CMS
		FTprtrestore();
/* # line 174 "fespawn.qsc" */	/* prompt */
  {
    IIprmptio(0,ERget(S_TU0017_Press_RETURN_to_clear),(short *)0,1,32,79,reply);
  }
/* # line 175 "fespawn.qsc" */	/* host code */
		FTrestore(FT_FORMS);
# else
		FTmore();
#endif
	...
	{
		FTrestore(FT_FORMS);
/* # line 195 "fespawn.qsc" */	/* clear */
  {
    IIclrscr();
  }
/* # line 196 "fespawn.qsc" */	/* host code */
