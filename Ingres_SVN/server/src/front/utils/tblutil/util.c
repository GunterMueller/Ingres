...
FUNC_EXTERN	bool		IITUvunValueUserNull( char *mvdefault );
/* static's */
static	PTR	tu_table;
static	PTR	tu_view;
static	PTR	tu_index;
...
static
  char _Form[]= ERx("tutopfr"), _Tblfld[]= ERx("tbllist");
/*{
...
char *dat2;
  {
	...
	i4  col1_compare = 0;
	i4  col2_compare = 0;
/* # line 197 "util.qsc" */	/* unloadtable */
    {
      if (IItbact(form,tblfld,0) == 0) goto IItbE1;
      while (IItunload() != 0) {
        IItcogetio((short *)0,1,32,FE_MAXNAME+1-1,col1_dat,col1);
        IItcogetio((short *)0,1,32,FE_MAXNAME+1-1,col2_dat,col2);
        IItcogetio((short *)0,1,30,4,&record,(char *)"_RECORD");
        IITBceColEnd();
        {
/* # line 200 "util.qsc" */	/* host code */
	    /*
	    ...
	    */
		...
		else
		{
		    ...
		    */
		    foundit = TRUE;
/* # line 220 "util.qsc" */	/* endloop */
          {
            if (1) goto IItbE1;
          }
/* # line 221 "util.qsc" */	/* host code */
		}
            }
	    else
	    {
		...
		foundit = TRUE;
/* # line 227 "util.qsc" */	/* endloop */
          {
            if (1) goto IItbE1;
          }
/* # line 228 "util.qsc" */	/* host code */
	    }
        }
      } /* IItunload */
IItbE1:
	...
	*insert_row = TRUE;
	...
	if (STcompare(IIUIscl_StdCatLevel(), UI_LEVEL_64) <= 0)
	{
	    ...
	    */
	    if (record > 0)
	    {
/* # line 315 "util.qsc" */	/* scroll */
    {
      if (IItbsetio(1,form,tblfld,-3) != 0) {
        IItbsmode((char *)"to");
        if (IItscroll(0,record) != 0) {
        } /* IItscroll */
      } /* IItbsetio */
    }
/* # line 317 "util.qsc" */	/* inquire_frs */
    {
      if (IIiqset(3,0,form,(char *)0, (char *)0) != 0) {
        IIiqfsio((short *)0,1,30,4,&disp_row,29,(char *)0,0);
      } /* IIiqset */
    }
/* # line 319 "util.qsc" */	/* getrow */
    {
      if (IItbsetio(2,form,tblfld,disp_row) != 0) {
        IItcogetio((short *)0,1,32,FE_MAXNAME+1-1,tmp_tname,colname);
        IITBceColEnd();
      } /* IItbsetio */
    }
/* # line 321 "util.qsc" */	/* host code */
...
/* # line 328 "util.qsc" */	/* inquire_frs */
    {
      if (IIiqset(3,0,form,(char *)0, (char *)0) != 0) {
        IIiqfsio((short *)0,1,30,4,&numrows,32,tblfld,0);
      } /* IIiqset */
    }
/* # line 329 "util.qsc" */	/* host code */
	        if (numrows > 0)
	        {
		    /* table field has data. new entry goes before
		    ** first row in table field
		    */
/* # line 334 "util.qsc" */	/* scroll */
    {
      if (IItbsetio(1,form,tblfld,-3) != 0) {
        IItbsmode((char *)"to");
        if (IItscroll(0,1) != 0) {
...
/* # line 336 "util.qsc" */	/* inquire_frs */
    {
      if (IIiqset(3,0,form,(char *)0, (char *)0) != 0) {
        IIiqfsio((short *)0,1,30,4,&disp_row,29,(char *)0,0);
      } /* IIiqset */
    }
/* # line 338 "util.qsc" */	/* getrow */
    {
      if (IItbsetio(2,form,tblfld,disp_row) != 0) {
        IItcogetio((short *)0,1,32,FE_MAXNAME+1-1,tmp_tname,colname);
        IITBceColEnd();
...
/* # line 359 "util.qsc" */	/* inquire_frs */
    {
      if (IIiqset(3,0,form,(char *)0, (char *)0) != 0) {
        IIiqfsio((short *)0,1,30,4,&disp_row,29,(char *)0,0);
      } /* IIiqset */
    }
/* # line 360 "util.qsc" */	/* host code */
	    }
	    else
	    {
/* # line 363 "util.qsc" */	/* inquire_frs */
    {
      if (IIiqset(3,0,form,(char *)0, (char *)0) != 0) {
        IIiqfsio((short *)0,1,30,4,&numrows,32,tblfld,0);
      } /* IIiqset */
    }
/* # line 364 "util.qsc" */	/* host code */
	        if (numrows > 0)
	        {
		    /* new entry goes before first row in table field */
/* # line 367 "util.qsc" */	/* scroll */
    {
      if (IItbsetio(1,form,tblfld,-3) != 0) {
        IItbsmode((char *)"to");
        if (IItscroll(0,1) != 0) {
...
/* # line 368 "util.qsc" */	/* inquire_frs */
    {
      if (IIiqset(3,0,form,(char *)0, (char *)0) != 0) {
        IIiqfsio((short *)0,1,30,4,&disp_row,29,(char *)0,0);
      } /* IIiqset */
    }
/* # line 369 "util.qsc" */	/* host code */
...
/* # line 447 "util.qsc" */	/* message */
  {
    IImessage(ERget(F_TU003A_Loading_Tables));
  }
/* # line 449 "util.qsc" */	/* inittable */
  {
    if (IItbinit(_Form,_Tblfld,(char *)"r") != 0) {
      IIthidecol((char *)"ictype",(char *)"i4");
      IItfill();
    } /* IItbinit */
  }
/* # line 450 "util.qsc" */	/* set_frs */
  {
    if (IIiqset(4,0,_Form,_Tblfld,(char *)0) != 0) {
      IIstfsio(21,(char *)"owner",0,(short *)0,1,32,0,(char *)"f");
    } /* IIiqset */
  }
/* # line 452 "util.qsc" */	/* host code */
/* b68076 */
...
/* # line 491 "util.qsc" */	/* loadtable */
  {
    if (IItbact(_Form,_Tblfld,1) != 0) {
      IItcoputio((char *)"table",(short *)0,1,32,0,rname);
      IItcoputio((char *)"owner",(short *)0,1,32,0,rown);
      IItcoputio((char *)"type",(short *)0,1,32,0,tbltype);
      IItcoputio((char *)"ictype",(short *)0,1,30,4,&tblictype);
      IITBceColEnd();
    } /* IItbact */
  }
/* # line 493 "util.qsc" */	/* host code */
		}
...
bool	maychange;
  ...
  char *rrowner;
  {
	...
	bool	isdelim  = FALSE;
	bool	dmy	 = FALSE;
/* # line 619 "util.qsc" */	/* inquire_frs */
    {
      if (IIiqset(3,0,_Form,(char *)0, (char *)0) != 0) {
        IIiqfsio((short *)0,1,30,4,&numrows,31,_Tblfld,0);
      } /* IIiqset */
    }
/* # line 620 "util.qsc" */	/* host code */
	if (numrows == 0)
	{
...
/* # line 627 "util.qsc" */	/* getrow */
    {
      if (IItbsetio(2,_Form,_Tblfld,-2) != 0) {
        IItcogetio((short *)0,1,32,0,tblname,(char *)"table");
        IItcogetio((short *)0,1,32,0,rrowner,(char *)"owner");
        IITBceColEnd();
      } /* IItbsetio */
    }
/* # line 629 "util.qsc" */	/* host code */
...
/* # line 664 "util.qsc" */	/* inquire_frs */
    {
      if (IIiqset(3,0,_Form,(char *)0, (char *)0) != 0) {
        IIiqfsio((short *)0,1,30,4,&numrows,31,_Tblfld,0);
      } /* IIiqset */
    }
/* # line 665 "util.qsc" */	/* host code */
/* harpa06 */
		    if (numrows == 0)
		    {
...
i4	rownumber;
  {
	...
	if (rownumber > 0)
	{
/* # line 802 "util.qsc" */	/* inquire_frs */
    {
      if (IIiqset(3,0,_Form,(char *)0, (char *)0) != 0) {
        IIiqfsio((short *)0,1,30,4,&numrecs,32,_Tblfld,0);
        IIiqfsio((short *)0,1,30,4,&numrows,31,_Tblfld,0);
      } /* IIiqset */
    }
/* # line 805 "util.qsc" */	/* host code */
		currrec = min(rownumber+(numrows*3/4), numrecs);
/* # line 806 "util.qsc" */	/* scroll */
    {
...
/* # line 807 "util.qsc" */	/* getrow */
    {
      if (IItbsetio(2,_Form,_Tblfld,numrows) != 0) {
        IItcogetio((short *)0,1,30,4,&currrec,(char *)"_RECORD");
        IITBceColEnd();
      } /* IItbsetio */
    }
/* # line 808 "util.qsc" */	/* host code */
		IIrowset(_Form, _Tblfld,
			 numrows - (currrec-rownumber), ERx("table"));
	}
	else
	{
/* # line 813 "util.qsc" */	/* scroll */
    {
      if (IItbsetio(1,_Form,_Tblfld,-3) != 0) {
        IItbsmode((char *)"to");
        if (IItscroll(0,1) != 0) {
...
/* # line 822 "util.qsc" */	/* loadtable */
    {
      if (IItbact(_Form,_Tblfld,1) != 0) {
        IItcoputio((char *)"table",(short *)0,1,32,0,ERx(""));
        IItcoputio((char *)"owner",(short *)0,1,32,0,ERx(""));
        IItcoputio((char *)"ictype",(short *)0,1,30,4,&tbltype);
        IITBceColEnd();
      } /* IItbact */
    }
/* # line 824 "util.qsc" */	/* set_frs */
    {
      if (IIiqset(4,0,_Form,_Tblfld,(char *)0) != 0) {
        IIstfsio(21,(char *)"type",0,(short *)0,1,32,0,(char *)"r");
      } /* IIiqset */
    }
/* # line 825 "util.qsc" */	/* set_frs */
    {
...
/* # line 903 "util.qsc" */	/* unloadtable */
    {
      if (IItbact(form,tblfld,0) == 0) goto IItbE2;
      while (IItunload() != 0) {
        IItcogetio((short *)0,1,32,(2*FE_MAXNAME)+1-1,column_value,tblcol);
        IItcogetio((short *)0,1,30,4,&record,(char *)"_RECORD");
        IITBceColEnd();
        {
/* # line 905 "util.qsc" */	/* host code */
            /* case insensitive compare */
            if (STbcompare(column_value,0, match,0, TRUE) == 0)
            {
                row = record;
/* # line 909 "util.qsc" */	/* endloop */
          {
            if (1) goto IItbE2;
          }
/* # line 910 "util.qsc" */	/* host code */
            }
        }
      } /* IItunload */
IItbE2:
