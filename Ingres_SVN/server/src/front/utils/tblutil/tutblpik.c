...
FUNC_EXTERN	bool	IIFRmdfMakeDefaultForm();
...
static 		STATUS	get_form_ready();
  static char Table_name[FE_MAXTABNAME+1];
...
static
  char *Form;
static
  char Mainform[]= ERx("iitutbllstpik");
static
  char Subform[]= ERx("iitutbllstpik2");
static
  char Col[]= ERx("table_name");
static
  char Own[]= ERx("table_owner");
  ...
  char tbl_name[FE_MAXNAME+1];
	...
	*/
	while (Tu_lp_state != TU_LP_DONE)
	{
	    ...
	    {
/* # line 287 "tutblpik.qsc" */	/* message */
  {
    IImessage(ERget(F_TU0049_Selecting_Names));
  }
/* # line 288 "tutblpik.qsc" */	/* inittable */
  {
    if (IItbinit(Form,Form,(char *)"r") != 0) {
      IIthidecol((char *)"owner",(char *)"varchar(32)");
      IItfill();
    } /* IItbinit */
  }
/* # line 290 "tutblpik.qsc" */	/* host code */
		...
		rows = load_tbllist(Form, Form);
		    ...
		    else
		    {
			    ...
			    ** message and return.
			    */
/* # line 340 "tutblpik.qsc" */	/* message */
  {
    IIFRgpcontrol(1,0);
    IIFRgpsetio(6,(short *)0,1,30,sizeof(301),(void *)IILQint(301));
    IIFRgpcontrol(2,0);
    IImessage(ERget(S_TU0052_EmptyDB_Msg));
  }
/* # line 341 "tutblpik.qsc" */	/* host code */
		    }
	...
	*/
	if (++sel_row > 0)
	{
		...
		own_name[0] = EOS;
/* # line 381 "tutblpik.qsc" */	/* scroll */
  {
    if (IItbsetio(1,Form,Form,-3) != 0) {
      IItbsmode((char *)"to");
      if (IItscroll(0,sel_row) != 0) {
      } /* IItscroll */
    } /* IItbsetio */
  }
/* # line 382 "tutblpik.qsc" */	/* getrow */
  {
    if (IItbsetio(2,Form,Form,-2) != 0) {
      IItcogetio((short *)0,1,32,FE_MAXNAME+1-1,tbl_name,Col);
      IItcogetio((short *)0,1,32,FE_MAXNAME+1-1,own_name,Own);
      IITBceColEnd();
    } /* IItbsetio */
  }
/* # line 384 "tutblpik.qsc" */	/* host code */
...
/* # line 435 "tutblpik.qsc" */	/* inittable */
  {
    if (IItbinit(Form,Form,(char *)"r") != 0) {
      IItfill();
    } /* IItbinit */
  }
/* # line 437 "tutblpik.qsc" */	/* host code */
  ...
  i4 err = 0;
	if (IituMainform)
	{
	    ...
	    if (!Lp_formready)
	    {
	        ...
	        Lp_formready = TRUE;
		lfaddr = (PTR) lf;
/* # line 520 "tutblpik.qsc" */	/* addform */
  {
    IIaddform(lfaddr);
  }
/* # line 521 "tutblpik.qsc" */	/* inquire_frs */
  {
    if (IIiqset(0,0,(char *)0, (char *)0, (char *)0) != 0) {
      IIiqfsio((short *)0,1,30,4,&err,1,(char *)0,0);
    } /* IIiqset */
  }
/* # line 522 "tutblpik.qsc" */	/* host code */
	    }
	}
	else
	{
		...
		lfaddr = (PTR) lf;
/* # line 538 "tutblpik.qsc" */	/* addform */
  {
    IIaddform(lfaddr);
  }
/* # line 539 "tutblpik.qsc" */	/* inquire_frs */
  {
    if (IIiqset(0,0,(char *)0, (char *)0, (char *)0) != 0) {
      IIiqfsio((short *)0,1,30,4,&err,1,(char *)0,0);
    } /* IIiqset */
  }
/* # line 540 "tutblpik.qsc" */	/* host code */
	    }
	}
...
/* # line 608 "tutblpik.qsc" */	/* getrow */
  {
    if (IItbsetio(2,Form,Form,-2) != 0) {
      IItcogetio((short *)0,1,32,FE_MAXNAME+1-1,table_name,Col);
      IItcogetio((short *)0,1,32,FE_MAXNAME+1-1,table_owner,Own);
      IITBceColEnd();
    } /* IItbsetio */
  }
/* # line 609 "tutblpik.qsc" */	/* host code */
  ...
  char *table;
{
  ...
  char rown[FE_MAXNAME+1];
	...
	while (FErel_fetch(&rel_block, &rel_info) == OK)
	{
		...
		*/
/* # line 696 "tutblpik.qsc" */	/* loadtable */
  {
    if (IItbact(form,table,1) != 0) {
      IItcoputio(Col,(short *)0,1,32,0,rel_info.name);
      IItcoputio(Own,(short *)0,1,32,0,rown);
      IITBceColEnd();
    } /* IItbact */
  }
/* # line 697 "tutblpik.qsc" */	/* host code */
		    i++;
		}
	}
