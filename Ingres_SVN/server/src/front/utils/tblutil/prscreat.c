...
/* # line 241 "prscreat.qsc" */	/* unloadtable */
  {
    if (IItbact(ERx("tucreatefr"),ERx("attributes"),0) == 0) goto IItbE1;
    while (IItunload() != 0) {
      IItcogetio((short *)0,1,32,FE_UNRML_MAXNAME + 1-1,attrname,(char *)
"name");
      IItcogetio((short *)0,1,32,TU_DATATYPE_SIZE+1-1,dtype,(char *)
"datafmt");
      IItcogetio((short *)0,1,32,4,keyno,(char *)"key");
      IItcogetio((short *)0,1,32,4,isnullable,(char *)"nullable");
      IItcogetio((short *)0,1,32,6,deflt,(char *)"defable");
      IItcogetio((short *)0,1,30,4,&ustate,(char *)"_STATE");
      IItcogetio((short *)0,1,30,4,&dkey,(char *)"default_lkey");
      IItcogetio((short *)0,1,30,4,&urow,(char *)"_RECORD");
      IITBceColEnd();
      {
/* # line 251 "prscreat.qsc" */	/* host code */
	switch(ustate)
	{
	    case stNEW:
	    case stUNCHANGED:
...
/* # line 572 "prscreat.qsc" */	/* host code */
    *p_modcolbuf = EOS;
