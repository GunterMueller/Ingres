...
i4	a1;
{
	...
	return OOsnd(*id, _rename, new) != NULL ? OK : FAIL;
}
/*{
...
PTR	a0,a1,a2,a3,a4,a5,a6,a7,a8;
{
	register OOID		obj;
	if ((obj = *id <= 0 ?
    	    /* 3 lint truncation warnings if size of ptr > OOID, 
	       but code valid */
	    (OOID)OOsnd(class, _newDb, FALSE, a0,a1,a2,a3,a4,a5,a6,a7,a8) :
	    (OOID)OOsnd(*id, _init, a0,a1,a2,a3,a4,a5,a6,a7,a8)) == nil ||
		(obj = (OOID)OOsnd(obj, ii_flushAll)) == nil)
		    return FAIL;
	else
	    *id = obj;
	return OK;
