...
char		*pattern, *lastname, *qualif;
  {
	...
	if (qualif == (char *)NULL)
	{
/* # line 96 "obcatfor.qsc" */	/* inquire_frs */
    {
      if (IIiqset(3,0,form,(char *)0, (char *)0) != 0) {
        IIiqfsio((short *)0,1,30,4,&cat.c_maxrow,30,tablefield,0);
      } /* IIiqset */
    }
/* # line 98 "obcatfor.qsc" */	/* host code */
...
char *mode;
{
	...
	if (mode != NULL)
/* # line 353 "obcatfor.qsc" */	/* loadtable */
  {
    if (IItbact(form,tablefield,1) != 0) {
      IItcoputio(_name,(short *)0,1,32,0,_iiOOempty);
      IITBceColEnd();
    } /* IItbact */
  }
/* # line 354 "obcatfor.qsc" */	/* host code */
}
VOID
...
/* # line 371 "obcatfor.qsc" */	/* inquire_frs */
    {
      if (IIiqset(3,0,frm,(char *)0, (char *)0) != 0) {
        IIiqfsio((short *)0,1,30,4,&cat.c_maxrow,30,tfield,0);
      } /* IIiqset */
    }
/* # line 373 "obcatfor.qsc" */	/* host code */
