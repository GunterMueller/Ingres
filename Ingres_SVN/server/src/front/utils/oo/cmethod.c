...
/* # line 469 "cmethod.sc" */	/* select */
  {
    IIsqInit((char *)0);
    IIwritio(0,(short *)0,1,32,0,(char *)
"select object_id, object_name, object_owner from ii_objects where ");
    IIwritio(1,(short *)0,1,32,0,where_clause);
    IIwritio(0,(short *)0,1,32,0,(char *)
...
IIrtB1:
    while (IInextget() != 0) {
      IIgetdomio((short *)0,1,30,4,&id[i]);
      IIgetdomio((short *)0,1,32,FE_MAXNAME+1-1,name[i]);
      IIgetdomio((short *)0,1,32,FE_MAXNAME+1-1,owner[i]);
      if (IIerrtest() != 0) goto IIrtB1;
/* # line 475 "cmethod.sc" */	/* host code */
		++found;
		/* a hack to pick out user vs. dba objects */
	        if (IIuserIndex == 0)
		{
/* # line 479 "cmethod.sc" */	/* endselect */
      {
        IIbreak();
        if (1) goto IIrtE1;
      }
/* # line 480 "cmethod.sc" */	/* host code */
		}
		if (i == 0) 
		{
			++i;
...
/* # line 488 "cmethod.sc" */	/* endselect */
      {
        IIbreak();
        if (1) goto IIrtE1;
      }
/* # line 489 "cmethod.sc" */	/* host code */
		}
    } /* IInextget */
    IIflush((char *)0,0);
IIrtE1:;
