...
/* # line 144 "catcover.qsc" */	/* set_frs */
    {
      if (IIiqset(1,0,(char *)0, (char *)0, (char *)0) != 0) {
        IIstfsio(21,form,0,(short *)0,1,32,0,(char *)"u");
      } /* IIiqset */
    }
  }
/* # line 148 "catcover.qsc" */	/* host code */
/*
...
/* # line 198 "catcover.qsc" */	/* inquire_frs */
    {
      if (IIiqset(3,0,form,(char *)0, (char *)0) != 0) {
        IIiqfsio((short *)0,1,32,9,mode,21,tabl,0);
      } /* IIiqset */
    }
/* # line 199 "catcover.qsc" */	/* host code */
...
bool            empty = empty_i;           
	...
	cat.c_form = form;
	cat.c_tfield = tabl;
/* # line 298 "catcover.qsc" */	/* inquire_frs */
    {
      if (IIiqset(3,0,form,(char *)0, (char *)0) != 0) {
        IIiqfsio((short *)0,1,30,4,&cat.c_maxrow,30,tabl,0);
      } /* IIiqset */
    }
/* # line 299 "catcover.qsc" */	/* host code */
	cat.c_noload = empty;
	cat.c_class = OOpclass(class);
...
/* # line 486 "catcover.qsc" */	/* inquire_frs */
    {
      if (IIiqset(3,0,form,(char *)0, (char *)0) != 0) {
        IIiqfsio((short *)0,1,30,4,&cat.c_maxrow,30,table,0);
      } /* IIiqset */
    }
/* # line 488 "catcover.qsc" */	/* host code */
