...
/* # line 111 "catutil.qsc" */	/* inquire_frs */
    {
      if (IIiqset(3,0,self->c_form,(char *)0, (char *)0) != 0) {
        IIiqfsio((short *)0,1,30,4,&self->c_maxrow,30,self->c_tfield,0);
      } /* IIiqset */
    }
/* # line 115 "catutil.qsc" */	/* host code */
	if ( noload )
/* # line 116 "catutil.qsc" */	/* loadtable */
    {
      if (IItbact(self->c_form,self->c_tfield,1) != 0) {
        IItcoputio(_name,(short *)0,1,32,0,_iiOOempty);
        IITBceColEnd();
      } /* IItbact */
    }
  }
/* # line 120 "catutil.qsc" */	/* host code */
/*{
...
VOID
  ...
  register OO_CATALOG *self;
  {
/* # line 141 "catutil.qsc" */	/* clear */
    {
      IIfldclear(self->c_tfield);
    }
/* # line 143 "catutil.qsc" */	/* host code */
	if ( self->c_noload )
	{
/* # line 145 "catutil.qsc" */	/* loadtable */
    {
      if (IItbact(self->c_form,self->c_tfield,1) != 0) {
        IItcoputio(_name,(short *)0,1,32,0,_iiOOempty);
        IItcoputio(_id,(short *)0,1,30,sizeof(-1),(void *)IILQint(-1));
        IITBceColEnd();
      } /* IItbact */
    }
/* # line 146 "catutil.qsc" */	/* set_frs */
    {
      if (IIiqset(1,0,(char *)0, (char *)0, (char *)0) != 0) {
        IIstfsio(21,self->c_form,0,(short *)0,1,32,0,(char *)"u");
      } /* IIiqset */
    }
/* # line 147 "catutil.qsc" */	/* host code */
	}
  }
/*
...
/* # line 196 "catutil.qsc" */	/* inquire_frs */
    {
      if (IIiqset(3,0,self->c_form,(char *)0, (char *)0) != 0) {
        IIiqfsio((short *)0,1,30,4,&rowcount,31,self->c_tfield,0);
      } /* IIiqset */
    }
/* # line 197 "catutil.qsc" */	/* host code */
	if ( rowcount == 1)
	{
		/* Found one row, but it might be a dummy. */
/* # line 200 "catutil.qsc" */	/* getrow */
    {
...
/* # line 201 "catutil.qsc" */	/* host code */
	}
...
/* # line 210 "catutil.qsc" */	/* getrow */
    {
      if (IItbsetio(2,self->c_form,self->c_tfield,-2) != 0) {
        IItcogetio((short *)0,1,30,4,&id,_id);
        IItcogetio((short *)0,1,32,sizeof(record->name)-1,name,_name);
        IITBceColEnd();
      } /* IItbsetio */
    }
/* # line 212 "catutil.qsc" */	/* host code */
...
/* # line 229 "catutil.qsc" */	/* inquire_frs */
    {
      if (IIiqset(3,0,self->c_form,(char *)0, (char *)0) != 0) {
        IIiqfsio((short *)0,1,30,4,&rowcount,31,self->c_tfield,0);
      } /* IIiqset */
    }
/* # line 233 "catutil.qsc" */	/* host code */
...
/* # line 247 "catutil.qsc" */	/* host code */
		}
		/*
	...
	*/
	if ( record != NULL )
	{
/* # line 263 "catutil.qsc" */	/* getrow */
    {
      if (IItbsetio(2,self->c_form,self->c_tfield,-2) != 0) {
        IItcogetio((short *)0,1,32,FE_MAXNAME+1-1,record->name,_name);
        IItcogetio((short *)0,1,30,4,&record->id,_id);
        IItcogetio((short *)0,1,30,4,&record->class,_class);
        IItcogetio((short *)0,1,32,DB_MAXNAME+1-1,record->owner,_owner);
        IItcogetio((short *)0,1,30,4,&record->env,_env);
        IItcogetio((short *)0,1,30,4,&record->is_current,_is_current);
        IItcogetio((short *)0,1,32,OOSHORTREMSIZE+1-1,record->short_remark,
        _short_remark);
        IItcogetio((short *)0,1,32,OODATESIZE+1-1,record->create_date,
        _create_date);
        IItcogetio((short *)0,1,32,OODATESIZE+1-1,record->alter_date,
        _altr_date);
        IItcogetio((short *)0,1,32,DB_MAXNAME+1-1,record->altered_by,
        _last_altered_by);
        IItcogetio((short *)0,1,30,4,&record->alter_cnt,_altr_count);
        IITBceColEnd();
      } /* IItbsetio */
    }
/* # line 276 "catutil.qsc" */	/* host code */
...
/* # line 318 "catutil.qsc" */	/* clear */
    {
      IIfldclear(self->c_tfield);
    }
/* # line 319 "catutil.qsc" */	/* host code */
	...
	if ( _send(catCheck, self)(self, row) == OK )
	{
		...
		if ( IIOOidCheck(&class, &row->id, row->name, owner) != OK )
		{
		 ...
		 if (IIUFccConfirmChoice(
				CONF_DESTROY, row->name, OOsnd(class, _name), 
...
/* # line 411 "catutil.qsc" */	/* deleterow */
    {
...
/* # line 412 "catutil.qsc" */	/* host code */
				return OK;
			}
		}
	}
		...
		if ( ans[0] != EOS && (CVlower(ans), !STequal(row->name, ans)) )
		{
			...
			else
			{
				...
				else
				{
					...
					{
/* # line 531 "catutil.qsc" */	/* deleterow */
    {
      if (IItbsetio(4,self->c_form,self->c_tfield,-2) != 0) {
        if (IItdelrow(0) != 0) {
        } /* IItdelrow */
...
/* # line 533 "catutil.qsc" */	/* host code */
