	...
	*/
	if (qry->qg_child == NULL && !(qstr->qg_state & QS_OSL))
	{
		...
		*/
		...
		if (input == QI_USTART || input == QI_UOSL)
		{
/* # line 177 "qgv0.qsc" */	/* retrieve */
  {
    IIwritio(0,(short *)0,1,32,0,(char *)"retrieve unique(");
    IIparret(tlist, argv,(int *)0);
    IIwritio(0,(short *)0,1,32,0,(char *)")where ");
    IIwritio(1,(short *)0,1,32,0,wclause);
    IIretinit((char *)0,0);
...
/* # line 181 "qgv0.qsc" */	/* host code */
		}
		else
		{
/* # line 184 "qgv0.qsc" */	/* retrieve */
  {
...
/* # line 186 "qgv0.qsc" */	/* host code */
	...
	brk_qry:
				...
				*/
/* # line 193 "qgv0.qsc" */	/* endretrieve */
        {
          IIbreak();
          if (1) goto IIrtE2;
        }
/* # line 194 "qgv0.qsc" */	/* host code */
	next_qry:
				rval = OK;
      }
    } /* IInextget */
...
/* # line 270 "qgv0.qsc" */	/* host code */
		}
		else
		{
/* # line 273 "qgv0.qsc" */	/* retrieve */
  {
    IIwritio(0,(short *)0,1,32,0,(char *)"retrieve(");
    IIparret(tlist, argv,(int *)0);
    IIwritio(0,(short *)0,1,32,0,(char *)")where ");
...
QDV0	*qry;
{
	...
	*/
	...
	qstr->qg_bsize = (i4) alloc;
     	/* lint truncation warning if size of ptr > int, but code valid */
	if ((qstr->qg_buffer = (char *)MEreqmem((u_i4)0, (u_i4)alloc, FALSE,
	    (STATUS *)NULL)) == NULL)
	{
		return QE_MEM;
	}
	...
	for (cp = qry->qg_param, alloc = qstr->qg_buffer,
...
DB_DATA_VALUE	*dbv;
{
    ...
    ADF_CB  *FEadfcb();
    adfcb = FEadfcb();
    if (afe_pad(adfcb, ptr, dbv->db_datatype, &offset) != OK)
    {
	FEafeerr(adfcb);
	return FAIL;
    }
...
static VOID
  ...
  {
    {
/* # line 935 "qgv0.qsc" */	/* set_equel */
      {
        IIeqstio((char *)"rowcount",(short *)0,1,30,4,&tcnt);
      }
    }
  }
