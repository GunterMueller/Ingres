	...
	*/
	...
	if (cu_gbfexist(class, name, owner))
	{
		...
		*addobj = FALSE;
	    ...
	    iiuicw1_CatWriteOn();  /* In case it got turned off */
/* # line 276 "cuaddobj.sc" */	/* repeat delete */
  {
    IIsexec();
    while (IInexec() == 0) {
      IIsqInit((char *)0);
      IIexExec(1,(char *)"cuaddobj1",6486,29145);
      IIputdomio((short *)0,1,32,0,name);
      IIputdomio((short *)0,1,32,0,owner);
      IIsyncup((char *)0,0);
      if (IInexec() == 0) {
        IIsqInit((char *)0);
        IIexDefine(1,(char *)"cuaddobj1",6486,29145);
        IIwritio(0,(short *)0,1,32,0,(char *)
"delete from graphs where graphid=");
        IIwritio(0,(short *)0,1,32,0,(char *)" $0=");
        IIputdomio((short *)0,1,32,0,name);
        IIwritio(0,(short *)0,1,32,0,(char *)"and gowner=");
        IIwritio(0,(short *)0,1,32,0,(char *)" $1=");
        IIputdomio((short *)0,1,32,0,owner);
        IIexDefine(0,(char *)"cuaddobj1",6486,29145);
        if (IIerrtest() == 0) {
          IIsexec();
        } /* IIerrtest */
      } /* IInexec */
...
/* # line 278 "cuaddobj.sc" */	/* repeat delete */
  {
    IIsexec();
    while (IInexec() == 0) {
      IIsqInit((char *)0);
      IIexExec(1,(char *)"cuaddobj2",6487,32727);
      IIputdomio((short *)0,1,32,0,name);
      IIputdomio((short *)0,1,32,0,owner);
      IIsyncup((char *)0,0);
      if (IInexec() == 0) {
        IIsqInit((char *)0);
        IIexDefine(1,(char *)"cuaddobj2",6487,32727);
        IIwritio(0,(short *)0,1,32,0,(char *)
"delete from gcommands where graphid=");
        IIwritio(0,(short *)0,1,32,0,(char *)" $0=");
        IIputdomio((short *)0,1,32,0,name);
        IIwritio(0,(short *)0,1,32,0,(char *)"and gowner=");
        IIwritio(0,(short *)0,1,32,0,(char *)" $1=");
        IIputdomio((short *)0,1,32,0,owner);
        IIexDefine(0,(char *)"cuaddobj2",6487,32727);
        if (IIerrtest() == 0) {
          IIsexec();
        } /* IIerrtest */
      } /* IInexec */
...
/* # line 279 "cuaddobj.sc" */	/* host code */
	}
	/* begin transaction */
	IIUIbeginXaction();
	return FEinqerr();
