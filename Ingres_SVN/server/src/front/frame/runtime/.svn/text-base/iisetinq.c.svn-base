...
i4
IIfssetio(name, nullind, isvar, type, len, tdata)
char	*name;				/* string containing name of field */
i2	*nullind;			/* Ptr to null indicator */
i4	isvar;				/* flag indicating whether variable */
i4	type;				/* data type of variable */
i4	len;				/* length in bytes of data */
PTR	tdata;				/* data value */
{
...
i4
IIfrsset(name, variable, type, len, tdata)
char	*name;				/* string containing name of field */
i4	variable;			/* flag indicating whether variable */
i4	type;				/* data type of variable */
i4	len;				/* length in bytes of data */
char	*tdata;				/* set of possible data types */
{
...
i4
IIfsinqio( nullind, variable, type, len, data, name)
i2	*nullind;				/* ptr to null indicator */
i4	variable;				/* flag - variable? */
...
i4
IIfrsinq(variable, type, len, data, name)
i4	variable;				/* flag - variable? */
i4	type;					/* variable data type */
i4	len;					/* length of data in bytes */
PTR	data;					/* data value*/
