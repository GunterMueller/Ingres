...
i4
IIputfldio(s1, ind, isvar, type, len, data)
char	*s1;		/* string containing name of field */
i2	*ind;		/* Ptr to the null indicator */
i4	isvar;		/* flag indicating whether variable */
i4	type;		/* data type of variable */
i4	len;		/* length in bytes of data */
PTR	data;		/* value from equel */
