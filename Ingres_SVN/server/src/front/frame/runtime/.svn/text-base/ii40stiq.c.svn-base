...
FUNC_EXTERN	RUNFRM		*IIget_stkf();
FUNC_EXTERN	RUNFRM		*RTgetfrm();
FUNC_EXTERN	TBSTRUCT	*RTgettbl();
FUNC_EXTERN	FIELD		*RTgetfld();
FUNC_EXTERN	FLDCOL		*RTgetcol();
FUNC_EXTERN	i4		RTinqsys();
FUNC_EXTERN	i4		RTinqfrm();
FUNC_EXTERN	i4		RTinqfld();
FUNC_EXTERN	i4		RTinqtbl();
FUNC_EXTERN	i4		RTinqcol();
FUNC_EXTERN	i4		RTinqrow();
FUNC_EXTERN	i4		RTinqrc();
FUNC_EXTERN	i4		RTsetsys();
FUNC_EXTERN	i4		RTsetfrm();
FUNC_EXTERN	i4		RTsetfld();
FUNC_EXTERN	i4		RTsettbl();
FUNC_EXTERN	i4		RTsetcol();
FUNC_EXTERN	i4		RTsetrow();
FUNC_EXTERN	i4		RTsetrc();
...
IIsimobj(pobj, attr, objname, row,  RTcode, arg1, arg2)
i4	pobj;
i4	attr;
char	*objname;
i4	row;
...
i4
IIstfsio(attr, name, row, nullind, isvar, type, length, tdata)
i4	attr;
char	*name;
i4	row;
i2	*nullind;
...
*/
i4
IIstfrs(attr, name, row, isvar, type, length, tdata)
i4	attr;
char	*name;
i4	row;
i4	isvar;
...
/* VARARGS4 */
i4
IIiqfsio(nullind, isvar, type, length, data, attr, name, row)
i2	*nullind;
i4	isvar;
i4	type;
i4	length;
...
*/
RUNFRM	*
IIget_stkf(argcnt, minargs, object, nml)
i4	argcnt;
i4	minargs;
char	*object;
char	**nml;
...
i4
IIiqfrs(isvar, type, length, data, attr, name, row)
i4	isvar;
i4	type;
i4	length;
PTR	data;
