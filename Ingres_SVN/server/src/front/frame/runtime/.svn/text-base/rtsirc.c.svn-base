...
FUNC_EXTERN	VOID		IITBscaSetCellAttr();
FUNC_EXTERN	STATUS		IITBicaInqCellAttr();
FUNC_EXTERN	i4		RTfindcolor();
FUNC_EXTERN	char		*IIstrconv();
FUNC_EXTERN	i4		IIgetrtcode();
