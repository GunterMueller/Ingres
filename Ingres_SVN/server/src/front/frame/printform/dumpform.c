...
/* # line 231 "dumpform.sc" */	/* select */
  {
    IIsqInit((char *)0);
    IIsqMods(1);
    IIwritio(0,(short *)0,1,32,0,(char *)
"select object_id, create_date, alter_date from ii_objects where objec\
t_name=");
    IIputdomio((short *)0,1,32,0,formname);
    ...
    IIretinit((char *)0,0);
    if (IInextget() != 0) {
      IIgetdomio((short *)0,1,30,4,&oo_id);
      IIgetdomio((short *)0,1,32,25,fcdate);
      IIgetdomio((short *)0,1,32,25,fadate);
    } /* IInextget */
    IIsqFlush((char *)0,0);
  }
/* # line 237 "dumpform.sc" */	/* inquire_ingres */
  {
    IILQisInqSqlio((short *)0,1,30,4,&rcount,8);
  }
/* # line 238 "dumpform.sc" */	/* host code */
		if (rcount == 0)
		{
			/* Set fowner to dba */
			STcopy(uidbdata->dba, fowner);
/* # line 242 "dumpform.sc" */	/* select */
  {
    IIsqInit((char *)0);
    IIsqMods(1);
    IIwritio(0,(short *)0,1,32,0,(char *)
...
/* # line 248 "dumpform.sc" */	/* host code */
		}
/* # line 249 "dumpform.sc" */	/* select */
  {
    IIsqInit((char *)0);
    IIwritio(0,(short *)0,1,32,0,(char *)
"select frmaxcol, frmaxlin, frfldno, frnsno, frtrimno, frflags, frposy\
, frposx from ii_forms where object_id=");
    IIputdomio((short *)0,1,30,4,&oo_id);
    IIretinit((char *)0,0);
    if (IIerrtest() != 0) goto IIrtE1;
IIrtB1:
    while (IInextget() != 0) {
      IIgetdomio((short *)0,1,30,4,&fmaxcol);
      IIgetdomio((short *)0,1,30,4,&fmaxlin);
      IIgetdomio((short *)0,1,30,4,&ffldno);
      IIgetdomio((short *)0,1,30,4,&fnsno);
      IIgetdomio((short *)0,1,30,4,&ftrimno);
      IIgetdomio((short *)0,1,30,4,&fflags);
      IIgetdomio((short *)0,1,30,4,&fbegrow);
      IIgetdomio((short *)0,1,30,4,&fbegcol);
      if (IIerrtest() != 0) goto IIrtB1;
/* # line 256 "dumpform.sc" */	/* host code */
...
/* # line 303 "dumpform.sc" */	/* select */
  {
    IIsqInit((char *)0);
    IIwritio(0,(short *)0,1,32,0,(char *)
"select flseq, fldname, fldatatype, fllength, flprec, fltitle, fldflag\
s, fld2flags, fldefault, flformat, flvalmsg, flvalchk, fltype, flsubse\
q from ii_fields where object_id=");
    IIputdomio((short *)0,1,30,4,&oo_id);
...
IIrtB2:
    while (IInextget() != 0) {
      IIgetdomio((short *)0,1,30,4,&fseq);
      IIgetdomio((short *)0,1,32,FE_MAXNAME + 1-1,fname);
      IIgetdomio((short *)0,1,30,4,&fdtype);
      IIgetdomio((short *)0,1,30,4,&flength);
      IIgetdomio((short *)0,1,30,4,&fprec);
      IIgetdomio((short *)0,1,32,50,ftitle);
      IIgetdomio((short *)0,1,30,4,&fflags);
      IIgetdomio((short *)0,1,30,4,&f2flags);
      IIgetdomio((short *)0,1,32,50,fdefault);
      IIgetdomio((short *)0,1,32,50,fformat);
      IIgetdomio((short *)0,1,32,100,fvalmsg);
      IIgetdomio((short *)0,1,32,255,fvalchk);
      IIgetdomio((short *)0,1,30,4,&ftype);
      IIgetdomio((short *)0,1,30,4,&fsubseq);
      if (IIerrtest() != 0) goto IIrtB2;
/* # line 315 "dumpform.sc" */	/* host code */
			STtrmwhite(fname);
			STtrmwhite(ftitle);
			STtrmwhite(fdefault);
			STtrmwhite(fformat);
...
IIrtE2:;
		...
		*/
/* # line 614 "dumpform.sc" */	/* select */
  {
    IIsqInit((char *)0);
    IIwritio(0,(short *)0,1,32,0,(char *)
"select trim_col, trim_lin, trim_trim, trim_flags from ii_trim where o\
bject_id=");
    IIputdomio((short *)0,1,30,4,&oo_id);
    IIretinit((char *)0,0);
...
IIrtB3:
    while (IInextget() != 0) {
      IIgetdomio((short *)0,1,30,4,&tposx);
      IIgetdomio((short *)0,1,30,4,&tposy);
      IIgetdomio((short *)0,1,32,fdTRIMLEN + 1-1,ttrm);
      IIgetdomio((short *)0,1,30,4,&tflags);
      if (IIerrtest() != 0) goto IIrtB3;
/* # line 619 "dumpform.sc" */	/* host code */
			/*
