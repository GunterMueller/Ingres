...
# ifdef IBM370
		STpolycat(2,
		 ...
		 ERx(" VALUES (?, ?, ?, ?, ?)"), sql_buf);
/* # line 211 "cfcomp.sc" */	/* prepare */
  {
    IIsqInit((char *)0);
    IIsqPrepare(0,(char *)"cfcpcf_stmt",(char *)0,0,sql_buf);
  }
/* # line 212 "cfcomp.sc" */	/* execute */
  {
    IIsqInit((char *)0);
    IIsqExStmt((char *)"cfcpcf_stmt",1);
    IIputdomio((short *)0,1,30,4,&cffrmid);
...
/* # line 213 "cfcomp.sc" */	/* host code */
# else
/* # line 214 "cfcomp.sc" */	/* repeated insert */
  {
    IIsexec();
    while (IInexec() == 0) {
      IIsqInit((char *)0);
      IIexExec(1,(char *)"cfcomp1",6471,18417);
      IIputdomio((short *)0,1,30,4,&cffrmid);
      IIputdomio((short *)0,1,30,4,&seqno);
      IIputdomio((short *)0,1,30,4,&rowsize);
      IIputdomio((short *)0,1,30,4,&cfsize);
      ...
      if (IInexec() == 0) {
        IIsqInit((char *)0);
        IIexDefine(1,(char *)"cfcomp1",6471,18417);
...
fdata)values(");
        ...
        IIputdomio((short *)0,1,44,0,&dbv);
        IIwritio(0,(short *)0,1,32,0,(char *)")");
        IIexDefine(0,(char *)"cfcomp1",6471,18417);
        if (IIerrtest() == 0) {
          IIsexec();
        } /* IIerrtest */
      } /* IInexec */
