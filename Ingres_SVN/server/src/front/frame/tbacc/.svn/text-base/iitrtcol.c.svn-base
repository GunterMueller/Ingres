...
i4
IItcolret(variable, type, len, data, colname)
i4	variable;				/* must be var for a ret col */
i4	type;
i4	len;
PTR	data;					/* ptr to legal C types	 */
char	*colname;
{
...
/* VARARGS4 */
i4
IItcogetio(ind, variable, type, len, data, colname)
i2	*ind;		/* null indicator */
i4	variable;	/* must be var for a ret col */
i4	type;		/* embedded type */
i4	len;		/* length of data */
PTR	data;		/* location to put data into */
char	*colname;
{
