...
FUNC_EXTERN	TBSTRUCT	*IIunldstate();
FUNC_EXTERN	i4		IIrec_num();
FUNC_EXTERN	i4		IItvalval();
FUNC_EXTERN	COLDESC		*IIcdget();
FUNC_EXTERN	VOID		IIFDscaSetCellAttr();
FUNC_EXTERN	FLDCOL		*FDfndcol();
FUNC_EXTERN	ADF_CB		*FEadfcb();
FUNC_EXTERN	i4		RTselcolor();
...
i4
IItbsetio(cmnd, formname, tabname, rownum)
i4		cmnd;	
char		*formname;
char		*tabname;
i4		rownum;
...
IITBicb(rfrm, tbs, colname, row, uservar)
RUNFRM		*rfrm;
TBSTRUCT	*tbs;
char		*colname;
i4		row;
...
IITBscb(rfrm, tbs, colname, row, data)
RUNFRM		*rfrm;
TBSTRUCT	*tbs;
char		*colname;
i4		row;
...
*/
VOID
IITBscaSetCellAttr(rfrm, tbs, colname, row, data, onoff, current)
RUNFRM		*rfrm;
TBSTRUCT	*tbs;
char		*colname;
i4		row;
...
*/
STATUS
IITBicaInqCellAttr(rfrm, tbs, colname, row, flagval)
RUNFRM		*rfrm;
TBSTRUCT	*tbs;
char		*colname;
i4		row;
