...
IIFDesEncodeSize()
{
	...
	{
		frsda.sqln = 10;
/* # line 176 "frcreate.sc" */	/* prepare */
  {
    IIsqInit((char *)0);
    IIsqPrepare(0,(char *)"iifrs_size",&frsda,1,(char *)
"select cfdata from ii_encoded_forms");
  }
/* # line 178 "frcreate.sc" */	/* host code */
		if (frsda.sqld == 1)
		{
...
FDwfrcreate(char *frmid, bool wins)
{
	FRAME	*frm;
  i4 was_inxaction;
/* # line 275 "frcreate.sc" */	/* inquire_ingres */
  {
    IILQisInqSqlio((short *)0,1,30,4,&was_inxaction,73);
  }
/* # line 276 "frcreate.sc" */	/* host code */
	frm = FDiwfrcreate(frmid, wins);
	if (!was_inxaction)
	{
/* # line 279 "frcreate.sc" */	/* commit */
  {
    IIsqInit((char *)0);
    IIxact(3);
  }
/* # line 280 "frcreate.sc" */	/* host code */
	}
	return(frm);
}
FRAME	*
...
/* # line 302 "frcreate.sc" */	/* select */
  {
    IIsqInit((char *)0);
    IIwritio(0,(short *)0,1,32,0,(char *)
"select object_id from ii_objects where object_name=");
    IIputdomio((short *)0,1,32,0,frmid);
...
/* # line 309 "frcreate.sc" */	/* host code */
			found++;
    } /* IInextget */
    IIflush((char *)0,0);
IIrtE1:;
...
/* # line 424 "frcreate.sc" */	/* select */
  {
    IIsqInit((char *)0);
    IIwritio(0,(short *)0,1,32,0,(char *)
"select cfseq, cfdatsize, cftotdat, cfdata from ii_encoded_forms where\
 object_id=");
...
IIrtB2:
    while (IInextget() != 0) {
      ...
      IIgetdomio((short *)0,1,30,4,&binsize);
      IIgetdomio((short *)0,1,30,4,&totsize);
      IIgetdomio((short *)0,1,44,0,&ldbv);
      if (IIerrtest() != 0) goto IIrtB2;
/* # line 429 "frcreate.sc" */	/* host code */
		if (!found)
		{
