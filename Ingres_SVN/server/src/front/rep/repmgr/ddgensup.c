...
/* # line 192 "ddgensup.sc" */	/* host code */
	if (RPdb_error_check(DBEC_SINGLE_ROW, NULL) != OK)
	{
/* # line 194 "ddgensup.sc" */	/* rollback */
  {
    IIsqInit((char *)0);
    IIxact(2);
  }
/* # line 195 "ddgensup.sc" */	/* host code */
		IIUGerr(E_RM0050_Error_updt_regist_tbl, UG_ERR_ERROR, 0);
		error_exit();
	}
	if (db_config_changed(0) != OK)
	{
/* # line 201 "ddgensup.sc" */	/* rollback */
  {
    IIsqInit((char *)0);
    IIxact(2);
  }
/* # line 202 "ddgensup.sc" */	/* host code */
		error_exit();
	}
/* # line 205 "ddgensup.sc" */	/* commit */
  {
    IIsqInit((char *)0);
    IIxact(3);
  }
/* # line 206 "ddgensup.sc" */	/* host code */
	FEing_exit();
