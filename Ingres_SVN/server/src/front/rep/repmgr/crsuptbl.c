...
/* # line 117 "crsuptbl.sc" */	/* host code */
...
/* # line 127 "crsuptbl.sc" */	/* select */
  {
    IIsqInit((char *)0);
    IIsqMods(1);
    IIwritio(0,(short *)0,1,32,0,(char *)
"select INT4(interval('seconds', DATE(");
    IIputdomio((short *)0,1,32,0,RMtbl->columns_registered);
    IIwritio(0,(short *)0,1,32,0,(char *)
") -DATE(create_date)))from iitables where table_name=");
    IIputdomio((short *)0,1,32,0,RMtbl->sha_name);
    IIretinit((char *)0,0);
    if (IInextget() != 0) {
...
/* # line 132 "crsuptbl.sc" */	/* host code */
...
/* # line 207 "crsuptbl.sc" */	/* insert */
  {
    IIsqInit((char *)0);
    IIwritio(0,(short *)0,1,32,0,(char *)
"insert into dd_support_tables(table_name)values(");
    IIputdomio((short *)0,1,32,0,RMtbl->sha_name);
    IIwritio(0,(short *)0,1,32,0,(char *)")");
    IIsyncup((char *)0,0);
  }
/* # line 209 "crsuptbl.sc" */	/* host code */
	err = RPdb_error_check(DBEC_SINGLE_ROW, &errinfo);
	if (err)
	{
...
/* # line 216 "crsuptbl.sc" */	/* commit */
  {
    IIsqInit((char *)0);
    IIxact(3);
  }
/* # line 218 "crsuptbl.sc" */	/* host code */
...
/* # line 278 "crsuptbl.sc" */	/* insert */
  {
    IIsqInit((char *)0);
    IIwritio(0,(short *)0,1,32,0,(char *)
"insert into dd_support_tables(table_name)values(");
    IIputdomio((short *)0,1,32,0,RMtbl->arc_name);
    IIwritio(0,(short *)0,1,32,0,(char *)")");
    IIsyncup((char *)0,0);
  }
/* # line 280 "crsuptbl.sc" */	/* host code */
		err = RPdb_error_check(DBEC_SINGLE_ROW, &errinfo);
		if (err)
		{
...
/* # line 295 "crsuptbl.sc" */	/* commit */
  {
    IIsqInit((char *)0);
    IIxact(3);
  }
/* # line 297 "crsuptbl.sc" */	/* host code */
	return (OK);
}
static STATUS
...
/* # line 310 "crsuptbl.sc" */	/* execute */
  {
    IIsqInit((char *)0);
    IIsqExImmed(sql_stmt);
    IIsyncup((char *)0,0);
  }
/* # line 311 "crsuptbl.sc" */	/* host code */
...
/* # line 320 "crsuptbl.sc" */	/* execute */
  {
    IIsqInit((char *)0);
    IIsqExImmed(sql_stmt);
    IIsyncup((char *)0,0);
  }
/* # line 321 "crsuptbl.sc" */	/* host code */
	if (RPdb_error_check(0, NULL) != OK)
	{
		IIUGerr(E_RM010A_Err_grant_tbl, UG_ERR_ERROR, 2,
			RMtbl->table_owner, RMtbl->table_name);
...
/* # line 332 "crsuptbl.sc" */	/* execute */
  {
    IIsqInit((char *)0);
    IIsqExImmed(sql_stmt);
    IIsyncup((char *)0,0);
  }
/* # line 333 "crsuptbl.sc" */	/* host code */
		if (RPdb_error_check(0, NULL) != OK)
		{
			IIUGerr(E_RM010A_Err_grant_tbl, UG_ERR_ERROR, 2,
				RMtbl->table_owner, RMtbl->table_name);
