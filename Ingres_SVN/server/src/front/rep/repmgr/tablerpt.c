...
/* # line 131 "tablerpt.sc" */	/* host code */
	pagenum = 1;
	linecount = 0;
/* # line 133 "tablerpt.sc" */	/* select */
  {
    IIsqInit(&sqlca);
    IIwritio(0,(short *)0,1,32,0,(char *)
"select t.table_name, i.column_sequence, TRIM(t.columns_registered), T\
RIM(t.supp_objs_created), TRIM(t.rules_created), t.cdds_no, s.cdds_nam\
e, t.cdds_lookup_table, t.prio_lookup_table, c.column_name, c.key_sequ\
ence, c.column_sequence, TRIM(LOWERCASE(i.");
    IIwritio(0,(short *)0,1,32,0,(char *)
"column_datatype)), i.column_length, i.column_nulls, i.column_defaults\
 from dd_regist_columns c, dd_regist_tables t, dd_cdds s, iicolumns i \
where t.cdds_no=s.cdds_no and c.table_no=t.table_no and t.table_name=i\
.table_name and t.table_owner=i.table_owner ");
    IIwritio(0,(short *)0,1,32,0,(char *)
"and c.column_name=i.column_name order by 1, 2");
    IIretinit((char *)0,0);
    if (IIerrtest() != 0) goto IIrtE1;
IIrtB1:
    while (IInextget() != 0) {
      IIgetdomio((short *)0,1,32,DB_MAXNAME+1-1,table_name);
      IIgetdomio((short *)0,1,30,4,&col_sequence);
      IIgetdomio((short *)0,1,32,25,columns_registered);
      IIgetdomio((short *)0,1,32,25,suppobj_created);
      ...
      IIgetdomio((short *)0,1,32,DB_MAXNAME+1-1,cdds_lookup_table);
      IIgetdomio((short *)0,1,32,DB_MAXNAME+1-1,prio_lookup_table);
      IIgetdomio((short *)0,1,32,DB_MAXNAME+1-1,column_name);
      IIgetdomio((short *)0,1,30,4,&key_sequence);
      IIgetdomio((short *)0,1,30,4,&column_sequence);
      IIgetdomio((short *)0,1,32,DB_MAXNAME+1-1,column_datatype);
      IIgetdomio((short *)0,1,30,4,&column_length);
      IIgetdomio((short *)0,1,32,1,column_nulls);
      IIgetdomio((short *)0,1,32,1,column_defaults);
      if (IIerrtest() != 0) goto IIrtB1;
/* # line 156 "tablerpt.sc" */	/* host code */
		if (first)
...
/* # line 285 "tablerpt.sc" */	/* host code */
	...
	return (OK);
rpt_err:
/* # line 293 "tablerpt.sc" */	/* host code */
	status = -sqlca.sqlcode;
/* # line 294 "tablerpt.sc" */	/* rollback */
  {
    IIsqInit(&sqlca);
    IIxact(2);
  }
/* # line 295 "tablerpt.sc" */	/* host code */
	SIclose(report_fp);
	return (status);
}
static void
