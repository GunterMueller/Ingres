...
/* # line 151 "repcat.sc" */	/* host code */
	...
	if (create_events() != OK)
		error_exit();
/* # line 169 "repcat.sc" */	/* commit */
  {
    IIsqInit((char *)0);
    IIxact(3);
  }
/* # line 170 "repcat.sc" */	/* host code */
	if (RPdb_error_check(0, NULL) != OK)
		error_exit();
/* # line 173 "repcat.sc" */	/* set */
  {
    IIsqInit((char *)0);
...
/* # line 174 "repcat.sc" */	/* host code */
	if (RPdb_error_check(0, NULL) != OK)
		error_exit();
	if (update_cat_level() != OK)
		error_exit();
/* # line 180 "repcat.sc" */	/* commit */
  {
    IIsqInit((char *)0);
    IIxact(3);
  }
/* # line 181 "repcat.sc" */	/* host code */
	if (RPdb_error_check(0, NULL) != OK)
		error_exit();
	FEing_exit();
...
error_exit()
{
/* # line 210 "repcat.sc" */	/* rollback */
  {
    IIsqInit((char *)0);
    IIxact(2);
  }
/* # line 211 "repcat.sc" */	/* host code */
	FEing_exit();
