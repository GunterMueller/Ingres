...
/* # line 195 "tblinteg.sc" */	/* inquire_sql */
  {
    IILQisInqSqlio((short *)0,1,30,4,&start_session,11);
  }
/* # line 196 "tblinteg.sc" */	/* host code */
...
/* # line 211 "tblinteg.sc" */	/* host code */
	...
	if (status != OK)
	{
/* # line 221 "tblinteg.sc" */	/* set_sql */
  {
    IILQssSetSqlio(11,(short *)0,1,30,4,&Session1);
  }
/* # line 222 "tblinteg.sc" */	/* disconnect */
  {
    IIsqInit((char *)0);
    IILQsidSessID(Session1);
    IIsqDisconnect();
  }
/* # line 223 "tblinteg.sc" */	/* set_sql */
  {
    IILQssSetSqlio(11,(short *)0,1,30,4,&start_session);
  }
/* # line 224 "tblinteg.sc" */	/* host code */
		SIclose(report_fp);
		return (status);
	}
	...
	i = 40 + STlength(tmp) / (u_i4)2;
	SIfprintf(report_fp, ERx("%*s\n"), i, tmp);
/* # line 247 "tblinteg.sc" */	/* set_sql */
  {
    IILQssSetSqlio(11,(short *)0,1,30,4,&Session1);
  }
/* # line 248 "tblinteg.sc" */	/* host code */
...
/* # line 461 "tblinteg.sc" */	/* set_sql */
  {
    IILQssSetSqlio(11,(short *)0,1,30,4,&Session2);
  }
/* # line 462 "tblinteg.sc" */	/* host code */
...
# endif
{
  ...
  i2 target_type;
	...
	i4		cdds_num;
	*dbname = *vnode = EOS;
/* # line 520 "tblinteg.sc" */	/* select */
  {
    IIsqInit((char *)0);
    IIsqMods(1);
    IIwritio(0,(short *)0,1,32,0,(char *)
"select TRIM(database_name), TRIM(vnode_name)from dd_databases where d\
atabase_no=");
    IIputdomio((short *)0,1,30,2,&db_no);
    IIretinit((char *)0,0);
    if (IInextget() != 0) {
      IIgetdomio((short *)0,1,32,DB_MAXNAME+1-1,dbname);
      IIgetdomio((short *)0,1,32,DB_MAXNAME+1-1,vnode);
    } /* IInextget */
    IIsqFlush((char *)0,0);
  }
/* # line 524 "tblinteg.sc" */	/* host code */
	...
	cdds_num = (i4)cdds_no;
/* # line 545 "tblinteg.sc" */	/* select */
  {
    IIsqInit((char *)0);
    IIsqMods(1);
    IIwritio(0,(short *)0,1,32,0,(char *)
"select target_type from dd_db_cdds where database_no=");
    IIputdomio((short *)0,1,30,2,&db_no);
...
/* # line 550 "tblinteg.sc" */	/* host code */
	if (RPdb_error_check(DBEC_SINGLE_ROW, &errinfo) != OK)
	{
...
{
  i4 cnt;
/* # line 602 "tblinteg.sc" */	/* connect */
  {
    IIsqInit((char *)0);
    IILQsidSessID(sess_no);
    IIsqUser(user_name);
    IIsqConnect(0,db_name,(char *)0, (char *)0, (char *)0, (char *)0, 
    (char *)0, (char *)0, (char *)0, (char *)0, (char *)0, (char *)0, 
    (char *)0, (char *)0, (char *)0);
  }
/* # line 603 "tblinteg.sc" */	/* host code */
...
/* # line 610 "tblinteg.sc" */	/* select */
  {
    ...
    IIretinit((char *)0,0);
    if (IInextget() != 0) {
      IIgetdomio((short *)0,1,32,0,dba);
    } /* IInextget */
    IIsqFlush((char *)0,0);
  }
/* # line 611 "tblinteg.sc" */	/* host code */
	if (!STequal(dba, user_name))
	{
/* # line 613 "tblinteg.sc" */	/* disconnect */
  {
    IIsqInit((char *)0);
    IILQsidSessID(sess_no);
    IIsqDisconnect();
  }
/* # line 614 "tblinteg.sc" */	/* connect */
  {
    IIsqInit((char *)0);
    IILQsidSessID(sess_no);
    IIsqUser(dba);
...
/* # line 616 "tblinteg.sc" */	/* host code */
		if (RPdb_error_check(0, NULL) != OK)
		{
...
/* # line 709 "tblinteg.sc" */	/* prepare */
  {
    IIsqInit((char *)0);
    IIsqPrepare(0,(char *)"s1",(char *)0,0,select_stmt);
  }
/* # line 710 "tblinteg.sc" */	/* host code */
	if (RPdb_error_check(0, NULL) != OK)
	{
...
/* # line 716 "tblinteg.sc" */	/* describe */
  {
    IIsqInit((char *)0);
    IIsqDescribe(0,(char *)"s1",sqlda1,0);
  }
/* # line 717 "tblinteg.sc" */	/* host code */
	if (RPdb_error_check(0, NULL) != OK)
	{
...
/* # line 724 "tblinteg.sc" */	/* open */
  {
    IIsqInit((char *)0);
    IIcsOpen((char *)"curs",7198,29168);
    IIwritio(0,(short *)0,1,32,0,(char *)"s1");
    IIwritio(0,(short *)0,1,32,0,(char *)" for readonly ");
    IIcsQuery((char *)"curs",7198,29168);
  }
/* # line 725 "tblinteg.sc" */	/* host code */
	if (RPdb_error_check(0, NULL) != OK)
	{
	...
	while (!done)
	{
/* # line 735 "tblinteg.sc" */	/* fetch */
  {
    IIsqInit((char *)0);
    if (IIcsRetScroll((char *)"curs",7198,29168,-1,-1) != 0) {
      IIcsDaGet(0,sqlda1);
      IIcsERetrieve();
    } /* IIcsRetrieve */
  }
/* # line 736 "tblinteg.sc" */	/* inquire_sql */
  {
    IILQisInqSqlio((short *)0,1,30,4,&done,61);
  }
/* # line 737 "tblinteg.sc" */	/* host code */
		...
		if (!done)
		{
/* # line 745 "tblinteg.sc" */	/* set_sql */
  {
    IILQssSetSqlio(11,(short *)0,1,30,4,&targ_sess);
  }
/* # line 746 "tblinteg.sc" */	/* host code */
...
/* # line 751 "tblinteg.sc" */	/* prepare */
  {
    IIsqInit((char *)0);
    IIsqPrepare(0,(char *)"s2",(char *)0,0,select_stmt);
  }
/* # line 752 "tblinteg.sc" */	/* host code */
			if (RPdb_error_check(0, NULL) != OK)
			{
...
/* # line 758 "tblinteg.sc" */	/* describe */
  {
    IIsqInit((char *)0);
    IIsqDescribe(0,(char *)"s2",sqlda2,0);
  }
/* # line 759 "tblinteg.sc" */	/* host code */
			if (RPdb_error_check(0, NULL) != OK)
			{
...
/* # line 765 "tblinteg.sc" */	/* execute */
  {
    IIsqInit((char *)0);
    IIsqMods(3);
    IIsqMods(1);
    IIsqExImmed(select_stmt);
    IIretinit((char *)0,0);
    if (IInextget() != 0) {
      IIcsDaGet(0,sqlda2);
    } /* IInextget */
...
/* # line 766 "tblinteg.sc" */	/* host code */
...
/* # line 782 "tblinteg.sc" */	/* set_sql */
  {
    IILQssSetSqlio(11,(short *)0,1,30,4,&src_sess);
  }
/* # line 783 "tblinteg.sc" */	/* host code */
				...
				for (i = 0; i < column_count; i++)
				{
						...
						sqlda1->sqlvar[i].sqllen) != 0)
					{
						...
						SIfprintf(report_fp,
							...
							sequence_no1);
/* # line 811 "tblinteg.sc" */	/* set_sql */
  {
    IILQssSetSqlio(11,(short *)0,1,30,4,&src_sess);
  }
/* # line 813 "tblinteg.sc" */	/* host code */
						print_cols(report_fp, RMtbl,
							src_owner, database_no1,
							transaction_id1,
							sequence_no1,
							(char *)NULL);
/* # line 818 "tblinteg.sc" */	/* set_sql */
  {
    IILQssSetSqlio(11,(short *)0,1,30,4,&targ_sess);
  }
/* # line 820 "tblinteg.sc" */	/* host code */
						print_cols(report_fp, RMtbl,
							targ_owner,
							database_no1,
							transaction_id1,
...
/* # line 830 "tblinteg.sc" */	/* set_sql */
  {
    IILQssSetSqlio(11,(short *)0,1,30,4,&src_sess);
  }
/* # line 831 "tblinteg.sc" */	/* host code */
	}
/* # line 832 "tblinteg.sc" */	/* close */
  {
    IIsqInit((char *)0);
    IIcsClose((char *)"curs",7198,29168);
  }
/* # line 834 "tblinteg.sc" */	/* host code */
	return (OK);
}
/*{
...
/* # line 866 "tblinteg.sc" */	/* set_sql */
  {
    IILQssSetSqlio(11,(short *)0,1,30,4,&Session1);
  }
/* # line 867 "tblinteg.sc" */	/* disconnect */
  {
    IIsqInit((char *)0);
    IILQsidSessID(Session1);
    IIsqDisconnect();
  }
/* # line 868 "tblinteg.sc" */	/* set_sql */
  {
    IILQssSetSqlio(11,(short *)0,1,30,4,&Session2);
  }
/* # line 869 "tblinteg.sc" */	/* disconnect */
  {
    IIsqInit((char *)0);
    IILQsidSessID(Session2);
    IIsqDisconnect();
  }
/* # line 870 "tblinteg.sc" */	/* set_sql */
  {
    IILQssSetSqlio(11,(short *)0,1,30,4,&start_session);
  }
/* # line 871 "tblinteg.sc" */	/* host code */
}
