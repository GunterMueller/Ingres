...
bool            force_rebuild;  /* rebuild everything: table, 
                                ** attribute, and join info */
  {
    ...
    char currname[FE_MAXNAME + 1];
        ...
        status = OK;
/* # line 222 "getinfo.qsc" */	/* message */
    {
      IImessage(ERget(S_QF0032_RetrieveTblEntryInfo));
    }
/* # line 223 "getinfo.qsc" */	/* getform */
    {
      if (IIfsetio(_mqbftbls) != 0) {
        IIgetfldio((short *)0,1,32,FE_MAXNAME + 1-1,currname,(char *)"\
name");
      } /* IIfsetio */
    }
/* # line 225 "getinfo.qsc" */	/* host code */
        STtrmwhite(currname);
        ...
        i = 0;
/* # line 275 "getinfo.qsc" */	/* unloadtable */
    {
      if (IItbact(_mqbftbls,_tables,0) == 0) goto IItbE1;
      while (IItunload() != 0) {
        IItcogetio((short *)0,1,32,(FE_UNRML_MAXNAME + 1)-1,t_tbl,_table);
        IItcogetio((short *)0,1,32,(FE_UNRML_MAXNAME + 1)-1,t_owner,_owner);
        IItcogetio((short *)0,1,32,(FE_UNRML_MAXNAME + 1)-1,t_ident,_abbr);
        IItcogetio((short *)0,1,32,10 + 1-1,t_role,_role);
        IItcogetio((short *)0,1,30,4,&t_state,(char *)"_STATE");
        IItcogetio((short *)0,1,30,4,&t_rec,(char *)"_RECORD");
        IITBceColEnd();
        {
          register i4 t_type;
/* # line 285 "getinfo.qsc" */	/* host code */
                char            *_detail;
                bool            empty_tbl_row;
                empty_tbl_row = FALSE;
                if  (t_tbl[0] == EOS)
                {
                             ...
                             (t_ident[0] != EOS))
                        {
                                IIUGerr(status = E_QF014B_BadTblName,
                                        0, 1, t_tbl);
/* # line 297 "getinfo.qsc" */	/* scroll */
          {
            if (IItbsetio(1,_mqbftbls,_tables,-3) != 0) {
              IItbsmode((char *)"to");
              if (IItscroll(0,t_rec) != 0) {
              } /* IItscroll */
            } /* IItbsetio */
          }
/* # line 298 "getinfo.qsc" */	/* endloop */
          {
            if (1) goto IItbE1;
          }
/* # line 299 "getinfo.qsc" */	/* host code */
                        };
                        empty_tbl_row = TRUE;
                }
                if  (!empty_tbl_row)
...
/* # line 333 "getinfo.qsc" */	/* endloop */
          {
            if (1) goto IItbE1;
          }
/* # line 334 "getinfo.qsc" */	/* host code */
                }
...
/* # line 353 "getinfo.qsc" */	/* endloop */
          {
            if (1) goto IItbE1;
          }
/* # line 354 "getinfo.qsc" */	/* host code */
                	}
...
/* # line 380 "getinfo.qsc" */	/* endloop */
          {
            if (1) goto IItbE1;
          }
/* # line 381 "getinfo.qsc" */	/* host code */
                                }
...
/* # line 399 "getinfo.qsc" */	/* host code */
                                status = REL_OVERFLOW;
/* # line 400 "getinfo.qsc" */	/* endloop */
          {
            if (1) goto IItbE1;
          }
/* # line 401 "getinfo.qsc" */	/* host code */
                        }
...
/* # line 426 "getinfo.qsc" */	/* host code */
...
/* # line 460 "getinfo.qsc" */	/* unloadtable */
    {
      ...
      while (IItunload() != 0) {
        ...
        {
          register i4 t_type;
/* # line 470 "getinfo.qsc" */	/* host code */
                        char            *_detail;
                        STATUS          always_ok;
...
/* # line 579 "getinfo.qsc" */	/* host code */
                                        status = t_type == mqIN_MASTER ? -1:-2;
/* # line 580 "getinfo.qsc" */	/* endloop */
          {
            if (1) goto IItbE2;
          }
/* # line 581 "getinfo.qsc" */	/* host code */
                                }
                        }
        }
      } /* IItunload */
...
/* # line 585 "getinfo.qsc" */	/* host code */
                if ( status == OK )
                { /* check for valid number of relations before continuing */
                        ...
                        {
/* # line 595 "getinfo.qsc" */	/* clear */
    {
      IIfldclear(_tables);
    }
/* # line 596 "getinfo.qsc" */	/* host code */
...
MQQDEF  *qdef;
  {
        ...
        ER_MSGID        resp;
    char tblfld[32 + 1];
/* # line 842 "getinfo.qsc" */	/* getform */
    {
      if (IIfsetio(_mqbftbls) != 0) {
        IIgetfldio((short *)0,1,32,32 + 1-1,tblfld,(char *)"tablefield");
      } /* IIfsetio */
    }
/* # line 844 "getinfo.qsc" */	/* host code */
        ...
        CVupper( tblfld );
/* # line 860 "getinfo.qsc" */	/* putform */
    {
      if (IIfsetio(_mqbftbls) != 0) {
        IIputfldio((char *)"tablefield",(short *)0,1,32,0,tblfld);
      } /* IIfsetio */
    }
  }
/* # line 865 "getinfo.qsc" */	/* host code */
/*
...
{
        qdef->mqnumtabs = 0;
/* # line 908 "getinfo.qsc" */	/* message */
  {
    IImessage(ERget(S_QF0036_RetrieveTableInfo));
  }
/* # line 910 "getinfo.qsc" */	/* host code */
