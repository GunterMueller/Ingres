...
IIfdB1:
      ...
      if (IIretval() == 1) {
        {
/* # line 154 "mqbfhelp.qsc" */	/* host code */
			mq_tflag = FALSE;
			break;
        }
      } else if (IIretval() == 2) {
        {
/* # line 159 "mqbfhelp.qsc" */	/* host code */
			mq_tflag = TRUE;
			break;
        }
      } else if (IIretval() == 3) {
        {
/* # line 164 "mqbfhelp.qsc" */	/* host code */
			FEhelp(ERx("qtabgosb.hlp"), ERget(S_QF0070_Run_Table_Submenu));
			continue;
        }
      } else if (IIretval() == 4) {
        {
/* # line 169 "mqbfhelp.qsc" */	/* host code */
			return;
        }
      } else {
        if (1) goto IIfdE1;
...
IImuI1:
      ...
      if (IInmuact(ERget(F_QF000B_SimpleFields),(char *)0,2,2,1) == 0) goto 
      IIfdE1;
      if (IInmuact(ERget(FE_TblField),(char *)0,2,2,2) == 0) goto IIfdE1;
...
/* # line 171 "mqbfhelp.qsc" */	/* host code */
	}
	onetbl = TRUE;
	if (mq_noload)
	{
