...
char	**argv;
{
  char t_user[FE_MAXNAME + 1];
  char t_dba[FE_MAXNAME + 1];
	char		*pipe;
	MQQDEF		*qdef;
...
/* # line 219 "mqbfmain.qsc" */	/* host code */
	/* Capture control_p to process validations */
/* # line 221 "mqbfmain.qsc" */	/* set_frs */
  {
    if (IIiqset(0,0,(char *)0, (char *)0, (char *)0) != 0) {
...
/* # line 225 "mqbfmain.qsc" */	/* host code */
...
/* # line 434 "mqbfmain.qsc" */	/* display */
  {
    if (IIdispfrm((char *)"mqstart",(char *)"r") == 0) goto IIfdE1;
    goto IImuI1;
IIfdI1:;
    if (IIfsetio((char *)0) == 0) goto IIfdE1;
    {
/* # line 437 "mqbfmain.qsc" */	/* host code */
...
IIfdB1:
    while (IIrunform() != 0) {
      if (IIretval() == 1) {
        {
/* # line 450 "mqbfmain.qsc" */	/* host code */
	begqbfn:
		if (mqcatfrm() != TRUE)
		{
			/* couldn't initialize catalog form */
		...
		{
/* # line 458 "mqbfmain.qsc" */	/* clear */
          {
            IIclrscr();
          }
/* # line 459 "mqbfmain.qsc" */	/* breakdisplay */
          {
            if (1) goto IIfdE1;
          }
/* # line 460 "mqbfmain.qsc" */	/* host code */
		}
        }
      } else if (IIretval() == 2) {
        {
/* # line 464 "mqbfmain.qsc" */	/* host code */
	begcat:
		if (mqcatfrm() != TRUE)
		{
			/* couldn't initialize catalog form */
		...
		{
/* # line 472 "mqbfmain.qsc" */	/* clear */
          {
            IIclrscr();
          }
/* # line 473 "mqbfmain.qsc" */	/* breakdisplay */
          {
            if (1) goto IIfdE1;
          }
/* # line 474 "mqbfmain.qsc" */	/* host code */
		}
        }
      } else if (IIretval() == 3) {
        {
/* # line 478 "mqbfmain.qsc" */	/* host code */
	beghelp:
		if (mqcatfrm() != TRUE)
		{
			/* couldn't initialize catalog form */
		...
		{
/* # line 486 "mqbfmain.qsc" */	/* clear */
          {
            IIclrscr();
          }
/* # line 487 "mqbfmain.qsc" */	/* breakdisplay */
          {
            if (1) goto IIfdE1;
          }
/* # line 488 "mqbfmain.qsc" */	/* host code */
		}
        }
      } else if (IIretval() == 4) {
        {
/* # line 492 "mqbfmain.qsc" */	/* host code */
		FEhelp(ERx("qmain.hlp"), ERget(S_QF0077_QBF_Start_Up_Frame));
        }
      } else if (IIretval() == 5) {
        {
/* # line 496 "mqbfmain.qsc" */	/* clear */
          {
            IIclrscr();
          }
/* # line 497 "mqbfmain.qsc" */	/* breakdisplay */
          {
            if (1) goto IIfdE1;
          }
        }
...
IImuI1:
    ...
    if (IInmuact(ERget(FE_QBFNames),(char *)0,2,2,1) == 0) goto IIfdE1;
    if (IInmuact(ERget(S_QF00D3_JoinDefs),(char *)0,2,2,2) == 0) goto IIfdE1;
    if (IInmuact(ERget(S_QF00D4_Tables),(char *)0,2,2,3) == 0) goto IIfdE1;
...
/* # line 500 "mqbfmain.qsc" */	/* host code */
endsmenu:
	if (mq_editjoin)
	{
		/*
