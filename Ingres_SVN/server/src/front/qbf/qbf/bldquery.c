...
i4	*tblwidth;
  {
	*tblwidth = 0;
	if ( mq_forms )
	{
		...
		if ( !mq_cfrm )
		{
/* # line 83 "bldquery.qsc" */	/* message */
    {
      IImessage(ERget(S_QF0010_InitForm));
    }
/* # line 85 "bldquery.qsc" */	/* host code */
# ifdef DEBUG
			if (mq_debug)
			{
				SIfprintf( mqoutf,
...
# endif
/* # line 95 "bldquery.qsc" */	/* forminit */
    {
      IIforminit(mq_frame);
    }
/* # line 96 "bldquery.qsc" */	/* host code */
...
# endif
		...
		{ /* problem with form or correlating attributes with fields */
			...
			*/
			...
			{
/* # line 144 "bldquery.qsc" */	/* message */
    {
      IImessage(ERget(S_QF0012_InitDefaultForm));
    }
/* # line 145 "bldquery.qsc" */	/* host code */
			}
			else
			{
				if ( frm_err != OK)
