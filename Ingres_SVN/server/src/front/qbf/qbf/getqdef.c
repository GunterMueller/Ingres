...
/* # line 164 "getqdef.sc" */	/* select */
  {
    IIsqInit((char *)0);
    IIwritio(0,(short *)0,1,32,0,(char *)
"select qtype, qinfo1, qinfo2, qinfo3, qinfo4, qinfo5 from ii_joindefs\
 where ii_joindefs.object_id=");
    IIputdomio((short *)0,1,30,4,&qdef->mqcr.id);
    IIwritio(0,(short *)0,1,32,0,(char *)"order by qtype");
    IIretinit((char *)0,0);
    if (IIerrtest() != 0) goto IIrtE1;
IIrtB1:
    while (IInextget() != 0) {
      IIgetdomio((short *)0,1,30,4,&qtype);
      IIgetdomio((short *)0,1,32,FE_MAXNAME + 1-1,first);
      IIgetdomio((short *)0,1,32,FE_MAXNAME + 1-1,second);
      IIgetdomio((short *)0,1,32,FE_MAXNAME + 1-1,third);
      IIgetdomio((short *)0,1,32,FE_MAXNAME + 1-1,fourth);
      IIgetdomio(&nulli,1,32,FE_MAXNAME + 1-1,fifth);
      if (IIerrtest() != 0) goto IIrtB1;
/* # line 170 "getqdef.sc" */	/* host code */
	    offset = SEQ_OFFSET;
	    rtype = qtype % offset;
	    rseq = qtype / offset;
	    ...
	    switch(rtype)
	    {
	      ...
	      case 1:
	      {
			...
			loop_status = FAIL;
/* # line 196 "getqdef.sc" */	/* endselect */
      {
        IIbreak();
        if (1) goto IIrtE1;
      }
/* # line 197 "getqdef.sc" */	/* host code */
		    }
...
/* # line 217 "getqdef.sc" */	/* endselect */
      {
        IIbreak();
        if (1) goto IIrtE1;
      }
/* # line 218 "getqdef.sc" */	/* host code */
...
/* # line 230 "getqdef.sc" */	/* endselect */
      {
        IIbreak();
        if (1) goto IIrtE1;
      }
/* # line 231 "getqdef.sc" */	/* host code */
		    ...
		    */
						...
						TRUE)) == FAIL)
			{
				...
				{
/* # line 255 "getqdef.sc" */	/* endselect */
      {
        IIbreak();
        if (1) goto IIrtE1;
      }
/* # line 256 "getqdef.sc" */	/* host code */
				}
				else
				{
	      ...
	      case 2:
	      {
			...
			FDerror(ERRALLOC, 0, ERx(""));
			loop_status = FAIL;
/* # line 277 "getqdef.sc" */	/* endselect */
      {
        IIbreak();
        if (1) goto IIrtE1;
      }
/* # line 278 "getqdef.sc" */	/* host code */
		    }
		    att = qdef->mqatts[numa];
		    if ( (loop_status = check_and_assign(first,
					 att->rvar,FALSE)) == FAIL)
/* # line 282 "getqdef.sc" */	/* endselect */
      {
        IIbreak();
        if (1) goto IIrtE1;
      }
/* # line 283 "getqdef.sc" */	/* host code */
		    if ( (loop_status = check_and_assign(second,
					 att->col,FALSE)) == FAIL)
/* # line 285 "getqdef.sc" */	/* endselect */
      {
        IIbreak();
        if (1) goto IIrtE1;
      }
/* # line 286 "getqdef.sc" */	/* host code */
		    /*
	      ...
	      case 3:
	      {
			...
			TRUE, (STATUS *)NULL)) == NULL)
		    {
    			FDerror(ERRALLOC, 0, ERx(""));
			loop_status = FAIL;
/* # line 325 "getqdef.sc" */	/* endselect */
      {
        IIbreak();
        if (1) goto IIrtE1;
      }
/* # line 326 "getqdef.sc" */	/* host code */
		    }
		    join = qdef->mqjoins[numj];
		    if ( (loop_status = check_and_assign(first,
					 join->rv1,FALSE)) == FAIL)
/* # line 330 "getqdef.sc" */	/* endselect */
      {
        IIbreak();
        if (1) goto IIrtE1;
      }
/* # line 331 "getqdef.sc" */	/* host code */
		    if ( (loop_status = check_and_assign(second,
					 join->col1,FALSE)) == FAIL)
/* # line 333 "getqdef.sc" */	/* endselect */
      {
        IIbreak();
        if (1) goto IIrtE1;
      }
/* # line 334 "getqdef.sc" */	/* host code */
		    if ( (loop_status = check_and_assign(third,
					 join->rv2,FALSE)) == FAIL)
/* # line 336 "getqdef.sc" */	/* endselect */
      {
        IIbreak();
        if (1) goto IIrtE1;
      }
/* # line 337 "getqdef.sc" */	/* host code */
		    if ( (loop_status = check_and_assign(fourth,
					 join->col2,FALSE)) == FAIL)
/* # line 339 "getqdef.sc" */	/* endselect */
      {
        IIbreak();
        if (1) goto IIrtE1;
      }
/* # line 340 "getqdef.sc" */	/* host code */
		    qdef->mqnumjoins++;
		    break;
	      }
	      default:
		    ...
		    loop_status = FAIL;
/* # line 346 "getqdef.sc" */	/* endselect */
      {
        IIbreak();
        if (1) goto IIrtE1;
      }
/* # line 347 "getqdef.sc" */	/* host code */
		    break;
	    }
    } /* IInextget */
    IIflush((char *)0,0);
...
MQQDEF	*qdef;
{
	...
	FE_ATT_INFO	attinfo;
	STATUS		rstat;
	char		tbl_keys[MQ_MAXCOLS][FE_MAXNAME + 1];
