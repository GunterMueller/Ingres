  ...
  char fldmode[10];
	...
	*/
	...
	for (i = 0; i < qdef->mqnumatts; i++)
	{
		...
		if (catt->jpart == 0)
		    continue;
/* # line 194 "bldwhere.qsc" */	/* inquire_frs */
  {
    if (IIiqset(2,0,formname,(char *)0, (char *)0) != 0) {
      IIiqfsio((short *)0,1,32,9,fldmode,21,fieldname,0);
    } /* IIiqset */
  }
/* # line 195 "bldwhere.qsc" */	/* host code */
...
# else
	...
	fname = formname;
	tfld = tfldname;
/* # line 473 "bldwhere.qsc" */	/* scroll */
    {
      if (IItbsetio(1,fname,tfld,-3) != 0) {
        IItbsmode((char *)"to");
        if (IItscroll(0,1) != 0) {
        } /* IItscroll */
      } /* IItbsetio */
    }
/* # line 474 "bldwhere.qsc" */	/* getrow */
    {
      if (IItbsetio(2,fname,tfld,1) != 0) {
        IItcogetio((short *)0,1,30,4,&rstate,(char *)"_STATE");
        IITBceColEnd();
      } /* IItbsetio */
    }
/* # line 475 "bldwhere.qsc" */	/* inquire_frs */
    {
      if (IIiqset(3,0,fname,(char *)0, (char *)0) != 0) {
        IIiqfsio((short *)0,1,30,4,&lrow,31,tfld,0);
        IIiqfsio((short *)0,1,30,4,&ncols,33,tfld,0);
      } /* IIiqset */
    }
/* # line 476 "bldwhere.qsc" */	/* host code */
