...
# endif
	...
	IIUGerr(E_IC0067_BadIngresVersion, UG_ERR_FATAL, 2,
			(PTR) ERx("II9.3"), (PTR) IIUIscl_StdCatLevel());
	/* NOTREACHED */
    }
...
/* # line 420 "ingcntrl.sc" */	/* set_sql */
  {
    IILQssSetSqlio(3,(short *)0,1,32,0,(char *)"genericerror");
  }
/* # line 421 "ingcntrl.sc" */	/* host code */
    /*
...
/* # line 540 "ingcntrl.qsc" */	/* set_frs */
    {
      if (IIiqset(0,0,(char *)0, (char *)0, (char *)0) != 0) {
        ...
        IIstfsio(2,(char *)0,0,(short *)0,1,30,sizeof(1),(void *)IILQint(1));
...
/* # line 546 "ingcntrl.qsc" */	/* host code */
    /*
    ...
    */
    ...
    Request = ERx("r");
/* # line 553 "ingcntrl.qsc" */	/* clear */
    {
      IIclrscr();
    }
/* # line 554 "ingcntrl.qsc" */	/* message */
    {
      IImessage(ERget(S_IC0038_Accessing_Databases));
    }
/* # line 556 "ingcntrl.qsc" */	/* host code */
    if ( Mgr )
    { 
	/* AccessDB */
	mgrform();
...
/* # line 566 "ingcntrl.qsc" */	/* clear */
    {
      IIclrscr();
    }
/* # line 568 "ingcntrl.qsc" */	/* host code */
    FEendforms();
    FEing_exit();
...
IIfdB1:
      while (IIrunform() != 0) {
        if (IIretval() == 1) {
          {
/* # line 712 "ingcntrl.qsc" */	/* getrow */
            {
              if (IItbsetio(2,ListPickFrm,ListPickTbl,-2) != 0) {
                IItcogetio((short *)0,1,32,0,buf,(char *)"choice");
                IITBceColEnd();
              } /* IItbsetio */
            }
/* # line 713 "ingcntrl.qsc" */	/* host code */
                STtrmwhite(buf);
/* # line 714 "ingcntrl.qsc" */	/* breakdisplay */
            {
              if (1) goto IIfdE1;
            }
          }
          ...
          {
/* # line 720 "ingcntrl.qsc" */	/* breakdisplay */
            {
              if (1) goto IIfdE1;
            }
          }
          ...
          {
/* # line 726 "ingcntrl.qsc" */	/* host code */
            	FEtabfnd(ListPickFrm, ListPickTbl);
          }
        } else if (IIretval() == 4) {
          {
/* # line 732 "ingcntrl.qsc" */	/* scroll */
            {
              if (IItbsetio(1,ListPickFrm,ListPickTbl,-3) != 0) {
                IItbsmode((char *)"to");
                if (IItscroll(0,1) != 0) {
                } /* IItscroll */
              } /* IItbsetio */
...
/* # line 738 "ingcntrl.qsc" */	/* scroll */
          ...
          {
/* # line 744 "ingcntrl.qsc" */	/* host code */
...
IImuI1:
      ...
      if (IInmuact(ERget(FE_Select),(char *)0,2,2,1) == 0) goto IIfdE1;
      IIFRInternal(0);
      ...
      if (IInmuact(ERget(FE_Help),ERget(F_FE0101_ExplKeyHelp),0,0,6) == 0) 
      goto IIfdE1;
      IIFRInternal(0);
...
/* # line 750 "ingcntrl.qsc" */	/* host code */
static STATUS
pickinit(type, qry)
char	*type;
  char *qry;
...
/* # line 761 "ingcntrl.qsc" */	/* inittable */
    {
      if (IItbinit(ListPickFrm,ListPickTbl,(char *)"r") != 0) {
        IItfill();
      } /* IItbinit */
    }
/* # line 763 "ingcntrl.qsc" */	/* host code */
/* # line 767 "ingcntrl.sc" */	/* execute */
  {
    IIsqInit((char *)0);
    IIsqMods(3);
    IIsqExImmed(qry);
...
IIrtB1:
    while (IInextget() != 0) {
      IIgetdomio((short *)0,1,32,FE_MAXNAME + 1-1,listitem);
      if (IIerrtest() != 0) goto IIrtB1;
/* # line 769 "ingcntrl.sc" */	/* host code */
	{
/* # line 766 "ingcntrl.qsc" */	/* loadtable */
    {
      if (IItbact(ListPickFrm,ListPickTbl,1) != 0) {
        IItcoputio((char *)"choice",(short *)0,1,32,0,listitem);
        IITBceColEnd();
      } /* IItbact */
    }
/* # line 767 "ingcntrl.qsc" */	/* host code */
	}
    } /* IInextget */
    IIflush((char *)0,0);
IIrtE1:;
...
char    *a1, *a2, *a3, *a4, *a5;
{
  ...
  char lbuf[512];
	...
	STcat(lbuf, ":");
/* # line 786 "ingcntrl.qsc" */	/* prompt */
  {
    IIFRgpcontrol(1,0);
    IIFRgpsetio(6,(short *)0,1,30,sizeof(301),(void *)IILQint(301));
    IIFRgpcontrol(2,0);
    IIprmptio(0,lbuf,(short *)0,1,32,2,dummy);
  }
/* # line 787 "ingcntrl.qsc" */	/* host code */
}
