...
/* # line 129 "unexdbmain.sc" */	/* host code */
...
/* # line 263 "unexdbmain.sc" */	/* host code */
	/*
...
/* # line 424 "unexdbmain.sc" */	/* host code */
		}
	    else
		{
...
/* # line 442 "unexdbmain.sc" */	/* execute procedure */
  {
    IIsqInit(&sqlca);
    IILQpriProcInit(2,(char *)"iiQEF_del_location");
    IILQprvProcValio((char *)"database_name",0,(short *)0,1,32,0,
    database_arr[j]);
    IILQprvProcValio((char *)"location_name",0,(short *)0,1,32,0,locname);
    IILQprvProcValio((char *)"access",0,(short *)0,1,30,4,&exusage);
...
/* # line 448 "unexdbmain.sc" */	/* host code */
					if ( sqlca.sqlcode < 0 &&
...
/* # line 466 "unexdbmain.sc" */	/* host code */
    FEing_exit();
    EXdelete();
    PCexit(OK);
}
...
/* # line 492 "unexdbmain.sc" */	/* select */
  {
    IIsqInit(&sqlca);
    IIsqMods(1);
    IIwritio(0,(short *)0,1,32,0,(char *)
"select location_area, status from iilocation_info where location_name\
=");
    IIputdomio((short *)0,1,32,0,locname);
    IIretinit((char *)0,0);
    if (IInextget() != 0) {
      IIgetdomio((short *)0,1,32,DB_AREA_MAX+1-1,linfo->li_area);
      IIgetdomio((short *)0,1,30,4,&linfo->li_usage);
    } /* IInextget */
    IIsqFlush((char *)0,0);
    if (sqlca.sqlcode < 0) 
      IIsqPrint(&sqlca);
  }
/* # line 497 "unexdbmain.sc" */	/* host code */
    if ((stat = FEinqerr()) != OK)
		return stat;
    if (FEinqrows() > 0)
