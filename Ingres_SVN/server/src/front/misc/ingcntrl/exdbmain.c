...
/* # line 191 "exdbmain.sc" */	/* host code */
...
/* # line 330 "exdbmain.sc" */	/* host code */
	/*
...
/* # line 674 "exdbmain.sc" */	/* host code */
	if (sqlca.sqlcode < 0 && sqlca.sqlcode != (-E_GE0032_WARNING))
	{
	    EXdelete();
	    PCexit(FAIL);
	}
/* # line 679 "exdbmain.sc" */	/* commit */
  {
    IIsqInit(&sqlca);
    IIxact(3);
    if (sqlca.sqlcode < 0) 
...
/* # line 680 "exdbmain.sc" */	/* host code */
    }
...
/* # line 692 "exdbmain.sc" */	/* execute procedure */
  {
    IIsqInit(&sqlca);
...
/* # line 698 "exdbmain.sc" */	/* host code */
		if ( sqlca.sqlcode < 0 &&
...
/* # line 709 "exdbmain.sc" */	/* host code */
    FEing_exit();
    EXdelete();
    PCexit(OK);
}
...
/* # line 740 "exdbmain.sc" */	/* select */
  {
    IIsqInit(&sqlca);
    IIsqMods(1);
    IIwritio(0,(short *)0,1,32,0,(char *)
"select location_area, status, raw_pct from iilocation_info where loca\
tion_name=");
...
/* # line 745 "exdbmain.sc" */	/* host code */
    if ((stat = FEinqerr()) != OK)
	return stat;
    if (FEinqrows() > 0)
