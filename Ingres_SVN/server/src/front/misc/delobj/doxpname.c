...
IIrtB1:
    while (IInextget() != 0) {
      IIgetdomio((short *)0,1,30,4,&_ooid);
      IIgetdomio((short *)0,1,30,4,&_ooclass);
      IIgetdomio((short *)0,1,32,(FE_MAXNAME + 1)-1,_ooname);
      IIgetdomio((short *)0,1,32,(FE_MAXNAME + 1)-1,_ooowner);
      if (IIerrtest() != 0) goto IIrtB1;
/* # line 385 "doxpname.sc" */	/* host code */
			/*
