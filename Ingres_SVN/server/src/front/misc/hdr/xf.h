...
*/
  typedef struct xf_colinfo_struct {
    ...
    char sys_maint[2];
    char log_key;
    char col_int_datatype[FE_MAXNAME + 1];
    i4 col_seq;
    i4 key_seq;
    char *default_value;
    char has_default[2];
...
/* xfproc.qsc */
FUNC_EXTERN void	xfprocedures();
/* xfrules.qsc */
FUNC_EXTERN void	xfrules();
FUNC_EXTERN void	xfevents(i4 output_flags);
...
# define XF_UNIQUE  32	
/* xfwrscrpt.c */
FUNC_EXTERN void	xfcrscript(char *owner, char *progname, bool portable, 
...
FUNC_EXTERN void    xmlprintrows(int numcols, XF_TABINFO *tp, char *dbname);
