...
/* # line 412 "udmain.sc" */	/* host code */
    ...
    {
	char *ingresname = INGRES_NAME;
	/* get name of dba */
/* # line 444 "udmain.sc" */	/* select */
  {
    IIsqInit((char *)0);
    IIsqMods(1);
    ...
    IIretinit((char *)0,0);
    if (IInextget() != 0) {
      IIgetdomio((short *)0,1,32,FE_MAXNAME + 1-1,dbaname);
    } /* IInextget */
    IIsqFlush((char *)0,0);
  }
/* # line 447 "udmain.sc" */	/* host code */
	/* get list of usernames */
	usercnt = 0;
	getingresname(ingresname);
	if (With_distrib)
	{
/* # line 452 "udmain.sc" */	/* select */
  {
    IIsqInit((char *)0);
    IIwritio(0,(short *)0,1,32,0,(char *)
"select table_owner from iidd_tables union select object_owner from ii\
dd_registrations");
    IIretinit((char *)0,0);
    if (IIerrtest() != 0) goto IIrtE1;
IIrtB1:
    while (IInextget() != 0) {
      IIgetdomio((short *)0,1,32,FE_MAXNAME + 1-1,uname);
      if (IIerrtest() != 0) goto IIrtB1;
/* # line 459 "udmain.sc" */	/* host code */
	    {
...
IIrtE1:;
	...
	else
	{
	    ...
	    */
	    ...
	    {
/* # line 477 "udmain.sc" */	/* select */
  {
    IIsqInit((char *)0);
    IIwritio(0,(short *)0,1,32,0,(char *)
"select table_owner from iitables union select procedure_owner from ii\
procedures union select object_owner from iiregistrations");
    IIretinit((char *)0,0);
...
IIrtE3:;
	...
	*/
	xfcrscript(curr_user, progname, portable, output_flags, output_flags2);
