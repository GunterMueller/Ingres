...
xfprocedures()
{
  ...
  char p_name[FE_MAXNAME + 1];
  char p_owner[FE_MAXNAME + 1];
  ...
  i2 permit_depth;
    ...
    */
    if (With_65_catalogs)
    {
/* # line 176 "xfproc.sc" */	/* select */
  {
    IIsqInit((char *)0);
    IIwritio(0,(short *)0,1,32,0,(char *)
"select distinct p.procedure_owner, p.procedure_name from iiprocedures\
 p where(p.procedure_owner=");
    IIputdomio((short *)0,1,32,0,Owner);
    IIwritio(0,(short *)0,1,32,0,(char *)"or ''=");
    IIputdomio((short *)0,1,32,0,Owner);
    IIwritio(0,(short *)0,1,32,0,(char *)
")and LOWERCASE(p.procedure_name)not like 'ii%' and p.system_use<>'G' \
order by p.procedure_owner, p.procedure_name");
    IIretinit((char *)0,0);
    if (IIerrtest() != 0) goto IIrtE1;
IIrtB1:
    while (IInextget() != 0) {
      IIgetdomio((short *)0,1,32,FE_MAXNAME + 1-1,p_owner);
      IIgetdomio((short *)0,1,32,FE_MAXNAME + 1-1,p_name);
      if (IIerrtest() != 0) goto IIrtB1;
/* # line 184 "xfproc.sc" */	/* host code */
	{
...
"select distinct p.procedure_owner, p.procedure_name from iiprocedures\
 p where(p.procedure_owner=");
    ...
    IIputdomio((short *)0,1,32,0,Owner);
    IIwritio(0,(short *)0,1,32,0,(char *)
")and p.procedure_owner<>'$ingres' and p.procedure_owner<>'$INGRES' or\
der by p.procedure_owner, p.procedure_name");
    IIretinit((char *)0,0);
...
/* # line 220 "xfproc.sc" */	/* select */
  {
    IIsqInit((char *)0);
    IIwritio(0,(short *)0,1,32,0,(char *)
"select p.procedure_owner, p.procedure_name, '',  -1, 0, p.text_sequen\
ce, p.text_segment from iiprocedures p where(p.procedure_owner=");
    IIputdomio((short *)0,1,32,0,Owner);
    IIwritio(0,(short *)0,1,32,0,(char *)"or ''=");
    IIputdomio((short *)0,1,32,0,Owner);
    IIwritio(0,(short *)0,1,32,0,(char *)
")and LOWERCASE(p.procedure_name)not like 'ii%' and p.system_use<>'G' \
union select pe.object_owner, pe.object_name, pe.permit_grantor, pe.pe\
rmit_depth, pe.permit_number, pe.text_sequence, pe.text_segment from i\
ipermits pe where(pe.object_owner=");
    IIputdomio((short *)0,1,32,0,Owner);
    IIwritio(0,(short *)0,1,32,0,(char *)"or ''=");
    IIputdomio((short *)0,1,32,0,Owner);
    IIwritio(0,(short *)0,1,32,0,(char *)
")and LOWERCASE(pe.object_name)not like 'ii%' and pe.object_type='P' o\
rder by 1, 2, 4, 5, 6");
    IIretinit((char *)0,0);
...
IIrtB3:
    while (IInextget() != 0) {
      ...
      IIgetdomio((short *)0,1,32,XF_PROCLINE + 1-1,text_segment);
      if (IIerrtest() != 0) goto IIrtB3;
/* # line 245 "xfproc.sc" */	/* host code */
	    {
...
/* # line 256 "xfproc.sc" */	/* select */
  {
    IIsqInit((char *)0);
    IIwritio(0,(short *)0,1,32,0,(char *)
"select p.procedure_owner, p.procedure_name, '', 0, p.text_sequence, p\
.text_segment from iiprocedures p where(p.procedure_owner=");
    IIputdomio((short *)0,1,32,0,Owner);
    IIwritio(0,(short *)0,1,32,0,(char *)"or ''=");
    IIputdomio((short *)0,1,32,0,Owner);
    IIwritio(0,(short *)0,1,32,0,(char *)
")union select pe.object_owner, pe.object_name, pe.object_owner, pe.pe\
rmit_number, pe.text_sequence, pe.text_segment from iipermits pe where\
(pe.object_owner=");
    IIputdomio((short *)0,1,32,0,Owner);
    IIwritio(0,(short *)0,1,32,0,(char *)"or ''=");
    IIputdomio((short *)0,1,32,0,Owner);
    IIwritio(0,(short *)0,1,32,0,(char *)
")and pe.object_type='P' order by 1, 2, 4, 5");
    IIretinit((char *)0,0);
