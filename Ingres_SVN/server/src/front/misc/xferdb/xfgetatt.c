...
*/
void
xfgetcols(table_name, table_owner)
  char *table_name;
  char *table_owner;
{
  char owner_name[FE_MAXNAME + 1];
  char datatype[FE_MAXNAME + 1];
  char int_datatype[FE_MAXNAME + 1];
  ...
  XF_COLINFO *cp;
    ...
    if (With_r302_catalogs)
    {
/* # line 238 "xfgetatt.sc" */	/* repeated select */
  {
    IIsexec();
    while (IInexec() == 0) {
      IIsqInit((char *)0);
      IIexExec(1,(char *)"xfgetatt1",7154,4145);
      ...
      if (IInexec() == 0) {
        IIsqInit((char *)0);
        IIexDefine(1,(char *)"xfgetatt1",7154,4145);
        IIwritio(0,(short *)0,1,32,0,(char *)
"select c.table_owner, c.column_name, c.column_datatype, c.column_inte\
rnal_datatype, c.column_internal_ingtype, c.column_scale, c.column_len\
gth, c.column_internal_length, c.column_nulls, c.column_defaults, c.co\
lumn_default_val, c.column_has_default, c.");
        IIwritio(0,(short *)0,1,32,0,(char *)
"column_sequence, c.key_sequence, c.column_system_maintained, c.column\
_collid from iicolumns c, iitables t where c.table_name=");
        IIwritio(0,(short *)0,1,32,0,(char *)" $0=");
        IIputdomio((short *)0,1,32,0,table_name);
        IIwritio(0,(short *)0,1,32,0,(char *)
"and c.table_owner=t.table_owner and c.table_name=t.table_name and(c.t\
able_owner=");
        ...
        IIputdomio((short *)0,1,32,0,table_owner);
        IIwritio(0,(short *)0,1,32,0,(char *)
")and t.table_type='T' order by c.table_owner, c.column_sequence desc");
        IIexDefine(0,(char *)"xfgetatt1",7154,4145);
        if (IIerrtest() == 0) {
          IIsexec();
        } /* IIerrtest */
      } /* IInexec */
...
IIrtB1:
    while (IInextget() != 0) {
      IIgetdomio((short *)0,1,32,FE_MAXNAME + 1-1,owner_name);
      IIgetdomio((short *)0,1,32,FE_MAXNAME + 1-1,cp->column_name);
      IIgetdomio((short *)0,1,32,FE_MAXNAME + 1-1,datatype);
      IIgetdomio((short *)0,1,32,FE_MAXNAME + 1-1,int_datatype);
      IIgetdomio((short *)0,1,30,4,&int_ingtype);
      IIgetdomio((short *)0,1,30,2,&scale);
      IIgetdomio((short *)0,1,30,4,&extern_len);
      IIgetdomio((short *)0,1,30,4,&intern_len);
      IIgetdomio((short *)0,1,32,1,cp->nulls);
      IIgetdomio((short *)0,1,32,1,cp->defaults);
      IIgetdomio(&null_ind,1,32,XF_DEFAULTLINE + 1-1,default_value);
      IIgetdomio((short *)0,1,32,1,cp->has_default);
      IIgetdomio((short *)0,1,30,4,&cp->col_seq);
      IIgetdomio((short *)0,1,30,4,&cp->key_seq);
      IIgetdomio((short *)0,1,32,1,cp->sys_maint);
      IIgetdomio((short *)0,1,30,4,&cp->collID);
      if (IIerrtest() != 0) goto IIrtB1;
/* # line 264 "xfgetatt.sc" */	/* host code */
	{
...
IIrtE1:;
    ...
    {
/* # line 277 "xfgetatt.sc" */	/* repeated select */
  {
    IIsexec();
    while (IInexec() == 0) {
      IIsqInit((char *)0);
      IIexExec(1,(char *)"xfgetatt2",7155,5022);
      IIputdomio((short *)0,1,32,0,table_name);
      IIputdomio((short *)0,1,32,0,table_owner);
      IIputdomio((short *)0,1,32,0,table_owner);
      IIretinit((char *)0,0);
      if (IInexec() == 0) {
        IIsqInit((char *)0);
        IIexDefine(1,(char *)"xfgetatt2",7155,5022);
        IIwritio(0,(short *)0,1,32,0,(char *)
"select c.table_owner, c.column_name, c.column_datatype, c.column_inte\
rnal_datatype, c.column_internal_ingtype, c.column_scale, c.column_len\
gth, c.column_internal_length, c.column_nulls, c.column_defaults, c.co\
lumn_default_val, c.column_has_default, c.");
        IIwritio(0,(short *)0,1,32,0,(char *)
"column_sequence, c.key_sequence, c.column_system_maintained,  -1 from\
 iicolumns c, iitables t where c.table_name=");
        IIwritio(0,(short *)0,1,32,0,(char *)" $0=");
        IIputdomio((short *)0,1,32,0,table_name);
        IIwritio(0,(short *)0,1,32,0,(char *)
"and c.table_owner=t.table_owner and c.table_name=t.table_name and(c.t\
able_owner=");
        ...
        IIwritio(0,(short *)0,1,32,0,(char *)
")and t.table_type='T' order by c.table_owner, c.column_sequence desc");
        IIexDefine(0,(char *)"xfgetatt2",7155,5022);
        if (IIerrtest() == 0) {
          IIsexec();
        } /* IIerrtest */
      } /* IInexec */
...
/* # line 302 "xfgetatt.sc" */	/* host code */
	{
	    if (xffillcolinfo( table_name, owner_name, datatype, int_datatype,
		    int_ingtype, extern_len, intern_len, scale, cp, 
		    (null_ind == -1 ? (char *) NULL : default_value)))
...
IIrtE2:;
    ...
    {
/* # line 315 "xfgetatt.sc" */	/* repeated select */
  {
    IIsexec();
    while (IInexec() == 0) {
      IIsqInit((char *)0);
      IIexExec(1,(char *)"xfgetatt3",7156,5809);
      IIputdomio((short *)0,1,32,0,table_name);
      IIputdomio((short *)0,1,32,0,table_owner);
      IIputdomio((short *)0,1,32,0,table_owner);
      IIretinit((char *)0,0);
      if (IInexec() == 0) {
        IIsqInit((char *)0);
        IIexDefine(1,(char *)"xfgetatt3",7156,5809);
        IIwritio(0,(short *)0,1,32,0,(char *)
"select c.table_owner, c.column_name, c.column_datatype, c.column_inte\
rnal_datatype, c.column_internal_ingtype, c.column_scale, c.column_len\
gth, c.column_internal_length, c.column_nulls, c.column_defaults, '', \
'', c.column_sequence, c.key_sequence, c.");
        IIwritio(0,(short *)0,1,32,0,(char *)
"column_system_maintained,  -1 from iicolumns c, iitables t where c.ta\
ble_name=");
        IIwritio(0,(short *)0,1,32,0,(char *)" $0=");
        IIputdomio((short *)0,1,32,0,table_name);
        IIwritio(0,(short *)0,1,32,0,(char *)
...
able_owner=");
        ...
        IIwritio(0,(short *)0,1,32,0,(char *)
")and t.table_type='T' order by c.table_owner, c.column_sequence desc");
        IIexDefine(0,(char *)"xfgetatt3",7156,5809);
        if (IIerrtest() == 0) {
          IIsexec();
        } /* IIerrtest */
      } /* IInexec */
...
IIrtB3:
    while (IInextget() != 0) {
      ...
      IIgetdomio((short *)0,1,32,1,cp->nulls);
      IIgetdomio((short *)0,1,32,1,cp->defaults);
      IIgetdomio((short *)0,1,32,XF_DEFAULTLINE + 1-1,default_value);
      IIgetdomio((short *)0,1,32,1,cp->has_default);
      IIgetdomio((short *)0,1,30,4,&cp->col_seq);
      IIgetdomio((short *)0,1,30,4,&cp->key_seq);
      IIgetdomio((short *)0,1,32,1,cp->sys_maint);
...
/* # line 339 "xfgetatt.sc" */	/* host code */
	{
	    if (xffillcolinfo( table_name, owner_name, datatype, int_datatype,
...
)
{
  char buf[100]= {0};
    ...
    */
    ...
    if (int_ingtype == DB_DEC_TYPE || int_ingtype == -DB_DEC_TYPE)
...
*/
void
xfgeticols(XF_TABINFO *tlist)
{
  char index_name[FE_MAXNAME + 1];
  char base_name[FE_MAXNAME + 1];
  char owner_name[FE_MAXNAME + 1];
  XF_COLINFO *cp;
  char stmtbuf[512];
    auto XF_TABINFO	*ip;
...
IIrtB4:
    while (IInextget() != 0) {
      ...
      IIgetdomio((short *)0,1,30,4,&cp->key_seq);
      IIgetdomio((short *)0,1,32,FE_MAXNAME + 1-1,owner_name);
      IIgetdomio((short *)0,1,32,FE_MAXNAME + 1-1,index_name);
      IIgetdomio((short *)0,1,32,FE_MAXNAME + 1-1,base_name);
      IIgetdomio((short *)0,1,32,FE_MAXNAME + 1-1,cp->column_name);
      if (IIerrtest() != 0) goto IIrtB4;
/* # line 619 "xfgetatt.sc" */	/* host code */
    {
        xfread_id(cp->column_name);
...
attnode()
{
	...
	*/
        ColFreeList = (XF_COLINFO *) XF_REQMEM(sizeof(*tmp) * XFA_BLOCK, FALSE);
        if (ColFreeList == NULL)
        {
