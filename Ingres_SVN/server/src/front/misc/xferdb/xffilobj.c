...
AND t.table_reltidx >= 0", Owner, Owner); 
	...
	{
/* # line 283 "xffilobj.sc" */	/* declare */
  {
    IIsqInit((char *)0);
    IIwritio(0,(short *)0,1,32,0,(char *)
"declare global temporary table session.tbl_list(tabname char(32)not n\
ull)on commit preserve rows with NORECOVERY");
    IIsyncup((char *)0,0);
  }
/* # line 287 "xffilobj.sc" */	/* host code */
	    with_tbl_list = TRUE;
            status = IIUGhsHtabScan(Obj_list, FALSE, &entry_key, &obj_name);
            while(status)
            {
/* # line 292 "xffilobj.sc" */	/* insert */
  {
    IIsqInit((char *)0);
    IIwritio(0,(short *)0,1,32,0,(char *)
"insert into session.tbl_list values(");
    IIputdomio((short *)0,1,32,0,obj_name);
    IIwritio(0,(short *)0,1,32,0,(char *)")");
    IIsyncup((char *)0,0);
  }
/* # line 293 "xffilobj.sc" */	/* host code */
...
IIrtB1:
    while (IInextget() != 0) {
      IIgetdomio((short *)0,1,32,FE_MAXNAME + 1-1,tp->name);
      IIgetdomio((short *)0,1,32,FE_MAXNAME + 1-1,tp->owner);
      IIgetdomio((short *)0,1,32,1,tp->has_permit);
      IIgetdomio((short *)0,1,32,1,tp->alltoall);
      IIgetdomio((short *)0,1,32,1,tp->rettoall);
      IIgetdomio((short *)0,1,32,1,tp->table_type);
      IIgetdomio((short *)0,1,32,1,tp->has_integ);
      IIgetdomio((short *)0,1,32,1,tp->journaled);
      IIgetdomio((short *)0,1,30,4,&tp->expire_date);
      IIgetdomio((short *)0,1,32,1,tp->multi_locations);
      IIgetdomio((short *)0,1,32,FE_MAXNAME + 1-1,tp->location);
      IIgetdomio((short *)0,1,32,1,tp->duplicates);
      IIgetdomio((short *)0,1,32,16,tp->storage);
      IIgetdomio((short *)0,1,32,1,tp->is_data_comp);
      IIgetdomio((short *)0,1,32,1,tp->is_key_comp);
      IIgetdomio((short *)0,1,32,1,tp->is_unique);
      IIgetdomio((short *)0,1,32,1,tp->unique_scope);
      IIgetdomio((short *)0,1,30,4,&tp->ifillpct);
      IIgetdomio((short *)0,1,30,4,&tp->dfillpct);
      IIgetdomio((short *)0,1,30,4,&tp->lfillpct);
      IIgetdomio((short *)0,1,30,4,&tp->minpages);
      IIgetdomio((short *)0,1,30,4,&tp->maxpages);
      IIgetdomio((short *)0,1,30,4,&tp->allocation_size);
      IIgetdomio((short *)0,1,30,4,&tp->extend_size);
      IIgetdomio((short *)0,1,32,1,tp->is_readonly);
      IIgetdomio((short *)0,1,30,4,&tp->num_rows);
      IIgetdomio((short *)0,1,32,1,tp->row_sec_audit);
      IIgetdomio((short *)0,1,30,4,&tp->pagesize);
      IIgetdomio((short *)0,1,30,4,&tp->priority);
      IIgetdomio((short *)0,1,30,4,&tp->row_width);
      IIgetdomio((short *)0,1,30,4,&tp->table_reltid);
      IIgetdomio((short *)0,1,30,4,&tp->table_reltidx);
      IIgetdomio((short *)0,1,30,4,&tp->phys_partitions);
      IIgetdomio((short *)0,1,30,4,&tp->partition_dimensions);
      if (IIerrtest() != 0) goto IIrtB1;
/* # line 320 "xffilobj.sc" */	/* host code */
        {
...
/* # line 336 "xffilobj.sc" */	/* select */
  {
    IIsqInit((char *)0);
    IIwritio(0,(short *)0,1,32,0,(char *)
"select t.table_name, t.table_owner, t.table_permits, t.all_to_all, t.\
ret_to_all, t.table_type, t.table_integrities, t.is_journalled, t.expi\
re_date, t.multi_locations, t.location_name, t.duplicate_rows, t.stora\
ge_structure, t.is_compressed, t.");
    IIwritio(0,(short *)0,1,32,0,(char *)
"key_is_compressed, t.unique_rule, t.unique_scope, t.table_ifillpct, t\
.table_dfillpct, t.table_lfillpct, t.table_minpages, t.table_maxpages,\
 t.allocation_size, t.extend_size, t.is_readonly, t.num_rows, t.row_se\
curity_audit, t.table_pagesize, t.");
    IIwritio(0,(short *)0,1,32,0,(char *)
"table_reltcpri, t.row_width, t.table_reltid, t.table_reltidx from iit\
ables t where t.table_type='T' and t.table_subtype='N' and(t.table_own\
er=");
    IIputdomio((short *)0,1,32,0,Owner);
    IIwritio(0,(short *)0,1,32,0,(char *)"or ''=");
    IIputdomio((short *)0,1,32,0,Owner);
    IIwritio(0,(short *)0,1,32,0,(char *)
")and t.table_name not like 'iietab%' order by t.table_owner DESC, t.t\
able_name DESC");
    IIretinit((char *)0,0);
...
/* # line 377 "xffilobj.sc" */	/* host code */
	{
	    if (filltable(tp, &tcount))
	    {
		tp->tab_next = tablist;
...
.table_dfillpct, t.table_lfillpct, t.table_minpages, t.table_maxpages,\
 t.allocation_size, t.extend_size, t.is_readonly, t.num_rows, t.row_se\
curity_audit, 2048, 0 from iitables t where t.");
    IIwritio(0,(short *)0,1,32,0,(char *)
"table_type='T' and t.table_subtype='N' and(t.table_owner=");
    IIputdomio((short *)0,1,32,0,Owner);
    IIwritio(0,(short *)0,1,32,0,(char *)"or ''=");
    IIputdomio((short *)0,1,32,0,Owner);
    IIwritio(0,(short *)0,1,32,0,(char *)
")and t.table_name not like 'iietab%' order by t.table_owner, t.table_\
name DESC");
    IIretinit((char *)0,0);
...
/* # line 432 "xffilobj.sc" */	/* host code */
	{
	    if (filltable(tp, &tcount))
	    {
		tp->tab_next = tablist;
...
ge_structure, t.is_compressed, t.");
    IIwritio(0,(short *)0,1,32,0,(char *)
"key_is_compressed, t.unique_rule, '', t.table_ifillpct, t.table_dfill\
pct, t.table_lfillpct, t.table_minpages, t.table_maxpages,  -1,  -1, '\
N', 2048, 0 from iitables t where t.table_type='T' and t.table_subtype\
='N' and(t.table_owner=");
    IIputdomio((short *)0,1,32,0,Owner);
    IIwritio(0,(short *)0,1,32,0,(char *)"or ''=");
    IIputdomio((short *)0,1,32,0,Owner);
...
/* # line 486 "xffilobj.sc" */	/* host code */
	{
	    if (filltable(tp, &tcount))
	    {
		tp->tab_next = tablist;
...
ret_to_all, t.table_type, t.table_integrities, t.is_journalled, t.expi\
re_date, t.multi_locations, t.location_name, t.duplicate_rows, t.stora\
ge_structure, t.is_compressed, t.unique_rule, ");
    IIwritio(0,(short *)0,1,32,0,(char *)
"'', t.table_ifillpct, t.table_dfillpct, t.table_lfillpct, t.table_min\
pages, t.table_maxpages,  -1,  -1, 'N', 2048, 0 from iitables t where \
t.table_type='T' and t.table_subtype='N' and(t.table_owner=");
    IIputdomio((short *)0,1,32,0,Owner);
    IIwritio(0,(short *)0,1,32,0,(char *)"or ''=");
    IIputdomio((short *)0,1,32,0,Owner);
    IIwritio(0,(short *)0,1,32,0,(char *)
...
/* # line 532 "xffilobj.sc" */	/* host code */
	{
	    if (filltable(tp, &tcount))
	    {
		tp->tab_next = tablist;
...
IIrtE5:;
	...
	for (tlist = tablist; tlist; tlist = tlist->tab_next)
	    xfgetcols(tlist->name, tlist->owner);
    }
...
*/
XF_TABINFO *
xffillindex(i4 constr, XF_TABINFO *tlist)
{
  XF_TABINFO *ip;
  short nullind;
  char stmtbuf[1024];
...
IIrtB6:
    while (IInextget() != 0) {
      IIgetdomio((short *)0,1,32,FE_MAXNAME + 1-1,ip->owner);
      IIgetdomio((short *)0,1,32,FE_MAXNAME + 1-1,ip->name);
      IIgetdomio((short *)0,1,32,FE_MAXNAME + 1-1,ip->base_name);
      IIgetdomio((short *)0,1,32,FE_MAXNAME + 1-1,ip->base_owner);
      IIgetdomio((short *)0,1,32,1,ip->indexes);
      IIgetdomio((short *)0,1,32,16,ip->storage);
      IIgetdomio((short *)0,1,32,1,ip->is_data_comp);
      IIgetdomio((short *)0,1,32,1,ip->is_key_comp);
      IIgetdomio((short *)0,1,32,1,ip->is_unique);
      IIgetdomio((short *)0,1,32,1,ip->unique_scope);
      IIgetdomio((short *)0,1,32,1,ip->persistent);
      IIgetdomio((short *)0,1,30,4,&ip->ifillpct);
      IIgetdomio((short *)0,1,30,4,&ip->dfillpct);
      IIgetdomio((short *)0,1,30,4,&ip->lfillpct);
      IIgetdomio((short *)0,1,30,4,&ip->minpages);
      IIgetdomio((short *)0,1,30,4,&ip->maxpages);
      IIgetdomio((short *)0,1,32,FE_MAXNAME + 1-1,ip->location);
      IIgetdomio((short *)0,1,32,1,ip->otherlocs);
      IIgetdomio((short *)0,1,30,4,&ip->pagesize);
      IIgetdomio((short *)0,1,30,4,&ip->priority);
      IIgetdomio(&nullind,1,31,8,&ip->rng_ll1);
      IIgetdomio(&nullind,1,31,8,&ip->rng_ll2);
      IIgetdomio(&nullind,1,31,8,&ip->rng_ll3);
      IIgetdomio(&nullind,1,31,8,&ip->rng_ll4);
      IIgetdomio(&nullind,1,31,8,&ip->rng_ur1);
      IIgetdomio(&nullind,1,31,8,&ip->rng_ur2);
      IIgetdomio(&nullind,1,31,8,&ip->rng_ur3);
      IIgetdomio(&nullind,1,31,8,&ip->rng_ur4);
      if (IIerrtest() != 0) goto IIrtB6;
/* # line 743 "xffilobj.sc" */	/* host code */
	{
	    if (fillindex(ip))
	    {
...
IIrtE6:;
	...
	if (!constr)
	{
/* # line 765 "xffilobj.sc" */	/* select */
  {
    IIsqInit((char *)0);
    IIwritio(0,(short *)0,1,32,0,(char *)
"select t.table_owner, t.table_name, i.base_name, i.base_owner, t.tabl\
e_indexes, t.storage_structure, t.is_compressed, t.key_is_compressed, \
t.unique_rule, i.unique_scope, i.persistent, t.table_ifillpct, t.table\
_dfillpct, t.table_lfillpct, t.table_minpages");
    IIwritio(0,(short *)0,1,32,0,(char *)
", t.table_maxpages, t.location_name, t.multi_locations, 2048, 0 from \
iitables t, iiindexes i where i.index_name=t.table_name and i.index_ow\
ner=t.table_owner and t.table_type='I' and(i.index_owner=");
    IIputdomio((short *)0,1,32,0,Owner);
    IIwritio(0,(short *)0,1,32,0,(char *)"or ''=");
    IIputdomio((short *)0,1,32,0,Owner);
    IIwritio(0,(short *)0,1,32,0,(char *)
")and t.system_use<>'G' order by t.table_owner, t.table_name DESC");
    IIretinit((char *)0,0);
...
/* # line 791 "xffilobj.sc" */	/* host code */
	{
	    if (fillindex(ip))
	    {
		ip->tab_next = indlist;
...
/* # line 830 "xffilobj.sc" */	/* host code */
        {
            if (fillindex(ip) &&
                (ip->name[0] != '$'))
            {
...
/* # line 848 "xffilobj.sc" */	/* select */
  {
    IIsqInit((char *)0);
    IIwritio(0,(short *)0,1,32,0,(char *)
"select t.table_owner, i.index_name, i.base_name, i.base_owner, t.tabl\
e_indexes, t.storage_structure, t.is_compressed, t.key_is_compressed, \
t.unique_rule, '', '', t.table_ifillpct, t.table_dfillpct, t.table_lfi\
llpct, t.table_minpages, t.table_maxpages, t.");
    IIwritio(0,(short *)0,1,32,0,(char *)
"location_name, t.multi_locations, 2048, 0 from iitables t, iiindexes \
i where i.index_name=t.table_name and i.index_owner=t.table_owner and \
t.table_type='I' and(i.index_owner=");
    IIputdomio((short *)0,1,32,0,Owner);
    IIwritio(0,(short *)0,1,32,0,(char *)"or ''=");
    IIputdomio((short *)0,1,32,0,Owner);
    IIwritio(0,(short *)0,1,32,0,(char *)")order by t.table_owner DESC");
    IIretinit((char *)0,0);
...
/* # line 873 "xffilobj.sc" */	/* host code */
	{
	    if (fillindex(ip))
	    {
		ip->tab_next = indlist;
...
IIrtE9:;
    ...
    else
    {
        ...
        */
/* # line 890 "xffilobj.sc" */	/* select */
  {
    IIsqInit((char *)0);
    IIwritio(0,(short *)0,1,32,0,(char *)
"select t.table_owner, i.index_name, i.base_name, i.base_owner, t.tabl\
e_indexes, t.storage_structure, t.is_compressed, t.unique_rule, '', ''\
, t.table_ifillpct, t.table_dfillpct, t.table_lfillpct, t.table_minpag\
es, t.table_maxpages, t.location_name, t.");
    IIwritio(0,(short *)0,1,32,0,(char *)
"multi_locations, 2048, 0 from iitables t, iiindexes i where i.index_n\
ame=t.table_name and i.index_owner=t.table_owner and(i.index_owner=");
    IIputdomio((short *)0,1,32,0,Owner);
    IIwritio(0,(short *)0,1,32,0,(char *)"or ''=");
    IIputdomio((short *)0,1,32,0,Owner);
    IIwritio(0,(short *)0,1,32,0,(char *)")order by t.table_owner DESC");
...
/* # line 913 "xffilobj.sc" */	/* host code */
	{
	    if (fillindex(ip))
	    {
		ip->tab_next = indlist;
...
xfaddlist(char *name)
{
    char	normname[FE_MAXNAME + 1];
    char	*name_ptr, namebuf[(FE_MAXNAME + 3)];
    if (name == NULL)
	return;
    /* 
