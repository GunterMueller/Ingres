  ...
  XF_TABINFO *op;
{
  ...
  i4 text_sequence;
	...
	return;
    lastnumber = 0;
/* # line 165 "xfinteg.sc" */	/* repeated select */
  {
    IIsexec();
    while (IInexec() == 0) {
      IIsqInit((char *)0);
      IIexExec(1,(char *)"xfinteg1",7153,15876);
      IIputdomio((short *)0,1,32,0,op->name);
      IIputdomio((short *)0,1,32,0,op->owner);
      IIretinit((char *)0,0);
      if (IInexec() == 0) {
        IIsqInit((char *)0);
        IIexDefine(1,(char *)"xfinteg1",7153,15876);
        IIwritio(0,(short *)0,1,32,0,(char *)
"select i.text_segment, i.integrity_number, i.text_sequence from iiint\
egrities i where i.table_name=");
...
"order by i.integrity_number, i.text_sequence");
        IIexDefine(0,(char *)"xfinteg1",7153,15876);
        if (IIerrtest() == 0) {
          IIsexec();
        } /* IIerrtest */
      } /* IInexec */
...
IIrtB1:
    while (IInextget() != 0) {
      IIgetdomio((short *)0,1,32,XF_INTEGLINE + 1-1,text_segment);
      IIgetdomio((short *)0,1,30,2,&number);
      IIgetdomio((short *)0,1,30,4,&text_sequence);
      if (IIerrtest() != 0) goto IIrtB1;
/* # line 173 "xfinteg.sc" */	/* host code */
    {
	if (tfd == NULL)
...
XF_TABINFO  *tlist;
{
  char constraint_name[FE_MAXNAME + 1];
  char table_name[FE_MAXNAME + 1];
  char schema_name[FE_MAXNAME + 1];
...
/* # line 525 "xfinteg.sc" */	/* declare */
  {
    IIsqInit((char *)0);
    IIwritio(0,(short *)0,1,32,0,(char *)
"declare global temporary table session.cqrytext as select i.consname,\
 r.relid, r.relowner, max(q.seq +1)as \"max\" from iirelation r, iiqry\
text q, iiintegrity i left join iirelation p on((p.relid=concat('$', i\
.consname)or p.relid=i.consname)and(locate(p.");
    IIwritio(0,(short *)0,1,32,0,(char *)"relid, '$')=1))where(r.relow\
ner=");
    IIputdomio((short *)0,1,32,0,Owner);
    IIwritio(0,(short *)0,1,32,0,(char *)"or ''=");
    IIputdomio((short *)0,1,32,0,Owner);
    IIwritio(0,(short *)0,1,32,0,(char *)
")and i.inttabbase=r.reltid and i.inttabidx=r.reltidx and i.intqryid1=\
q.txtid1 and i.intqryid2=q.txtid2 and q.mode=20 and i.consflags!=0 and\
 i.intseq=0 group by i.consname, r.relid, r.relowner on commit preserv\
e rows with NORECOVERY");
    IIsyncup((char *)0,0);
  }
/* # line 540 "xfinteg.sc" */	/* select */
  {
    IIsqInit((char *)0);
    IIwritio(0,(short *)0,1,32,0,(char *)
"select i.consname, r.relid, r.relowner, charextract('UC R    P', mod(\
i.consflags, 16)), text_sequence=q.seq +1, m.\"max\", q.txt, i.consid1\
, ifnull(p.relpgsize, r.relpgsize)from iirelation r, session.cqrytext \
m, iiqrytext q, iiintegrity i left join ");
    IIwritio(0,(short *)0,1,32,0,(char *)
"iirelation p on((p.relid=concat('$', i.consname)or p.relid=i.consname\
)and(locate(p.relid, '$')=1))where(r.relowner=");
    IIputdomio((short *)0,1,32,0,Owner);
    IIwritio(0,(short *)0,1,32,0,(char *)"or ''=");
    IIputdomio((short *)0,1,32,0,Owner);
    IIwritio(0,(short *)0,1,32,0,(char *)
")and((i.consname=m.consname)and(m.relid=r.relid)and(m.relowner=r.relo\
wner))and i.inttabbase=r.reltid and i.inttabidx=r.reltidx and i.intqry\
id1=q.txtid1 and i.intqryid2=q.txtid2 and q.mode=20 and i.consflags!=0\
 and i.intseq=0 order by i.consid1, r.relowner");
    IIwritio(0,(short *)0,1,32,0,(char *)
", r.relid, i.consname, text_sequence");
    IIretinit((char *)0,0);
    if (IIerrtest() != 0) goto IIrtE2;
IIrtB2:
    while (IInextget() != 0) {
      IIgetdomio((short *)0,1,32,FE_MAXNAME + 1-1,constraint_name);
      IIgetdomio((short *)0,1,32,FE_MAXNAME + 1-1,table_name);
      IIgetdomio((short *)0,1,32,FE_MAXNAME + 1-1,schema_name);
      IIgetdomio((short *)0,1,32,1,constraint_type);
      IIgetdomio((short *)0,1,30,4,&text_sequence);
      IIgetdomio((short *)0,1,30,4,&max_sequence);
      IIgetdomio((short *)0,1,32,XF_INTEGLINE + 1-1,text_segment);
      IIgetdomio((short *)0,1,30,4,&consid1);
      IIgetdomio((short *)0,1,30,4,&cpage_size);
      if (IIerrtest() != 0) goto IIrtB2;
/* # line 563 "xfinteg.sc" */	/* host code */
    {
	if (tfd == NULL)
	{
	    tfd = xfreopen(Xf_in, TH_IS_BUFFERED);
	...
	if (process_table) 
	{
	    ...
	    */
	    ...
	    if (cpage_size > XF_COMPAT_PGSIZE &&
		where_with &&
...
/* # line 693 "xfinteg.sc" */	/* drop */
  {
    IIsqInit((char *)0);
    IIwritio(0,(short *)0,1,32,0,(char *)"drop session.cqrytext");
    IIsyncup((char *)0,0);
  }
/* # line 695 "xfinteg.sc" */	/* host code */
    for (ip = ilist; ip != NULL; ip = ip->tab_next)
    {
