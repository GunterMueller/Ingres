...
/* # line 181 "xfpermit.sc" */	/* select */
  {
    IIsqInit((char *)0);
    IIwritio(0,(short *)0,1,32,0,(char *)
"select p.object_name, p.object_owner, p.permit_grantor, p.permit_dept\
h, p.permit_number, p.text_sequence, p.text_segment from iipermits p w\
here(p.object_owner=");
    IIputdomio((short *)0,1,32,0,Owner);
    IIwritio(0,(short *)0,1,32,0,(char *)"or ''=");
    IIputdomio((short *)0,1,32,0,Owner);
    IIwritio(0,(short *)0,1,32,0,(char *)
")and p.object_type in('T', 'S')and(LOWERCASE(p.object_owner)!='$ingre\
s' or LOWERCASE(p.object_name)like 'ii$_%' escape '$')order by p.permi\
t_depth, p.permit_grantor, p.object_owner, p.object_name, p.permit_num\
ber, p.text_sequence");
    IIretinit((char *)0,0);
...
/* # line 196 "xfpermit.sc" */	/* host code */
            {
...
here(p.object_owner=");
    ...
    IIputdomio((short *)0,1,32,0,Owner);
    IIwritio(0,(short *)0,1,32,0,(char *)
")and p.object_type='T' and p.object_name=");
    IIputdomio((short *)0,1,32,0,entry_name);
    IIwritio(0,(short *)0,1,32,0,(char *)
"order by p.permit_depth, p.permit_grantor, p.object_owner, p.object_n\
ame, p.permit_number, p.text_sequence");
    IIretinit((char *)0,0);
...
/* # line 224 "xfpermit.sc" */	/* host code */
                {
                    writepermit(&tfd, object_name,
                                permit_number, text_sequence,
                                permit_grantor, text_segment);
...
IIrtE2:;
	...
	/* before 6.5, the object owner is the only possible permit grantor. */
        if(Owner[0] == EOS || Obj_list == NULL)
        {
/* # line 241 "xfpermit.sc" */	/* select */
  {
    IIsqInit((char *)0);
    IIwritio(0,(short *)0,1,32,0,(char *)
"select p.object_name, p.object_owner, p.permit_number, p.text_sequenc\
e, p.text_segment from iipermits p, iitables t where(p.object_owner=");
    IIputdomio((short *)0,1,32,0,Owner);
    IIwritio(0,(short *)0,1,32,0,(char *)"or ''=");
    IIputdomio((short *)0,1,32,0,Owner);
    IIwritio(0,(short *)0,1,32,0,(char *)
")and p.object_type='T' and t.table_name=p.object_name and t.table_own\
er=p.object_owner and t.table_type='T' order by p.object_owner, p.obje\
ct_name, p.permit_number, p.text_sequence");
    IIretinit((char *)0,0);
...
/* # line 254 "xfpermit.sc" */	/* host code */
            {
                writepermit(&tfd, object_name,
                            permit_number, text_sequence,
...
")and p.object_type='T' and p.object_name=");
    IIputdomio((short *)0,1,32,0,entry_name);
    IIwritio(0,(short *)0,1,32,0,(char *)
"and t.table_name=p.table_name and t.table_owner=p.object_owner and t.\
table_type='T' order by p.object_owner, p.object_name, p.permit_number\
, p.text_sequence");
    IIretinit((char *)0,0);
...
/* # line 283 "xfpermit.sc" */	/* host code */
                {
                    writepermit(&tfd, object_name,
                                permit_number, text_sequence,
                                object_owner, text_segment);
