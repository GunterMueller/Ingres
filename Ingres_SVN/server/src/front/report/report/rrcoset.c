...
/* # line 399 "rrcoset.sc" */	/* select */
  {
    IIsqInit((char *)0);
    IIwritio(0,(short *)0,1,32,0,(char *)
"select rcosequence, rcotype, rcosection, rcoattid, rcocommand, rcotex\
t from ii_rcommands where ");
    IIwritio(1,(short *)0,1,32,0,qual);
    IIwritio(0,(short *)0,1,32,0,(char *)" order by rcotype, rcosequen\
ce");
    IIretinit((char *)0,0);
    if (IIerrtest() != 0) goto IIrtE1;
IIrtB1:
    while (IInextget() != 0) {
      IIgetdomio((short *)0,1,30,4,&csequence);
      IIgetdomio((short *)0,1,32,0,ctype);
      IIgetdomio((short *)0,1,32,0,csection);
      IIgetdomio((short *)0,1,32,0,cattid);
      IIgetdomio((short *)0,1,32,0,ccommand);
      IIgetdomio((short *)0,1,32,0,ctext);
      if (IIerrtest() != 0) goto IIrtB1;
/* # line 417 "rrcoset.sc" */	/* host code */
		ecode = process_command();
		if (ecode != ECODE_OK)
		{
/* # line 420 "rrcoset.sc" */	/* endselect */
      {
        IIbreak();
        if (1) goto IIrtE1;
      }
/* # line 421 "rrcoset.sc" */	/* host code */
		}
    } /* IInextget */
    IIflush((char *)0,0);
IIrtE1:;
