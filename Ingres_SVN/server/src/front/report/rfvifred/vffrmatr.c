...
/* # line 326 "vffrmatr.qsc" */	/* redisplay */
  {
    IIredisp();
  }
/* # line 327 "vffrmatr.qsc" */	/* host code */
...
IIfdI1:;
    ...
    {
/* # line 392 "vffrmatr.qsc" */	/* host code */
		/*
...
/* # line 416 "vffrmatr.qsc" */	/* host code */
		...
		if (attrbytes_visible)
		{
			...
			? ERget(F_UG0001_Yes1)
			: ERget(F_UG0006_No1);
/* # line 427 "vffrmatr.qsc" */	/* putform */
      {
        if (IIfsetio((char *)"vffrmatr") != 0) {
          IIputfldio((char *)"attrbytes",(short *)0,1,32,0,iptr);
        } /* IIfsetio */
      }
/* # line 428 "vffrmatr.qsc" */	/* host code */
		}
		else
		{
/* # line 431 "vffrmatr.qsc" */	/* set_frs */
      {
...
/* # line 432 "vffrmatr.qsc" */	/* host code */
		}
		vfPutFrmAtr();          
		/*
...
/* # line 467 "vffrmatr.qsc" */	/* host code */
			oposy = frame->frposy;
			oposx = frame->frposx;
			ostyle = popuptxt;
			if (isfixed)
...
/* # line 484 "vffrmatr.qsc" */	/* host code */
...
IIfdB1:
    while (IIrunform() != 0) {
      if (IIretval() == 1) {
        {
/* # line 504 "vffrmatr.qsc" */	/* validate */
          {
            if (IIvalfld((char *)"style") == 0) {
              goto IIfdB1;
            } /* IIvalfld */
          }
/* # line 505 "vffrmatr.qsc" */	/* getform */
          {
            if (IIfsetio((char *)0) != 0) {
              IIgetfldio((short *)0,1,32,99,buf,(char *)"style");
            } /* IIfsetio */
          }
/* # line 506 "vffrmatr.qsc" */	/* host code */
...
/* # line 534 "vffrmatr.qsc" */	/* host code */
			...
			*/
/* # line 548 "vffrmatr.qsc" */	/* putform */
          {
            if (IIfsetio((char *)0) != 0) {
              IIputfldio((char *)"screen_size",(short *)0,1,32,0,cur);
            } /* IIfsetio */
          }
/* # line 549 "vffrmatr.qsc" */	/* set_frs */
          {
            if (IIiqset(2,0,(char *)"",(char *)0, (char *)0) != 0) {
              IIstfsio(54,(char *)"screen_size",0,(short *)0,1,30,sizeof(0),
              (void *)IILQint(0));
...
/* # line 550 "vffrmatr.qsc" */	/* host code */
		    }
		    vfPutFrmAtr();
		}
		else if (ispopup)
		{
/* # line 556 "vffrmatr.qsc" */	/* putform */
          {
            if (IIfsetio((char *)"vffrmatr") != 0) {
              IIputfldio((char *)"style",(short *)0,1,32,0,popuptxt);
            } /* IIfsetio */
          }
/* # line 557 "vffrmatr.qsc" */	/* host code */
		}
		else
		{
/* # line 560 "vffrmatr.qsc" */	/* putform */
          {
            if (IIfsetio((char *)"vffrmatr") != 0) {
              IIputfldio((char *)"style",(short *)0,1,32,0,fullscreentxt);
            } /* IIfsetio */
          }
/* # line 561 "vffrmatr.qsc" */	/* host code */
		}
/* # line 562 "vffrmatr.qsc" */	/* resume */
          {
            IIresnext();
            if (1) goto IIfdB1;
          }
        ...
        {
/* # line 566 "vffrmatr.qsc" */	/* validate */
          {
            if (IIvalfld((char *)"screen_size") == 0) {
              goto IIfdB1;
            } /* IIvalfld */
          }
/* # line 567 "vffrmatr.qsc" */	/* getform */
          {
            if (IIfsetio((char *)0) != 0) {
              IIgetfldio((short *)0,1,32,99,buf,(char *)"screen_size");
            } /* IIfsetio */
          }
/* # line 569 "vffrmatr.qsc" */	/* host code */
		CVlower(buf);
...
/* # line 587 "vffrmatr.qsc" */	/* host code */
		...
		else
		{
			...
			**  Must be current.
			*/
/* # line 595 "vffrmatr.qsc" */	/* putform */
          {
            if (IIfsetio((char *)0) != 0) {
              IIputfldio((char *)"screen_size",(short *)0,1,32,0,cur);
            } /* IIfsetio */
          }
/* # line 596 "vffrmatr.qsc" */	/* host code */
			frame->frmflags &= ~(fdNSCRWID | fdWSCRWID);
		}
/* # line 598 "vffrmatr.qsc" */	/* resume */
          {
            IIresnext();
            if (1) goto IIfdB1;
          }
        ...
        {
/* # line 602 "vffrmatr.qsc" */	/* validate */
          {
            if (IIvalfld((char *)"postype") == 0) {
              goto IIfdB1;
            } /* IIvalfld */
          }
/* # line 603 "vffrmatr.qsc" */	/* getform */
          {
            if (IIfsetio((char *)0) != 0) {
              IIgetfldio((short *)0,1,32,99,buf,(char *)"postype");
            } /* IIfsetio */
          }
/* # line 605 "vffrmatr.qsc" */	/* host code */
		CVlower(buf);
		...
		if (isfixed)
		{
/* # line 622 "vffrmatr.qsc" */	/* putform */
          {
            if (IIfsetio((char *)"vffrmatr") != 0) {
              IIputfldio((char *)"postype",(short *)0,1,32,0,fixedtxt);
            } /* IIfsetio */
          }
/* # line 623 "vffrmatr.qsc" */	/* host code */
		}
		else
		{
/* # line 626 "vffrmatr.qsc" */	/* putform */
          {
            if (IIfsetio((char *)"vffrmatr") != 0) {
              IIputfldio((char *)"postype",(short *)0,1,32,0,floatingtxt);
            } /* IIfsetio */
          }
/* # line 627 "vffrmatr.qsc" */	/* host code */
		}
/* # line 628 "vffrmatr.qsc" */	/* resume */
          {
            IIresnext();
            if (1) goto IIfdB1;
          }
        ...
        {
/* # line 632 "vffrmatr.qsc" */	/* validate */
          {
            if (IIvalfld((char *)"border") == 0) {
              goto IIfdB1;
            } /* IIvalfld */
          }
/* # line 633 "vffrmatr.qsc" */	/* getform */
          {
            if (IIfsetio((char *)"vffrmatr") != 0) {
              IIgetfldio((short *)0,1,32,99,buf,(char *)"border");
            } /* IIfsetio */
          }
/* # line 634 "vffrmatr.qsc" */	/* host code */
		i = (IIVF_yes1[0] == buf[0]);
...
/* # line 649 "vffrmatr.qsc" */	/* resume */
        ...
        {
/* # line 653 "vffrmatr.qsc" */	/* getform */
          {
            if (IIfsetio((char *)"vffrmatr") != 0) {
              IIgetfldio((short *)0,1,30,4,&pos,(char *)"startrow");
            } /* IIfsetio */
          }
/* # line 654 "vffrmatr.qsc" */	/* host code */
		if (pos < 1)
		{
			IIUGerr(E_VF0125_StartRowColErr, UG_ERR_ERROR, 0);
/* # line 657 "vffrmatr.qsc" */	/* putform */
          {
            if (IIfsetio((char *)"vffrmatr") != 0) {
...
/* # line 665 "vffrmatr.qsc" */	/* resume */
          {
            if (1) goto IIfdB1;
          }
/* # line 666 "vffrmatr.qsc" */	/* host code */
		}
		if (pos != oposy)
		{
			fattr_chg = TRUE;
...
/* # line 672 "vffrmatr.qsc" */	/* resume */
        ...
        {
/* # line 676 "vffrmatr.qsc" */	/* getform */
          {
            if (IIfsetio((char *)"vffrmatr") != 0) {
              IIgetfldio((short *)0,1,30,4,&pos,(char *)"startcol");
            } /* IIfsetio */
          }
/* # line 677 "vffrmatr.qsc" */	/* host code */
		if (pos < 1)
		{
			IIUGerr(E_VF0125_StartRowColErr, UG_ERR_ERROR, 0);
/* # line 680 "vffrmatr.qsc" */	/* putform */
          {
            if (IIfsetio((char *)"vffrmatr") != 0) {
...
/* # line 681 "vffrmatr.qsc" */	/* resume */
          {
            if (1) goto IIfdB1;
          }
/* # line 682 "vffrmatr.qsc" */	/* host code */
		}
		if (vfChkFrmFit(frame->frposy, pos, isborder) != 0) 
		{
			IIUGerr(E_VF0126_StartRCOvFlo, UG_ERR_ERROR, 1,
				ERget(F_VF004d_Coltitle));
/* # line 687 "vffrmatr.qsc" */	/* putform */
          {
            if (IIfsetio((char *)"vffrmatr") != 0) {
              IIputfldio((char *)"startcol",(short *)0,1,30,sizeof(1),
              (void *)IILQint(1));
...
/* # line 688 "vffrmatr.qsc" */	/* resume */
          {
            if (1) goto IIfdB1;
          }
/* # line 689 "vffrmatr.qsc" */	/* host code */
		}
		if (pos != oposx)
		{
			fattr_chg = TRUE;
...
/* # line 695 "vffrmatr.qsc" */	/* resume */
        ...
        {
/* # line 699 "vffrmatr.qsc" */	/* validate */
          {
            if (IIvalfld((char *)"attrbytes") == 0) {
              goto IIfdB1;
            } /* IIvalfld */
          }
/* # line 700 "vffrmatr.qsc" */	/* getform */
          {
            if (IIfsetio((char *)"vffrmatr") != 0) {
              IIgetfldio((short *)0,1,32,99,buf,(char *)"attrbytes");
            } /* IIfsetio */
          }
/* # line 701 "vffrmatr.qsc" */	/* host code */
		space_for_attr = (IIVF_yes1[0] == buf[0]);
/* # line 702 "vffrmatr.qsc" */	/* resume */
          {
            IIresnext();
            if (1) goto IIfdB1;
          }
        ...
        {
/* # line 707 "vffrmatr.qsc" */	/* host code */
		if (ispopup == FALSE)
		{
			IIUGerr(E_VF0129_NoVisAdjFullScr, UG_ERR_ERROR, 0); 
/* # line 710 "vffrmatr.qsc" */	/* resume */
          {
            if (1) goto IIfdB1;
          }
/* # line 711 "vffrmatr.qsc" */	/* host code */
		}
		fattr_chg = TRUE;
		FTfrminvis();
		vfVisualAdj();
		retval = TRUE;
		FTfrmvis();
/* # line 717 "vffrmatr.qsc" */	/* breakdisplay */
          {
            if (1) goto IIfdE1;
          }
        }
        ...
        {
/* # line 723 "vffrmatr.qsc" */	/* host code */
		IIUFfieldHelp();
        }
      } else if (IIretval() == 10) {
        {
/* # line 728 "vffrmatr.qsc" */	/* host code */
		vfhelpsub(VFH_FRMATR, ERget(S_VF0130_Form_Attr), NULL);
        }
      } else if (IIretval() == 11) {
        {
/* # line 733 "vffrmatr.qsc" */	/* breakdisplay */
          {
            if (1) goto IIfdE1;
          }
        }
...
/* # line 738 "vffrmatr.qsc" */	/* host code */
	/*
...
/* # line 790 "vffrmatr.qsc" */	/* putform */
  {
    if (IIfsetio((char *)"vffrmatr") != 0) {
      IIputfldio((char *)"nrows",(short *)0,1,30,4,&n);
    } /* IIfsetio */
  }
/* # line 791 "vffrmatr.qsc" */	/* host code */
	n = ncols + (isborder ? 2 * (1 + IIVFsfaSpaceForAttr) : 0);
/* # line 792 "vffrmatr.qsc" */	/* putform */
  {
    if (IIfsetio((char *)"vffrmatr") != 0) {
      IIputfldio((char *)"ncols",(short *)0,1,30,4,&n);
    } /* IIfsetio */
  }
/* # line 793 "vffrmatr.qsc" */	/* host code */
}
/*{
...
/* # line 827 "vffrmatr.qsc" */	/* host code */
	    sz = frame->frposy;
/* # line 828 "vffrmatr.qsc" */	/* putform */
  {
    if (IIfsetio((char *)"vffrmatr") != 0) {
      IIputfldio((char *)"startrow",(short *)0,1,30,4,&sz);
    } /* IIfsetio */
  }
/* # line 829 "vffrmatr.qsc" */	/* host code */
	    sz = frame->frposx;
/* # line 830 "vffrmatr.qsc" */	/* putform */
  {
    if (IIfsetio((char *)"vffrmatr") != 0) {
      IIputfldio((char *)"startcol",(short *)0,1,30,4,&sz);
    } /* IIfsetio */
  }
/* # line 831 "vffrmatr.qsc" */	/* host code */
	}
	else    /* floating */
	{
...
/* # line 836 "vffrmatr.qsc" */	/* host code */
	}
}
/*{
...
vfPutFrmAtr()
{
  char *ptr;
	...
	if (ispopup)
	{
/* # line 870 "vffrmatr.qsc" */	/* putform */
  {
    if (IIfsetio((char *)"vffrmatr") != 0) {
      IIputfldio((char *)"style",(short *)0,1,32,0,popuptxt);
    } /* IIfsetio */
  }
/* # line 872 "vffrmatr.qsc" */	/* host code */
		ptr = (isborder) ? ERget(F_UG0001_Yes1) : ERget(F_UG0006_No1);
/* # line 873 "vffrmatr.qsc" */	/* putform */
  {
    if (IIfsetio((char *)"vffrmatr") != 0) {
...
/* # line 876 "vffrmatr.qsc" */	/* host code */
	}
	else    /* fullscreen */
	{
/* # line 879 "vffrmatr.qsc" */	/* putform */
  {
    if (IIfsetio((char *)"vffrmatr") != 0) {
      IIputfldio((char *)"style",(short *)0,1,32,0,fullscreentxt);
    } /* IIfsetio */
...
/* # line 883 "vffrmatr.qsc" */	/* host code */
	}
	if (isfixed)
	{
/* # line 887 "vffrmatr.qsc" */	/* putform */
  {
    if (IIfsetio((char *)"vffrmatr") != 0) {
      IIputfldio((char *)"postype",(short *)0,1,32,0,fixedtxt);
    } /* IIfsetio */
  }
/* # line 888 "vffrmatr.qsc" */	/* host code */
	}
	else    /* floating */
	{
		if (ispopup == TRUE)
/* # line 892 "vffrmatr.qsc" */	/* putform */
  {
    if (IIfsetio((char *)"vffrmatr") != 0) {
      IIputfldio((char *)"postype",(short *)0,1,32,0,floatingtxt);
    } /* IIfsetio */
  }
/* # line 893 "vffrmatr.qsc" */	/* host code */
	}
	vfPutStartRowCol();
}
/*{
...
/* # line 1191 "vffrmatr.qsc" */	/* submenu */
  {
    goto IImuI2;
IIfdB2:
    IIrunmu(0);
    if (IIretval() == 1) {
      {
/* # line 1194 "vffrmatr.qsc" */	/* host code */
			vfFormResize(&vtfrm);
      }
    } else if (IIretval() == 2) {
      {
/* # line 1198 "vffrmatr.qsc" */	/* host code */
...
/* # line 1211 "vffrmatr.qsc" */	/* host code */
		VTKillPreview(&vtfrm);
	}
/* # line 1213 "vffrmatr.qsc" */	/* clear */
  {
    IIclrscr();
  }
/* # line 1214 "vffrmatr.qsc" */	/* host code */
}
/*{
