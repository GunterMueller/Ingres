...
/* # line 328 "writefrm.sc" */	/* host code */
				found = TRUE;
/* # line 329 "writefrm.sc" */	/* endselect */
      {
        IIbreak();
        if (1) goto IIrtE1;
      }
...
/* # line 331 "writefrm.sc" */	/* host code */
			if (found)
			{
...
/* # line 420 "writefrm.sc" */	/* host code */
		if (FEinqerr())
		{
			return(FAIL);
		}
...
/* # line 437 "writefrm.sc" */	/* host code */
		if (FEinqerr())
		{
			return(FAIL);
		}
