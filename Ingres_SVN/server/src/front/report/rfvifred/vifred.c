...
# ifndef	FT3270
/* # line 450 "vifred.qsc" */	/* inquire_frs */
  {
    if (IIiqset(0,0,(char *)0, (char *)0, (char *)0) != 0) {
      IIiqfsio((short *)0,1,32,29,mapval,8,(char *)0,2000);
    } /* IIiqset */
  }
/* # line 451 "vifred.qsc" */	/* host code */
...
/* # line 549 "vifred.qsc" */	/* host code */
      ...
      {
/* # line 557 "vifred.qsc" */	/* host code */
			vfhelp(VFH_ECREATS, ERget(S_VF0104_Create_Submenu));
			continue;
      }
    } else if (IIretval() == 8) {
      {
/* # line 563 "vifred.qsc" */	/* host code */
			VTflashplus(frame, 0, 0, 0);
			break;
      }
    } else {
...
IImuI1:
    ...
    if (IInmuact(ERget(FE_Trim),ERget(F_VF0096_cr_trim),2,2,1) == 0) goto 
    IIfdE1;
    if (IInmuact(ERget(FE_Field),ERget(F_VF0097_cr_field),2,2,2) == 0) goto 
    IIfdE1;
    if (IInmuact(ERget(FE_TblField),ERget(F_VF0098_cr_tbl_field),2,2,3) == 0) 
    goto IIfdE1;
    if (IInmuact(ERget(F_VF0055_BlankLine),ERget(F_VF0099_cr_line),2,2,4) == 0
    ) goto IIfdE1;
    if (IInmuact(boxitm,ERget(F_VF009A_cr_box),2,2,5) == 0) goto IIfdE1;
    if (IInmuact(ERget(F_VF0075_DuplicateFld),ERget(F_VF009B_dup_field),2,2,6)
     == 0) goto IIfdE1;
    if (IInmuact(ERget(FE_Help),ERget(F_FE0100_ExplFrameHelp),0,2,7) == 0) 
    goto IIfdE1;
    IIFRInternal(0);
    if (IInfrskact(1,(char *)0,0,2,7) == 0) goto IIfdE1;
    if (IInmuact(ERget(FE_End),ERget(F_VF00A5_rbf_end),2,2,8) == 0) goto IIfdE1;
    IIFRInternal(0);
...
/* # line 566 "vifred.qsc" */	/* host code */
# else
/* # line 567 "vifred.qsc" */	/* submenu */
  {
    goto IImuI2;
IIfdB2:
    IIrunmu(0);
    if (IIretval() == 1) {
      {
/* # line 570 "vifred.qsc" */	/* host code */
			createTrim();
			break;
      }
    } else if (IIretval() == 2) {
      {
/* # line 575 "vifred.qsc" */	/* host code */
			addColumn(FALSE);
			break;
      }
    } else if (IIretval() == 3) {
      {
/* # line 582 "vifred.qsc" */	/* host code */
			addColumn(TRUE);
			break;
      }
    } else if (IIretval() == 4) {
      {
/* # line 588 "vifred.qsc" */	/* host code */
			heading();
			break;
      }
    } else if (IIretval() == 5) {
      {
/* # line 594 "vifred.qsc" */	/* host code */
			createLine();
			break;
      }
    } else if (IIretval() == 6) {
      {
/* # line 601 "vifred.qsc" */	/* host code */
			vfhelp(RFH_ECREATS,
...
IImuI2:
    ...
    if (IInmuact(ERget(FE_Trim),ERget(F_VF0096_cr_trim),2,2,1) == 0) goto 
    IIfdE2;
    if (IInmuact(ERget(FE_Column),ERget(F_VF009D_column),2,2,2) == 0) goto 
    IIfdE2;
    if (IInmuact(ERget(F_VF006F_Aggregate),ERget(F_VF009E_agg),2,2,3) == 0) 
    goto IIfdE2;
    if (IInmuact(menu_heading,ERget(F_VF009F_heading),2,2,4) == 0) goto IIfdE2;
    if (IInmuact(ERget(FE_Line),ERget(F_VF0099_cr_line),2,2,5) == 0) goto 
    IIfdE2;
    if (IInmuact(ERget(FE_Help),ERget(F_FE0100_ExplFrameHelp),0,2,6) == 0) 
    goto IIfdE2;
    IIFRInternal(0);
    if (IInfrskact(1,(char *)0,0,2,6) == 0) goto IIfdE2;
    if (IInmuact(ERget(FE_End),ERget(F_VF00A5_rbf_end),2,2,7) == 0) goto IIfdE2;
    IIFRInternal(0);
    if (IInfrskact(3,(char *)0,2,2,7) == 0) goto IIfdE2;
    if (IIendmu() == 0) goto IIfdE2;
    goto IIfdB2;
IIfdE2:;
  }
/* # line 610 "vifred.qsc" */	/* host code */
# endif
	}
	vfTrigUpd();
