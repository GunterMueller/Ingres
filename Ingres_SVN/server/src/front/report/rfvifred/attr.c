...
/* # line 466 "attr.qsc" */	/* inittable */
  {
    if (IItbinit((char *)"vifattr",(char *)"vifattr",(char *)"u") != 0) {
      IItfill();
    } /* IItbinit */
  }
/* # line 467 "attr.qsc" */	/* host code */
...
/* # line 482 "attr.qsc" */	/* host code */
	}
	if (hdr->fhd2flags & fdVQLOCK)
	{
/* # line 486 "attr.qsc" */	/* set_frs */
  {
    if (IIiqset(2,0,(char *)"vifattr",(char *)0, (char *)0) != 0) {
...
/* # line 488 "attr.qsc" */	/* host code */
	}
	else
	{
/* # line 491 "attr.qsc" */	/* set_frs */
  {
    if (IIiqset(2,0,(char *)"vifattr",(char *)0, (char *)0) != 0) {
...
/* # line 547 "attr.qsc" */	/* host code */
			scrlfld = TRUE;		/* this is a scrollable field */
		}
		else
		{
/* # line 551 "attr.qsc" */	/* putform */
  {
    if (IIfsetio((char *)"vifattr") != 0) {
...
/* # line 567 "attr.qsc" */	/* host code */
		}
	}
	else
	{
		scrlfld = FALSE;	/* this is not a scrollable field */
/* # line 572 "attr.qsc" */	/* putform */
  {
    if (IIfsetio((char *)"vifattr") != 0) {
      IIputfldio((char *)"scrollable",(short *)0,1,32,0,lno1);
      IIputfldio((char *)"scrollsz",(short *)0,1,30,sizeof(0),(void *)IILQint(
...
/* # line 611 "attr.qsc" */	/* host code */
		if (!fromtf)
/* # line 612 "attr.qsc" */	/* set_frs */
  {
    if (IIiqset(2,0,(char *)"vifattr",(char *)0, (char *)0) != 0) {
      IIstfsio(54,(char *)"defval",0,(short *)0,1,30,sizeof(0),
      (void *)IILQint(0));
...
/* # line 613 "attr.qsc" */	/* host code */
	}
/* # line 614 "attr.qsc" */	/* putform */
  {
    if (IIfsetio((char *)"vifattr") != 0) {
...
/* # line 619 "attr.qsc" */	/* host code */
	cp = type->ftvalstr;
/* # line 620 "attr.qsc" */	/* putform */
  {
    if (IIfsetio((char *)"vifattr") != 0) {
      IIputfldio((char *)"valstr",(short *)0,1,32,0,cp);
    } /* IIfsetio */
  }
/* # line 622 "attr.qsc" */	/* host code */
	cp = type->ftvalmsg;
/* # line 623 "attr.qsc" */	/* putform */
  {
    if (IIfsetio((char *)"vifattr") != 0) {
      IIputfldio((char *)"valmsg",(short *)0,1,32,0,cp);
    } /* IIfsetio */
  }
/* # line 625 "attr.qsc" */	/* host code */
	cp = type->ftdefault;
/* # line 626 "attr.qsc" */	/* putform */
  {
    if (IIfsetio((char *)"vifattr") != 0) {
      IIputfldio((char *)"defval",(short *)0,1,32,0,cp);
    } /* IIfsetio */
  }
/* # line 628 "attr.qsc" */	/* host code */
	cp = hdr->fhdname;
/* # line 629 "attr.qsc" */	/* putform */
  {
    if (IIfsetio((char *)"vifattr") != 0) {
      IIputfldio((char *)"name",(short *)0,1,32,0,cp);
    } /* IIfsetio */
  }
/* # line 631 "attr.qsc" */	/* host code */
	attrcolor = vfgetcolor(hdr->fhdflags);
	colorhdr->fhdflags &= ~fdCOLOR;
	colorhdr->fhdflags |= hdr->fhdflags & fdCOLOR;
	*colorval = attrcolor;
/* # line 636 "attr.qsc" */	/* putform */
  {
    if (IIfsetio((char *)"vifattr") != 0) {
...
/* # line 756 "attr.qsc" */	/* host code */
			...
			{
/* # line 769 "attr.qsc" */	/* endloop */
          {
            if (1) goto IItbE1;
          }
/* # line 770 "attr.qsc" */	/* host code */
			}
        }
      } /* IItunload */
IItbE1:
...
/* # line 829 "attr.qsc" */	/* getform */
    {
      if (IIfsetio((char *)"vifattr") != 0) {
        IIgetfldio((short *)0,1,32,0,cptr,(char *)"defval");
      } /* IIfsetio */
    }
/* # line 830 "attr.qsc" */	/* host code */
	if (nhdr->fhd2flags & fdDERIVED)
	{
...
/* # line 837 "attr.qsc" */	/* getform */
    {
      if (IIfsetio((char *)"vifattr") != 0) {
        IIgetfldio((short *)0,1,30,4,&acolor,(char *)"color");
      } /* IIfsetio */
    }
/* # line 838 "attr.qsc" */	/* host code */
	...
	*/
	ntype->ftvalchk = NULL;
/* # line 848 "attr.qsc" */	/* getform */
    {
      if (IIfsetio((char *)"vifattr") != 0) {
        IIgetfldio((short *)0,1,32,0,cptr,(char *)"valmsg");
      } /* IIfsetio */
    }
/* # line 849 "attr.qsc" */	/* host code */
	if (nhdr->fhd2flags & fdDERIVED)
	{
	...
	*/
/* # line 859 "attr.qsc" */	/* getform */
    {
      if (IIfsetio((char *)"vifattr") != 0) {
        IIgetfldio((short *)0,1,32,0,cptr,(char *)"datatype");
      } /* IIfsetio */
    }
/* # line 860 "attr.qsc" */	/* host code */
	...
	*/
	...
	{
/* # line 876 "attr.qsc" */	/* getform */
    {
      if (IIfsetio((char *)"vifattr") != 0) {
        IIgetfldio((short *)0,1,32,0,cptr,(char *)"nullable");
      } /* IIfsetio */
    }
/* # line 877 "attr.qsc" */	/* host code */
		CVlower(cptr);
		if (*cptr == *IIVF_yes1)
		{
		...
		if (afe_vtychk(FEadfcb(), &usertype, &dbv) != OK)
		{
			...
			*/
			...
			if (*cp != '\0')
			{
/* # line 899 "attr.qsc" */	/* putform */
    {
      if (IIfsetio((char *)"vifattr") != 0) {
        IIputfldio((char *)"datatype",(short *)0,1,32,0,cp);
      } /* IIfsetio */
    }
/* # line 900 "attr.qsc" */	/* host code */
			}
			return(FAIL);
		}
		/*
		...
		*/
		if (!fromtf)
		{
				...
				&valid, &is_str) != OK || !valid)
			{
				...
				cp = attrdtype.dbut_name;
/* # line 919 "attr.qsc" */	/* putform */
    {
      if (IIfsetio((char *)"vifattr") != 0) {
        IIputfldio((char *)"datatype",(short *)0,1,32,0,cp);
      } /* IIfsetio */
    }
/* # line 921 "attr.qsc" */	/* host code */
				/*
...
/* # line 932 "attr.qsc" */	/* host code */
				    was_chartype = TRUE;
				    if (!(nhdr->fhd2flags & fdDERIVED))
				    {
/* # line 935 "attr.qsc" */	/* set_frs */
    {
      if (IIiqset(2,0,(char *)"vifattr",(char *)0, (char *)0) != 0) {
        IIstfsio(54,(char *)"scrollable",0,(short *)0,1,30,sizeof(0),
        (void *)IILQint(0));
...
/* # line 937 "attr.qsc" */	/* host code */
	...
	cptr = nhdr->fhdname;
/* # line 993 "attr.qsc" */	/* getform */
    {
      if (IIfsetio((char *)"vifattr") != 0) {
        IIgetfldio((short *)0,1,32,0,cptr,(char *)"name");
      } /* IIfsetio */
    }
/* # line 994 "attr.qsc" */	/* host code */
...
/* # line 1232 "attr.qsc" */	/* host code */
		...
		{
/* # line 1241 "attr.qsc" */	/* resume */
          {
            IIresnext();
            if (1) goto IIfdB1;
          }
/* # line 1242 "attr.qsc" */	/* host code */
		}
        }
      } else if (IIretval() == 3) {
        {
/* # line 1246 "attr.qsc" */	/* getform */
          {
            if (IIfsetio((char *)"vifattr") != 0) {
              IIgetfldio((short *)0,1,32,39,dttype,(char *)"datatype");
            } /* IIfsetio */
          }
/* # line 1247 "attr.qsc" */	/* host code */
...
/* # line 1253 "attr.qsc" */	/* resume */
          {
            if (1) goto IIfdB1;
          }
/* # line 1254 "attr.qsc" */	/* host code */
		}
		/*
...
/* # line 1276 "attr.qsc" */	/* getform */
          {
            if (IIfsetio((char *)0) != 0) {
              IIgetfldio((short *)0,1,32,1,dval,(char *)"derived");
            } /* IIfsetio */
          }
/* # line 1277 "attr.qsc" */	/* host code */
					if (*dval == *IIVF_no1)
					{
/* # line 1279 "attr.qsc" */	/* set_frs */
          {
            if (IIiqset(2,0,(char *)"vifattr",(char *)0, (char *)0) != 0) {
              IIstfsio(54,(char *)"scrollable",0,(short *)0,1,30,sizeof(0),
              (void *)IILQint(0));
...
/* # line 1296 "attr.qsc" */	/* host code */
			}
		}
/* # line 1298 "attr.qsc" */	/* resume */
          {
            IIresnext();
            if (1) goto IIfdB1;
          }
...
/* # line 1333 "attr.qsc" */	/* resume */
          {
            if (1) goto IIfdB1;
          }
/* # line 1334 "attr.qsc" */	/* host code */
		}
/* # line 1335 "attr.qsc" */	/* resume */
          {
            IIresnext();
            if (1) goto IIfdB1;
          }
        ...
        {
/* # line 1339 "attr.qsc" */	/* getform */
          {
            if (IIfsetio((char *)0) != 0) {
              IIgetfldio((short *)0,1,32,1,dval,(char *)"derived");
            } /* IIfsetio */
          }
/* # line 1340 "attr.qsc" */	/* host code */
	    if (*dval == *IIVF_yes1)
	    {
		if (der_fld == FALSE)
		{
		    der_fld = TRUE;
/* # line 1345 "attr.qsc" */	/* getform */
          {
            if (IIfsetio((char *)0) != 0) {
...
/* # line 1368 "attr.qsc" */	/* host code */
		if (!fromtf)
/* # line 1369 "attr.qsc" */	/* set_frs */
          {
            if (IIiqset(2,0,(char *)"vifattr",(char *)0, (char *)0) != 0) {
              IIstfsio(54,(char *)"defval",0,(short *)0,1,30,sizeof(0),
              (void *)IILQint(0));
...
/* # line 1370 "attr.qsc" */	/* host code */
		if (can_scroll)
/* # line 1371 "attr.qsc" */	/* set_frs */
          {
            if (IIiqset(2,0,(char *)"vifattr",(char *)0, (char *)0) != 0) {
              IIstfsio(54,(char *)"scrollable",0,(short *)0,1,30,sizeof(0),
              (void *)IILQint(0));
...
/* # line 1372 "attr.qsc" */	/* host code */
		if (scrlfld)
/* # line 1373 "attr.qsc" */	/* set_frs */
          {
            if (IIiqset(2,0,(char *)"vifattr",(char *)0, (char *)0) != 0) {
              IIstfsio(54,(char *)"scrollsz",0,(short *)0,1,30,sizeof(0),
              (void *)IILQint(0));
...
/* # line 1374 "attr.qsc" */	/* host code */
	    }
/* # line 1375 "attr.qsc" */	/* putform */
          {
            if (IIfsetio((char *)"vifattr") != 0) {
...
/* # line 1385 "attr.qsc" */	/* getform */
          {
            if (IIfsetio((char *)"vifattr") != 0) {
              IIgetfldio((short *)0,1,32,39,dttype,(char *)"datatype");
            } /* IIfsetio */
          }
/* # line 1386 "attr.qsc" */	/* host code */
		STcopy(dttype, usertype.dbut_name);
		usertype.dbut_kind = DB_UT_NOTNULL;
		if (afe_vtychk(FEadfcb(), &usertype, &dbv) != OK)
		{
			IIUGerr(E_VF0007_not_valid_datatype,
				UG_ERR_ERROR, 1, usertype.dbut_name);
/* # line 1392 "attr.qsc" */	/* resume */
          {
            IIresfld((char *)"datatype");
            if (1) goto IIfdB1;
          }
/* # line 1393 "attr.qsc" */	/* host code */
		}
		if (!scr_check(nhdr, ntype))
		{
/* # line 1396 "attr.qsc" */	/* resume */
          {
            IIresfld((char *)"scrollsz");
            if (1) goto IIfdB1;
          }
/* # line 1397 "attr.qsc" */	/* host code */
		}
		if (vfretattr(nhdr, ntype, oldnm, writeout, fromtf) == FAIL)
		{
/* # line 1400 "attr.qsc" */	/* resume */
          {
            if (1) goto IIfdB1;
          }
/* # line 1401 "attr.qsc" */	/* host code */
		}
# ifndef FORRBF
		if (fromtf)
		{
			...
			if (curfield == -1)
			{
				nomoreattr();
				nomore = TRUE;
/* # line 1410 "attr.qsc" */	/* resume */
          {
            if (1) goto IIfdB1;
          }
/* # line 1411 "attr.qsc" */	/* host code */
			}
		}
		else
# endif
		{
			if (attotflds == 1)
			{
				nomoreattr();
				nomore = TRUE;
/* # line 1420 "attr.qsc" */	/* resume */
          {
            if (1) goto IIfdB1;
          }
/* # line 1421 "attr.qsc" */	/* host code */
			}
...
/* # line 1434 "attr.qsc" */	/* getform */
          {
            if (IIfsetio((char *)"vifattr") != 0) {
              IIgetfldio((short *)0,1,32,39,dttype,(char *)"datatype");
            } /* IIfsetio */
          }
/* # line 1435 "attr.qsc" */	/* host code */
		STcopy(dttype, usertype.dbut_name);
		usertype.dbut_kind = DB_UT_NOTNULL;
		if (afe_vtychk(FEadfcb(), &usertype, &dbv) != OK)
		{
			IIUGerr(E_VF0007_not_valid_datatype,
				UG_ERR_ERROR, 1, usertype.dbut_name);
/* # line 1441 "attr.qsc" */	/* resume */
          {
            IIresfld((char *)"datatype");
            if (1) goto IIfdB1;
          }
/* # line 1442 "attr.qsc" */	/* host code */
		}
		if (!scr_check(nhdr, ntype))
		{
/* # line 1445 "attr.qsc" */	/* resume */
          {
            IIresfld((char *)"scrollsz");
            if (1) goto IIfdB1;
          }
/* # line 1446 "attr.qsc" */	/* host code */
		}
		if (vfretattr(nhdr, ntype, oldnm, writeout, fromtf) == FAIL)
		{
/* # line 1449 "attr.qsc" */	/* resume */
          {
            if (1) goto IIfdB1;
          }
/* # line 1450 "attr.qsc" */	/* host code */
		}
# ifndef FORRBF
		if (fromtf)
		{
			...
			if (curfield == -1)
			{
				nomoreattr();
				nomore = TRUE;
/* # line 1460 "attr.qsc" */	/* resume */
          {
            if (1) goto IIfdB1;
          }
/* # line 1461 "attr.qsc" */	/* host code */
			}
		}
		else
# endif
		{
			if (attotflds == 1)
			{
				nomoreattr();
				nomore = TRUE;
/* # line 1470 "attr.qsc" */	/* resume */
          {
            if (1) goto IIfdB1;
          }
/* # line 1471 "attr.qsc" */	/* host code */
			}
...
/* # line 1483 "attr.qsc" */	/* host code */
		valderhdlr();
/* # line 1484 "attr.qsc" */	/* getform */
          {
            if (IIfsetio((char *)"vifvalder") != 0) {
              IIgetfldio((short *)0,1,32,fdVSTRLEN + 1-1,formula,(char *)
"valstr");
...
/* # line 1485 "attr.qsc" */	/* putform */
        ...
        {
/* # line 1491 "attr.qsc" */	/* host code */
		IIUFfieldHelp();
        }
      } else if (IIretval() == 10) {
        {
/* # line 1496 "attr.qsc" */	/* host code */
		STcopy(ERget(S_VF000D_Field_Attributes), hlpbuf);
		FEhelp(VFH_ATTRIBUTE, hlpbuf);
        }
      } else if (IIretval() == 11) {
        {
/* # line 1501 "attr.qsc" */	/* host code */
		if (!nomore)
		{
/* # line 1503 "attr.qsc" */	/* validate */
          {
            if (IIvalfld((char *)"vifattr") == 0) {
              goto IIfdB1;
            } /* IIvalfld */
...
/* # line 1506 "attr.qsc" */	/* getform */
          {
            if (IIfsetio((char *)"vifattr") != 0) {
              IIgetfldio((short *)0,1,32,39,dttype,(char *)"datatype");
            } /* IIfsetio */
          }
/* # line 1507 "attr.qsc" */	/* host code */
			STcopy(dttype, usertype.dbut_name);
			usertype.dbut_kind = DB_UT_NOTNULL;
			if (afe_vtychk(FEadfcb(), &usertype, &dbv) != OK)
			{
				IIUGerr(E_VF0007_not_valid_datatype,
					UG_ERR_ERROR, 1, usertype.dbut_name);
/* # line 1513 "attr.qsc" */	/* resume */
          {
            IIresfld((char *)"datatype");
            if (1) goto IIfdB1;
          }
/* # line 1514 "attr.qsc" */	/* host code */
			}
			if (!scr_check(nhdr, ntype))
			{
/* # line 1517 "attr.qsc" */	/* resume */
          {
            IIresfld((char *)"scrollsz");
            if (1) goto IIfdB1;
          }
/* # line 1518 "attr.qsc" */	/* host code */
			}
			if (vfretattr(nhdr, ntype, oldnm, writeout,
				fromtf) == FAIL)
			{
/* # line 1522 "attr.qsc" */	/* resume */
          {
            if (1) goto IIfdB1;
          }
/* # line 1523 "attr.qsc" */	/* host code */
			}
		}
/* # line 1525 "attr.qsc" */	/* enddisplay */
          {
            if (1) goto IIfdF1;
          }
        }
...
FLDTYPE *type;
{
  ...
  char *llno1;
	...
	if (vfdml == FEDMLSQL)
	{
/* # line 1581 "attr.qsc" */	/* putform */
  {
    if (IIfsetio((char *)"vifattr") != 0) {
      IIputfldio((char *)"nullable",(short *)0,1,32,0,llyes1);
    } /* IIfsetio */
  }
/* # line 1582 "attr.qsc" */	/* host code */
		attrdtype.dbut_kind = DB_UT_NULL;
	}
	else
	{
/* # line 1586 "attr.qsc" */	/* putform */
  {
    if (IIfsetio((char *)"vifattr") != 0) {
      IIputfldio((char *)"nullable",(short *)0,1,32,0,llno1);
    } /* IIfsetio */
  }
/* # line 1587 "attr.qsc" */	/* host code */
		attrdtype.dbut_kind = DB_UT_NOTNULL;
	}
/* # line 1589 "attr.qsc" */	/* clear */
  {
    IIfldclear((char *)"datatype");
  }
/* # line 1590 "attr.qsc" */	/* host code */
...
/* # line 1617 "attr.qsc" */	/* putform */
  {
    if (IIfsetio((char *)"vifattr") != 0) {
      IIputfldio((char *)"datatype",(short *)0,1,32,0,dptr);
    } /* IIfsetio */
  }
/* # line 1618 "attr.qsc" */	/* host code */
...
/* # line 1626 "attr.qsc" */	/* putform */
  {
    if (IIfsetio((char *)"vifattr") != 0) {
      IIputfldio((char *)"nullable",(short *)0,1,32,0,dptr);
    } /* IIfsetio */
  }
/* # line 1627 "attr.qsc" */	/* host code */
...
/* # line 1674 "attr.qsc" */	/* host code */
		attrinit(hdr, type, FALSE, &colorval, der_str, val_str);
		vfndeftype(hdr, type);
		can_scroll = FALSE;
		scrlfld = FALSE;
/* # line 1678 "attr.qsc" */	/* putform */
      {
        if (IIfsetio((char *)0) != 0) {
...
/* # line 1689 "attr.qsc" */	/* resume */
        ...
        {
/* # line 1693 "attr.qsc" */	/* getform */
          {
            if (IIfsetio((char *)0) != 0) {
              IIgetfldio((short *)0,1,30,4,&bfldcolor,(char *)"color");
            } /* IIfsetio */
          }
/* # line 1694 "attr.qsc" */	/* host code */
		...
		{
/* # line 1703 "attr.qsc" */	/* resume */
          {
            IIresnext();
            if (1) goto IIfdB2;
          }
/* # line 1704 "attr.qsc" */	/* host code */
		}
        }
      } else if (IIretval() == 3) {
        {
/* # line 1708 "attr.qsc" */	/* getform */
          {
            if (IIfsetio((char *)"vifattr") != 0) {
              IIgetfldio((short *)0,1,32,39,bbuf,(char *)"datatype");
            } /* IIfsetio */
          }
/* # line 1709 "attr.qsc" */	/* host code */
		...
		if (afe_vtychk(FEadfcb(), &usertype, &dbv) != OK)
		{
			IIUGerr(E_VF0007_not_valid_datatype, UG_ERR_ERROR,
				1, usertype.dbut_name);
/* # line 1715 "attr.qsc" */	/* resume */
          {
            if (1) goto IIfdB2;
          }
/* # line 1716 "attr.qsc" */	/* host code */
		}
/* # line 1717 "attr.qsc" */	/* resume */
          {
            IIresnext();
            if (1) goto IIfdB2;
          }
        ...
        {
/* # line 1721 "attr.qsc" */	/* getform */
          {
            if (IIfsetio((char *)0) != 0) {
              IIgetfldio((short *)0,1,32,1,derval,(char *)"derived");
            } /* IIfsetio */
          }
/* # line 1722 "attr.qsc" */	/* host code */
	    if (*derval == *IIVF_yes1)
	    {
		if (der_fld == FALSE)
		{
		    der_fld = TRUE;
/* # line 1727 "attr.qsc" */	/* getform */
          {
            if (IIfsetio((char *)0) != 0) {
...
/* # line 1749 "attr.qsc" */	/* host code */
	    }
/* # line 1750 "attr.qsc" */	/* putform */
          {
            if (IIfsetio((char *)"vifattr") != 0) {
...
/* # line 1759 "attr.qsc" */	/* host code */
		valderhdlr();
/* # line 1760 "attr.qsc" */	/* getform */
          {
            if (IIfsetio((char *)"vifvalder") != 0) {
              IIgetfldio((short *)0,1,32,fdVSTRLEN + 1-1,dvstr,(char *)
"valstr");
...
/* # line 1761 "attr.qsc" */	/* putform */
        ...
        {
/* # line 1767 "attr.qsc" */	/* host code */
		IIUFfieldHelp();
        }
      } else if (IIretval() == 7) {
        {
/* # line 1772 "attr.qsc" */	/* host code */
		FEhelp(VFH_ATTRIBUTE, ERget(S_VF000D_Field_Attributes));
        }
      } else if (IIretval() == 8) {
        {
/* # line 1776 "attr.qsc" */	/* validate */
          {
            if (IIvalfld((char *)"vifattr") == 0) {
              goto IIfdB2;
            } /* IIvalfld */
          }
/* # line 1777 "attr.qsc" */	/* validate */
          {
            if (IIvalfld((char *)"nullable") == 0) {
              goto IIfdB2;
            } /* IIvalfld */
          }
/* # line 1778 "attr.qsc" */	/* validate */
          {
            if (IIvalfld((char *)"derived") == 0) {
              goto IIfdB2;
            } /* IIvalfld */
          }
/* # line 1779 "attr.qsc" */	/* getform */
          {
            if (IIfsetio((char *)"vifattr") != 0) {
              IIgetfldio((short *)0,1,32,39,bbuf,(char *)"datatype");
            } /* IIfsetio */
          }
/* # line 1780 "attr.qsc" */	/* host code */
		STcopy(bbuf, usertype.dbut_name);
		usertype.dbut_kind = DB_UT_NOTNULL;
		/*
		...
		*/
		if (!(bbuf[0] == EOS && attrdtype.dbut_name[0] == EOS))
		{
			if (afe_vtychk(FEadfcb(), &usertype, &dbv) != OK)
			{
				IIUGerr(E_VF0007_not_valid_datatype,
					UG_ERR_ERROR, 1, usertype.dbut_name);
/* # line 1792 "attr.qsc" */	/* resume */
          {
            IIresfld((char *)"datatype");
            if (1) goto IIfdB2;
          }
/* # line 1793 "attr.qsc" */	/* host code */
			}
		}
		/*
		** clear all field attributes except those that can
		...
		*/
		...
		i = 0;
		attr = attrflag;
/* # line 1803 "attr.qsc" */	/* unloadtable */
          {
...
/* # line 1805 "attr.qsc" */	/* host code */
			...
			{
/* # line 1817 "attr.qsc" */	/* endloop */
                {
                  if (1) goto IItbE2;
                }
/* # line 1818 "attr.qsc" */	/* host code */
			}
              }
            } /* IItunload */
IItbE2:
...
/* # line 1821 "attr.qsc" */	/* host code */
		...
		{
			IIUGerr(E_VF0004_Cant_set_both, UG_ERR_ERROR, 0);
/* # line 1825 "attr.qsc" */	/* resume */
          {
            if (1) goto IIfdB2;
          }
/* # line 1826 "attr.qsc" */	/* host code */
		}
		if ((hdr->fhdflags & fdLOWCASE) && (hdr->fhdflags & fdUPCASE))
		{
			IIUGerr(E_VF0005_Cant_set_low_up, UG_ERR_ERROR, 0);
/* # line 1830 "attr.qsc" */	/* resume */
          {
            if (1) goto IIfdB2;
          }
/* # line 1831 "attr.qsc" */	/* host code */
		}
		ptr = buf;
/* # line 1835 "attr.qsc" */	/* getform */
          {
            if (IIfsetio((char *)"vifattr") != 0) {
              IIgetfldio((short *)0,1,32,0,ptr,(char *)"valstr");
            } /* IIfsetio */
          }
/* # line 1836 "attr.qsc" */	/* host code */
		type->ftvalstr = saveStr(ptr);
/* # line 1838 "attr.qsc" */	/* getform */
          {
            if (IIfsetio((char *)"vifattr") != 0) {
              IIgetfldio((short *)0,1,32,4,nflag,(char *)"derived");
            } /* IIfsetio */
          }
/* # line 1839 "attr.qsc" */	/* host code */
...
/* # line 1877 "attr.qsc" */	/* getform */
          {
            if (IIfsetio((char *)"vifattr") != 0) {
              IIgetfldio((short *)0,1,32,0,ptr,(char *)"defval");
            } /* IIfsetio */
          }
/* # line 1878 "attr.qsc" */	/* host code */
		if (hdr->fhd2flags & fdDERIVED)
		{
			/* No default values for derived fields. */
			ptr[0] = EOS;
...
/* # line 1885 "attr.qsc" */	/* getform */
          {
            if (IIfsetio((char *)"vifattr") != 0) {
              IIgetfldio((short *)0,1,32,0,ptr,(char *)"valmsg");
            } /* IIfsetio */
          }
/* # line 1886 "attr.qsc" */	/* host code */
		if (hdr->fhd2flags & fdDERIVED)
		{
			/* No validation error message for derived fields. */
			ptr[0] = EOS;
		...
		ptr = hdr->fhdname;
/* # line 1894 "attr.qsc" */	/* getform */
          {
            if (IIfsetio((char *)"vifattr") != 0) {
              IIgetfldio((short *)0,1,32,0,ptr,(char *)"name");
            } /* IIfsetio */
          }
/* # line 1896 "attr.qsc" */	/* host code */
		/*
		...
		*/
		if (!(old_name[0] == EOS && *ptr == EOS))
		{
			...
			{
/* # line 1903 "attr.qsc" */	/* resume */
          {
            IIresfld((char *)"name");
            if (1) goto IIfdB2;
          }
/* # line 1904 "attr.qsc" */	/* host code */
			}
		}
		CVlower(hdr->fhdname);
/* # line 1909 "attr.qsc" */	/* getform */
          {
            if (IIfsetio((char *)"vifattr") != 0) {
              IIgetfldio((short *)0,1,30,4,&bcolor,(char *)"color");
            } /* IIfsetio */
          }
/* # line 1910 "attr.qsc" */	/* host code */
		vfsetcolor(&hdr->fhdflags, bcolor);
		/*
		**  Get and check datatype/nullability from form.
		*/
/* # line 1915 "attr.qsc" */	/* getform */
          {
            if (IIfsetio((char *)"vifattr") != 0) {
              IIgetfldio((short *)0,1,32,49,dbuf,(char *)"datatype");
            } /* IIfsetio */
          }
/* # line 1917 "attr.qsc" */	/* host code */
		/*
...
/* # line 1928 "attr.qsc" */	/* getform */
          {
            if (IIfsetio((char *)"vifattr") != 0) {
              IIgetfldio((short *)0,1,32,49,dbuf,(char *)"nullable");
            } /* IIfsetio */
          }
/* # line 1929 "attr.qsc" */	/* host code */
			CVlower(dbuf);
			if (*dbuf == *IIVF_yes1)
			{
				usertype.dbut_kind = DB_UT_NULL;
			...
			if (afe_vtychk(FEadfcb(), &usertype, &dbv) != OK)
			{
				...
				if (*ptr != '\0')
				{
/* # line 1945 "attr.qsc" */	/* putform */
          {
            if (IIfsetio((char *)"vifattr") != 0) {
              IIputfldio((char *)"datatype",(short *)0,1,32,0,ptr);
            } /* IIfsetio */
          }
/* # line 1946 "attr.qsc" */	/* host code */
				}
/* # line 1947 "attr.qsc" */	/* resume */
          {
            IIresfld((char *)"datatype");
            if (1) goto IIfdB2;
          }
/* # line 1948 "attr.qsc" */	/* host code */
			}
			/*
...
/* # line 2204 "attr.qsc" */	/* host code */
	CVlower(nbuf);
	/* If derived, simply zap scrollability. */
	if (*derbuf == *IIVF_yes1)
	{
/* # line 2209 "attr.qsc" */	/* putform */
  {
    if (IIfsetio((char *)"vifattr") != 0) {
...
/* # line 2244 "attr.qsc" */	/* host code */
	...
	*/
/* # line 2252 "attr.qsc" */	/* getform */
  {
    if (IIfsetio((char *)"vifattr") != 0) {
      IIgetfldio((short *)0,1,32,39,tbuf,(char *)"scrollable");
    } /* IIfsetio */
  }
/* # line 2253 "attr.qsc" */	/* host code */
	if (*tbuf == *IIVF_no1)
	{
		scrlfld = FALSE;
		hdr->fhd2flags &= ~fdSCRLFD;
	...
	*/
/* # line 2270 "attr.qsc" */	/* getform */
  {
    if (IIfsetio((char *)"vifattr") != 0) {
      IIgetfldio((short *)0,1,30,4,&scrlength,(char *)"scrollsz");
    } /* IIfsetio */
  }
/* # line 2272 "attr.qsc" */	/* host code */
	/*
...
IIfdB3:
    while (IIrunform() != 0) {
      if (IIretval() == 1) {
        {
/* # line 2339 "attr.qsc" */	/* getform */
          {
            if (IIfsetio((char *)"vifattr") != 0) {
              IIgetfldio((short *)0,1,32,1,drived,(char *)"derived");
            } /* IIfsetio */
          }
/* # line 2340 "attr.qsc" */	/* host code */
	if (*drived == *IIVF_yes1)
