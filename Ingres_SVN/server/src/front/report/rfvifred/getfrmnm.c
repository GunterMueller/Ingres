...
vfsvdisp()
{
	...
	if (vfspec == 'F')
	{
/* # line 354 "getfrmnm.qsc" */	/* set_frs */
  {
    if (IIiqset(2,0,_vfsave,(char *)0, (char *)0) != 0) {
      IIstfsio(21,_name,0,(short *)0,1,32,0,(char *)"q");
    } /* IIiqset */
  }
/* # line 355 "getfrmnm.qsc" */	/* host code */
	}
/* # line 356 "getfrmnm.qsc" */	/* putform */
  {
    if (IIfsetio(_vfsave) != 0) {
      IIputfldio((char *)"xfield1",(short *)0,1,32,0,ERx(""));
      IIputfldio((char *)"xfield2",(short *)0,1,32,0,ERx(""));
      IIputfldio((char *)"xfield3",(short *)0,1,32,0,ERx(""));
      IIputfldio((char *)"xfield4",(short *)0,1,32,0,ERx(""));
    } /* IIfsetio */
  }
/* # line 358 "getfrmnm.qsc" */	/* host code */
	return(OK);
}
/*{
