...
# endif
		case ALIGN:
			...
			IIVFrcRulersControl();
/* # line 419 "cursor.qsc" */	/* redisplay */
  {
    IIredisp();
  }
/* # line 420 "cursor.qsc" */	/* host code */
...
/* # line 440 "cursor.qsc" */	/* redisplay */
  {
    IIredisp();
  }
/* # line 441 "cursor.qsc" */	/* host code */
			IIVTlf( frame, FALSE, FALSE );
			continue;
		case COLOPTS:
...
/* # line 529 "cursor.qsc" */	/* redisplay */
  {
    IIredisp();
  }
/* # line 530 "cursor.qsc" */	/* host code */
			    IIVTlf(frame, FALSE, FALSE);
...
# endif
				...
				NULL, obj_type, help_subject, help_file);
/* # line 629 "cursor.qsc" */	/* redisplay */
  {
    IIredisp();
  }
/* # line 630 "cursor.qsc" */	/* host code */
			    IIVTlf(frame, FALSE, FALSE);
			    if (choice == CONFCH_YES)
			    {
				/* Save, then exit. */
...
# endif
			...
			FTclear();
# ifdef FORRBF
/* # line 672 "cursor.qsc" */	/* endforms */
  {
    IIendforms();
  }
/* # line 673 "cursor.qsc" */	/* host code */
			EXsignal(EXEXIT, 2, (long)0, (long)NOABORT);
# else
			if (!Vfeqlcall)
			{
/* # line 677 "cursor.qsc" */	/* endforms */
  {
    IIendforms();
  }
/* # line 678 "cursor.qsc" */	/* host code */
				enddb();
				vfexit(OK);
			}
...
IIfdB1:
    while (IIrunform() != 0) {
      if (IIretval() == 1) {
        {
/* # line 900 "cursor.qsc" */	/* host code */
		cancelled = TRUE;
/* # line 901 "cursor.qsc" */	/* breakdisplay */
          {
            if (1) goto IIfdE1;
          }
        }
        ...
        {
/* # line 906 "cursor.qsc" */	/* host code */
		FEhelp(VFH_RUCTRL, ERget(S_VF016F_RULER_CTRL));
        }
      } else if (IIretval() == 3) {
        {
/* # line 911 "cursor.qsc" */	/* enddisplay */
          {
            if (1) goto IIfdF1;
          }
        }
