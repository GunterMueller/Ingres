...
/* # line 248 "rfwrite.qsc" */	/* clear */
  {
    IIclrscr();
  }
/* # line 250 "rfwrite.qsc" */	/* host code */
...
/* # line 273 "rfwrite.qsc" */	/* host code */
	...
	*/
	...
	{
/* # line 280 "rfwrite.qsc" */	/* set_frs */
    {
      if (IIiqset(2,0,formname,(char *)0, (char *)0) != 0) {
        IIstfsio(21,(char *)"xfield2",0,(short *)0,1,32,0,(char *)"r");
      } /* IIiqset */
    }
/* # line 281 "rfwrite.qsc" */	/* host code */
	}
	else
	{
/* # line 284 "rfwrite.qsc" */	/* set_frs */
    {
      if (IIiqset(2,0,formname,(char *)0, (char *)0) != 0) {
        IIstfsio(21,(char *)"xfield2",0,(short *)0,1,32,0,(char *)"f");
      } /* IIiqset */
    }
/* # line 285 "rfwrite.qsc" */	/* host code */
	}
	if  (Rbf_from_ABF)
	{
		r_name = Rbf_orname;
/* # line 289 "rfwrite.qsc" */	/* putform */
    {
      if (IIfsetio(formname) != 0) {
        IIputfldio((char *)"name",(short *)0,1,32,0,r_name);
      } /* IIfsetio */
    }
/* # line 290 "rfwrite.qsc" */	/* set_frs */
    {
      if (IIiqset(2,0,formname,(char *)0, (char *)0) != 0) {
        IIstfsio(21,(char *)"name",0,(short *)0,1,32,0,(char *)"q");
      } /* IIiqset */
    }
/* # line 291 "rfwrite.qsc" */	/* host code */
	}
	/*
	...
	*/
	...
	if  (ql_avail == FEDMLBOTH)
	{
		...
		fldmode = ERx("FILL");
/* # line 316 "rfwrite.qsc" */	/* putform */
    {
      if (IIfsetio(formname) != 0) {
        IIputfldio((char *)"xfield3",(short *)0,1,32,0,
        ERget(F_RF002B_Query_language_));
      } /* IIfsetio */
    }
/* # line 317 "rfwrite.qsc" */	/* putform */
    {
      if (IIfsetio(formname) != 0) {
        IIputfldio((char *)"xfield4",(short *)0,1,32,0,r_qlang);
      } /* IIfsetio */
    }
/* # line 318 "rfwrite.qsc" */	/* host code */
	}
	else
	{
		fldmode = ERx("READ");
/* # line 322 "rfwrite.qsc" */	/* putform */
    {
      if (IIfsetio(formname) != 0) {
        IIputfldio((char *)"xfield3",(short *)0,1,32,0,
        ERget(F_RF002B_Query_language_));
...
/* # line 323 "rfwrite.qsc" */	/* putform */
    {
      if (IIfsetio(formname) != 0) {
        IIputfldio((char *)"xfield4",(short *)0,1,32,0,ERget(F_RF0008_sql));
      } /* IIfsetio */
    }
/* # line 324 "rfwrite.qsc" */	/* host code */
	}
/* # line 325 "rfwrite.qsc" */	/* set_frs */
    {
      if (IIiqset(2,0,formname,(char *)0, (char *)0) != 0) {
        IIstfsio(21,(char *)"xfield4",0,(short *)0,1,32,0,fldmode);
      } /* IIiqset */
    }
/* # line 327 "rfwrite.qsc" */	/* host code */
	return (OK);
  }
static
STATUS
...
i4	*right_margin;
  {
    ...
    char r_tname[FE_MAXTABNAME];
    char r_qlang[FE_MAXNAME+1];
	FE_RSLV_NAME	rfs_ferslv;
	Rbf_xns_given = FALSE;
	formname = Nrsave;
/* # line 348 "rfwrite.qsc" */	/* getform */
    {
      if (IIfsetio(formname) != 0) {
        IIgetfldio((short *)0,1,32,FE_MAXTABNAME-1,r_tname,(char *)
"xfield2");
      } /* IIfsetio */
    }
/* # line 350 "rfwrite.qsc" */	/* host code */
	/*
	...
	*/
	if (En_SrcTyp != JDRepSrc)
	{
		...
		if  (ql_avail == FEDMLBOTH)
		{
/* # line 438 "rfwrite.qsc" */	/* getform */
    {
      if (IIfsetio(formname) != 0) {
        IIgetfldio((short *)0,1,32,FE_MAXNAME+1-1,r_qlang,(char *)"xfi\
eld4");
      } /* IIfsetio */
    }
/* # line 439 "rfwrite.qsc" */	/* host code */
