...
#define MAXTITLE	128
static READONLY char	_Name[]		= ERx("look_up"),
...
i4		ndesc;
  {
	...
	if ( IIFRmdfMakeDefaultForm( ERget(_QualifyTitle),
				_ii_qualify, TRUE, ndesc, flds, 0, &frm
		) != OK )
	{
		return (char *)NULL;
	}
	...
	{
/* # line 1053 "abrtlkup.qsc" */	/* addform */
    {
      IIaddform(frm);
    }
/* # line 1054 "abrtlkup.qsc" */	/* host code */
		return _ii_qualify;
	}
  }
/*
...
/* # line 1110 "abrtlkup.qsc" */	/* display */
  {
    if (IIdispfrm(form,(char *)"q") == 0) goto IIfdE1;
    goto IImuI1;
IIfdI1:;
IIfdB1:
    while (IIrunform() != 0) {
      if (IIretval() == 1) {
        {
/* # line 1113 "abrtlkup.qsc" */	/* host code */
		...
		if ( (qryd = (QRY_SPEC *)FEreqmem(tag,
			...
			|| (qualfld = (ABRT_QFLD *)FEreqmem(tag,
						...
						TRUE, &rval)) == NULL )
		{
/* # line 1143 "abrtlkup.qsc" */	/* breakdisplay */
          {
            if (1) goto IIfdE1;
          }
/* # line 1144 "abrtlkup.qsc" */	/* host code */
		}
		...
		qryd += nspecs;
		qryd->qs_var = (PTR)ERx(( nspecs == 0 ) ? " WHERE " : " AND ");
		...
		qryd->qs_type = QS_END;
		rval = OK;
/* # line 1181 "abrtlkup.qsc" */	/* breakdisplay */
          {
            if (1) goto IIfdE1;
          }
        }
        ...
        {
/* # line 1186 "abrtlkup.qsc" */	/* host code */
		rval = FAIL;
/* # line 1187 "abrtlkup.qsc" */	/* breakdisplay */
          {
            if (1) goto IIfdE1;
          }
        }
        ...
        {
/* # line 1191 "abrtlkup.qsc" */	/* host code */
...
IImuI1:
    ...
    if (IInmuact(ERget(FE_Go),ERget(_QualifyExpl),2,2,1) == 0) goto IIfdE1;
    IIFRInternal(0);
    if (IInfrskact(4,(char *)0,2,2,1) == 0) goto IIfdE1;
    if (IInmuact(ERget(FE_Forget),ERget(_ForgetExpl),2,2,2) == 0) goto IIfdE1;
    IIFRInternal(0);
...
/* # line 1194 "abrtlkup.qsc" */	/* host code */
...
i4		rows;
  {
	...
	if ( IIFRmdfMakeDefaultForm( title, _ii_lookup, col_titles,
					ndesc, flds, rows, &frm) != OK )
	{
		return FAIL;
	}
	/* initialize form and table field */
/* # line 1258 "abrtlkup.qsc" */	/* addform */
    {
      IIaddform(frm);
    }
/* # line 1259 "abrtlkup.qsc" */	/* host code */
...
/* # line 1328 "abrtlkup.qsc" */	/* message */
    {
      IImessage(msg);
    }
/* # line 1329 "abrtlkup.qsc" */	/* host code */
	qry->qr_qdesc->qg_mode &= ~QM_MAP;
	qry->qr_version &= ~QR_0_ROWS_OK;
	if ( !IIARgn1RtsgenV1(qry, QI_START) )
	{ /* no rows fetched */
/* # line 1334 "abrtlkup.qsc" */	/* message */
    {
      IImessage(ERget(S_IT001C_No_rows_retrieved));
    }
/* # line 1335 "abrtlkup.qsc" */	/* sleep */
    {
      IIsleep(3);
    }
/* # line 1336 "abrtlkup.qsc" */	/* host code */
		return 0;
	}
/* # line 1338 "abrtlkup.qsc" */	/* inquire_frs */
    {
      if (IIiqset(3,0,_ii_lookup,(char *)0, (char *)0) != 0) {
        IIiqfsio((short *)0,1,30,4,&row,32,_ii_lookup,0);
      } /* IIiqset */
    }
/* # line 1339 "abrtlkup.qsc" */	/* host code */
	if ( row > 1 )
	{
	...
	for ( cols = qry->qr_argv; cols->qv_name != NULL ; ++cols )
    {
      ...
      register DB_DATA_VALUE *value;
		name = cols->qv_name;
		value = cols->qv_dbval;
/* # line 1361 "abrtlkup.qsc" */	/* getrow */
      {
        if (IItbsetio(2,_ii_lookup,_ii_lookup,-2) != 0) {
          IItcogetio((short *)0,1,44,0,value,name);
          IITBceColEnd();
        } /* IItbsetio */
      }
    }
/* # line 1363 "abrtlkup.qsc" */	/* host code */
	return row;
  }
/*
...
/* # line 1496 "abrtlkup.qsc" */	/* loadtable */
    {
      if (IItbact(_ii_lookup,_ii_lookup,1) != 0) {
        IItsc_param( template, dbv_ptrs ,(int *)0);
        IITBceColEnd();
      } /* IItbact */
    }
/* # line 1497 "abrtlkup.qsc" */	/* host code */
	}
	if ( row > 1 )
	{
		row = 1 + IIFRrlpRunListPick( _ii_lookup, _ii_lookup,
