...
DB_DATA_VALUE	*data;
  {
	...
	_VOID_ IIgetfldio((i2 *) NULL, 1, DB_DBV_TYPE, 0, (PTR)data,
			name, DB_CHR_TYPE);
/* # line 81 "abrtgetf.qsc" */	/* inquire_frs */
    {
      if (IIiqset(0,0,(char *)0, (char *)0, (char *)0) != 0) {
        IIiqfsio((short *)0,1,30,4,&frserror,1,(char *)0,0);
      } /* IIiqset */
    }
/* # line 82 "abrtgetf.qsc" */	/* host code */
	if (frserror != 0)
	{
...
/* # line 124 "abrtgetf.qsc" */	/* inquire_frs */
    {
      if (IIiqset(0,0,(char *)0, (char *)0, (char *)0) != 0) {
        IIiqfsio((short *)0,1,30,4,&frserror,1,(char *)0,0);
      } /* IIiqset */
    }
/* # line 125 "abrtgetf.qsc" */	/* host code */
	if (frserror != 0)
	{
        	cb = FEadfcb();
                adc_getempty(cb, data);
