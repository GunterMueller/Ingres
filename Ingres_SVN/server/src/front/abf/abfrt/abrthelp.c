...
ABRTSPRO	*proc;
  {
		...
		else
    {
      char *fn;
			LOtos(&tmp, &fn);
/* # line 156 "abrthelp.qc" */	/* helpfile */
      {
        IIhelpfile(subject,fn);
      }
    }
/* # line 158 "abrthelp.qc" */	/* host code */
	}
	return NULL;
  }
/*{
...
ABRTSPRO	*proc;
  {
		...
		else
    {
      char *fn;
			LOtos(&tmp, &fn);
/* # line 259 "abrthelp.qc" */	/* help_frs */
      {
        IIfrshelp(0,subject,fn);
      }
    }
/* # line 261 "abrthelp.qc" */	/* host code */
	}
	return NULL;
  }
/*{
...
/* # line 413 "abrthelp.qc" */	/* host code */
	...
	if ( fldname[0] == EOS )
	{
/* # line 420 "abrthelp.qc" */	/* inquire_frs */
    {
      if (IIiqset(1,0,(char *)0, (char *)0, (char *)0) != 0) {
        IIiqfsio((short *)0,1,32,FE_MAXNAME+1-1,fldname,22,formname,0);
      } /* IIiqset */
    }
/* # line 421 "abrthelp.qc" */	/* host code */
...
/* # line 452 "abrthelp.qc" */	/* host code */
		...
		{ /* Check for column existence */
			...
			** table field.
			*/
/* # line 464 "abrthelp.qc" */	/* inquire_frs */
    {
      if (IIiqset(4,0,formname,fldname,(char *)0) != 0) {
        IIiqfsio((short *)0,1,30,4,&istable,23,colname,0);
      } /* IIiqset */
    }
/* # line 467 "abrthelp.qc" */	/* host code */
			if ( (errnum = FEinqferr()) != OK )
			{
	    			_VOID_ IIseterr(user_errh);
