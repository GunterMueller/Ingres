	...
	*a9;
{
	...
	*/
	if (!isxflag)
/* # line 189 "inidb.sc" */	/* commit */
  {
    IIsqInit((char *)0);
    IIxact(3);
  }
/* # line 190 "inidb.sc" */	/* host code */
...
/* # line 313 "inidb.sc" */	/* commit */
  {
    IIsqInit((char *)0);
    IIxact(3);
  }
/* # line 314 "inidb.sc" */	/* host code */
	IIARsadSetArDbname(dbname);
	return;
}
/*{
  ...
  i4 sess_id;
{
	...
	if (sess_id != 0)
	{
/* # line 394 "inidb.sc" */	/* set_ingres */
  {
    IILQssSetSqlio(11,(short *)0,1,30,4,&sess_id);
  }
/* # line 395 "inidb.sc" */	/* host code */
	}
	else
	{
		IILQncsNoCurSession();
...
/* # line 453 "inidb.sc" */	/* inquire_ingres */
  {
    IILQisInqSqlio((short *)0,1,30,4,&transact,73);
  }
/* # line 454 "inidb.sc" */	/* inquire_ingres */
  {
    IILQisInqSqlio((short *)0,1,30,4,&sess_id,11);
  }
/* # line 455 "inidb.sc" */	/* inquire_ingres */
  {
    IILQisInqSqlio((short *)0,1,32,DB_MAXNAME+1-1,dbname,81);
  }
/* # line 456 "inidb.sc" */	/* host code */
	if (sess_id != 0)
	{
		...
		*/
		...
		if ( (dbname != NULL) && ((dbtmp == NULL) || (*dbtmp == NULL)) )
			STcopy(dbname, dbtmp);
		if (transact != 1)
		{
/* # line 475 "inidb.sc" */	/* commit */
  {
    IIsqInit((char *)0);
    IIxact(3);
  }
/* # line 476 "inidb.sc" */	/* host code */
		}
	    }
...
validate_session(i4 *sess_id, char *conn_name, bool is_disconnect)
{
  i4 current_sess_id;
	...
	*/
	...
	{
/* # line 562 "inidb.sc" */	/* inquire_ingres */
  {
    IILQisInqSqlio((short *)0,1,30,4,&current_sess_id,11);
  }
/* # line 563 "inidb.sc" */	/* host code */
...
{
  i4 sess;
/* # line 608 "inidb.sc" */	/* inquire_ingres */
  {
    IILQisInqSqlio((short *)0,1,30,4,&sess,11);
  }
/* # line 609 "inidb.sc" */	/* host code */
	if (sess != 0)
	{
		...
		*/
		IIresync();
/* # line 615 "inidb.sc" */	/* rollback */
  {
    IIsqInit((char *)0);
    IIxact(2);
  }
/* # line 616 "inidb.sc" */	/* host code */
	}
	dbms_exit();
}
/*{
...
dbms_exit ()
{
/* # line 654 "inidb.sc" */	/* disconnect */
  {
    IIsqInit((char *)0);
    IILQsidSessID(-99);
    IIsqDisconnect();
  }
/* # line 655 "inidb.sc" */	/* host code */
	if (!IIarNoDB)
	{
/* # line 657 "inidb.sc" */	/* set_ingres */
  {
    IILQssSetSqlio(11,(short *)0,1,30,sizeof(ABRT_SESSION),(void *)IILQint(
    ABRT_SESSION));
  }
/* # line 658 "inidb.sc" */	/* disconnect */
  {
    IIsqInit((char *)0);
    IILQsidSessID(ABRT_SESSION);
    IIsqDisconnect();
  }
/* # line 659 "inidb.sc" */	/* host code */
	}
	IIARsadSetArDbname(NULL);
}
/*{
