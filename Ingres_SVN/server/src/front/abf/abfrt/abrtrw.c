...
/* # line 260 "abrtrw.qsc" */	/* display */
      {
        if (IIdispfrm(formnm,mode) == 0) goto IIfdE1;
        goto IImuI1;
IIfdI1:;
        if (IIfsetio((char *)0) == 0) goto IIfdE1;
        {
/* # line 263 "abrtrw.qsc" */	/* host code */
...
IIfdB1:
        while (IIrunform() != 0) {
          if (IIretval() == 1) {
            {
/* # line 274 "abrtrw.qsc" */	/* validate */
              {
                if (IIchkfrm() == 0) {
                  goto IIfdB1;
                } /* IIchkfrm */
              }
/* # line 276 "abrtrw.qsc" */	/* host code */
				/*
				...
				*/
				run_report = TRUE;
/* # line 283 "abrtrw.qsc" */	/* breakdisplay */
              {
                if (1) goto IIfdE1;
              }
            }
            ...
            {
/* # line 288 "abrtrw.qsc" */	/* host code */
				run_report = TRUE;
				batch = TRUE;
/* # line 290 "abrtrw.qsc" */	/* breakdisplay */
              {
                if (1) goto IIfdE1;
              }
            }
            ...
            {
/* # line 297 "abrtrw.qsc" */	/* host code */
				FEhelp( hlpREPMU, ERget(_Help_Title) );
            }
          } else if (IIretval() == 4) {
            {
/* # line 304 "abrtrw.qsc" */	/* breakdisplay */
              {
                if (1) goto IIfdE1;
              }
            }
...
IImuI1:
        ...
        if (IInmuact(ERget(FE_Report),ERget(_RunRep_Expl),1,2,1) == 0) goto 
        IIfdE1;
        if (IInmuact(_batch,ERget(_Batch_Expl),1,2,2) == 0) goto IIfdE1;
...
/* # line 315 "abrtrw.qsc" */	/* clear */
      {
        IIclrscr();
      }
/* # line 316 "abrtrw.qsc" */	/* host code */
				RunReport( &(frm->abrfrrw), rwparams.buf, batch );
#ifndef FT3270
/* # line 318 "abrtrw.qsc" */	/* clear */
      {
        IIclrscr();
      }
/* # line 319 "abrtrw.qsc" */	/* host code */
#endif
/*
...
static STATUS
  ...
  {
	bool	err = FALSE;
/* # line 361 "abrtrw.qsc" */	/* formdata */
    {
      if (IIdispfrm(form,(char *)"Names") == 0) goto IIfdE2;
      while (IIfnames() != 0) {
        {
          i4 istable;
          char cfield[FE_MAXNAME+1];
/* # line 366 "abrtrw.qsc" */	/* inquire_frs */
          {
            if (IIiqset(2,0,(char *)"",(char *)0, (char *)0) != 0) {
              IIiqfsio((short *)0,1,32,FE_MAXNAME+1-1,cfield,19,(char *)0,0);
              IIiqfsio((short *)0,1,30,4,&istable,28,(char *)0,0);
            } /* IIiqset */
          }
/* # line 367 "abrtrw.qsc" */	/* host code */
		if ( istable == 1 )
		{
			abusrerr(NOTBLFLD, cfield, (char *)NULL);
			err = TRUE;
/* # line 371 "abrtrw.qsc" */	/* endloop */
          {
            if (1) goto IIfdE2;
          }
/* # line 372 "abrtrw.qsc" */	/* host code */
		}
        }
      } /* IIfnames */
IIfdE2:;
...
register buffer	*buf;
  {
	...
	ADF_CB	*FEadfcb();
	cb = FEadfcb();
/* # line 423 "abrtrw.qsc" */	/* formdata */
    {
      if (IIdispfrm(form,(char *)"Names") == 0) goto IIfdE3;
      while (IIfnames() != 0) {
        {
          i4 type;
          short nulli;
...
/* # line 430 "abrtrw.qsc" */	/* inquire_frs */
          {
            if (IIiqset(2,0,(char *)"",(char *)0, (char *)0) != 0) {
              IIiqfsio((short *)0,1,32,FE_MAXNAME+1-1,cfield,19,(char *)0,0);
              IIiqfsio((short *)0,1,30,4,&type,25,(char *)0,0);
            } /* IIiqset */
          }
/* # line 431 "abrtrw.qsc" */	/* host code */
		cvar[0] = EOS;
		switch (type)
		{
		  case 0: /* table field */
          ...
          {
            i4 ivar;
/* # line 442 "abrtrw.qsc" */	/* getform */
            {
              if (IIfsetio(form) != 0) {
                IIgetfldio(&nulli,1,30,4,&ivar,cfield);
              } /* IIfsetio */
            }
/* # line 443 "abrtrw.qsc" */	/* host code */
		  ...
		  case 2: /* float */
          {
            f8 dvar;
			i2	res_width;
/* # line 453 "abrtrw.qsc" */	/* getform */
            {
              if (IIfsetio(form) != 0) {
                IIgetfldio(&nulli,1,31,8,&dvar,cfield);
              } /* IIfsetio */
            }
/* # line 454 "abrtrw.qsc" */	/* host code */
			if ( nulli != DB_EMB_NULL )
...
/* # line 471 "abrtrw.qsc" */	/* getform */
            {
              if (IIfsetio(form) != 0) {
                IIgetfldio(&nulli,1,32,0,str,cfield);
              } /* IIfsetio */
            }
/* # line 472 "abrtrw.qsc" */	/* host code */
			if ( nulli != DB_EMB_NULL )
			{
                                STtrmwhite(str); 
				/*
...
/* # line 708 "abrtrw.qsc" */	/* inquire_frs */
      {
        if (IIiqset(2,0,form,(char *)0, (char *)0) != 0) {
          IIiqfsio((short *)0,1,30,4,&dttype,42,*fp,0);
        } /* IIiqset */
      }
/* # line 709 "abrtrw.qsc" */	/* host code */
		...
		if (dir == OUT)
		{
			...
			{ /* by reference ... */
/* # line 726 "abrtrw.qsc" */	/* getform */
      {
        if (IIfsetio(form) != 0) {
          IIgetfldio((short *)0,1,44,0,actual,*fp);
        } /* IIfsetio */
      }
/* # line 727 "abrtrw.qsc" */	/* host code */
			}
		}
		else /* dir == IN */
		{
			...
			{ /* display parameter in field */
				...
				{
/* # line 766 "abrtrw.qsc" */	/* putform */
      {
        if (IIfsetio(form) != 0) {
          IIputfldio(*fp,(short *)0,1,44,0,actual);
        } /* IIfsetio */
      }
/* # line 767 "abrtrw.qsc" */	/* host code */
				}
			}
			else
