...
/* # line 114 "abrtutil.qsc" */	/* getform */
    {
      if (IIfsetio(form) != 0) {
        IIgetoper(1);
        IIgetfldio((short *)0,1,30,4,&op,flname);
      } /* IIfsetio */
    }
/* # line 115 "abrtutil.qsc" */	/* host code */
			if ( op != 0 )
			{
				if ( !any )
					any = TRUE;
    ...
    {
      i4 ivar;
/* # line 130 "abrtutil.qsc" */	/* getform */
      {
        if (IIfsetio(form) != 0) {
          IIgetfldio((short *)0,1,30,4,&ivar,flname);
        } /* IIfsetio */
      }
/* # line 131 "abrtutil.qsc" */	/* host code */
					CVna(ivar, buf);
					break;
    }
				  case 'f':
    {
      f8 fvar;
					i2	res_width;
/* # line 140 "abrtutil.qsc" */	/* getform */
      {
        if (IIfsetio(form) != 0) {
          IIgetfldio((short *)0,1,31,8,&fvar,flname);
        } /* IIfsetio */
      }
/* # line 141 "abrtutil.qsc" */	/* host code */
					CVfa(fvar, 25, 18, 'e',
				  ...
				  case 'c':
    {
      ...
      char tbuf[2048];
					cp = buf;
					*cp++ = '\"';
/* # line 156 "abrtutil.qsc" */	/* getform */
      {
        if (IIfsetio(form) != 0) {
          IIgetfldio((short *)0,1,32,2047,tbuf,flname);
        } /* IIfsetio */
      }
/* # line 157 "abrtutil.qsc" */	/* host code */
...
i4	type;
  {
	...
	if (row == NULL)
	{
/* # line 448 "abrtutil.qsc" */	/* getrow */
    {
      if (IItbsetio(2,form,table,-2) != 0) {
        IItrc_param(buf, argv,(int *)0);
        IITBceColEnd();
      } /* IItbsetio */
    }
/* # line 449 "abrtutil.qsc" */	/* host code */
	}
	else
	{
/* # line 452 "abrtutil.qsc" */	/* getrow */
    {
      if (IItbsetio(2,form,table,*row) != 0) {
        IItrc_param(buf, argv,(int *)0);
        IITBceColEnd();
      } /* IItbsetio */
    }
/* # line 453 "abrtutil.qsc" */	/* host code */
	}
	if ( FEinqferr() != OK )
	{
		if (row != NULL)
...
*/
char *
iiarTypeName( dbv, typename )
DB_DATA_VALUE	*dbv;
AB_TYPENAME	typename;
{
