...
/* # line 616 "abrtnqry.qsc" */	/* inquire_frs */
  {
    if (IIiqset(1,0,(char *)0, (char *)0, (char *)0) != 0) {
      IIiqfsio((short *)0,1,32,FE_MAXNAME+1-1,curform,19,(char *)0,0);
    } /* IIiqset */
  }
/* # line 617 "abrtnqry.qsc" */	/* host code */
		if ( STequal(form, curform) )
		{
  char *tblfld = loopqry->qr_table;
  char tfmode[20];
/* # line 622 "abrtnqry.qsc" */	/* clear */
  {
    IIfldclear(tblfld);
  }
/* # line 623 "abrtnqry.qsc" */	/* inquire_frs */
  {
    if (IIiqset(2,0,curform,(char *)0, (char *)0) != 0) {
      IIiqfsio((short *)0,1,32,19,tfmode,21,tblfld,0);
    } /* IIiqset */
  }
/* # line 624 "abrtnqry.qsc" */	/* host code */
                    /*
...
/* # line 632 "abrtnqry.qsc" */	/* set_frs */
  {
    if (IIiqset(2,0,curform,(char *)0, (char *)0) != 0) {
      IIstfsio(21,tblfld,0,(short *)0,1,32,0,ERx("update"));
    } /* IIiqset */
  }
/* # line 633 "abrtnqry.qsc" */	/* inquire_frs */
  {
    if (IIiqset(2,0,curform,(char *)0, (char *)0) != 0) {
      IIiqfsio((short *)0,1,32,19,tfmode,21,tblfld,0);
    } /* IIiqset */
  }
/* # line 634 "abrtnqry.qsc" */	/* host code */
                    }
		}
	    }
	}
  ...
  char fmode[2];
/* # line 672 "abrtnqry.qsc" */	/* inquire_frs */
  {
    if (IIiqset(1,0,(char *)0, (char *)0, (char *)0) != 0) {
      IIiqfsio((short *)0,1,32,1,fmode,21,(char *)0,0);
    } /* IIiqset */
  }
/* # line 673 "abrtnqry.qsc" */	/* host code */
	if ( fmode[0] == 'Q' )
/* # line 674 "abrtnqry.qsc" */	/* set_frs */
  {
    if (IIiqset(1,0,(char *)0, (char *)0, (char *)0) != 0) {
      IIstfsio(21,(char *)0,0,(short *)0,1,32,0,(char *)"u");
    } /* IIiqset */
  }
/* # line 675 "abrtnqry.qsc" */	/* host code */
    }
    /*
