...
static READONLY char andST[] = 		ERx(" and ");
static READONLY char llST[] =  		ERx("((");
static READONLY char and_llST[] =  	ERx(" and ((");
static READONLY char r_or_lST[] =  	ERx(") or (");
static READONLY char rrST[] = 		ERx("))");
VOID
...
/* # line 298 "abrtpred.qsc" */	/* inquire_frs */
  {
    if (IIiqset(3,0,form,(char *)0, (char *)0) != 0) {
      IIiqfsio((short *)0,1,32,15,mode,21,tfname,0);
    } /* IIiqset */
  }
/* # line 299 "abrtpred.qsc" */	/* host code */
	...
	/* OK, now unload it */
	tf_empty = TRUE;
/* # line 307 "abrtpred.qsc" */	/* unloadtable */
  {
    if (IItbact(form,tfname,0) == 0) goto IItbE1;
    while (IItunload() != 0) {
      IItcogetio((short *)0,1,30,4,&state_var,(char *)"_state");
      IITBceColEnd();
      {
/* # line 309 "abrtpred.qsc" */	/* host code */
		row_empty = TRUE;
		switch (state_var)
		{
		    case 1:	/* New */
			...
			for (i = first; i <= last; i++)
			{
				...
				else if (rval != QG_NOSPEC)
				{
					...
					error_found = TRUE;
/* # line 347 "abrtpred.qsc" */	/* endloop */
        {
          if (1) goto IItbE1;
        }
/* # line 348 "abrtpred.qsc" */	/* host code */
				}
			}
			break;
		    default:
...
/* # line 357 "abrtpred.qsc" */	/* host code */
...
bool
  ...
  {
    char mode[16];
/* # line 385 "abrtpred.qsc" */	/* inquire_frs */
    {
      if (IIiqset(1,0,(char *)0, (char *)0, (char *)0) != 0) {
        IIiqfsio((short *)0,1,32,15,mode,21,form,0);
      } /* IIiqset */
    }
/* # line 387 "abrtpred.qsc" */	/* host code */
	if ( CMcmpnocase(mode, ERx("q")) == 0 )
	{
		return TRUE;
	}
