...
# ifdef INTERPIMG_OK
				...
				*/
/* # line 176 "abrtadd.qsc" */	/* addform */
    {
      IIaddform(frm_temp);
    }
/* # line 177 "abrtadd.qsc" */	/* host code */
# else
				/*
...
# endif
				...
				frm_temp = *comfrm;
/* # line 198 "abrtadd.qsc" */	/* addform */
    {
      IIaddform(frm_temp);
    }
/* # line 199 "abrtadd.qsc" */	/* host code */
				break;
			    }
			    case ABFOSDB:
			    {
...
/* # line 222 "abrtadd.sc" */	/* inquire_ingres */
  {
    IILQisInqSqlio((short *)0,1,30,4,&saved_id,11);
  }
/* # line 223 "abrtadd.sc" */	/* host code */
				if (saved_id != UI_SESSION
				    && saved_id != ABRT_SESSION)
				{
/* # line 226 "abrtadd.sc" */	/* set_ingres */
  {
    IILQssSetSqlio(11,(short *)0,1,30,4,&sys_sess);
  }
/* # line 227 "abrtadd.sc" */	/* inquire_ingres */
  {
    IILQisInqSqlio((short *)0,1,30,4,&sess_id,11);
  }
/* # line 228 "abrtadd.sc" */	/* host code */
				    if ( sess_id != sys_sess )
				    {
				        iiarUsrErr(E_AR006A_NOINIFRM_NODB, 2,
						frm->abrfrname, formname);
...
/* # line 236 "abrtadd.qsc" */	/* forminit */
    {
      IIforminit(formname);
    }
/* # line 237 "abrtadd.qsc" */	/* host code */
				rval = FEinqerr();
				if ( rval != OK )
				{
