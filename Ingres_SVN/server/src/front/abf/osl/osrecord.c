  ...
  i2 rec_order;
	...
	*/
	...
	if (rec == NULL && !Loaded)
	{
		...
		Loaded = TRUE;
		recid = OC_UNDEFINED;
/* # line 789 "osrecord.sc" */	/* repeated select */
  {
    IIsexec();
    while (IInexec() == 0) {
      IIsqInit((char *)0);
      IIexExec(1,(char *)"osrecord1",6978,9595);
      IIputdomio((short *)0,1,30,4,&applid);
      IIputdomio((short *)0,1,30,sizeof(OC_RECORD),(void *)IILQint(OC_RECORD));
      IIretinit((char *)0,0);
      if (IInexec() == 0) {
        IIsqInit((char *)0);
        IIexDefine(1,(char *)"osrecord1",6978,9595);
        IIwritio(0,(short *)0,1,32,0,(char *)
"select o.object_name, o.object_owner, o.object_id from ii_objects o, \
ii_abfobjects a where a.applid=");
        IIwritio(0,(short *)0,1,32,0,(char *)" $0=");
        IIputdomio((short *)0,1,30,4,&applid);
        IIwritio(0,(short *)0,1,32,0,(char *)
"and o.object_id=a.object_id and o.object_class=");
        IIwritio(0,(short *)0,1,32,0,(char *)" $1=");
        IIputdomio((short *)0,1,30,sizeof(OC_RECORD),(void *)IILQint(OC_RECORD
        ));
        IIexDefine(0,(char *)"osrecord1",6978,9595);
        if (IIerrtest() == 0) {
          IIsexec();
        } /* IIerrtest */
      } /* IInexec */
...
IIrtB1:
    while (IInextget() != 0) {
      IIgetdomio((short *)0,1,32,FE_MAXNAME + 1-1,recname);
      IIgetdomio((short *)0,1,32,FE_MAXNAME + 1-1,recowner);
      IIgetdomio((short *)0,1,30,4,&ooid);
      if (IIerrtest() != 0) goto IIrtB1;
/* # line 797 "osrecord.sc" */	/* host code */
		{
			REC *r;
...
IIrtE1:;
	...
	if (rec != NULL && rec->r_fields == NULL && rec->r_ooid != OC_UNDEFINED)
	{
		...
		recid = rec->r_ooid;
/* # line 821 "osrecord.sc" */	/* repeated select */
  {
    IIsexec();
    while (IInexec() == 0) {
      IIsqInit((char *)0);
      IIexExec(1,(char *)"osrecord2",6979,15868);
      IIputdomio((short *)0,1,30,4,&recid);
      IIretinit((char *)0,0);
      if (IInexec() == 0) {
        IIsqInit((char *)0);
        IIexDefine(1,(char *)"osrecord2",6979,15868);
        IIwritio(0,(short *)0,1,32,0,(char *)
"select o.object_name, r.class_order, r.type_name, r.adf_length, r.adf\
_type, r.adf_scale from ii_objects o, ii_abfclasses r where r.class_id\
=");
        IIwritio(0,(short *)0,1,32,0,(char *)" $0=");
        IIputdomio((short *)0,1,30,4,&recid);
        IIwritio(0,(short *)0,1,32,0,(char *)
"and o.object_id=r.catt_id order by r.class_order DESC");
        IIexDefine(0,(char *)"osrecord2",6979,15868);
        if (IIerrtest() == 0) {
          IIsexec();
        } /* IIerrtest */
      } /* IInexec */
...
IIrtB2:
    while (IInextget() != 0) {
      IIgetdomio((short *)0,1,32,FE_MAXNAME + 1-1,attname);
      IIgetdomio((short *)0,1,30,2,&rec_order);
      IIgetdomio((short *)0,1,32,FE_MAXNAME + 1-1,db_desc);
      IIgetdomio((short *)0,1,30,4,&db_length);
      IIgetdomio((short *)0,1,30,2,&db_type);
      IIgetdomio((short *)0,1,30,2,&db_prec);
      if (IIerrtest() != 0) goto IIrtB2;
/* # line 830 "osrecord.sc" */	/* host code */
		{
