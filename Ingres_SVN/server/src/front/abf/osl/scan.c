...
lex ()
{
	...
	{ /* Start token collection */
		...
		*/
		case ':':
		{
		    static READONLY DBLCH   colon[] = {{'=', OSCOLEQ}, EOS};
		...
		case '!':
		{
		    static READONLY DBLCH   exclaim[] = {{'=', OSNOTEQ}, EOS};
		...
		case '>':
		{
		    static READONLY DBLCH   greater[] = {{'=', OSGTE}, EOS};
		...
		case '*':
		{
		    static READONLY DBLCH   star[] = {{'*', OSEXP}, EOS};
		...
		case '(':
		{
		    static READONLY DBLCH   lparen[] = {{'|', OSLSQBRK}, EOS};
...
# endif
		...
		case '|':
		{
		    static READONLY DBLCH   bar[] = {{')', OSRSQBRK}, EOS};
