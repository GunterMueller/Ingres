...
*/
GLOBALDEF READONLY char _IICGif[]       = ERx("if");
GLOBALDEF READONLY char _IICGelseif[]   = ERx("else if");
GLOBALDEF READONLY char _IICGfor[]      = ERx("for");
GLOBALDEF READONLY char _IICGwhile[]    = ERx("while");
