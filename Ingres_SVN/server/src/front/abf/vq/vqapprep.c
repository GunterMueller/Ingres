...
APPL *_appl;	/* ptr to the application structure for the current app */
  static char _form[]= ERx("vqapprep");
  static char _tf[]= ERx("tf");
  static char _col[]= ERx("col");
...
IIfdI1:;
    ...
    {
/* # line 139 "vqapprep.qsc" */	/* host code */
		IIUGfmt(title, sizeof(title) - 1, ERget(F_VQ013C_AppRepTitle), 
			1, IIabExename);
/* # line 141 "vqapprep.qsc" */	/* putform */
      {
        if (IIfsetio((char *)0) != 0) {
          IIputfldio(ERx("title_fld"),(short *)0,1,32,0,title);
        } /* IIfsetio */
      }
/* # line 143 "vqapprep.qsc" */	/* inittable */
      {
        if (IItbinit(_form,_tf,(char *)"r") != 0) {
          IItfill();
        } /* IItbinit */
      }
/* # line 144 "vqapprep.qsc" */	/* host code */
		vq_LoadAppRep();
    }
IIfdB1:
    while (IIrunform() != 0) {
      if (IIretval() == 1) {
        {
/* # line 150 "vqapprep.qsc" */	/* host code */
		FEtabfnd(_form, _tf);
        }
      } else if (IIretval() == 2) {
        {
/* # line 155 "vqapprep.qsc" */	/* host code */
		bool	dummy;
		if (IIUFtfuTblFldUnload(_form, _tf, _col, 
					&msg, &dummy) != OK)
		{
/* # line 160 "vqapprep.qsc" */	/* message */
          {
            IImessage(msg);
          }
/* # line 161 "vqapprep.qsc" */	/* sleep */
          {
            IIsleep(2);
          }
/* # line 162 "vqapprep.qsc" */	/* host code */
		}
        }
      } else if (IIretval() == 3) {
        {
/* # line 167 "vqapprep.qsc" */	/* scroll */
          {
...
/* # line 172 "vqapprep.qsc" */	/* scroll */
        ...
        {
/* # line 178 "vqapprep.qsc" */	/* host code */
		if (IIabVision )
        ...
        {
/* # line 186 "vqapprep.qsc" */	/* breakdisplay */
          {
            if (1) goto IIfdE1;
          }
        }
...
IImuI1:
    ...
    if (IInmuact(ERget(FE_WriteFile),ERget(F_FE010E_WriteExpl),2,2,2) == 0) 
    goto IIfdE1;
    IIFRInternal(0);
    if (IInfrskact(5,ERget(F_FE0105_ExplTop),2,2,3) == 0) goto IIfdE1;
    IIFRInternal(0);
    if (IInfrskact(6,ERget(F_FE0106_ExplBottom),2,2,4) == 0) goto IIfdE1;
    if (IInmuact(ERget(FE_Help),ERget(F_VQ007C_AppRepHelpExpl),2,2,5) == 0) 
    goto IIfdE1;
    IIFRInternal(0);
    if (IInfrskact(1,(char *)0,2,2,5) == 0) goto IIfdE1;
    if (IInmuact(ERget(FE_End),ERget(F_VQ007D_AppRepEndExpl),2,2,6) == 0) 
    goto IIfdE1;
    IIFRInternal(0);
...
/* # line 189 "vqapprep.qsc" */	/* host code */
}
/*{
...
vq_Load(line)
  char *line;
{
/* # line 695 "vqapprep.qsc" */	/* loadtable */
  {
    if (IItbact(_form,_tf,1) != 0) {
      IItcoputio(_col,(short *)0,1,32,0,line);
      IITBceColEnd();
    } /* IItbact */
  }
/* # line 696 "vqapprep.qsc" */	/* host code */
}
