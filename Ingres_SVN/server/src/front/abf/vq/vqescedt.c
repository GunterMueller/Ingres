...
static READONLY 
  char formname[]=	ERx("vqesctyp"), indcol[]= 	ERx("col1"), namecol[]= 	ERx("col2")
  , numcol[]= 	ERx("col3"), help_file[]=	ERx("vqescfld.hlp"), _space[]= 	ERx(" ")
  , _star[]=		ERx("*");
...
/* # line 490 "vqescedt.qsc" */	/* getrow */
  {
    if (IItbsetio(2,formname,formname,-2) != 0) {
      IItcogetio((short *)0,1,30,4,&esctype,numcol);
      IITBceColEnd();
    } /* IItbsetio */
  }
/* # line 491 "vqescedt.qsc" */	/* host code */
...
/* # line 562 "vqescedt.qsc" */	/* getrow */
  {
    if (IItbsetio(2,iivqLP0form,iivqLP1tblfld,-2) != 0) {
      IItcogetio((short *)0,1,32,FLDACTNMSZ-1,actname,iivqLP2actCol);
      IItcogetio((short *)0,1,30,4,&fld2flags,iivqLP4flags2Col);
      IItcogetio((short *)0,1,30,4,&acttype,iivqLP5fldTypeCol);
      IITBceColEnd();
    } /* IItbsetio */
  }
/* # line 566 "vqescedt.qsc" */	/* host code */
...
METAFRAME	*metaframe;
{
  ...
  PTR lp4;
	...
	*/
	...
	/* Add form */
	lp4 = (PTR)frame;
/* # line 708 "vqescedt.qsc" */	/* addform */
  {
    IIaddform(lp4);
  }
/* # line 710 "vqescedt.qsc" */	/* host code */
	/* Load tablefield */ 
/* # line 711 "vqescedt.qsc" */	/* inittable */
  {
    if (IItbinit(formname,formname,(char *)"f") != 0) {
      IIthidecol(numcol,(char *)"i4");
      IItfill();
    } /* IItbinit */
  }
/* # line 712 "vqescedt.qsc" */	/* host code */
...
/* # line 722 "vqescedt.qsc" */	/* loadtable */
  {
    if (IItbact(formname,formname,1) != 0) {
      IItcoputio(indcol,(short *)0,1,32,0,_space);
      IItcoputio(namecol,(short *)0,1,32,0,escname);
      IItcoputio(numcol,(short *)0,1,30,4,&i);
      IITBceColEnd();
    } /* IItbact */
  }
/* # line 724 "vqescedt.qsc" */	/* host code */
		}
        }
	return (OK);
}
...
METAFRAME	*metaframe;
  {
	...
	*/
/* # line 849 "vqescedt.qsc" */	/* unloadtable */
    {
      if (IItbact(formname,formname,0) == 0) goto IItbE1;
      while (IItunload() != 0) {
        IItcogetio((short *)0,1,30,4,&esctype,numcol);
        IITBceColEnd();
        {
/* # line 851 "vqescedt.qsc" */	/* host code */
		...
		if (matched)
		{
/* # line 869 "vqescedt.qsc" */	/* putrow */
          {
            if (IItbsetio(3,formname,formname,-2) != 0) {
              IItcoputio(indcol,(short *)0,1,32,0,_star);
              IITBceColEnd();
            } /* IItbsetio */
          }
/* # line 870 "vqescedt.qsc" */	/* host code */
		}
		else
		{
/* # line 873 "vqescedt.qsc" */	/* putrow */
          {
            if (IItbsetio(3,formname,formname,-2) != 0) {
              IItcoputio(indcol,(short *)0,1,32,0,_space);
              IITBceColEnd();
...
/* # line 874 "vqescedt.qsc" */	/* host code */
		}
        }
      } /* IItunload */
IItbE1:
...
/* # line 878 "vqescedt.qsc" */	/* host code */
/*{
