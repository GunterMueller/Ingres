...
static
  char locks_form[]= ERx("vqlocks"), locks_tblfld[]= ERx("columns"), _locktype
  []= ERx("locktype"), _master_col[]= ERx("master_col"), _detail_col[]= ERx("detail_col")
  ;
...
METAFRAME	*mf;
  {
    ...
    char old_locks[FE_MAXNAME + 1];
    char new_locks[FE_MAXNAME + 1];
	char	options[100];
	char	buf[64];
	MFTAB	*master;
	MFTAB	*detail;
...
/* # line 576 "vqfrbeha.qsc" */	/* inittable */
    {
      if (IItbinit(locks_form,locks_tblfld,(char *)"u") != 0) {
        IItfill();
      } /* IItbinit */
    }
/* # line 577 "vqfrbeha.qsc" */	/* display */
    {
      if (IIdispfrm(locks_form,(char *)"f") == 0) goto IIfdE1;
      goto IImuI1;
IIfdI1:;
      if (IIfsetio((char *)0) == 0) goto IIfdE1;
      IIputfldio(_locktype,(short *)0,1,32,0,old_locks);
      {
/* # line 580 "vqfrbeha.qsc" */	/* host code */
		if (!(old_mask & MF_OPTIM))
		{
			...
			*/
/* # line 586 "vqfrbeha.qsc" */	/* set_frs */
        {
          if (IIiqset(2,0,locks_form,(char *)0, (char *)0) != 0) {
            IIstfsio(21,locks_tblfld,0,(short *)0,1,32,0,(char *)"r");
          } /* IIiqset */
        }
/* # line 587 "vqfrbeha.qsc" */	/* host code */
			if (detail_exists)
			{
				for (i = 0; i < 3; i++)
				{
/* # line 591 "vqfrbeha.qsc" */	/* loadtable */
        {
          if (IItbact(locks_form,locks_tblfld,1) != 0) {
            IItcoputio((char *)"master_col",(short *)0,1,32,0,
            ERget(F_VQ010D_n_a));
            IItcoputio((char *)"detail_col",(short *)0,1,32,0,
            ERget(F_VQ010D_n_a));
            IITBceColEnd();
          } /* IItbact */
        }
/* # line 595 "vqfrbeha.qsc" */	/* host code */
				}
			}
			else
			{
/* # line 599 "vqfrbeha.qsc" */	/* set_frs */
        {
          if (IIiqset(4,0,locks_form,locks_tblfld,(char *)0) != 0) {
            IIstfsio(54,(char *)"detail_col",0,(short *)0,1,30,sizeof(1),
            (void *)IILQint(1));
          } /* IIiqset */
        }
/* # line 602 "vqfrbeha.qsc" */	/* host code */
				for (i = 0; i < 3; i++)
				{
/* # line 604 "vqfrbeha.qsc" */	/* loadtable */
        {
          if (IItbact(locks_form,locks_tblfld,1) != 0) {
            IItcoputio((char *)"master_col",(short *)0,1,32,0,
            ERget(F_VQ010D_n_a));
...
/* # line 607 "vqfrbeha.qsc" */	/* host code */
				}
			}
/* # line 609 "vqfrbeha.qsc" */	/* resume */
        {
          if (1) goto IIfdB1;
        }
/* # line 610 "vqfrbeha.qsc" */	/* host code */
		}
...
/* # line 620 "vqfrbeha.qsc" */	/* loadtable */
        {
          if (IItbact(locks_form,locks_tblfld,1) != 0) {
            IItcoputio((char *)"master_col",&master_null,1,32,0,master_cols[i]);
            IItcoputio((char *)"detail_col",&detail_null,1,32,0,detail_cols[i]);
            IITBceColEnd();
          } /* IItbact */
        }
/* # line 624 "vqfrbeha.qsc" */	/* host code */
			}
		}
		else
		{
/* # line 628 "vqfrbeha.qsc" */	/* set_frs */
        {
          if (IIiqset(4,0,locks_form,locks_tblfld,(char *)0) != 0) {
            IIstfsio(54,(char *)"detail_col",0,(short *)0,1,30,sizeof(1),
            (void *)IILQint(1));
...
/* # line 631 "vqfrbeha.qsc" */	/* host code */
			for (i = 0; i < 3; i++)
			{
				master_null = (master_cols[i] == NULL ||
					master_cols[i][0] == EOS ? -1 : 0);
/* # line 635 "vqfrbeha.qsc" */	/* loadtable */
        {
          if (IItbact(locks_form,locks_tblfld,1) != 0) {
            IItcoputio((char *)"master_col",&master_null,1,32,0,master_cols[i]);
            IITBceColEnd();
...
/* # line 638 "vqfrbeha.qsc" */	/* host code */
			}
		}
      }
IIfdB1:
      while (IIrunform() != 0) {
        if (IIretval() == 1) {
          {
            i4 changed;
/* # line 645 "vqfrbeha.qsc" */	/* inquire_frs */
            {
              if (IIiqset(2,0,locks_form,(char *)0, (char *)0) != 0) {
                IIiqfsio((short *)0,1,30,4,&changed,20,_locktype,0);
              } /* IIiqset */
            }
/* # line 646 "vqfrbeha.qsc" */	/* host code */
		if (changed == 0)
		{
			new_mask = old_mask;
			STcopy(old_locks, new_locks);
/* # line 650 "vqfrbeha.qsc" */	/* resume */
            {
              IIresnext();
              if (1) goto IIfdB1;
            }
/* # line 651 "vqfrbeha.qsc" */	/* host code */
		}
		lock_change = changed;
/* # line 654 "vqfrbeha.qsc" */	/* set_frs */
            {
              if (IIiqset(2,0,locks_form,(char *)0, (char *)0) != 0) {
                IIstfsio(20,_locktype,0,(short *)0,1,30,sizeof(0),
                (void *)IILQint(0));
              } /* IIiqset */
            }
/* # line 655 "vqfrbeha.qsc" */	/* getform */
            {
              if (IIfsetio(locks_form) != 0) {
                IIgetfldio((short *)0,1,32,FE_MAXNAME + 1-1,new_locks,
                _locktype);
              } /* IIfsetio */
            }
/* # line 657 "vqfrbeha.qsc" */	/* host code */
		/*
		...
		*/
		...
		{
/* # line 664 "vqfrbeha.qsc" */	/* resume */
            {
              if (1) goto IIfdB1;
            }
/* # line 665 "vqfrbeha.qsc" */	/* host code */
		}
		/*
		...
		*/
		...
		else if (new_mask & MF_OPTIM)
		{
			...
			*/
/* # line 683 "vqfrbeha.qsc" */	/* clear */
            {
              IIfldclear(locks_tblfld);
            }
/* # line 684 "vqfrbeha.qsc" */	/* inittable */
            {
              if (IItbinit(locks_form,locks_tblfld,(char *)"u") != 0) {
                IItfill();
              } /* IItbinit */
            }
/* # line 685 "vqfrbeha.qsc" */	/* host code */
			if (detail_exists)
			{
				for (i = 0; i < 3; i++)
				{
					...
					detail_null = (detail_cols[i] == NULL ||
						detail_cols[i][0] ==
						EOS ? -1 : 0);
/* # line 695 "vqfrbeha.qsc" */	/* loadtable */
            {
              if (IItbact(locks_form,locks_tblfld,1) != 0) {
                IItcoputio((char *)"master_col",&master_null,1,32,0,
                master_cols[i]);
                IItcoputio((char *)"detail_col",&detail_null,1,32,0,
                detail_cols[i]);
                IITBceColEnd();
              } /* IItbact */
            }
/* # line 699 "vqfrbeha.qsc" */	/* host code */
				}
			}
			else
			{
				for (i = 0; i < 3; i++)
				{
					master_null = (master_cols[i] == NULL ||
						master_cols[i][0] ==
						EOS ? -1 : 0);
/* # line 708 "vqfrbeha.qsc" */	/* loadtable */
            {
              if (IItbact(locks_form,locks_tblfld,1) != 0) {
                IItcoputio((char *)"master_col",&master_null,1,32,0,
                master_cols[i]);
...
/* # line 711 "vqfrbeha.qsc" */	/* host code */
				}
			}
		}
		else if (old_mask & MF_OPTIM)
		{
			...
			*/
/* # line 721 "vqfrbeha.qsc" */	/* clear */
            {
              IIfldclear(locks_tblfld);
            }
/* # line 722 "vqfrbeha.qsc" */	/* inittable */
            {
              if (IItbinit(locks_form,locks_tblfld,(char *)"r") != 0) {
                IItfill();
              } /* IItbinit */
            }
/* # line 723 "vqfrbeha.qsc" */	/* host code */
			if (detail_exists)
			{
				for (i = 0; i < 3; i++)
				{
/* # line 727 "vqfrbeha.qsc" */	/* loadtable */
            {
              if (IItbact(locks_form,locks_tblfld,1) != 0) {
                IItcoputio((char *)"master_col",(short *)0,1,32,0,
                ERget(F_VQ010D_n_a));
...
/* # line 731 "vqfrbeha.qsc" */	/* host code */
				}
			}
			else
			{
				for (i = 0; i < 3; i++)
				{
/* # line 737 "vqfrbeha.qsc" */	/* loadtable */
            {
              if (IItbact(locks_form,locks_tblfld,1) != 0) {
                IItcoputio((char *)"master_col",(short *)0,1,32,0,
                ERget(F_VQ010D_n_a));
...
/* # line 740 "vqfrbeha.qsc" */	/* host code */
				}
			}
		}
...
/* # line 750 "vqfrbeha.qsc" */	/* resume */
        ...
        } else if (IIretval() == 2) {
          {
            i4 state;
            i4 row = 0;
/* # line 757 "vqfrbeha.qsc" */	/* host code */
		i4	m = 0;
		i4	d = 0;
		char	*mcols[3];
		char	*dcols[3];
		...
		i = 0;
/* # line 765 "vqfrbeha.qsc" */	/* validate */
            {
              if (IIvalfld(_locktype) == 0) {
                goto IIfdB1;
              } /* IIvalfld */
            }
/* # line 767 "vqfrbeha.qsc" */	/* host code */
		/*
		...
		*/
		...
		if (new_mask & MF_OPTIM)
		{
			...
			** by the user
			*/
/* # line 782 "vqfrbeha.qsc" */	/* unloadtable */
            {
              if (IItbact(locks_form,locks_tblfld,0) == 0) goto IItbE1;
              while (IItunload() != 0) {
                IItcogetio(&master_null,1,32,FE_MAXNAME+1-1,master_cols[i],
                _master_col);
                IItcogetio(&detail_null,1,32,FE_MAXNAME+1-1,detail_cols[i],
                _detail_col);
                IItcogetio((short *)0,1,30,4,&state,(char *)"_STATE");
                IItcogetio((short *)0,1,30,4,&row,(char *)"_RECORD");
                IITBceColEnd();
                {
/* # line 789 "vqfrbeha.qsc" */	/* host code */
				...
				if (state == stNEW || state == stCHANGE)
				{
					...
					*/
					if (master_null != -1 &&
						...
						master_cols[i], i) != OK)
					{
/* # line 812 "vqfrbeha.qsc" */	/* scroll */
                  {
                    if (IItbsetio(1,locks_form,locks_tblfld,-3) != 0) {
                      IItbsmode((char *)"to");
                      if (IItscroll(0,row) != 0) {
                      } /* IItscroll */
                    } /* IItbsetio */
                  }
/* # line 814 "vqfrbeha.qsc" */	/* resume */
                  {
                    IIrescol(locks_tblfld,_master_col);
                    IItunend();
                    if (1) goto IIfdB1;
                  }
/* # line 816 "vqfrbeha.qsc" */	/* host code */
					}
					if (detail_exists && detail_null != -1
						&& check_lockcol(detail,
						detail_cols[i], i) != OK)
					{
/* # line 821 "vqfrbeha.qsc" */	/* scroll */
                  {
                    if (IItbsetio(1,locks_form,locks_tblfld,-3) != 0) {
                      IItbsmode((char *)"to");
                      if (IItscroll(0,row) != 0) {
...
/* # line 823 "vqfrbeha.qsc" */	/* resume */
                  {
                    IIrescol(locks_tblfld,_detail_col);
                    IItunend();
                    if (1) goto IIfdB1;
                  }
/* # line 825 "vqfrbeha.qsc" */	/* host code */
					}
				}
				if (master_null == -1)
					master_cols[i][0] = EOS;
...
/* # line 841 "vqfrbeha.qsc" */	/* host code */
			/*
			...
			*/
			if (empty_tf == TRUE)
			{
				IIUGerr(E_VQ00E8_No_Locking_Cols,
					UG_ERR_ERROR, 0);
/* # line 849 "vqfrbeha.qsc" */	/* resume */
            {
              if (1) goto IIfdB1;
            }
/* # line 850 "vqfrbeha.qsc" */	/* host code */
			}
			/* 
		...
		*/
		...
		new_mask = -1;
/* # line 890 "vqfrbeha.qsc" */	/* breakdisplay */
            {
              if (1) goto IIfdE1;
            }
          }
          ...
          {
/* # line 897 "vqfrbeha.qsc" */	/* breakdisplay */
            {
              if (1) goto IIfdE1;
            }
          }
        } else if (IIretval() == 4) {
          {
            ...
            i4 rownum;
/* # line 908 "vqfrbeha.qsc" */	/* inquire_frs */
            {
              if (IIiqset(1,0,(char *)0, (char *)0, (char *)0) != 0) {
                IIiqfsio((short *)0,1,32,FE_MAXNAME + 1-1,fdname,22,locks_form
                ,0);
              } /* IIiqset */
            }
/* # line 910 "vqfrbeha.qsc" */	/* host code */
		...
		if (STequal(fdname, _locktype))
		{
			...
			*/
			if ((new_mask = IIFDlpListPick (
				...
				(i4(*)())NULL, (PTR)NULL)) >= 0)
			{
/* # line 932 "vqfrbeha.qsc" */	/* putform */
            {
              if (IIfsetio(locks_form) != 0) {
                IIputfldio(_locktype,(short *)0,1,32,0,
                ERget(lock_types[new_mask].type));
              } /* IIfsetio */
            }
/* # line 934 "vqfrbeha.qsc" */	/* set_frs */
            {
              if (IIiqset(2,0,locks_form,(char *)0, (char *)0) != 0) {
                IIstfsio(20,_locktype,0,(short *)0,1,30,sizeof(1),
                (void *)IILQint(1));
              } /* IIiqset */
            }
/* # line 935 "vqfrbeha.qsc" */	/* host code */
		...
		{
/* # line 942 "vqfrbeha.qsc" */	/* inquire_frs */
            {
              if (IIiqset(3,0,locks_form,(char *)0, (char *)0) != 0) {
                IIiqfsio((short *)0,1,30,4,&rownum,29,locks_tblfld,0);
                IIiqfsio((short *)0,1,32,FE_MAXNAME + 1-1,colname,34,
                locks_tblfld,0);
              } /* IIiqset */
            }
/* # line 946 "vqfrbeha.qsc" */	/* host code */
          ...
          {
/* # line 956 "vqfrbeha.qsc" */	/* host code */
...
IIfdF1:
      ...
      goto IIfdE1;
IImuI1:
      if (IIFRafActFld(_locktype,0,1) == 0) goto IIfdE1;
      if (IIinitmu() == 0) goto IIfdE1;
      if (IInmuact(ERget(FE_OK),(char *)0,2,2,2) == 0) goto IIfdE1;
      IIFRInternal(0);
      if (IInfrskact(4,(char *)0,2,2,2) == 0) goto IIfdE1;
      if (IInmuact(ERget(FE_Cancel),ERget(F_FE0109_ExplForget),0,0,3) == 0) 
      goto IIfdE1;
      IIFRInternal(0);
...
/* # line 960 "vqfrbeha.qsc" */	/* host code */
/*
...
i4	coltype;
{
  ...
  char colname[FE_MAXNAME + 1];
	...
	*/
	...
	if (choice >=0)
	{
/* # line 1349 "vqfrbeha.qsc" */	/* inquire_frs */
  {
    if (IIiqset(3,0,locks_form,(char *)0, (char *)0) != 0) {
      IIiqfsio((short *)0,1,32,FE_MAXNAME + 1-1,colname,34,locks_tblfld,0);
    } /* IIiqset */
  }
/* # line 1350 "vqfrbeha.qsc" */	/* putrow */
  {
    if (IItbsetio(3,locks_form,locks_tblfld,-2) != 0) {
      IItcoputio(colname,(short *)0,1,32,0,colarray[choice]);
      IITBceColEnd();
    } /* IItbsetio */
  }
/* # line 1351 "vqfrbeha.qsc" */	/* host code */
	}
}
