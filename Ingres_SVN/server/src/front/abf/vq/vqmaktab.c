...
MFTAB **tabptr;
{
  ...
  i4 key_id;
		i4 key_use;
		key_use = -1;
/* # line 285 "vqmaktab.sc" */	/* select */
  {
    IIsqInit((char *)0);
    IIwritio(0,(short *)0,1,32,0,(char *)
"select key_id, column_name from iialt_columns where table_name=");
    IIputdomio((short *)0,1,32,0,relinfo.name);
    IIwritio(0,(short *)0,1,32,0,(char *)"and table_owner=");
    IIputdomio((short *)0,1,32,0,relinfo.owner);
    IIretinit((char *)0,0);
...
/* # line 291 "vqmaktab.sc" */	/* host code */
