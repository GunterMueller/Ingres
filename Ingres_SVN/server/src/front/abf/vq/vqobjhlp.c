  ...
  OOID obj_type;
{
  ...
  char obj_name[FE_MAXNAME + 1];
	...
	namelist = lpmem;
/* # line 389 "vqobjhlp.sc" */	/* repeated select */
  {
    IIsexec();
    while (IInexec() == 0) {
      IIsqInit((char *)0);
      IIexExec(1,(char *)"vqobjhlp1",7022,22622);
      IIputdomio((short *)0,1,30,4,&obj_type);
      IIputdomio((short *)0,1,30,4,&applid);
      IIretinit((char *)0,0);
      if (IInexec() == 0) {
        IIsqInit((char *)0);
        IIexDefine(1,(char *)"vqobjhlp1",7022,22622);
        IIwritio(0,(short *)0,1,32,0,(char *)
"select distinct object_name from ii_objects, ii_abfobjects where ii_o\
bjects.object_class=");
...
plid=");
        ...
        IIexDefine(0,(char *)"vqobjhlp1",7022,22622);
        if (IIerrtest() == 0) {
          IIsexec();
        } /* IIerrtest */
      } /* IInexec */
...
/* # line 397 "vqobjhlp.sc" */	/* host code */
...
bool    *resume;
{
  ...
  char field_val[FE_MAXNAME + 1];
	*resume = FALSE;        /* Leave the listpick */
	if (choice < 0)
		return;
/* # line 507 "vqobjhlp.qsc" */	/* inquire_frs */
  {
    if (IIiqset(1,0,(char *)0, (char *)0, (char *)0) != 0) {
      IIiqfsio((short *)0,1,32,FE_MAXNAME + 1-1,formname,19,(char *)0,0);
      IIiqfsio((short *)0,1,32,FE_MAXNAME + 1-1,tfname,22,(char *)0,0);
    } /* IIiqset */
  }
/* # line 508 "vqobjhlp.qsc" */	/* inquire_frs */
  {
    if (IIiqset(3,0,formname,(char *)0, (char *)0) != 0) {
      IIiqfsio((short *)0,1,32,FE_MAXNAME + 1-1,colname,34,tfname,0);
    } /* IIiqset */
  }
/* # line 509 "vqobjhlp.qsc" */	/* getrow */
  {
    if (IItbsetio(2,formname,tfname,-2) != 0) {
      IItcogetio((short *)0,1,32,FE_MAXNAME + 1-1,field_val,colname);
      IITBceColEnd();
    } /* IItbsetio */
  }
/* # line 511 "vqobjhlp.qsc" */	/* host code */
...
/* # line 557 "vqobjhlp.qsc" */	/* getrow */
  {
    if (IItbsetio(2,iivqLP0form,iivqLP1tblfld,-2) != 0) {
      IItcogetio((short *)0,1,32,FE_MAXNAME + 1-1,actname,iivqLP2actCol);
      IItcogetio((short *)0,1,30,4,&flags2,iivqLP4flags2Col);
      IItcogetio((short *)0,1,30,4,&fldtype,iivqLP5fldTypeCol);
      IITBceColEnd();
    } /* IItbsetio */
  }
/* # line 561 "vqobjhlp.qsc" */	/* host code */
