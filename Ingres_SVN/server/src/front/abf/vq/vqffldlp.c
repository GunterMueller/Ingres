...
static READONLY char	_all[] 	= ERx("ALL");
static READONLY char	_dot[] 	= ERx(".");
/* Listpick form data */
static READONLY		
  char ind_col[]= ERx("indicator"), _space[]= ERx(" "), _star[]= ERx("*");
...
char	*lphdr;
{
  ...
  PTR lp4;
	...
	*/
	...
	/* Init form */
	lp4 = (PTR)lpf_frame;
/* # line 570 "vqffldlp.qsc" */	/* addform */
  {
    IIaddform(lp4);
  }
/* # line 572 "vqffldlp.qsc" */	/* host code */
	return (OK);
}
/*
...
{
/* # line 584 "vqffldlp.qsc" */	/* inittable */
  {
    if (IItbinit(iivqLP0form,iivqLP1tblfld,(char *)"u") != 0) {
      IIthidecol(iivqLP3flagsCol,(char *)"i4");
      IIthidecol(iivqLP4flags2Col,(char *)"i4");
      IIthidecol(iivqLP5fldTypeCol,(char *)"i4");
      IItfill();
    } /* IItbinit */
  }
/* # line 588 "vqffldlp.qsc" */	/* host code */
...
/* # line 610 "vqffldlp.qsc" */	/* unloadtable */
  {
    if (IItbact(iivqLP0form,iivqLP1tblfld,0) == 0) goto IItbE1;
    while (IItunload() != 0) {
      IItcogetio((short *)0,1,32,(2*FE_MAXNAME) + 2-1,rowactnm,iivqLP2actCol);
      IITBceColEnd();
      {
/* # line 612 "vqffldlp.qsc" */	/* host code */
		matched = FALSE;
		...
		if (matched)
		{
/* # line 624 "vqffldlp.qsc" */	/* putrow */
        {
          if (IItbsetio(3,iivqLP0form,iivqLP1tblfld,-2) != 0) {
            IItcoputio(ind_col,(short *)0,1,32,0,_star);
            IITBceColEnd();
          } /* IItbsetio */
        }
/* # line 625 "vqffldlp.qsc" */	/* host code */
		}
		else
		{
/* # line 628 "vqffldlp.qsc" */	/* putrow */
        {
          if (IItbsetio(3,iivqLP0form,iivqLP1tblfld,-2) != 0) {
            IItcoputio(ind_col,(short *)0,1,32,0,_space);
            IITBceColEnd();
          } /* IItbsetio */
        }
/* # line 629 "vqffldlp.qsc" */	/* host code */
		}
      }
    } /* IItunload */
IItbE1:
...
/* # line 631 "vqffldlp.qsc" */	/* host code */
}
/*
  ...
  i4 fldtype;
{
  ...
  i4 fieldflags2;
	...
	switch(fldtype)
	{
		...
		/* Load the tablefield */
/* # line 866 "vqffldlp.qsc" */	/* loadtable */
  {
    if (IItbact(iivqLP0form,iivqLP1tblfld,1) != 0) {
      IItcoputio(iivqLP2actCol,(short *)0,1,32,0,actnm);
      IItcoputio(iivqLP3flagsCol,(short *)0,1,30,4,&fieldflags);
      IItcoputio(iivqLP4flags2Col,(short *)0,1,30,4,&fieldflags2);
      IItcoputio(iivqLP5fldTypeCol,(short *)0,1,30,4,&fldtype);
      IITBceColEnd();
    } /* IItbact */
  }
/* # line 870 "vqffldlp.qsc" */	/* host code */
}
/*{
