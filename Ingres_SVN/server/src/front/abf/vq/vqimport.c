...
/* # line 283 "vqimport.sc" */	/* repeated select */
  {
    IIsexec();
    while (IInexec() == 0) {
      IIsqInit((char *)0);
      IIexExec(1,(char *)"vqimport1",7025,29180);
      IIputdomio((short *)0,1,30,sizeof(OC_APPL),(void *)IILQint(OC_APPL));
      IIputdomio((short *)0,1,30,4,&currappid);
      IIretinit((char *)0,0);
      if (IInexec() == 0) {
        IIsqInit((char *)0);
        IIexDefine(1,(char *)"vqimport1",7025,29180);
        IIwritio(0,(short *)0,1,32,0,(char *)
"select object_id, object_name, short_remark from ii_objects where obj\
ect_class=");
        ...
        IIexDefine(0,(char *)"vqimport1",7025,29180);
        if (IIerrtest() == 0) {
          IIsexec();
        } /* IIerrtest */
      } /* IInexec */
...
IIrtB1:
    while (IInextget() != 0) {
      ...
      IIgetdomio((short *)0,1,32,FE_MAXNAME+1-1,appbuf);
      IIgetdomio((short *)0,1,32,OOSHORTREMSIZE+1-1,rembuf);
      if (IIerrtest() != 0) goto IIrtB1;
/* # line 291 "vqimport.sc" */	/* host code */
	{
		/*
		...
		*/
		if (count >= MAX_APPS)
		{
/* # line 298 "vqimport.sc" */	/* endselect */
      {
        IIbreak();
        if (1) goto IIrtE1;
      }
/* # line 299 "vqimport.sc" */	/* host code */
		}
...
IIrtE1:;
	...
	if (IIFRmdfMakeDefaultForm(ERget(F_VQ0166_Select_Imp_App),
		sel_form, TRUE, 2, appfd, min(15, count), &appframe) != OK)
	{
		FEfree(lptag);
		IIUGerr(E_VQ006E_Bad_Sel_Form, UG_ERR_ERROR, 0);
		return(-1);
	}
/* # line 346 "vqimport.qsc" */	/* addform */
  {
    IIaddform(appframe);
  }
/* # line 347 "vqimport.qsc" */	/* inittable */
  {
    if (IItbinit(sel_form,sel_form,(char *)"r") != 0) {
      IItfill();
    } /* IItbinit */
  }
/* # line 349 "vqimport.qsc" */	/* host code */
	for (i = 0; i < count; i++)
	{
		/*
		...
		**	_col2 = short remark
		*/
/* # line 356 "vqimport.qsc" */	/* loadtable */
  {
    if (IItbact(sel_form,sel_form,1) != 0) {
      IItcoputio(_col1,(short *)0,1,32,0,appls[i]);
      IItcoputio(_col2,(short *)0,1,32,0,remarks[i]);
      IITBceColEnd();
    } /* IItbact */
  }
/* # line 360 "vqimport.qsc" */	/* host code */
	}
...
/* # line 474 "vqimport.qsc" */	/* addform */
  {
    IIaddform(frframe);
  }
/* # line 475 "vqimport.qsc" */	/* inittable */
  {
    if (IItbinit(sel_form,sel_form,(char *)"r") != 0) {
      IItfill();
    } /* IItbinit */
  }
/* # line 477 "vqimport.qsc" */	/* host code */
	for (i = 0; i < count; i++)
	{
		/*
...
/* # line 487 "vqimport.qsc" */	/* loadtable */
  {
    if (IItbact(sel_form,sel_form,1) != 0) {
      IItcoputio(_col1,(short *)0,1,32,0,frame_name);
      IItcoputio(_col2,(short *)0,1,32,0,frame_type);
      IItcoputio(_col3,(short *)0,1,32,0,frame_desc);
      IITBceColEnd();
    } /* IItbact */
  }
/* # line 492 "vqimport.qsc" */	/* host code */
	}
