...
/* # line 228 "iamdec.sc" */	/* select */
  {
    IIsqInit((char *)0);
    IIwritio(0,(short *)0,1,32,0,(char *)
"select encode_estring, encode_sequence from ii_encodings where encode\
_object=");
...
IIrtB1:
    while (IInextget() != 0) {
      IIgetdomio((short *)0,1,32,0,rdptr);
      IIgetdomio((short *)0,1,30,4,&nseq);
      if (IIerrtest() != 0) goto IIrtB1;
/* # line 234 "iamdec.sc" */	/* host code */
# ifdef PCINGRES
		...
		if (EXdeclare(IIAMmeMemError, &context) != OK)
		{
			rc = ILE_NOMEM;
			EXdelete();
/* # line 245 "iamdec.sc" */	/* endselect */
      {
        IIbreak();
        if (1) goto IIrtE1;
      }
/* # line 246 "iamdec.sc" */	/* host code */
		}
# endif
		if ((rc = state_handler()) != OK)
		{
/* # line 250 "iamdec.sc" */	/* endselect */
      {
        IIbreak();
        if (1) goto IIrtE1;
      }
/* # line 251 "iamdec.sc" */	/* host code */
		}
		if ((rdptr = tok_catbuf()) == NULL)
		{
			rc = ILE_NOMEM;
/* # line 255 "iamdec.sc" */	/* endselect */
      {
        IIbreak();
        if (1) goto IIrtE1;
      }
/* # line 256 "iamdec.sc" */	/* host code */
		}
    } /* IInextget */
    IIflush((char *)0,0);
IIrtE1:;
  }
/* # line 258 "iamdec.sc" */	/* inquire_ingres */
  {
    IILQisInqSqlio((short *)0,1,30,4,&err,2);
  }
/* # line 259 "iamdec.sc" */	/* host code */
			...
			*/
			...
			if ( tblp->numel < 0 )
			{
				...
				return (ILE_NOMEM);
                        ...
                        **                                      - kchin 2/5/93
                        */
                        Decaddr = ME_ALIGN_MACRO(Decaddr,sizeof(PTR));
			/*
