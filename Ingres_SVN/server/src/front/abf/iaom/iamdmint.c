...
APPL	*appl;
{
  ...
  char owner_name[FE_MAXNAME + 1];
	...
	*/
	...
	if ( ooid == -1 )
	{
/* # line 617 "iamdmint.sc" */	/* repeated select */
  {
    IIsexec();
    while (IInexec() == 0) {
      IIsqInit((char *)0);
      IIexExec(1,(char *)"iamdmint1",6610,509);
      IIputdomio((short *)0,1,30,4,&applid);
      IIputdomio((short *)0,1,30,4,&exclude1);
      IIputdomio((short *)0,1,30,4,&exclude2);
      IIputdomio((short *)0,1,30,4,&exclude3);
      IIretinit((char *)0,0);
      if (IInexec() == 0) {
        IIsqInit((char *)0);
        IIexDefine(1,(char *)"iamdmint1",6610,509);
        IIwritio(0,(short *)0,1,32,0,(char *)
"select o.object_id as objid, o.object_name as objname, o.object_class\
 as objclass, a.abfdef_name, a.object_class, a.abfdef_owner, a.abfdef_\
deptype as deptype, a.abf_linkname, a.abf_deporder as depord from ii_o\
bjects o, ii_abfdependencies a where o.");
        IIwritio(0,(short *)0,1,32,0,(char *)
"object_id=a.object_id and a.abfdef_applid=");
        IIwritio(0,(short *)0,1,32,0,(char *)" $0=");
        IIputdomio((short *)0,1,30,4,&applid);
        IIwritio(0,(short *)0,1,32,0,(char *)
"and a.abfdef_deptype<>0 and a.abfdef_deptype<>");
        IIwritio(0,(short *)0,1,32,0,(char *)" $1=");
        IIputdomio((short *)0,1,30,4,&exclude1);
        IIwritio(0,(short *)0,1,32,0,(char *)"and a.abfdef_deptype<>");
...
"order by objname, objclass, deptype, depord");
        IIexDefine(0,(char *)"iamdmint1",6610,509);
        if (IIerrtest() == 0) {
          IIsexec();
        } /* IIerrtest */
      } /* IInexec */
...
IIrtB1:
    while (IInextget() != 0) {
      ...
      IIgetdomio((short *)0,1,32,FE_MAXNAME+1-1,ent1.name);
      IIgetdomio((short *)0,1,30,4,&ent1.class);
      IIgetdomio((short *)0,1,32,FE_MAXNAME+1-1,ent2.name);
      IIgetdomio((short *)0,1,30,4,&ent2.class);
      IIgetdomio((short *)0,1,32,FE_MAXNAME + 1-1,owner_name);
      IIgetdomio((short *)0,1,30,4,&relation.deptype);
      IIgetdomio(&linkname_ind,1,32,FE_MAXNAME+1-1,relation.linkname);
      IIgetdomio(&deporder_ind,1,30,4,&relation.deporder);
      if (IIerrtest() != 0) goto IIrtB1;
/* # line 641 "iamdmint.sc" */	/* host code */
            {
...
IIrtE1:;
	...
	{
/* # line 682 "iamdmint.sc" */	/* repeated select */
  {
    IIsexec();
    while (IInexec() == 0) {
      IIsqInit((char *)0);
      IIexExec(1,(char *)"iamdmint2",6611,2221);
      IIputdomio((short *)0,1,30,4,&applid);
      ...
      if (IInexec() == 0) {
        IIsqInit((char *)0);
        IIexDefine(1,(char *)"iamdmint2",6611,2221);
        IIwritio(0,(short *)0,1,32,0,(char *)
"select o.object_id as objid, o.object_name as objname, o.object_class\
 as objclass, a.abfdef_name, a.object_class, a.abfdef_owner, a.abfdef_\
deptype as deptype, a.abf_linkname, a.abf_deporder as depord from ii_o\
...
"object_id=a.object_id and a.abfdef_applid=");
        IIwritio(0,(short *)0,1,32,0,(char *)" $0=");
        IIputdomio((short *)0,1,30,4,&applid);
        IIwritio(0,(short *)0,1,32,0,(char *)"and o.object_id=");
        IIwritio(0,(short *)0,1,32,0,(char *)" $1=");
        IIputdomio((short *)0,1,30,4,&ooid);
        IIwritio(0,(short *)0,1,32,0,(char *)
"and a.abfdef_deptype<>0 and a.abfdef_deptype<>");
        ...
        IIwritio(0,(short *)0,1,32,0,(char *)
"order by objname, objclass, deptype, depord");
        IIexDefine(0,(char *)"iamdmint2",6611,2221);
        if (IIerrtest() == 0) {
          IIsexec();
        } /* IIerrtest */
      } /* IInexec */
...
/* # line 707 "iamdmint.sc" */	/* host code */
            {
		if (linkname_ind == DB_EMB_NULL)
			*relation.linkname = EOS;
		if (deporder_ind == DB_EMB_NULL)
