...
static READONLY char	_ii_abfobjects[]	= ERx("ii_abfobjects");
static READONLY char	_ii_abfclasses[]	= ERx("ii_abfclasses");
static READONLY char	_object_id[]		= ERx("object_id");
...
static OO_METHOD	mO2001[] = {
	{44,{0x3},OC_METHOD,_authorized,0,0,0,0,0,0,0,1,
		ERx("iiamAuthorized"),iiamAuthorized,0,1,0,0,0},
	...
	{45,{0x3},OC_METHOD,_destroy,0,0,0,0,0,0,0,1,
		ERx("iiamDestroy"),iiamDestroy,0,1,0,0,0},
