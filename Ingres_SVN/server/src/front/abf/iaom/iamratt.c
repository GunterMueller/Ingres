...
RECDEF *class;
{
  ...
  RECMEM *catt;
	...
	Cur_class = class;
/* # line 132 "iamratt.sc" */	/* repeated select */
  {
    IIsexec();
    while (IInexec() == 0) {
      IIsqInit((char *)0);
      IIexExec(1,(char *)"iamratt1",6605,31677);
      IIputdomio((short *)0,1,30,4,&class_id);
      IIretinit((char *)0,0);
      if (IInexec() == 0) {
        IIsqInit((char *)0);
        IIexDefine(1,(char *)"iamratt1",6605,31677);
        IIwritio(0,(short *)0,1,32,0,(char *)
"select r.class_id, o.object_id, o.object_name, r.type_name, r.adf_len\
gth, r.adf_type, r.adf_scale, o.object_owner, o.short_remark, o.create\
_date, o.alter_date, o.last_altered_by from ii_objects o, ii_abfclasse\
s r where r.class_id=");
        IIwritio(0,(short *)0,1,32,0,(char *)" $0=");
        IIputdomio((short *)0,1,30,4,&class_id);
        IIwritio(0,(short *)0,1,32,0,(char *)
"and o.object_id=r.catt_id order by o.object_name DESC");
        IIexDefine(0,(char *)"iamratt1",6605,31677);
        if (IIerrtest() == 0) {
          IIsexec();
        } /* IIerrtest */
      } /* IInexec */
...
IIrtB1:
    while (IInextget() != 0) {
      IIgetdomio((short *)0,1,30,4,&class_id);
      IIgetdomio((short *)0,1,30,4,&catt_id);
      IIgetdomio((short *)0,1,32,FE_MAXNAME+1-1,name);
      IIgetdomio((short *)0,1,32,0,dbdesc.db_data);
      IIgetdomio((short *)0,1,30,4,&dbdesc.db_length);
      IIgetdomio((short *)0,1,30,2,&dbdesc.db_datatype);
      IIgetdomio((short *)0,1,30,2,&dbdesc.db_scale);
      IIgetdomio((short *)0,1,32,FE_MAXNAME+1-1,owner);
      IIgetdomio((short *)0,1,32,OOSHORTREMSIZE+1-1,short_remark);
      IIgetdomio((short *)0,1,32,sizeof(OOCAT_DATE)-1,create_date);
      IIgetdomio((short *)0,1,32,sizeof(OOCAT_DATE)-1,alter_date);
      IIgetdomio((short *)0,1,32,FE_MAXNAME+1-1,altered_by);
      if (IIerrtest() != 0) goto IIrtB1;
/* # line 146 "iamratt.sc" */	/* host code */
	{
...
insertAtt ( catt, applid, classid, desc )
  ...
  DB_DATA_DESC *desc;
{
/* # line 289 "iamratt.sc" */	/* repeated insert */
  {
    IIsexec();
    while (IInexec() == 0) {
      IIsqInit((char *)0);
      IIexExec(1,(char *)"iamratt2",6606,6348);
      IIputdomio((short *)0,1,30,4,&applid);
      IIputdomio((short *)0,1,30,4,&classid);
      IIputdomio((short *)0,1,30,4,&catt->ooid);
      IIputdomio((short *)0,1,30,2,&desc->db_datatype);
      IIputdomio((short *)0,1,32,0,desc->db_data);
      IIputdomio((short *)0,1,30,4,&desc->db_length);
      IIputdomio((short *)0,1,30,2,&desc->db_scale);
      IIsyncup((char *)0,0);
      if (IInexec() == 0) {
        IIsqInit((char *)0);
        IIexDefine(1,(char *)"iamratt2",6606,6348);
        IIwritio(0,(short *)0,1,32,0,(char *)
"insert into ii_abfclasses(appl_id, class_id, catt_id, class_order, ad\
f_type, type_name, adf_length, adf_scale)values(");
        IIwritio(0,(short *)0,1,32,0,(char *)" $0=");
        IIputdomio((short *)0,1,30,4,&applid);
        IIwritio(0,(short *)0,1,32,0,(char *)", ");
        ...
        IIputdomio((short *)0,1,30,2,&desc->db_scale);
        IIwritio(0,(short *)0,1,32,0,(char *)")");
        IIexDefine(0,(char *)"iamratt2",6606,6348);
        if (IIerrtest() == 0) {
          IIsexec();
        } /* IIerrtest */
      } /* IInexec */
...
updateAtt ( catt, applid, classid, desc )
  ...
  DB_DATA_DESC *desc;
{
/* # line 314 "iamratt.sc" */	/* repeated update */
  {
    IIsexec();
    while (IInexec() == 0) {
      IIsqInit((char *)0);
      IIexExec(1,(char *)"iamratt3",6607,8108);
      IIputdomio((short *)0,1,30,2,&desc->db_datatype);
      IIputdomio((short *)0,1,32,0,desc->db_data);
      IIputdomio((short *)0,1,30,4,&desc->db_length);
      IIputdomio((short *)0,1,30,2,&desc->db_scale);
      ...
      if (IInexec() == 0) {
        IIsqInit((char *)0);
        IIexDefine(1,(char *)"iamratt3",6607,8108);
        IIwritio(0,(short *)0,1,32,0,(char *)
"update ii_abfclasses set class_order=0, adf_type=");
        IIwritio(0,(short *)0,1,32,0,(char *)" $0=");
        IIputdomio((short *)0,1,30,2,&desc->db_datatype);
        IIwritio(0,(short *)0,1,32,0,(char *)", type_name=");
        IIwritio(0,(short *)0,1,32,0,(char *)" $1=");
        IIputdomio((short *)0,1,32,0,desc->db_data);
        IIwritio(0,(short *)0,1,32,0,(char *)", adf_length=");
        IIwritio(0,(short *)0,1,32,0,(char *)" $2=");
        IIputdomio((short *)0,1,30,4,&desc->db_length);
        IIwritio(0,(short *)0,1,32,0,(char *)", adf_scale=");
        IIwritio(0,(short *)0,1,32,0,(char *)" $3=");
        IIputdomio((short *)0,1,30,2,&desc->db_scale);
        IIwritio(0,(short *)0,1,32,0,(char *)"where appl_id=");
        IIwritio(0,(short *)0,1,32,0,(char *)" $4=");
        IIputdomio((short *)0,1,30,4,&applid);
        IIwritio(0,(short *)0,1,32,0,(char *)"and class_id=");
        IIwritio(0,(short *)0,1,32,0,(char *)" $5=");
        IIputdomio((short *)0,1,30,4,&classid);
        IIwritio(0,(short *)0,1,32,0,(char *)"and catt_id=");
        IIwritio(0,(short *)0,1,32,0,(char *)" $6=");
        IIputdomio((short *)0,1,30,4,&catt->ooid);
        IIexDefine(0,(char *)"iamratt3",6607,8108);
        if (IIerrtest() == 0) {
          IIsexec();
        } /* IIerrtest */
      } /* IInexec */
  ...
  RECMEM *attr;
{
	...
	if ( !IIUIinXaction() )
		iiuicw1_CatWriteOn();
/* # line 356 "iamratt.sc" */	/* repeat delete */
  {
    IIsexec();
    while (IInexec() == 0) {
      IIsqInit((char *)0);
      IIexExec(1,(char *)"iamratt4",6608,6073);
      IIputdomio((short *)0,1,30,4,&attr->ooid);
      IIsyncup((char *)0,0);
      if (IInexec() == 0) {
        IIsqInit((char *)0);
        IIexDefine(1,(char *)"iamratt4",6608,6073);
        IIwritio(0,(short *)0,1,32,0,(char *)
"delete from ii_abfclasses r where r.catt_id=");
        IIwritio(0,(short *)0,1,32,0,(char *)" $0=");
        IIputdomio((short *)0,1,30,4,&attr->ooid);
        IIexDefine(0,(char *)"iamratt4",6608,6073);
        if (IIerrtest() == 0) {
          IIsexec();
        } /* IIerrtest */
      } /* IInexec */
  ...
  RECDEF *class;
{
	...
	if ( !IIUIinXaction() )
		iiuicw1_CatWriteOn();
/* # line 397 "iamratt.sc" */	/* repeat delete */
  {
    IIsexec();
    while (IInexec() == 0) {
      IIsqInit((char *)0);
      IIexExec(1,(char *)"iamratt5",6609,3578);
      IIputdomio((short *)0,1,30,4,&class->ooid);
      IIsyncup((char *)0,0);
      if (IInexec() == 0) {
        IIsqInit((char *)0);
        IIexDefine(1,(char *)"iamratt5",6609,3578);
        IIwritio(0,(short *)0,1,32,0,(char *)
"delete from ii_abfclasses r where r.class_id=");
        IIwritio(0,(short *)0,1,32,0,(char *)" $0=");
        IIputdomio((short *)0,1,30,4,&class->ooid);
        IIexDefine(0,(char *)"iamratt5",6609,3578);
        if (IIerrtest() == 0) {
          IIsexec();
        } /* IIerrtest */
      } /* IInexec */
