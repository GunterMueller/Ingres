...
FILE		*listfile;
{
  ...
  i4 id;
	...
	*/
	if (IEDebug)
		SIprintf("\ncursor fetch...\n\n");
/* # line 302 "ieexport.sc" */	/* open */
  {
    IIsqInit(&sqlca);
    IIcsOpen((char *)"iidepcur",6976,17277);
    IIwritio(0,(short *)0,1,32,0,(char *)
"select distinct d.abfdef_name, d.object_class, o.object_id from ii_ab\
fdependencies d, ii_objects o where d.abfdef_applid=");
    IIputdomio((short *)0,1,30,4,&app_id);
    IIwritio(0,(short *)0,1,32,0,(char *)
"and d.object_id=o.object_id and d.abfdef_deptype=3502");
    IIcsQuery((char *)"iidepcur",6976,17277);
    if (sqlca.sqlcode < 0) 
      IIsqPrint(&sqlca);
  }
/* # line 303 "ieexport.sc" */	/* host code */
	/*
...
/* # line 314 "ieexport.sc" */	/* fetch */
  {
    IIsqInit(&sqlca);
    if (IIcsRetScroll((char *)"iidepcur",6976,17277,-1,-1) != 0) {
      IIcsGetio((short *)0,1,32,FE_MAXNAME+1-1,name);
      IIcsGetio((short *)0,1,30,4,&class);
      IIcsGetio((short *)0,1,30,4,&id);
      IIcsERetrieve();
    } /* IIcsRetrieve */
    if (sqlca.sqlcode < 0) 
      IIsqPrint(&sqlca);
  }
/* # line 315 "ieexport.sc" */	/* host code */
		if (sqlca.sqlcode != 0)
		    break;
		/*
		** Fix for BUG 1511.
...
/* # line 389 "ieexport.sc" */	/* close */
  {
    IIsqInit(&sqlca);
    IIcsClose((char *)"iidepcur",6976,17277);
    if (sqlca.sqlcode < 0) 
      IIsqPrint(&sqlca);
  }
/* # line 390 "ieexport.sc" */	/* host code */
	IIUIendXaction();
	return rval;
}
/*{
