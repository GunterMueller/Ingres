  ...
  i4 recid;
{
  ...
  char *EffectiveUser = "";
	...
	*/
	...
	{
	    case OC_FORM:
/* # line 533 "ieutils.sc" */	/* select */
  {
    IIsqInit(&sqlca);
    IIsqMods(1);
    IIwritio(0,(short *)0,1,32,0,(char *)
"select o.object_id from ii_objects o, ii_forms f where o.object_name=");
    IIputdomio((short *)0,1,32,0,object_name);
    IIwritio(0,(short *)0,1,32,0,(char *)"and o.object_class=");
    IIputdomio((short *)0,1,30,4,&object_class);
    IIwritio(0,(short *)0,1,32,0,(char *)
"and o.object_id=f.object_id and o.object_owner=");
    IIputdomio((short *)0,1,32,0,EffectiveUser);
    IIretinit((char *)0,0);
    if (IInextget() != 0) {
      IIgetdomio((short *)0,1,30,4,&object_id);
    } /* IInextget */
    IIsqFlush((char *)0,0);
    if (sqlca.sqlcode < 0) 
      IIsqPrint(&sqlca);
  }
/* # line 540 "ieutils.sc" */	/* host code */
       	break;
	    case OC_JOINDEF:
/* # line 543 "ieutils.sc" */	/* select */
  {
    IIsqInit(&sqlca);
    IIsqMods(1);
    IIwritio(0,(short *)0,1,32,0,(char *)
"select distinct o.object_id from ii_objects o, ii_joindefs j where o.\
object_name=");
    IIputdomio((short *)0,1,32,0,object_name);
    IIwritio(0,(short *)0,1,32,0,(char *)"and o.object_class=");
    IIputdomio((short *)0,1,30,4,&object_class);
    IIwritio(0,(short *)0,1,32,0,(char *)"and o.object_id=j.object_id");
    IIretinit((char *)0,0);
    if (IInextget() != 0) {
      IIgetdomio((short *)0,1,30,4,&object_id);
    } /* IInextget */
...
/* # line 549 "ieutils.sc" */	/* host code */
		break;
	    case OC_RECMEM:
/* # line 552 "ieutils.sc" */	/* select */
  {
    IIsqInit(&sqlca);
    IIsqMods(1);
    IIwritio(0,(short *)0,1,32,0,(char *)
"select o.object_id from ii_objects o, ii_abfclasses a where o.object_\
name=");
    IIputdomio((short *)0,1,32,0,object_name);
    IIwritio(0,(short *)0,1,32,0,(char *)
"and o.object_class=2133 and a.class_id=");
    IIputdomio((short *)0,1,30,4,&recid);
    IIwritio(0,(short *)0,1,32,0,(char *)"and a.appl_id=");
    IIputdomio((short *)0,1,30,4,&applid);
    IIwritio(0,(short *)0,1,32,0,(char *)"and a.catt_id=o.object_id");
    IIretinit((char *)0,0);
    if (IInextget() != 0) {
      IIgetdomio((short *)0,1,30,4,&object_id);
    } /* IInextget */
...
/* # line 560 "ieutils.sc" */	/* host code */
		break;
	    case OC_REPORT:
/* # line 563 "ieutils.sc" */	/* select */
  {
    IIsqInit(&sqlca);
    IIsqMods(1);
    IIwritio(0,(short *)0,1,32,0,(char *)
"select o.object_id from ii_objects o, ii_reports r where o.object_nam\
e=");
    IIputdomio((short *)0,1,32,0,object_name);
    IIwritio(0,(short *)0,1,32,0,(char *)"and o.object_class=");
    IIputdomio((short *)0,1,30,4,&object_class);
    IIwritio(0,(short *)0,1,32,0,(char *)"and o.object_id=r.object_id");
    IIretinit((char *)0,0);
    if (IInextget() != 0) {
      IIgetdomio((short *)0,1,30,4,&object_id);
    } /* IInextget */
...
/* # line 569 "ieutils.sc" */	/* host code */
		break;
	    default:
	    /* object lives in ii_abfobjects */
/* # line 573 "ieutils.sc" */	/* select */
  {
    IIsqInit(&sqlca);
    IIsqMods(1);
    IIwritio(0,(short *)0,1,32,0,(char *)
"select o.object_id from ii_objects o, ii_abfobjects a where o.object_\
name=");
    IIputdomio((short *)0,1,32,0,object_name);
    IIwritio(0,(short *)0,1,32,0,(char *)"and o.object_class=");
    IIputdomio((short *)0,1,30,4,&object_class);
    IIwritio(0,(short *)0,1,32,0,(char *)
"and o.object_id=a.object_id and a.applid=");
    IIputdomio((short *)0,1,30,4,&applid);
    IIretinit((char *)0,0);
    if (IInextget() != 0) {
      IIgetdomio((short *)0,1,30,4,&object_id);
...
/* # line 580 "ieutils.sc" */	/* host code */
		break;
	}
/* # line 583 "ieutils.sc" */	/* inquire_ingres */
  {
    IILQisInqSqlio((short *)0,1,30,4,&errnum,2);
    IILQisInqSqlio((short *)0,1,30,4,&rcount,8);
  }
/* # line 585 "ieutils.sc" */	/* host code */
	if (errnum != 0)
		return errnum;
	if (rcount < 1) 
	{
		...
		*/
			...
			(object_class <= OC_AMAXFRAME) ) )
		{
			if (IEDebug)
				...
				object_name, object_class);
/* # line 606 "ieutils.sc" */	/* select */
  {
    IIsqInit(&sqlca);
    IIwritio(0,(short *)0,1,32,0,(char *)
"select o.object_id, o.object_class from ii_objects o, ii_abfobjects a\
 where o.object_name=");
    IIputdomio((short *)0,1,32,0,object_name);
    IIwritio(0,(short *)0,1,32,0,(char *)"and o.object_class<>");
    IIputdomio((short *)0,1,30,4,&object_class);
    IIwritio(0,(short *)0,1,32,0,(char *)
"and((o.object_class>=2020 and o.object_class<=2100)or(o.object_class>\
=2200 and o.object_class<=2300))and o.object_id=a.object_id and a.appl\
id=");
    IIputdomio((short *)0,1,30,4,&applid);
    IIretinit((char *)0,0);
...
IIrtB1:
    while (IInextget() != 0) {
      IIgetdomio((short *)0,1,30,4,&object_id);
      IIgetdomio((short *)0,1,30,4,&dup_class);
...
/* # line 621 "ieutils.sc" */	/* inquire_ingres */
  {
    IILQisInqSqlio((short *)0,1,30,4,&errnum,2);
    IILQisInqSqlio((short *)0,1,30,4,&rcount,8);
  }
/* # line 623 "ieutils.sc" */	/* host code */
			if (errnum != 0)
				return errnum;
			/* 
