...
char		*inbuf;
{
  ...
  i4 adf_scale;
	...
	if (objrec->update)
	{
/* # line 373 "ierecord.sc" */	/* update */
  {
    IIsqInit(&sqlca);
    IIwritio(0,(short *)0,1,32,0,(char *)
"update ii_abfclasses set class_order=");
    IIputdomio((short *)0,1,30,4,&class_order);
    IIwritio(0,(short *)0,1,32,0,(char *)", adf_type=");
    IIputdomio((short *)0,1,30,4,&adf_type);
    IIwritio(0,(short *)0,1,32,0,(char *)", type_name=");
    IIputdomio((short *)0,1,32,0,type_name);
...
/* # line 383 "ierecord.sc" */	/* host code */
	}
	else
	{
/* # line 386 "ierecord.sc" */	/* insert */
  {
    IIsqInit(&sqlca);
    IIwritio(0,(short *)0,1,32,0,(char *)
"insert into ii_abfclasses(appl_id, catt_id, class_id, class_order, ad\
...
/* # line 393 "ierecord.sc" */	/* host code */
	}
	return(FEinqerr());
}
