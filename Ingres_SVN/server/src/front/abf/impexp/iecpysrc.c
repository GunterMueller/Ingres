...
IEPARAMS	*srclist;
{
  ...
  char oname[FE_MAXNAME+1];
	...
	*/
/* # line 272 "iecpysrc.sc" */	/* open */
  {
    IIsqInit(&sqlca);
    IIcsOpen((char *)"iicpysrc",6977,2525);
...
s, o.object_name from ii_abfobjects a, ii_objects o where a.applid=");
    ...
    IIwritio(0,(short *)0,1,32,0,(char *)
"and a.object_id=o.object_id and a.abf_source<>'' and((o.object_class>\
=2020 and o.object_class<2100)or(o.object_class>=2200 and o.object_cla\
ss<2300))");
    IIcsQuery((char *)"iicpysrc",6977,2525);
    if (sqlca.sqlcode < 0) 
      IIsqPrint(&sqlca);
  }
/* # line 274 "iecpysrc.sc" */	/* host code */
	while (sqlca.sqlcode == 0)
	{
/* # line 276 "iecpysrc.sc" */	/* fetch */
  {
    IIsqInit(&sqlca);
    if (IIcsRetScroll((char *)"iicpysrc",6977,2525,-1,-1) != 0) {
      IIcsGetio((short *)0,1,32,MAX_LOC +1-1,tempbuf);
      IIcsGetio((short *)0,1,30,4,&flags);
      IIcsGetio((short *)0,1,30,4,&oid);
      IIcsGetio((short *)0,1,30,4,&class);
      IIcsGetio((short *)0,1,32,FE_MAXNAME+1-1,oname);
      IIcsERetrieve();
    } /* IIcsRetrieve */
    if (sqlca.sqlcode < 0) 
      IIsqPrint(&sqlca);
  }
/* # line 279 "iecpysrc.sc" */	/* host code */
		if (sqlca.sqlcode != 0)
			break;
		if (IEDebug)
...
/* # line 340 "iecpysrc.sc" */	/* close */
  {
    IIsqInit(&sqlca);
    IIcsClose((char *)"iicpysrc",6977,2525);
    if (sqlca.sqlcode < 0) 
      IIsqPrint(&sqlca);
  }
/* # line 342 "iecpysrc.sc" */	/* host code */
}
/*
