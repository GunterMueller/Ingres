...
/*::
** Name:        ILgetI4Operand() -        Return I4 Operand of an IL Statement.
**
** An IL statement is simply a series of i2's. An i4 sits across two
** operands in some known (special) cases.
**
** Inputs to this macro:
**      IL      *stmt;  ** a pointer to the beginning of the IL statement **
**      i4      num;    ** the relative number of the operand **
...
*/
# define ILgetI4Operand(stmt, num)        ((i4) *((stmt) + (num)))
