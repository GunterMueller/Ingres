...
/* # line 951 "ilquery.qsc" */	/* inquire_frs */
      {
        if (IIiqset(1,0,(char *)0, (char *)0, (char *)0) != 0) {
          IIiqfsio((short *)0,1,32,FE_MAXNAME+1-1,iqry->saved_mode,21,
          (char *)0,0);
        } /* IIiqset */
      }
/* # line 953 "ilquery.qsc" */	/* host code */
		qry->qr_version &= ~QR_0_ROWS_OK;
	...
	if (!rowsfound)
	{
		...
		{
/* # line 961 "ilquery.qsc" */	/* message */
    {
      IImessage(ERget(S_IT001C_No_rows_retrieved));
    }
/* # line 962 "ilquery.qsc" */	/* sleep */
    {
      IIsleep(3);
    }
/* # line 963 "ilquery.qsc" */	/* host code */
		}
...
IL	*stmt;
{
	...
	if (ILNULLVAL(ILgetOperand(stmt, 1)))
	{
		...
		{
/* # line 1009 "ilquery.qsc" */	/* message */
  {
    IImessage(ERget(S_IT001D_No_query_currently_ac));
  }
/* # line 1010 "ilquery.qsc" */	/* sleep */
  {
    IIsleep(3);
  }
/* # line 1011 "ilquery.qsc" */	/* host code */
		}
		else if (!abrtsgen(prm->pr_oldprm->pr_qry, QI_NMASTER))
		{
		    if (give_message)
		    {
/* # line 1016 "ilquery.qsc" */	/* message */
  {
    IImessage(ERget(S_IT001E_No_more_rows));
  }
/* # line 1017 "ilquery.qsc" */	/* sleep */
  {
    IIsleep(3);
  }
/* # line 1018 "ilquery.qsc" */	/* host code */
		    }
		}
		return;
	}
	...
	if (!rowsfound)
	{
	    if (give_message)
	    {
/* # line 1035 "ilquery.qsc" */	/* message */
  {
    IImessage(ERget(S_IT001E_No_more_rows));
  }
/* # line 1036 "ilquery.qsc" */	/* sleep */
  {
    IIsleep(3);
  }
/* # line 1037 "ilquery.qsc" */	/* host code */
	    }
	...
	if (!(ILNULLVAL(ILgetOperand(stmt, 1))))
	{
		...
		*/
		...
		if (iqry != NULL)
		{
		    ...
		    {
/* # line 1125 "ilquery.qsc" */	/* set_frs */
    {
      if (IIiqset(1,0,(char *)0, (char *)0, (char *)0) != 0) {
        IIstfsio(21,(char *)0,0,(short *)0,1,32,0,iqry->saved_mode);
      } /* IIiqset */
    }
/* # line 1126 "ilquery.qsc" */	/* host code */
		    }
