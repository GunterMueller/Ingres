...
ABRTSFUNCS	*hl_proc;
{
  ...
  i4 saved_id;
    ...
    ** user applications.
    */
/* # line 259 "iltop.sc" */	/* set_ingres */
  {
    IILQssSetSqlio(7,(short *)0,1,30,sizeof(0),(void *)IILQint(0));
  }
/* # line 260 "iltop.sc" */	/* host code */
    if ( IIUIdcn_ingres() )
    { /* for INGRES only ... */
/* # line 262 "iltop.sc" */	/* set */
  {
    IIsqInit((char *)0);
    IIwritio(0,(short *)0,1,32,0,(char *)
"set lockmode on ii_encodings where readlock=nolock");
    IIsyncup((char *)0,0);
  }
/* # line 263 "iltop.sc" */	/* host code */
    }
    IIARfrsInit( TRUE );
    /*
    ** Open ILRF session.
...
/* # line 284 "iltop.sc" */	/* inquire_ingres */
  {
    IILQisInqSqlio((short *)0,1,30,4,&saved_id,11);
  }
/* # line 285 "iltop.sc" */	/* host code */
    /* Switch to Interpreter/Front-End Session */
/* # line 286 "iltop.sc" */	/* set_ingres */
  {
    IILQssSetSqlio(11,(short *)0,1,30,sizeof(UI_SESSION),(void *)IILQint(
    UI_SESSION));
  }
/* # line 287 "iltop.sc" */	/* host code */
    /*
...
ParmTextFunc( )
  {
    ...
    char ParmBuf[ 256 ];
/* # line 405 "iltop.qsc" */	/* prompt */
    {
      IIFRgpcontrol(1,0);
      IIFRgpsetio(6,(short *)0,1,30,sizeof(301),(void *)IILQint(301));
      IIFRgpsetio(3,(short *)0,1,30,sizeof(5),(void *)IILQint(5));
      IIFRgpcontrol(2,0);
      IIprmptio(0,ERget( S_IT0021_Enter_app_parms ),(short *)0,1,32,255,
      ParmBuf);
    }
/* # line 408 "iltop.qsc" */	/* host code */
