...
bool	is_static;
{
  i4 saved_id;
    u_i4	rval;
    /* Get current session ID */
/* # line 991 "ilcall.sc" */	/* inquire_ingres */
  {
    IILQisInqSqlio((short *)0,1,30,4,&saved_id,11);
  }
/* # line 993 "ilcall.sc" */	/* host code */
    /* Switch to Interpreter/Front-End Session */
/* # line 994 "ilcall.sc" */	/* set_ingres */
  {
    IILQssSetSqlio(11,(short *)0,1,30,sizeof(UI_SESSION),(void *)IILQint(
    UI_SESSION));
  }
/* # line 996 "ilcall.sc" */	/* host code */
	...
	*/
	...
	/* Get current session ID */
/* # line 1048 "ilcall.sc" */	/* inquire_ingres */
  {
    IILQisInqSqlio((short *)0,1,30,4,&saved_id,11);
  }
/* # line 1050 "ilcall.sc" */	/* host code */
	/* Switch to Interpreter/Front-End Session */
/* # line 1051 "ilcall.sc" */	/* set_ingres */
  {
    IILQssSetSqlio(11,(short *)0,1,30,sizeof(UI_SESSION),(void *)IILQint(
    UI_SESSION));
  }
/* # line 1053 "ilcall.sc" */	/* host code */
