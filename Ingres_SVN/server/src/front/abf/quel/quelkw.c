/*
**	Copyright (c) 1985, 1986 Ingres Corporation
*/
...
static READONLY KW	dirktab[] = {	/* DDB */
...
static READONLY char	_Transaction[] =	ERx("transaction");
...
static READONLY char	_Field[] =	ERx("field");
