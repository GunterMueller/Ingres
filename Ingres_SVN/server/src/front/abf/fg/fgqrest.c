...
static READONLY char _equal[] 	= " = ";
static READONLY char opers[] 	= "!=<>^";
static READONLY char openpar[] 	= "( ";
static READONLY char open2pars[] = "( ( ";
static READONLY char closepar[] = " ) ";
static READONLY char close2pars[] = " ) ) ";
static READONLY char _quote[] 	= "'";
static READONLY char uscore[] 	= "_";

static READONLY char _and[] 	= "AND";
static READONLY char _between[] = "BETWEEN";
static READONLY char _in[] 	= "IN";
static READONLY char _is[] 	= "IS";
static READONLY char _like[] 	= "LIKE";
static READONLY char _not[] 	= "NOT";
static READONLY char _or[] 	= "OR";
