...
/* static's */
static READONLY char _asc[]             = ERx(" ASC");
static READONLY char _desc[]            = ERx(" DESC");
static READONLY char _from[]        	= ERx("FROM");
static READONLY char _into[]        	= ERx("INTO ");
static READONLY char _order_by[]	= ERx("ORDER BY");
static READONLY char _qualification[]	= ERx("QUALIFICATION");
static READONLY char _set[]		= ERx("SET");
static READONLY char _values[]        	= ERx("VALUES");
static READONLY char _where[]        	= ERx("WHERE");
static READONLY char _isnull[]		= ERx(" IS NULL");
static READONLY char _or[]		= ERx(" OR");
static READONLY char _user[]		= ERx("USER");
static READONLY char _now[]		= ERx("'NOW'");
static READONLY char _optim[]		= ERx("optimistic");

static READONLY char _zero[]		= ERx("0");
static READONLY char _one[]		= ERx("1");

static READONLY char _null[]        	= ERx("");
static READONLY char _dot[]        	= ERx(".");
static READONLY char _equal[]        	= ERx(" = ");
static READONLY char _equal_deref[]    	= ERx(" = :");
static READONLY char _space[]    	= ERx(" ");
static READONLY char _lparen[]		= ERx("(");
static READONLY char _rparen[]		= ERx(")");
static READONLY char _colon[]		= ERx(":");
static READONLY char _plus[]		= ERx(" + ");
