...
*/
static READONLY char	s_Add[]		= ERx("add");		/* RTI/SQL */
static READONLY char	s_All[]		= ERx("all");		/* RTI/SQL */
static READONLY char	s_And[]		= ERx("and");		/* RTI/SQL */
static READONLY char	s_As[]		= ERx("as");		/* RTI/SQL */
static READONLY char	s_By[]		= ERx("by");		/* RTI/SQL */
static READONLY char	s_Commit[]	= ERx("commit");	/* RTI/SQL */
static READONLY char	s_Connect[]	= ERx("connect");	/* RTI/SQL */
static READONLY char	s_Current[]	= ERx("current");	/* RTI/SQL */
static READONLY char	s_Dbevent[]	= ERx("dbevent");	/* RTI/SQL */
static READONLY char	s_Dbms_Passwd[]	= ERx("dbms_password"); /* RTI/SQL */
static READONLY char	s_Default[]	= ERx("default");	/* RTI/SQL */
static READONLY char	s_Disconnect[]	= ERx("disconnect");	/* RTI/SQL */
static READONLY char	s_Entry[]	= ERx("entry");
static READONLY char	s_Escape[]	= ERx("escape");
static READONLY char	s_Execute[]	= ERx("execute");
static READONLY char	s_Group[]	= ERx("group");		/* RTI/SQL */
static READONLY char	s_Integrity[]	= ERx("integrity");	/* RTI/SQL */
static READONLY char	s_Join[]	= ERx("join");		/* RTI/SQL */
static READONLY char	s_Key[]		= ERx("key");		/* RTI/SQL */
static READONLY char	s_Like[]	= ERx("like");		/* RTI/SQL */
static READONLY char	s_Link[]	= ERx("link");		/* RTI/SQL */
static READONLY char	s_Location[]	= ERx("location");	/* RTI/SQL */
static READONLY char	s_Menu[]	= ERx("menu");		/* RTI/SQL */
static READONLY char	s_Next[]	= ERx("next");		/* RTI/SQL */
static READONLY char	s_Nextfield[]	= ERx("nextfield");
static READONLY char	s_Not[]		= ERx("not");		/* RTI/SQL */
static READONLY char	s_On[]		= ERx("on");		/* RTI/SQL */
static READONLY char	s_Or[]		= ERx("or");		/* RTI/SQL */
static READONLY char	s_Password[]	= ERx("password");	/* RTI/SQL */
static READONLY char	s_Permit[]	= ERx("permit");	/* RTI/SQL */
static READONLY char	s_Prevfield[]	= ERx("previousfield");
static READONLY char	s_Privileges[]	= ERx("privileges");	/* RTI/SQL */
static READONLY char	s_Procedure[]	= ERx("procedure");	/* RTI/SQL */
static READONLY char	s_Profile[]	= ERx("profile");	/* RTI/SQL */
static READONLY char	s_Public[]	= ERx("public");	/* RTI/SQL */
static READONLY char	s_Role[]	= ERx("role");		/* RTI/SQL */
static READONLY char	s_Rule[]	= ERx("rule");		/* RTI/SQL */
static READONLY char	s_SecAlarm[]	= ERx("security_alarm"); /* RTI/SQL */
static READONLY char	s_SecAudit[]	= ERx("security_audit"); /* RTI/SQL */
static READONLY char	s_Session[]	= ERx("session"); 	/* RTI/SQL */
static READONLY char	s_Synonym[]	= ERx("synonym");	/* RTI/SQL */
static READONLY char	s_Table[]	= ERx("table");		/* RTI/SQL */
static READONLY char	s_To[]		= ERx("to");		/* RTI/SQL */
static READONLY char	s_Users[]	= ERx("users");		/* RTI/SQL */
static READONLY char	s_User[]	= ERx("user");		/* RTI/SQL */
static READONLY char	s_View[]	= ERx("view");

/* CREATE Double Keyword Table */
static READONLY KW	crktab[] = {
...
static READONLY KW 	sessionktab[] = {
...
static READONLY KW 	connectktab[] = {
	{s_To,	CONNECT,	FALSE,	NULL},
	NULL
};
static READONLY KW 	disconnectktab[] = {
	{s_Current,	DISCONNECT,		FALSE,	NULL},
	NULL
};
static READONLY KW 	identktab[] = {
	{s_By,	IDENTIFIED_BY,	FALSE,	NULL},
	NULL
};
static READONLY KW 	setktab[] = {
