...
char *applowner;
{
  ...
  char object_owner[FE_MAXNAME + 1];
	...
	*/
	maxid = -1;
/* # line 160 "insrcs.sc" */	/* select */
  {
    IIsqInit((char *)0);
    IIsqMods(1);
    IIwritio(0,(short *)0,1,32,0,(char *)
"select a.abf_source, o.object_id, o.object_owner from ii_abfobjects a\
, ii_objects o where o.object_name=");
    IIputdomio((short *)0,1,32,0,applname);
    IIwritio(0,(short *)0,1,32,0,(char *)"and o.object_class=");
    IIputdomio((short *)0,1,30,sizeof(OC_APPL),(void *)IILQint(OC_APPL));
    IIwritio(0,(short *)0,1,32,0,(char *)
"and o.object_id=a.object_id and o.object_id=a.applid order by object_\
id");
    IIretinit((char *)0,0);
    if (IInextget() != 0) {
      IIgetdomio((short *)0,1,32,0,sfilebuf);
      IIgetdomio((short *)0,1,30,4,&maxid);
      IIgetdomio((short *)0,1,32,FE_MAXNAME + 1-1,object_owner);
    } /* IInextget */
    IIsqFlush((char *)0,0);
  }
/* # line 168 "insrcs.sc" */	/* host code */
	if (maxid < 0)
	{
		/*
...
char	*lfile;
{
  ...
  char oname[FE_MAXNAME+1];
	...
	** shouldn't matter.
	*/
/* # line 366 "insrcs.sc" */	/* select */
  {
    IIsqInit((char *)0);
    IIsqMods(1);
    IIwritio(0,(short *)0,1,32,0,(char *)
"select count(*)from ii_abfobjects where applid=");
    IIputdomio((short *)0,1,30,4,&applid);
    IIretinit((char *)0,0);
    if (IInextget() != 0) {
      IIgetdomio((short *)0,1,30,4,&mfcount);
    } /* IInextget */
    IIsqFlush((char *)0,0);
  }
/* # line 370 "insrcs.sc" */	/* host code */
	++mfcount;
	mfnew = (struct mfchg *)
...
/* # line 380 "insrcs.sc" */	/* select */
  {
    IIsqInit((char *)0);
    IIwritio(0,(short *)0,1,32,0,(char *)
"select distinct a.abf_source, a.abf_flags, a.object_id, o.object_clas\
s, o.object_name from ii_abfobjects a, ii_objects o where a.applid=");
    IIputdomio((short *)0,1,30,4,&applid);
    IIwritio(0,(short *)0,1,32,0,(char *)
"and a.object_id=o.object_id and a.object_id<>a.applid and a.abf_sourc\
e<>'' and o.object_class<>");
    IIputdomio((short *)0,1,30,4,&c_class);
    IIretinit((char *)0,0);
    if (IIerrtest() != 0) goto IIrtE1;
IIrtB1:
    while (IInextget() != 0) {
      IIgetdomio((short *)0,1,32,MAX_LOC-1,tempbuf);
...
{
	iiuicw1_CatWriteOn();
/* # line 544 "insrcs.sc" */	/* update */
  {
    IIsqInit((char *)0);
    IIwritio(0,(short *)0,1,32,0,(char *)
"update ii_abfobjects a set abf_source=");
    IIputdomio((short *)0,1,32,0,sdir);
    IIwritio(0,(short *)0,1,32,0,(char *)"where a.object_id=");
    IIputdomio((short *)0,1,30,4,&id);
    IIwritio(0,(short *)0,1,32,0,(char *)"and a.applid=");
    IIputdomio((short *)0,1,30,4,&id);
    IIsyncup((char *)0,0);
  }
/* # line 547 "insrcs.sc" */	/* host code */
	iiuicw0_CatWriteOff();
}
