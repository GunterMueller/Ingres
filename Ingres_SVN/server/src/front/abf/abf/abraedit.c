...
GLOBALDEF READONLY COMP_CLASS_INFO iiABratts = {
	OC_RECMEM,
...
/* # line 132 "abraedit.qsc" */	/* putform */
    {
      if (IIfsetio(formname) != 0) {
        IIputfldio(_title,(short *)0,1,32,0,title);
        IIputfldio((char *)"name",(short *)0,1,32,0,ratt->name);
      } /* IIfsetio */
    }
/* # line 137 "abraedit.qsc" */	/* host code */
...
/* # line 155 "abraedit.qsc" */	/* host code */
/*
...
/* # line 187 "abraedit.qsc" */	/* inquire_frs */
    {
      if (IIiqset(2,0,formname,(char *)0, (char *)0) != 0) {
        IIiqfsio((short *)0,1,30,4,&sremark_change,20,_short_remark,0);
      } /* IIiqset */
    }
/* # line 191 "abraedit.qsc" */	/* host code */
...
/* # line 202 "abraedit.qsc" */	/* host code */
