...
GLOBALDEF READONLY COMP_CLASS_INFO iiABconsts = {
	OC_CONST,
...
/* # line 166 "abcoedit.qsc" */	/* putform */
    {
      if (IIfsetio(formname) != 0) {
        IIputfldio(_title,(short *)0,1,32,0,title);
        IIputfldio(_name,(short *)0,1,32,0,constant->name);
        IIputfldio(_data_type,(short *)0,1,32,0,type);
        IIputfldio(_value,(short *)0,1,32,0,value);
      } /* IIfsetio */
    }
/* # line 173 "abcoedit.qsc" */	/* host code */
...
/* # line 187 "abcoedit.qsc" */	/* host code */
/*
...
/* # line 286 "abcoedit.qsc" */	/* putform */
    {
      if (IIfsetio(form) != 0) {
        IIputfldio(_data_type,(short *)0,1,32,0,old_type_str);
      } /* IIfsetio */
    }
/* # line 289 "abcoedit.qsc" */	/* host code */
			return FAIL;
		}
		...
		** and unchanged.
		*/
/* # line 300 "abcoedit.qsc" */	/* inquire_frs */
    {
      if (IIiqset(2,0,(char *)"",(char *)0, (char *)0) != 0) {
        IIiqfsio((short *)0,1,30,4,&val_changed,20,_value,0);
      } /* IIiqset */
    }
/* # line 303 "abcoedit.qsc" */	/* host code */
		if ( val_changed || comp->data.inDatabase )
		{ 
			/* value field is not empty; check 
			** against new type.
			*/
/* # line 308 "abcoedit.qsc" */	/* getform */
    {
      if (IIfsetio(form) != 0) {
        IIgetfldio((short *)0,1,32,180+1-1,value,_value);
      } /* IIfsetio */
    }
/* # line 309 "abcoedit.qsc" */	/* host code */
			if ( STtrmwhite(value) > 0
			  && _ckValue(&tmpdbv, value) != OK
			   )
			{
/* # line 313 "abcoedit.qsc" */	/* clear */
    {
      IIfldclear(_value);
    }
/* # line 314 "abcoedit.qsc" */	/* host code */
			}
		}
		return OK;
	}
...
/* # line 373 "abcoedit.qsc" */	/* inquire_frs */
    {
      if (IIiqset(2,0,form,(char *)0, (char *)0) != 0) {
        IIiqfsio((short *)0,1,30,4,&sremark_change,20,_short_remark,0);
      } /* IIiqset */
    }
/* # line 377 "abcoedit.qsc" */	/* set_frs */
    {
      if (IIiqset(2,0,form,(char *)0, (char *)0) != 0) {
        IIstfsio(20,_data_type,0,(short *)0,1,30,sizeof(0),(void *)IILQint(0));
      } /* IIiqset */
    }
/* # line 378 "abcoedit.qsc" */	/* getform */
    {
      if (IIfsetio(form) != 0) {
        IIgetfldio((short *)0,1,32,FE_MAXNAME+1-1,constant_type,_data_type);
      } /* IIfsetio */
    }
/* # line 379 "abcoedit.qsc" */	/* getform */
    {
      if (IIfsetio(form) != 0) {
        IIgetfldio((short *)0,1,32,180+1-1,value,_value);
      } /* IIfsetio */
    }
/* # line 381 "abcoedit.qsc" */	/* host code */
...
/* # line 459 "abcoedit.qsc" */	/* host code */
