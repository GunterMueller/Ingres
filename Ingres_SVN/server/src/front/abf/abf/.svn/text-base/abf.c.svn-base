...
char	**argv;
{
	static READONLY	char	_ABF[]		= ERx("abf");
	static READONLY	char	_Vision[]	= ERx("vision");

	/* "Client" info passed to FEningres for use by IIUICheckDictVer */
	static READONLY char	_ClVision[]	= ERx("VISION");
	static READONLY char	_ClIngres[]	= ERx("INGRES");
