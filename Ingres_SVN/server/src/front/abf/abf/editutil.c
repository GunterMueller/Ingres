...
APPL_COMP	*comp;
  ...
  {
    char srcfile[48+1];
/* # line 198 "editutil.qsc" */	/* getform */
    {
      if (IIfsetio(form) != 0) {
        IIgetfldio((short *)0,1,32,48+1-1,srcfile,_srcfile);
      } /* IIfsetio */
    }
/* # line 200 "editutil.qsc" */	/* host code */
...
char		lbuf[MAX_LOC+1];
  {
	...
	if ( (stat = NMloc(TEMP, PATH, (char *)NULL, &path)) == OK )
	{
		...
		{
			LOtos(temp, &file);
/* # line 381 "editutil.qsc" */	/* printscreen */
    {
      IIprnscr(file);
    }
/* # line 382 "editutil.qsc" */	/* host code */
		}
	}
	return stat;
  }
...
u_i4			tag;
  register DB_DATA_DESC *type_desc;
  {
    ...
    i4 desc_change;
    i4 null_change;
/* # line 523 "editutil.qsc" */	/* inquire_frs */
    {
      if (IIiqset(2,0,form,(char *)0, (char *)0) != 0) {
        IIiqfsio((short *)0,1,30,4,&desc_change,20,_return_type,0);
        IIiqfsio((short *)0,1,30,4,&null_change,20,_nullable,0);
      } /* IIiqset */
    }
/* # line 528 "editutil.qsc" */	/* host code */
    ...
    {
      char nullbuf[16];
/* # line 537 "editutil.qsc" */	/* set_frs */
      {
        if (IIiqset(2,0,form,(char *)0, (char *)0) != 0) {
          IIstfsio(20,_nullable,0,(short *)0,1,30,sizeof(0),(void *)IILQint(0));
        } /* IIiqset */
      }
/* # line 538 "editutil.qsc" */	/* getform */
      {
        if (IIfsetio(form) != 0) {
          IIgetfldio((short *)0,1,32,15,nullbuf,_nullable);
        } /* IIfsetio */
      }
/* # line 539 "editutil.qsc" */	/* host code */
	...
	else
    {
      char desc[FE_MAXNAME+1];
		DB_DATA_VALUE	new;
/* # line 556 "editutil.qsc" */	/* set_frs */
      {
        if (IIiqset(2,0,form,(char *)0, (char *)0) != 0) {
          IIstfsio(20,_return_type,0,(short *)0,1,30,sizeof(0),
          (void *)IILQint(0));
        } /* IIiqset */
      }
/* # line 557 "editutil.qsc" */	/* getform */
      {
        if (IIfsetio(form) != 0) {
          IIgetfldio((short *)0,1,32,FE_MAXNAME+1-1,desc,_return_type);
        } /* IIfsetio */
      }
/* # line 558 "editutil.qsc" */	/* host code */
...
APPL_COMP	*obj;
  ...
  DB_DATA_DESC *dbdv;
  {
    ...
    i4 desc_change;
    char buf[16];
/* # line 731 "editutil.qsc" */	/* inquire_frs */
    {
      if (IIiqset(2,0,form,(char *)0, (char *)0) != 0) {
        IIiqfsio((short *)0,1,30,4,&desc_change,20,_data_type,0);
      } /* IIiqset */
    }
/* # line 735 "editutil.qsc" */	/* set_frs */
    {
      if (IIiqset(2,0,form,(char *)0, (char *)0) != 0) {
        IIstfsio(20,_nullable,0,(short *)0,1,30,sizeof(0),(void *)IILQint(0));
      } /* IIiqset */
    }
/* # line 736 "editutil.qsc" */	/* getform */
    {
      if (IIfsetio(form) != 0) {
        IIgetfldio((short *)0,1,32,15,buf,_nullable);
      } /* IIfsetio */
    }
/* # line 738 "editutil.qsc" */	/* host code */
	/* Note:  The field must be validated "yes" or "no". */
	...
	/* description changed */
/* # line 768 "editutil.qsc" */	/* set_frs */
    {
      if (IIiqset(2,0,form,(char *)0, (char *)0) != 0) {
        IIstfsio(20,_data_type,0,(short *)0,1,30,sizeof(0),(void *)IILQint(0));
      } /* IIiqset */
    }
/* # line 769 "editutil.qsc" */	/* getform */
    {
      if (IIfsetio(form) != 0) {
        IIgetfldio((short *)0,1,32,FE_MAXNAME+1-1,desc,_data_type);
      } /* IIfsetio */
    }
/* # line 770 "editutil.qsc" */	/* host code */
	_VOID_ STtrmwhite(desc);
...
i4		dml;
  {
    ...
    char old_title[FE_MAXNAME+1];
		if ( dml == DB_NODT )
/* # line 845 "editutil.qsc" */	/* getform */
    {
      if (IIfsetio(formname) != 0) {
        IIgetfldio((short *)0,1,32,FE_MAXNAME+1-1,old_title,_yn_field_title);
      } /* IIfsetio */
    }
/* # line 847 "editutil.qsc" */	/* host code */
		if ( dbdv->db_datatype == DB_DMY_TYPE )
...
/* # line 874 "editutil.qsc" */	/* putform */
    {
      if (IIfsetio(formname) != 0) {
        IIputfldio(_data_type,(short *)0,1,32,0,typename);
      } /* IIfsetio */
    }
/* # line 876 "editutil.qsc" */	/* host code */
	if ( yn_msg_id != ER_OK )
	{ /* Nullability/Array-ness was changed */
/* # line 878 "editutil.qsc" */	/* putform */
    {
      if (IIfsetio(formname) != 0) {
        IIputfldio(_nullable,(short *)0,1,32,0,ERget( yn_msg_id ));
        IIputfldio(_yn_field_title,(short *)0,1,32,0,yn_title);
      } /* IIfsetio */
    }
/* # line 881 "editutil.qsc" */	/* host code */
	}
  }
