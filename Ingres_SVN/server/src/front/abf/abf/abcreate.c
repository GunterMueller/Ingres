...
static READONLY
  char _createForm[]= ERx("abfcompcreate"), _crselectForm[]= ERx("abfcomptypeselect")
  , _selectForm[]= ERx("abfcompselect"), _useTblFld[]= ERx("usage");
...
static READONLY LISTMENU Crmen[] =
{
...
/* # line 359 "abcreate.qsc" */	/* putform */
    {
      if (IIfsetio(_crselectForm) != 0) {
        IIputfldio(_title,(short *)0,1,32,0,title);
      } /* IIfsetio */
    }
/* # line 361 "abcreate.qsc" */	/* host code */
...
i4  idx;
{
  ...
  OOID type;
	...
	{
	case FE_Select:
/* # line 382 "abcreate.qsc" */	/* getrow */
  {
    if (IItbsetio(2,_crselectForm,_useTblFld,-2) != 0) {
      IItcogetio((short *)0,1,30,4,&type,_class);
      IITBceColEnd();
    } /* IItbsetio */
  }
/* # line 384 "abcreate.qsc" */	/* host code */
...
/* # line 427 "abcreate.qsc" */	/* loadtable */
    {
      if (IItbact(_selectForm,_useTblFld,1) != 0) {
        IItcoputio((char *)"usage",(short *)0,1,32,0,buf);
        IItcoputio((char *)"description",(short *)0,1,32,0,ERget(desc));
        IItcoputio(_title,(short *)0,1,30,4,&title);
        IItcoputio(_class,(short *)0,1,30,4,&class);
        IItcoputio((char *)"language",(short *)0,1,30,4,&language);
        IITBceColEnd();
      } /* IItbact */
    }
  }
/* # line 436 "abcreate.qsc" */	/* host code */
static
...
i4  idx;
  {
	...
	{
	case FE_Select:
/* # line 454 "abcreate.qsc" */	/* getrow */
    {
      if (IItbsetio(2,_selectForm,_useTblFld,-2) != 0) {
        IItcogetio((short *)0,1,30,4,&nclass,_class);
        IItcogetio((short *)0,1,30,4,&title,_title);
        IItcogetio((short *)0,1,30,4,&lang,(char *)"language");
        IITBceColEnd();
      } /* IItbsetio */
    }
/* # line 459 "abcreate.qsc" */	/* host code */
		new.ooid = *(lp->id);
		new.class = nclass;
		new.appl = lp->app;
		if ( nclass == OC_HLPROC )
...
/* # line 548 "abcreate.qsc" */	/* inittable */
    {
      if (IItbinit(_selectForm,_useTblFld,(char *)"u") != 0) {
        IIthidecol(_class,(char *)"i4");
        IIthidecol((char *)"language",(char *)"i4");
        IIthidecol(_title,(char *)"i4");
        IItfill();
      } /* IItbinit */
    }
/* # line 551 "abcreate.qsc" */	/* host code */
...
/* # line 622 "abcreate.qsc" */	/* putform */
    {
      if (IIfsetio(_crselectForm) != 0) {
        IIputfldio(_title,(short *)0,1,32,0,title);
      } /* IIfsetio */
    }
/* # line 624 "abcreate.qsc" */	/* host code */
...
/* # line 668 "abcreate.qsc" */	/* putform */
    {
      if (IIfsetio(_createForm) != 0) {
        IIputfldio((char *)"type",(short *)0,1,32,0,type);
      } /* IIfsetio */
    }
/* # line 670 "abcreate.qsc" */	/* host code */
	return OK;
  }
/*
** History:
...
/* # line 1256 "abcreate.qsc" */	/* inittable */
  {
    if (IItbinit(_crselectForm,_useTblFld,(char *)"r") != 0) {
      IIthidecol(_class,(char *)"i4");
      IItfill();
    } /* IItbinit */
  }
/* # line 1257 "abcreate.qsc" */	/* loadtable */
  {
    if (IItbact(_crselectForm,_useTblFld,1) != 0) {
      IItcoputio((char *)"usage",(short *)0,1,32,0,ERget(FE_Frame));
      IItcoputio((char *)"description",(short *)0,1,32,0,ERget(_FrameDesc));
      IItcoputio((char *)"class",(short *)0,1,30,sizeof(OC_APPLFRAME),
      (void *)IILQint(OC_APPLFRAME));
      IITBceColEnd();
    } /* IItbact */
  }
/* # line 1262 "abcreate.qsc" */	/* loadtable */
  {
    if (IItbact(_crselectForm,_useTblFld,1) != 0) {
      IItcoputio((char *)"usage",(short *)0,1,32,0,ERget(FE_Procedure));
      IItcoputio((char *)"description",(short *)0,1,32,0,ERget(_ProcedureDesc));
      IItcoputio((char *)"class",(short *)0,1,30,sizeof(OC_APPLPROC),
      (void *)IILQint(OC_APPLPROC));
      IITBceColEnd();
    } /* IItbact */
  }
/* # line 1267 "abcreate.qsc" */	/* host code */
/*******
