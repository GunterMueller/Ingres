...
/* # line 134 "ibdoimg.qsc" */	/* forms */
  {
    IIforms(0);
  }
/* # line 136 "ibdoimg.qsc" */	/* host code */
	/*
	...
	for (i = 0; i < rtt->abrofcnt; ++i)
	{
		...
		*/
		if ((fo = (rtt->abroftab)[i].abrform) != NULL)
		{
			...
			/* FElocktag(TRUE); */
/* # line 189 "ibdoimg.qsc" */	/* forminit */
  {
    IIforminit(formname);
  }
/* # line 190 "ibdoimg.qsc" */	/* host code */
			/* FElocktag(FALSE); */
			if (FEinqferr() != 0)
	...
	*/
	...
	EXdelete();
	if	(IIabfmFormsMode == FALSE)
/* # line 236 "ibdoimg.qsc" */	/* endforms */
  {
    IIendforms();
  }
/* # line 237 "ibdoimg.qsc" */	/* host code */
	return OK;
}
/*
...
{
	if	(IIabfmFormsMode == FALSE)
/* # line 250 "ibdoimg.qsc" */	/* endforms */
  {
    IIendforms();
  }
/* # line 251 "ibdoimg.qsc" */	/* host code */
