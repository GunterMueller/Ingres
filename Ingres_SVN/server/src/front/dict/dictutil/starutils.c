...
/* # line 511 "starutils.sc" */	/* commit */
  {
    IIsqInit(&sqlca);
    IIxact(3);
  }
/* # line 513 "starutils.sc" */	/* direct connect */
  {
    IIsqInit(&sqlca);
...
/* # line 521 "starutils.sc" */	/* inquire_ingres */
  {
    IILQisInqSqlio((short *)0,1,30,4,&local_errno,2);
  }
/* # line 522 "starutils.sc" */	/* host code */
	if (local_errno != 0)
	{
	    return (FAIL);
	}
...
{
	STATUS stat = OK;
/* # line 558 "starutils.sc" */	/* direct disconnect */
  {
    IIsqInit(&sqlca);
...
/* # line 560 "starutils.sc" */	/* host code */
...
{
/* # line 597 "starutils.sc" */	/* direct disconnect */
  {
    IIsqInit(&sqlca);
    IIwritio(0,(short *)0,1,32,0,(char *)"direct disconnect");
    IIsyncup((char *)0,0);
  }
/* # line 598 "starutils.sc" */	/* host code */
}
