...
static char	READONLY	Word_ignore_err[] = ERx("IGNORE_NEXT_ERROR");
static char	READONLY	IgnoreAllErrors[] = ERx("ALL");
...
/* # line 216 "dctmdsup.sc" */	/* commit */
  {
    IIsqInit(&sqlca);
    IIxact(3);
  }
/* # line 217 "dctmdsup.sc" */	/* set */
  {
    IIsqInit(&sqlca);
    IIwritio(0,(short *)0,1,32,0,(char *)"set AUTOCOMMIT on");
    IIsyncup((char *)0,0);
  }
/* # line 218 "dctmdsup.sc" */	/* host code */
    }
...
/* # line 479 "dctmdsup.sc" */	/* inquire_ingres */
  {
    IILQisInqSqlio((short *)0,1,30,4,&local_errno,2);
    IILQisInqSqlio((short *)0,1,32,256,errtext,63);
  }
/* # line 481 "dctmdsup.sc" */	/* host code */
	    if (local_errno != 0)
	    {
	...
	** TABLE statements for on the CDB (we're connected to the CDB).
    ...
    if (stat == OK)
    {
/* # line 507 "dctmdsup.sc" */	/* commit */
  {
    IIsqInit(&sqlca);
    IIxact(3);
  }
/* # line 508 "dctmdsup.sc" */	/* host code */
    }
    return (stat);
}
/*{
...
/* # line 944 "dctmdsup.sc" */	/* repeated select */
  {
    IIsexec();
    while (IInexec() == 0) {
      IIsqInit(&sqlca);
      IIexExec(1,(char *)"dctmdsup1",7042,7384);
      IIputdomio((short *)0,1,32,0,cap_capability);
      IIretinit((char *)0,0);
      if (IInexec() == 0) {
        IIsqInit(&sqlca);
        IIsqMods(1);
        IIexDefine(1,(char *)"dctmdsup1",7042,7384);
        IIwritio(0,(short *)0,1,32,0,(char *)
"select cap_value from iidbcapabilities where cap_capability=");
        IIwritio(0,(short *)0,1,32,0,(char *)" $0=");
        IIputdomio((short *)0,1,32,0,cap_capability);
        IIexDefine(0,(char *)"dctmdsup1",7042,7384);
        if (IIerrtest() == 0) {
          IIsexec();
        } /* IIerrtest */
      } /* IInexec */
    ...
    if (IInextget() != 0) {
      IIgetdomio((short *)0,1,32,FE_MAXNAME +1-1,db_type_str);
    } /* IInextget */
    IIsqFlush((char *)0,0);
  }
/* # line 952 "dctmdsup.sc" */	/* inquire_ingres */
  {
    IILQisInqSqlio((short *)0,1,30,4,&local_errno,2);
    IILQisInqSqlio((short *)0,1,32,256,errtext,63);
  }
/* # line 953 "dctmdsup.sc" */	/* host code */
...
/* # line 1103 "dctmdsup.sc" */	/* host code */
    if(sqlca.sqlcode != 0)
    {
	return (FAIL);
    }
