...
//
// SQL Assistant
LPTSTR CreateSelectStmWizard(HWND hwndOwner, LPTSTR lpszNode, LPTSTR lpszDatabase);
LPTSTR CreateSQLWizard (HWND hwndOwner, LPTSTR lpszNode, LPTSTR lpszDatabase);
LPTSTR CreateSearchCondWizard(HWND hwndOwner, LPTSTR lpszNode, LPTSTR lpszDatabase, TOBJECTLIST* lpTableList, TOBJECTLIST* pListCol);
