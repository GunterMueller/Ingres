  ...
  LPCHKPT lpchk = GetDlgProp(hwnd);
   ...
   switch (id)
   {
     case IDOK:
     {
       ...
       //HWND hwndDelete = GetDlgItem(hwnd, IDC_CHKPOINT_DELETEPREV);
       //HWND hwndExclusive = GetDlgItem(hwnd, IDC_CHKPOINT_XLOCK);
       //HWND hwndEnable = GetDlgItem(hwnd, IDC_CHKPOINT_EJOURNALING);
       //HWND hwndWait = GetDlgItem(hwnd, IDC_CHKPOINT_WAIT);
