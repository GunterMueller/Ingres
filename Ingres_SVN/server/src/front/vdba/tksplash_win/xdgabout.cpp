...
#define EDIT_X         104     // 84 + 20
#define EDIT_Y          74     // 20 + 34 + 20

// Copyright height.
#define EDIT_HEIGHT    178     // ABOUT_HEIGHT - EDIT_Y - 20 - BUTTON_HEIGHT - 20 - BUTTON_HEIGHT - 20
...
BOOL CxDlgAbout::OnInitDialog() 
{
	...
	lstrcpy(lf.lfFaceName, _T("Tahoma"));  // with face name "Tahoma".
	...
	strCopyright = m_strProductVersion + _T("\r\n");
