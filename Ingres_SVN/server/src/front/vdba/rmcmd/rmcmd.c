	       ...
	       const char *usrbuf )
{
    ...
    */
    status = SYS$GETJPIW( 0, NULL, NULL, itmlst, &iosb, NULL, NULL );
    if ( status & 1 ) 
	...
	status = SYS$QIOW( 0, term_chan, IO$_WRITEVBLK | IO$M_NOW, &iosb,
 ...
 ** the same logic here:
 **/
	status = SYS$GETJPIW( 0, 0, 0, &jpigetpid, &iosb, 0, 0 );
	...
	status = SYS$GETJPIW( 0, &procid, 0, &jpigetnam, &iosb, 0, 0 );
	if ( status != SS$_NORMAL || iosb.iosb$w_status !=SS$_NORMAL ) {
            if ( iosb.iosb$w_status != SS$_NORMAL )
                status = iosb.iosb$w_status;
	...
	if ( STbcompare( procname, 0, thisproc, 0, TRUE) != 0 )
	    ...
	    ** already running by scanning for procname prefix and group 
            ...
            */
	    status = SYS$GETJPIW(0,0,0,&jpigetpid[1],&iosb,0,0);
	    ...
	    status = SYS$GETJPIW(0,&context,0,&jpigetnam,&iosb,0,0);
...
#define SET_COM_PATH_CMD 4	/* (cmd to be modified before use) */
		...
		*(ii_system + STlength( ii_system ) - 1) = '\0';
		...
		for ( i = 0; start_commands[i] != NULL; i++ )
		{
		      ...
		      status = SYS$QIOW( 0, chan, IO$_WRITEVBLK|IO$M_NOW,
				         &iosb, NULL, NULL,
...
/* # line 2159 "rmcmd.sc" */	/* host code */
	if (sqlca.sqlcode < 0) 
#ifdef VMS
        {
/* # line 2162 "rmcmd.sc" */	/* set_sql */
  {
    IILQssSetSqlio(11,(short *)0,1,30,sizeof(1),(void *)IILQint(1));
  }
/* # line 2163 "rmcmd.sc" */	/* disconnect */
  {
    IIsqInit(&sqlca);
    IIsqDisconnect();
  }
/* # line 2164 "rmcmd.sc" */	/* host code */
	    return (DAEMON_FAILED_NO_IIDBDB);
        }
#else
	{
...
#endif /* VMS */
/* # line 2173 "rmcmd.sc" */	/* set_sql */
  {
    IILQssSetSqlio(3,(short *)0,1,32,0,(char *)"genericerror");
  }
/* # line 2175 "rmcmd.sc" */	/* host code */
    /* create rmcmdstpnode event to shut down specific node */
/* # line 2176 "rmcmd.sc" */	/* create dbevent */
  {
    IIsqInit(&sqlca);
    IIwritio(0,(short *)0,1,32,0,(char *)"create dbevent rmcmdstpnode");
    IIsyncup((char *)0,0);
  }
/* # line 2177 "rmcmd.sc" */	/* host code */
    if (sqlca.sqlcode < 0 && sqlca.sqlcode != -30200)
    {
 #ifdef VMS
/* # line 2180 "rmcmd.sc" */	/* disconnect */
  {
    IIsqInit(&sqlca);
    IIsqDisconnect();
  }
/* # line 2181 "rmcmd.sc" */	/* set_sql */
  {
    IILQssSetSqlio(11,(short *)0,1,30,sizeof(1),(void *)IILQint(1));
  }
/* # line 2182 "rmcmd.sc" */	/* disconnect */
  {
    IIsqInit(&sqlca);
    IIsqDisconnect();
  }
/* # line 2183 "rmcmd.sc" */	/* host code */
...
/* # line 2191 "rmcmd.sc" */	/* create table */
  {
    IIsqInit(&sqlca);
    IIwritio(0,(short *)0,1,32,0,(char *)
"create table remotecmdlock(holder int)");
    IIsyncup((char *)0,0);
  }
/* # line 2192 "rmcmd.sc" */	/* host code */
   if (sqlca.sqlcode < 0 && sqlca.sqlcode != -30200)
   {
#ifdef VMS
/* # line 2195 "rmcmd.sc" */	/* disconnect */
  {
    IIsqInit(&sqlca);
    IIsqDisconnect();
  }
/* # line 2196 "rmcmd.sc" */	/* set_sql */
  {
    IILQssSetSqlio(11,(short *)0,1,30,sizeof(1),(void *)IILQint(1));
  }
/* # line 2197 "rmcmd.sc" */	/* disconnect */
  {
    IIsqInit(&sqlca);
    IIsqDisconnect();
  }
/* # line 2198 "rmcmd.sc" */	/* host code */
	return (DAEMON_FAILED_NO_TABLES);
#else
	log_message(E_RE0006_STARTUP_RMCMD_OBJ, 1);
	goto end;
...
/* # line 2206 "rmcmd.sc" */	/* commit */
  {
    IIsqInit(&sqlca);
    IIxact(3);
  }
/* # line 2207 "rmcmd.sc" */	/* set */
  {
    IIsqInit(&sqlca);
    IIwritio(0,(short *)0,1,32,0,(char *)
"set lockmode on remotecmdlock where level=table, readlock=exclusive, \
timeout=nowait");
    IIsyncup((char *)0,0);
  }
/* # line 2208 "rmcmd.sc" */	/* set_sql */
  {
    IILQssSetSqlio(11,(short *)0,1,30,sizeof(1),(void *)IILQint(1));
  }
/* # line 2211 "rmcmd.sc" */	/* set */
  {
    IIsqInit(&sqlca);
    IIwritio(0,(short *)0,1,32,0,(char *)
"set lockmode session where readlock=exclusive");
...
/* # line 2214 "rmcmd.sc" */	/* host code */
    if (sqlca.sqlcode < 0) 
#ifdef VMS
    {
/* # line 2217 "rmcmd.sc" */	/* disconnect */
  {
    IIsqInit(&sqlca);
    IIsqDisconnect();
  }
/* # line 2218 "rmcmd.sc" */	/* host code */
       return (DAEMON_FAILED_NO_IIDBDB);
    }
#else
    {
    ...
    */
/* # line 2230 "rmcmd.sc" */	/* select */
  {
    IIsqInit(&sqlca);
    IIsqMods(1);
    IIwritio(0,(short *)0,1,32,0,(char *)"select count(*)from remotecm\
d");
    IIretinit((char *)0,0);
    if (IInextget() != 0) {
      IIgetdomio((short *)0,1,30,4,&hdl);
    } /* IInextget */
    IIsqFlush((char *)0,0);
  }
/* # line 2231 "rmcmd.sc" */	/* host code */
    if (sqlca.sqlcode < 0) 
    {
#ifdef VMS
/* # line 2234 "rmcmd.sc" */	/* disconnect */
  {
    IIsqInit(&sqlca);
    IIsqDisconnect();
  }
/* # line 2235 "rmcmd.sc" */	/* host code */
	return (DAEMON_FAILED_NO_TABLES);
#else
	log_message(E_RE0006_STARTUP_RMCMD_OBJ, 1);
	goto end;
...
/* # line 2244 "rmcmd.sc" */	/* execute */
  {
    IIsqInit(&sqlca);
    IIsqExImmed(stmt);
    IIsyncup((char *)0,0);
  }
/* # line 2246 "rmcmd.sc" */	/* host code */
    if (sqlca.sqlcode < 0) 
    {
#ifdef VMS
/* # line 2249 "rmcmd.sc" */	/* disconnect */
  {
    IIsqInit(&sqlca);
    IIsqDisconnect();
  }
/* # line 2250 "rmcmd.sc" */	/* host code */
...
/* # line 2258 "rmcmd.sc" */	/* execute */
  {
    IIsqInit(&sqlca);
    IIsqExImmed(stmt);
    IIsyncup((char *)0,0);
  }
/* # line 2259 "rmcmd.sc" */	/* host code */
    if (sqlca.sqlcode < 0) 
    {
#ifdef VMS
/* # line 2262 "rmcmd.sc" */	/* disconnect */
  {
    IIsqInit(&sqlca);
    IIsqDisconnect();
  }
/* # line 2263 "rmcmd.sc" */	/* host code */
	return (DAEMON_FAILED_NO_TABLES); /* TO DO : differentiate this specific error under VMS */
#else
...
/* # line 2271 "rmcmd.sc" */	/* execute */
  {
    IIsqInit(&sqlca);
    IIsqExImmed(stmt);
    IIsyncup((char *)0,0);
  }
/* # line 2272 "rmcmd.sc" */	/* host code */
    if (sqlca.sqlcode < 0) 
    {
#ifdef VMS
/* # line 2275 "rmcmd.sc" */	/* disconnect */
  {
    IIsqInit(&sqlca);
    IIsqDisconnect();
  }
/* # line 2276 "rmcmd.sc" */	/* host code */
	return (DAEMON_FAILED_NO_TABLES); /* TO DO : differentiate this specific error under VMS */
#else
	log_message(E_RE0008_STARTUP_DBEVNT_STP, 1);
	goto end;
...
/* # line 2289 "rmcmd.sc" */	/* delete */
  {
    IIsqInit(&sqlca);
    IIwritio(0,(short *)0,1,32,0,(char *)
"delete from remotecmd where status=");
    IIputdomio((short *)0,1,30,4,&status1);
    IIsyncup((char *)0,0);
  }
/* # line 2290 "rmcmd.sc" */	/* delete */
  {
    IIsqInit(&sqlca);
    IIwritio(0,(short *)0,1,32,0,(char *)
"delete from remotecmd where cmd1 like 'rmcmdstpnode%'");
    IIsyncup((char *)0,0);
  }
/* # line 2291 "rmcmd.sc" */	/* commit */
  {
    IIsqInit(&sqlca);
    IIxact(3);
  }
/* # line 2293 "rmcmd.sc" */	/* host code */
    if (sqlca.sqlcode < 0) 
    {
/* # line 2295 "rmcmd.sc" */	/* disconnect */
  {
    IIsqInit(&sqlca);
    IIsqDisconnect();
  }
/* # line 2296 "rmcmd.sc" */	/* host code */
    ...
    */
    ...
    if ( (status & 1) == 0 )
    {
/* # line 2311 "rmcmd.sc" */	/* disconnect */
  {
    IIsqInit(&sqlca);
    IIsqDisconnect();
  }
/* # line 2312 "rmcmd.sc" */	/* host code */
	return ( status );
    }
    status = SYS$SETEF( success_efn );
    if ( (status & 1) == 0 )
    {
/* # line 2317 "rmcmd.sc" */	/* disconnect */
  {
    IIsqInit(&sqlca);
    IIsqDisconnect();
  }
/* # line 2318 "rmcmd.sc" */	/* host code */
	return ( status );
    }
	...
	if (!master)
	{
/* # line 2335 "rmcmd.sc" */	/* set_sql */
  {
    IILQssSetSqlio(11,(short *)0,1,30,sizeof(3),(void *)IILQint(3));
  }
/* # line 2336 "rmcmd.sc" */	/* select */
  {
    IIsqInit(&sqlca);
    IIsqMods(1);
    IIwritio(0,(short *)0,1,32,0,(char *)"select * from remotecmdlock");
    IIretinit((char *)0,0);
    if (IInextget() != 0) {
      IIgetdomio((short *)0,1,30,4,&hdl);
    } /* IInextget */
...
/* # line 2337 "rmcmd.sc" */	/* host code */
	    if (sqlca.sqlcode >= 0)
	    {
		/* got exclusive lock on remotecmdlock, now master */
		master = 1;
	    }
/* # line 2342 "rmcmd.sc" */	/* set_sql */
  {
    IILQssSetSqlio(11,(short *)0,1,30,sizeof(1),(void *)IILQint(1));
  }
/* # line 2343 "rmcmd.sc" */	/* host code */
	}
	if (master)
	{
        hdl = -1;
...
/* # line 2352 "rmcmd.sc" */	/* update */
  {
    IIsqInit(&sqlca);
    IIwritio(0,(short *)0,1,32,0,(char *)"update remotecmd set status=");
    IIputdomio((short *)0,1,30,4,&status2);
    IIwritio(0,(short *)0,1,32,0,(char *)"where status=");
    IIputdomio((short *)0,1,30,4,&status1);
    IIsyncup((char *)0,0);
  }
/* # line 2355 "rmcmd.sc" */	/* host code */
#ifndef VMS  /* porting to VMS needed */
	if (sqlca.sqlcode < 0) 
	{
...
#endif  /* VMS */
/* # line 2363 "rmcmd.sc" */	/* select */
  {
    IIsqInit(&sqlca);
    IIsqMods(1);
    IIwritio(0,(short *)0,1,32,0,(char *)
"select handle, cmd1, user_id from remotecmd where status=");
    IIputdomio((short *)0,1,30,4,&status2);
    IIwritio(0,(short *)0,1,32,0,(char *)
"and handle=(select min(handle)from remotecmd where status=");
    IIputdomio((short *)0,1,30,4,&status2);
    IIwritio(0,(short *)0,1,32,0,(char *)")");
    IIretinit((char *)0,0);
    if (IInextget() != 0) {
      IIgetdomio((short *)0,1,30,4,&hdl);
      IIgetdomio((short *)0,1,32,3999,szCommand);
      IIgetdomio((short *)0,1,32,99,username);
    } /* IInextget */
    IIsqFlush((char *)0,0);
  }
/* # line 2367 "rmcmd.sc" */	/* host code */
	if (sqlca.sqlcode < 0) 
	{
#ifndef VMS  /* porting to VMS needed */
...
/* # line 2459 "rmcmd.sc" */	/* update */
  {
    IIsqInit(&sqlca);
    IIwritio(0,(short *)0,1,32,0,(char *)"update remotecmd set status=");
    IIputdomio((short *)0,1,30,4,&status1);
    IIwritio(0,(short *)0,1,32,0,(char *)"where handle=");
    IIputdomio((short *)0,1,30,4,&hdl);
    IIsyncup((char *)0,0);
  }
/* # line 2462 "rmcmd.sc" */	/* commit */
  {
    IIsqInit(&sqlca);
    IIxact(3);
  }
/* # line 2463 "rmcmd.sc" */	/* host code */
            status2 = status1;
	    if (sqlca.sqlcode < 0) 
	    {
#ifndef VMS  /* porting to VMS needed */
...
/* # line 2735 "rmcmd.sc" */	/* commit */
  {
    IIsqInit(&sqlca);
    IIxact(3);
  }
/* # line 2736 "rmcmd.sc" */	/* host code */
#ifndef VMS  /* porting to VMS needed */
...
/* # line 2835 "rmcmd.sc" */	/* commit */
  {
    IIsqInit(&sqlca);
    IIxact(3);
  }
/* # line 2836 "rmcmd.sc" */	/* host code */
            status2 = status1;
	    if (sqlca.sqlcode < 0) 
	    {
		log_message(E_RE000A_DAEMON_UPDATE_FAIL, 1);
...
/* # line 2973 "rmcmd.sc" */	/* commit */
  {
    IIsqInit(&sqlca);
    IIxact(3);
  }
/* # line 2974 "rmcmd.sc" */	/* host code */
			if (sqlca.sqlcode < 0) 
			{
			    log_message(E_RE000D_DAEMON_STATUS_UPDATE, 1);
			    goto end;
        ...
        else
        {
            status1=RMCMDSTATUS_REQUEST4TERMINATE;
            hdl = -1;
/* # line 2989 "rmcmd.sc" */	/* select */
  {
    IIsqInit(&sqlca);
    IIsqMods(1);
    IIwritio(0,(short *)0,1,32,0,(char *)
"select status from remotecmd where status=");
    IIputdomio((short *)0,1,30,4,&status1);
    IIretinit((char *)0,0);
    if (IInextget() != 0) {
      IIgetdomio((short *)0,1,30,4,&hdl);
...
/* # line 2993 "rmcmd.sc" */	/* commit */
  {
    IIsqInit(&sqlca);
    IIxact(3);
  }
/* # line 2995 "rmcmd.sc" */	/* host code */
	    if (sqlca.sqlcode < 0) 
	    {
#ifndef VMS  /* porting to VMS needed */
		log_message(E_RE000B_DAEMON_READ_FAIL, 1);
		...
		goto end;
            ...
            if (hdl >= 0)
            {
/* # line 3005 "rmcmd.sc" */	/* raise dbevent */
  {
    IIsqInit(&sqlca);
    IIwritio(0,(short *)0,1,32,0,(char *)"raise dbevent rmcmdstpnode");
    IIsyncup((char *)0,0);
  }
/* # line 3006 "rmcmd.sc" */	/* host code */
		if (sqlca.sqlcode < 0) 
		{
#ifndef VMS  /* porting to VMS needed */
		    log_message(E_RE000B_DAEMON_READ_FAIL, 1);
...
#define H_NB_LOOP ( H_TOTAL_MS / H_LOOP_MS)
	...
	{
/* # line 3041 "rmcmd.sc" */	/* get dbevent */
  {
    IIsqInit(&sqlca);
    IILQesEvStat(0,0);
    if (sqlca.sqlcode < 0) 
...
/* # line 3042 "rmcmd.sc" */	/* inquire_sql */
  {
    IILQisInqSqlio((short *)0,1,32,2047,stmt,74);
  }
/* # line 3043 "rmcmd.sc" */	/* host code */
		if (stmt[0]==EOS)
		{
			i4HighReactivity --;
			Sleep(H_LOOP_MS);
	...
	{
/* # line 3055 "rmcmd.sc" */	/* get dbevent */
  {
    IIsqInit(&sqlca);
    IILQesEvStat(0,1);
    if (sqlca.sqlcode < 0) 
...
/* # line 3056 "rmcmd.sc" */	/* inquire_sql */
  {
    IILQisInqSqlio((short *)0,1,32,2047,stmt,74);
  }
/* # line 3057 "rmcmd.sc" */	/* host code */
		if (stmt[0]!=EOS)
			i4HighReactivity = H_NB_LOOP;
	}
#else
/* # line 3061 "rmcmd.sc" */	/* get dbevent */
  {
    IIsqInit(&sqlca);
    IILQesEvStat(0,1);
    if (sqlca.sqlcode < 0) 
...
/* # line 3062 "rmcmd.sc" */	/* inquire_sql */
  {
    IILQisInqSqlio((short *)0,1,32,2047,stmt,74);
  }
/* # line 3063 "rmcmd.sc" */	/* host code */
#endif
	/* node stop event */
	if ( !MEcmp( stmt, rmcmdstpnode, STlength(rmcmdstpnode) ) )
	{
	    i4 node_arg;
/* # line 3069 "rmcmd.sc" */	/* inquire_sql */
  {
    IILQisInqSqlio((short *)0,1,32,2047,stmt,78);
  }
/* # line 3070 "rmcmd.sc" */	/* host code */
	    CVal(stmt, &node_arg);
...
/* # line 3091 "rmcmd.sc" */	/* commit */
  {
    IIsqInit(&sqlca);
    IIxact(3);
  }
/* # line 3092 "rmcmd.sc" */	/* disconnect */
  {
    IIsqInit(&sqlca);
    IIsqDisconnect();
  }
/* # line 3094 "rmcmd.sc" */	/* host code */
...
{
   iRMOutputLine++;
/* # line 3133 "rmcmd.sc" */	/* insert */
  {
    IIsqInit(&sqlca);
    IIwritio(0,(short *)0,1,32,0,(char *)"insert into remotecmdout val\
ues(");
    IIputdomio((short *)0,1,30,4,&iqHdl);
    IIwritio(0,(short *)0,1,32,0,(char *)", ");
    IIputdomio((short *)0,1,30,4,&iRMOutputLine);
    IIwritio(0,(short *)0,1,32,0,(char *)", ");
    IIputdomio((short *)0,1,32,0,buf_userid);
    IIwritio(0,(short *)0,1,32,0,(char *)", ");
    IIputdomio((short *)0,1,32,0,buf_sessionid);
    IIwritio(0,(short *)0,1,32,0,(char *)", ");
    IIputdomio((short *)0,1,32,0,buf);
    IIwritio(0,(short *)0,1,32,0,(char *)", 'N')");
    IIsyncup((char *)0,0);
  }
/* # line 3135 "rmcmd.sc" */	/* host code */
#ifndef VMS  /* porting to VMS needed */
   if (sqlca.sqlcode < 0) 
...
/* # line 3154 "rmcmd.sc" */	/* raise dbevent */
  {
    IIsqInit(&sqlca);
    IIwritio(0,(short *)0,1,32,0,(char *)"raise dbevent rmcmdcmdend");
    IIsyncup((char *)0,0);
  }
/* # line 3155 "rmcmd.sc" */	/* commit */
  {
    IIsqInit(&sqlca);
    IIxact(3);
  }
/* # line 3156 "rmcmd.sc" */	/* host code */
#ifndef VMS  /* porting to VMS needed */
  if (sqlca.sqlcode < 0) 
	log_message(E_RE000A_DAEMON_UPDATE_FAIL, 1);
#endif  /* VMS */
...
/* # line 3174 "rmcmd.sc" */	/* connect */
  {
    IIsqInit(&sqlca);
    IILQsidSessID(2);
    IIsqConnect(0,connectionname,(char *)0, (char *)0, (char *)0, (char *)0, 
    (char *)0, (char *)0, (char *)0, (char *)0, (char *)0, (char *)0, 
    (char *)0, (char *)0, (char *)0);
    if (sqlca.sqlcode < 0) 
      goto er1;
  }
/* # line 3175 "rmcmd.sc" */	/* select */
  {
    IIsqInit(&sqlca);
    IIsqMods(1);
    IIwritio(0,(short *)0,1,32,0,(char *)
"select count(*)from iitables where LOWERCASE(table_name)='dd_cdds'");
    IIretinit((char *)0,0);
    if (IInextget() != 0) {
      IIgetdomio((short *)0,1,30,4,&icnt);
    } /* IInextget */
    IIsqFlush((char *)0,0);
    if (sqlca.sqlcode < 0) 
      goto er1;
  }
/* # line 3176 "rmcmd.sc" */	/* commit */
  {
    IIsqInit(&sqlca);
    IIxact(3);
    if (sqlca.sqlcode < 0) 
...
/* # line 3178 "rmcmd.sc" */	/* set_sql */
  {
    IILQssSetSqlio(11,(short *)0,1,30,sizeof(1),(void *)IILQint(1));
  }
/* # line 3180 "rmcmd.sc" */	/* host code */
	if (icnt>0)
		return TRUE;
	else
		return FALSE;
er1:
/* # line 3185 "rmcmd.sc" */	/* set_sql */
  {
    IILQssSetSqlio(11,(short *)0,1,30,sizeof(1),(void *)IILQint(1));
  }
/* # line 3186 "rmcmd.sc" */	/* host code */
...
{
	bool bResult = TRUE;
/* # line 3193 "rmcmd.sc" */	/* connect */
  {
    IIsqInit(&sqlca);
    IILQsidSessID(2);
    IIsqConnect(0,(char *)"iidbdb/ingres",(char *)0, (char *)0, (char *)0, 
    (char *)0, (char *)0, (char *)0, (char *)0, (char *)0, (char *)0, 
    (char *)0, (char *)0, (char *)0, (char *)0);
  }
/* # line 3194 "rmcmd.sc" */	/* host code */
	if (sqlca.sqlcode <0) {
/* # line 3195 "rmcmd.sc" */	/* set_sql */
  {
    IILQssSetSqlio(11,(short *)0,1,30,sizeof(1),(void *)IILQint(1));
  }
/* # line 3196 "rmcmd.sc" */	/* host code */
		bResult = FALSE;
	}
	return bResult;
} 
...
{
	BOOL bResult = TRUE;
/* # line 3203 "rmcmd.sc" */	/* disconnect */
  {
    IIsqInit(&sqlca);
    IIsqDisconnect();
  }
/* # line 3204 "rmcmd.sc" */	/* host code */
	if (sqlca.sqlcode<0)
		bResult = FALSE;
/* # line 3206 "rmcmd.sc" */	/* set_sql */
  {
    IILQssSetSqlio(11,(short *)0,1,30,sizeof(1),(void *)IILQint(1));
  }
/* # line 3207 "rmcmd.sc" */	/* host code */
	if (sqlca.sqlcode<0)
		bResult = FALSE;
	return bResult;
}	  
...
"select user_id, session_id from remotecmd where handle=");
    ...
    IIretinit((char *)0,0);
    if (IInextget() != 0) {
      IIgetdomio((short *)0,1,32,99,buf_userid);
      IIgetdomio((short *)0,1,32,99,buf_sessionid);
    } /* IInextget */
    IIsqFlush((char *)0,0);
  }
/* # line 3241 "rmcmd.sc" */	/* host code */
   if (sqlca.sqlcode < 0)  {
...
/* # line 3262 "rmcmd.sc" */	/* commit */
  {
    IIsqInit(&sqlca);
    IIxact(3);
  }
/* # line 3263 "rmcmd.sc" */	/* host code */
		AddLine("* dddispf: Failure in executing command");
		TerminateQuickCmd();
		return;
    }
/* # line 3267 "rmcmd.sc" */	/* select */
  {
    IIsqInit(&sqlca);
    IIsqMods(1);
    IIwritio(0,(short *)0,1,32,0,(char *)
"select own from iidatabase where name=");
    ...
    IIretinit((char *)0,0);
    if (IInextget() != 0) {
      IIgetdomio((short *)0,1,32,99,dbaname);
    } /* IInextget */
    IIsqFlush((char *)0,0);
  }
/* # line 3268 "rmcmd.sc" */	/* inquire_sql */
  {
    IILQisInqSqlio((short *)0,1,30,4,&error_no,2);
    IILQisInqSqlio((short *)0,1,32,256,error_text,63);
  }
/* # line 3269 "rmcmd.sc" */	/* host code */
    if (! RestoreMainSession()) {
/* # line 3270 "rmcmd.sc" */	/* commit */
  {
    IIsqInit(&sqlca);
    IIxact(3);
  }
/* # line 3271 "rmcmd.sc" */	/* host code */
		AddLine("* dddispf: Failure in executing command");
		TerminateQuickCmd();
		return;
    }
	if (error_no)   {
/* # line 3277 "rmcmd.sc" */	/* commit */
  {
    IIsqInit(&sqlca);
    IIxact(3);
  }
/* # line 3278 "rmcmd.sc" */	/* host code */
		AddLine("* dddispf: Failure in executing command");
		TerminateQuickCmd();
		return;
    }
...
/* # line 3420 "rmcmd.sc" */	/* host code */
   ...
   iRMInputLine  = -1;
    ...
    STcopy(lpwords[1],dbname);
    if (! switch2iidbdbsession()) {
/* # line 3443 "rmcmd.sc" */	/* commit */
  {
    IIsqInit(&sqlca);
    IIxact(3);
  }
/* # line 3444 "rmcmd.sc" */	/* host code */
		AddLine(ERx("* ddstoref: Failure in executing command"));
		TerminateQuickCmd();
		return;
    }
/* # line 3448 "rmcmd.sc" */	/* select */
  {
    IIsqInit(&sqlca);
    IIsqMods(1);
    IIwritio(0,(short *)0,1,32,0,(char *)
...
/* # line 3449 "rmcmd.sc" */	/* inquire_sql */
  {
    IILQisInqSqlio((short *)0,1,30,4,&error_no,2);
    IILQisInqSqlio((short *)0,1,32,256,error_text,63);
  }
/* # line 3450 "rmcmd.sc" */	/* host code */
    if (! RestoreMainSession()) {
/* # line 3451 "rmcmd.sc" */	/* commit */
  {
    IIsqInit(&sqlca);
    IIxact(3);
  }
/* # line 3452 "rmcmd.sc" */	/* host code */
		AddLine(ERx("* ddstoref: Failure in executing command"));
		TerminateQuickCmd();
		return;
    }
	if (error_no)   {
/* # line 3457 "rmcmd.sc" */	/* commit */
  {
    IIsqInit(&sqlca);
    IIxact(3);
  }
/* # line 3458 "rmcmd.sc" */	/* host code */
		AddLine(ERx("* ddstoref: Failure in executing command"));
		TerminateQuickCmd();
		return;
    }
...
"select orderno, instring from remotecmdin where handle=");
    ...
    IIputdomio((short *)0,1,30,4,&iRMInputLine);
...
IIrtB1:
    while (IInextget() != 0) {
      ...
      IIgetdomio((short *)0,1,32,0,buf);
      if (IIerrtest() != 0) goto IIrtB1;
/* # line 3536 "rmcmd.sc" */	/* host code */
        if (ordno>=0) {
           iRMInputLine++;
	   ...
	   if (!STlength(buf))
           {
			  bDone=TRUE;
/* # line 3548 "rmcmd.sc" */	/* endselect */
      {
        IIbreak();
        if (1) goto IIrtE1;
      }
/* # line 3549 "rmcmd.sc" */	/* host code */
	   }
    	   SIfprintf(fp,ERx("%s\n"),buf);
	   SIflush(fp);
       }
...
/* # line 3562 "rmcmd.sc" */	/* commit */
  {
    IIsqInit(&sqlca);
    IIxact(3);
  }
/* # line 3563 "rmcmd.sc" */	/* host code */
	   if (bDone)
	      break;
    }
	SIclose(fp);
...
/* # line 3605 "rmcmd.sc" */	/* host code */
   ...
   if (LOgt(curpath, &curloc)!=OK) {
	...
	if ( STbcompare(buf_userid, 0, RmcmdStartUser,0,TRUE)) { /* if user not the same user that was launched rmcmd process, perform additional checks */
		...
		if (! switch2iidbdbsession()) {
/* # line 3737 "rmcmd.sc" */	/* commit */
  {
    IIsqInit(&sqlca);
    IIxact(3);
  }
/* # line 3738 "rmcmd.sc" */	/* host code */
		    AddLine("* dddispf: Failure in getting localDB owner");
			TerminateQuickCmd();
			return TRUE;
		}
/* # line 3742 "rmcmd.sc" */	/* select */
  {
    IIsqInit(&sqlca);
    IIsqMods(1);
    IIwritio(0,(short *)0,1,32,0,(char *)
...
/* # line 3743 "rmcmd.sc" */	/* inquire_sql */
  {
    IILQisInqSqlio((short *)0,1,30,4,&error_no,2);
    IILQisInqSqlio((short *)0,1,32,256,error_text,63);
  }
/* # line 3744 "rmcmd.sc" */	/* host code */
		if (! RestoreMainSession()) {
/* # line 3745 "rmcmd.sc" */	/* commit */
  {
    IIsqInit(&sqlca);
    IIxact(3);
  }
/* # line 3746 "rmcmd.sc" */	/* host code */
		    AddLine("* dddispf: Failure in getting localDB owner");
			TerminateQuickCmd();
			return TRUE;
		}
	    if (error_no)   {
/* # line 3751 "rmcmd.sc" */	/* commit */
  {
    IIsqInit(&sqlca);
    IIxact(3);
  }
/* # line 3752 "rmcmd.sc" */	/* host code */
		    AddLine("* dddispf: Failure in getting localDB owner");
		    TerminateQuickCmd();
		    return TRUE;
        }
...
/* # line 3858 "rmcmd.sc" */	/* execute */
  {
    IIsqInit(&sqlca);
    IIsqExImmed(stopstmt);
    IIsyncup((char *)0,0);
  }
/* # line 3860 "rmcmd.sc" */	/* host code */
    iqHdl = hdl;
/* # line 3862 "rmcmd.sc" */	/* delete */
  {
    IIsqInit(&sqlca);
    IIwritio(0,(short *)0,1,32,0,(char *)
"delete from remotecmd where handle=");
    IIputdomio((short *)0,1,30,4,&iqHdl);
    IIsyncup((char *)0,0);
  }
/* # line 3863 "rmcmd.sc" */	/* commit */
  {
    IIsqInit(&sqlca);
    IIxact(3);
  }
/* # line 3865 "rmcmd.sc" */	/* host code */
    return TRUE;
}
/*
**  Name: log_message
