...
/* # line 275 "rmcmdstp.sc" */	/* host code */
...
/* # line 286 "rmcmdstp.sc" */	/* select */
  {
    IIsqInit(&sqlca);
    IIsqMods(1);
    IIwritio(0,(short *)0,1,32,0,(char *)
"select count(*)from iirelation where relid in('remotecmd', 'REMOTECMD\
')");
    IIretinit((char *)0,0);
    if (IInextget() != 0) {
      IIgetdomio((short *)0,1,30,4,&no_remotecmds);
    } /* IInextget */
    IIsqFlush((char *)0,0);
  }
/* # line 289 "rmcmdstp.sc" */	/* host code */
    if (no_remotecmds > 1)
    {
...
/* # line 309 "rmcmdstp.sc" */	/* select */
  {
    IIsqInit(&sqlca);
    IIsqMods(1);
    IIwritio(0,(short *)0,1,32,0,(char *)
"select relowner from iirelation where relid in('remotecmd', 'REMOTECM\
D')");
    IIretinit((char *)0,0);
    if (IInextget() != 0) {
      IIgetdomio((short *)0,1,32,39,tbl_owner);
    } /* IInextget */
    IIsqFlush((char *)0,0);
  }
/* # line 312 "rmcmdstp.sc" */	/* host code */
           STtrmwhite(tbl_owner);
           if (STcasecmp(userid, tbl_owner) != 0)
           {
              /* Need to connect as a different user */
/* # line 318 "rmcmdstp.sc" */	/* disconnect */
  {
    IIsqInit(&sqlca);
    IIsqDisconnect();
  }
/* # line 320 "rmcmdstp.sc" */	/* connect */
  {
    IIsqInit(&sqlca);
    IIsqUser(tbl_owner);
    IIsqConnect(0,(char *)"imadb/ingres",(char *)0, (char *)0, (char *)0, 
...
/* # line 322 "rmcmdstp.sc" */	/* host code */
              if (sqlca.sqlcode !=0)
              {
        ...
        handle_val = -1;
/* # line 334 "rmcmdstp.sc" */	/* select */
  {
    IIsqInit(&sqlca);
    IIsqMods(1);
    IIwritio(0,(short *)0,1,32,0,(char *)"select max(handle)from remot\
ecmd");
    IIretinit((char *)0,0);
    if (IInextget() != 0) {
      IIgetdomio((short *)0,1,30,4,&handle_val);
    } /* IInextget */
    IIsqFlush((char *)0,0);
  }
/* # line 335 "rmcmdstp.sc" */	/* host code */
...
/* # line 343 "rmcmdstp.sc" */	/* insert */
  {
    IIsqInit(&sqlca);
    IIwritio(0,(short *)0,1,32,0,(char *)
"insert into remotecmd(handle, status, user_id, session_id, cmd1)value\
s(");
    IIputdomio((short *)0,1,30,4,&handle_val);
    IIwritio(0,(short *)0,1,32,0,(char *)", ");
    IIputdomio((short *)0,1,30,4,&status_val);
    IIwritio(0,(short *)0,1,32,0,(char *)", ");
    IIputdomio((short *)0,1,32,0,userid);
    IIwritio(0,(short *)0,1,32,0,(char *)", ");
    IIputdomio((short *)0,1,32,0,sessionid);
    IIwritio(0,(short *)0,1,32,0,(char *)", ");
    IIputdomio((short *)0,1,32,0,cmds);
    IIwritio(0,(short *)0,1,32,0,(char *)")");
    IIsyncup((char *)0,0);
  }
/* # line 345 "rmcmdstp.sc" */	/* host code */
        if (sqlca.sqlcode !=0)
        {
...
/* # line 355 "rmcmdstp.sc" */	/* execute */
  {
    IIsqInit(&sqlca);
    IIsqExImmed(stmt);
    IIsyncup((char *)0,0);
  }
/* # line 357 "rmcmdstp.sc" */	/* host code */
        if (sqlca.sqlcode < 0) 
        {
    ...
    */
    if (optflgs & OPTMSK)
    {
/* # line 368 "rmcmdstp.sc" */	/* execute procedure */
  {
    IIsqInit(&sqlca);
    IILQpriProcInit(2,(char *)"ima_drop_sessions");
    while (IILQprsProcStatus(0) != 0) {
    } /* IILQprsProcStatus */
  }
/* # line 369 "rmcmdstp.sc" */	/* host code */
...
/* # line 377 "rmcmdstp.sc" */	/* commit */
  {
    IIsqInit(&sqlca);
    IIxact(3);
  }
/* # line 379 "rmcmdstp.sc" */	/* disconnect */
  {
    IIsqInit(&sqlca);
    IIsqDisconnect();
  }
/* # line 381 "rmcmdstp.sc" */	/* host code */
    PCexit(OK);
end:
    if (ires == RES_SUCCESS)
/* # line 385 "rmcmdstp.sc" */	/* commit */
  {
    IIsqInit(&sqlca);
    IIxact(3);
  }
/* # line 386 "rmcmdstp.sc" */	/* host code */
    else
/* # line 387 "rmcmdstp.sc" */	/* rollback */
  {
    IIsqInit(&sqlca);
    IIxact(2);
  }
/* # line 388 "rmcmdstp.sc" */	/* disconnect */
  {
    IIsqInit(&sqlca);
    IIsqDisconnect();
  }
/* # line 390 "rmcmdstp.sc" */	/* host code */
    PCexit(FAIL);
}
