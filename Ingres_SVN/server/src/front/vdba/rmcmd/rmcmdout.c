...
/* # line 337 "rmcmdout.sc" */	/* host code */
   if (sqlca.sqlcode !=0)
#ifdef VMS
     return (102);
#else
...
/* # line 351 "rmcmdout.sc" */	/* host code */
   if (sqlca.sqlcode < 0) 
#ifdef VMS
   {
      ires = 104;
      ...
      goto end;
#endif
/* # line 360 "rmcmdout.sc" */	/* commit */
  {
    IIsqInit(&sqlca);
    IIxact(3);
  }
/* # line 362 "rmcmdout.sc" */	/* host code */
   iOutputLine = -1;
...
ues(");
    IIputdomio((short *)0,1,30,4,&hdl);
    IIwritio(0,(short *)0,1,32,0,(char *)", ");
    IIputdomio((short *)0,1,30,4,&iOutputLine);
    IIwritio(0,(short *)0,1,32,0,(char *)", ");
    IIputdomio((short *)0,1,32,0,buf1);
    IIwritio(0,(short *)0,1,32,0,(char *)", ");
    IIputdomio((short *)0,1,32,0,buf2);
    IIwritio(0,(short *)0,1,32,0,(char *)", ");
    IIputdomio((short *)0,1,32,0,buf);
    IIwritio(0,(short *)0,1,32,0,(char *)", ");
    IIputdomio((short *)0,1,32,0,bufNOCR);
    IIwritio(0,(short *)0,1,32,0,(char *)")");
    IIsyncup((char *)0,0);
  }
/* # line 373 "rmcmdout.sc" */	/* host code */
   if (sqlca.sqlcode < 0) 
#ifdef VMS
   {
      ires = 105;
      ...
      goto end;
#endif
/* # line 382 "rmcmdout.sc" */	/* raise dbevent */
  {
    IIsqInit(&sqlca);
    IIwritio(0,(short *)0,1,32,0,(char *)"raise dbevent rmcmdnewoutput\
line");
    IIsyncup((char *)0,0);
  }
/* # line 384 "rmcmdout.sc" */	/* host code */
   if (sqlca.sqlcode < 0) 
#ifdef VMS
   {
      ires = 105;
      ...
      goto end;
#endif
/* # line 394 "rmcmdout.sc" */	/* commit */
  {
    IIsqInit(&sqlca);
    IIxact(3);
  }
/* # line 395 "rmcmdout.sc" */	/* host code */
 /*     printf("result sent to client : %s\n",buf); */
   }
   /* termination */
   status1=RMCMDSTATUS_FINISHED;
/* # line 400 "rmcmdout.sc" */	/* update */
  {
    IIsqInit(&sqlca);
...
/* # line 403 "rmcmdout.sc" */	/* host code */
   if (sqlca.sqlcode < 0) 
#ifdef VMS
		ires = 106;
#else
		ires = 1;
#endif
/* # line 409 "rmcmdout.sc" */	/* raise dbevent */
  {
    IIsqInit(&sqlca);
    IIwritio(0,(short *)0,1,32,0,(char *)"raise dbevent rmcmdcmdend");
    IIsyncup((char *)0,0);
  }
/* # line 410 "rmcmdout.sc" */	/* host code */
   if (sqlca.sqlcode < 0) 
#ifdef VMS
		ires = 106;
#else
...
/* # line 418 "rmcmdout.sc" */	/* commit */
  {
    IIsqInit(&sqlca);
    IIxact(3);
  }
/* # line 419 "rmcmdout.sc" */	/* disconnect */
  {
    IIsqInit(&sqlca);
    IIsqDisconnect();
  }
/* # line 420 "rmcmdout.sc" */	/* host code */
#ifdef VMS
   close( 0 );
   return (ires);
#endif
