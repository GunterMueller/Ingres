...
#define CP_X	20		// X coordination of coyright box
#define CP_Y	310		// Y coordination of coyright box
...
void CSplashWnd::ShowSplashScreen(CWnd* pParentWnd /*= NULL*/)
{
	...
	/* get year information by parsing "II 2.6/0301 (int.wnt/86)" */
	/* style string from gv.h */
