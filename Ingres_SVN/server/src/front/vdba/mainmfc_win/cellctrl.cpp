...
int CuCellCtrl::GetDetailPaletteIndex(BYTE by)
{
  switch (by) {
    ...
    case (BYTE) PAGE_SPRIG        : return 5;
    case (BYTE) PAGE_LEAF         : return 6;
    case (BYTE) PAGE_OVERFLOW_LEAF: return 7;
    case (BYTE) PAGE_OVERFLOW_DATA: return 8;
    case (BYTE) PAGE_ASSOCIATED   : return 9;
    case (BYTE) PAGE_DATA         : return 10;
    case (BYTE) PAGE_UNUSED       : return 11;
    // hash specific section (ingres >= 2.5)
    case (BYTE) PAGE_EMPTY_DATA_NO_OVF    : return 12;
    case (BYTE) PAGE_EMPTY_OVERFLOW       : return 13;
    case (BYTE) PAGE_DATA_WITH_OVF        : return 14;
    case (BYTE) PAGE_EMPTY_DATA_WITH_OVF  : return 15;
    default:
      ASSERT (FALSE);
      return 0;
  }
