...
#ifdef WIN16
FUNC_EXTERN VOID	  IIUGeppErrorPrettyPrint ();
FUNC_EXTERN STATUS  IIUGfreetagblock(u_i2);
FUNC_EXTERN VOID    IIAFddcDetermineDatatypeClass (i4, nat*);
FUNC_EXTERN STATUS  afe_numaggs(ADF_CB *cb, DB_DATA_VALUE   *dbv, 
                        i4   *result);
FUNC_EXTERN DB_STATUS iiafParseType (ADF_CB *, char *, ADI_DT_NAME *, 
                        DB_DATA_VALUE	*);
FUNC_EXTERN DB_STATUS iiafScanNum ( char 	**numstr, i4	*num);
FUNC_EXTERN DB_STATUS afe_sqltrans (ADF_CB *, bool, char	*, i4,
                        char	[], i4	*);
FUNC_EXTERN DB_STATUS afe_error(ADF_CB *,u_i4,nat, ...);
FUNC_EXTERN DB_STATUS afe_errtostr (ADF_CB*, char*, nat*);
FUNC_EXTERN STATUS	 iiafTypeHack (ADF_CB *, char *, DB_DATA_VALUE *);
FUNC_EXTERN STATUS	 afe_dtrimlen (ADF_CB*, DB_DATA_VALUE*);
FUNC_EXTERN DB_STATUS afe_tyoutput(ADF_CB *, DB_DATA_VALUE *, DB_USER_TYPE *);
FUNC_EXTERN DB_STATUS iiafComputeLen (ADF_CB *, ADI_FI_DESC *, AFE_OPERS *, 
                        DB_DATA_VALUE*);
FUNC_EXTERN DB_STATUS afe_ficoerce(ADF_CB*, DB_DATA_VALUE*, DB_DATA_VALUE*, 
                        ADI_FI_ID*);
FUNC_EXTERN DB_STATUS afe_vtyoutput (ADF_CB*, DB_DATA_VALUE*, DB_USER_TYPE*);
FUNC_EXTERN STATUS    afe_clinstd (ADF_CB*, ADI_FI_ID, AFE_OPERS*, 
                        DB_DATA_VALUE*);
FUNC_EXTERN STATUS    afe_opid (ADF_CB*, char *, ADI_OP_ID*);
FUNC_EXTERN DB_STATUS afe_fdesc (ADF_CB*, ADI_OP_ID, AFE_OPERS*, AFE_OPERS*, 
                        DB_DATA_VALUE*, ADI_FI_DESC*);
FUNC_EXTERN DB_STATUS afe_fitype(ADF_CB*, char *, i4  *);
FUNC_EXTERN DB_LANG   IIAFstrDml (ADF_CB*, char *);
FUNC_EXTERN DB_STATUS afe_cvinto (ADF_CB*, DB_DATA_VALUE*, DB_DATA_VALUE*);
FUNC_EXTERN DB_STATUS afe_dplen (ADF_CB*, DB_DATA_VALUE*, i4*);
FUNC_EXTERN i4	    f_strT (u_char**, nat*, u_char*, nat);
FUNC_EXTERN i4	    f_lentrmwhite (u_char*, nat);
FUNC_EXTERN         f_strrgt (u_char*, i4, u_char*, nat);
FUNC_EXTERN 	    f_colfmt (PTR, DB_TEXT_STRING*, i4, i4, bool, bool);
FUNC_EXTERN i4	    afe_pad (ADF_CB*, PTR, DB_DT_ID, nat*);
FUNC_EXTERN DB_STATUS afe_cancoerce ();
FUNC_EXTERN STATUS    afe_dec_info(char *decstr, char decpt,
                                   i4  *lenp, i4  *precp, i4  *scalep);
FUNC_EXTERN bool    afe_tycoerce (ADF_CB *acb, DB_DT_ID itype, DB_DT_ID otype);
FUNC_EXTERN DB_STATUS afe_dpvalue(ADF_CB *, DB_DATA_VALUE*, DB_DATA_VALUE*);
FUNC_EXTERN DB_STATUS IIAFcvWildCard ( DB_DATA_VALUE*, i4, i4, nat*);
#endif /* WIN16 */
