...
/* function prototypes */
	TDrclreol();
	TDflush (char);
	TDdaout (u_char, u_char, u_char);
	TDdaput (u_char);
	TDputcolor (u_char);
i4	TDerrmsg (u_i4, i4, char*);
	TDzap();
VOID	IITDfixvsve(char**, char**);
	TDfillch (PTR, i4, i4, nat);
	dmpchr(char, FILE*);
VOID	IITDrstsize();
i4	ITxout(char*, char*, nat);
	TDsmvcur (i4, i4, i4, nat);
	TDgettmode();
	TDsetterm(char*);
VOID	TDboxsetup();
	TDtwincpy(PTR, PTR, i4, nat);
	TDonmacro (i4);
	FKclrlbl (i4);
	TDfill(i4, u_char, char*);
VOID	IITD1dDelwin (PTR);
	TDaddLast (char*, u_char);
	TDclrTop();
	TDscroll();
VOID	IITDxoff (i4);
VOID	IITDyoff (i4);
i4	TDhline (PTR, i4, i4, i4, i4, nat);
i4	TDvline (PTR, i4, i4, i4, i4, nat);
	TDhv(PTR, i4, i4, i4, i4, char, char, i4, nat);
	TDsetcorners (char*,char*,char*,char*,nat, i4, i4, nat);
i4	TDrmove (PTR, i4, nat);
i4	TDmove  (PTR,nat, nat);
i4	TDraddstr ();  
i4	TDaddstr();
VOID	TDdelwin ();
	TDtnamatch();
...
/* addch.c */
FUNC_EXTERN	i4  TDaddhdlr(PTR,nat,nat,u_char,PTR,bool);
FUNC_EXTERN	i4  TDxaddstr(PTR,nat,PTR);
/* box.c */
FUNC_EXTERN	void TDboxput(PTR,PTR,nat,nat,nat,nat);
FUNC_EXTERN	     TDsetcorners(PTR,PTR,PTR,PTR,nat,nat,nat,nat);
FUNC_EXTERN	     TDhv(PTR,nat ,nat,nat,nat,char,char,nat ,nat);
FUNC_EXTERN	     TDboxtopless(PTR,char,char,char);
FUNC_EXTERN	     TDboxhdlr(PTR,nat,nat,nat);
FUNC_EXTERN	     TDtfdraw(PTR,nat,nat,char);
FUNC_EXTERN	     TDcorners(PTR,nat);
FUNC_EXTERN	i4 TDhline(PTR,nat,nat,nat,nat,nat);
FUNC_EXTERN	i4 TDvline(PTR,nat,nat,nat,nat,nat);
/* clear.c */
FUNC_EXTERN	char *IITDgbGetBegin(PTR,nat);
/* crput.c */
FUNC_EXTERN	    TDmvcur(i4,nat,nat,nat);
FUNC_EXTERN	i4 TDplod(i4);
FUNC_EXTERN	    TDsmvcur(i4,nat,nat,nat);
/* crtty.c */
FUNC_EXTERN	i4 IITDscSizeChg(i4);
/* delch.c */
FUNC_EXTERN	    TDfillch(PTR,nat,nat,nat);
/* dispattr.c */
FUNC_EXTERN	char TDcolor(i4);
FUNC_EXTERN	     TDsetdispattr(i4);
FUNC_EXTERN	     TDsetattr(PTR,i4);
FUNC_EXTERN	void TDputattr(PTR,i4);
/* endwin.c */
FUNC_EXTERN	     TDrstcur(i4,nat,nat,nat);
/* extend.c */
FUNC_EXTERN	struct _win_st *TDextend(PTR,nat);
/* hilite.c */
FUNC_EXTERN	    TDhilite(PTR,nat,nat,u_char);
FUNC_EXTERN	    TDrowhilite(PTR,nat,u_char);
/* initscr.c */
FUNC_EXTERN	i4 TDerrmsg(u_i4,nat,PTR);
/* itxout.c */
FUNC_EXTERN	i4 ITxout(PTR,PTR,nat);
/* keys.c */
FUNC_EXTERN	    FKprserr(PTR,nat,PTR);
FUNC_EXTERN	    FK30parse(PTR,nat);
FUNC_EXTERN	    FKclrlbl(i4);
FUNC_EXTERN	    FKungetch(PTR,nat);
FUNC_EXTERN	    FKmacro(i4);
FUNC_EXTERN	struct _key_struct *FKexpmac(i4);
FUNC_EXTERN	void IITDmfkMapFuncKeys(i4,PTR);
/* locator.c */
FUNC_EXTERN	i4 IITDlioLocInObj(PTR,nat,nat);
/* mvfix.c */
FUNC_EXTERN	    TDmvchwadd(PTR,nat,nat,char);
FUNC_EXTERN	    TDmvstrwadd(PTR,nat,nat,PTR);
/* mvprintw.c */
FUNC_EXTERN	    TDmvwprintw(PTR,nat,nat,char *fmt, ...);
/* newwin.c */
FUNC_EXTERN	STATUS IITD2waWinAlloc(PTR,nat);
FUNC_EXTERN	struct _win_st *TDnewwin(i4,nat,nat,nat);
FUNC_EXTERN	struct _win_st *TDsubwin(PTR,nat,nat,nat,nat,PTR);
FUNC_EXTERN	struct _win_st *TDmakenew(i4,nat,nat,nat);
FUNC_EXTERN	    TDfill(i4,u_char,PTR);
/* nomacro.c */
FUNC_EXTERN	    TDnomacro(i4);
FUNC_EXTERN	    TDonmacro(i4);
/* onewin.c */
FUNC_EXTERN	STATUS TDonewin(PTR,PTR,PTR,nat,nat);
/* overwrt.c */
FUNC_EXTERN	void TDoverlay(PTR,nat,nat,PTR,nat,nat);
/* refresh.c */
FUNC_EXTERN	    TDmakech(PTR,nat);
/* restore.c */
FUNC_EXTERN	    TDfkmode(i4);
FUNC_EXTERN	    TDrestore(i4,nat);
/* sbox.c */
FUNC_EXTERN	    TDsbox(PTR,nat,nat,nat,nat,char,char,char,nat,nat,bool);
/* sextend.c */
FUNC_EXTERN	struct _win_st *TDsextend(PTR,nat);
/* tddblutl.c */
FUNC_EXTERN	i4 TDxinc(PTR,nat,nat,nat);
FUNC_EXTERN	i4 TDxdec(PTR,nat,nat,nat);
FUNC_EXTERN	i4 TDfixpos(PTR,nat,nat);
FUNC_EXTERN	i4 TDmvcrsr(i4,PTR,nat,bool);
FUNC_EXTERN	struct _key_struct *TDsetKS(PTR,nat,nat);
/* tdfplus.c */
FUNC_EXTERN	void TDflashplus(PTR,nat,nat,nat);
/* tdmove.c */
FUNC_EXTERN	i4 TDmove(PTR,nat,nat);
FUNC_EXTERN	i4 TDrmove(PTR,nat,nat);
/* tdtmputl.c */
FUNC_EXTERN	struct _win_st *TDtmpwin(PTR,nat,nat);
FUNC_EXTERN	   TDtwincpy(PTR,PTR,nat,nat);
/* tgoto.c */
FUNC_EXTERN	char *TDtgoto(PTR,nat,nat);
/* totop.c */
FUNC_EXTERN	    TDutil(PTR,PTR,nat,nat,PTR);
FUNC_EXTERN	    TDupvfsl(PTR,nat);
/* windex.c */
FUNC_EXTERN	void IITDgvmode(i4);
FUNC_EXTERN	void IITDxoff(i4);
FUNC_EXTERN	void IITDyoff(i4);
FUNC_EXTERN	void IITDnwscrn(PTR,nat,nat,nat,nat,i4,i4);
FUNC_EXTERN	void IITDnwtbl(i4,PTR);
FUNC_EXTERN	void IITDfield(i4,nat,nat,nat,nat,i4,i4,nat);
FUNC_EXTERN	void IITDfldtitle(i4,nat,PTR);
FUNC_EXTERN	void IITDedpdmenu(void);
FUNC_EXTERN	void IITDmnline(i4,nat,PTR);
FUNC_EXTERN	void IITDhotspot(i4,nat,nat,nat,PTR,nat);
FUNC_EXTERN	void IITDhsHotspotString(i4,PTR);
/* winmsg.c */
FUNC_EXTERN	void IITDssaSetStdmsgAttr(i4);
