...
#ifdef WIN16
VOID	UGcat_to_dt();
STATUS	IIUGhfHtabFind (PTR, PTR, PTR);
VOID	IIUGerr(ER_MSGID,nat,nat, ...);
VOID	IIUGsber(PTR,PTR,nat,u_i4, i4,nat, ...);
VOID	IIUGmsg (PTR,bool,nat,...);
STATUS	IIUGhlpname (PTR, PTR);
i4	IIUGnpNextPrime (i4);
STATUS	IIUGhiHtabInit (i4, PTR, PTR,PTR, PTR); 
STATUS	IIUGheHtabEnter (PTR, PTR, PTR);
i4	IIUGhsHtabScan (PTR, bool, PTR, PTR);
VOID	IIUGprompt (PTR, i4, bool, PTR, i4, i4,...);
char	*IIUGfemFormatErrorMessage(PTR,nat, PTR, bool);
STATUS  IIUGinit();
