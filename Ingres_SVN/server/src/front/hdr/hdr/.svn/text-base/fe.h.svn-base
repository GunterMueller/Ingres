...
PTR	FEreqlng(/* u_i4, i4, bool, STATUS * */);
char	*FEsalloc(/* char * */);
char	*FEtsalloc(/* u_i4, char * */);
PTR	iiugReqMem(/* u_i4, u_i4, bool, STATUS * */);
#endif /* NT_GENERIC */
...
FUNC_EXTERN STATUS	IIFDffFormatField(char *, i4, i4, i4, i4, char *, i4,
					  i4, PTR, i4, i4, PTR *);
FUNC_EXTERN STATUS	IIFRmdfMakeDefaultForm(char *, char *, bool, i4, PTR,
					       i4, PTR *);
FUNC_EXTERN bool	FEhframe(char *, char *, bool, PTR, char *[], char *[], i4);
...
FUNC_EXTERN bool	IIRTdohelp(char *, char *, PTR, bool, i4, VOID(*)());
...
FUNC_EXTERN VOID	FEhkeys(char *, PTR, char **, char **, i4);
