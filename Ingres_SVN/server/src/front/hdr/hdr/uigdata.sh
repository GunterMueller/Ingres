...
EXEC SQL END EXCLUDE SECTION;
    ...
    char user[FE_MAXNAME+1];
    char sdba[FE_MAXNAME+1];
    char suser[FE_MAXNAME+1];
    char database[FE_MAXDBNM+1];
    char catowner[FE_MAXNAME+1];
    char ingsql_level[VER_SIZE+1];
    char opensql_level[VER_SIZE+1];
    char catalog_level[VER_SIZE+1];
    char ingquel_level[VER_SIZE+1];
EXEC SQL BEGIN EXCLUDE SECTION;
	/*
