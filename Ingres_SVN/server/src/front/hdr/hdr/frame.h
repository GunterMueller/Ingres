...
/* function prototypes */
/* chgtbrow.c */
FUNC_EXTERN	i4 FDchgtbrow(PTR,nat);
/* clrflds.c */
FUNC_EXTERN	i4  FDclr(PTR,nat,nat,nat,nat,nat);
/* copy.c */
FUNC_EXTERN	i4 FDcopytab(PTR,nat,nat);
/* copyup.c */
FUNC_EXTERN	    FDcopyup(PTR,nat,nat);
FUNC_EXTERN	    FDcopydown(PTR,nat,nat);
/* datafmt.c */
FUNC_EXTERN	i4 FDdatafmt(PTR,nat,nat,nat,nat,nat,PTR,PTR,PTR);
/* decoding.c */
FUNC_EXTERN	i4 CFdecode(PTR,PTR,nat);
/* emptyrow.c */
FUNC_EXTERN	    FDemptyrow(PTR,nat);
/* error.c */
FUNC_EXTERN	void IIFDerror(u_i4,nat, ...);
FUNC_EXTERN	void IIFDsterr(u_i4);
/* fdderive.c */
FUNC_EXTERN	i4    IIFDgdvGetDeriveVal(PTR,PTR,nat);
FUNC_EXTERN	STATUS IIFDsdvSetDeriveVal(PTR,PTR,nat);
FUNC_EXTERN	void IIFDidfInvalidDeriveFld(PTR,PTR,nat);
FUNC_EXTERN	void IIFDudfUpdateDeriveFld(PTR,PTR,nat);
FUNC_EXTERN	i4  IIFDvsfValidateSrcFld(PTR,PTR,nat);
/* fdmove.c */
FUNC_EXTERN	i4  FDmove(i4,PTR,PTR,nat);
/* fdmvtab.c */
FUNC_EXTERN	i4  FDrightcol(PTR,nat);
FUNC_EXTERN	i4  FDdownrow(PTR,nat);
FUNC_EXTERN	i4  FDuprow(PTR,nat);
/* fdqbfraw.c */
FUNC_EXTERN	void FDqbfraw(PTR,PTR,nat,PTR,nat);
/* fdutil.c */
FUNC_EXTERN	i4    FDavchk(PTR,PTR,nat);
FUNC_EXTERN	STATUS FDdbvget(PTR,PTR,PTR,nat,PTR);
FUNC_EXTERN	STATUS FDfmtget(PTR,PTR,PTR,nat,PTR);
FUNC_EXTERN	STATUS FDsetoper(PTR,PTR,PTR,nat,nat);
FUNC_EXTERN	i4    FDdispupd(PTR,PTR,PTR,nat);
FUNC_EXTERN	void FDschgbit(PTR,nat,nat);
FUNC_EXTERN	i4  IIFDmiMarkInvalid(PTR,nat,nat,nat,nat,nat);
FUNC_EXTERN	void IIFDgccb(PTR,nat,PTR,PTR);
FUNC_EXTERN	     IIFDtccb(PTR,nat,PTR);
FUNC_EXTERN	     IIFDtscb(PTR,nat,PTR,i4,nat);
FUNC_EXTERN	void IIFDfscb(PTR,nat);
FUNC_EXTERN	i4  IIFDccb(PTR,nat,nat,nat,nat,nat);
FUNC_EXTERN	i4  IIFDscb(PTR,nat,nat,nat,nat,nat);
FUNC_EXTERN	void IIFDsfsSetFieldScrolling(PTR,nat);
FUNC_EXTERN	void IIFDscaSetCellAttr(PTR,PTR,PTR,nat,i4,nat,nat,nat);
/* fdvalid.c */
FUNC_EXTERN	i4  FDvalidate(PTR,nat,nat,nat,nat,PTR);
/* fixstate.c */
FUNC_EXTERN	i4  FDfixstate(PTR,nat);
/* fldclr.c */
FUNC_EXTERN	void FDfldclr(PTR,nat,nat);
/* fldofmd.c */
FUNC_EXTERN	struct fldstr *FDfldofmd(PTR,nat,nat);
/* fldval.c */
FUNC_EXTERN	i4   FDfieldval(PTR,nat,nat,nat,nat,nat);
/* fmtchg.c */
FUNC_EXTERN	void IIFDshsSetHdrSize(i4,nat,nat,nat,PTR);
FUNC_EXTERN	i4  IIFDfctFldColTraverse(PTR,PTR,nat,nat,PTR,nat);
/* frcreate.c */
FUNC_EXTERN	void FDfrprint(i4);
FUNC_EXTERN	struct frmstr *FDbincreate(PTR,bool,i4);
/* frmisc.c */
FUNC_EXTERN	struct fldstr *FDfind(PTR,PTR,nat,PTR);
/* getcol.c */
FUNC_EXTERN	i4    FDgetcol(i4,PTR,nat,PTR,PTR);
/* getdata.c */
FUNC_EXTERN	i4  FDnodata(PTR,nat,nat,nat,nat,nat);
FUNC_EXTERN	i4  FDgetdata(PTR,nat,nat,nat,nat,nat);
FUNC_EXTERN	i4  IIFDvfValidateFld(PTR,nat,nat,nat,nat,nat,bool);
FUNC_EXTERN	void IIFDfdeFldDataError(u_i4,nat,...);
/* gotofld.c */
FUNC_EXTERN	     FDtfsgfix(PTR,nat);
/* gtfldno.c */
FUNC_EXTERN	i4  FDgtfldno(i4,PTR,PTR,PTR);
/* gtname.c */
FUNC_EXTERN	char *FDgetname(PTR,nat);
/* newfld.c */
FUNC_EXTERN   i4  FDwflalloc(PTR,bool);
FUNC_EXTERN	struct fldstr *FDnewfld(PTR,nat,nat);
/* newtbl.c */
FUNC_EXTERN i4    FDwcolalloc(PTR,PTR,bool);
FUNC_EXTERN i4    FDwtblalloc(PTR);
FUNC_EXTERN	struct tblcolstr *FDnewcol(PTR,nat);
/* newtrim.c */
FUNC_EXTERN	struct trmstr *FDnewtrim(PTR,nat,nat);
/* parse.c */
FUNC_EXTERN	void IIFDieIgnoreErrs(i4);
/* putcol.c */
FUNC_EXTERN	i4  FDputcol(PTR,nat,PTR,PTR);
/* putdata.c */
FUNC_EXTERN	i4  FDputdata(PTR,nat,nat,nat,nat,nat);
/* putfrm.c */
FUNC_EXTERN	     FDsetscroll(i4);
FUNC_EXTERN	i4  FDinitsp(PTR,nat,nat);
FUNC_EXTERN	void FDrstfrm(PTR,nat);
FUNC_EXTERN	i4  FDaddinit(PTR,nat,nat,nat,nat,nat);
FUNC_EXTERN	i4  FDaddns(PTR,nat,nat,nat,nat,nat);
FUNC_EXTERN	i4  FDersfld(PTR,nat,nat,nat,nat,nat);
static	void FDmodedraw(struct frmstr *frm,long fldno,long all);
static	long FDddDispData(struct frmstr *frm,long fldno);
/* puttbl.c */
FUNC_EXTERN	i4  FDtblput(PTR,nat,nat,nat,nat,nat);
/* qrydata.c */
FUNC_EXTERN	i4  FDqrydata(PTR,nat,nat,nat,nat,nat);
FUNC_EXTERN	     FDqrytest(i4);
/* qryfld.c */
FUNC_EXTERN	i4  FDputoper(i4,PTR,nat,nat,nat,nat,nat);
/* rangechk.c */
FUNC_EXTERN	STATUS FDrngchk(PTR,PTR,PTR,PTR,bool,PTR,PTR,bool,nat,PTR,PTR,PTR);
/* scrmsg.c */
FUNC_EXTERN	int wwinerr(char *str,nat a1,nat a2,nat a3,nat a4,nat a5,
                 i4  a6,nat a7,nat a8,nat a9,nat a10);
/* strverse.c */
FUNC_EXTERN	i4  FDsfldtrv(PTR,PTR,nat);
FUNC_EXTERN	i4  FDstbltrv(PTR,PTR,nat);
FUNC_EXTERN	     FDsrowtrv(PTR,nat,PTR);
FUNC_EXTERN	i4  IIFDlrtLastRowTrv(PTR,nat,PTR);
/* tbutil.c */
FUNC_EXTERN  i4    FDtblOK(PTR,PTR);
FUNC_EXTERN	i4  FDclrrow(PTR,nat);
FUNC_EXTERN	i4  FDclrcol(PTR,nat,PTR);
FUNC_EXTERN	i4  FDckrow(PTR,nat);
FUNC_EXTERN	i4  FDckcol(PTR,nat,PTR);
FUNC_EXTERN	i4  FDcoltrv(PTR,nat,PTR,PTR);
FUNC_EXTERN	i4  FDscoltrv(PTR,nat,PTR,PTR);
FUNC_EXTERN	i4  FDcolop(PTR,nat,PTR,PTR);
FUNC_EXTERN	i4  FDinsqcol(PTR,nat,PTR,nat,PTR,PTR);
/* traverse.c */
FUNC_EXTERN	void FDFTsmode(i4);
FUNC_EXTERN	i4  FDfldtrv(i4,PTR,nat);
FUNC_EXTERN	i4  FDtbltrv(PTR,PTR,nat);
FUNC_EXTERN	     FDrowtrv(PTR,nat,PTR);
/* txtcreat.c */
FUNC_EXTERN	struct frmstr *FDtxtcreate(PTR,bool,i4);
/* txtfdcre.c */
FUNC_EXTERN	    FDtxtfldcre(PTR,i4,PTR,nat,bool);

/* from front!frame!valid */
/* dlex.c */
FUNC_EXTERN   i4   IIFVdscDrvStrCnv(PTR, u_i2);
FUNC_EXTERN	void IIFVdeErr(u_i4,nat,...);
/* dnode.c */
FUNC_EXTERN	struct dnode *IIFVmsMathSetup(i4,PTR,PTR);
void IIFVcaiCallAdeInst(PTR,nat,nat,nat,PTR,PTR,PTR);
/* drveval.c */
FUNC_EXTERN STATUS IIFVddeDoDeriveEval(PTR,PTR,PTR,PTR);
FUNC_EXTERN STATUS IIFVfdeFastDrvEval(PTR,PTR,PTR,PTR);
FUNC_EXTERN	void IIFViaInvalidateAgg(PTR,nat);
FUNC_EXTERN	void IIFVliaLocInvalAgg(PTR,nat);
/* lex.c */
FUNC_EXTERN	     vl_strcnv(PTR,u_i2,nat);
FUNC_EXTERN	void IIFVndNegateDecimal(PTR,nat);
FUNC_EXTERN	void IIFVsdsScanDelimString(i4);
/* mkatrtre.c */
FUNC_EXTERN	struct vtree *vl_mkattrtree(PTR,nat,PTR);
/* mklist.c */
FUNC_EXTERN	struct valroot *vl_mklist(i4);
/* parerror.c */
FUNC_EXTERN	   vl_nopar_error(u_i4,nat, ...);
FUNC_EXTERN	void IIFVdpError(u_i4,nat,char *a1,char *a2,char *a3,char *a4,char *a5);
/* maketree.c */
i4  vl_docoerce(PTR,PTR,PTR,PTR,PTR,PTR);
i4  vl_lscoerce(PTR,PTR);
#endif /* WIN16 */
