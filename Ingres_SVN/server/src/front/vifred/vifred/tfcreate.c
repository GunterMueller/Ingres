...
**              18-jan-93 (dkhor)
**              On axp_osf, pointers are 8 bytes.  In loadtable(), declare
**              ccol as long (which is 8 bytes on axp_osf).
**              In unloadtbl(), declare ptr as long.
**              In tfhandler(), declare ccol as long.
**      25-sep-96 (mcgem01)
**              Global data moved to vfdata.c
**      11-Feb-97 (fanra01)
**              Bug 80588
**              Modified gettable function to accept character pointer.
**              Changed tfhandler function to declare character array to pass
**              to gettable.
**	21-jan-1999 (hanch04)
...
/* # line 512 "tfcreate.qsc" */	/* loadtable */
  {
...
/* # line 515 "tfcreate.qsc" */	/* host code */
				break;
			case EDITING:
				col = (FLDCOL *)ccol;
				hdr = &col->flhdr;
				flg = hdr->fhd2flags & fdVQLOCK;
/* # line 521 "tfcreate.qsc" */	/* loadtable */
  {
    if (IItbact(_Form,_TableFld,1) != 0) {
      IItcoputio((char *)"title",(short *)0,1,32,0,ctitle);
      IItcoputio((char *)"format",(short *)0,1,32,0,cformat);
...
/* # line 524 "tfcreate.qsc" */	/* host code */
				break;
			case CHGATTR:
				col = (FLDCOL *)ccol;
				hdr = &col->flhdr;
...
/* # line 534 "tfcreate.qsc" */	/* loadtable */
  {
    if (IItbact(_Form,_TableFld,1) != 0) {
      IItcoputio((char *)"title",(short *)0,1,32,0,ctitle);
      IItcoputio((char *)"format",(short *)0,1,32,0,cformat);
...
/* # line 537 "tfcreate.qsc" */	/* host code */
				break;
		}
	}
}
...
**      11-Feb-97 (fanra01)
**          Bug 80588
**          Replace local declaration of character array with character pointer
**          as parameter.  Previously returned a stack pointer invalidated when
**          the funtion returned.
**
*/
static char *
gettable(char * tname)
...
# endif
/* # line 595 "tfcreate.qsc" */	/* message */
  {
    IImessage(ERget(S_VF00D3_Working));
  }
/* # line 597 "tfcreate.qsc" */	/* host code */
...
unloadtbl ()
{
  ...
  SIZE_TYPE ptr;
	...
	tfcounter = 0;
	rowwidth = 0;
/* # line 680 "tfcreate.qsc" */	/* unloadtable */
  {
...
"internname");
      ...
      IITBceColEnd();
      {
/* # line 685 "tfcreate.qsc" */	/* host code */
 	    register FMT	*ufmt;
	    str = uformat;
	    switch (ustate)
	    {
		...
		case stCHANGE:
			...
			if ( tfcounter >= DB_GW2_MAX_COLS )
			{
			    ...
			    ++uerrs;
/* # line 725 "tfcreate.qsc" */	/* endloop */
        {
          if (1) goto IItbE1;
        }
/* # line 726 "tfcreate.qsc" */	/* host code */
			}
			/*
...
/* # line 865 "tfcreate.qsc" */	/* host code */
	if ( nmerrs > 0 || uerrs > 0 )
	{
		return FALSE;
	}
...
/* # line 1437 "tfcreate.qsc" */	/* host code */
	...
	*/
	...
	tfcounter = i;
/* # line 1473 "tfcreate.qsc" */	/* inittable */
  {
...
/* # line 1474 "tfcreate.qsc" */	/* host code */
...
tblfldcreate()
{
	...
	allocTF();
	tfcols = ltfcols;	/* pt tfcols to the local array */
/* # line 1492 "tfcreate.qsc" */	/* set_frs */
  {
    if (IIiqset(2,0,_Form,(char *)0, (char *)0) != 0) {
      IIstfsio(53,_NameFld,0,(short *)0,1,30,sizeof(0),(void *)IILQint(0));
    } /* IIiqset */
  }
/* # line 1493 "tfcreate.qsc" */	/* inittable */
  {
    if (IItbinit(_Form,_TableFld,(char *)"f") != 0) {
      IIthidecol((char *)"clptr",(char *)"i4");
      IIthidecol((char *)"flags",(char *)"i4");
...
/* # line 1494 "tfcreate.qsc" */	/* host code */
...
/* return of _LASTROW and _MAXROW may not be necessary */
	vfdmpoff();
/* # line 1583 "tfcreate.qsc" */	/* clear */
    {
      IIclrscr();
    }
/* # line 1584 "tfcreate.qsc" */	/* display */
    {
...
IIfdI1:;
      ...
      {
/* # line 1587 "tfcreate.qsc" */	/* clear */
        {
          IIclrflds();
        }
/* # line 1588 "tfcreate.qsc" */	/* host code */
		if ( iivfRTIspecial )
		{
/* # line 1590 "tfcreate.qsc" */	/* set_frs */
        {
          if (IIiqset(2,0,_Form,(char *)0, (char *)0) != 0) {
...
/* # line 1593 "tfcreate.qsc" */	/* host code */
		}
		else
		{
/* # line 1596 "tfcreate.qsc" */	/* set_frs */
        {
          if (IIiqset(2,0,_Form,(char *)0, (char *)0) != 0) {
...
/* # line 1599 "tfcreate.qsc" */	/* host code */
		}
		if (tfname != NULL)
		{ /* Edit existing table field ... */
/* # line 1602 "tfcreate.qsc" */	/* putform */
        {
...
/* # line 1618 "tfcreate.qsc" */	/* host code */
			loadtable(EDITING);
/* # line 1619 "tfcreate.qsc" */	/* resume */
        {
          IIresfld(_TableFld);
          if (1) goto IIfdB1;
        }
...
/* # line 1623 "tfcreate.qsc" */	/* putform */
        {
          if (IIfsetio((char *)0) != 0) {
...
/* # line 1631 "tfcreate.qsc" */	/* host code */
		}
      }
IIfdB1:
      while (IIrunform() != 0) {
...
/* # line 1636 "tfcreate.qsc" */	/* host code */
		if (clflg & fdVQLOCK)
		{
/* # line 1638 "tfcreate.qsc" */	/* inquire_frs */
            {
              if (IIiqset(0,0,(char *)0, (char *)0, (char *)0) != 0) {
                IIiqfsio((short *)0,1,30,4,&cmd,38,(char *)0,0);
              } /* IIiqset */
            }
/* # line 1639 "tfcreate.qsc" */	/* host code */
			/*
			...
			*/
			if (cmd == CMD_NEXT || cmd == CMD_RET
			    || cmd == CMD_NXITEM)
			{
/* # line 1649 "tfcreate.qsc" */	/* resume */
            {
              IIrescol(_TableFld,(char *)"format");
              if (1) goto IIfdB1;
            }
/* # line 1650 "tfcreate.qsc" */	/* host code */
			}
			else
			{
/* # line 1653 "tfcreate.qsc" */	/* resume */
            {
              IIrescol(_TableFld,(char *)"title");
              if (1) goto IIfdB1;
            }
/* # line 1654 "tfcreate.qsc" */	/* host code */
			}
		}
          }
        } else if (IIretval() == 2) {
          {
            i4 currow;
            char *newname;
/* # line 1662 "tfcreate.qsc" */	/* inquire_frs */
            {
              if (IIiqset(2,0,_Form,(char *)0, (char *)0) != 0) {
                IIiqfsio((short *)0,1,30,4,&istable,28,(char *)0,0);
              } /* IIiqset */
            }
/* # line 1663 "tfcreate.qsc" */	/* host code */
		if (!istable)
		{
...
/* # line 1680 "tfcreate.qsc" */	/* set_frs */
            {
...
/* # line 1681 "tfcreate.qsc" */	/* host code */
		}
          }
        } else if (IIretval() == 3) {
          {
/* # line 1685 "tfcreate.qsc" */	/* inquire_frs */
            {
              if (IIiqset(2,0,_Form,(char *)0, (char *)0) != 0) {
                IIiqfsio((short *)0,1,30,4,&istable,28,(char *)0,0);
              } /* IIiqset */
            }
/* # line 1686 "tfcreate.qsc" */	/* host code */
		if (!istable)
		{
...
/* # line 1696 "tfcreate.qsc" */	/* host code */
			if (clflg & fdVQLOCK)
			{
			...
			{
/* # line 1702 "tfcreate.qsc" */	/* deleterow */
            {
...
/* # line 1703 "tfcreate.qsc" */	/* set_frs */
            {
              if (IIiqset(1,0,(char *)0, (char *)0, (char *)0) != 0) {
                IIstfsio(20,_Form,0,(short *)0,1,30,sizeof(1),(void *)IILQint(
                1));
...
/* # line 1704 "tfcreate.qsc" */	/* host code */
			}
		}
          }
        } else if (IIretval() == 4) {
...
/* # line 1709 "tfcreate.qsc" */	/* host code */
	    ADF_CB	*ladfcb;
            ...
            i4 rowtype;
            i4 recptr;
/* # line 1717 "tfcreate.qsc" */	/* inquire_frs */
            {
              if (IIiqset(2,0,_Form,(char *)0, (char *)0) != 0) {
                IIiqfsio((short *)0,1,30,4,&istable,28,(char *)0,0);
              } /* IIiqset */
...
/* # line 1724 "tfcreate.qsc" */	/* resume */
            {
              if (1) goto IIfdB1;
            }
/* # line 1725 "tfcreate.qsc" */	/* host code */
	    }
/* # line 1726 "tfcreate.qsc" */	/* getrow */
            {
              if (IItbsetio(2,_Form,_TableFld,-2) != 0) {
...
/* # line 1727 "tfcreate.qsc" */	/* host code */
		...
		IIUGerr(E_VF00E0_TblFldMenu, UG_ERR_ERROR, 2,
			ERget(F_VF0030_EditAttr), cltitle);
/* # line 1733 "tfcreate.qsc" */	/* resume */
            {
              if (1) goto IIfdB1;
            }
/* # line 1734 "tfcreate.qsc" */	/* host code */
	    }
	    ladfcb = FEadfcb();
	    vfstdel(ATBLFD);
	    tfcounter = 0;
	    /* need to eliminate UNDEFINED or DELETED row during unload */
/* # line 1739 "tfcreate.qsc" */	/* unloadtable */
            {
...
internname");
                ...
                IITBceColEnd();
                {
/* # line 1743 "tfcreate.qsc" */	/* host code */
		FLDCOL		*acol;
		FLDTYPE		*type;
		DB_DATA_VALUE	dbv;
		switch (rowtype)
		{
			...
			if (tfcounter >= DB_GW2_MAX_COLS)
			{
				...
				IIUGerr(E_VF00E5_TooManyCols, UG_ERR_ERROR,
					1, &tmp);
/* # line 1759 "tfcreate.qsc" */	/* resume */
                  {
                    IItunend();
                    if (1) goto IIfdB1;
                  }
/* # line 1760 "tfcreate.qsc" */	/* host code */
			}
			acol = (FLDCOL *) ccol;
			if (acol == NULL)
			{
...
/* # line 1863 "tfcreate.qsc" */	/* inittable */
            {
              if (IItbinit(_Form,_TableFld,(char *)"f") != 0) {
                IIthidecol((char *)"clptr",(char *)"i4");
                IIthidecol((char *)"flags",(char *)"i4");
...
/* # line 1864 "tfcreate.qsc" */	/* host code */
	    loadtable(CHGATTR);
          }
        } else if (IIretval() == 5) {
          {
            i4 moverec;
            i4 currow;
/* # line 1871 "tfcreate.qsc" */	/* inquire_frs */
            {
              if (IIiqset(2,0,_Form,(char *)0, (char *)0) != 0) {
                IIiqfsio((short *)0,1,30,4,&istable,28,(char *)0,0);
              } /* IIiqset */
...
/* # line 1877 "tfcreate.qsc" */	/* host code */
...
/* # line 1882 "tfcreate.qsc" */	/* host code */
			else
			{
/* # line 1884 "tfcreate.qsc" */	/* inquire_frs */
            {
              if (IIiqset(3,0,_Form,(char *)0, (char *)0) != 0) {
                IIiqfsio((short *)0,1,30,4,&currow,29,_TableFld,0);
              } /* IIiqset */
            }
/* # line 1886 "tfcreate.qsc" */	/* getrow */
            {
...
/* # line 1888 "tfcreate.qsc" */	/* host code */
			}
		}
		else
		{
			...
			IIUGerr(E_VF00E0_TblFldMenu, UG_ERR_ERROR, 2,
				ERget(FE_Move), buf);
/* # line 1896 "tfcreate.qsc" */	/* resume */
            {
              if (1) goto IIfdB1;
            }
/* # line 1897 "tfcreate.qsc" */	/* host code */
		}
/* # line 1899 "tfcreate.qsc" */	/* display */
            {
...
IIfdB2:
              while (IIrunnest() != 0) {
                if (IIretval() == 1) {
                  {
/* # line 1902 "tfcreate.qsc" */	/* inquire_frs */
                    {
                      if (IIiqset(2,0,_Form,(char *)0, (char *)0) != 0) {
                        IIiqfsio((short *)0,1,30,4,&istable,28,(char *)0,0);
                      } /* IIiqset */
...
/* # line 1906 "tfcreate.qsc" */	/* resume */
                    {
                      if (1) goto IIfdB2;
                    }
/* # line 1907 "tfcreate.qsc" */	/* host code */
			}
			else
                    {
                      i4 destrec;
/* # line 1912 "tfcreate.qsc" */	/* inquire_frs */
                      {
                        if (IIiqset(3,0,_Form,(char *)0, (char *)0) != 0) {
                          IIiqfsio((short *)0,1,30,4,&currow,29,_TableFld,0);
                        } /* IIiqset */
                      }
/* # line 1914 "tfcreate.qsc" */	/* getrow */
                      {
                        if (IItbsetio(2,_Form,_TableFld,currow) != 0) {
...
/* # line 1916 "tfcreate.qsc" */	/* host code */
				if (destrec == moverec)
				{
/* # line 1918 "tfcreate.qsc" */	/* breakdisplay */
                      {
                        if (1) goto IIfdE2;
                      }
/* # line 1919 "tfcreate.qsc" */	/* host code */
				}
/* # line 1920 "tfcreate.qsc" */	/* scroll */
                      {
...
/* # line 1927 "tfcreate.qsc" */	/* deleterow */
                      {
                        if (IItbsetio(4,_Form,_TableFld,-2) != 0) {
                          if (IItdelrow(0) != 0) {
                          } /* IItdelrow */
...
/* # line 1928 "tfcreate.qsc" */	/* host code */
				if (moverec < destrec)
				{
					destrec--;
				}
/* # line 1932 "tfcreate.qsc" */	/* scroll */
                      {
                        if (IItbsetio(1,_Form,_TableFld,-3) != 0) {
                          IItbsmode((char *)"to");
...
/* # line 1933 "tfcreate.qsc" */	/* inquire_frs */
                      {
                        if (IIiqset(3,0,_Form,(char *)0, (char *)0) != 0) {
                          IIiqfsio((short *)0,1,30,4,&currow,29,_TableFld,0);
                        } /* IIiqset */
                      }
/* # line 1935 "tfcreate.qsc" */	/* host code */
				currow--;
/* # line 1936 "tfcreate.qsc" */	/* insertrow */
                      {
                        if (IItbsetio(5,_Form,_TableFld,currow) != 0) {
                          if (IItinsert() != 0) {
...
/* # line 1942 "tfcreate.qsc" */	/* set_frs */
                      {
                        if (IIiqset(1,0,(char *)0, (char *)0, (char *)0) != 0
                        ) {
...
/* # line 1944 "tfcreate.qsc" */	/* breakdisplay */
                  ...
                  {
/* # line 1950 "tfcreate.qsc" */	/* host code */
			IIUFfieldHelp();
                  }
                } else if (IIretval() == 3) {
                  {
/* # line 1955 "tfcreate.qsc" */	/* host code */
			FEhelp(VFH_TFMOVE, ERget(S_VF00EA_TblFldMoveCol));
                  }
                } else if (IIretval() == 4) {
                  {
/* # line 1960 "tfcreate.qsc" */	/* breakdisplay */
                    {
                      if (1) goto IIfdE2;
                    }
                  }
...
IIfdE2:;
          ...
          {
            char *tblname;
/* # line 1967 "tfcreate.qsc" */	/* getform */
            {
              if (IIfsetio((char *)0) != 0) {
                IIgetfldio((short *)0,1,32,FE_MAXNAME + 1-1,tfldname,_NameFld);
              } /* IIfsetio */
            }
/* # line 1968 "tfcreate.qsc" */	/* host code */
		STtrmwhite(tfldname);
		tfcounter = 0;
		if ( (tblname = gettable(tname)) != NULL )
		{
			if ( tfldname[0] == EOS )
			{
/* # line 1975 "tfcreate.qsc" */	/* putform */
            {
              if (IIfsetio((char *)0) != 0) {
                IIputfldio(_NameFld,(short *)0,1,32,0,tblname);
              } /* IIfsetio */
            }
/* # line 1976 "tfcreate.qsc" */	/* host code */
			}
/* # line 1977 "tfcreate.qsc" */	/* set_frs */
            {
              if (IIiqset(1,0,(char *)0, (char *)0, (char *)0) != 0) {
                IIstfsio(20,_Form,0,(short *)0,1,30,sizeof(1),(void *)IILQint(
                1));
...
/* # line 1979 "tfcreate.qsc" */	/* host code */
          ...
          {
/* # line 1985 "tfcreate.qsc" */	/* host code */
		if (tfname != NULL && attrchanged)
		{
/* # line 1987 "tfcreate.qsc" */	/* validate */
            {
              if (IIchkfrm() == 0) {
                goto IIfdB1;
              } /* IIchkfrm */
            }
/* # line 1988 "tfcreate.qsc" */	/* host code */
			IIUGmsg(ERget(S_VF00EB_EndRequired), TRUE, 0);
/* # line 1989 "tfcreate.qsc" */	/* resume */
            {
              if (1) goto IIfdB1;
            }
/* # line 1990 "tfcreate.qsc" */	/* host code */
		}
/* # line 1991 "tfcreate.qsc" */	/* breakdisplay */
            {
              if (1) goto IIfdE1;
            }
          }
          ...
          {
/* # line 1995 "tfcreate.qsc" */	/* host code */
		/* Implement the Find command. */
            i4 nrows;
/* # line 1998 "tfcreate.qsc" */	/* inquire_frs */
            {
              if (IIiqset(3,0,_Form,(char *)0, (char *)0) != 0) {
                IIiqfsio((short *)0,1,30,4,&nrows,31,_TableFld,0);
              } /* IIiqset */
            }
/* # line 1999 "tfcreate.qsc" */	/* host code */
		if (nrows == 0)
		{
			IIUGmsg(ERget(S_VF00EC_NoCols), TRUE, 0);
/* # line 2002 "tfcreate.qsc" */	/* resume */
            {
              if (1) goto IIfdB1;
            }
/* # line 2003 "tfcreate.qsc" */	/* host code */
		}
		FEtabfnd( _Form, _TableFld );
          }
        } else if (IIretval() == 9) {
          {
/* # line 2009 "tfcreate.qsc" */	/* host code */
		/* Implement the Top command. */
/* # line 2010 "tfcreate.qsc" */	/* scroll */
            {
              if (IItbsetio(1,_Form,_TableFld,-3) != 0) {
                IItbsmode((char *)"to");
                if (IItscroll(0,1) != 0) {
          ...
          {
/* # line 2014 "tfcreate.qsc" */	/* host code */
		/* Implement the Bottom command. */
/* # line 2015 "tfcreate.qsc" */	/* scroll */
            {
              if (IItbsetio(1,_Form,_TableFld,-3) != 0) {
                IItbsmode((char *)"to");
                if (IItscroll(0,-1) != 0) {
          ...
          {
/* # line 2021 "tfcreate.qsc" */	/* host code */
		FEhelp(VFH_TBLFLD, ERget(S_VF00ED_CreateEditTblFld));
          }
        } else if (IIretval() == 12) {
          {
            i4 maxrow;
/* # line 2027 "tfcreate.qsc" */	/* host code */
		i4	stat;
		FIELD	*tffield;
            char showlines[10];
            char titledisp[10];
            ...
            char xbottom[10];
            char xclsep[10];
/* # line 2037 "tfcreate.qsc" */	/* inquire_frs */
            {
              if (IIiqset(1,0,(char *)0, (char *)0, (char *)0) != 0) {
                IIiqfsio((short *)0,1,30,4,&maxrow,20,_Form,0);
              } /* IIiqset */
            }
/* # line 2038 "tfcreate.qsc" */	/* host code */
		if ( maxrow == 0 && !attrchanged )
/* # line 2039 "tfcreate.qsc" */	/* breakdisplay */
            {
              if (1) goto IIfdE1;
            }
/* # line 2041 "tfcreate.qsc" */	/* host code */
		...
		*/
/* # line 2045 "tfcreate.qsc" */	/* message */
            {
              IImessage(
...
/* # line 2048 "tfcreate.qsc" */	/* getform */
            {
              if (IIfsetio((char *)0) != 0) {
                IIgetfldio((short *)0,1,32,FE_MAXNAME + 1-1,tfldname,_NameFld);
...
/* # line 2052 "tfcreate.qsc" */	/* host code */
		(VOID) STtrmwhite(tfldname);
		if (!vffnmchk(tfldname, ERget(F_VF0031_TblFld)))
		{
/* # line 2055 "tfcreate.qsc" */	/* resume */
            {
              IIresfld(_NameFld);
              if (1) goto IIfdB1;
            }
/* # line 2056 "tfcreate.qsc" */	/* host code */
		}
		CVlower(tfldname);
		if ( iivfRTIspecial )
		{
/* # line 2061 "tfcreate.qsc" */	/* getform */
            {
              if (IIfsetio((char *)0) != 0) {
...
/* # line 2064 "tfcreate.qsc" */	/* host code */
		}
...
/* # line 2091 "tfcreate.qsc" */	/* resume */
            {
              if (1) goto IIfdB1;
            }
/* # line 2092 "tfcreate.qsc" */	/* host code */
		}
...
/* # line 2109 "tfcreate.qsc" */	/* resume */
            {
              if (1) goto IIfdB1;
            }
/* # line 2110 "tfcreate.qsc" */	/* host code */
		}
		if ((tfname == NULL)
			&& (vfnmunique(tfldname, TRUE, AFIELD) == FOUND))
		{
			IIUGerr(E_VF000A_internal_name_exists, UG_ERR_ERROR,
				1, tfldname);
/* # line 2117 "tfcreate.qsc" */	/* resume */
            {
              IIresfld(_NameFld);
              if (1) goto IIfdB1;
            }
/* # line 2118 "tfcreate.qsc" */	/* host code */
		}
		createtbfl(tffield, stat);
/* # line 2121 "tfcreate.qsc" */	/* enddisplay */
            {
              if (1) goto IIfdF1;
            }
          }
...
/* # line 2123 "tfcreate.qsc" */	/* host code */
	FTclear();
  }
/*{
...
/* # line 2169 "tfcreate.qsc" */	/* display */
  {
...
IIfdI3:;
    ...
    {
/* # line 2172 "tfcreate.qsc" */	/* putform */
      {
        if (IIfsetio((char *)0) != 0) {
          IIputfldio((char *)"title",(short *)0,1,32,0,titlestr);
        } /* IIfsetio */
      }
/* # line 2173 "tfcreate.qsc" */	/* putform */
      {
        if (IIfsetio((char *)0) != 0) {
...
IIfdB3:
    while (IIrunform() != 0) {
      if (IIretval() == 1) {
        {
/* # line 2178 "tfcreate.qsc" */	/* getform */
          {
            if (IIfsetio((char *)0) != 0) {
              IIgetfldio((short *)0,1,32,0,tbls,(char *)"tablename");
            } /* IIfsetio */
          }
/* # line 2180 "tfcreate.qsc" */	/* host code */
	if (tbls[0] == EOS)     /* if it's a null name */
	{
			...
			2, (PTR) ERget(FE_OK), (PTR) ERget(FE_Cancel));
/* # line 2188 "tfcreate.qsc" */	/* resume */
          {
            if (1) goto IIfdB3;
          }
/* # line 2189 "tfcreate.qsc" */	/* host code */
	}
	...
	if (prompttype == QN_JDF_PROMPT)
	{
		...
		{
/* # line 2201 "tfcreate.qsc" */	/* resume */
          {
            if (1) goto IIfdB3;
          }
/* # line 2202 "tfcreate.qsc" */	/* host code */
		}
...
/* # line 2213 "tfcreate.qsc" */	/* breakdisplay */
          {
            if (1) goto IIfdE3;
          }
        }
        ...
        {
/* # line 2219 "tfcreate.qsc" */	/* host code */
	tbls[0] = EOS;
/* # line 2220 "tfcreate.qsc" */	/* breakdisplay */
          {
            if (1) goto IIfdE3;
          }
        }
        ...
        {
/* # line 2226 "tfcreate.qsc" */	/* host code */
	if ( prompttype == QN_JDF_PROMPT )
	{
		char	hlpbuf[132+1];
	...
	{
/* # line 2252 "tfcreate.qsc" */	/* putform */
          {
            if (IIfsetio((char *)0) != 0) {
              IIputfldio((char *)"tablename",(short *)0,1,32,0,p_tbl);
            } /* IIfsetio */
          }
/* # line 2253 "tfcreate.qsc" */	/* host code */
	}
        }
      } else if (IIretval() == 4) {
        {
/* # line 2259 "tfcreate.qsc" */	/* host code */
...
/* # line 2272 "tfcreate.qsc" */	/* host code */
}
