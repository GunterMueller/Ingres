...
/* # line 218 "dupfld.sc" */	/* repeated select */
  {
    IIsexec();
    while (IInexec() == 0) {
      IIsqInit((char *)0);
      IIexExec(1,(char *)"dupfld1",7513,3838);
      IIputdomio((short *)0,1,30,4,&id);
      IIretinit((char *)0,0);
      if (IInexec() == 0) {
        IIsqInit((char *)0);
        IIexDefine(1,(char *)"dupfld1",7513,3838);
...
_id=");
        ...
        IIexDefine(0,(char *)"dupfld1",7513,3838);
        if (IIerrtest() == 0) {
          IIsexec();
        } /* IIerrtest */
      } /* IInexec */
...
/* # line 258 "dupfld.qsc" */	/* host code */
					need_toinit = FALSE;
					for (i = 0; i < DUPMAXDISP; i++)
					{
/* # line 261 "dupfld.qsc" */	/* loadtable */
  {
...
/* # line 266 "dupfld.qsc" */	/* host code */
					}
				}
/* # line 268 "dupfld.qsc" */	/* loadtable */
  {
    if (IItbact(Form,TFld,1) != 0) {
...
/* # line 303 "dupfld.qsc" */	/* host code */
		}
	}
/* # line 306 "dupfld.qsc" */	/* putform */
  {
    if (IIfsetio(Form) != 0) {
...
/* # line 323 "dupfld.qsc" */	/* host code */
	    ...
	    */
	    ...
	    fldcount = 0;
/* # line 406 "dupfld.sc" */	/* repeated select */
  {
    IIsexec();
    while (IInexec() == 0) {
      IIsqInit((char *)0);
      IIexExec(1,(char *)"dupfld2",7514,9980);
      IIputdomio((short *)0,1,30,4,&id);
      ...
      if (IInexec() == 0) {
        IIsqInit((char *)0);
        IIexDefine(1,(char *)"dupfld2",7514,9980);
        IIwritio(0,(short *)0,1,32,0,(char *)
...
"flprec, flsubseq from ii_fields where object_id=");
        ...
        IIputdomio((short *)0,1,30,4,&seq2);
        IIexDefine(0,(char *)"dupfld2",7514,9980);
        if (IIerrtest() == 0) {
          IIsexec();
        } /* IIerrtest */
      } /* IInexec */
		    ...
		    if (fldcount && seq1 == seq2)
		    {
			    ...
			    */
			    IIUGerr(E_VF013E_TooManyRows, UG_ERR_ERROR,
				    2, savename, nm);
			    error = TRUE;
/* # line 432 "dupfld.sc" */	/* endselect */
      {
        IIbreak();
        if (1) goto IIrtE2;
      }
/* # line 433 "dupfld.sc" */	/* host code */
		    }
		    /*
...
/* # line 660 "dupfld.sc" */	/* repeated select */
  {
    IIsexec();
    while (IInexec() == 0) {
      IIsqInit((char *)0);
      IIexExec(1,(char *)"dupfld3",7515,13042);
      ...
      if (IInexec() == 0) {
        IIsqInit((char *)0);
        IIexDefine(1,(char *)"dupfld3",7515,13042);
        IIwritio(0,(short *)0,1,32,0,(char *)
...
")order by object_name, object_owner");
        IIexDefine(0,(char *)"dupfld3",7515,13042);
        if (IIerrtest() == 0) {
          IIsexec();
        } /* IIerrtest */
      } /* IInexec */
...
/* # line 671 "dupfld.qsc" */	/* host code */
					need_toinit = FALSE;
					for (i = 0; i < DUPMAXDISP; i++)
					{
/* # line 674 "dupfld.qsc" */	/* loadtable */
  {
    if (IItbact(Form,TFld,1) != 0) {
...
/* # line 677 "dupfld.qsc" */	/* host code */
					}
				}
/* # line 679 "dupfld.qsc" */	/* loadtable */
  {
    if (IItbact(Form,TFld,1) != 0) {
...
/* # line 701 "dupfld.qsc" */	/* host code */
				need_toinit = FALSE;
				for (i = 0; i < DUPMAXDISP; i++)
				{
/* # line 704 "dupfld.qsc" */	/* loadtable */
  {
    if (IItbact(Form,TFld,1) != 0) {
      IItcoputio((char *)"name",(short *)0,1,32,0,nmlist2[i]);
      IItcoputio((char *)"id",(short *)0,1,30,4,&idlist2[i]);
...
/* # line 707 "dupfld.qsc" */	/* host code */
				}
			}
/* # line 709 "dupfld.qsc" */	/* loadtable */
  {
    if (IItbact(Form,TFld,1) != 0) {
      IItcoputio((char *)"name",(short *)0,1,32,0,loadname);
      IItcoputio((char *)"id",(short *)0,1,30,4,&loadid);
...
/* # line 721 "dupfld.qsc" */	/* host code */
		for (i = 0; i < listcount; i++)
		{
			loadname = nmlist2[i];
			loadid = idlist2[i];
/* # line 725 "dupfld.qsc" */	/* loadtable */
  {
    if (IItbact(Form,TFld,1) != 0) {
      IItcoputio((char *)"name",(short *)0,1,32,0,loadname);
      IItcoputio((char *)"id",(short *)0,1,30,4,&loadid);
...
/* # line 750 "dupfld.qsc" */	/* message */
  {
    IImessage(ERget(F_VF007C_RetFlds));
  }
/* # line 751 "dupfld.qsc" */	/* host code */
		...
		for (i = 0; i < endFrame; i++, lp++)
		{
			for (lt = *lp; lt != NNIL; lt = vflnNext(lt, i))
			{
				...
				else
				{
					if (need_toinit)
					{
/* # line 896 "dupfld.qsc" */	/* inittable */
  {
    if (IItbinit(Form,TFld,(char *)"r") != 0) {
      IIthidecol((char *)"idfld",(char *)"i4");
      IItfill();
    } /* IItbinit */
  }
/* # line 898 "dupfld.qsc" */	/* host code */
						...
						{
/* # line 901 "dupfld.qsc" */	/* loadtable */
  {
    if (IItbact(Form,TFld,1) != 0) {
      IItcoputio((char *)"name",(short *)0,1,32,0,nmlist1[j]);
      IItcoputio((char *)"idfld",(short *)0,1,30,4,&idlist1[j]);
      IITBceColEnd();
    } /* IItbact */
  }
/* # line 904 "dupfld.qsc" */	/* host code */
						}
					}
					fldptr = (PTR) fd;
					fdname = hdr->fhdname;
/* # line 908 "dupfld.qsc" */	/* loadtable */
  {
    if (IItbact(Form,TFld,1) != 0) {
      IItcoputio((char *)"name",(short *)0,1,32,0,fdname);
      IItcoputio((char *)"idfld",(short *)0,1,30,4,&fldptr);
      IITBceColEnd();
    } /* IItbact */
  }
/* # line 910 "dupfld.qsc" */	/* host code */
				}
				listcount++;
			}
		}
...
/* # line 921 "dupfld.qsc" */	/* host code */
			for (i = 0; i < listcount; i++)
			{
				fldptr = idlist1[i];
				fdname = nmlist1[i];
/* # line 925 "dupfld.qsc" */	/* loadtable */
  {
    if (IItbact(Form,TFld,1) != 0) {
      IItcoputio((char *)"name",(short *)0,1,32,0,fdname);
      IItcoputio((char *)"idfld",(short *)0,1,30,4,&fldptr);
...
/* # line 946 "dupfld.qsc" */	/* host code */
		...
		if (mitem == MU_LISTFORMS)
		{
		    ...
		    */
/* # line 953 "dupfld.qsc" */	/* message */
  {
    IImessage(ERget(F_VF007E_RetForms));
  }
/* # line 954 "dupfld.qsc" */	/* host code */
		    IIVFlfListForms();
		}
		else if (++sel_row > 0)
		{
/* # line 958 "dupfld.qsc" */	/* scroll */
  {
    if (IItbsetio(1,Form,TFld,-3) != 0) {
      IItbsmode((char *)"to");
...
/* # line 959 "dupfld.qsc" */	/* getrow */
  {
    if (IItbsetio(2,Form,TFld,-2) != 0) {
      IItcogetio((short *)0,1,32,199,buf,(char *)"name");
      IItcogetio((short *)0,1,30,4,&fldptr,(char *)"idfld");
      IITBceColEnd();
    } /* IItbsetio */
  }
/* # line 960 "dupfld.qsc" */	/* host code */
		    fdname = buf;
		    fd = (FIELD *) fldptr;
		    for (;;)
		    {
/* # line 964 "dupfld.qsc" */	/* prompt */
  {
    IIprmptio(0,ERget(F_VF0077_NewFldName),(short *)0,1,32,199,buf);
  }
/* # line 965 "dupfld.qsc" */	/* host code */
			    /*
	...
	{
/* # line 1097 "dupfld.qsc" */	/* message */
  {
    IImessage(ERget(F_VF007F_NoCurFld));
  }
/* # line 1099 "dupfld.qsc" */	/* host code */
		/*
		**  Grab list of forms from db.
		*/
		IIVFlfListForms();
	...
	*/
/* # line 1109 "dupfld.qsc" */	/* redisplay */
  {
    IIredisp();
  }
/* # line 1110 "dupfld.qsc" */	/* host code */
