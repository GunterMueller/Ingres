...
IIfdB1:
    ...
    if (IIretval() == 1) {
      {
/* # line 144 "vfedbox.qsc" */	/* host code */
      ...
      {
/* # line 160 "vfedbox.qsc" */	/* host code */
			vfBoxAttr(ps);
			break;
      }
    } else if (IIretval() == 3) {
      {
/* # line 165 "vfedbox.qsc" */	/* host code */
			STcopy(ERget(S_VF0136_EDITING_BOX_LINE), hlpbuf);
			vfhelpsub(VFH_EDBOX, hlpbuf, NULL);
      }
    } else if (IIretval() == 4) {
      {
/* # line 170 "vfedbox.qsc" */	/* host code */
			break;
      }
    } else {
      if (1) goto IIfdE1;
...
/* # line 172 "vfedbox.qsc" */	/* host code */
	}
	setGlMove(ps);
	vfTrigUpd();
...
POS	*ps;
{
  ...
  char uflag[6];
	char	hlpbuf[100];
/* # line 333 "vfedbox.qsc" */	/* clear */
  {
    IIclrscr();
  }
/* # line 335 "vfedbox.qsc" */	/* display */
  {
...
IIfdI2:;
    ...
    {
/* # line 338 "vfedbox.qsc" */	/* inittable */
      {
...
/* # line 352 "vfedbox.qsc" */	/* host code */
...
/* # line 363 "vfedbox.qsc" */	/* host code */
		...
		{
/* # line 372 "vfedbox.qsc" */	/* resume */
          {
            IIresnext();
            if (1) goto IIfdB2;
          }
/* # line 373 "vfedbox.qsc" */	/* host code */
		}
        }
      } else if (IIretval() == 3) {
        {
/* # line 379 "vfedbox.qsc" */	/* host code */
		IIUFfieldHelp();
        }
      } else if (IIretval() == 4) {
        {
/* # line 383 "vfedbox.qsc" */	/* host code */
		STcopy(ERget(S_VF0132_Box_Attributes), hlpbuf);
		FEhelp(VFH_BOXATTR, hlpbuf);
        }
      } else if (IIretval() == 5) {
        {
/* # line 388 "vfedbox.qsc" */	/* validate */
          {
            if (IIvalfld((char *)"vfboxatr") == 0) {
              goto IIfdB2;
            } /* IIvalfld */
          }
/* # line 389 "vfedbox.qsc" */	/* host code */
		flags = i = 0;
/* # line 390 "vfedbox.qsc" */	/* unloadtable */
          {
            ...
            while (IItunload() != 0) {
              ...
              IITBceColEnd();
              {
/* # line 392 "vfedbox.qsc" */	/* host code */
			if (i < MAXBOXATR)
			{
			...
			{
/* # line 399 "vfedbox.qsc" */	/* endloop */
                {
                  if (1) goto IItbE1;
                }
/* # line 400 "vfedbox.qsc" */	/* host code */
			}
              }
            } /* IItunload */
IItbE1:
...
/* # line 402 "vfedbox.qsc" */	/* getform */
          {
            if (IIfsetio((char *)0) != 0) {
              IIgetfldio((short *)0,1,30,4,&curcolor,(char *)"color");
            } /* IIfsetio */
          }
/* # line 403 "vfedbox.qsc" */	/* host code */
		vfsetcolor(&flags, curcolor);
		*(i4*)ps->ps_feat = flags;
/* # line 405 "vfedbox.qsc" */	/* enddisplay */
          {
            if (1) goto IIfdF2;
          }
        }
...
/* # line 407 "vfedbox.qsc" */	/* host code */
	FTclear();
}
VOID
allocBoxAttr()
