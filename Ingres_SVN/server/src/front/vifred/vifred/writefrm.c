...
**              the default int value for a function will truncate a  
**              64-bit address on ris_u64 platform. 
**	21-jan-1999 (hanch04)
...
**	    replace nat and longnat with i4
**	13-Mar-2003 (hanje04)
**	    Prototype FDpar_str() to stop returned pointer begin truncated on 
	...
	else if ( vforigintype == OT_EDIT && !STequal(formname, vforgname) )
	{
		...
		*/
			...
			uidbdata->user) == OK )
		{
			...
			*/
/* # line 328 "writefrm.sc" */	/* select */
  {
    IIsqInit((char *)0);
    IIwritio(0,(short *)0,1,32,0,(char *)
"select relname, qbftype, relowner from ii_qbfnames where object_id=");
    IIputdomio((short *)0,1,30,4,&id_qbfname);
    IIwritio(0,(short *)0,1,32,0,(char *)"and frname=");
    IIputdomio((short *)0,1,32,0,torgname);
    IIretinit((char *)0,0);
    if (IIerrtest() != 0) goto IIrtE1;
IIrtB1:
    while (IInextget() != 0) {
      IIgetdomio((short *)0,1,32,FE_MAXNAME + 2 + 1-1,tname);
      IIgetdomio((short *)0,1,30,4,&type);
      IIgetdomio(&t_null_owner,1,32,FE_MAXNAME + 2 + 1-1,towner);
      if (IIerrtest() != 0) goto IIrtB1;
/* # line 334 "writefrm.sc" */	/* host code */
				found = TRUE;
/* # line 335 "writefrm.sc" */	/* endselect */
      {
        IIbreak();
        if (1) goto IIrtE1;
      }
...
/* # line 337 "writefrm.sc" */	/* host code */
			if (found)
			{
...
/* # line 443 "writefrm.sc" */	/* host code */
		if (FEinqerr())
		{
			return(FAIL);
		}
