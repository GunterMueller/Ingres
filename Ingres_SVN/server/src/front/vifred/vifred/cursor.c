...
# endif
		case ALIGN:
			...
			IIVFrcRulersControl();
/* # line 421 "cursor.qsc" */	/* redisplay */
  {
    IIredisp();
  }
/* # line 422 "cursor.qsc" */	/* host code */
...
/* # line 442 "cursor.qsc" */	/* redisplay */
  {
    IIredisp();
  }
/* # line 443 "cursor.qsc" */	/* host code */
			IIVTlf( frame, FALSE, FALSE );
			continue;
		case COLOPTS:
...
/* # line 531 "cursor.qsc" */	/* redisplay */
  {
    IIredisp();
  }
/* # line 532 "cursor.qsc" */	/* host code */
			    IIVTlf(frame, FALSE, FALSE);
...
# endif
				...
				NULL, obj_type, help_subject, help_file);
/* # line 631 "cursor.qsc" */	/* redisplay */
  {
    IIredisp();
  }
/* # line 632 "cursor.qsc" */	/* host code */
			    IIVTlf(frame, FALSE, FALSE);
			    if (choice == CONFCH_YES)
			    {
				/* Save, then exit. */
...
# endif
			...
			FTclear();
# ifdef FORRBF
/* # line 674 "cursor.qsc" */	/* endforms */
  {
    IIendforms();
  }
/* # line 675 "cursor.qsc" */	/* host code */
			EXsignal(EXEXIT, 2, (long)0, (long)NOABORT);
# else
			if (!Vfeqlcall)
			{
/* # line 679 "cursor.qsc" */	/* endforms */
  {
    IIendforms();
  }
/* # line 680 "cursor.qsc" */	/* host code */
				enddb();
				vfexit(OK);
			}
...
/* # line 875 "cursor.qsc" */	/* display */
  {
    if (IIdispfrm((char *)"vfrulfrm",(char *)"f") == 0) goto IIfdE1;
    goto IImuI1;
IIfdI1:;
    if (IIfsetio((char *)0) == 0) goto IIfdE1;
    {
/* # line 878 "cursor.qsc" */	/* host code */
		if (IIVFxh_disp)
		{
...
/* # line 896 "cursor.qsc" */	/* putform */
      {
        if (IIfsetio((char *)0) != 0) {
          IIputfldio((char *)"ruler",(short *)0,1,32,0,ruler_val);
        } /* IIfsetio */
      }
/* # line 897 "cursor.qsc" */	/* putform */
      {
        if (IIfsetio((char *)0) != 0) {
          IIputfldio((char *)"sedge",(short *)0,1,32,0,sedge_val);
        } /* IIfsetio */
      }
    }
IIfdB1:
    while (IIrunform() != 0) {
      if (IIretval() == 1) {
        {
/* # line 902 "cursor.qsc" */	/* host code */
		cancelled = TRUE;
/* # line 903 "cursor.qsc" */	/* breakdisplay */
          {
            if (1) goto IIfdE1;
          }
        }
        ...
        {
/* # line 908 "cursor.qsc" */	/* host code */
		FEhelp(VFH_RUCTRL, ERget(S_VF016F_RULER_CTRL));
        }
      } else if (IIretval() == 3) {
        {
/* # line 913 "cursor.qsc" */	/* enddisplay */
          {
            if (1) goto IIfdF1;
          }
        }
...
IImuI1:
    ...
    if (IInmuact(ERget(FE_Cancel),ERget(F_FE0103_ExplCancel),0,2,1) == 0) 
    goto IIfdE1;
    IIFRInternal(0);
    ...
    if (IInmuact(ERget(FE_End),ERget(F_FE0102_ExplEnd),2,2,3) == 0) goto IIfdE1;
    IIFRInternal(0);
...
/* # line 916 "cursor.qsc" */	/* host code */
	if (cancelled)
	{
		return;
	}
/* # line 921 "cursor.qsc" */	/* getform */
  {
    if (IIfsetio((char *)"vfrulfrm") != 0) {
      IIgetfldio((short *)0,1,32,9,ruler_val,(char *)"ruler");
    } /* IIfsetio */
  }
/* # line 922 "cursor.qsc" */	/* getform */
  {
    if (IIfsetio((char *)"vfrulfrm") != 0) {
      IIgetfldio((short *)0,1,32,9,sedge_val,(char *)"sedge");
    } /* IIfsetio */
  }
/* # line 924 "cursor.qsc" */	/* host code */
