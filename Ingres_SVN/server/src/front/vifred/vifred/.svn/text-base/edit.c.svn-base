...
**	08-04-97 (i4jo01)
**		Do not update the precision value for decimal fields
**		if not running standalone. 
**	13/08/98 (kitch01)
**		Bug 91491. Back out above change (08-04-97) as it prevents 
**		precision value	for decimal fields being updated. Required
**		by this bug fix. The above change has been reworked and fixed
**		in fmvvalid.c.
**	21-jan-1999 (hanch04)
