...
# define	TO_DB		FALSE
# define	TO_FILE		TRUE
GLOBALREF 	LOCATION	VFFLD;
GLOBALREF 	LOCATION	VFTRD;
...
static	char		*ANUMBER = ERx("\t%d");
  ...
  GLOBALREF char *fname;
  GLOBALREF OOID vffrmid;
/*{
...
/* # line 369 "fasttodb.sc" */	/* host code */
	if (FEinqerr())
	{
		return(FAIL);
	}
...
# endif
/* # line 468 "fasttodb.sc" */	/* copy table */
  {
    IIsqInit((char *)0);
    IIwritio(0,(short *)0,1,32,0,(char *)
...
/* # line 499 "fasttodb.sc" */	/* host code */
	if (FEinqerr())
	{
		return(FAIL);
	}
...
bool	dest;
{
  ...
  char nchar[2];
	...
	else			/*  destination is the database */
	{
		...
		**	INSERT.
		*/
/* # line 693 "fasttodb.sc" */	/* repeat insert */
  {
    IIsexec();
    while (IInexec() == 0) {
      IIsqInit((char *)0);
      IIexExec(1,(char *)"fasttodb1",7511,17082);
      IIputdomio((short *)0,1,30,4,&vffrmid);
      ...
      if (IInexec() == 0) {
        IIsqInit((char *)0);
        IIexDefine(1,(char *)"fasttodb1",7511,17082);
        IIwritio(0,(short *)0,1,32,0,(char *)
...
"fldefault, flformat, flvalmsg, flvalchk)values(");
        ...
        IIputdomio((short *)0,1,32,0,nchar);
        IIwritio(0,(short *)0,1,32,0,(char *)")");
        IIexDefine(0,(char *)"fasttodb1",7511,17082);
        if (IIerrtest() == 0) {
          IIsexec();
        } /* IIerrtest */
      } /* IInexec */
...
/* # line 710 "fasttodb.sc" */	/* host code */
		if (FEinqerr())
		{
			return(FAIL);
		}
  ...
  i4 t_subseq;
	...
	{	
		...
		*/
		...
		t_subseq = subseq++;  
/* # line 901 "fasttodb.sc" */	/* repeat insert */
  {
    IIsexec();
    while (IInexec() == 0) {
      IIsqInit((char *)0);
      IIexExec(1,(char *)"fasttodb2",7512,22457);
      IIputdomio((short *)0,1,30,4,&vffrmid);
      IIputdomio((short *)0,1,30,4,&t_fhseq);
      IIputdomio((short *)0,1,32,0,intrname);
      ...
      if (IInexec() == 0) {
        IIsqInit((char *)0);
        IIexDefine(1,(char *)"fasttodb2",7512,22457);
        IIwritio(0,(short *)0,1,32,0,(char *)
"insert into ii_fields(object_id, flseq, fldname, fldatatype, fllength\
, flprec, flwidth, flmaxlin, flmaxcol, flposy, flposx, fldatawidth, fl\
datalin, fldatacol, fltitle, fltitcol, fltitlin, flintrp, fldflags, fl\
...
", flvalmsg, flvalchk, fltype, flsubseq)values(");
        ...
        IIputdomio((short *)0,1,30,4,&t_subseq);
        IIwritio(0,(short *)0,1,32,0,(char *)")");
        IIexDefine(0,(char *)"fasttodb2",7512,22457);
        if (IIerrtest() == 0) {
          IIsexec();
        } /* IIerrtest */
      } /* IInexec */
...
/* # line 918 "fasttodb.sc" */	/* host code */
		if (FEinqerr())
		{
			return(FAIL);
		}
...
/* # line 1015 "fasttodb.sc" */	/* repeat insert */
  {
    IIsexec();
    while (IInexec() == 0) {
      IIsqInit((char *)0);
      IIexExec(1,(char *)"fasttodb3",7513,10677);
      IIputdomio((short *)0,1,30,4,&vffrmid);
      ...
      if (IInexec() == 0) {
        IIsqInit((char *)0);
        IIexDefine(1,(char *)"fasttodb3",7513,10677);
        IIwritio(0,(short *)0,1,32,0,(char *)
...
flags, trim_font, trim_ptsz, trim_trim)values(");
        ...
        IIputdomio((short *)0,1,32,0,buf);
        IIwritio(0,(short *)0,1,32,0,(char *)")");
        IIexDefine(0,(char *)"fasttodb3",7513,10677);
        if (IIerrtest() == 0) {
          IIsexec();
        } /* IIerrtest */
      } /* IInexec */
...
/* # line 1022 "fasttodb.sc" */	/* host code */
			if (FEinqerr())
			{
				return(FAIL);
			}
...
# endif
/* # line 1063 "fasttodb.sc" */	/* copy table */
  {
    IIsqInit((char *)0);
    IIwritio(0,(short *)0,1,32,0,(char *)
...
/* # line 1074 "fasttodb.sc" */	/* host code */
	if (FEinqerr())
	{
		return(FAIL);
	}
...
# ifdef IBM370
		STpolycat(2,
		 ...
		 ERx(" VALUES (?, ?, ?, ?, ?)"), sql_buf);
/* # line 1219 "fasttodb.sc" */	/* prepare */
  {
    IIsqInit((char *)0);
    IIsqPrepare(0,(char *)"iivfccf_stmt",(char *)0,0,sql_buf);
  }
/* # line 1220 "fasttodb.sc" */	/* execute */
  {
    IIsqInit((char *)0);
...
/* # line 1222 "fasttodb.sc" */	/* host code */
# else
/* # line 1223 "fasttodb.sc" */	/* repeat insert */
  {
    IIsexec();
    while (IInexec() == 0) {
      IIsqInit((char *)0);
      IIexExec(1,(char *)"fasttodb4",7514,692);
      IIputdomio((short *)0,1,30,4,&vffrmid);
      IIputdomio((short *)0,1,30,4,&seqno);
      IIputdomio((short *)0,1,30,4,&rowsize);
      IIputdomio((short *)0,1,30,4,&cfsize);
      ...
      if (IInexec() == 0) {
        IIsqInit((char *)0);
        IIexDefine(1,(char *)"fasttodb4",7514,692);
        IIwritio(0,(short *)0,1,32,0,(char *)
...
fdata)values(");
        ...
        IIputdomio((short *)0,1,44,0,&dbv);
        IIwritio(0,(short *)0,1,32,0,(char *)")");
        IIexDefine(0,(char *)"fasttodb4",7514,692);
        if (IIerrtest() == 0) {
          IIsexec();
        } /* IIerrtest */
      } /* IInexec */
...
/* # line 1228 "fasttodb.sc" */	/* host code */
# endif
		if (size != 0)
		{
			seqno++;
...
/* # line 1320 "fasttodb.sc" */	/* host code */
	if (FEinqerr())
	{
		return(FAIL);
	}
/* # line 1325 "fasttodb.sc" */	/* delete */
  {
    IIsqInit((char *)0);
    IIwritio(0,(short *)0,1,32,0,(char *)
...
/* # line 1326 "fasttodb.sc" */	/* host code */
	if (FEinqerr())
	{
		return(FAIL);
	}
/* # line 1331 "fasttodb.sc" */	/* delete */
  {
    IIsqInit((char *)0);
    IIwritio(0,(short *)0,1,32,0,(char *)
...
/* # line 1332 "fasttodb.sc" */	/* host code */
	if (FEinqerr())
	{
		return(FAIL);
	}
...
/* # line 1341 "fasttodb.sc" */	/* host code */
	if (FEinqerr())
	{
		return(FAIL);
	}
