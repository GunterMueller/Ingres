...
#define                 PSQ_C_C2SECURE  0x0001
    ...
    i4		    psq_mode;           /* Query/statement mode */
					/* If you change/add any, please
					** update ulddata.roc */
#define                 PSQ_RETRIEVE    1   /* retrieve statement */
#define                 PSQ_RETINTO     2   /* retrieve into statement */
#define                 PSQ_APPEND      3   /* append statement */
#define                 PSQ_REPLACE     4   /* replace statement */
#define                 PSQ_DELETE      5   /* delete statement */
#define                 PSQ_COPY        6   /* copy statement */
#define                 PSQ_DISTCREATE  7   /* distributed create statement */
#define                 PSQ_DESTROY     8   /* destroy statement */
#define                 PSQ_HELP        9   /* help statement (on relations) */
#define                 PSQ_INDEX       10   /* index statement */
#define                 PSQ_MODIFY      11  /* modify statement */
#define                 PSQ_PRINT       12  /* print statement */
#define                 PSQ_RANGE       13  /* range statement */
#define                 PSQ_SAVE        14  /* save statement */
#define                 PSQ_DEFCURS     15  /* define cursor statement - new */
#define                 PSQ_QRYDEFED	16  /* define cursor statement
					    ** plan exists, share it.
					    */
#define                 PSQ_VIEW        17  /* define view statement */
#define                 PSQ_ABSAVE      18  /* abort to savepoint statement */
#define                 PSQ_PROT        19  /* define permit statement */
#define                 PSQ_INTEG       20  /* define integrity statement */
#define                 PSQ_CLSCURS     21  /* close cursor statement */
#define                 PSQ_RELOCATE    22  /* relocate statement */
#define                 PSQ_DEFQRY      23  /* define query statement */
#define                 PSQ_EXECQRY     24  /* execute query statement */
#define                 PSQ_DEFREF      25  /* define reference statement */
#define                 PSQ_BGNTRANS    26  /* begin transaction statement */
#define                 PSQ_ENDTRANS    27  /* end transaction statement */
#define                 PSQ_SVEPOINT    28  /* savepoint statement */
#define                 PSQ_ABORT       29  /* abort statement */
#define			PSQ_DSTINTEG	30  /* destroy integrity statement */
#define			PSQ_DSTPERM	31  /* destroy permit statement */
#define			PSQ_DSTREF	32  /* destroy reference statement */
					    /*
					    ** CREATE EVENT -
					    ** Must match value of DB_EVENT in
					    ** <dbms.h> for text identification
					    */
#define			PSQ_EVENT	33
#define			PSQ_EXCURS	34  /* execute cursor statement */
#define			PSQ_CALLPROC	35  /* execute procedure statement */
#define			PSQ_EVDROP	36  /* DROP EVENT */
#define			PSQ_EVREGISTER	37  /* REGISTER EVENT */
#define			PSQ_EVDEREG	38  /* REMOVE EVENT */
#define			PSQ_EVRAISE	39  /* RAISE EVENT */
#define			PSQ_REPCURS	40  /* replace cursor statement */
#define			PSQ_RETCURS	41  /* retrieve cursor statement */
#define			PSQ_DESCINPUT	42  /* DESCRIBE INPUT */
#define			PSQ_REPDYN	43  /* repeat dynamic q already
					    ** compiled */
#define			PSQ_SCACHEDYN	44  /* set cache_dynamic statement */
#define			PSQ_SNOCACHEDYN	45  /* set nocache_dynamic statement */
#define			PSQ_SAGGR	46  /* set aggregate statement */
#define			PSQ_SCPUFACT	47  /* set cpufactor statement */
#define			PSQ_SDATEFMT	48  /* set date_format statement */
#define			PSQ_SSCACHEDYN	49  /* set session [no]cache_dyn */
#define			PSQ_SDECIMAL	50  /* set decimal statement */
#define			PSQ_SWORKLOC	51  /* set work locations */
		/* 52 unused, available */
#define			PSQ_SJOURNAL	53  /* set journaling statement */
#define			PSQ_SMNFMT	54  /* set money format statement */
#define			PSQ_SMNPREC	55  /* set money precision statement */
		/* 56 unused, available */
		/* 57 unused, available */
#define			PSQ_SRINTO	58  /* set retrieve_into statement */
		/* 59 unused, available */
#define			PSQ_SSQL	60  /* set sql statement */
#define			PSQ_SSTATS	61  /* set statistics statement */
#define			PSQ_SLOCKMODE	62  /* set lockmode statement */
#define			PSQ_DMFTRACE	63  /* set trace point DMxxxx stmt. */
#define			PSQ_PSFTRACE	64  /* set trace point PSxxxx stmt. */
#define			PSQ_SCFTRACE	65  /* set trace point SCxxxx stmt. */
#define			PSQ_RDFTRACE	66  /* set trace point RDxxxx stmt. */
#define			PSQ_QEFTRACE	67  /* set trace point QExxxx stmt. */
#define			PSQ_OPFTRACE	68  /* set trace point OPxxxx stmt. */
#define			PSQ_QSFTRACE	69  /* set trace point QSxxxx stmt. */
#define			PSQ_ADFTRACE	70  /* set trace point ADxxxx stmt. */
#define			PSQ_STRACE	71  /* general set trace statement */
#define			PSQ_DELCURS	72  /* delete cursor statement */
#define			PSQ_SQEP	73  /* set [no]qep statement */
#define			PSQ_COMMIT	74  /* SQL commit work stmnt */
#define			PSQ_DESCRIBE	75  /* SQL describe stmnt */
#define			PSQ_PREPARE	76  /* SQL prepare stmnt */
#define			PSQ_INPREPARE	77  /* SQL prepare into stmnt */
#define			PSQ_ROLLBACK	78  /* SQL rollback work stmnt */
#define			PSQ_AUTOCOMMIT	79  /* SQL autocommit stmnt */
#define			PSQ_RLSAVE	80  /* SQL rollback to savepoint stmt */
#define			PSQ_OBSOLETE	81  /* for obsolete SET commands */
#define			PSQ_JTIMEOUT	82  /* SET JOINOP [NO]TIMEOUT */
#define			PSQ_DEFLOC	83  /* DEFINE LOCATION */
#define			PSQ_GRANT	84  /* SQL grant statement */
#define			PSQ_ALLJOURNAL	85  /* set journaling - no tablename*/
					    /* SCF should do nothing here */
#define			PSQ_50DEFQRY	86  /* 5.0 repeat query */
#define			PSQ_CREDBP	87  /* create db procedure */
#define			PSQ_DRODBP	88  /* drop db procedure */
#define			PSQ_EXEDBP	89  /* execute db procedure */
#define			PSQ_IF		90  /* if stmnt */
#define			PSQ_RETURN	91  /* return stmnt */
#define			PSQ_MESSAGE	92  /* message stmnt */
#define			PSQ_VAR		93  /* declaration of loc var */
#define			PSQ_WHILE	94  /* while stmt (for syntax errors) */
#define			PSQ_ASSIGN	95  /* assign stmt (for syntax errors)*/
#define			PSQ_DIRCON	96  /* Star direct connect */
#define			PSQ_DIRDISCON	97  /* Star direct disconnect */
#define			PSQ_DIREXEC	98  /* DIRECT EXECUTE IMMEDIATE */
#define			PSQ_REMOVE	99  /* REMOVE [TABLE|VIEW]      */
#define			PSQ_0_CRT_LINK 100  /* CREATE LINK */
#define			PSQ_REG_LINK   101  /* REGISTER...AS LINK */
#define			PSQ_SECURE     102  /* PREPARE to COMMIT */
#define			PSQ_REG_IMPORT 103  /* REGISTER...AS IMPORT */
#define                 PSQ_REG_INDEX  104  /* REGISTER INDEX */
#define                 PSQ_REG_REMOVE 105  /* REMOVE [TABLE/INDEX] */
#define			PSQ_DDCOPY     106  /* COPY in STAR */
#define			PSQ_REREGISTER 107  /* REGISTER ... AS REFRESH  */
#define			PSQ_DDLCONCUR  108  /* SET DDL_CONCURRENCY ON|OFF */
	/* 109 unused, available */
#define			PSQ_RULE       110  /* CREATE RULE - global tree and
					    ** text identifier DB_RULE must be
					    ** the same value.
					    */
#define			PSQ_DSTRULE    111  /* DESTROY RULE */
#define			PSQ_RS_ERROR   112  /* RAISE ERROR */
#define			PSQ_CGROUP     113  /* CREATE GROUP */
#define			PSQ_AGROUP     114  /* ALTER  GROUP...ADD  */
#define			PSQ_DGROUP     115  /* ALTER  GROUP...DROP */
#define			PSQ_KGROUP     116  /* DROP   GROUP */
#define			PSQ_CAPLID     117  /* CREATE APLID */
#define			PSQ_AAPLID     118  /* ALTER  APLID */
#define			PSQ_KAPLID     119  /* DROP   APLID */
#define			PSQ_REVOKE     120  /* Generic REVOKE */
#define			PSQ_GDBPRIV    121  /* GRANT  ON DATABASE */
#define			PSQ_RDBPRIV    122  /* REVOKE ON DATABASE */
#define			PSQ_IPROC      123  /* Execute internal DBP */
#define			PSQ_MXQUERY    124  /* SET [NO]MAX... */
#define			PSQ_CUSER      125  /* CREATE USER */
#define			PSQ_AUSER      126  /* ALTER USER */
#define			PSQ_KUSER      127  /* DROP USER */
#define			PSQ_CLOC       128  /* CREATE LOCATION */
#define			PSQ_ALOC       129  /* ALTER LOCATION */
#define			PSQ_KLOC       130  /* DROP LOCATION */
#define			PSQ_CALARM     131  /* CREATE SECURITY_ALARM */
#define			PSQ_KALARM     132  /* DROP SECURITY_ALARM */
#define			PSQ_ENAUDIT    133  /* ENABLE SECURITY_AUDIT */
#define			PSQ_DISAUDIT   134  /* DISABLE SECURITY_AUDIT */
#define			PSQ_COMMENT    135  /* COMMENT ON TABLE/COLUMN */
#define			PSQ_GOKPRIV    136  /* GRANT  ACCESS,UPDATE_SYSCAT */
#define			PSQ_ROKPRIV    137  /* REVOKE ACCESS,UPDATE_SYSCAT */
#define			PSQ_CSYNONYM   138  /* CREATE SYNONYM */
#define			PSQ_DSYNONYM   139  /* DROP SYNONYM   */
					    /* SET SESSION AUTHORIZATION */
#define			PSQ_SET_SESS_AUTH_ID 140
#define			PSQ_ENDLOOP    141  /* ENDLOOP stmt (for syntax err) */
#define			PSQ_SLOGGING   142  /* SET [NO]LOGGING */
#define			PSQ_SON_ERROR  143  /* SET SESSION */
#define                 PSQ_UPD_ROWCNT 144  /* SET UPDATE_ROWCOUNT */
	/* 145 unused, available */
#define			PSQ_DGTT       146  /* DECLARE GLOBAL TEMPORARY TABLE */
#define			PSQ_DGTT_AS_SELECT 147 /* DGTT ... AS SELECT */
#define			PSQ_GWFTRACE   148  /* SET TRACE POINT GWxxx */
#define			PSQ_CONS       149  /* CONSTRAINT (used in DB_QMODE;
					    **      here only as placeholder) */
#define			PSQ_ALTERTABLE 150  /* ALTER TABLE  */
#define         	PSQ_CREATE_SCHEMA 151 /* CREATE SCHEMA */
#define			PSQ_REGPROC    152 /* Execute registered DBP */
#define			PSQ_DDEXECPROC 153 /* Execute Dynamic registered DBP */
#define         	PSQ_CRESETDBP  154  /* create set-input db procedure */
#define                 PSQ_CREATE     155  /* create statement */
#define			PSQ_DROP_SCHEMA 156 /* DROP SCHEMA */
#define			PSQ_SXFTRACE	157 /* SET TRACE POINT SXxxx */
#define			PSQ_SET_SESSION 158 /* SET SESSION ... */
#define			PSQ_ALTAUDIT	159 /* ALTER SECURITY_AUDIT ... */
#define			PSQ_CPROFILE  	160 /* CREATE PROFILE */
#define			PSQ_DPROFILE 	161 /* DROP PROFILE */
#define			PSQ_APROFILE 	162 /* ALTER PROFILE */
#define			PSQ_MXSESSION   163 /* SET [NO]MAX session limits */
	/* 164 unused, available */
#define			PSQ_SETROLE	165 /* SET ROLE */
#define			PSQ_RGRANT 	166 /* GRANT ROLE */
#define			PSQ_RREVOKE 	167 /* REVOKE ROLE */
#define                 PSQ_STRANSACTION 168 /* <set transaction statement> */
#define                 PSQ_XA_ROLLBACK  169 /* rollback distributed trans */
#define                 PSQ_XA_COMMIT    170 /* commit distributed trans */
#define                 PSQ_XA_PREPARE   171 /* prepare to commit distributed */
					     /* transaction */
#define                 PSQ_ATBL_ADD_COLUMN 172  /* ALTER TABLE ADD COLUMN */
#define                 PSQ_ATBL_DROP_COLUMN 173 /* ALTER TABLE DROP COLUMN */
#define			PSQ_REPEAT	174 /* repeat stmt (for syntax errors) */
#define			PSQ_FOR		175 /* for stmt (for syntax errors) */
#define			PSQ_RETROW	176 /* return row stmt (for syntax) */
#define			PSQ_SETRANDOMSEED 177 /* SET RANDOM_SEED */
#define			PSQ_ALTERDB	178 /* ALTER DATABASE */
#define			PSQ_CSEQUENCE	179 /* create sequence */
#define			PSQ_ASEQUENCE   180 /* alter sequence */
#define			PSQ_DSEQUENCE	181 /* drop sequence */
#define                 PSQ_ATBL_ALTER_COLUMN 182  /* ALTER TABLE ALTER COLUMN */
#define			PSQ_SETUNICODESUB  183 /* SET [NO]UNICODE_SUBSTITUTION */
#define                 PSQ_GCA_XA_START    184 /* xa_start() */
#define                 PSQ_GCA_XA_END      185 /* xa_end() */
#define                 PSQ_GCA_XA_PREPARE  186 /* xa_prepare() */
#define                 PSQ_GCA_XA_COMMIT   187 /* xa_commit()  */
#define                 PSQ_GCA_XA_ROLLBACK 188 /* xa_rollback() */
#define			PSQ_FREELOCATOR	189	/* FREE LOCATOR */
				/* If you change/add any, please
				** update ulddata.roc */
...
#define	    PST_NOMETA		0
    ...
    /* PST_ANY_SUBSELECT defines that this operator is TRUE for each value
    ...
    */
#define	    PST_ANY_SUBSELECT	2

    /* PST_ALL_SUBSELECT defines that this operator is TRUE for each value
    ** on the left side if the operator defined by pst_opno is TRUE for
    ...
    */
#define	    PST_ALL_SUBSELECT	3

    /* PST_ONE_SUBSELECT defines that only zero or one value can be returned
    ** from the subselect on the right side. If two or more values are returned
    ** then an error should be returned to the user.
    */
#define	    PST_ONE_SUBSELECT	1
...
#define	    PST_DOESNT_APPLY	2       /* not a LIKE operator		    */
    ...
    i2		pst_flags;
					/* If this is a PST_AND node, then
					** the left conjunct can be used in
					** a Smart Disk scan.
					*/
#define		PST_SD_OK	1	
...
#define		PST_INLIST	16	/* Indicates that this "=" node 
					...
					** as part of in-list optimization */
...
{
    /* DB_DATA_VALUE pst_srceval;/* The resolved source/comparand type */
...
typedef struct
{
    i4              pst_type;           /* code identifying node type */
#define                 PST_AND         0   /* Takes PST_OP_NODE */
#define                 PST_OR          1   /* Takes PST_OP_NODE */
#define                 PST_UOP         2   /* Takes PST_OP_NODE */
#define                 PST_BOP         3   /* Takes PST_OP_NODE */
#define                 PST_AOP         4   /* Takes PST_OP_NODE */
#define                 PST_COP         5   /* Takes PST_OP_NODE */
#define                 PST_CONST       6   /* Takes PST_CNST_NODE */
#define                 PST_RESDOM      7   /* Takes PST_RSDM_NODE */
#define                 PST_VAR         8   /* Takes PST_VAR_NODE */
#define                 PST_ROOT        9  /* Takes PST_RT_NODE */
#define                 PST_QLEND       10  /* Takes nothing */
#define                 PST_TREE        11  /* Takes nothing */
#define                 PST_BYHEAD      12  /* Takes PST_RSDM_NODE */
#define                 PST_AGHEAD      13  /* Takes PST_RT_NODE */
#define                 PST_SORT        14  /* Takes PST_SRT_NODE */
#define			PST_CURVAL	15  /* Takes PST_CRVAL_NODE */
#define			PST_NOT		16  /* Takes nothing */
#define			PST_SUBSEL	17  /* Takes PST_RT_NODE */
#define			PST_RULEVAR	18  /* Takes PST_RL_NODE */
#define			PST_TAB		19  /* Takes PST_TAB_NODE */
#define			PST_MOP		20  /* Takes PST_OP_NODE */
#define			PST_OPERAND	21  /* Takes nothing */
#define			PST_CASEOP	22  /* Takes PST_CASE_NODE */
#define			PST_WHLIST	23  /* Takes nothing */
#define			PST_WHOP	24  /* Takes nothing */
#define			PST_SEQOP	25  /* Takes PST_SEQOP_NODE */
#define			PST_GSET	26  /* Takes nothing */
#define			PST_GBCR	27  /* Takes PST_GROUP_NODE */
#define			PST_GCL		28  /* Takes nothing */
...
typedef struct _PST_RESTAB
{
    ...
    i4		    pst_resjour;	/* Result rel. journaled: TRUE/FALSE */
    ...
    i4	    pst_compress;	/* compression options, as follows: */
...
#define			PST_NO_AUTOSTRUCT   0x02
					/* autostruct is off */
    i4	    pst_temporary;	/* zero if table is permanent, non-zero
					** if table is temporary.
					*/
    i4	    pst_recovery;	/* zero if temporary table was declared
...
typedef struct _PST_STATEMENT
{
	...
	*/
    ...
    i4			pst_type;
#define	PST_DV_TYPE	1	/* PST_DECVAR	*/
#define PST_QT_TYPE	2	/* PST_QTREE	*/
#define PST_IF_TYPE	3	/* PST_IFSTMT	*/
#define PST_MSG_TYPE	4	/* PST_MSGSTMT	*/
#define PST_RTN_TYPE	5	/* PST_RTNSTMT	*/
#define PST_CMT_TYPE	6	/* PST_CMTSTMT  */
#define PST_RBK_TYPE	7	/* PST_RBKSTMT  */
#define PST_RSP_TYPE	8	/* PST_RSPSTMT  */
#define PST_WH_TYPE	9	/* Reserved for PSF use at this time */
#define	PST_CP_TYPE	10	/* PST_CPROCSTMT - EXECUTE/CALL PROCEDURE */
#define PST_EMSG_TYPE	11	/* PST_MSGSTMT - same as MESSAGE */
#define PST_IP_TYPE	12	/* PST_IPROCSTMT - execute an internal DBP */
#define	PST_EVREG_TYPE 	 13	/* REGISTER EVENT - data is PST_EVENTSTMT */
#define	PST_EVDEREG_TYPE 14	/* REMOVE EVENT - data is PST_EVENTSTMT */
#define	PST_EVRAISE_TYPE 15	/* RAISE EVENT - data is PST_EVENTSTMT */
				/*
				** ENDLOOP - will not be visible outside PSF -
				** the only truly useful field is pst_next
				*/
#define	PST_ENDLOOP_TYPE 16	
#define PST_EXEC_IMM_TYPE 17     /* implies EXECUTE IMMEDIATE type */
#define PST_REGPROC_TYPE 18	/* PST_REGPROC_STMT - execute a registered DBP*/
#define PST_RP_TYPE	19	/* Reserved for PSF use at this time */
#define PST_FOR_TYPE	20	/* FOR loop */
#define PST_RETROW_TYPE 21	/* RETURN ROW */
