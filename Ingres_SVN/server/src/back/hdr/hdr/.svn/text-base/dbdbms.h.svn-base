...
/* the following are names which should match the length of DB_MAXNAME in size */
#define			DB_NDINGRES_NAME    "ingres                          "
#define                 DB_INGRES_NAME	    "$ingres                         "
#define			DB_ABSENT_NAME	    "                                "
#define			DB_DBDB_NAME	    "iidbdb                          "
#define                 DB_CACHEUTIL_NAME   "<Cache Utility>                 "
#define                 DB_DCACHEUTIL_NAME  "$cache_utility                  "
#define                 DB_ARCHIVER_NAME    "$archiver                       "
#define                 DB_UPDATEARCH_NAME  "$archiver_update                "
#define                 DB_DBUNKNOWN_NAME   "UNKNOWN DB                      "
#define                 DB_OWNUNKNOWN_NAME  "UNKNOWN_OWNER                   "
#define                 DB_RECOVERY_NAME    "$recovery                       "
#define                 DB_LOGDUMP_NAME	    "$log_dump                       "
#define                 DB_RCPCONFIG_NAME   "$rcpconfig                      "
#define			DB_BUFMGR_NAME	    "<Buffer Manager>	             "
#define			DB_BUFMGR_OWNER	    "$buffer_manager                 "
#define                 DB_FASTCOMMIT_NAME  "<Fast Commit Thread>            "
#define                 DB_FASTTHREAD_NAME  "$fast_commit_thread             "
#define			DB_CPTHREAD_NAME    "<Consistency Pt Thread>         "
#define			DB_CPTHREAD_OWNER   "$consistency_pt_thread          "
#define                 DB_WRITEBEHIND_NAME "<Write Behind Thread>           "
#define                 DB_WRITETHREAD_NAME "$write_behind                   "
#define                 DB_DEFAULT_NAME	    "$default                        "
#define                 DB_OPENDB_NAME	    "$opendb                         "
#define                 DB_ALLOCATE_NAME    "$allocate                       "
#define                 DB_NOTAVAIL_NAME    "NOT_AVAILABLE                   "
#define                 DB_NOTTAB_NAME	    "NOT_A_TABLE                     "
#define                 DB_LOGFORCE_NAME    "$Log_Force                      "
#define                 DB_RECTHREAD_NAME   " <Recovery Thread>              "
#define                 DB_LOGWRITE_NAME    " <Log Writer>                   "
#define                 DB_GROUPCOMMIT_NAME " <Group Commit Thread>          "
#define                 DB_GROUPTHREAD_NAME "$group_commit_thread            "
#define                 DB_CP_TIMER_NAME    " <Consistency Point Timer>      "
#define                 DB_CPTMRTHREAD_NAME "$consistency_point_timer        "
#define                 DB_FORCEABORT_NAME  " <Force Abort Thread>           "
#define                 DB_DXRECOVERY_NAME  " <DX recovery thread>           "
#define                 DB_BWRITBEHIND_NAME " <Write Behind Thread>          "
#define                 DB_BFASTCOMMIT_NAME " <Fast Commit Thread>           "
#define			DB_BCPTHREAD_NAME   " <Consistency Pt Thread>        "
#define                 DB_SYSINIT_NAME	    " <SYSTEM INITIALIZATION>        "
#define                 DB_EVENTTHREAD_NAME " <Event Thread>                 "
#define                 DB_DEADPROC_NAME    " <Dead Process Detector>        "
#define                 DB_LOGFILEIO_NAME   "<Logfile I/O Thread>            "
#define                 DB_LOGTHREAD_NAME   "$Logfile_I/O_Thread             "
#define                 DB_AUDITTHREAD_NAME " <Security Audit Thread>        "
#define                 DB_TERMTHREAD_NAME  " <Terminator Thread>            "
#define                 DB_SECAUD_WRITER_NAME " <Security Audit Writer Thread> "
#define                 DB_BWRITALONG_NAME  " <Write Along Thread>           "
#define                 DB_BREADAHEAD_NAME  " <Read Ahead Thread>            "
#define			DB_REP_QMAN_NAME    " <Replicator Queue Management>  "
#define                 DB_LK_CALLBACK_NAME " <LK Callback Thread>           "
#define                 DB_DEADLOCK_NAME    " <LK Deadlock Thread>           "
#define                 DB_SORTTHREAD_NAME  " <Sort Thread>                  "
#define                 DB_LICENSETHREAD_NAME " <License Checking Thread>      "
#define			DB_TEMP_TAB_NAME    "$<Temporary Table>"
#define                 DB_CSP_MAIN_NAME    " <Cluster support>              "
#define                 DB_CSP_MSGMON_NAME  " <Cluster msg monitor>          "
#define                 DB_CSP_MSGTHR_NAME  " <Cluster msg thread>           "
#define			DB_EXCH_THREAD_NAME " <Parallel Query Thread>        "
#define			DB_DIST_DEADLOCK_NAME " <CSP Deadlock Thread>          "
#define			DB_GLC_SUPPORT_NAME " <GLC Support Thread>           "
...
#define			DB_VPT_SIZEOF_TUPLE_HDR(page_type)	\
		...
		(page_type == DB_PG_V5) ?  14 : 0) /* FIX ME 14 for now */
...
typedef struct _DB_IISEQUENCE
{
    ...
    i4		dbs_prec;		/* If sequence value is DECIMAL, 
					** precision of value */
    /* Note : the tuple image has a decimal(31) and an integer instance 
    ** for each of the sequence parameter values. */
    struct {				/* Start value of sequence */
	char	decval[16];		/* decimal sequence value */
	i4	intval;			/* integer sequence value */
    } dbs_start;
...
** All valuses are as defined in  dudbms.h  for DU
** Some of these definitions are not used but are provided for completeness. 
** Values are mirrored in common/hdr/hdr/dudbms.qsh as Database compatibility
** values.
*/
...
*/
typedef i4  DB_JNTYPE;
#define		DB_NOJOIN	(DB_JNTYPE) 0x01
#define		DB_INNER_JOIN	(DB_JNTYPE) 0x02
#define		DB_LEFT_JOIN	(DB_JNTYPE) 0x04
#define		DB_RIGHT_JOIN	(DB_JNTYPE) 0x08
#define		DB_FULL_JOIN	(DB_JNTYPE) 0x0c
#define		DB_NAT_JOIN	(DB_JNTYPE) 0x10
#define		DB_LANTI_JOIN	(DB_JNTYPE) 0x11
#define		DB_RANTI_JOIN	(DB_JNTYPE) 0x12
#define		DB_FANTI_JOIN	(DB_JNTYPE) 0x14
#define		DB_INTERSECT_JOIN (DB_JNTYPE) 0x18

/*}
