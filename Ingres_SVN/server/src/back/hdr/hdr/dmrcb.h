...
#define                 DMR_NODUPLICATES    0x01L
			                    /* DMR_NODUPLICATES is used on first
                                            ...
                                            ** allowed. */
#define                 DMR_NEXT            0x02L
#define                 DMR_CURRENT_POS     0x04L
#define                 DMR_BY_TID          0x08L
                                            /* Above three items describe
                                            ** type of get operation. */
#define                 DMR_ENDLOAD         0x10L     
...
#define		        DMR_MINI_XACT 	    0x10000L
					    ...
					    ** currently
					    */
#define                 DMR_SORT            0x20000L
                                            /* This flag is used when getting
                                            ** tuples to append them to a
                                            ** sorter. 
                                            */
#define			DMR_XTABLE	    0x40000L
					    /*
					    ** cross-table update
					    */
#define                 DMR_PKEY_PROJECTION 0x80000L
#define                 DMR_DUP_ROLLBACK    0x100000L
#define                 DMR_RAAT            0x200000L
#define                 DMR_AGENT           0x400000L
					    /* Use dmrAgent thread to
					    ** execute DMR request
					    */
#define                 DMR_AGENT_CALLBACK  0x800000L
					    /* dmrAgent callback to  
					    ** dmr? function
					    ** (set internally)
					    */
#define                 DMR_NO_SIAGENTS     0x1000000L
...
#define			DMR_ENDQUAL	    7L /* position at the end of qual */
    ...
    DM_PTR          dmr_attr_desc;          /* Pointer to an array of pts to
                                            ...
                                            ** retrieved. */
    PTR		    dmr_q_fcn;		    /* Address of qualification function.
					    ** The follow values returned by
					    ** the qualification are used to
...
#define DMR_AGLIM_MIN         0x0004          /* MIN aggregate requested    */
    PTR		    dmr_agg_excb;	    /* ADE_EXCB to use when executing
					    ...
					    */
    PTR		    dmr_agg_exhandler;	    /* ptr to exception handler for */
					    /* ade execution of DMR_AGGREGATE */
    PTR		    dmr_res_data;	    /* ptr to additional result block */
    PTR		    dmr_qef_adf_cb;         /* ptr to QEF ADF_CB passed  */
					    /* DMF for initialization    */
