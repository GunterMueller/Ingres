...
/*}
** Name: QEC_32C_PLUS1 - A 33-character structure.
**
** Description:
...
typedef char	QEC_32C_PLUS1[DB_MAXNAME + 1];
...
{
    QEC_32C_PLUS1   d2_1_ldb_node;	/* node name */
    ...
    QEC_8C_PLUS1    d2_7_ldb_dba;	/* "Y" if notion of DBA exists, "N" 
					** otherwise */
    QEC_32C_PLUS1   d2_8_ldb_dbaname;	/* DBA's name if such notion exists */
...
struct _QEC_D3_LDB_COLUMNS
{
    ...
    QEC_32C_PLUS1   d3_2_lcl_name;	/* local column name */
...
struct _QEC_D4_LDB_DBCAPS
{
    ...
    QEC_32C_PLUS1   d4_2_cap_cap;	/* capability */
    QEC_32C_PLUS1   d4_3_cap_val;	/* value of capability */
...
struct _QEC_D5_LONG_LDBNAMES
{
    ...
    QEC_32C_PLUS1   d5_3_ldb_alias;	/* "iildb_" + textual equivalent of 
					** above id */
...
{
    QEC_32C_PLUS1   d6_1_obj_name;	/* object name */
    QEC_32C_PLUS1   d6_2_obj_owner;	/* object owner */
...
struct _QEC_D9_TABLEINFO
{
    ...
    QEC_32C_PLUS1   d9_3_tab_name;	/* local table name */
    QEC_32C_PLUS1   d9_4_tab_owner;	/* local table owner */
...
{
    QEC_32C_PLUS1   l1_1_usr_name;	/* user name */
    QEC_32C_PLUS1   l1_2_dba_name;	/* DBA name */
...
{
    QEC_32C_PLUS1   l2_1_tab_name;	/* table name */
    QEC_32C_PLUS1   l2_2_tab_owner;	/* table owner */
    i4		    l2_3_key_id;	/* an arbitrary number to identify 
					** the key uniquely */
    QEC_32C_PLUS1   l2_4_col_name;	/* column name */
...
{
    QEC_32C_PLUS1   l3_1_tab_name;	/* table name */
    QEC_32C_PLUS1   l3_2_tab_owner;	/* table owner */
    QEC_32C_PLUS1   l3_3_col_name;	/* column name */
    QEC_32C_PLUS1   l3_4_data_type;	/* data type of column */
...
#define	QEC_03I_CC_COLUMNS_12	   12
    ...
    QEC_32C_PLUS1   l3_13_internal_datatype;
...
{
    QEC_32C_PLUS1    l4_1_cap_cap;	/* capability */
    QEC_32C_PLUS1    l4_2_cap_val;	/* value of above */
...
{
    QEC_32C_PLUS1   l5_1_tab_name;	/* table name */
    QEC_32C_PLUS1   l5_2_tab_owner;	/* table owner */
    QEC_32C_PLUS1   l5_3_col_name;	/* column name */
...
{
    QEC_32C_PLUS1   l6_1_ind_name;	/* index name */
    QEC_32C_PLUS1   l6_2_ind_owner;	/* index owner */
    QEC_DATE_PLUS1  l6_3_cre_date;	/* creation date */
    QEC_32C_PLUS1   l6_4_base_name;	/* base table name */
    QEC_32C_PLUS1   l6_5_base_owner;	/* base table owner */
...
{
    QEC_32C_PLUS1   l7_1_ind_name;	/* index name */
    QEC_32C_PLUS1   l7_2_ind_owner;	/* index owner */
    QEC_32C_PLUS1   l7_3_col_name;	/* column name */
...
{
    QEC_32C_PLUS1   l14_1_obj_name;	/* object name */
    QEC_32C_PLUS1   l14_2_obj_owner;	/* object owner */
...
{
    QEC_32C_PLUS1   l15_1_tab_name;	/* table name */
    QEC_32C_PLUS1   l15_2_tab_owner;	/* table owner */
    QEC_32C_PLUS1   l15_3_col_name;	/* column name */
...
{
    QEC_32C_PLUS1   l16_1_tab_name;	/* table name */
    QEC_32C_PLUS1   l16_2_tab_owner;	/* table owner */
...
{
    QEC_32C_PLUS1   l17_1_tab_name;	/* table name */
    QEC_32C_PLUS1   l17_2_tab_owner;	/* table owner */
...
{
    QEC_32C_PLUS1   l18_1_proc_name;	/* object name */
    QEC_32C_PLUS1   l18_2_proc_owner;	/* object owner */
...
{
    QEC_32C_PLUS1    qec_i1_name;	/* name */
    QEC_32C_PLUS1    qec_i2_owner;	/* owner */
    QEC_32C_PLUS1    qec_i3_given;	/* given name */
}   QEC_INDEX_ID;
...
typedef struct _QEC_LINK
{
    ...
    QEC_32C_PLUS1	 qec_5_ldb_alias;	/* LDB alias if name exceeds 32 
						** chars */
