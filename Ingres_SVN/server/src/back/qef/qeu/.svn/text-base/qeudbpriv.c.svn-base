...
**
** Internal QEF call:   status = (*que_qual)(qeu_qarg, &current_tuple)
**
** Description:
...
**      dbpriv_tuple		The current tuple being considered
**
** Outputs:
**	None.
**
**	Returns:
**          DMR_F_RETURN        Match (all prospects are qualified)
