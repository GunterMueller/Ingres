...
QEUQ_CB		    *qeuq_cb)
{
	...
	*/
	...
	qeu.qeu_qual = (PTR)qeu_qalarm_by_name;
	qeu.qeu_qarg = (PTR)atuple;
	...
	*/
	...
	if (from_drop_alarm)		
	{
	    ...
	    */
	    ...
	    aqeu.qeu_qual = (PTR)qeu_qalarm_by_name;
	    aqeu.qeu_qarg = (PTR)atuple_name;
	}
	else				/* DROP TABLE */
	{
...
** Internal QEF call: status = qeu_qalarm_by_name(&search_tuple, &current_tuple)
**
** Description:
