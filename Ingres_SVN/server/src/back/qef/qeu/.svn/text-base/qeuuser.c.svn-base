...
QEUQ_CB		*qeuq_cb)
{
	...
	*/
	...
	dbqef_data.dt_data = (PTR)&db_tuple;
        ...
        dbqeu.qeu_klen = 0;
        dbqeu.qeu_key = NULL;
        dbqeu.qeu_qual = (PTR)qeu_dbowner;
        dbqeu.qeu_qarg = (PTR)dbqual_parms;
	dbqual_parms[0]	= (PTR)qef_cb;
	dbqual_parms[1]   = (PTR)&dbqual_tuple;
...
DU_USER		*ustuple)
{
	...
	*/
	...
	else
	{
	    ...
	    qeu.qeu_qual = (PTR)qeu_quser;
	    qeu.qeu_qarg = (PTR)&qualtuple;
	}
...
**
** Inputs:
**	qual_tuple		Template iiuser tuple to search for:
**		.du_group	Default group
**	user_tuple		The current tuple being considered
**
** Outputs:
**	None.
**
...
DU_USER		*user_tuple)
{
    if (qual_tuple == NULL || user_tuple == NULL)	/* Bad parm; abort! */
...
**
** Inputs:
**	qual_parms		Array of pointers to qualification parameters:
**	    qef_db		    pointer to the current qef_cb
**	    qual_tuple		    qualification iidatabase tuple
**	db_tuple		The current tuple being considered
**
** Outputs:
**	None.
**
...
DU_DATABASE	*db_tuple)
{
    ...
    qef_cb      = (QEF_CB *)qual_parms[0];
    qual_tuple  = (DU_DATABASE *)qual_parms[1];
