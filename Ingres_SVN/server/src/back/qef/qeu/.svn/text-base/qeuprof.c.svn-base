...
QEUQ_CB		*qeuq_cb)
{
	...
	*/
	...
	usrqef_data.dt_data = (PTR)&usr_tuple;
        ...
        usrqeu.qeu_klen = 0;
	usrqeu.qeu_qual=(PTR)qual_user_profile;
	usrqeu.qeu_qarg= (PTR)&ptuple;	/* For current profile name */
...
)
{
	...
	*/
	...
	qeu.qeu_qual=(PTR)qual_user_profile;
	qeu.qeu_qarg= (PTR)old_ptuple;
...
**
** Inputs:
**	ptuple	- Profile tuple to match against
**
**	utuple  - User tuple to check
**
** Outputs:
**	None
**
