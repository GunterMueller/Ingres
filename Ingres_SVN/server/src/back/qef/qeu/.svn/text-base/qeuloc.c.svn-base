...
QEUQ_CB		    *qeuq_cb)
{
	...
	*/
	...
	qeu.qeu_qual = (PTR)qeu_qdatabase;
	qeu.qeu_qarg = (PTR)ltuple->du_lname;
...
**
** Inputs:
**      qual_loc		The location name for which to scan.
...
** Inputs:
**      qual_loc		The location name for which to scan.
**      ex_tuple		The current tuple being considered
**
** Outputs:
**      None.
**
