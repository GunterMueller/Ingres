...
DB_USERGROUP	*ugtuple)
{
	...
	*/
	   ...
	   )
	{
	    qeu.qeu_klen = 0;
	    qeu.qeu_key = NULL;
	    qeu.qeu_qual = (PTR)qeu_qgroup;
	    qeu.qeu_qarg = (PTR)qual_parms;
	    qual_parms[0]	= (PTR)qef_cb;
	    qual_parms[1]	= (PTR)&qualtuple;
	    qual_parms[2]	= (PTR)&audit;
	    qual_parms[3]	= (PTR)NULL;
	}
	else
	{
...
**	    qual_tuple		    qualification tuple
**	    audit		    if TRUE, audit record as being dropped.
**	group_tuple		The current tuple being considered
**
** Outputs:
**	None.
**
...
DB_USERGROUP	*group_tuple)
{
    ...
    qual_tuple	= (DB_USERGROUP *)qual_parms[1];
