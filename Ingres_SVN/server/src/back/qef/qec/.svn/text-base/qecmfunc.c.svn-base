...
QEF_FUNC        qef_func[] ) 
{
    ...
    qef_func[QE_ORIG].func_name	    = (DB_STATUS (*)())qen_orig;
    qef_func[QE_TJOIN].func_id	    = QE_TJOIN;            /* function id */
    qef_func[QE_TJOIN].func_name    = (DB_STATUS (*)())qen_tjoin;
    qef_func[QE_KJOIN].func_id	    = QE_KJOIN;            /* function id */
    qef_func[QE_KJOIN].func_name    = (DB_STATUS (*)())qen_kjoin;
    qef_func[QE_HJOIN].func_id	    = QE_HJOIN;            /* function id */
    qef_func[QE_HJOIN].func_name    = (DB_STATUS (*)())qen_hjoin;
    qef_func[QE_SORT].func_id	    = QE_SORT;             /* function id */
    qef_func[QE_SORT].func_name     = (DB_STATUS (*)())qen_sort;
    qef_func[QE_TSORT].func_id	    = QE_TSORT;            /* function id */
    qef_func[QE_TSORT].func_name    = (DB_STATUS (*)())qen_tsort;
    qef_func[QE_ISJOIN].func_id	    = QE_ISJOIN;           /* function id */
    qef_func[QE_ISJOIN].func_name   = (DB_STATUS (*)())qen_isjoin;
    qef_func[QE_FSMJOIN].func_id    = QE_FSMJOIN;          /* function id */
    qef_func[QE_FSMJOIN].func_name  = (DB_STATUS (*)())qen_fsmjoin;
    qef_func[QE_QP].func_id	    = QE_QP;		   /* function id */
    qef_func[QE_QP].func_name	    = (DB_STATUS (*)())qen_qp;
    qef_func[QE_SEJOIN].func_id	    = QE_SEJOIN;	   /* function id */
    qef_func[QE_SEJOIN].func_name   = (DB_STATUS (*)())qen_sejoin;
    qef_func[QE_CPJOIN].func_id	    = QE_CPJOIN;           /* function id */
    qef_func[QE_CPJOIN].func_name   = (DB_STATUS (*)())qen_cpjoin;
    qef_func[QE_ORIGAGG].func_id    = QE_ORIGAGG;           /* function id */
    qef_func[QE_ORIGAGG].func_name  = (DB_STATUS (*)())qen_origagg;
    qef_func[QE_EXCHANGE].func_id   = QE_EXCHANGE;         /* function id */
    qef_func[QE_EXCHANGE].func_name = (DB_STATUS (*)())qen_exchange;
}
