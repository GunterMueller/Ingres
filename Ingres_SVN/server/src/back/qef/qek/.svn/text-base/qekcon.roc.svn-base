...
GLOBALDEF READONLY QEK_K1_STR_CODE IIQE_01_str[] =   
{
    "Y",		QEK_1VAL_Y,	
    "y",		QEK_1VAL_Y,	
    "N",		QEK_2VAL_N,	
...
GLOBALDEF READONLY QEK_K1_STR_CODE IIQE_02_str[] =   
{
    "NO",		QEK_8VAL_NO,	
    "no",		QEK_8VAL_NO,	
    NULL,		0		/* table terminator */
...
GLOBALDEF READONLY QEK_K1_STR_CODE IIQE_03_str[] =   
{
    "YES",		QEK_9VAL_YES,	
    "yes",		QEK_9VAL_YES,	
    NULL,		0		/* table terminator */
...
GLOBALDEF READONLY QEK_K1_STR_CODE IIQE_04_str[] =   
{
    "NONE",		QEK_3VAL_NONE,	    
    "none",		QEK_3VAL_NONE,	    
    "STAR",		QEK_4VAL_STAR,	    
...
GLOBALDEF READONLY QEK_K1_STR_CODE IIQE_05_str[] =  
{
...
GLOBALDEF READONLY QEK_K1_STR_CODE IIQE_06_str[] =  
{
...
GLOBALDEF READONLY QEK_K1_STR_CODE IIQE_08_str[] =  
{
...
GLOBALDEF READONLY QEK_K1_STR_CODE IIQE_09_str[] =  
{
...
GLOBALDEF READONLY  QEK_K1_STR_CODE IIQE_10_str[] = /* table of capabilities */
{
...
GLOBALDEF READONLY  QEK_K1_STR_CODE IIQE_11_str[] = /* table of capabilities */
{
...
GLOBALDEF READONLY  QEK_K1_STR_CODE IIQE_12_str[] = /* table of capabilities */
{
...
GLOBALDEF READONLY  QEK_K1_STR_CODE IIQE_14_str[] = /* table of capabilities */
{
...
GLOBALDEF READONLY  QEK_K1_STR_CODE IIQE_15_str[] = /* table of capabilities */
{
...
GLOBALDEF READONLY  QEK_K1_STR_CODE IIQE_16_str[] = /* table of capabilities */
{
...
GLOBALDEF READONLY QEK_K1_STR_CODE IIQE_17_str[] = /* table of capabilities */
{
...
GLOBALDEF READONLY  QEK_K1_STR_CODE	*IIQE_18_str_tab[QEK_18MAX_LENGTH] 
    = /* table of pointers */
{
    NULL,		    /* 0 */
    IIQE_01_str,	    /* 1 */
...
GLOBALDEF READONLY char	IIQE_c0_usr_ingres[] = "$ingres";
...
GLOBALDEF READONLY char	IIQE_c1_iidbdb[] = "iidbdb";
...
GLOBALDEF READONLY char	IIQE_c2_abort[] = "abort;";
...
GLOBALDEF READONLY char	IIQE_c3_commit[] = "commit;";
...
GLOBALDEF READONLY char	IIQE_c4_rollback[] = "rollback;";
...
GLOBALDEF READONLY char	IIQE_c5_low_ingres[] = "ingres";
...
GLOBALDEF READONLY char	IIQE_c6_cap_ingres[] = "INGRES";
...
GLOBALDEF READONLY char	*IIQE_c7_sql_tab[SQL_11_WHERE + 1] =
{
    "and",			    /* SQL_00_AND */
...
GLOBALDEF READONLY char	*IIQE_c8_ddb_cat[TDD_32_VIEWS + 1] =
{
    "",				/* TDD_00_? */
...
GLOBALDEF READONLY char	*IIQE_c9_ldb_cat[TII_25_IIUSERS + 1] =
{
    "",				/* TII_00_? */
...
GLOBALDEF READONLY char	*IIQE_10_col_tab[COL_53_INTERNAL_STATUS + 1] =
{
...
GLOBALDEF READONLY char	*IIQE_11_con_tab[QEK_1CON_USER_NAME + 1] =
{
...
GLOBALDEF READONLY RQR_CB    IIQE_c12_rqr = { NULL };
...
GLOBALDEF READONLY TPR_CB    IIQE_c13_tpr = { NULL };
...
GLOBALDEF READONLY char *IIQE_27_cap_names[QEK_12NAME_OPENSQL_LEVEL + 1] = 
...
GLOBALDEF READONLY char	    IIQE_30_alias_prefix[] = "long_";
...
GLOBALDEF READONLY char	    IIQE_31_beg_sess[] = "QEC_BEGIN_SESSION";
...
GLOBALDEF READONLY char	    IIQE_32_end_sess[] = "QEC_END_SESSION";
...
GLOBALDEF READONLY char	    IIQE_33_integer[] = "INTEGER";
...
GLOBALDEF READONLY char	    IIQE_34_float[] = "FLOAT";
...
GLOBALDEF READONLY char	    IIQE_35_text[] = "TEXT";
...
GLOBALDEF READONLY char	    IIQE_36_date[] = "DATE";
...
GLOBALDEF READONLY char	    IIQE_37_money[] = "MONEY";
...
GLOBALDEF READONLY char	    IIQE_38_char[] = "CHAR";
...
GLOBALDEF READONLY char	    IIQE_39_varchar[] = "VARCHAR";
...
GLOBALDEF READONLY char	    IIQE_40_decimal[] = "DECIMAL";
...
GLOBALDEF READONLY char	    IIQE_41_qet_t9_ok_w_ldbs[] = "QET_T9_OK_W_LDBS";
...
GLOBALDEF READONLY char	    IIQE_42_ing_60[] = "II9.3";
...
GLOBALDEF READONLY char	    IIQE_43_heap[] = "HEAP";
...
GLOBALDEF READONLY  char	*IIQE_50_act_tab[] = 
{
...
GLOBALDEF READONLY  char	*IIQE_51_rqf_tab[] = 
{
    "",				    /* 0 */
    "RQR_STARTUP",		    /* 1 */
    "RQR_SHUTDOWN",		    /* 2 */
...
GLOBALDEF READONLY  char	*IIQE_52_tpf_tab[] = 
{
    "",				    /* 0 */
    "TPF_STARTUP",		    /* 1 */
    "TPF_SHUTDOWN",		    /* 2 */
...
GLOBALDEF READONLY  char	*IIQE_53_lo_qef_tab[] = 
{
    "",				    /* 0 */
    "",				    /* 1 */
    "QEC_INITIALIZE",		    /* 2 */
...
GLOBALDEF READONLY  char	*IIQE_54_hi_qef_tab[] = 
{
    "QED_IIDBDB",		    /* 500 */
    "QED_DDBINFO",		    /* 501 */		
    "QED_LDBPLUS",		    /* 502 */		
...
GLOBALDEF READONLY  char	IIQE_61_qefsess[] = "QEF";
...
GLOBALDEF READONLY  char	IIQE_62_3dots[] = "...";
...
GLOBALDEF READONLY  char	IIQE_63_qperror[] = 
					"ERROR detected in query plan!\n";
...
GLOBALDEF READONLY  char	IIQE_64_callerr[] = 
					"ERROR occurred while calling";
...
GLOBALDEF READONLY  char	IIQE_65_tracing[] = "Tracing";
