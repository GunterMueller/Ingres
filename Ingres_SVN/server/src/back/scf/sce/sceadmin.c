...
/* # line 196 "sceadmin.sc" */	/* host code */
    if (sce_waserr())
    {
	SIprintf("EVADM: Exiting because of error ...\n");
/* # line 199 "sceadmin.sc" */	/* disconnect */
  {
    IIsqInit((char *)0);
    IIsqDisconnect();
  }
/* # line 200 "sceadmin.sc" */	/* host code */
	PCexit(FAIL);
    }
    while (1)
    {
...
/* # line 209 "sceadmin.sc" */	/* disconnect */
  {
    IIsqInit((char *)0);
    IIsqDisconnect();
  }
/* # line 210 "sceadmin.sc" */	/* host code */
    PCexit(OK);	
    /*NOTREACHED*/	
    return(FAIL);	
} /* main */
...
/* # line 303 "sceadmin.sc" */	/* execute */
  {
    IIsqInit((char *)0);
    IIsqExImmed(stmt);
    IIsyncup((char *)0,0);
  }
/* # line 304 "sceadmin.sc" */	/* host code */
	break;
      case 2:		/* Add event thread */
	STprintf(stmt, "SET TRACE POINT SC923 %d", SCE_AADD_THREAD);
/* # line 307 "sceadmin.sc" */	/* execute */
  {
    IIsqInit((char *)0);
    IIsqExImmed(stmt);
    IIsyncup((char *)0,0);
  }
/* # line 308 "sceadmin.sc" */	/* host code */
	break;
      case 3:		/* Trace event thread */
/* # line 310 "sceadmin.sc" */	/* set */
  {
    IIsqInit((char *)0);
    IIwritio(0,(short *)0,1,32,0,(char *)"set TRACE TERMINAL");
    IIsyncup((char *)0,0);
  }
/* # line 311 "sceadmin.sc" */	/* host code */
	if (sce_waserr())
	    break;
	STprintf(stmt, "SET TRACE POINT SC923 %d 1", SCE_ATRC_THREAD);
/* # line 314 "sceadmin.sc" */	/* execute */
  {
    IIsqInit((char *)0);
    IIsqExImmed(stmt);
    IIsyncup((char *)0,0);
  }
/* # line 315 "sceadmin.sc" */	/* host code */
	break;
      case 4:		/* Untrace event thread */
/* # line 317 "sceadmin.sc" */	/* set */
  {
    IIsqInit((char *)0);
    IIwritio(0,(short *)0,1,32,0,(char *)"set NOTRACE TERMINAL");
    IIsyncup((char *)0,0);
  }
/* # line 318 "sceadmin.sc" */	/* host code */
	if (sce_waserr())
	    break;
	STprintf(stmt, "SET TRACE POINT SC923 %d 0", SCE_ATRC_THREAD);
/* # line 321 "sceadmin.sc" */	/* execute */
  {
    IIsqInit((char *)0);
    IIsqExImmed(stmt);
    IIsyncup((char *)0,0);
  }
/* # line 322 "sceadmin.sc" */	/* host code */
	break;
      case 5:		/* Dump SCE structures */
/* # line 324 "sceadmin.sc" */	/* set */
  {
    IIsqInit((char *)0);
    IIwritio(0,(short *)0,1,32,0,(char *)"set TRACE POINT SC921");
    IIsyncup((char *)0,0);
  }
/* # line 325 "sceadmin.sc" */	/* host code */
	break;
      case 6:		/* Dump EV structures */
/* # line 327 "sceadmin.sc" */	/* set */
  {
    IIsqInit((char *)0);
    IIwritio(0,(short *)0,1,32,0,(char *)"set TRACE POINT SC922");
    IIsyncup((char *)0,0);
  }
/* # line 328 "sceadmin.sc" */	/* host code */
	break;
      case 7:		/* List servers in EV */
      case 8:		/* Update servers in EV */
	IItm_trace(sce_traptrace);
	num_pids = 0;
/* # line 333 "sceadmin.sc" */	/* set */
  {
    IIsqInit((char *)0);
    IIwritio(0,(short *)0,1,32,0,(char *)"set TRACE POINT SC922");
    IIsyncup((char *)0,0);
  }
/* # line 334 "sceadmin.sc" */	/* host code */
	IItm_trace(0L);
	if (sce_waserr())
	    break;
...
/* # line 360 "sceadmin.sc" */	/* execute */
  {
    IIsqInit((char *)0);
    IIsqExImmed(stmt);
    IIsyncup((char *)0,0);
  }
/* # line 361 "sceadmin.sc" */	/* host code */
	    }
	}
	if (num_pids == 0)
	{
...
/* # line 378 "sceadmin.sc" */	/* execute */
  {
    IIsqInit((char *)0);
    IIsqExImmed(stmt);
    IIsyncup((char *)0,0);
  }
/* # line 379 "sceadmin.sc" */	/* host code */
	}
	break;
      case 10:		/* O/S command */
...
/* # line 387 "sceadmin.sc" */	/* call */
  {
    IIsqInit((char *)0);
    IIutsys(0,(char *)"SYSTEM",(char *)0);
    IIutsys(1,(char *)"command",stmt);
    IIutsys(2,(char *)0,(char *)0);
  }
/* # line 388 "sceadmin.sc" */	/* host code */
	break;
      default:
	SIprintf("%%EVADM-ERR: Menu option <%d> out of range 1..%d\n", 
		 op, MAXMU);
...
{
  i4 err;
/* # line 417 "sceadmin.sc" */	/* inquire_ingres */
  {
    IILQisInqSqlio((short *)0,1,30,4,&err,2);
  }
/* # line 418 "sceadmin.sc" */	/* host code */
    return (err != 0);
} /* sce_waserr */
/*{
