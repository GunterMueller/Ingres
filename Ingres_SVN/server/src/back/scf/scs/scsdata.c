...
GLOBALDEF DU_DATABASE	      dbdb_dbtuple
	...
	/* du_own */		{'$','i','n','g','r','e','s',' ',' ',' ',' ',' ',
						...
						' ',' ',' ',' ',
						' ',' ',' ',' '},
	/* du_dbloc */		{'i','i','_','d','a','t','a','b','a','s','e',' ',
						' ',' ',' ',' ',
						' ',' ',' ',' ',
						' ',' ',' ',' ',
						' ',' ',' ',' ',
						' ',' ',' ',' '},
	/* du_ckploc */		{'i','i','_','c','h','e','c','k','p','o','i','n',
						't',' ',' ',' ',
						' ',' ',' ',' ',
						' ',' ',' ',' ',
						' ',' ',' ',' ',
						' ',' ',' ',' '},
	/* du_jnlloc */		{'i','i','_','j','o','u','r','n','a','l',' ',' ',
						' ',' ',' ',' ',
						' ',' ',' ',' ',
						' ',' ',' ',' ',
						' ',' ',' ',' ',
						' ',' ',' ',' '},
	/* du_workloc */	{'i','i','_','w','o','r','k',' ',' ',' ',' ',' ',
						' ',' ',' ',' ',
						' ',' ',' ',' ',
						' ',' ',' ',' ',
						' ',' ',' ',' ',
						' ',' ',' ',' '},
	/* du_access */			    DU_GLOBAL | DU_OPERATIVE,
	/* du_dbservice */		    0,
	/* du_dbcmptlvl */		    {DU_CUR_DBCMPTLVL_CHARS},
	/* du_1dbcmptminor */		    DU_1CUR_DBCMPTMINOR,
	/* du_dbid */			    1,
	/* du_dmploc */		{'i','i','_','d','u','m','p',' ',' ',' ',' ',' ',
						' ',' ',' ',' ',
						' ',' ',' ',' ',
						' ',' ',' ',' ',
						' ',' ',' ',' ',
