	...
	*/
	...
	do {
		...
		*/
		if(event_opened==FALSE)
		{
		    ...
		    */
		    ...
		    status = qef_call(QEU_OPEN, ( PTR ) &ev_qeu);
	            if (status)
		    {
		...
		*/
		if(xevent_opened==FALSE)
		{
		    ...
		    */
		    ...
		    status = qef_call(QEU_OPEN, ( PTR ) &xev_qeu);
	            if (status)
		    {
		         sc0e_0_put(E_SC034B_ALARM_QRY_IIEVENT, 0);
		...
		*/
	        ...
	        status = qef_call(QEU_GET, ( PTR ) &xev_qeu);
		...
		*/
		ev_qeu.qeu_tid=xevtuple.dbx_tidp;
	        status = qef_call(QEU_GET, ( PTR ) &ev_qeu);
    ...
    if(event_opened)
    {
	if( qef_call(QEU_CLOSE, ( PTR ) &ev_qeu)!=E_DB_OK)
	{
		sc0e_0_put(qeu.error.err_code, 0);
		sc0e_0_put(E_SC034B_ALARM_QRY_IIEVENT, 0);
		sc0e_0_put(E_US2476_9334_IISECALARM_ERROR, 0);
    ...
    if(xevent_opened)
    {
	if( qef_call(QEU_CLOSE, ( PTR ) &xev_qeu)!=E_DB_OK)
	{
		sc0e_0_put(qeu.error.err_code, 0);
		sc0e_0_put(E_US2476_9334_IISECALARM_ERROR, 0);
	}
    ...
    if(opened)
    {
	if( qef_call(QEU_CLOSE, ( PTR ) &qeu)!=E_DB_OK)
	{
		sc0e_0_put(qeu.error.err_code, 0);
		sc0e_0_put(E_US2476_9334_IISECALARM_ERROR, 0);
	}
