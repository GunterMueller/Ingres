...
ascs_gca_recv(SCD_SCB *scb)
{
    ...
    */
	...
	!scb->scb_cscb.cscb_gcp.gca_it_parms.gca_end_of_data;
...
ascs_gca_put(SCD_SCB *scb, i4  msgtype, i4 len, PTR data)
{
    ...
    */
	...
	(i4)(sizeof(SCC_GCMSG) + len + Sc_main_cb->sc_gchdr_size), 
	DB_SCF_ID,
	(PTR)SCS_MEM,
	SCG_TAG,
	(PTR *)&message);
    ...
    */
    ...
    MEcopy(data, len, scb->scb_cscb.cscb_gcp.gca_fo_parms.gca_data_area);
