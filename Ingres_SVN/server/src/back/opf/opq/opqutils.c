...
/* # line 573 "opqutils.sc" */	/* inquire_ingres */
  {
    IILQisInqSqlio((short *)0,1,32,ER_MAX_LEN + 1-1,error_msg,63);
  }
/* # line 575 "opqutils.sc" */	/* host code */
	SIprintf("%s\n", error_msg);
	(VOID)SIflush(stdout);
...
bool		quiet)
{
	...
	** character set statistics */
	if (attrp->hist_dt.db_datatype == DB_CHA_TYPE && version != NULL)
	{
...
/* # line 3006 "opqutils.sc" */	/* host code */
/*
...
/* # line 3066 "opqutils.sc" */	/* describe */
  {
    IIsqInit(&sqlca);
...
/* # line 3068 "opqutils.sc" */	/* host code */
...
/* # line 3073 "opqutils.sc" */	/* open */
  {
    IIsqInit(&sqlca);
    IIcsOpen((char *)"c1",6073,1502);
    IIwritio(0,(short *)0,1,32,0,(char *)"s");
    IIwritio(0,(short *)0,1,32,0,(char *)" for readonly ");
    IIcsQuery((char *)"c1",6073,1502);
    if (sqlca.sqlcode < 0) 
      opq_sqlerror();
    else if (sqlca.sqlwarn.sqlwarn0 == 'W') 
      opq_sqlerror();
  }
/* # line 3075 "opqutils.sc" */	/* host code */
    while (sqlca.sqlcode == GE_OK)
    {
/* # line 3077 "opqutils.sc" */	/* fetch */
  {
    IIsqInit(&sqlca);
    if (IIcsRetScroll((char *)"c1",6073,1502,-1,-1) != 0) {
      IIcsDaGet(0,sqlda);
      IIcsERetrieve();
    } /* IIcsRetrieve */
    if (sqlca.sqlcode < 0) 
...
/* # line 3078 "opqutils.sc" */	/* host code */
    }
/* # line 3080 "opqutils.sc" */	/* close */
  {
    IIsqInit(&sqlca);
    IIcsClose((char *)"c1",6073,1502);
    if (sqlca.sqlcode < 0) 
      opq_sqlerror();
    else if (sqlca.sqlwarn.sqlwarn0 == 'W') 
      opq_sqlerror();
  }
/* # line 3082 "opqutils.sc" */	/* host code */
    rp->ntups = nrows;
}
/*
...
/* # line 3127 "opqutils.sc" */	/* repeated select */
  {
    IIsexec();
    while (IInexec() == 0) {
      IIsqInit(&sqlca);
      IIexExec(1,(char *)"opqutils1",6074,15357);
      IIputdomio((short *)0,1,32,0,es_ownname);
      IIputdomio((short *)0,1,32,0,es_relname);
      IIretinit((char *)0,0);
      if (IInexec() == 0) {
        IIsqInit(&sqlca);
        IIsqMods(1);
        IIexDefine(1,(char *)"opqutils1",6074,15357);
...
where table_owner=");
        ...
        IIputdomio((short *)0,1,32,0,es_relname);
        IIexDefine(0,(char *)"opqutils1",6074,15357);
        if (IIerrtest() == 0) {
          IIsexec();
        } /* IIerrtest */
      } /* IInexec */
    ...
    if (IInextget() != 0) {
      IIgetdomio((short *)0,1,30,4,&es_nrows);
      IIgetdomio((short *)0,1,30,4,&es_pages);
      IIgetdomio((short *)0,1,30,4,&es_ovflow);
    } /* IInextget */
    IIsqFlush((char *)0,0);
    if (sqlca.sqlcode < 0) 
      opq_sqlerror();
...
/* # line 3134 "opqutils.sc" */	/* host code */
...
bool		statdump)
{
  ...
  i4 es_relwid;
	...
	{
/* # line 3470 "opqutils.sc" */	/* repeated select */
  {
    IIsexec();
    while (IInexec() == 0) {
      IIsqInit(&sqlca);
      IIexExec(1,(char *)"opqutils2",6075,18137);
      IIputdomio((short *)0,1,32,0,es_owner);
      IIputdomio((short *)0,1,32,0,es_relname);
      IIretinit((char *)0,0);
      if (IInexec() == 0) {
        IIsqInit(&sqlca);
        IIexDefine(1,(char *)"opqutils2",6075,18137);
        IIwritio(0,(short *)0,1,32,0,(char *)
"select table_owner, num_rows, table_type, table_reltid, table_reltidx\
, number_pages, table_stats, overflow_pages, row_width from iitables w\
here table_owner=");
        IIwritio(0,(short *)0,1,32,0,(char *)" $0=");
        IIputdomio((short *)0,1,32,0,es_owner);
        IIwritio(0,(short *)0,1,32,0,(char *)"and table_name=");
        IIwritio(0,(short *)0,1,32,0,(char *)" $1=");
        IIputdomio((short *)0,1,32,0,es_relname);
        IIexDefine(0,(char *)"opqutils2",6075,18137);
        if (IIerrtest() == 0) {
          IIsexec();
        } /* IIerrtest */
      } /* IInexec */
...
IIrtB1:
    while (IInextget() != 0) {
      IIgetdomio((short *)0,1,32,0,es_ownname);
      IIgetdomio((short *)0,1,30,4,&es_nrows);
      IIgetdomio((short *)0,1,32,8 + 1-1,es_type);
      IIgetdomio((short *)0,1,30,4,&es_reltid);
      IIgetdomio((short *)0,1,30,4,&es_xreltid);
      IIgetdomio((short *)0,1,30,4,&es_pages);
      IIgetdomio((short *)0,1,32,8 + 1-1,es_tstat);
      IIgetdomio((short *)0,1,30,4,&es_ovflow);
      IIgetdomio((short *)0,1,30,4,&es_relwid);
      if (IIerrtest() != 0) goto IIrtB1;
/* # line 3481 "opqutils.sc" */	/* host code */
...
/* # line 3616 "opqutils.sc" */	/* repeated select */
  {
    IIsexec();
    while (IInexec() == 0) {
      IIsqInit(&sqlca);
      IIexExec(1,(char *)"opqutils3",6076,18681);
      IIputdomio((short *)0,1,32,0,es_ownname);
      IIputdomio((short *)0,1,32,0,es_relname);
      IIputdomio((short *)0,1,32,0,es_ownname);
      IIputdomio((short *)0,1,32,0,es_relname);
      ...
      if (IInexec() == 0) {
        IIsqInit(&sqlca);
        IIexDefine(1,(char *)"opqutils3",6076,18681);
        IIwritio(0,(short *)0,1,32,0,(char *)
"select first 1 1 from iistats s, iihistograms h where h.table_owner=");
        IIwritio(0,(short *)0,1,32,0,(char *)" $0=");
        IIputdomio((short *)0,1,32,0,es_ownname);
        IIwritio(0,(short *)0,1,32,0,(char *)"and h.table_name=");
        IIwritio(0,(short *)0,1,32,0,(char *)" $1=");
        IIputdomio((short *)0,1,32,0,es_relname);
        IIwritio(0,(short *)0,1,32,0,(char *)"and s.table_owner=");
        IIwritio(0,(short *)0,1,32,0,(char *)" $2=");
        IIputdomio((short *)0,1,32,0,es_ownname);
        IIwritio(0,(short *)0,1,32,0,(char *)"and s.table_name=");
        IIwritio(0,(short *)0,1,32,0,(char *)" $3=");
        IIputdomio((short *)0,1,32,0,es_relname);
        IIwritio(0,(short *)0,1,32,0,(char *)
"and h.table_name=s.table_name and h.table_owner=s.table_owner and h.c\
olumn_name=s.column_name");
        IIexDefine(0,(char *)"opqutils3",6076,18681);
        if (IIerrtest() == 0) {
          IIsexec();
        } /* IIerrtest */
      } /* IInexec */
...
/* # line 3628 "opqutils.sc" */	/* host code */
...
/* # line 3726 "opqutils.sc" */	/* select */
  {
    IIsqInit(&sqlca);
    IIsqMods(1);
    IIwritio(0,(short *)0,1,32,0,(char *)
"select count(*)from iitables where table_owner in(");
    IIputdomio((short *)0,1,32,0,es_ownr);
    IIwritio(0,(short *)0,1,32,0,(char *)", ");
    IIputdomio((short *)0,1,32,0,es_dba);
    IIwritio(0,(short *)0,1,32,0,(char *)")and table_name not like ");
    IIputdomio((short *)0,1,32,0,es_pattern);
    IIwritio(0,(short *)0,1,32,0,(char *)"and table_type in('T', 'I')");
    IIretinit((char *)0,0);
    if (IInextget() != 0) {
      IIgetdomio((short *)0,1,30,4,&rel_cnt);
    } /* IInextget */
    IIsqFlush((char *)0,0);
    if (sqlca.sqlcode < 0) 
      opq_sqlerror();
...
/* # line 3732 "opqutils.sc" */	/* host code */
    }
...
/* # line 3781 "opqutils.sc" */	/* select */
  {
    IIsqInit(&sqlca);
    IIsqMods(1);
    IIwritio(0,(short *)0,1,32,0,(char *)"select dbmsinfo('collation')");
    IIretinit((char *)0,0);
    if (IInextget() != 0) {
      IIgetdomio((short *)0,1,32,0,es_collation);
    } /* IInextget */
    IIsqFlush((char *)0,0);
    if (sqlca.sqlcode < 0) 
      opq_sqlerror();
...
/* # line 3784 "opqutils.sc" */	/* host code */
	...
	** and initialize the ADF control block to point to it. */
	if (status = aducolinit(es_collation,
			       (PTR (*)(u_i4, u_i4, bool, STATUS *))MEreqmem,
			       &tbl, &sys_err)
	    != OK)
	{
	    opq_error((DB_STATUS)E_DB_ERROR,
...
OPQ_GLOBAL *g)
{
  char *es_collation;
    ...
    CL_SYS_ERR  sys_err;	/* OS-specific error information */
    es_collation = (char *)&collation_name;
/* # line 3853 "opqutils.sc" */	/* select */
  {
    IIsqInit(&sqlca);
    IIsqMods(1);
    IIwritio(0,(short *)0,1,32,0,(char *)"select dbmsinfo('ucollation'\
)");
    IIretinit((char *)0,0);
    if (IInextget() != 0) {
      IIgetdomio((short *)0,1,32,0,es_collation);
...
/* # line 3856 "opqutils.sc" */	/* host code */
    if (STlength(es_collation) == 0)
    {
...
/* # line 3940 "opqutils.sc" */	/* select */
  {
    ...
    IIretinit((char *)0,0);
    if (IInextget() != 0) {
      IIgetdomio((short *)0,1,32,0,es_owner);
    } /* IInextget */
    IIsqFlush((char *)0,0);
    if (sqlca.sqlcode < 0) 
      opq_sqlerror();
...
/* # line 3943 "opqutils.sc" */	/* select */
  {
    ...
    IIretinit((char *)0,0);
    if (IInextget() != 0) {
      IIgetdomio((short *)0,1,32,0,es_dba);
    } /* IInextget */
    IIsqFlush((char *)0,0);
    if (sqlca.sqlcode < 0) 
      opq_sqlerror();
...
/* # line 3946 "opqutils.sc" */	/* host code */
...
OPQ_GLOBAL *g)
{
  ...
  char iitables[DB_GW1_MAXNAME + 1];
    ...
    */
/* # line 4059 "opqutils.sc" */	/* select */
  {
    IIsqInit(&sqlca);
    IIwritio(0,(short *)0,1,32,0,(char *)
"select distinct table_name, table_type from iitables where table_name\
 in(");
    IIputdomio((short *)0,1,32,0,iistats);
    IIwritio(0,(short *)0,1,32,0,(char *)", ");
    IIputdomio((short *)0,1,32,0,iihistograms);
    IIwritio(0,(short *)0,1,32,0,(char *)", ");
    IIputdomio((short *)0,1,32,0,iitables);
    IIwritio(0,(short *)0,1,32,0,(char *)")");
    IIretinit((char *)0,0);
    if (IIerrtest() != 0) goto IIrtE3;
IIrtB3:
    while (IInextget() != 0) {
      IIgetdomio((short *)0,1,32,DB_GW1_MAXNAME + 1-1,es_tblname);
      IIgetdomio((short *)0,1,32,8 + 1-1,es_type);
      if (IIerrtest() != 0) goto IIrtB3;
/* # line 4066 "opqutils.sc" */	/* host code */
	if (es_type[0] != 'T' &&
	    es_type[0] != 'V'
	   )
	{
...
/* # line 4186 "opqutils.sc" */	/* describe */
  {
    IIsqInit(&sqlca);
    IIsqDescribe(0,(char *)"s",sqlda,0);
    if (sqlca.sqlcode < 0) 
...
/* # line 4188 "opqutils.sc" */	/* host code */
...
/* # line 4197 "opqutils.sc" */	/* host code */
    while (sqlca.sqlcode == GE_OK)
    {
/* # line 4199 "opqutils.sc" */	/* fetch */
  {
    IIsqInit(&sqlca);
    if (IIcsRetScroll((char *)"c1",6073,1502,-1,-1) != 0) {
      IIcsDaGet(0,sqlda);
...
/* # line 4201 "opqutils.sc" */	/* host code */
...
/* # line 4363 "opqutils.sc" */	/* host code */
    /*
	...
	*/
/* # line 4437 "opqutils.sc" */	/* select */
  {
    IIsqInit(&sqlca);
    IIsqMods(1);
    IIwritio(0,(short *)0,1,32,0,(char *)
"select dbmsinfo('table_statistics')");
    IIretinit((char *)0,0);
    if (IInextget() != 0) {
      IIgetdomio((short *)0,1,32,8,es_tblstats);
    } /* IInextget */
    IIsqFlush((char *)0,0);
    if (sqlca.sqlcode < 0) 
      opq_sqlerror();
...
/* # line 4440 "opqutils.sc" */	/* host code */
...
bool		statdump)
{
  ...
  i4 es_gwid = GW_IMA;
    ...
    */
/* # line 4657 "opqutils.sc" */	/* select */
  {
    IIsqInit(&sqlca);
    IIwritio(0,(short *)0,1,32,0,(char *)
"select t.table_name, t.table_owner, t.num_rows, t.table_reltid, t.tab\
le_reltidx, t.number_pages, t.overflow_pages, t.row_width, t.table_typ\
e, t.table_stats from iitables t, iirelation i where t.table_owner in(");
    IIputdomio((short *)0,1,32,0,es_ownr);
    IIwritio(0,(short *)0,1,32,0,(char *)", ");
    IIputdomio((short *)0,1,32,0,es_dba);
    IIwritio(0,(short *)0,1,32,0,(char *)")and t.table_name not like ");
    IIputdomio((short *)0,1,32,0,es_pattern);
    IIwritio(0,(short *)0,1,32,0,(char *)
"and t.table_type in('T', 'I')and t.table_reltid=i.reltid and t.table_\
name=i.relid and i.relgwid<>");
    IIputdomio((short *)0,1,30,4,&es_gwid);
    IIwritio(0,(short *)0,1,32,0,(char *)
"and(t.table_name<>'remotecmdlock' or t.table_owner<>'$ingres')order b\
y t.table_name");
    IIretinit((char *)0,0);
    if (IIerrtest() != 0) goto IIrtE4;
IIrtB4:
    while (IInextget() != 0) {
      IIgetdomio((short *)0,1,32,0,es_relname);
      IIgetdomio((short *)0,1,32,0,es_ownname);
      IIgetdomio((short *)0,1,30,4,&es_nrows);
      IIgetdomio((short *)0,1,30,4,&es_reltid);
      IIgetdomio((short *)0,1,30,4,&es_xreltid);
      ...
      IIgetdomio((short *)0,1,30,4,&es_ovflow);
      IIgetdomio((short *)0,1,30,4,&es_relwid);
      IIgetdomio((short *)0,1,32,8,es_tabtype);
      IIgetdomio((short *)0,1,32,8 + 1-1,es_tstat);
      if (IIerrtest() != 0) goto IIrtB4;
/* # line 4677 "opqutils.sc" */	/* host code */
	...
	** if current table is in exclusion list. */
	...
	if (!exclude && !overrun && (statdump || es_tabtype[0] != 'I'))
	{
		...
		*/
		overrun = TRUE;
/* # line 4716 "opqutils.sc" */	/* endselect */
      {
        IIbreak();
        if (1) goto IIrtE4;
        if (sqlca.sqlcode < 0) 
...
/* # line 4717 "opqutils.sc" */	/* host code */
	    }
	    else
	    {
...
IIrtE4:;
  ...
  i4 es_num;
	    es_relname = (char *)&(*rpp)->relname;
	    es_ownname = (char *)&(*rpp)->ownname;
/* # line 4778 "opqutils.sc" */	/* repeated select */
  {
    IIsexec();
    while (IInexec() == 0) {
      IIsqInit(&sqlca);
      IIexExec(1,(char *)"opqutils4",6077,26362);
      IIputdomio((short *)0,1,32,0,es_ownname);
      IIputdomio((short *)0,1,32,0,es_relname);
      IIretinit((char *)0,0);
      if (IInexec() == 0) {
        IIsqInit(&sqlca);
        IIexDefine(1,(char *)"opqutils4",6077,26362);
        IIwritio(0,(short *)0,1,32,0,(char *)
"select first 1 1 from iistats s, iihistograms h where h.table_owner=");
        IIwritio(0,(short *)0,1,32,0,(char *)" $0=");
        IIputdomio((short *)0,1,32,0,es_ownname);
...
"and h.table_name=s.table_name and h.table_owner=s.table_owner and h.c\
olumn_name=s.column_name");
        IIexDefine(0,(char *)"opqutils4",6077,26362);
        if (IIerrtest() == 0) {
          IIsexec();
        } /* IIerrtest */
      } /* IInexec */
...
/* # line 4788 "opqutils.sc" */	/* host code */
		(*rpp)->withstats = (bool)TRUE;
    } /* IInextget */
    IIflush((char *)0,0);
IIrtE5:;
