...
/* # line 75 "opqoptdb.sc" */	/* host code */
# define MAXCOLS	(IISQ_MAX_COLS - 1)/2
# define MAXEXIT	5
# define MAXFREQ	2000
# define MAXCOMPOSITE	256
# define OPQ_DEFSAMPLE	500000
...
/* # line 888 "opqoptdb.sc" */	/* host code */
/*{
...
# ifdef NO_COLLID_SUP_IN_STAR
                          ...
                          */
                          if (g->opq_dbms.dbms_type & OPQ_STAR)
                           {
/* # line 1149 "opqoptdb.sc" */	/* repeated select */
  {
    IIsexec();
    while (IInexec() == 0) {
      IIsqInit(&sqlca);
      IIexExec(1,(char *)"opqoptdb1",7597,21370);
      IIputdomio((short *)0,1,32,0,es_rname);
      IIputdomio((short *)0,1,32,0,es_rowner);
      IIputdomio((short *)0,1,32,0,es_atnptr);
      IIretinit((char *)0,0);
      if (IInexec() == 0) {
        IIsqInit(&sqlca);
        IIexDefine(1,(char *)"opqoptdb1",7597,21370);
        IIwritio(0,(short *)0,1,32,0,(char *)
"select column_name, column_datatype, column_length, column_scale, col\
umn_nulls, column_sequence, column_internal_ingtype from iicolumns whe\
re table_name=");
        ...
        IIputdomio((short *)0,1,32,0,es_atnptr);
        IIexDefine(0,(char *)"opqoptdb1",7597,21370);
        if (IIerrtest() == 0) {
          IIsexec();
        } /* IIerrtest */
      } /* IInexec */
...
IIrtB1:
    while (IInextget() != 0) {
      IIgetdomio((short *)0,1,32,0,es_atname);
...
/* # line 1162 "opqoptdb.sc" */	/* host code */
				if (es_ingtype < 0)
...
# endif  /* ifdef NO_COLLID_SUP_IN_STAR   */
                           {
/* # line 1231 "opqoptdb.sc" */	/* repeated select */
  {
    IIsexec();
    while (IInexec() == 0) {
      IIsqInit(&sqlca);
      IIexExec(1,(char *)"opqoptdb2",7598,10600);
      IIputdomio((short *)0,1,32,0,es_rname);
      IIputdomio((short *)0,1,32,0,es_rowner);
      IIputdomio((short *)0,1,32,0,es_atnptr);
      IIretinit((char *)0,0);
      if (IInexec() == 0) {
        IIsqInit(&sqlca);
        IIexDefine(1,(char *)"opqoptdb2",7598,10600);
        IIwritio(0,(short *)0,1,32,0,(char *)
"select column_name, column_datatype, column_length, column_scale, col\
umn_collid, column_nulls, column_sequence, column_internal_ingtype fro\
m iicolumns where table_name=");
        IIwritio(0,(short *)0,1,32,0,(char *)" $0=");
        IIputdomio((short *)0,1,32,0,es_rname);
        IIwritio(0,(short *)0,1,32,0,(char *)"and table_owner=");
        IIwritio(0,(short *)0,1,32,0,(char *)" $1=");
        ...
        IIwritio(0,(short *)0,1,32,0,(char *)" $2=");
        IIputdomio((short *)0,1,32,0,es_atnptr);
        IIexDefine(0,(char *)"opqoptdb2",7598,10600);
        if (IIerrtest() == 0) {
          IIsexec();
        } /* IIerrtest */
      } /* IInexec */
...
IIrtB2:
    while (IInextget() != 0) {
      ...
      IIgetdomio((short *)0,1,30,4,&es_len);
      IIgetdomio((short *)0,1,30,4,&es_scale);
      IIgetdomio((short *)0,1,30,4,&es_collID);
      IIgetdomio((short *)0,1,32,8+1-1,es_nulls);
      IIgetdomio((short *)0,1,30,4,&es_attrno);
      IIgetdomio((short *)0,1,30,2,&es_ingtype);
      if (IIerrtest() != 0) goto IIrtB2;
/* # line 1244 "opqoptdb.sc" */	/* host code */
				if (es_ingtype < 0)
				    es_ingtype = - es_ingtype;
				if (es_ingtype >= ADD_LOW_USER  &&
				    es_ingtype <= ADD_HIGH_USER
...
# ifdef NO_COLLID_SUP_IN_STAR
                         ...
                         */
                         if (g->opq_dbms.dbms_type & OPQ_STAR)
                          {
/* # line 1322 "opqoptdb.sc" */	/* repeated select */
  {
    IIsexec();
    while (IInexec() == 0) {
      IIsqInit(&sqlca);
      IIexExec(1,(char *)"opqoptdb3",7599,8297);
      IIputdomio((short *)0,1,32,0,es_rname);
      IIputdomio((short *)0,1,32,0,es_rowner);
      IIputdomio((short *)0,1,32,0,es_atnptr);
      IIretinit((char *)0,0);
      if (IInexec() == 0) {
        IIsqInit(&sqlca);
        IIexDefine(1,(char *)"opqoptdb3",7599,8297);
        IIwritio(0,(short *)0,1,32,0,(char *)
"select column_name, column_datatype, column_length, column_scale, col\
umn_nulls, column_sequence from iicolumns where table_name=");
        IIwritio(0,(short *)0,1,32,0,(char *)" $0=");
        IIputdomio((short *)0,1,32,0,es_rname);
        IIwritio(0,(short *)0,1,32,0,(char *)"and table_owner=");
        IIwritio(0,(short *)0,1,32,0,(char *)" $1=");
        ...
        IIwritio(0,(short *)0,1,32,0,(char *)" $2=");
        IIputdomio((short *)0,1,32,0,es_atnptr);
        IIexDefine(0,(char *)"opqoptdb3",7599,8297);
        if (IIerrtest() == 0) {
          IIsexec();
        } /* IIerrtest */
      } /* IInexec */
...
/* # line 1335 "opqoptdb.sc" */	/* host code */
				/* Make sure we can build histos for this type. */
...
# endif  /* ifdef NO_COLLID_SUP_IN_STAR   */
                        { 
/* # line 1380 "opqoptdb.sc" */	/* repeated select */
  {
    IIsexec();
    while (IInexec() == 0) {
      IIsqInit(&sqlca);
      IIexExec(1,(char *)"opqoptdb4",7600,9065);
      IIputdomio((short *)0,1,32,0,es_rname);
      IIputdomio((short *)0,1,32,0,es_rowner);
      IIputdomio((short *)0,1,32,0,es_atnptr);
      IIretinit((char *)0,0);
      if (IInexec() == 0) {
        IIsqInit(&sqlca);
        IIexDefine(1,(char *)"opqoptdb4",7600,9065);
        IIwritio(0,(short *)0,1,32,0,(char *)
"select column_name, column_datatype, column_length, column_scale, col\
umn_collid, column_nulls, column_sequence from iicolumns where table_n\
ame=");
        IIwritio(0,(short *)0,1,32,0,(char *)" $0=");
        IIputdomio((short *)0,1,32,0,es_rname);
        IIwritio(0,(short *)0,1,32,0,(char *)"and table_owner=");
        ...
        IIwritio(0,(short *)0,1,32,0,(char *)" $2=");
        IIputdomio((short *)0,1,32,0,es_atnptr);
        IIexDefine(0,(char *)"opqoptdb4",7600,9065);
        if (IIerrtest() == 0) {
          IIsexec();
        } /* IIerrtest */
      } /* IInexec */
...
/* # line 1393 "opqoptdb.sc" */	/* host code */
				/* Make sure we can build histos for this type. */
				if (adi_dtinfo(g->opq_adfcb, es_ingtype,
					&typeflags) || (typeflags & AD_NOHISTOGRAM))
				{
...
# ifdef NO_COLLID_SUP_IN_STAR
          ...
          */
          if (g->opq_dbms.dbms_type & OPQ_STAR)
           {
/* # line 1537 "opqoptdb.sc" */	/* repeated select */
  {
    IIsexec();
    while (IInexec() == 0) {
      IIsqInit(&sqlca);
      IIexExec(1,(char *)"opqoptdb5",7601,7906);
      IIputdomio((short *)0,1,32,0,es1_rname);
      IIputdomio((short *)0,1,32,0,es1_rowner);
      IIretinit((char *)0,0);
      if (IInexec() == 0) {
        IIsqInit(&sqlca);
        IIexDefine(1,(char *)"opqoptdb5",7601,7906);
        IIwritio(0,(short *)0,1,32,0,(char *)
"select column_name, column_datatype, column_length, column_scale, col\
umn_nulls, column_sequence, key_sequence, column_internal_ingtype from\
 iicolumns where table_name=");
        IIwritio(0,(short *)0,1,32,0,(char *)" $0=");
        IIputdomio((short *)0,1,32,0,es1_rname);
        IIwritio(0,(short *)0,1,32,0,(char *)"and table_owner=");
        IIwritio(0,(short *)0,1,32,0,(char *)" $1=");
        ...
        IIexDefine(0,(char *)"opqoptdb5",7601,7906);
        if (IIerrtest() == 0) {
          IIsexec();
        } /* IIerrtest */
      } /* IInexec */
...
IIrtB5:
    while (IInextget() != 0) {
      ...
      IIgetdomio((short *)0,1,30,4,&es1_keysq);
      IIgetdomio((short *)0,1,30,2,&es1_ingtype);
      if (IIerrtest() != 0) goto IIrtB5;
/* # line 1550 "opqoptdb.sc" */	/* host code */
		if (es1_ingtype < 0)
...
/* # line 1634 "opqoptdb.sc" */	/* host code */
           }    
          else   /* End of the special handling for Star DB */
# endif  /* ifdef NO_COLLID_SUP_IN_STAR */
           {
/* # line 1638 "opqoptdb.sc" */	/* repeated select */
  {
    IIsexec();
    while (IInexec() == 0) {
      IIsqInit(&sqlca);
      IIexExec(1,(char *)"opqoptdb6",7602,3832);
      IIputdomio((short *)0,1,32,0,es1_rname);
      IIputdomio((short *)0,1,32,0,es1_rowner);
      IIretinit((char *)0,0);
      if (IInexec() == 0) {
        IIsqInit(&sqlca);
        IIexDefine(1,(char *)"opqoptdb6",7602,3832);
        IIwritio(0,(short *)0,1,32,0,(char *)
"select column_name, column_datatype, column_length, column_scale, col\
umn_collid, column_nulls, column_sequence, key_sequence, column_intern\
al_ingtype from iicolumns where table_name=");
        IIwritio(0,(short *)0,1,32,0,(char *)" $0=");
        IIputdomio((short *)0,1,32,0,es1_rname);
        IIwritio(0,(short *)0,1,32,0,(char *)"and table_owner=");
        IIwritio(0,(short *)0,1,32,0,(char *)" $1=");
        IIputdomio((short *)0,1,32,0,es1_rowner);
        IIwritio(0,(short *)0,1,32,0,(char *)"order by key_sequence");
        IIexDefine(0,(char *)"opqoptdb6",7602,3832);
        if (IIerrtest() == 0) {
          IIsexec();
        } /* IIerrtest */
      } /* IInexec */
...
IIrtB6:
    while (IInextget() != 0) {
      ...
      IIgetdomio((short *)0,1,30,4,&es1_len);
      IIgetdomio((short *)0,1,30,4,&es1_scale);
      IIgetdomio((short *)0,1,30,4,&es1_collID);
      IIgetdomio((short *)0,1,32,8+1-1,es1_nulls);
      IIgetdomio((short *)0,1,30,4,&es1_atno);
      IIgetdomio((short *)0,1,30,4,&es1_keysq);
      IIgetdomio((short *)0,1,30,2,&es1_ingtype);
      if (IIerrtest() != 0) goto IIrtB6;
/* # line 1651 "opqoptdb.sc" */	/* host code */
		if (es1_ingtype < 0)
		    es1_ingtype = - es1_ingtype;
		if (es1_ingtype >= ADD_LOW_USER  &&
		    es1_ingtype <= ADD_HIGH_USER
...
/* # line 1737 "opqoptdb.sc" */	/* host code */
             }
           }
	}
	else
...
# ifdef NO_COLLID_SUP_IN_STAR
         ...
         */
         if (g->opq_dbms.dbms_type & OPQ_STAR)  
          {
/* # line 1752 "opqoptdb.sc" */	/* repeated select */
  {
    IIsexec();
    while (IInexec() == 0) {
      IIsqInit(&sqlca);
      IIexExec(1,(char *)"opqoptdb7",7603,32740);
      IIputdomio((short *)0,1,32,0,es1_rname);
      IIputdomio((short *)0,1,32,0,es1_rowner);
      IIretinit((char *)0,0);
      if (IInexec() == 0) {
        IIsqInit(&sqlca);
        IIexDefine(1,(char *)"opqoptdb7",7603,32740);
        IIwritio(0,(short *)0,1,32,0,(char *)
"select column_name, column_datatype, column_length, column_scale, col\
umn_nulls, column_sequence, key_sequence, column_ingdatatype from iico\
lumns where table_name=");
        IIwritio(0,(short *)0,1,32,0,(char *)" $0=");
        IIputdomio((short *)0,1,32,0,es1_rname);
        IIwritio(0,(short *)0,1,32,0,(char *)"and table_owner=");
        IIwritio(0,(short *)0,1,32,0,(char *)" $1=");
        IIputdomio((short *)0,1,32,0,es1_rowner);
        IIwritio(0,(short *)0,1,32,0,(char *)"order by key_sequence");
        IIexDefine(0,(char *)"opqoptdb7",7603,32740);
        if (IIerrtest() == 0) {
          IIsexec();
        } /* IIerrtest */
      } /* IInexec */
...
/* # line 1763 "opqoptdb.sc" */	/* host code */
...
/* # line 1833 "opqoptdb.sc" */	/* host code */
          }  
         else  /* End of the special handling for Star DB */
# endif  /*  ifdef NO_COLLID_SUP_IN_STAR  */
          {
/* # line 1837 "opqoptdb.sc" */	/* repeated select */
  {
    IIsexec();
    while (IInexec() == 0) {
      IIsqInit(&sqlca);
      IIexExec(1,(char *)"opqoptdb8",7604,3830);
      IIputdomio((short *)0,1,32,0,es1_rname);
      IIputdomio((short *)0,1,32,0,es1_rowner);
      IIretinit((char *)0,0);
      if (IInexec() == 0) {
        IIsqInit(&sqlca);
        IIexDefine(1,(char *)"opqoptdb8",7604,3830);
        IIwritio(0,(short *)0,1,32,0,(char *)
"select column_name, column_datatype, column_length, column_scale, col\
umn_collid, column_nulls, column_sequence, key_sequence from iicolumns\
 where table_name=");
        IIwritio(0,(short *)0,1,32,0,(char *)" $0=");
        IIputdomio((short *)0,1,32,0,es1_rname);
        IIwritio(0,(short *)0,1,32,0,(char *)"and table_owner=");
        ...
        IIputdomio((short *)0,1,32,0,es1_rowner);
        IIwritio(0,(short *)0,1,32,0,(char *)"order by key_sequence");
        IIexDefine(0,(char *)"opqoptdb8",7604,3830);
        if (IIerrtest() == 0) {
          IIsexec();
        } /* IIerrtest */
      } /* IInexec */
...
/* # line 1848 "opqoptdb.sc" */	/* host code */
		if ((relp->index || relp->comphist || g->opq_comppkey) && 
			(es1_keysq == 0 ||
			MEcmp("tidp                            ", 
			    (PTR)es1_atname, sizeof(DB_ATT_NAME)) == 0 ||
...
/* # line 1920 "opqoptdb.sc" */	/* host code */
             }
          }
        }
...
# ifdef NO_COLLID_SUP_IN_STAR
         ...
         */
         if (g->opq_dbms.dbms_type & OPQ_STAR)
          {
/* # line 1980 "opqoptdb.sc" */	/* repeated select */
  {
    IIsexec();
    while (IInexec() == 0) {
      IIsqInit(&sqlca);
      IIexExec(1,(char *)"opqoptdb9",7605,4719);
      IIputdomio((short *)0,1,32,0,es2_rname);
      IIputdomio((short *)0,1,32,0,es2_rowner);
      IIputdomio((short *)0,1,32,0,es2_rname);
      IIputdomio((short *)0,1,32,0,es2_rowner);
      IIretinit((char *)0,0);
      if (IInexec() == 0) {
        IIsqInit(&sqlca);
        IIexDefine(1,(char *)"opqoptdb9",7605,4719);
        IIwritio(0,(short *)0,1,32,0,(char *)
"select distinct c.column_name, c.column_datatype, c.column_length, c.\
column_scale, c.column_nulls, c.column_sequence, c.column_internal_ing\
type from iicolumns c, iiindexes i, iiindex_columns ic where i.base_na\
me=");
        IIwritio(0,(short *)0,1,32,0,(char *)" $0=");
        IIputdomio((short *)0,1,32,0,es2_rname);
        ...
        IIwritio(0,(short *)0,1,32,0,(char *)" $1=");
        IIputdomio((short *)0,1,32,0,es2_rowner);
        IIwritio(0,(short *)0,1,32,0,(char *)"and c.table_name=");
        IIwritio(0,(short *)0,1,32,0,(char *)" $2=");
        IIputdomio((short *)0,1,32,0,es2_rname);
        ...
        IIputdomio((short *)0,1,32,0,es2_rowner);
        IIwritio(0,(short *)0,1,32,0,(char *)
"and i.index_name=ic.index_name and i.index_owner=ic.index_owner and c\
.column_name=ic.column_name and c.table_name=i.base_name and c.table_o\
wner=i.base_owner");
        IIexDefine(0,(char *)"opqoptdb9",7605,4719);
        if (IIerrtest() == 0) {
          IIsexec();
        } /* IIerrtest */
      } /* IInexec */
...
IIrtB9:
    while (IInextget() != 0) {
      IIgetdomio((short *)0,1,32,0,es2_atname);
      IIgetdomio((short *)0,1,32,DB_GW1_MAXNAME+1-1,es2_type);
      IIgetdomio((short *)0,1,30,4,&es2_len);
      IIgetdomio((short *)0,1,30,4,&es2_scale);
      IIgetdomio((short *)0,1,32,8+1-1,es2_nulls);
      IIgetdomio((short *)0,1,30,4,&es2_atno);
      IIgetdomio((short *)0,1,30,2,&es2_ingtype);
      if (IIerrtest() != 0) goto IIrtB9;
/* # line 1998 "opqoptdb.sc" */	/* host code */
		if (es2_ingtype < 0)
...
# endif   /* ifdef  NO_COLLID_SUP_IN_STAR  */
          {
/* # line 2076 "opqoptdb.sc" */	/* repeated select */
  {
    IIsexec();
    while (IInexec() == 0) {
      IIsqInit(&sqlca);
      IIexExec(1,(char *)"opqoptdb10",7606,3442);
      IIputdomio((short *)0,1,32,0,es2_rname);
      IIputdomio((short *)0,1,32,0,es2_rowner);
      IIputdomio((short *)0,1,32,0,es2_rname);
      IIputdomio((short *)0,1,32,0,es2_rowner);
      ...
      if (IInexec() == 0) {
        IIsqInit(&sqlca);
        IIexDefine(1,(char *)"opqoptdb10",7606,3442);
        IIwritio(0,(short *)0,1,32,0,(char *)
"select distinct c.column_name, c.column_datatype, c.column_length, c.\
column_scale, c.column_collid, c.column_nulls, c.column_sequence, c.co\
lumn_internal_ingtype from iicolumns c, iiindexes i, iiindex_columns i\
c where i.base_name=");
        IIwritio(0,(short *)0,1,32,0,(char *)" $0=");
        IIputdomio((short *)0,1,32,0,es2_rname);
        IIwritio(0,(short *)0,1,32,0,(char *)"and i.base_owner=");
...
.column_name=ic.column_name and c.table_name=i.base_name and c.table_o\
wner=i.base_owner");
        IIexDefine(0,(char *)"opqoptdb10",7606,3442);
        if (IIerrtest() == 0) {
          IIsexec();
        } /* IIerrtest */
      } /* IInexec */
...
IIrtB10:
    while (IInextget() != 0) {
      ...
      IIgetdomio((short *)0,1,30,4,&es2_len);
      IIgetdomio((short *)0,1,30,4,&es2_scale);
      IIgetdomio((short *)0,1,30,4,&es2_collID);
      IIgetdomio((short *)0,1,32,8+1-1,es2_nulls);
      IIgetdomio((short *)0,1,30,4,&es2_atno);
      IIgetdomio((short *)0,1,30,2,&es2_ingtype);
      if (IIerrtest() != 0) goto IIrtB10;
/* # line 2094 "opqoptdb.sc" */	/* host code */
		if (es2_ingtype < 0)
		    es2_ingtype = -es2_ingtype;
		if (es2_ingtype >= ADD_LOW_USER  &&
		    es2_ingtype <= ADD_HIGH_USER
...
# ifdef NO_COLLID_SUP_IN_STAR
          ...
          */
          if (g->opq_dbms.dbms_type & OPQ_STAR)
           {
/* # line 2183 "opqoptdb.sc" */	/* repeated select */
  {
    IIsexec();
    while (IInexec() == 0) {
      IIsqInit(&sqlca);
      IIexExec(1,(char *)"opqoptdb11",7607,7516);
      IIputdomio((short *)0,1,32,0,es2_rname);
      IIputdomio((short *)0,1,32,0,es2_rowner);
      IIputdomio((short *)0,1,32,0,es2_rname);
      IIputdomio((short *)0,1,32,0,es2_rowner);
      ...
      if (IInexec() == 0) {
        IIsqInit(&sqlca);
        IIexDefine(1,(char *)"opqoptdb11",7607,7516);
        IIwritio(0,(short *)0,1,32,0,(char *)
"select distinct c.column_name, c.column_datatype, c.column_length, c.\
column_scale, c.column_nulls, c.column_sequence from iicolumns c, iiin\
dexes i, iiindex_columns ic where i.base_name=");
        IIwritio(0,(short *)0,1,32,0,(char *)" $0=");
        IIputdomio((short *)0,1,32,0,es2_rname);
        IIwritio(0,(short *)0,1,32,0,(char *)"and i.base_owner=");
        IIwritio(0,(short *)0,1,32,0,(char *)" $1=");
...
.column_name=ic.column_name and c.table_name=i.base_name and c.table_o\
wner=i.base_owner");
        IIexDefine(0,(char *)"opqoptdb11",7607,7516);
        if (IIerrtest() == 0) {
          IIsexec();
        } /* IIerrtest */
      } /* IInexec */
...
/* # line 2201 "opqoptdb.sc" */	/* host code */
...
# endif  /* ifdef NO_COLLID_SUP_IN_STAR  */
           {
/* # line 2265 "opqoptdb.sc" */	/* repeated select */
  {
    IIsexec();
    while (IInexec() == 0) {
      IIsqInit(&sqlca);
      IIexExec(1,(char *)"opqoptdb12",7608,2928);
      IIputdomio((short *)0,1,32,0,es2_rname);
      IIputdomio((short *)0,1,32,0,es2_rowner);
      IIputdomio((short *)0,1,32,0,es2_rname);
      IIputdomio((short *)0,1,32,0,es2_rowner);
      ...
      if (IInexec() == 0) {
        IIsqInit(&sqlca);
        IIexDefine(1,(char *)"opqoptdb12",7608,2928);
        IIwritio(0,(short *)0,1,32,0,(char *)
"select distinct c.column_name, c.column_datatype, c.column_length, c.\
column_scale, c.column_collid, c.column_nulls, c.column_sequence from \
iicolumns c, iiindexes i, iiindex_columns ic where i.base_name=");
        IIwritio(0,(short *)0,1,32,0,(char *)" $0=");
        IIputdomio((short *)0,1,32,0,es2_rname);
        IIwritio(0,(short *)0,1,32,0,(char *)"and i.base_owner=");
        IIwritio(0,(short *)0,1,32,0,(char *)" $1=");
...
.column_name=ic.column_name and c.table_name=i.base_name and c.table_o\
wner=i.base_owner");
        IIexDefine(0,(char *)"opqoptdb12",7608,2928);
        if (IIerrtest() == 0) {
          IIsexec();
        } /* IIerrtest */
      } /* IInexec */
...
/* # line 2283 "opqoptdb.sc" */	/* host code */
		if (!overrun && doatt(attlst, es2_atno, ai, TRUE))
		{
		    if (ai >= g->opq_dbcaps.max_cols)
		    {
...
/* # line 2753 "opqoptdb.sc" */	/* host code */
    }
...
/* # line 2767 "opqoptdb.sc" */	/* repeated update */
  {
    IIsexec();
    while (IInexec() == 0) {
      IIsqInit(&sqlca);
      IIexExec(1,(char *)"opqoptdb13",7609,28506);
      IIputdomio((short *)0,1,32,0,es_yes);
      IIputdomio((short *)0,1,32,0,rname);
      IIputdomio((short *)0,1,32,0,rowner);
      IIsyncup((char *)0,0);
      if (IInexec() == 0) {
        IIsqInit(&sqlca);
        IIexDefine(1,(char *)"opqoptdb13",7609,28506);
        IIwritio(0,(short *)0,1,32,0,(char *)
"update iitables set table_stats=");
        ...
        IIwritio(0,(short *)0,1,32,0,(char *)" $2=");
        IIputdomio((short *)0,1,32,0,rowner);
        IIexDefine(0,(char *)"opqoptdb13",7609,28506);
        if (IIerrtest() == 0) {
          IIsexec();
        } /* IIerrtest */
      } /* IInexec */
...
/* # line 2772 "opqoptdb.sc" */	/* host code */
# ifdef FUTURE_USE
/* # line 2773 "opqoptdb.sc" */	/* repeated update */
  {
    IIsexec();
    while (IInexec() == 0) {
      IIsqInit(&sqlca);
      IIexExec(1,(char *)"opqoptdb14",7610,25818);
      IIputdomio((short *)0,1,32,0,es_yes);
      IIputdomio((short *)0,1,32,0,rname);
      IIputdomio((short *)0,1,32,0,rowner);
      IIsyncup((char *)0,0);
      if (IInexec() == 0) {
        IIsqInit(&sqlca);
        IIexDefine(1,(char *)"opqoptdb14",7610,25818);
        IIwritio(0,(short *)0,1,32,0,(char *)
"update iiphysical_tables set table_stats=");
        ...
        IIwritio(0,(short *)0,1,32,0,(char *)" $2=");
        IIputdomio((short *)0,1,32,0,rowner);
        IIexDefine(0,(char *)"opqoptdb14",7610,25818);
        if (IIerrtest() == 0) {
          IIsexec();
        } /* IIerrtest */
      } /* IInexec */
...
/* # line 2777 "opqoptdb.sc" */	/* host code */
# endif /* FUTURE_USE */
    }
...
/* # line 2847 "opqoptdb.sc" */	/* repeated insert */
  {
    IIsexec();
    while (IInexec() == 0) {
      IIsqInit(&sqlca);
      IIexExec(1,(char *)"opqoptdb15",7611,24153);
      IIputdomio((short *)0,1,32,0,rname);
      IIputdomio((short *)0,1,32,0,rowner);
      IIputdomio((short *)0,1,32,0,atrname);
      IIputdomio((short *)0,1,30,2,&es2_sequence);
      IIputdomio((short *)0,1,44,0,&es2_hist);
      IIsyncup((char *)0,0);
      if (IInexec() == 0) {
        IIsqInit(&sqlca);
        IIexDefine(1,(char *)"opqoptdb15",7611,24153);
        IIwritio(0,(short *)0,1,32,0,(char *)
"insert into iihistograms(table_name, table_owner, column_name, text_s\
equence, text_segment)values(");
        IIwritio(0,(short *)0,1,32,0,(char *)" $0=");
        IIputdomio((short *)0,1,32,0,rname);
        IIwritio(0,(short *)0,1,32,0,(char *)", ");
        IIwritio(0,(short *)0,1,32,0,(char *)" $1=");
        ...
        IIputdomio((short *)0,1,44,0,&es2_hist);
        IIwritio(0,(short *)0,1,32,0,(char *)")");
        IIexDefine(0,(char *)"opqoptdb15",7611,24153);
        if (IIerrtest() == 0) {
          IIsexec();
        } /* IIerrtest */
      } /* IInexec */
...
/* # line 2850 "opqoptdb.sc" */	/* host code */
    }
    else
    {
  i4 reltid;
...
/* # line 2863 "opqoptdb.sc" */	/* repeated insert */
  {
    IIsexec();
    while (IInexec() == 0) {
      IIsqInit(&sqlca);
      IIexExec(1,(char *)"opqoptdb16",7612,9434);
      IIputdomio((short *)0,1,30,4,&reltid);
      IIputdomio((short *)0,1,30,4,&reltidx);
      IIputdomio((short *)0,1,30,2,&atrno);
      IIputdomio((short *)0,1,30,2,&es2_sequence);
      IIputdomio((short *)0,1,44,0,&es2_hist);
      IIsyncup((char *)0,0);
      if (IInexec() == 0) {
        IIsqInit(&sqlca);
        IIexDefine(1,(char *)"opqoptdb16",7612,9434);
        IIwritio(0,(short *)0,1,32,0,(char *)
"insert into iihistogram(htabbase, htabindex, hatno, hsequence, histog\
ram)values(");
        IIwritio(0,(short *)0,1,32,0,(char *)" $0=");
        IIputdomio((short *)0,1,30,4,&reltid);
        IIwritio(0,(short *)0,1,32,0,(char *)", ");
        ...
        IIputdomio((short *)0,1,44,0,&es2_hist);
        IIwritio(0,(short *)0,1,32,0,(char *)")");
        IIexDefine(0,(char *)"opqoptdb16",7612,9434);
        if (IIerrtest() == 0) {
          IIsexec();
        } /* IIerrtest */
      } /* IInexec */
...
/* # line 2866 "opqoptdb.sc" */	/* host code */
    }
}
/*{
...
bool		   fromfile)
{
  ...
  f8 statrepf;
	...
	** reptfact with it. */
/* # line 3501 "opqoptdb.sc" */	/* host code */
	if (g->opq_dbcaps.cat_updateable & OPQ_STATS_UPD)
	{
/* # line 3503 "opqoptdb.sc" */	/* repeated select */
  {
    IIsexec();
    while (IInexec() == 0) {
      IIsqInit(&sqlca);
      IIexExec(1,(char *)"opqoptdb17",7613,20327);
      IIputdomio((short *)0,1,32,0,rname);
      IIputdomio((short *)0,1,32,0,rowner);
      IIputdomio((short *)0,1,32,0,atrname);
      IIretinit((char *)0,0);
      if (IInexec() == 0) {
        IIsqInit(&sqlca);
        IIsqMods(1);
        IIexDefine(1,(char *)"opqoptdb17",7613,20327);
        IIwritio(0,(short *)0,1,32,0,(char *)
"select rept_factor from iistats where table_name=");
        IIwritio(0,(short *)0,1,32,0,(char *)" $0=");
        IIputdomio((short *)0,1,32,0,rname);
        IIwritio(0,(short *)0,1,32,0,(char *)"and table_owner=");
        IIwritio(0,(short *)0,1,32,0,(char *)" $1=");
        ...
        IIwritio(0,(short *)0,1,32,0,(char *)" $2=");
        IIputdomio((short *)0,1,32,0,atrname);
        IIexDefine(0,(char *)"opqoptdb17",7613,20327);
        if (IIerrtest() == 0) {
          IIsexec();
        } /* IIerrtest */
      } /* IInexec */
    ...
    if (IInextget() != 0) {
      IIgetdomio((short *)0,1,31,8,&statrepf);
    } /* IInextget */
    IIsqFlush((char *)0,0);
    if (sqlca.sqlcode < 0) 
      opq_sqlerror();
  }
/* # line 3507 "opqoptdb.sc" */	/* host code */
	}
	else
	{
/* # line 3510 "opqoptdb.sc" */	/* repeated select */
  {
    IIsexec();
    while (IInexec() == 0) {
      IIsqInit(&sqlca);
      IIexExec(1,(char *)"opqoptdb18",7614,17749);
      IIputdomio((short *)0,1,30,4,&reltid);
      IIputdomio((short *)0,1,30,4,&reltidx);
      IIputdomio((short *)0,1,30,2,&atrno);
      IIretinit((char *)0,0);
      if (IInexec() == 0) {
        IIsqInit(&sqlca);
        IIsqMods(1);
        IIexDefine(1,(char *)"opqoptdb18",7614,17749);
        IIwritio(0,(short *)0,1,32,0,(char *)
"select sreptfact from iistatistics where stabbase=");
        IIwritio(0,(short *)0,1,32,0,(char *)" $0=");
        IIputdomio((short *)0,1,30,4,&reltid);
        ...
        IIwritio(0,(short *)0,1,32,0,(char *)" $2=");
        IIputdomio((short *)0,1,30,2,&atrno);
        IIexDefine(0,(char *)"opqoptdb18",7614,17749);
        if (IIerrtest() == 0) {
          IIsexec();
        } /* IIerrtest */
      } /* IInexec */
...
/* # line 3514 "opqoptdb.sc" */	/* host code */
	}
/* # line 3516 "opqoptdb.sc" */	/* host code */
	if (sqlca.sqlerrd[2]) 
	{
	...
	*/
	if (g->opq_dbcaps.cat_updateable & OPQ_STATS_UPD)
	{
/* # line 3560 "opqoptdb.sc" */	/* repeat delete */
  {
    IIsexec();
    while (IInexec() == 0) {
      IIsqInit(&sqlca);
      IIexExec(1,(char *)"opqoptdb19",7615,24280);
      IIputdomio((short *)0,1,32,0,rname);
      IIputdomio((short *)0,1,32,0,rowner);
      IIputdomio((short *)0,1,32,0,atrname);
      IIsyncup((char *)0,0);
      if (IInexec() == 0) {
        IIsqInit(&sqlca);
        IIexDefine(1,(char *)"opqoptdb19",7615,24280);
        IIwritio(0,(short *)0,1,32,0,(char *)
"delete from iistats where table_name=");
        ...
        IIwritio(0,(short *)0,1,32,0,(char *)" $2=");
        IIputdomio((short *)0,1,32,0,atrname);
        IIexDefine(0,(char *)"opqoptdb19",7615,24280);
        if (IIerrtest() == 0) {
          IIsexec();
        } /* IIerrtest */
      } /* IInexec */
...
/* # line 3563 "opqoptdb.sc" */	/* host code */
	}
	else
	{
/* # line 3567 "opqoptdb.sc" */	/* repeat delete */
  {
    IIsexec();
    while (IInexec() == 0) {
      IIsqInit(&sqlca);
      IIexExec(1,(char *)"opqoptdb20",7616,14436);
      IIputdomio((short *)0,1,30,4,&reltid);
      IIputdomio((short *)0,1,30,4,&reltidx);
      IIputdomio((short *)0,1,30,2,&atrno);
      IIsyncup((char *)0,0);
      if (IInexec() == 0) {
        IIsqInit(&sqlca);
        IIexDefine(1,(char *)"opqoptdb20",7616,14436);
        IIwritio(0,(short *)0,1,32,0,(char *)
"delete from iistatistics where stabbase=");
        ...
        IIwritio(0,(short *)0,1,32,0,(char *)" $2=");
        IIputdomio((short *)0,1,30,2,&atrno);
        IIexDefine(0,(char *)"opqoptdb20",7616,14436);
        if (IIerrtest() == 0) {
          IIsexec();
        } /* IIerrtest */
      } /* IInexec */
...
/* # line 3570 "opqoptdb.sc" */	/* host code */
	}
	if (g->opq_dbcaps.cat_updateable & OPQ_HISTS_UPD)
	{
/* # line 3575 "opqoptdb.sc" */	/* repeat delete */
  {
    IIsexec();
    while (IInexec() == 0) {
      IIsqInit(&sqlca);
      IIexExec(1,(char *)"opqoptdb21",7617,9813);
      IIputdomio((short *)0,1,32,0,rname);
      IIputdomio((short *)0,1,32,0,rowner);
      IIputdomio((short *)0,1,32,0,atrname);
      IIsyncup((char *)0,0);
      if (IInexec() == 0) {
        IIsqInit(&sqlca);
        IIexDefine(1,(char *)"opqoptdb21",7617,9813);
        IIwritio(0,(short *)0,1,32,0,(char *)
"delete from iihistograms where table_name=");
        ...
        IIwritio(0,(short *)0,1,32,0,(char *)" $2=");
        IIputdomio((short *)0,1,32,0,atrname);
        IIexDefine(0,(char *)"opqoptdb21",7617,9813);
        if (IIerrtest() == 0) {
          IIsexec();
        } /* IIerrtest */
      } /* IInexec */
...
/* # line 3578 "opqoptdb.sc" */	/* host code */
	}
	else
	{
/* # line 3582 "opqoptdb.sc" */	/* repeat delete */
  {
    IIsexec();
    while (IInexec() == 0) {
      IIsqInit(&sqlca);
      IIexExec(1,(char *)"opqoptdb22",7618,9042);
      IIputdomio((short *)0,1,30,4,&reltid);
      IIputdomio((short *)0,1,30,4,&reltidx);
      IIputdomio((short *)0,1,30,2,&atrno);
      IIsyncup((char *)0,0);
      if (IInexec() == 0) {
        IIsqInit(&sqlca);
        IIexDefine(1,(char *)"opqoptdb22",7618,9042);
        IIwritio(0,(short *)0,1,32,0,(char *)
"delete from iihistogram where htabbase=");
        ...
        IIwritio(0,(short *)0,1,32,0,(char *)" $2=");
        IIputdomio((short *)0,1,30,2,&atrno);
        IIexDefine(0,(char *)"opqoptdb22",7618,9042);
        if (IIerrtest() == 0) {
          IIsexec();
        } /* IIerrtest */
      } /* IInexec */
...
/* # line 3585 "opqoptdb.sc" */	/* host code */
	}
    }
...
/* # line 3662 "opqoptdb.sc" */	/* repeated insert */
  {
    IIsexec();
    while (IInexec() == 0) {
      IIsqInit(&sqlca);
      IIexExec(1,(char *)"opqoptdb23",7619,10065);
      IIputdomio((short *)0,1,32,0,rname);
      IIputdomio((short *)0,1,32,0,rowner);
      IIputdomio((short *)0,1,32,0,atrname);
      IIputdomio((short *)0,1,32,0,es3_date);
      IIputdomio((short *)0,1,31,4,&es3_nunique);
      IIputdomio((short *)0,1,31,4,&es3_reptfact);
      IIputdomio((short *)0,1,32,0,es3_charunique);
      IIputdomio((short *)0,1,31,4,&es3_null_count);
      IIputdomio((short *)0,1,30,2,&es3_max_cell);
      IIputdomio((short *)0,1,30,2,&es3_domain);
      IIputdomio((short *)0,1,32,0,es3_charcomplete);
      IIputdomio((short *)0,1,32,0,es3_version);
      IIputdomio((short *)0,1,30,2,&es3_histlength);
      IIsyncup((char *)0,0);
      if (IInexec() == 0) {
        IIsqInit(&sqlca);
        IIexDefine(1,(char *)"opqoptdb23",7619,10065);
        IIwritio(0,(short *)0,1,32,0,(char *)
"insert into iistats(table_name, table_owner, column_name, create_date\
, num_unique, rept_factor, has_unique, pct_nulls, num_cells, column_do\
main, is_complete, stat_version, hist_data_length)values(");
        IIwritio(0,(short *)0,1,32,0,(char *)" $0=");
        IIputdomio((short *)0,1,32,0,rname);
        IIwritio(0,(short *)0,1,32,0,(char *)", ");
        IIwritio(0,(short *)0,1,32,0,(char *)" $1=");
        ...
        IIputdomio((short *)0,1,30,2,&es3_histlength);
        IIwritio(0,(short *)0,1,32,0,(char *)")");
        IIexDefine(0,(char *)"opqoptdb23",7619,10065);
        if (IIerrtest() == 0) {
          IIsexec();
        } /* IIerrtest */
      } /* IInexec */
...
/* # line 3670 "opqoptdb.sc" */	/* host code */
	}
	else
	{
	    /*
	    ...
	    */
/* # line 3678 "opqoptdb.sc" */	/* repeated insert */
  {
    IIsexec();
    while (IInexec() == 0) {
      IIsqInit(&sqlca);
      IIexExec(1,(char *)"opqoptdb24",7620,8162);
      IIputdomio((short *)0,1,30,4,&reltid);
      IIputdomio((short *)0,1,30,4,&reltidx);
      IIputdomio((short *)0,1,31,4,&es3_nunique);
      IIputdomio((short *)0,1,31,4,&es3_reptfact);
      ...
      IIputdomio((short *)0,1,30,2,&es3_max_cell);
      IIputdomio((short *)0,1,30,2,&es3_domain);
      IIputdomio((short *)0,1,30,1,&es3_complete);
      IIputdomio((short *)0,1,30,1,&es3_unique);
      IIputdomio((short *)0,1,32,0,es3_version);
      IIputdomio((short *)0,1,30,2,&es3_histlength);
      IIsyncup((char *)0,0);
      if (IInexec() == 0) {
        IIsqInit(&sqlca);
        IIexDefine(1,(char *)"opqoptdb24",7620,8162);
        IIwritio(0,(short *)0,1,32,0,(char *)
"insert into iistatistics(stabbase, stabindex, snunique, sreptfact, sn\
ull, satno, snumcells, sdomain, scomplete, sunique, sdate, sversion, s\
histlength)values(");
        IIwritio(0,(short *)0,1,32,0,(char *)" $0=");
        IIputdomio((short *)0,1,30,4,&reltid);
        IIwritio(0,(short *)0,1,32,0,(char *)", ");
        ...
        IIputdomio((short *)0,1,30,2,&es3_histlength);
        IIwritio(0,(short *)0,1,32,0,(char *)")");
        IIexDefine(0,(char *)"opqoptdb24",7620,8162);
        if (IIerrtest() == 0) {
          IIsexec();
        } /* IIerrtest */
      } /* IInexec */
...
/* # line 3686 "opqoptdb.sc" */	/* host code */
	}
    }
    /*
...
/* # line 3707 "opqoptdb.sc" */	/* host code */
	    opq_setstats(g, relp);
	}
    }
    else if (fromfile)
...
/* # line 4039 "opqoptdb.sc" */	/* prepare */
  {
    IIsqInit(&sqlca);
    IIsqPrepare(0,(char *)"s",(char *)0,0,stmt);
    if (sqlca.sqlcode < 0) 
      opq_sqlerror();
    else if (sqlca.sqlwarn.sqlwarn0 == 'W') 
      opq_sqlerror();
  }
/* # line 4040 "opqoptdb.sc" */	/* describe */
  {
    IIsqInit(&sqlca);
    IIsqDescribe(0,(char *)"s",sqlda,0);
    if (sqlca.sqlcode < 0) 
      opq_sqlerror();
    else if (sqlca.sqlwarn.sqlwarn0 == 'W') 
      opq_sqlerror();
  }
/* # line 4042 "opqoptdb.sc" */	/* host code */
	    ...
	    */
/* # line 4164 "opqoptdb.sc" */	/* open */
  {
    IIsqInit(&sqlca);
    IIcsOpen((char *)"c1",7596,9598);
    IIwritio(0,(short *)0,1,32,0,(char *)"s");
    IIwritio(0,(short *)0,1,32,0,(char *)" for readonly ");
    IIcsQuery((char *)"c1",7596,9598);
  }
/* # line 4165 "opqoptdb.sc" */	/* host code */
...
/* # line 4194 "opqoptdb.sc" */	/* host code */
	    while (sqlca.sqlcode == GE_OK)
	    {
/* # line 4196 "opqoptdb.sc" */	/* fetch */
  {
    IIsqInit(&sqlca);
    if (IIcsRetScroll((char *)"c1",7596,9598,-1,-1) != 0) {
      IIcsDaGet(0,sqlda);
      IIcsERetrieve();
    } /* IIcsRetrieve */
    if (sqlca.sqlcode < 0) 
...
/* # line 4197 "opqoptdb.sc" */	/* host code */
	    }
/* # line 4199 "opqoptdb.sc" */	/* close */
  {
    IIsqInit(&sqlca);
    IIcsClose((char *)"c1",7596,9598);
    if (sqlca.sqlcode < 0) 
      opq_sqlerror();
    else if (sqlca.sqlwarn.sqlwarn0 == 'W') 
      opq_sqlerror();
  }
/* # line 4200 "opqoptdb.sc" */	/* host code */
	}
...
/* bug 68015: should be attp->...., not attrp->...) */
		    if (attp->hist_dt.db_datatype == DB_CHA_TYPE)
		    {
			/* adc_hg_dtln() makes histogram DB_CHA_TYPE for all
			** character types.*/
...
ADF_CB		*adfcb)
{
	...
	*/
	...
	for (old_cell = 1, cell = 1; cell <= old_max_cell; cell++)
	{
	    ...
	    {
	        MEcopy((PTR)oldloc, maxlength, (PTR)(newloc));
	        lastloc = oldloc;
...
char		**selexpr)
{
    ...
    ** composite "column". */
    compdt.db_datatype = DB_CHA_TYPE;
    compdt.db_length = 0;
    compdt.db_prec = 0;
    ...
    ** expression and accumulating composite column length as we go. */
	...
	switch (abs(attrp->attr_dt.db_datatype)) {
	  ...
	  case DB_TXT_TYPE:
	  case DB_NVCHR_TYPE:
	    STprintf(coltxt1, "char(hex(char(%s)))", (char *)&attrp->delimname);
			/* varying strings need "char" coercion */
	    datlen = attrp->attr_dt.db_length - 2;
			/* remove length */
	    break;
	  default:
	    STprintf(coltxt1, "char(hex(%s))", (char *)&attrp->delimname);
	...
	**   "char(ifnull('00'+char(hex(col)), '010000...00'))". That is, 
	...
	** are all zeroes, of the appropriate length. */
	if (attrp->attr_dt.db_datatype < 0)
	{
	    ...
	    coltxt1 = wrktxt2;
	    coltxt2 = wrktxt1;
	    sprintf(coltxt1, "char(ifnull('00'+%s, %s))", 
				coltxt2, nullstr);
	}
...
# endif	/* x3B5 */
    ...
    ** expression which concatenates all the columns. */
    ...
    {
	if (!comp_selbuild(g, relp, attrpp, &selexpr)) return(FALSE);
  ...
  char *stmt;
	...
	if (relp->index || g->opq_comppkey)
	    ...
	    (i4)(sizeof("select distinct %s, %s from %s order by 1") +
	    3 * DB_GW1_MAXNAME+6), &opq_sbuf);
	{
	    char    *name;
	    if (sample)
	    {
		name = &relp->samplename.nametype.maxname[0];
		STprintf(stmt, "select %s from %s%s order by 1",
		    selexpr, sestbl, name);
		sqlda->sqln = 1;
	    }
	    else
	    {
		name = &relp->delimname.nametype.maxname[0];
		STprintf(stmt, "select %s from %s order by 1",
		    selexpr, name);
		sqlda->sqln = 1;
	    }
	}
...
/* # line 6896 "opqoptdb.sc" */	/* describe */
  {
    IIsqInit(&sqlca);
    IIsqDescribe(0,(char *)"s",sqlda,0);
    if (sqlca.sqlcode < 0) 
...
/* # line 6898 "opqoptdb.sc" */	/* host code */
...
/* # line 6919 "opqoptdb.sc" */	/* host code */
	toomany	= FALSE;
	cellexact = -1;
	cellinexact = 0;
	cellinexact1 = 0;
...
/* # line 6936 "opqoptdb.sc" */	/* host code */
	    if (sqlca.sqlcode != GE_OK)
		break;
	    else
	    {
...
/* # line 7110 "opqoptdb.sc" */	/* host code */
    }
# ifdef xDEBUG
    {
	long	timeval;
...
# endif /* (xDEBUG) */
    ...
    */
    ...
    if (attrp->hist_dt.db_datatype == DB_CHA_TYPE ||
	attrp->hist_dt.db_datatype == DB_NCHR_TYPE ||
	attrp->hist_dt.db_datatype == DB_NVCHR_TYPE)
    {
	...
	** optimizedb overhead in processing the individual rows. */
	{
	    ...
	    {
		name = &relp->delimname.nametype.maxname[0];
		STprintf(stmt, "select %s, count(*) from %s group by 1 order by 1",
		    selexpr, name);
		sqlda->sqln = 2;
	    }
	}
...
/* # line 7598 "opqoptdb.sc" */	/* describe */
  {
    IIsqInit(&sqlca);
    IIsqDescribe(0,(char *)"s",sqlda,0);
    if (sqlca.sqlcode < 0) 
...
/* # line 7600 "opqoptdb.sc" */	/* host code */
	/* allocate buffer, describe location for the column. */
	{
	    sqlda->sqlvar[0].sqltype = DB_DBV_TYPE;
	    sqlda->sqlvar[0].sqllen  = sizeof(DB_DATA_VALUE);
...
/* # line 7624 "opqoptdb.sc" */	/* host code */
	toomany	= FALSE;
	cellexact = -1;
	cellinexact = 0;
	cellinexact1 = 0;
...
/* # line 7638 "opqoptdb.sc" */	/* host code */
	    if (sqlca.sqlcode != GE_OK)
		break;
	    else
	    {
...
/* # line 7787 "opqoptdb.sc" */	/* host code */
    }
# ifdef xDEBUG
    {
	long	timeval;
...
char	    **argv)
{
	...
	** composite histogram, it points to first column. */
	...
	if ((*relp)->comphist)
	{
	    (*attrp)->hist_dt.db_datatype = DB_CHA_TYPE;
	    (*attrp)->attr_dt.db_datatype = DB_CHA_TYPE;
		...
		*/
		...
		if (DB_FAILURE_MACRO(s))
		    opq_adferror(g->opq_adfcb, (i4)E_OP0981_ADI_FICOERCE, 
				(i4)0, (PTR)cname, (i4)0, (PTR)tname);
		fblk.adf_fi_id = fid;
		STRUCT_ASSIGN_MACRO((*attrp)->hist_dt,
		    fblk.adf_r_dv);
	...
	*/	
	{
	    ...
	    */
	    eps *= cells;	
	    if (tcount > (1.0 + eps) || tcount < (1.0 - eps))
	    {
...
/* # line 9129 "opqoptdb.sc" */	/* host code */
...
/* # line 9250 "opqoptdb.sc" */	/* execute */
  {
    IIsqInit(&sqlca);
    IIsqExImmed(stmt);
    IIsyncup((char *)0,0);
  }
/* # line 9252 "opqoptdb.sc" */	/* host code */
	if (sqlca.sqlcode >= GE_OK)
	{
	    created = (bool)TRUE;
	    relp->samplecrtd = (bool)TRUE;
	    relp->nsample = sqlca.sqlerrd[2];
/* # line 9257 "opqoptdb.sc" */	/* commit */
  {
    IIsqInit(&sqlca);
    IIxact(3);
  }
/* # line 9258 "opqoptdb.sc" */	/* host code */
	    break;
	}
    }
...
/* # line 9268 "opqoptdb.sc" */	/* inquire_ingres */
  {
    IILQisInqSqlio((short *)0,1,32,ER_MAX_LEN + 1-1,error_msg,63);
  }
/* # line 9270 "opqoptdb.sc" */	/* host code */
...
# endif  /* (xDEBUG) */
/* # line 9293 "opqoptdb.sc" */	/* host code */
}
/*{
...
/* # line 9372 "opqoptdb.sc" */	/* host code */
    }
    if (g->opq_dbms.dbms_type & OPQ_STAR)
    {
  char *es_objname;
  ...
  char es_locname[DB_GW1_MAXNAME + 1];
	...
	*/
/* # line 9396 "opqoptdb.sc" */	/* repeated select */
  {
    IIsexec();
    while (IInexec() == 0) {
      IIsqInit(&sqlca);
      IIexExec(1,(char *)"opqoptdb25",7621,3294);
      IIputdomio((short *)0,1,32,0,es_objname);
      IIputdomio((short *)0,1,32,0,es_objowner);
      IIretinit((char *)0,0);
      if (IInexec() == 0) {
        IIsqInit(&sqlca);
        IIexDefine(1,(char *)"opqoptdb25",7621,3294);
        IIwritio(0,(short *)0,1,32,0,(char *)
"select i.ldb_node, i.ldb_dbms, i.ldb_database, t.table_name from iidd\
b_ldbids i, iiddb_objects o, iiddb_ldb_dbcaps c, iiddb_tableinfo t whe\
re o.object_name=");
        IIwritio(0,(short *)0,1,32,0,(char *)" $0=");
        IIputdomio((short *)0,1,32,0,es_objname);
        ...
        IIputdomio((short *)0,1,32,0,es_objowner);
        IIwritio(0,(short *)0,1,32,0,(char *)
"and o.object_base=t.object_base and o.object_index=t.object_index and\
 o.object_type in('L', 'T')and t.ldb_id=c.ldb_id and t.ldb_id=i.ldb_id\
 and t.local_type='T' and c.ldb_id=i.ldb_id and c.cap_capability='INGR\
ES' and c.cap_value='Y'");
        IIexDefine(0,(char *)"opqoptdb25",7621,3294);
        if (IIerrtest() == 0) {
          IIsexec();
        } /* IIerrtest */
      } /* IInexec */
...
IIrtB13:
    while (IInextget() != 0) {
      IIgetdomio((short *)0,1,32,DB_GW1_MAXNAME + 1-1,es_node);
      IIgetdomio((short *)0,1,32,DB_GW1_MAXNAME + 1-1,es_dbms);
      IIgetdomio((short *)0,1,32,DB_GW1_MAXNAME + 1-1,es_database);
      IIgetdomio((short *)0,1,32,DB_GW1_MAXNAME + 1-1,es_locname);
      if (IIerrtest() != 0) goto IIrtB13;
/* # line 9415 "opqoptdb.sc" */	/* host code */
	    {
		cnt++;
	    }
    } /* IInextget */
...
/* # line 9448 "opqoptdb.sc" */	/* host code */
...
/* # line 9452 "opqoptdb.sc" */	/* direct execute immediate */
  {
    IIsqInit(&sqlca);
    IIwritio(0,(short *)0,1,32,0,(char *)"direct execute immediate ");
    IIvarstrio((short *)0,1,32,0,stmt);
    IIwritio(0,(short *)0,1,32,0,(char *)"with node=");
    IIvarstrio((short *)0,1,32,0,es_node);
    IIwritio(0,(short *)0,1,32,0,(char *)", dbms=");
    IIvarstrio((short *)0,1,32,0,es_dbms);
    IIwritio(0,(short *)0,1,32,0,(char *)", database=");
    IIvarstrio((short *)0,1,32,0,es_database);
    IIsyncup((char *)0,0);
    if (sqlca.sqlcode < 0) 
      opq_sqlerror();
    else if (sqlca.sqlwarn.sqlwarn0 == 'W') 
...
/* # line 9458 "opqoptdb.sc" */	/* host code */
	}
    }
    return (TRUE);
}
...
#define OPQ_DDTDROP "drop %s"
    ...
    ** 25% exact cells with minimum 25 and maximum 1000. */
    ...
    if (sample && opq_global.opq_newrepfest)
    {
  ...
  char *dbname;
	...
	*/
/* # line 9763 "opqoptdb.sc" */	/* set_sql */
  {
    IILQssSetSqlio(15,(short *)0,1,30,sizeof(1),(void *)IILQint(1));
  }
/* # line 9765 "opqoptdb.sc" */	/* host code */
	if (!user)
	{
/* # line 9767 "opqoptdb.sc" */	/* connect */
  {
    IIsqInit(&sqlca);
...
/* # line 9768 "opqoptdb.sc" */	/* host code */
	}
	else
	{
/* # line 9771 "opqoptdb.sc" */	/* connect */
  {
    IIsqInit(&sqlca);
    IIsqUser(user);
    IIsqConnect(0,dbname,waitopt,(char *)0, (char *)0, (char *)0, (char *)0, 
...
/* # line 9782 "opqoptdb.sc" */	/* host code */
...
/* # line 9832 "opqoptdb.sc" */	/* host code */
	    }
	    else
	    {
/* # line 9835 "opqoptdb.sc" */	/* connect */
  {
    IIsqInit(&sqlca);
    IIsqUser(user);
    IIsqConnect(0,dbname,appl_flag,(char *)"+Y",ifs[0],ifs[1],ifs[2],ifs[3],
...
/* # line 9840 "opqoptdb.sc" */	/* host code */
	    }
	}
	else
	{
...
/* # line 9851 "opqoptdb.sc" */	/* host code */
	    }
	    else
	    {
/* # line 9854 "opqoptdb.sc" */	/* connect */
  {
    IIsqInit(&sqlca);
    IIsqUser(user);
    IIsqConnect(0,dbname,ifs[0],ifs[1],ifs[2],ifs[3],ifs[4],ifs[5],ifs[6],
...
/* # line 9858 "opqoptdb.sc" */	/* host code */
	    }
	}
	opq_global.opq_env.dbopen = TRUE;
	/*
			...
			relp++, was_nothing_done++)
		{
			...
			*/
			    ...
			    tbl_reltidx=(*relp)->reltidx;                        
                            ...
                            {
/* # line 10184 "opqoptdb.sc" */	/* repeated select */
  {
    IIsexec();
    while (IInexec() == 0) {
      IIsqInit(&sqlca);
      IIexExec(1,(char *)"opqoptdb26",7622,19806);
      IIputdomio((short *)0,1,30,4,&tbl_reltid);
      IIputdomio((short *)0,1,30,4,&tbl_reltidx);
      IIretinit((char *)0,0);
      if (IInexec() == 0) {
        IIsqInit(&sqlca);
        IIsqMods(1);
        IIexDefine(1,(char *)"opqoptdb26",7622,19806);
        IIwritio(0,(short *)0,1,32,0,(char *)
"select relextend from iirelation i where reltid=");
        IIwritio(0,(short *)0,1,32,0,(char *)" $0=");
        IIputdomio((short *)0,1,30,4,&tbl_reltid);
        IIwritio(0,(short *)0,1,32,0,(char *)"and reltidx=");
        IIwritio(0,(short *)0,1,32,0,(char *)" $1=");
        IIputdomio((short *)0,1,30,4,&tbl_reltidx);
        IIexDefine(0,(char *)"opqoptdb26",7622,19806);
        if (IIerrtest() == 0) {
          IIsexec();
        } /* IIerrtest */
      } /* IInexec */
    ...
    if (IInextget() != 0) {
      IIgetdomio((short *)0,1,30,4,&relextend);
    } /* IInextget */
    IIsqFlush((char *)0,0);
    if (sqlca.sqlcode < 0) 
      opq_sqlerror();
...
/* # line 10188 "opqoptdb.sc" */	/* host code */
                            }
...
/* # line 10208 "opqoptdb.sc" */	/* host code */
			}
			else
			{
...
/* # line 10263 "opqoptdb.sc" */	/* host code */
				    if ((*relp)->index || 
...
/* # line 10299 "opqoptdb.sc" */	/* host code */
				/*
...
/* # line 10349 "opqoptdb.sc" */	/* execute */
  {
    IIsqInit(&sqlca);
    IIsqExImmed(stmt);
    IIsyncup((char *)0,0);
...
/* # line 10350 "opqoptdb.sc" */	/* host code */
                    }
		}
...
/* # line 10369 "opqoptdb.sc" */	/* host code */
		} /* for each table */
	    }
	}
	while (argv[parmno] && argv[parmno][0] == '-')
	    parmno++;				/* skip to next db */
/* # line 10376 "opqoptdb.sc" */	/* disconnect */
  {
    IIsqInit(&sqlca);
    IIsqDisconnect();
    if (sqlca.sqlcode < 0) 
...
/* # line 10378 "opqoptdb.sc" */	/* host code */
	opq_global.opq_env.dbopen = FALSE;
    }
    (VOID) EXdelete();
    PCexit((i4)OK);
...
opt_opq_exit(VOID)
{
    ...
    */
    ...
    {
/* # line 10436 "opqoptdb.sc" */	/* host code */
    }
    if (opq_global.opq_env.dbopen)
    {
	/* Rollback will close all open cursors. */
/* # line 10441 "opqoptdb.sc" */	/* rollback */
  {
    IIsqInit(&sqlca);
    IIxact(2);
  }
/* # line 10443 "opqoptdb.sc" */	/* disconnect */
  {
    IIsqInit(&sqlca);
    IIsqDisconnect();
  }
/* # line 10444 "opqoptdb.sc" */	/* host code */
	opq_global.opq_env.dbopen = FALSE;
    }
...
i4            overflow;
{
  ...
  i4 es1_overflow;
		...
		*/
/* # line 10631 "opqoptdb.sc" */	/* commit */
  {
    IIsqInit(&sqlca);
    IIxact(3);
  }
/* # line 10632 "opqoptdb.sc" */	/* host code */
        }
        ...
        es1_rows = (i4)rows;
/* # line 10640 "opqoptdb.sc" */	/* repeated update */
  {
    IIsexec();
    while (IInexec() == 0) {
      IIsqInit(&sqlca);
      IIexExec(1,(char *)"opqoptdb27",7623,28636);
      IIputdomio((short *)0,1,30,4,&es1_pages);
      IIputdomio((short *)0,1,30,4,&es1_overflow);
      IIputdomio((short *)0,1,30,4,&es1_rows);
      IIputdomio((short *)0,1,32,0,es1_tname);
      IIputdomio((short *)0,1,32,0,es1_owner);
      IIsyncup((char *)0,0);
      if (IInexec() == 0) {
        IIsqInit(&sqlca);
        IIexDefine(1,(char *)"opqoptdb27",7623,28636);
        IIwritio(0,(short *)0,1,32,0,(char *)
"update iitables set number_pages=");
        IIwritio(0,(short *)0,1,32,0,(char *)" $0=");
        IIputdomio((short *)0,1,30,4,&es1_pages);
        IIwritio(0,(short *)0,1,32,0,(char *)", overflow_pages=");
        IIwritio(0,(short *)0,1,32,0,(char *)" $1=");
        IIputdomio((short *)0,1,30,4,&es1_overflow);
        IIwritio(0,(short *)0,1,32,0,(char *)", num_rows=");
        IIwritio(0,(short *)0,1,32,0,(char *)" $2=");
        IIputdomio((short *)0,1,30,4,&es1_rows);
        IIwritio(0,(short *)0,1,32,0,(char *)"where table_name=");
        IIwritio(0,(short *)0,1,32,0,(char *)" $3=");
        ...
        IIwritio(0,(short *)0,1,32,0,(char *)" $4=");
        IIputdomio((short *)0,1,32,0,es1_owner);
        IIexDefine(0,(char *)"opqoptdb27",7623,28636);
        if (IIerrtest() == 0) {
          IIsexec();
        } /* IIerrtest */
      } /* IInexec */
...
/* # line 10647 "opqoptdb.sc" */	/* host code */
	/* Update related index information. */
/* # line 10648 "opqoptdb.sc" */	/* repeated update */
  {
    IIsexec();
    while (IInexec() == 0) {
      IIsqInit(&sqlca);
      IIexExec(1,(char *)"opqoptdb28",7624,25936);
      IIputdomio((short *)0,1,30,4,&es1_rows);
      IIputdomio((short *)0,1,32,0,es1_owner);
      IIputdomio((short *)0,1,32,0,es1_tname);
      IIputdomio((short *)0,1,32,0,es1_owner);
      ...
      if (IInexec() == 0) {
        IIsqInit(&sqlca);
        IIexDefine(1,(char *)"opqoptdb28",7624,25936);
        IIwritio(0,(short *)0,1,32,0,(char *)
"update iitables set num_rows=");
        IIwritio(0,(short *)0,1,32,0,(char *)" $0=");
        IIputdomio((short *)0,1,30,4,&es1_rows);
        ...
        IIputdomio((short *)0,1,32,0,es1_owner);
        IIwritio(0,(short *)0,1,32,0,(char *)
"and table_name in(select index_name from iiindexes where base_name=");
        IIwritio(0,(short *)0,1,32,0,(char *)" $2=");
        IIputdomio((short *)0,1,32,0,es1_tname);
        ...
        IIputdomio((short *)0,1,32,0,es1_owner);
        IIwritio(0,(short *)0,1,32,0,(char *)")");
        IIexDefine(0,(char *)"opqoptdb28",7624,25936);
        if (IIerrtest() == 0) {
          IIsexec();
        } /* IIerrtest */
      } /* IInexec */
...
/* # line 10655 "opqoptdb.sc" */	/* host code */
# ifdef FUTURE_USE
/* # line 10656 "opqoptdb.sc" */	/* repeated update */
  {
    IIsexec();
    while (IInexec() == 0) {
      IIsqInit(&sqlca);
      IIexExec(1,(char *)"opqoptdb29",7625,31582);
      IIputdomio((short *)0,1,30,4,&es1_pages);
      IIputdomio((short *)0,1,30,4,&es1_overflow);
      IIputdomio((short *)0,1,30,4,&es1_rows);
      IIputdomio((short *)0,1,32,0,es1_tname);
      ...
      if (IInexec() == 0) {
        IIsqInit(&sqlca);
        IIexDefine(1,(char *)"opqoptdb29",7625,31582);
        IIwritio(0,(short *)0,1,32,0,(char *)
"update iiphysical_tables set number_pages=");
        IIwritio(0,(short *)0,1,32,0,(char *)" $0=");
        IIputdomio((short *)0,1,30,4,&es1_pages);
        IIwritio(0,(short *)0,1,32,0,(char *)", overflow_pages=");
        IIwritio(0,(short *)0,1,32,0,(char *)" $1=");
        ...
        IIwritio(0,(short *)0,1,32,0,(char *)" $4=");
        IIputdomio((short *)0,1,32,0,es1_owner);
        IIexDefine(0,(char *)"opqoptdb29",7625,31582);
        if (IIerrtest() == 0) {
          IIsexec();
        } /* IIerrtest */
      } /* IInexec */
...
/* # line 10662 "opqoptdb.sc" */	/* host code */
# endif /* FUTURE_USE */
        if (opq_global.opq_dbms.dbms_type & OPQ_STAR)
        {
		...
		** at this time.
		*/
/* # line 10673 "opqoptdb.sc" */	/* commit */
  {
    IIsqInit(&sqlca);
    IIxact(3);
  }
/* # line 10674 "opqoptdb.sc" */	/* host code */
        }
    }
    else
    {
  ...
  i4 pages_per_partition;
	...
	es2_rows = (i4)rows;
        ...
        {       
/* # line 10698 "opqoptdb.sc" */	/* select */
  {
    IIsqInit(&sqlca);
    IIsqMods(1);
    IIwritio(0,(short *)0,1,32,0,(char *)
"select relprim, relspec, relnparts from iirelation i where reltid=");
    IIputdomio((short *)0,1,30,4,&es2_reltid);
    IIwritio(0,(short *)0,1,32,0,(char *)"and reltidx=");
    IIputdomio((short *)0,1,30,4,&es2_xreltid);
    IIretinit((char *)0,0);
    if (IInextget() != 0) {
      IIgetdomio((short *)0,1,30,4,&es2_pgprim);
      IIgetdomio((short *)0,1,30,2,&es2_relspec);
      IIgetdomio((short *)0,1,30,4,&num_partitions);
    } /* IInextget */
    IIsqFlush((char *)0,0);
  }
/* # line 10703 "opqoptdb.sc" */	/* host code */
/*
                if (es2_relspec == 5 || es2_relspec == 7) 
                    es2_pgprim = es2_origpgprim; 
*/
/* # line 10707 "opqoptdb.sc" */	/* repeated update */
  {
    IIsexec();
    while (IInexec() == 0) {
      IIsqInit(&sqlca);
      IIexExec(1,(char *)"opqoptdb30",7626,219);
      IIputdomio((short *)0,1,30,4,&es2_rows);
      IIputdomio((short *)0,1,30,4,&es2_pgtotal);
      IIputdomio((short *)0,1,30,4,&es2_reltid);
      IIputdomio((short *)0,1,30,4,&es2_xreltid);
      IIsyncup((char *)0,0);
      if (IInexec() == 0) {
        IIsqInit(&sqlca);
        IIexDefine(1,(char *)"opqoptdb30",7626,219);
        IIwritio(0,(short *)0,1,32,0,(char *)
"update iirelation set reltups=");
        IIwritio(0,(short *)0,1,32,0,(char *)" $0=");
        IIputdomio((short *)0,1,30,4,&es2_rows);
        IIwritio(0,(short *)0,1,32,0,(char *)", relpages=");
        IIwritio(0,(short *)0,1,32,0,(char *)" $1=");
        IIputdomio((short *)0,1,30,4,&es2_pgtotal);
        ...
        IIwritio(0,(short *)0,1,32,0,(char *)" $3=");
        IIputdomio((short *)0,1,30,4,&es2_xreltid);
        IIexDefine(0,(char *)"opqoptdb30",7626,219);
        if (IIerrtest() == 0) {
          IIsexec();
        } /* IIerrtest */
      } /* IInexec */
...
/* # line 10713 "opqoptdb.sc" */	/* host code */
...
/* # line 10720 "opqoptdb.sc" */	/* update */
  {
    IIsqInit(&sqlca);
    IIwritio(0,(short *)0,1,32,0,(char *)"update iirelation set reltup\
s=");
    IIputdomio((short *)0,1,30,4,&rows_per_partition);
    IIwritio(0,(short *)0,1,32,0,(char *)", relpages=");
    IIputdomio((short *)0,1,30,4,&pages_per_partition);
    IIwritio(0,(short *)0,1,32,0,(char *)"where reltid=");
    IIputdomio((short *)0,1,30,4,&es2_reltid);
    IIwritio(0,(short *)0,1,32,0,(char *)"and reltidx<0 and relnparts!\
=0");
    IIsyncup((char *)0,0);
  }
/* # line 10727 "opqoptdb.sc" */	/* host code */
...
/* # line 10738 "opqoptdb.sc" */	/* host code */
	    }
	    /* Update related index information. */
/* # line 10741 "opqoptdb.sc" */	/* repeated update */
  {
    IIsexec();
    while (IInexec() == 0) {
      IIsqInit(&sqlca);
      IIexExec(1,(char *)"opqoptdb31",7627,473);
      IIputdomio((short *)0,1,30,4,&es2_rows);
      IIputdomio((short *)0,1,30,4,&es2_reltid);
      IIputdomio((short *)0,1,30,4,&es2_reltid);
      IIsyncup((char *)0,0);
      if (IInexec() == 0) {
        IIsqInit(&sqlca);
        IIexDefine(1,(char *)"opqoptdb31",7627,473);
        IIwritio(0,(short *)0,1,32,0,(char *)
"update iirelation set reltups=");
        IIwritio(0,(short *)0,1,32,0,(char *)" $0=");
        IIputdomio((short *)0,1,30,4,&es2_rows);
        ...
        IIputdomio((short *)0,1,30,4,&es2_reltid);
        IIwritio(0,(short *)0,1,32,0,(char *)
"and reltidx in(select indexid from iiindex where baseid=");
        IIwritio(0,(short *)0,1,32,0,(char *)" $2=");
        IIputdomio((short *)0,1,30,4,&es2_reltid);
        IIwritio(0,(short *)0,1,32,0,(char *)")");
        IIexDefine(0,(char *)"opqoptdb31",7627,473);
        if (IIerrtest() == 0) {
          IIsexec();
        } /* IIerrtest */
      } /* IInexec */
...
/* # line 10747 "opqoptdb.sc" */	/* host code */
        }
        else
        {
	    es2_reltid  = (relp)->reltid;
...
/* # line 10769 "opqoptdb.sc" */	/* repeated update */
  {
    IIsexec();
    while (IInexec() == 0) {
      IIsqInit(&sqlca);
      IIexExec(1,(char *)"opqoptdb32",7628,457);
      IIputdomio((short *)0,1,30,4,&es2_rows);
      IIputdomio((short *)0,1,30,4,&es2_pgtotal);
      IIputdomio((short *)0,1,30,4,&es2_pgprim);
      IIputdomio((short *)0,1,30,4,&es2_reltid);
      IIputdomio((short *)0,1,30,4,&es2_xreltid);
      IIsyncup((char *)0,0);
      if (IInexec() == 0) {
        IIsqInit(&sqlca);
        IIexDefine(1,(char *)"opqoptdb32",7628,457);
        IIwritio(0,(short *)0,1,32,0,(char *)
"update iirelation set reltups=");
        IIwritio(0,(short *)0,1,32,0,(char *)" $0=");
        IIputdomio((short *)0,1,30,4,&es2_rows);
        ...
        IIwritio(0,(short *)0,1,32,0,(char *)" $1=");
        IIputdomio((short *)0,1,30,4,&es2_pgtotal);
        IIwritio(0,(short *)0,1,32,0,(char *)", relprim=");
        IIwritio(0,(short *)0,1,32,0,(char *)" $2=");
        IIputdomio((short *)0,1,30,4,&es2_pgprim);
        IIwritio(0,(short *)0,1,32,0,(char *)"where reltid=");
        IIwritio(0,(short *)0,1,32,0,(char *)" $3=");
        ...
        IIwritio(0,(short *)0,1,32,0,(char *)" $4=");
        IIputdomio((short *)0,1,30,4,&es2_xreltid);
        IIexDefine(0,(char *)"opqoptdb32",7628,457);
        if (IIerrtest() == 0) {
          IIsexec();
        } /* IIerrtest */
      } /* IInexec */
...
/* # line 10776 "opqoptdb.sc" */	/* host code */
	    /*
	    ** Update related index information.
	    ** 21-apr-94 (jimg)
...
/* # line 10785 "opqoptdb.sc" */	/* repeated update */
  {
    IIsexec();
    while (IInexec() == 0) {
      IIsqInit(&sqlca);
      IIexExec(1,(char *)"opqoptdb33",7629,2006);
      IIputdomio((short *)0,1,30,4,&es2_rows);
      IIputdomio((short *)0,1,30,4,&idx_pgtotal);
      IIputdomio((short *)0,1,30,4,&es2_reltid);
      IIputdomio((short *)0,1,30,4,&es2_reltid);
      IIsyncup((char *)0,0);
      if (IInexec() == 0) {
        IIsqInit(&sqlca);
        IIexDefine(1,(char *)"opqoptdb33",7629,2006);
        IIwritio(0,(short *)0,1,32,0,(char *)
"update iirelation set reltups=");
        IIwritio(0,(short *)0,1,32,0,(char *)" $0=");
        IIputdomio((short *)0,1,30,4,&es2_rows);
...
"and reltidx in(select indexid from iiindex where baseid=");
        ...
        IIputdomio((short *)0,1,30,4,&es2_reltid);
        IIwritio(0,(short *)0,1,32,0,(char *)")");
        IIexDefine(0,(char *)"opqoptdb33",7629,2006);
        if (IIerrtest() == 0) {
          IIsexec();
        } /* IIerrtest */
      } /* IInexec */
...
/* # line 10792 "opqoptdb.sc" */	/* host code */
            }
        }
    }
    return((DB_STATUS)E_DB_OK);
