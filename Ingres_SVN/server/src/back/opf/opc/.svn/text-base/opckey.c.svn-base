		...
		OPC_KOR	    *dnf_or)
{
    ...
    **		    this key qual contains an inequality
    **		)
    */
    ...
    */
	...
	if (cnf_and->opc_curcomp >= 0)
	{
	    ...
	    if (cnf_comp->opc_lo_const->opc_tconst_type == PST_USER)
	    {
...
**	of 30,000 or greater are too hard for opc_range. As opc_range
