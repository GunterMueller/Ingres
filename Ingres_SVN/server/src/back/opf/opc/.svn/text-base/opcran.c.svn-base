...
/* temp work around for a possible QEF bug
**    if (opvgrv->opv_gsubselect->opv_ahd == NULL) 
*/
    {
...
**    else
**    {
**	ran->qp_act = opvgrv->opv_gsubselect->opv_ahd;
**    }
*/
    ...
    */
    MEfill(sizeof (avail_eqcmp), (u_char)0, (PTR)&avail_eqcmp);
    for (jattno = 0; jattno < subqry->ops_attrs.opz_av; jattno += 1)
    {
	jatt = subqry->ops_attrs.opz_base->opz_attnums[jattno];
	    ...
	    )
	{
	    ...
	    */
	    ...
	    /* fill in the map of available eqcs */
	    BTset((i4)eqcno, (char *)&avail_eqcmp);
    ...
    */
    opc_gtqual(global, cnode, qn->qen_type, &avail_eqcmp, (OPE_BMEQCLS *) NULL,
