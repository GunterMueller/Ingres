	...
	ULM_SMARK	    *markp )
{
    ...
    ** to evaluate this function attribute */
	...
	status = opcu_tree_to_text(&temp_handle,
	...
	OPCQHD		    *qthdr )
{
	...
	** the parent */
	...
	status = opcu_tree_to_text(&handle, 
	    mode, /* query mode */
...
*/
	...
	*/
		...
		;)
		{
			...
			OPD_ISITE site;
				/*
				** Either this bool factor is an expression-LIKE and 
				**  OPQ_2ELIKE is on, which means
				...
				**  expression result.
				** OR this is not an expression-LIKE bool factor.
				*/
				/*
