...
struct _OPC_KCONST
{
	...
	** constants. Opc_nqconsts is the number of elements on the linked
	** list
	*/
	...
	** parameters. Opc_nqparms is the number of elements in the
	** opc_qparms array that are actually filled in (ie. non-null).
	*/
	...
	** is determined by opc_szkparam. The zeroth element of this array
	** is used to hold the OPC_QCONSTs for expressions, which OPC treats
	** parameters. Opc_ndbpvars is the number of elements in opc_dbpvars
	** that are non-null.
	*/
...
struct _OPC_QAND
{
	...
	*/
	...
	/* Opc_nnochange and opc_max_dnf_keyno hold information that is used
	...
	*/
    ...
    i4		opc_louseless_keyno;
    i4		opc_hiuseless_keyno;
