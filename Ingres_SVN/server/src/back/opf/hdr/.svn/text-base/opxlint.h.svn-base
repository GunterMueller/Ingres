...
/* # ifndef OPN_SFDIRCOST */
FUNC_EXTERN OPO_BLOCKS opn_sfdircost(
		OPS_SUBQUERY       *subquery,
		OPO_CO             *cop,
		OPO_TUPLES         *keyperpage);
/* #endif */
