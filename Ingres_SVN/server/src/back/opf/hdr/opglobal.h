...
**          initial creation
*/
typedef i4  OPN_IOMTYPE;
#define                 OPN_IOBTREE     3
/* not implemented yet */
#define                 OPN_IOHASH      2
/* implies HASH, ISAM and SORT reformats are done */
#define                 OPN_IOISAM      1
/* implies ISAM, and SORT reformats are done */
#define                 OPN_IOSORT      0
/* implies SORT reformats are done */

/*}
...
**          initial creation
*/
typedef i4  OPS_DUPLICATES;
#define                 OPS_DUNDEFINED  1
/* do not care about duplicates in the result */
#define                 OPS_DREMOVE     2
/* remove duplicates - add a SORT node to the top of the query plan */
#define                 OPS_DKEEP       3
/* keep duplicates - add tids to query so duplicates are not discarded */

/*}
...
**          initial creation for outer join support
*/
typedef i4  OPL_OJTYPE;
#define                 OPL_UNKNOWN     0
/* used for nodes which do not have any outer join operations */
#define                 OPL_RIGHTJOIN   1
#define                 OPL_LEFTJOIN    2
#define                 OPL_FULLJOIN    3
#define                 OPL_INNERJOIN   4
#define                 OPL_FOLDEDJOIN  5
...
#define                 OPO_SJHASH	6
/* Hash join */
#define                 OPO_SJCARTPROD  7
/* cartesean product */
#define                 OPO_SJNOJOIN    8
/* not a join node, either ORIG or PR */

/*}
...
typedef struct _OPO_COMAPS
{
    OPE_BMEQCLS     opo_eqcmap;         /* map field indicating which
                                        ...
                                        */
    OPL_BMOJ	    opo_filter;		/* map of left joins which have had their
					** filter requirements satisfied,... filter
					** is used when the same left join is 
					** evaluated at 2 join nodes */
#ifdef OPM_FLATAGGON
