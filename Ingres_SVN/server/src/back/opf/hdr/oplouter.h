...
#define			OPL_OJSPLIT	0x00000040L
/* TRUE - if a top sort node may be needed to correct outer join duplicates */
...
/* TRUE - if during query tree traversal, a "case" expression is encountered */
    ...
    OPL_BMOJ	    opl_filterneeded; /* map of outer joins which need to be 
				    ** checked for filtering requirements */
}   OPL_OJOIN;

/*}
