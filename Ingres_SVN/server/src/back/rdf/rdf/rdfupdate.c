	    ...
	    QEUQ_CB	*qeuq_cb)
{
    ...
    ** from user defined length */
    ...
    {
	col_ptr = ((DMU_ATTR_ENTRY **)dmu_cb->dmu_attr_array.ptr_address)[i];
	    ...
	    RDF_CB	    *rdfcb)
{
    ...
    */
	...
	if (DB_FAILURE_MACRO(status))
	    rdu_ferror(global, status, qeuq_cb.error.err_code, 
