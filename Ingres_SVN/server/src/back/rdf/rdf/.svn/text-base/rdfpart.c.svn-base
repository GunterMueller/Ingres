...
rdp_build_partdef(RDF_GLOBAL *global)
{
    ...
    */
	...
	{
	    /* Report error, return */
	    rdu_ferror(global,status,temp_ulm_rcb.ulm_error.err_code,
...
rdp_inconsistent(RDF_GLOBAL *global, char *catalog, char *str)
{
    ...
    */
    global->rdfcb->rdf_error.err_code = E_RD0025_USER_ERROR;

    status = ule_format(E_RD014B_BAD_PARTCAT, NULL, ULE_LOG, &sqlstate,
...
rdp_sort_breaks(RDF_GLOBAL *global, DB_PART_DIM *dim_ptr, char errbuf[])
{
    ...
    READONLY i4 *incrPtr;		/* Increments table pointer */
