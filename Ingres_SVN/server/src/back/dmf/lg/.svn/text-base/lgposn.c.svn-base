...
CL_ERR_DESC	*sys_err)
{
    ...
    {
	ule_format(E_DMA408_LGPOSN_BAD_ID, (CL_ERR_DESC *)0,
    ...
    {
	ule_format(E_DMA409_LGPOSN_BAD_XACT, (CL_ERR_DESC *)0,
    ...
    {
	ule_format(E_DMA40A_LGPOSN_BAD_PARM, (CL_ERR_DESC *)0,
	...
	if (lga)
	{
	    ...
	    {
		ule_format(E_DMA40B_LGPOSN_BAD_LGA, (CL_ERR_DESC *)0,
			    ULE_LOG, NULL, 0, 0, 0, &err_code, 3,
			    0, position,
	...
	{
	    ule_format(E_DMA40C_LGPOSN_NULL_LGA, (CL_ERR_DESC *)0,
	...
	context->lgc_buffer == (LBH *)((char *)context->lgc_record+LG_MAX_RSZ)&&
