...
CL_ERR_DESC	    *sys_err)
{
    ...
    status = LG_close((LG_ID *) &lg_id, sys_err);
...
CL_ERR_DESC	    *sys_err)
{
    ...
    {
	ule_format(E_DMA40D_LGCLOSE_BAD_ID, (CL_ERR_DESC *)0,
    ...
    {
	ule_format(E_DMA40E_LGCLOSE_BAD_PROC, (CL_ERR_DESC *)0,
	...
	if (lfb->lfb_status & LFB_PRIMARY_LOG_OPENED)
	{
	    ...
	    {
		(VOID) ule_format(local_status, &local_sys_err, ULE_LOG, NULL,
				    0, 0, 0,
				    &err_code, 0);
