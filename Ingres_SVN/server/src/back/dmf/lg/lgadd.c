...
CL_ERR_DESC	    *sys_err)
{
    ...
    STATUS		status;
    LG_ID		*lg_id = (LG_ID*)&external_lg_id;
    ...
    */
    ...
    {
	ule_format(E_DMA411_LGADD_BAD_LEN, (CL_ERR_DESC *)0,
    ...
    {
	ule_format(E_DMA40F_LGADD_BAD_ID, (CL_ERR_DESC *)0,
		    ULE_LOG, NULL, 0, 0, 0, &err_code, 2,
	...
	ule_format(E_DMA410_LGADD_BAD_PROC, (CL_ERR_DESC *)0,
    ...
    */
    ...
    {
	TRdisplay("%@ LGadd: args were:%p(%d,%d).%x.%p.%x.%p\n",
		lg_id, lg_id->id_id, lg_id->id_instance,
