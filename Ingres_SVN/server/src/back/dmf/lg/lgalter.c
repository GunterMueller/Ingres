...
CL_ERR_DESC	    *sys_err)
{
	...
	*/
	...
	{
	    ule_format(E_DMA400_LG_BAD_BCNT_ALTER, (CL_ERR_DESC *)0,
			ULE_LOG, NULL, 0, 0, 0,
			&err_code, 4,
	...
	*/
	...
	{
	    ule_format(E_DMA46C_LGALTER_SBKS_INUSE, (CL_ERR_DESC *)0,
	...
	{
	    ule_format(E_DMA46D_LGALTER_SBKTAB_INUSE, (CL_ERR_DESC *)0,
	...
	*/
	...
	if (ext == 0)
	{
	    ule_format(E_DMA46E_LGALTER_SBKTAB_NOMEM, (CL_ERR_DESC *)0,
			ULE_LOG, NULL, 0, 0, 0, &err_code, 1,
	...
	{
	    ule_format(E_DMA46F_LGALTER_LBKS_INUSE, (CL_ERR_DESC *)0,
			ULE_LOG, NULL, 0, 0, 0, &err_code, 1,
			0, lgd->lgd_ldb_inuse);
	    return (LG_MEM_INUSE);
	}
	...
	{
	    ule_format(E_DMA470_LGALTER_LBKTAB_INUSE, (CL_ERR_DESC *)0,
			ULE_LOG, NULL, 0, 0, 0, &err_code, 1,
	...
	*/
	...
	if (ext == 0)
	{
	    ule_format(E_DMA471_LGALTER_LBKTAB_NOMEM, (CL_ERR_DESC *)0,
			ULE_LOG, NULL, 0, 0, 0, &err_code, 1,
			0, sizeof(i4) * value);
	    return (LG_EXCEED_LIMIT);
	}
	...
	*/
	...
	{
	    ule_format(E_DMA401_LG_BAD_HDRSIZE, (CL_ERR_DESC *)0,
			ULE_LOG, NULL, 0, 0, 0,
			&err_code, 2,
	...
	lg_id = *(LG_ID *)&hdr_struct->lg_hdr_lg_id;

	/*	Check the lg_id. */

	if (lg_id.id_id == 0 || (i4)lg_id.id_id > lgd->lgd_lpbb_count)
	{
	    ule_format(E_DMA474_LGALTER_BADPARAM, (CL_ERR_DESC *)0,
			ULE_LOG, NULL, 0, 0, 0, &err_code, 3,
	...
	{
	    ule_format(E_DMA475_LGALTER_BADPARAM, (CL_ERR_DESC *)0,
			ULE_LOG, NULL, 0, 0, 0, &err_code, 4,
			0, lpb->lpb_type, 0, lpb->lpb_id.id_instance,
			0, lg_id.id_instance, 0, "LG_A_HEADER");
	    return (LG_BADPARAM);
	}
    ...
    case LG_A_BOF:
	/* NOT USED ANYMORE */
	ule_format(E_DMA472_LGALTER_BADPARAM, (CL_ERR_DESC *)0,
	    ULE_LOG, NULL, 0, 0, 0, &err_code, 3,
	...
	*/
	    ...
	    lpb->lpb_id.id_instance != lg_id.id_instance)
	{
	    ule_format(E_DMA475_LGALTER_BADPARAM, (CL_ERR_DESC *)0,
			ULE_LOG, NULL, 0, 0, 0, &err_code, 4,
			0, lpb->lpb_type, 0, lpb->lpb_id.id_instance,
			0, lg_id.id_instance, 0, "LG_A_EOF");
	    return (LG_BADPARAM);
	}
	lfb = (LFB *)LGK_PTR_FROM_OFFSET(lpb->lpb_lfb_offset);
	...
	*/
	if (l_item == 0)
	{
	    ule_format(E_DMA473_LGALTER_BADPARAM, (CL_ERR_DESC *)0,
	    ...
	    lpb->lpb_id.id_instance != lg_id.id_instance)
	{
	    ule_format(E_DMA475_LGALTER_BADPARAM, (CL_ERR_DESC *)0,
			ULE_LOG, NULL, 0, 0, 0, &err_code, 4,
			0, lpb->lpb_type, 0, lpb->lpb_id.id_instance,
			0, lg_id.id_instance, 0, "LG_A_CPFDONE");
	    return (LG_BADPARAM);
	}
	...
	*/
	    ...
	    lpb->lpb_id.id_instance != lg_id.id_instance)
	{
	    ule_format(E_DMA475_LGALTER_BADPARAM, (CL_ERR_DESC *)0,
			ULE_LOG, NULL, 0, 0, 0, &err_code, 4,
			0, lpb->lpb_type, 0, lpb->lpb_id.id_instance,
			0, lg_id.id_instance, 0, "LG_A_CPWAITDONE");
	    return (LG_BADPARAM);
	}
	...
	*/
	    ...
	    lpb->lpb_id.id_instance != lg_id.id_instance)
	{
	    ule_format(E_DMA475_LGALTER_BADPARAM, (CL_ERR_DESC *)0,
			ULE_LOG, NULL, 0, 0, 0, &err_code, 4,
			0, lpb->lpb_type, 0, lpb->lpb_id.id_instance,
			0, lg_id.id_instance, 0, "LG_A_FORCE_ABORT");
	    return (LG_BADPARAM);
	}
    ...
    case LG_A_SBACKUP:
        ...
        if (l_item < sizeof(LG_ID))
	{
	    ule_format(E_DMA472_LGALTER_BADPARAM, (CL_ERR_DESC *)0,
			ULE_LOG, NULL, 0, 0, 0, &err_code, 3,
			0, l_item, 0, sizeof(LG_ID), 0, "LG_A_SBACKUP");
	    return (LG_BADPARAM);
	}
        ...
        /*  Check the db_id. */
        if (db_id.id_id == 0 || (i4)db_id.id_id > lgd->lgd_lpdb_count)
	{
	    ule_format(E_DMA474_LGALTER_BADPARAM, (CL_ERR_DESC *)0,
			ULE_LOG, NULL, 0, 0, 0, &err_code, 3,
			0, db_id.id_id, 0, lgd->lgd_lpdb_count,
			0, "LG_A_SBACKUP");
	    return (LG_BADPARAM);
	}

	lpdb_table = (SIZE_TYPE *)LGK_PTR_FROM_OFFSET(lgd->lgd_lpdb_table);
	lpd = (LPD *)LGK_PTR_FROM_OFFSET(lpdb_table[db_id.id_id]);

        if (lpd->lpd_type != LPD_TYPE ||
            lpd->lpd_id.id_instance != db_id.id_instance)
        {
	    ule_format(E_DMA475_LGALTER_BADPARAM, (CL_ERR_DESC *)0,
			ULE_LOG, NULL, 0, 0, 0, &err_code, 4,
			0, lpd->lpd_type, 0, lpd->lpd_id.id_instance,
			0, db_id.id_instance, 0, "LG_A_SBACKUP");
            return (LG_BADPARAM);
        }
	...
	*/
        ...
        if (ldb->ldb_status & LDB_BACKUP)
	{
	    ...
	    ule_format(E_DMA476_LGALTER_DBSTATE, (CL_ERR_DESC *)0,
			ULE_LOG, NULL, 0, 0, 0, &err_code, 4,
	    ...
	    */
		...
		if (my_lpd->lpd_ldb == ldb_offset)
		{
		    ...
		    status = LKshow(LK_S_LIST_NAME, 0, 
				...
				(LK_LOCK_KEY *)0, sizeof(lock_list_id),
			...
			status = LKrequest(LK_NOWAIT | LK_MULTITHREAD | LK_LOCAL,
				    lock_list_id,
				    &lock_key, LK_S, (LK_VALUE*)0, &lock_id,
				    0, sys_err);

		    if (status)
		    {
			/* Failure, unset the stall condition */
			ule_format(E_DMA475_LGALTER_BADPARAM, sys_err,
				    ULE_LOG, NULL, 0, 0, 0, &err_code, 4,
				    0, lock_list_id, 
	...
	*/
	...
	if (db_id.id_id == 0 || (i4)db_id.id_id > lgd->lgd_ldbb_count)
	{
	    ule_format(E_DMA474_LGALTER_BADPARAM, (CL_ERR_DESC *)0,
			ULE_LOG, NULL, 0, 0, 0, &err_code, 3,
			0, db_id.id_id, 0, lgd->lgd_ldbb_count,
			0, "LG_A_CKPERROR");
	    return (LG_BADPARAM);
	}

	ldbb_table = (SIZE_TYPE *)LGK_PTR_FROM_OFFSET(lgd->lgd_ldbb_table);
	ldb = (LDB *)LGK_PTR_FROM_OFFSET(ldbb_table[db_id.id_id]);

	if (ldb->ldb_type != LDB_TYPE ||
	    ldb->ldb_id.id_instance != db_id.id_instance)
	{
	    ule_format(E_DMA475_LGALTER_BADPARAM, (CL_ERR_DESC *)0,
			ULE_LOG, NULL, 0, 0, 0, &err_code, 4,
			0, ldb->ldb_type, 0, ldb->ldb_id.id_instance,
			0, db_id.id_instance, 0, "LG_A_CKPERROR");
            return (LG_BADPARAM);
        }
	...
	*/
        ...
        if (l_item < sizeof(LG_ID))
	{
	    ule_format(E_DMA472_LGALTER_BADPARAM, (CL_ERR_DESC *)0,
			ULE_LOG, NULL, 0, 0, 0, &err_code, 3,
			0, l_item, 0, sizeof(LG_ID), 0, "LG_A_FBACKUP");
	    return (LG_BADPARAM);
	}
	...
	ldb = (LDB *)LGK_PTR_FROM_OFFSET(ldbb_table[db_id.id_id]);
	    ...
	    ule_format(E_DMA475_LGALTER_BADPARAM, (CL_ERR_DESC *)0,
			ULE_LOG, NULL, 0, 0, 0, &err_code, 4,
			0, ldb->ldb_type, 0, ldb->ldb_id.id_instance,
			0, db_id.id_instance, 0, "LG_A_FBACKUP");
            return (LG_BADPARAM);
        }
	...
	*/
        ...
        if (l_item < sizeof(LG_ID))
	{
	    ule_format(E_DMA472_LGALTER_BADPARAM, (CL_ERR_DESC *)0,
			ULE_LOG, NULL, 0, 0, 0, &err_code, 3,
			0, l_item, 0, sizeof(LG_ID), 0, "LG_A_DBACKUP");
	    return (LG_BADPARAM);
	}
	...
	lpd = (LPD *)LGK_PTR_FROM_OFFSET(lpdb_table[db_id.id_id]);
	    ...
	    ule_format(E_DMA475_LGALTER_BADPARAM, (CL_ERR_DESC *)0,
			ULE_LOG, NULL, 0, 0, 0, &err_code, 4,
			0, lpd->lpd_type, 0, lpd->lpd_id.id_instance,
			0, db_id.id_instance, 0, "LG_A_DBACKUP");
            return (LG_BADPARAM);
        }
        ...
        if (l_item < sizeof(LG_ID))
	{
	    ule_format(E_DMA472_LGALTER_BADPARAM, (CL_ERR_DESC *)0,
			ULE_LOG, NULL, 0, 0, 0, &err_code, 3,
			0, l_item, 0, sizeof(LG_ID), 0, "LG_A_SJSWITCH");
	    return (LG_BADPARAM);
	}
	...
	lpd = (LPD *)LGK_PTR_FROM_OFFSET(lpdb_table[db_id.id_id]);
	    ...
	    ule_format(E_DMA475_LGALTER_BADPARAM, (CL_ERR_DESC *)0,
			ULE_LOG, NULL, 0, 0, 0, &err_code, 4,
			0, lpd->lpd_type, 0, lpd->lpd_id.id_instance,
			0, db_id.id_instance, 0, "LG_A_SJSWITCH");
            return (LG_BADPARAM);
        }
        ...
        if (tmp_status & LDB_JSWITCH)
	{
	    ...
	    ule_format(E_DMA476_LGALTER_DBSTATE, (CL_ERR_DESC *)0,
			ULE_LOG, NULL, 0, 0, 0, &err_code, 4,
			0, ldb->ldb_id.id_id, 0, ldb->ldb_id.id_instance,
			0, ldb->ldb_status, 0, "LG_A_SJSWITCH");
	}
        ...
        if (l_item < sizeof(LG_ID))
	{
	    ule_format(E_DMA472_LGALTER_BADPARAM, (CL_ERR_DESC *)0,
			ULE_LOG, NULL, 0, 0, 0, &err_code, 3,
			0, l_item, 0, sizeof(LG_ID), 0, "LG_A_RESUME");
	    return (LG_BADPARAM);
	}
	...
	lpd = (LPD *)LGK_PTR_FROM_OFFSET(lpdb_table[db_id.id_id]);
	    ...
	    ule_format(E_DMA475_LGALTER_BADPARAM, (CL_ERR_DESC *)0,
			ULE_LOG, NULL, 0, 0, 0, &err_code, 4,
			0, lpd->lpd_type, 0, lpd->lpd_id.id_instance,
			0, db_id.id_instance, 0, "LG_A_RESUME");
            return (LG_BADPARAM);
        }
            ...
            (ldb->ldb_status & LDB_STALL) == 0)
	{
        ...
        if (ldb->ldb_status & LDB_STALL)
        {
            ...
            LG_resume(&lgd->lgd_ckpdb_event, 0);
	    (VOID)LG_unmutex(&ldb->ldb_mutex);
        }
        else    
	{
	...
	if (l_item < sizeof(LG_ID))
	{
	    ule_format(E_DMA472_LGALTER_BADPARAM, (CL_ERR_DESC *)0,
			ULE_LOG, NULL, 0, 0, 0, &err_code, 3,
			0, l_item, 0, sizeof(LG_ID), 0, "LG_A_DBRECOVER");
	    return (LG_BADPARAM);
	}
	...
	ldb_offset = ldbb_table[db_id.id_id];
	    ...
	    ldb->ldb_id.id_instance != db_id.id_instance)
	{
	    ule_format(E_DMA475_LGALTER_BADPARAM, (CL_ERR_DESC *)0,
			ULE_LOG, NULL, 0, 0, 0, &err_code, 4,
			0, ldb->ldb_type, 0, ldb->ldb_id.id_instance,
			0, db_id.id_instance, 0, "LG_A_DBRECOVER");
	    return (LG_BADPARAM);
	}
	    ...
	    lpb_offset != end_offset;)
	{
		...
		*/
		...
		if (ldb->ldb_status & LDB_OPENDB_PEND)
		{
		    ...
		    LG_resume(&lgd->lgd_open_event, 0);
		}    
	...
	{
#ifdef xDEBUG
	    LG_debug_wacky_ldb_found(lgd, (LDB *)0);
#endif
	    ule_format(E_DMA474_LGALTER_BADPARAM, (CL_ERR_DESC *)0,
			ULE_LOG, NULL, 0, 0, 0, &err_code, 3,
			0, db_id.id_id, 0, lgd->lgd_ldbb_count,
	...
	*/
	...
	if (*(i4 *)item)
	{
	    ...
	    */
	    ...
	    LG_resume(&lgd->lgd_wait_stall, 0);
	    (VOID)LG_unmutex(&lgd->lgd_mutex);
	}
	else
	{
	...
	*/
	...
	if (l_item < sizeof(LG_ID))
	{
	    ule_format(E_DMA472_LGALTER_BADPARAM, (CL_ERR_DESC *)0,
			ULE_LOG, NULL, 0, 0, 0, &err_code, 3,
			0, l_item, 0, sizeof(LG_ID), 0, "LG_A_PASS_ABORT");
	    return (LG_BADPARAM);
	}
	...
	*/
	...
	if ( lxb->lxb_status & LXB_SHARED_HANDLE )
	{
	    ...
	    {
		ule_format(E_DMA493_LG_NO_SHR_TXN, (CL_ERR_DESC *)0,
		    ULE_LOG, NULL, 0, 0, 0, &err_code, 3,
		    0, *(u_i4*)&lxb->lxb_id,
		    0, lxb->lxb_status,
		    0, "LG_A_SERVER_ABORT/LG_A_OFF_SERVER_ABORT");
	    ...
	    {
		ule_format(E_DMA494_LG_INVALID_SHR_TXN, (CL_ERR_DESC *)0,
		...
		while ( lxbq != (LXBQ*)&slxb->lxb_handles )
		{
			     ...
			     handle_lxb->lxb_status & LXB_ORPHAN )
			{
				...
				ule_format(E_DM900E_BAD_LOG_END, sys_err, ULE_LOG, NULL,
				    (char *)0, 0L, (i4 *)0, &err_code, 1, 0, log_id);
			    }

			    /* ...and its lock list handle, if any */
			    if ( lock_id )
			    {
				status = LKrelease(LK_ALL, lock_id, (LK_LKID *)0, 
				...
				if ( status != OK )
				{
					...
					(char *)0, 0L, (i4 *)0, &err_code, 1, 0, lock_id);
				}
			    }
			}
			else
	...
	*/
	...
	MECOPY_CONST_MACRO((char *)&ctx->lg_ctx_id, sizeof(LG_ID), 
			    (char *)&lx_id);
	...
	*/
	{
	    ...
	    */
	    MECOPY_CONST_MACRO((char *) &tr->tr_id, sizeof(LG_ID), 
			(char *) &lx_id);
	    ...
	    */
	    MECOPY_CONST_MACRO((char *) &tr->tr_pr_id, sizeof(LG_ID), 
			(char *) &lg_id);
		...
		ule_format(E_DMA475_LGALTER_BADPARAM, (CL_ERR_DESC *)0,
			    ULE_LOG, NULL, 0, 0, 0, &err_code, 4,
			    0, lpb->lpb_type, 0, lpb->lpb_id.id_instance,
			    0, lg_id.id_instance, 0, "LG_A_OWNER(2)");
		return (LG_BADPARAM);
	    }
	    ...
	    */
	    MECOPY_CONST_MACRO((char *) &tr->tr_lpd_id, sizeof(LG_ID), 
			(char *) &db_id);
		...
		ule_format(E_DMA475_LGALTER_BADPARAM, (CL_ERR_DESC *)0,
			    ULE_LOG, NULL, 0, 0, 0, &err_code, 4,
			    0, lpd->lpd_type, 0, lpd->lpd_id.id_instance,
			    0, db_id.id_instance, 0, "LG_A_OWNER(3)");
		return (LG_BADPARAM);
	    }
	    ...
	    */
		...
		ule_format(E_DMA474_LGALTER_BADPARAM, (CL_ERR_DESC *)0,
			    ...
			    0, lx_id.id_id, 0, lgd->lgd_lxbb_count,
			    0, "LG_A_OWNER");
		ule_format(E_DMA48D_ADOPT_NONORPHAN, (CL_ERR_DESC *)0,
			    ULE_LOG, NULL, 0, 0, 0, &err_code, 2,
			    0, lx_id.id_id, 0, lxb->lxb_status);
		return (LG_BADPARAM);
	    }
	...
	*/
    ...
    case LG_A_DBCONTEXT:
	{
	    ...
	    */
	    ...
	    db = (LG_DATABASE *)item;
	    MECOPY_CONST_MACRO((char *) &db->db_id, sizeof(LG_ID), 
			(char *) &db_id);
	    ...
	    */
		...
		ule_format(E_DMA475_LGALTER_BADPARAM, (CL_ERR_DESC *)0,
			    ULE_LOG, NULL, 0, 0, 0, &err_code, 4,
			    0, ldb->ldb_type, 0, ldb->ldb_id.id_instance,
			    0, db_id.id_instance, 0, "LG_A_DBCONTEXT");
		return (LG_BADPARAM);
	    }
	...
	else if ( flag == LG_A_XA_DISASSOC && lxb->lxb_status & LXB_SHARED_HANDLE )
	{
	    ...
	    */
		...
		if ( lxb != handle_lxb && 
		    ...
		    DB_DIS_TRAN_ID_EQL_MACRO(lxb->lxb_dis_tran_id, handle_lxb->lxb_dis_tran_id) )
		{
		    /*
	...
	*/
	if (l_item < (sizeof(LG_ID) + sizeof(i4)))
	{
	    ule_format(E_DMA472_LGALTER_BADPARAM, (CL_ERR_DESC *)0,
			ULE_LOG, NULL, 0, 0, 0, &err_code, 3,
			0, l_item, 0, sizeof(LG_ID) + sizeof(i4),
			0, "LG_A_BUFMGR_ID");
	    return (LG_BADPARAM);
	}
	    ...
	    lpb->lpb_id.id_instance != lg_id.id_instance)
	{
	    ule_format(E_DMA475_LGALTER_BADPARAM, (CL_ERR_DESC *)0,
			ULE_LOG, NULL, 0, 0, 0, &err_code, 4,
			0, lpb->lpb_type, 0, lpb->lpb_id.id_instance,
			0, lg_id.id_instance, 0, "LG_A_BUFMGR_ID");
	    return (LG_BADPARAM);
	}
	...
	lpb->lpb_bufmgr_id = *(i4 *)((char *)item + sizeof(LG_ID));
	...
	*/
	...
	if (lg_id.id_id == 0 && lg_id.id_instance == 0)
	{
	...
	else
	{
		...
		ule_format(E_DMA475_LGALTER_BADPARAM, (CL_ERR_DESC *)0,
			ULE_LOG, NULL, 0, 0, 0, &err_code, 4,
			0, lpb->lpb_type, 0, lpb->lpb_id.id_instance,
			0, lg_id.id_instance, 0, "LG_A_DISABLE_DUAL_LOGGING");
		return (LG_BADPARAM);
	    }
	    lfb = (LFB *)LGK_PTR_FROM_OFFSET(lpb->lpb_lfb_offset);
	}
	...
	*/
	...
	else
	{
		...
		ule_format(E_DMA475_LGALTER_BADPARAM, (CL_ERR_DESC *)0,
			    ULE_LOG, NULL, 0, 0, 0, &err_code, 4,
			    0, lpb->lpb_type, 0, lpb->lpb_id.id_instance,
			    0, lg_id.id_instance, 0, "LG_A_ENABLE_DUAL_LOGGING");
		return (LG_BADPARAM);
	    }
	...
	*/
	    ...
	    lpb->lpb_id.id_instance != lg_id.id_instance)
	{
	    ule_format(E_DMA475_LGALTER_BADPARAM, (CL_ERR_DESC *)0,
			ULE_LOG, NULL, 0, 0, 0, &err_code, 4,
			0, lpb->lpb_type, 0, lpb->lpb_id.id_instance,
			0, lg_id.id_instance, 0, "LG_A_FABRT_SID");
	    return (LG_BADPARAM);
	}
    ...
    case LG_A_LXB_OWNER:
	{
	    ...
	    */
		...
		ule_format(E_DMA475_LGALTER_BADPARAM, (CL_ERR_DESC *)0,
			    ULE_LOG, NULL, 0, 0, 0, &err_code, 4,
			    0, lpb->lpb_type, 0, lpb->lpb_id.id_instance,
			    0, lg_id.id_instance, 0, "LG_A_LXB_OWNER(2)");
		return (LG_BADPARAM);
	    }
	...
	*/
	...
	{
	    ule_format(E_DMA490_LXB_RESERVED_SPACE, (CL_ERR_DESC *)0,
		    ULE_LOG, NULL, 0, 0, 0, &err_code, 6,
	...
	{
	    ule_format(E_DMA491_LFB_RESERVED_SPACE, (CL_ERR_DESC *)0,
		    ULE_LOG, NULL, 0, 0, 0, &err_code, 1,
		    sizeof(lfb->lfb_reserved_space), &lfb->lfb_reserved_space);
	...
	*/
	...
	else
	{
		...
		ule_format(E_DMA475_LGALTER_BADPARAM, (CL_ERR_DESC *)0,
		    ULE_LOG, NULL, 0, 0, 0, &err_code, 4,
		    0, lpb->lpb_type, 0, lpb->lpb_id.id_instance,
		    0, lg_id.id_instance, 0, "LG_A_LFLSN");
		return (LG_BADPARAM);
	    }
	...
	if (l_item < sizeof(LG_ID))
	{
	    ule_format(E_DMA472_LGALTER_BADPARAM, (CL_ERR_DESC *)0,
			ULE_LOG, NULL, 0, 0, 0, &err_code, 3,
			0, l_item, 0, sizeof(LG_ID), 0, "LG_A_LBACKUP");
	    return (LG_BADPARAM);
	}
	    ...
	    lpd->lpd_id.id_instance != db_id.id_instance)
	{
	    ule_format(E_DMA475_LGALTER_BADPARAM, (CL_ERR_DESC *)0,
			ULE_LOG, NULL, 0, 0, 0, &err_code, 4,
			0, lpd->lpd_type, 0, lpd->lpd_id.id_instance,
			0, db_id.id_instance, 0, "LG_A_LBACKUP");
	    return (LG_BADPARAM);
	}
	...
	MECOPY_VAR_MACRO(item, sizeof(lx_id), (char*)&lx_id);
	     ...
	     --lxb->lxb_in_mini == 0 )
	{
	    ...
	    */
		...
		if ( lgd->lgd_wait_mini.lwq_count )
		    LG_resume(&lgd->lgd_wait_mini, (i4)0);
		(VOID)LG_unmutex(&slxb->lxb_mutex);
	    }
	}
	...
	*/
    ...
    case LG_A_FILE_DELETE:
	{
	    ...
	    */
	    ...
	    MECOPY_CONST_MACRO((char *)&fdel->fdel_id, sizeof(LG_ID), 
			(char *) &lx_id);
	    if (lx_id.id_id == 0 || (i4)lx_id.id_id > lgd->lgd_lxbb_count)
	    {
		ule_format(E_DMA474_LGALTER_BADPARAM, (CL_ERR_DESC *)0,
			...
			i4 num_buffers)
{
    ...
    {
	(VOID)LG_unmutex(&lfb->lfb_mutex);
	ule_format(E_DMA46B_LGALTER_ALLOC_LBB, (CL_ERR_DESC *)0,
		    ULE_LOG, NULL, 0, 0, 0, &err_code, 1,
	...
	if (status = LG_imutex(&lbb->lbb_mutex,
	    STprintf(sem_name, "LBB mutex %8d", lfb->lfb_buf_cnt)))
	    return(status);
