...
CL_ERR_DESC	    *sys_err)
{
    ...
    {
	ule_format(E_DMA415_LGEND_BAD_ID, (CL_ERR_DESC *)0,
    ...
    {
	ule_format(E_DMA416_LGEND_BAD_XACT, (CL_ERR_DESC *)0,
...
i4		flag)
{
    ...
    */
	...
	else
	{
	    ...
	    LG_assign_tran_id(lfb, lxb, FALSE);
	...
	*/
	if (orphaned_xact)
	    LGremove(*(LG_DBID*)&lpd->lpd_id, &sys_err);
