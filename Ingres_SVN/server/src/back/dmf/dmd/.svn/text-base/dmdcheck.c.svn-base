...
i4	    line)
{
    ...
    ule_format(E_DM9449_DMD_CHECK, (CL_ERR_DESC *)0, ULE_LOG, NULL,
			(char *)0, (i4)0, (i4 *)0, &local_err_code, 2,
			0, file,
			0, line);
	...
	if ( stat == OK )
	{
	    ...
	    ule_format (E_DM942B_CRASH_LOG, (CL_ERR_DESC *)0, ULE_LOG, 
		NULL, (char *)0, (i4)0, (i4 *)0, &local_err_code, 
		1, DMDCHECK_FILENAME_LEN, crash_fname);
	}
    }

    ule_format(error_code, (CL_ERR_DESC *)0, ULE_LOG, NULL, (char *)0, 
			(i4)0, (i4 *)0, &local_err_code, 0);
    /*
