...
i4	    *err_code)
{
    ...
    *gw_xacts = TRUE;
    ...
    if (status)
    {
	ule_format(E_DM9A01_GATEWAY_INIT, (CL_SYS_ERR *)0, ULE_LOG, NULL,
		(char * )0, (i4)0, (i4 *)0, &local_error, 1,
		STlength(SystemProductName), SystemProductName);
	ule_format(gw_rcb.gwr_error.err_code, (CL_SYS_ERR *)0, ULE_LOG, NULL,
	...
	switch(gw_rcb.gwr_error.err_code)
	{
		...
		*err_code = E_DM0112_RESOURCE_QUOTA_EXCEED;
	    ...
	    default:
		*err_code = E_DM0136_GATEWAY_ERROR;
	}
    }
    else
    {
...
**	attr_list	- list of columns in DM2T_ATTR_ENTRY array
...
i4		    *err_code)
{
    ...
    /*
    ** Build attribute list from DM2T_ATTR_ENTRY array.  Allocate array to
    ** build list into.
    */
    mem_needed = attr_count * sizeof(DMT_ATT_ENTRY) + sizeof(DMP_MISC);
    status = dm0m_allocate(mem_needed, (i4)0, (i4)MISC_CB,
	(i4)MISC_ASCII_ID, (char *)NULL, (DM_OBJECT**)&mem_ptr, err_code);
    if (status)
    {
	...
	*err_code = E_DM0112_RESOURCE_QUOTA_EXCEED;
	...
	column_array[i].att_prec = attr_ptr->attr_prec;
	column_array[i].att_collID = attr_ptr->attr_collID;
	column_array[i].att_flags = attr_ptr->attr_flags;
    ...
    */
	...
	base_tab_id.db_tab_index = 0;
	    ...
	    &base_tab_id, (DB_TRAN_ID *)0, xcb->xcb_lk_id, xcb->xcb_log_id,
	    (i4)(DM2T_NOBUILD | DM2T_NOWAIT), (DMP_DCB*)0, &tcb, err_code);
	if (status != E_DB_OK)
	{
	    ule_format(*err_code, (CL_SYS_ERR *)0, ULE_LOG, NULL,
		(char * )0, (i4)0, (i4 *)0, &local_error, 0);
	    *err_code = E_DM9A05_GATEWAY_REGISTER;
	    return (E_DB_ERROR);
	}
	...
	*/
        status = dm2t_unfix_tcb(&tcb, (i4)0, xcb->xcb_lk_id, xcb->xcb_log_id, err_code);
        if (status != E_DB_OK)
	{
	    ule_format(*err_code, (CL_SYS_ERR *)0, ULE_LOG, NULL,
		(char * )0, (i4)0, (i4 *)0, &local_error, 0);
    ...
    */
	...
	switch (gw_rcb.gwr_error.err_code)
	{
		...
		*err_code = E_DM0142_GWF_ALREADY_REPORTED;
		break;
		...
		*err_code = E_DM0042_DEADLOCK;
	    ...
	    default:
		ule_format(E_DM9A05_GATEWAY_REGISTER, (CL_SYS_ERR *)0,
			    ULE_LOG, NULL, (char * )0, (i4)0,
			    (i4 *)0, &local_error, 0);
		ule_format(gw_rcb.gwr_error.err_code, (CL_SYS_ERR *)0,
			    ULE_LOG, NULL, (char * )0, (i4)0,
			    (i4 *)0, &local_error, 0);
...
i4		    *err_code)
{
    ...
    */
    ...
    if (status)
    {
	ule_format(E_DM9A06_GATEWAY_REMOVE, (CL_SYS_ERR *)0, ULE_LOG, NULL,
	    (char * )0, (i4)0, (i4 *)0, &local_error, 1,
	    STlength(SystemProductName), SystemProductName);
	ule_format(gw_rcb.gwr_error.err_code, (CL_SYS_ERR *)0, ULE_LOG, NULL,
	    (char * )0, (i4)0, (i4 *)0, &local_error, 0);
...
i4		    *err_code)
{
    ...
    */
    ...
    {
	status = dmf_get_scb(&scb, err_code);
	if (status != E_DB_OK)
	{
	    ule_format(E_DM9A07_GATEWAY_OPEN, (CL_SYS_ERR *)0, ULE_LOG, NULL,
		(char * )0, (i4)0, (i4 *)0, &local_error, 1,
		STlength (SystemProductName), SystemProductName);
	    ule_format(*err_code, (CL_SYS_ERR *)0, ULE_LOG, NULL,
		(char * )0, (i4)0, (i4 *)0, &local_error, 0);
	...
	if (xcb == NULL)
	{
		...
		(char * )0, (i4)0, (i4 *)0, &local_error, 1,
		STlength(SystemProductName), SystemProductName);
	    ule_format(E_DM003B_BAD_TRAN_ID, (CL_SYS_ERR *)0, ULE_LOG, NULL,
		(char * )0, (i4)0, (i4 *)0, &local_error, 0);
	    *err_code = E_DM0136_GATEWAY_ERROR;
	    return (E_DB_ERROR);
	}
    ...
    */
    mem_needed =
	(i4)ME_ALIGN_MACRO(sizeof(DMP_MISC), sizeof(ALIGN_RESTRICT));
    mem_needed +=
	(i4)ME_ALIGN_MACRO(sizeof(DMT_TBL_ENTRY), sizeof(ALIGN_RESTRICT));
    mem_needed += tcb->tcb_rel.relatts *
	(i4)ME_ALIGN_MACRO(sizeof(DMT_ATT_ENTRY), sizeof(ALIGN_RESTRICT));
    mem_needed += tcb->tcb_index_count *
	(i4)ME_ALIGN_MACRO(sizeof(DMT_IDX_ENTRY), sizeof(ALIGN_RESTRICT));
	...
	*err_code = E_DM0112_RESOURCE_QUOTA_EXCEED;
    ...
    table_entry =
	(DMT_TBL_ENTRY *)((char *)mem_ptr +
	(int)ME_ALIGN_MACRO(sizeof(DMP_MISC), sizeof(ALIGN_RESTRICT)));
    mem_ptr->misc_data = (char*)table_entry;

    column_array = (DMT_ATT_ENTRY *)((char *)table_entry +
	(int)ME_ALIGN_MACRO(sizeof(DMT_TBL_ENTRY), sizeof(ALIGN_RESTRICT)));
    /*
    ** 05-feb-04 (chash01)
    ...
    */
	...
	(tcb->tcb_rel.relatts *
	(int)ME_ALIGN_MACRO(sizeof(DMT_ATT_ENTRY), sizeof(ALIGN_RESTRICT))));
	...
	*/
	...
	switch (gw_rcb.gwr_error.err_code)
	{
		...
		*err_code = E_DM0042_DEADLOCK;
	    ...
	    default:
		ule_format(E_DM9A07_GATEWAY_OPEN, (CL_SYS_ERR *)0,
			    ULE_LOG, NULL, (char * )0, (i4)0,
			    (i4 *)0, &local_error, 1,
			    STlength(SystemProductName), SystemProductName);
		ule_format(gw_rcb.gwr_error.err_code, (CL_SYS_ERR *)0,
...
i4		    *err_code)
{
    ...
    */
	...
	if (status != E_DB_OK)
	{
	    ule_format(E_DM9A08_GATEWAY_CLOSE, (CL_SYS_ERR *)0, ULE_LOG, NULL,
		(char * )0, (i4)0, (i4 *)0, &local_error, 1,
		STlength(SystemProductName), SystemProductName);
	    ule_format(*err_code, (CL_SYS_ERR *)0, ULE_LOG, NULL,
		(char * )0, (i4)0, (i4 *)0, &local_error, 0);
...
i4		    *err_code)
{
    ...
    */
    ...
    gw_rcb.gwr_qual_arg = (PTR)rcb->rcb_f_arg;
    ...
    */
	...
	switch(gw_rcb.gwr_error.err_code)
	{
		...
		*err_code = E_DM0055_NONEXT;
	    ...
	    default:
		ule_format(E_DM9A09_GATEWAY_POSITION, (CL_SYS_ERR *)0, ULE_LOG,
			   NULL, (char * )0, (i4)0, (i4 *)0,
			   &local_error, 1, STlength (SystemProductName),
			   SystemProductName);
		ule_format(gw_rcb.gwr_error.err_code, (CL_SYS_ERR *)0, ULE_LOG,
			   NULL, (char * )0, (i4)0, (i4 *)0,
			   &local_error, 0);
		*err_code = E_DM0136_GATEWAY_ERROR;
		break;
...
i4		    *err_code)
{
    ...
    */
	...
	switch(gw_rcb.gwr_error.err_code)
	{
		...
		*err_code = E_DM0141_GWF_DATA_CVT_ERROR;
		break;
		...
		*err_code = E_DM0055_NONEXT;
	    ...
	    default:
		ule_format(E_DM9A0A_GATEWAY_GET, (CL_SYS_ERR *)0,
			    ULE_LOG, NULL, (char * )0, (i4)0,
			    (i4 *)0, &local_error, 1,
			    STlength (SystemProductName), SystemProductName);
    ...
    */
	...
	checkForInterrupt( rcb, &status, err_code );
    return (status);
}

/*{
    ...
    */
	...
	switch (gw_rcb.gwr_error.err_code)
	{
		...
		*err_code = E_DM0112_RESOURCE_QUOTA_EXCEED;
		...
		ule_format(E_DM9A0B_GATEWAY_PUT, (CL_SYS_ERR *)0,
			    ULE_LOG, NULL, (char * )0, (i4)0,
			    (i4 *)0, &local_error, 1,
			    STlength(SystemProductName), SystemProductName);
		ule_format(gw_rcb.gwr_error.err_code, (CL_SYS_ERR *)0,
    ...
    */
	...
	switch (gw_rcb.gwr_error.err_code)
	{
		...
		*err_code = E_DM0112_RESOURCE_QUOTA_EXCEED;
		...
		ule_format(E_DM9A0C_GATEWAY_REPLACE, (CL_SYS_ERR *)0,
			    ULE_LOG, NULL, (char * )0, (i4)0,
			    (i4 *)0, &local_error, 1,
			    STlength(SystemProductName), SystemProductName);
		ule_format(gw_rcb.gwr_error.err_code, (CL_SYS_ERR *)0,
...
i4		    *err_code)
{
	...
	switch(gw_rcb.gwr_error.err_code)
	{
		...
		*err_code = E_DM0112_RESOURCE_QUOTA_EXCEED;
	    ...
	    default:
		ule_format(E_DM9A0D_GATEWAY_DELETE, (CL_SYS_ERR *)0, ULE_LOG,
		    NULL, (char * )0, (i4)0, (i4 *)0, &local_error,
...
i4		    *err_code)
{
    ...
    if (status)
    {
	ule_format(E_DM9A0E_GATEWAY_BEGIN, (CL_SYS_ERR *)0, ULE_LOG, NULL,
	    (char * )0, (i4)0, (i4 *)0, &local_error, 1,
	    STlength (SystemProductName), SystemProductName);
	ule_format(gw_rcb.gwr_error.err_code, (CL_SYS_ERR *)0, ULE_LOG, NULL,
	    (char * )0, (i4)0, (i4 *)0, &local_error, 0);
...
i4		    *err_code)
{
    ...
    if (status)
    {
	ule_format(E_DM9A0F_GATEWAY_COMMIT, (CL_SYS_ERR *)0, ULE_LOG, NULL,
	    (char * )0, (i4)0, (i4 *)0, &local_error, 1,
	    STlength (SystemProductName), SystemProductName);
	ule_format(gw_rcb.gwr_error.err_code, (CL_SYS_ERR *)0, ULE_LOG, NULL,
	    (char * )0, (i4)0, (i4 *)0, &local_error, 0);
...
i4		    *err_code)
{
    ...
    if (status)
    {
	ule_format(E_DM9A10_GATEWAY_ABORT, (CL_SYS_ERR *)0, ULE_LOG, NULL,
	    (char * )0, (i4)0, (i4 *)0, &local_error, 1,
	    STlength (SystemProductName), SystemProductName);
	ule_format(gw_rcb.gwr_error.err_code, (CL_SYS_ERR *)0, ULE_LOG, NULL,
	    (char * )0, (i4)0, (i4 *)0, &local_error, 0);
...
i4		    *err_code)
{
	...
	*/
	*err_code = E_DM002F_BAD_SESSION_ID;
	return (E_DB_ERROR);
    }
