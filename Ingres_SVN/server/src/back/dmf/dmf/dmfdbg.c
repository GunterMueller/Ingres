...
DM0C_DSC    *dsc;
{
    ...
    TRdisplay("=========================dsc dump============================\n");
    TRdisplay("	Status: %v\n",
	"VALID,JOURNAL,CKP_INPROGRESS,DSC_DUMP,ROLL_FORWARD,SM_INCON,\
PARTIAL_ROLL,<128>,PRETEND,DUMP_DIR_EXISTS,DISABLE_JNL,NO_LOGGING",
	dsc->dsc_status);
    ...
    TRdisplay(" DBaccess=%x    DBservice=%x    Compat Level=(%4s,%d)\n",
	...
	",ABORT-1,ABORT-2,INVALID-1,INVALID-2,OPEN,REDO-FAIL,WILLING-COMMIT",
		dsc->dsc_inconst_code,
		time_buf_first );
    }
...
DM0C_CNF    *cnf;
{
    ...
    */
    ...
    TRdisplay("    Status   : %v\n\n",
        "VALID,JOURNAL,CKP_INPROGRESS,DUMP,ROLL_FORWARD,SMINC,PART,,PRE,\
CFG_BACKUP,JOURNAL_DISABLED,NOLOGGING",
...
WILL_COMMIT_ERR,NOLOGGING_ERROR,NOLOGGING_OPENDB",
