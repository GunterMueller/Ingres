...
**	    Added blocking_mode.
**	01-Oct-2007 (jonj)
**	    Deleted unneeeded cbt_id, renamed cback to cback_fcn.
**	26-Oct-2007 (jonj)
**	    Deleted LKREQ_STALLED_DURING_REQUEST, LKREQ_STALLED_CONVERSION,
**	    replaced with LKB_STALLED attribute.
**	19-Nov-2007 (jonj) 
**	    Add LKREQ_RESULT_FLAGS define.
*/
...
#define	LKREQ_RESULT_FLAGS "\
UPD_VALUE,UPD_LOCKID,VALADDR_PROVIDED,CHECK_STATUS,PHYSICAL,\
20,40,80,COLLECTED"
...
STALLED,DISTRIB,RSB_MUTEXED,EODLC,2000,4000,IS_RSBS"
...
#define LKD_PURGE_DLOCK_LIST    0x0100L /* DIST dlock needs purge of ON_DLOCK */
#define LKD_SHOW_DEADLOCKS	0x8000L /* Display deadlock info */
/* String values of above values: */
#define	LKD_STATUS "\
AST_ENABLE,CLUSTER,CSP_RUNDOWN,CSP_COMPL,HOLD_NEW,HELD_NEW,\
NO_DLM_GLC,PURGE_DLOCK_L,200,400,800,1000,2000,4000,SHOW_DEAD"
...
MASTER_CSP,ALLOC,10000,XSVDB,XROW,MULTITHREAD,CANC_EVENT"
