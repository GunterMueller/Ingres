...
# define DM1B_CC_TIDEOF_LEAF ((u_i4) 0xfffffffd)
...
typedef struct _DM1B_V2_INDEX
{
    ...
    i2		bt_tid_size;		/* Size of tids */
    char        bt_unused[18];          /* For possible future use. */
    u_i4        page_spare6;            /* 64 bit tid project */
    DM_PAGENO   bt_data;                /* Associated Data Page number. */
    i4          bt_kids;                /* Number of children or tids on page */
...
/*
** Name : _DM1B_INDEX - BTREE index page header union.
**
** Description :
**
** History :
...
union _DM1B_INDEX
{
   DM1B_V1_INDEX	dm1b_v1_index;
   DM1B_V2_INDEX	dm1b_v2_index;
};
...
FUNC_EXTERN DB_STATUS dm1bxreplace(
			...
			char            *key,
			DM_TID		*datatid,
			DM1B_INDEX      *old_buffer,
			DM_LINE_IDX	old_child,
			DM1B_INDEX      *new_buffer,
...
#define DM1B_VPT_GET_BT_ATTCNT(page_type, pgptr)                   \
 (page_type != DM_COMPAT_PGTYPE ? ((DM1B_V2_INDEX *)pgptr)->bt_attcnt :0)
...
#define DM1B_VPT_SET_BT_ATTCNT(page_type, btree_type, pgptr, value)        \
	...
	{							    \
	    if (btree_type == DM1B_PLEAF)				    \
        	((DM1B_V2_INDEX *)pgptr)->bt_attcnt = value;	    \
	    else						    \
		((DM1B_V2_INDEX *)pgptr)->bt_attcnt = 0;            \
	}							    \
     }

#define DM1B_VPT_GET_ATTSIZE_MACRO(page_type, pgptr)                     \
	((page_type != DM_COMPAT_PGTYPE) ?                     \
	((DM1B_V2_INDEX *)pgptr)->bt_attcnt * sizeof(DM1B_ATTR) : 0)
...
#define DM1B_V1_GET_PAGE_STAT_MACRO(pgptr)			\
	((DM1B_V1_INDEX *)pgptr)->page_stat

#define DM1B_V2_GET_PAGE_STAT_MACRO(pgptr)			\
	((DM1B_V2_INDEX *)pgptr)->page_stat 
...
#define DM1B_VPT_SET_PAGE_STAT_MACRO(page_type, pgptr, value)	\
     {								\
	if (page_type != DM_COMPAT_PGTYPE)			\
          ((DM1B_V2_INDEX *)pgptr)->page_stat |= value;		\
        else 							\
	  ((DM1B_V1_INDEX *)pgptr)->page_stat |= value;		\
     }
...
#define DM1B_VPT_GET_PAGE_MAIN_MACRO(page_type, pgptr)		\
        (page_type != DM_COMPAT_PGTYPE ? 			\
	((DM1B_V2_INDEX *)pgptr)->page_main :			\
        ((DM1B_V1_INDEX *)pgptr)->page_main)
 
#define DM1B_VPT_SET_PAGE_MAIN_MACRO(page_type, pgptr, value)	\
     {								\
        if (page_type != DM_COMPAT_PGTYPE)			\
          ((DM1B_V2_INDEX *)pgptr)->page_main = value;		\
        else 							\
	  ((DM1B_V1_INDEX *)pgptr)->page_main = value;		\
     }
...
#define DM1B_V1_GET_PAGE_OVFL_MACRO(pgptr)			\
        ((DM1B_V1_INDEX *)pgptr)->page_ovfl

#define DM1B_V2_GET_PAGE_OVFL_MACRO(pgptr)			\
	((DM1B_V2_INDEX *)pgptr)->page_ovfl
...
#define DM1B_VPT_SET_PAGE_OVFL_MACRO(page_type, pgptr, value)	\
     {								\
        if (page_type != DM_COMPAT_PGTYPE)			\
          ((DM1B_V2_INDEX *)pgptr)->page_ovfl = value;		\
        else 							\
	  ((DM1B_V1_INDEX *)pgptr)->page_ovfl = value;		\
     }
...
#define DM1B_V1_GET_PAGE_PAGE_MACRO(pgptr)			\
        ((DM1B_V1_INDEX *)pgptr)->page_page

#define DM1B_V2_GET_PAGE_PAGE_MACRO(pgptr)			\
	((DM1B_V2_INDEX *)pgptr)->page_page
...
#define DM1B_VPT_SET_PAGE_PAGE_MACRO(page_type, pgptr, value)	\
     {								\
        if (page_type != DM_COMPAT_PGTYPE)			\
          ((DM1B_V2_INDEX *)pgptr)->page_page = value;		\
        else 							\
	  ((DM1B_V1_INDEX *)pgptr)->page_page = value;		\
     }
...
#define DM1B_VPT_SET_PAGE_SZTYPE_MACRO(page_type, page_size, pgptr)	\
     {								\
        if (page_type != DM_COMPAT_PGTYPE)			\
          ((DM1B_V2_INDEX *)pgptr)->page_sztype = page_size + page_type;\
     }
 
#define DM1B_V1_GET_PAGE_SEQNO_MACRO(pgptr)			\
        ((DM1B_V1_INDEX *)pgptr)->page_seq_number

#define DM1B_V2_GET_PAGE_SEQNO_MACRO(pgptr)			\
        ((DM1B_V2_INDEX *)pgptr)->page_seq_number
...
#define DM1B_VPT_SET_PAGE_SEQNO_MACRO(page_type, pgptr, value)	\
     {								\
        if (page_type != DM_COMPAT_PGTYPE)			\
            ((DM1B_V2_INDEX *)pgptr)->page_seq_number = value;	\
        else 							\
	    ((DM1B_V1_INDEX *)pgptr)->page_seq_number = value;	\
     }
 
#define DM1B_VPT_GET_PAGE_CHKSUM_MACRO(page_type, pgptr)	\
        (page_type != DM_COMPAT_PGTYPE ? 			\
        ((DM1B_V2_INDEX *)pgptr)->page_checksum :		\
        ((DM1B_V1_INDEX *)pgptr)->page_checksum)
 
#define DM1B_VPT_SET_PAGE_CHKSUM_MACRO(page_type, pgptr, value)	\
     {								\
        if (page_type != DM_COMPAT_PGTYPE)			\
          ((DM1B_V2_INDEX *)pgptr)->page_checksum = value;	\
        else 							\
	  ((DM1B_V1_INDEX *)pgptr)->page_checksum = value;	\
     }
 
#define DM1B_VPT_GET_PAGE_TRAN_ID_MACRO(page_type, pgptr)		\
        (page_type != DM_COMPAT_PGTYPE ?				\
        ((DM1B_V2_INDEX *)pgptr)->page_tran_id :		\
        ((DM1B_V1_INDEX *)pgptr)->page_tran_id)
 
#ifdef sgi_us5
#define DM1B_VPT_SET_PAGE_TRAN_ID_MACRO(page_type, pgptr, tran_id)   \
     {                                                          \
        if (page_type != DM_COMPAT_PGTYPE)                       \
          ((DM1B_V2_INDEX *)pgptr)->page_tran_id = tran_id;     \
        else                                                    \
          ((DM1B_V1_INDEX *)pgptr)->page_tran_id = tran_id;     \
     }
#else
#define DM1B_VPT_SET_PAGE_TRAN_ID_MACRO(page_type, pgptr, tran_id)	\
     {								\
        if (page_type != DM_COMPAT_PGTYPE)			\
          STRUCT_ASSIGN_MACRO(tran_id, ((DM1B_V2_INDEX *)pgptr)->page_tran_id);\
        else							\
          STRUCT_ASSIGN_MACRO(tran_id, ((DM1B_V1_INDEX *)pgptr)->page_tran_id);\
     } 
#endif /* sgi_us5 */

#define DM1B_V1_GET_TRAN_ID_LOW_MACRO(pgptr)			\
        ((DM1B_V1_INDEX *)pgptr)->page_tran_id.db_low_tran

#define DM1B_V2_GET_TRAN_ID_LOW_MACRO(pgptr)			\
        ((DM1B_V2_INDEX *)pgptr)->page_tran_id.db_low_tran
...
#define DM1B_V1_GET_TRAN_ID_HIGH_MACRO(pgptr)			\
        ((DM1B_V1_INDEX *)pgptr)->page_tran_id.db_high_tran

#define DM1B_V2_GET_TRAN_ID_HIGH_MACRO(pgptr)			\
        ((DM1B_V2_INDEX *)pgptr)->page_tran_id.db_high_tran 
...
#define DM1B_VPT_GET_PAGE_LOG_ADDR_MACRO(page_type, pgptr, log_addr)	\
     {								\
        if (page_type != DM_COMPAT_PGTYPE)			\
        STRUCT_ASSIGN_MACRO(((DM1B_V2_INDEX *)pgptr)->page_log_addr,log_addr); \
        else							\
        STRUCT_ASSIGN_MACRO(((DM1B_V1_INDEX *)pgptr)->page_log_addr,log_addr);\
     }
...
#define DM1B_VPT_SET_PAGE_LOG_ADDR_MACRO(page_type, pgptr, log_addr)	\
     {								\
        if (page_type != DM_COMPAT_PGTYPE)			\
        {							\
        STRUCT_ASSIGN_MACRO(log_addr,((DM1B_V2_INDEX *)pgptr)->page_log_addr); \
	((DM1B_V2_INDEX *)pgptr)->bt_clean_count = 0;           \
        }							\
        else							\
        STRUCT_ASSIGN_MACRO(log_addr, ((DM1B_V1_INDEX *)pgptr)->page_log_addr);\
     }
 
#define DM1B_VPT_GET_LOG_ADDR_LOW_MACRO(page_type, pgptr)            \
        (page_type != DM_COMPAT_PGTYPE ?				\
        ((DM1B_V2_INDEX *)pgptr)->page_log_addr.lsn_low :	\
        ((DM1B_V1_INDEX *)pgptr)->page_log_addr.lsn_low)
 
#define DM1B_VPT_GET_LOG_ADDR_HIGH_MACRO(page_type, pgptr)           \
        (page_type != DM_COMPAT_PGTYPE ?				\
        ((DM1B_V2_INDEX *)pgptr)->page_log_addr.lsn_high :	\
        ((DM1B_V1_INDEX *)pgptr)->page_log_addr.lsn_high)

#define DM1B_VPT_ADDR_PAGE_LOG_ADDR_MACRO(page_type, pgptr)		\
        (page_type != DM_COMPAT_PGTYPE ?				\
        (LG_LSN *)&(((DM1B_V2_INDEX *)pgptr)->page_log_addr) :	\
        (LG_LSN *)&(((DM1B_V1_INDEX *)pgptr)->page_log_addr))

#define DM1B_VPT_GET_BT_CLEAN_COUNT_MACRO(page_type, pgptr)		\
        (page_type != DM_COMPAT_PGTYPE ? 			\
	((DM1B_V2_INDEX *)pgptr)->bt_clean_count :		\
	DM1B_CC_INVALID)
...
#define DM1B_V1_GET_BT_NEXTPAGE_MACRO(pgptr)			\
        ((DM1B_V1_INDEX *)pgptr)->bt_nextpage

#define DM1B_V2_GET_BT_NEXTPAGE_MACRO(pgptr)			\
        ((DM1B_V2_INDEX *)pgptr)->bt_nextpage
...
#define DM1B_VPT_SET_BT_NEXTPAGE_MACRO(page_type, pgptr, value)	\
     {								\
	if (page_type != DM_COMPAT_PGTYPE) 			\
          ((DM1B_V2_INDEX *)pgptr)->bt_nextpage = value;	\
	else							\
          ((DM1B_V1_INDEX *)pgptr)->bt_nextpage = value;	\
     }

#define DM1B_VPT_GET_BT_SPLIT_LSN_MACRO(page_type, pgptr, split_lsn)	\
        (page_type != DM_COMPAT_PGTYPE ?				\
        STRUCT_ASSIGN_MACRO(((DM1B_V2_INDEX *)pgptr)->bt_split_lsn,split_lsn): \
        STRUCT_ASSIGN_MACRO(((DM1B_V1_INDEX *)pgptr)->bt_split_lsn, split_lsn))
 
#define DM1B_VPT_GET_SPLIT_LSN_LOW_MACRO(page_type, pgptr)		\
        (page_type != DM_COMPAT_PGTYPE ?				\
        ((DM1B_V2_INDEX *)pgptr)->bt_split_lsn.lsn_low :        \
        ((DM1B_V1_INDEX *)pgptr)->bt_split_lsn.lsn_low)
 
#define DM1B_VPT_GET_SPLIT_LSN_HIGH_MACRO(page_type, pgptr)		\
        (page_type != DM_COMPAT_PGTYPE ?				\
        ((DM1B_V2_INDEX *)pgptr)->bt_split_lsn.lsn_high :       \
        ((DM1B_V1_INDEX *)pgptr)->bt_split_lsn.lsn_high)

#define DM1B_VPT_SET_BT_SPLIT_LSN_MACRO(page_type, pgptr, split_lsn)	\
     {								\
        if (page_type != DM_COMPAT_PGTYPE)			\
        STRUCT_ASSIGN_MACRO(split_lsn,((DM1B_V2_INDEX *)pgptr)->bt_split_lsn);\
        else								\
        STRUCT_ASSIGN_MACRO(split_lsn,((DM1B_V1_INDEX *)pgptr)->bt_split_lsn);\
     }
 
#define DM1B_V1_ADDR_BT_SPLIT_LSN_MACRO(pgptr)			\
        (LG_LSN *)&(((DM1B_V1_INDEX *)pgptr)->bt_split_lsn)

#define DM1B_V2_ADDR_BT_SPLIT_LSN_MACRO(pgptr)			\
        (LG_LSN *)&(((DM1B_V2_INDEX *)pgptr)->bt_split_lsn) 
...
#define DM1B_V1_GET_BT_DATA_MACRO(pgptr)			\
        ((DM1B_V1_INDEX *)pgptr)->bt_data

#define DM1B_V2_GET_BT_DATA_MACRO(pgptr)			\
	((DM1B_V2_INDEX *)pgptr)->bt_data 
...
#define DM1B_VPT_SET_BT_DATA_MACRO(page_type, pgptr, value)		\
     {								\
	if (page_type != DM_COMPAT_PGTYPE)			\
	  ((DM1B_V2_INDEX *)pgptr)->bt_data = value;		\
	else							\
          ((DM1B_V1_INDEX *)pgptr)->bt_data = value;		\
     }
...
#define DM1B_V1_GET_BT_KIDS_MACRO(pgptr)			\
        ((DM1B_V1_INDEX *)pgptr)->bt_kids

#define DM1B_V2_GET_BT_KIDS_MACRO(pgptr)			\
	((DM1B_V2_INDEX *)pgptr)->bt_kids 
...
#define DM1B_VPT_SET_BT_KIDS_MACRO(page_type, pgptr, value)		\
     {								\
        if (page_type != DM_COMPAT_PGTYPE)			\
          ((DM1B_V2_INDEX *)pgptr)->bt_kids = value; 		\
	else							\
          ((DM1B_V1_INDEX *)pgptr)->bt_kids = value;		\
     }
 
#define DM1B_V1_BT_SEQUENCE_MACRO(pgptr)			\
        (DM_LINEID *)(((DM1B_V1_INDEX *)pgptr)->bt_sequence)

#define DM1B_V2_BT_SEQUENCE_MACRO(pgptr)			\
        (DM_LINEID *)(((DM1B_V2_INDEX *)pgptr)->bt_sequence)
...
#define DM1B_VPT_GET_BT_SEQUENCE_MACRO(page_type, pgptr, index, btseq)	\
    {									\
        if (page_type != DM_COMPAT_PGTYPE)				\
          btseq.dm_v2_lineid = (((DM1B_V2_INDEX *)pgptr)->bt_sequence[index]);\
	else								\
          btseq.dm_v1_lineid = (((DM1B_V1_INDEX *)pgptr)->bt_sequence[index]);\
    }
 
#define DM1B_VPT_SET_BT_SEQUENCE_MACRO(page_type, pgptr, index, index2)	\
     {									\
        if (page_type != DM_COMPAT_PGTYPE)				\
          ((DM1B_V2_INDEX *)pgptr)->bt_sequence[index] = 		\
	  	((DM1B_V2_INDEX *)pgptr)->bt_sequence[index2];		\
	else								\
          ((DM1B_V1_INDEX *)pgptr)->bt_sequence[index] = 		\
		((DM1B_V1_INDEX *)pgptr)->bt_sequence[index2];		\
     }
 
#define DM1B_VPT_ASSIGN_BT_SEQUENCE_MACRO(page_type, pgptr, index, btseq)\
     {									\
        if (page_type != DM_COMPAT_PGTYPE)				\
          ((DM1B_V2_INDEX *)pgptr)->bt_sequence[index] = btseq.dm_v2_lineid; \
	else								\
          ((DM1B_V1_INDEX *)pgptr)->bt_sequence[index] = btseq.dm_v1_lineid; \
     }
 
#define DM1B_V1_GET_ADDR_BT_SEQUENCE_MACRO(pgptr, index)	\
        (DM_LINEID *)&(((DM1B_V1_INDEX *)pgptr)->bt_sequence[index])

#define DM1B_V2_GET_ADDR_BT_SEQUENCE_MACRO(pgptr, index)	\
        (DM_LINEID *)&(((DM1B_V2_INDEX *)pgptr)->bt_sequence[index]) 
...
#define DM1B_V1_GET_BT_TIDSZ_MACRO(pgptr)			\
        ((DM1B_V1_INDEX *)pgptr)->bt_tid_size

#define DM1B_V2_GET_BT_TIDSZ_MACRO(pgptr)			\
	((DM1B_V2_INDEX *)pgptr)->bt_tid_size 
...
#define DM1B_VPT_SET_BT_TIDSZ_MACRO(page_type, pgptr, value)	\
     {								\
        if (page_type != DM_COMPAT_PGTYPE)			\
          ((DM1B_V2_INDEX *)pgptr)->bt_tid_size = value; 	\
	else							\
          ((DM1B_V1_INDEX *)pgptr)->bt_tid_size = value;	\
     }
 
/* any change to this macro will probably require change to DMPP counterpart */
#define DM1B_SKIP_DELETED_KEY_MACRO(r, b, low_tran)		\
	(!row_locking(r) || !low_tran 				\
	...
	TRUE : dmxe_xn_active(low_tran) ? FALSE : TRUE)

/* any change to this macro will probably require change to DMPP counterpart */
#define DM1B_DUPCHECK_NEED_ROW_LOCK_MACRO(r, b, low_tran)	\
	(!row_locking(r) || !low_tran 				\
	|| low_tran == r->rcb_tran_id.db_low_tran		\
	|| !(LSN_GTE(DM1B_VPT_ADDR_PAGE_LOG_ADDR_MACRO(		\
	r->rcb_tcb_ptr->tcb_rel.relpgtype, b), &r->rcb_oldest_lsn)) ? \
	FALSE : dmxe_xn_active(low_tran) ? TRUE : FALSE)
