...
typedef struct _DM_STECB
{
    ...
    i4	    	    ste_pbix;		/* parent index to exch buffer array */
    i4	    	    ste_cbix;		/* child index to exch buffer array */
    i4	    	    ste_prstrt;		/* ex array index to restart parent */
    i4	    	    ste_crstrt;		/* ex array index to restart child */
    ...
    i4	    	    ste_c_puts;		/* rows "put" to thread */
    i4	    	    ste_c_gets;		/* rows "gotten" from thread */
