...
*/
/* unused		unused		    0x01L */
#define                 DM2R_ELIMINATE_DUPS 0x02L
#define                 DM2R_NOSORT         0x04L
#define                 DM2R_TABLE_EXISTS   0x010L
#define                 DM2R_DUPKEY_ERR     0x020L
#define                 DM2R_EMPTY          0x040L
#define			DM2R_SORTNC	    0x080L

/*}
