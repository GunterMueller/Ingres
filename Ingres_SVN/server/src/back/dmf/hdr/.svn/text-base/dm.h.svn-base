...
**
** So that all new tables created receive the latest DMF version the
** DMF_T_VERSION should always be re-defined to be the highest version
** value used. The DMF_S_* constants can be used to formulate range
** checks on the version number.
*/

#define       DMF_T0_VERSION       CV_C_CONST_MACRO('6', '.', '0', ' ')
#define	      DMF_S0_VERSION	   "6.0 "
#define       DMF_T1_VERSION       CV_C_CONST_MACRO('6', '.', '0', 'a')
#define	      DMF_S1_VERSION	   "6.0a"
#define       DMF_T2_VERSION       CV_C_CONST_MACRO('6', '.', '1', 'a')
#define	      DMF_S2_VERSION	   "6.1a"
#define       DMF_T3_VERSION       CV_C_CONST_MACRO('7', '.', '0', ' ')
#define	      DMF_S3_VERSION	   "7.0 "
#define       DMF_T4_VERSION       CV_C_CONST_MACRO('8', '.', '0', ' ')
#define	      DMF_S4_VERSION	   "8.0 "
#define       DMF_T5_VERSION       CV_C_CONST_MACRO('8', '.', '5', ' ')
#define	      DMF_S5_VERSION	   "8.5 "
#define       DMF_T6_VERSION       CV_C_CONST_MACRO('8', '.', '6', ' ')
#define	      DMF_S6_VERSION	   "8.6 "
#define       DMF_T7_VERSION       CV_C_CONST_MACRO('9', '.', '0', ' ')
#define	      DMF_S7_VERSION	   "9.0"
#define       DMF_T8_VERSION       CV_C_CONST_MACRO('9', '.', '1', ' ')
#define	      DMF_S8_VERSION	   "9.1"
#define       DMF_T9_VERSION       CV_C_CONST_MACRO('9', '.', '2', ' ')
#define	      DMF_S9_VERSION	   "9.2"
#define       DMF_T_VERSION        DMF_T7_VERSION
#define	      DMF_S_VERSION	   DMF_S7_VERSION
...
page_type == DM_PG_V3 || page_type == DM_PG_V4 || page_type == DM_PG_V5) ? 1 : 0) 
...
#define			OBJ_T_FREE	    CV_C_CONST_MACRO('F', 'R', 'E', 'E')
    ...
    bool	    svcb_load_optim;	    /* Enable/disable async writes on 
					    ** modify/load/index operations */
...
#define		    E_DM9398_SD_INFO			(E_DM_MASK + 0x9398L)
