...
then
	...
	if [ "$shlinkHB_cmd" ]; then
		shlink_cmd="$shlinkHB_cmd"
	fi
	if [ "$shlinkHB_opts" ]; then
		shlink_opts="$shlinkHB_opts"
	fi
...
#
[ "$config" = "rs4_us5" -o "$config" = "ris_u64" -o "$config" = "i64_aix" ] &&
mkexplist()
{
...
#
#
[ "$config" = "ris_us5" -o "$config" = "rs4_us5" -o "$config" = "ris_u64" \
  -o "$config" = "i64_aix" ] &&
archive_lib()
{
    libname=$1
...
then
    ...
    [ "$config" = "ris_us5" -o "$config" = "rs4_us5" -o \
      "$config" = "ris_u64" -o "$config" = "i64_aix" ] && mkexplist
    rm -f $INGLIB/lib(PROG0PRFX)becompat.1.$SLSFX
    echo $shlink_cmd -o $INGLIB/lib(PROG0PRFX)becompat.1.$SLSFX \*.o $shlink_opts
    case $config in
    dgi_us5 | dg8_us5 | nc4_us5 | sqs_ptx | sos_us5 | pym_us5 | rmx_us5 | \
    rux_us5)
           $shlink_cmd -o $INGLIB/lib(PROG0PRFX)becompat.1.$SLSFX *.o $shlink_opts \
    ...
    usl_us5 )
           ...
           ;;
    dr6_us5)
        $shlink_cmd -o $INGLIB/lib(PROG0PRFX)becompat.1.$SLSFX *.o \
    ...
    *)
    ...
    if [ $? != 0 -o ! -r $INGLIB/lib(PROG0PRFX)becompat.1.$SLSFX ]
    then
        echo $0 Failed,  aborting !!
        exit 4
    else
        [ "$config" = "ris_us5" -o "$config" = "rs4_us5" -o \
          "$config" = "ris_u64" -o "$config" = "i64_aix" ] \
	  && archive_lib lib(PROG0PRFX)becompat.1
        # on some systems, libs being non writable may add to performance
        chmod 755 $INGLIB/lib(PROG0PRFX)becompat.1.$SLSFX
        ls -l $INGLIB/lib(PROG0PRFX)becompat.1.$SLSFX
        echo Cleaning up ....
...
then
    ...
    [ "$config" = "ris_us5" -o "$config" = "rs4_us5" -o \
      "$config" = "ris_u64" -o "$config" = "i64_aix" ] && mkexplist
    rm -f $INGLIB/lib(PROG0PRFX)scf.1.$SLSFX
    echo $shlink_cmd -o $INGLIB/lib(PROG0PRFX)scf.1.$SLSFX \*.o $shlink_opts
    case $config in
    dgi_us5 | dg8_us5 | nc4_us5 | sqs_ptx | sos_us5 | pym_us5 | rmx_us5 | \
    rux_us5)
           $shlink_cmd -o $INGLIB/lib(PROG0PRFX)scf.1.$SLSFX *.o $shlink_opts \
    ...
    usl_us5 )
           ...
           ;;
    dr6_us5)
        $shlink_cmd -o $INGLIB/lib(PROG0PRFX)scf.1.$SLSFX *.o \
    ...
    *)
    ...
    if [ $? != 0 -o ! -r $INGLIB/lib(PROG0PRFX)scf.1.$SLSFX ]
    then
        echo $0 Failed,  aborting !!
        exit 4
    else
	  ...
	  && archive_lib lib(PROG0PRFX)scf.1
        # on some systems, libs being non writable may add to performance
        chmod 755 $INGLIB/lib(PROG0PRFX)scf.1.$SLSFX
        ls -l $INGLIB/lib(PROG0PRFX)scf.1.$SLSFX
        echo Cleaning up ....
...
then
    ...
    [ "$config" = "ris_us5" -o "$config" = "rs4_us5" -o \
      "$config" = "ris_u64" -o "$config" = "i64_aix" ] && mkexplist
    rm -f $INGLIB/lib(PROG0PRFX)opf.1.$SLSFX
    echo $shlink_cmd -o $INGLIB/lib(PROG0PRFX)opf.1.$SLSFX \*.o $shlink_opts
    case $config in
    dgi_us5 | dg8_us5 | nc4_us5 | sqs_ptx | sos_us5 | pym_us5 | rmx_us5 | \
    rux_us5)
           $shlink_cmd -o $INGLIB/lib(PROG0PRFX)opf.1.$SLSFX *.o $shlink_opts \
    ...
    usl_us5 )
           ...
           ;;
    dr6_us5)
        $shlink_cmd -o $INGLIB/lib(PROG0PRFX)opf.1.$SLSFX *.o \
    ...
    *)
    ...
    if [ $? != 0 -o ! -r $INGLIB/lib(PROG0PRFX)opf.1.$SLSFX ]
    then
        echo $0 Failed,  aborting !!
        exit 4
    else
	  ...
	  && archive_lib lib(PROG0PRFX)opf.1
        # on some systems, libs being non writable may add to performance
        chmod 755 $INGLIB/lib(PROG0PRFX)opf.1.$SLSFX
        ls -l $INGLIB/lib(PROG0PRFX)opf.1.$SLSFX
        echo Cleaning up ....
...
#    rm -f rdfgetdesc.o rdfgetinfo.o rdfinvalid.o
    ...
    [ "$config" = "ris_us5" -o "$config" = "rs4_us5" -o \
      "$config" = "ris_u64" -o "$config" = "i64_aix" ] && mkexplist
    rm -f $INGLIB/lib(PROG0PRFX)rdf.1.$SLSFX
    echo $shlink_cmd -o $INGLIB/lib(PROG0PRFX)rdf.1.$SLSFX \*.o $shlink_opts
    case $config in
    dgi_us5 | dg8_us5 | nc4_us5 | sqs_ptx | sos_us5 | pym_us5 | rmx_us5 | \
    rux_us5)
           $shlink_cmd -o $INGLIB/lib(PROG0PRFX)rdf.1.$SLSFX *.o $shlink_opts \
    ...
    usl_us5 )
           ...
           ;;
    dr6_us5)
        $shlink_cmd -o $INGLIB/lib(PROG0PRFX)rdf.1.$SLSFX *.o \
    ...
    *)
    ...
    if [ $? != 0 -o ! -r $INGLIB/lib(PROG0PRFX)rdf.1.$SLSFX ]
    then
        echo $0 Failed,  aborting !!
        exit 4
    else
	  ...
	  && archive_lib lib(PROG0PRFX)rdf.1
        # on some systems, libs being non writable may add to performance
        chmod 755 $INGLIB/lib(PROG0PRFX)rdf.1.$SLSFX
        ls -l $INGLIB/lib(PROG0PRFX)rdf.1.$SLSFX
        echo Cleaning up ....
...
then
    ...
    [ "$config" = "ris_us5" -o "$config" = "rs4_us5" -o \
      "$config" = "ris_u64" -o "$config" = "i64_aix" ] && mkexplist
    rm -f $INGLIB/lib(PROG0PRFX)qef.1.$SLSFX
    echo $shlink_cmd -o $INGLIB/lib(PROG0PRFX)qef.1.$SLSFX \*.o $shlink_opts
    case $config in
    dgi_us5 | dg8_us5 | nc4_us5 | sqs_ptx | sos_us5 | pym_us5 | rmx_us5 | \
    rux_us5)
           $shlink_cmd -o $INGLIB/lib(PROG0PRFX)qef.1.$SLSFX *.o $shlink_opts \
    ...
    usl_us5 )
           ...
           ;;
    dr6_us5)
        $shlink_cmd -o $INGLIB/lib(PROG0PRFX)qef.1.$SLSFX *.o \
    ...
    *)
    ...
    if [ $? != 0 -o ! -r $INGLIB/lib(PROG0PRFX)qef.1.$SLSFX ]
    then
        echo $0 Failed,  aborting !!
        exit 4
    else
	  ...
	  && archive_lib lib(PROG0PRFX)qef.1
        # on some systems, libs being non writable may add to performance
        chmod 755 $INGLIB/lib(PROG0PRFX)qef.1.$SLSFX
        ls -l $INGLIB/lib(PROG0PRFX)qef.1.$SLSFX
        echo Cleaning up ....
...
then
    ...
    [ "$config" = "ris_us5" -o "$config" = "rs4_us5" -o \
      "$config" = "ris_u64" -o "$config" = "i64_aix" ] && mkexplist
    rm -f $INGLIB/lib(PROG0PRFX)psf.1.$SLSFX
    echo $shlink_cmd -o $INGLIB/lib(PROG0PRFX)psf.1.$SLSFX \*.o $shlink_opts
    case $config in
    dgi_us5 | dg8_us5 | nc4_us5 | sqs_ptx | sos_us5 | pym_us5 | rmx_us5 | \
    rux_us5)
           $shlink_cmd -o $INGLIB/lib(PROG0PRFX)psf.1.$SLSFX *.o $shlink_opts \
    ...
    usl_us5 )
           ...
           ;;
    dr6_us5)
        $shlink_cmd -o $INGLIB/lib(PROG0PRFX)psf.1.$SLSFX *.o \
    ...
    *)
    ...
    if [ $? != 0 -o ! -r $INGLIB/lib(PROG0PRFX)psf.1.$SLSFX ]
    then
        echo $0 Failed,  aborting !!
        exit 4
    else
	  ...
	  && archive_lib lib(PROG0PRFX)psf.1
        # on some systems, libs being non writable may add to performance
        chmod 755 $INGLIB/lib(PROG0PRFX)psf.1.$SLSFX
        ls -l $INGLIB/lib(PROG0PRFX)psf.1.$SLSFX
        echo Cleaning up ....
...
then
    ...
    [ "$config" = "ris_us5" -o "$config" = "rs4_us5" -o \
      "$config" = "ris_u64" -o "$config" = "i64_aix" ] && mkexplist
    rm -f $INGLIB/lib(PROG0PRFX)dbutil.1.$SLSFX
    echo $shlink_cmd -o $INGLIB/lib(PROG0PRFX)dbutil.1.$SLSFX \*.o $shlink_opts
    case $config in
    dgi_us5 | dg8_us5 | nc4_us5 | sqs_ptx | sos_us5 | pym_us5 | rmx_us5 | \
    rux_us5)
           $shlink_cmd -o $INGLIB/lib(PROG0PRFX)dbutil.1.$SLSFX *.o $shlink_opts \
    ...
    usl_us5 )
           ...
           ;;
    dr6_us5)
        $shlink_cmd -o $INGLIB/lib(PROG0PRFX)dbutil.1.$SLSFX *.o \
    ...
    *)
    ...
    if [ $? != 0 -o ! -r $INGLIB/lib(PROG0PRFX)dbutil.1.$SLSFX ]
    then
        echo $0 Failed,  aborting !!
        exit 4
    else
	  ...
	  && archive_lib lib(PROG0PRFX)dbutil.1
        # on some systems, libs being non writable may add to performance
        chmod 755 $INGLIB/lib(PROG0PRFX)dbutil.1.$SLSFX
        ls -l $INGLIB/lib(PROG0PRFX)dbutil.1.$SLSFX
        echo Cleaning up ....
...
then
    ...
    [ "$config" = "ris_us5" -o "$config" = "rs4_us5" -o \
      "$config" = "ris_u64" -o "$config" = "i64_aix" ] && mkexplist
    rm -f $INGLIB/lib(PROG0PRFX)qsf.1.$SLSFX
    echo $shlink_cmd -o $INGLIB/lib(PROG0PRFX)qsf.1.$SLSFX \*.o $shlink_opts
    case $config in
    dgi_us5 | dg8_us5 | nc4_us5 | sqs_ptx | sos_us5 | pym_us5 | rmx_us5 | \
    rux_us5)
           $shlink_cmd -o $INGLIB/lib(PROG0PRFX)qsf.1.$SLSFX *.o $shlink_opts \
    ...
    usl_us5 )
           ...
           ;;
    dr6_us5)
        $shlink_cmd -o $INGLIB/lib(PROG0PRFX)qsf.1.$SLSFX *.o \
    ...
    *)
    ...
    if [ $? != 0 -o ! -r $INGLIB/lib(PROG0PRFX)qsf.1.$SLSFX ]
    then
        echo $0 Failed,  aborting !!
        exit 4
    else
	  ...
	  && archive_lib lib(PROG0PRFX)qsf.1
        # on some systems, libs being non writable may add to performance
        chmod 755 $INGLIB/lib(PROG0PRFX)qsf.1.$SLSFX
        ls -l $INGLIB/lib(PROG0PRFX)qsf.1.$SLSFX
        echo Cleaning up ....
...
then
    ...
    [ "$config" = "ris_us5" -o "$config" = "rs4_us5" -o \
      "$config" = "ris_u64" -o "$config" = "i64_aix" ] && mkexplist
    rm -f $INGLIB/lib(PROG0PRFX)dmf.1.$SLSFX
    echo $shlink_cmd -o $INGLIB/lib(PROG0PRFX)dmf.1.$SLSFX \*.o $shlink_opts
    case $config in
    dgi_us5 | dg8_us5 | nc4_us5 | sqs_ptx | sos_us5 | pym_us5 | rmx_us5 | \
    rux_us5)
           $shlink_cmd -o $INGLIB/lib(PROG0PRFX)dmf.1.$SLSFX *.o $shlink_opts \
    ...
    usl_us5 )
           ...
           ;;
    dr6_us5)
        $shlink_cmd -o $INGLIB/lib(PROG0PRFX)dmf.1.$SLSFX *.o \
    ...
    ts2_us5)
      ...
      *_lnx|int_rpl)
        $shlink_cmd -o $INGLIB/lib(PROG0PRFX)dmf.1.$SLSFX *.o \
	$INGLIB/lib(PROG0PRFX)becompat.1.$SLSFX \
    ...
    *)
    ...
    if [ $? != 0 -o ! -r $INGLIB/lib(PROG0PRFX)dmf.1.$SLSFX ]
    then
        echo $0 Failed,  aborting !!
        exit 4
    else
	  ...
	  && archive_lib lib(PROG0PRFX)dmf.1
        # on some systems, libs being non writable may add to performance
        chmod 755 $INGLIB/lib(PROG0PRFX)dmf.1.$SLSFX
        ls -l $INGLIB/lib(PROG0PRFX)dmf.1.$SLSFX
        echo Cleaning up ....
...
then
    ...
    [ "$config" = "ris_us5" -o "$config" = "rs4_us5" -o \
      "$config" = "ris_u64" -o "$config" = "i64_aix" ] && mkexplist
    rm -f $INGLIB/lib(PROG0PRFX)gwf.1.$SLSFX
    echo $shlink_cmd -o $INGLIB/lib(PROG0PRFX)gwf.1.$SLSFX \*.o $shlink_opts
    case $config in
    dgi_us5 | dg8_us5 | nc4_us5 | sqs_ptx | sos_us5 | pym_us5 | rmx_us5 | \
    rux_us5)
           $shlink_cmd -o $INGLIB/lib(PROG0PRFX)gwf.1.$SLSFX *.o $shlink_opts \
    ...
    usl_us5 )
           ...
           ;;
    dr6_us5)
        $shlink_cmd -o $INGLIB/lib(PROG0PRFX)gwf.1.$SLSFX *.o \
    ...
    *)
    ...
    if [ $? != 0 -o ! -r $INGLIB/lib(PROG0PRFX)gwf.1.$SLSFX ]
    then
        echo $0 Failed,  aborting !!
        exit 4
    else
        [ "$config" = "ris_us5" -o "$config" = "rs4_us5" -o \
          "$config" = "ris_u64" -o "$config" = "i64_iax" ] \
	  && archive_lib lib(PROG0PRFX)gwf.1
        # on some systems, libs being non writable may add to performance
        chmod 755 $INGLIB/lib(PROG0PRFX)gwf.1.$SLSFX
        ls -l $INGLIB/lib(PROG0PRFX)gwf.1.$SLSFX
        echo Cleaning up ....
...
then
    ...
    [ "$config" = "ris_us5" -o "$config" = "rs4_us5" -o \
      "$config" = "ris_u64" -o "$config" = "i64_iax" ] && mkexplist
    rm -f $INGLIB/lib(PROG0PRFX)adf.1.$SLSFX
    echo $shlink_cmd -o $INGLIB/lib(PROG0PRFX)adf.1.$SLSFX \*.o $shlink_opts
    case $config in
    dgi_us5 | dg8_us5 | nc4_us5 | sqs_ptx | sos_us5 | pym_us5 | rmx_us5 | \
    rux_us5)
           $shlink_cmd -o $INGLIB/lib(PROG0PRFX)adf.1.$SLSFX *.o $shlink_opts \
    ...
    usl_us5 )
           ...
           ;;
    dr6_us5)
        $shlink_cmd -o $INGLIB/lib(PROG0PRFX)adf.1.$SLSFX *.o \
    ...
    *)
    ...
    if [ $? != 0 -o ! -r $INGLIB/lib(PROG0PRFX)adf.1.$SLSFX ]
    then
        echo $0 Failed,  aborting !!
        exit 4
    else
	  ...
	  && archive_lib lib(PROG0PRFX)adf.1
        # on some systems, libs being non writable may add to performance
        chmod 755 $INGLIB/lib(PROG0PRFX)adf.1.$SLSFX
        ls -l $INGLIB/lib(PROG0PRFX)adf.1.$SLSFX
        echo Cleaning up ....
...
then
    ...
    [ "$config" = "ris_us5" -o "$config" = "rs4_us5" -o \
      "$config" = "ris_u64" -o "$config" = "i64_aix" ] && mkexplist
    rm -f $INGLIB/lib(PROG0PRFX)ulf.1.$SLSFX
    echo $shlink_cmd -o $INGLIB/lib(PROG0PRFX)ulf.1.$SLSFX \*.o $shlink_opts
    case $config in
    dgi_us5 | dg8_us5 | nc4_us5 | sqs_ptx | sos_us5 | pym_us5 | rmx_us5 | \
    rux_us5)
           $shlink_cmd -o $INGLIB/lib(PROG0PRFX)ulf.1.$SLSFX *.o $shlink_opts \
    ...
    usl_us5 )
           ...
           ;;
    dr6_us5)
        $shlink_cmd -o $INGLIB/lib(PROG0PRFX)ulf.1.$SLSFX *.o \
    ...
    *)
    ...
    if [ $? != 0 -o ! -r $INGLIB/lib(PROG0PRFX)ulf.1.$SLSFX ]
    then
        echo $0 Failed,  aborting !!
        exit 4
    else
	  ...
	  && archive_lib lib(PROG0PRFX)ulf.1
        # on some systems, libs being non writable may add to performance
        chmod 755 $INGLIB/lib(PROG0PRFX)ulf.1.$SLSFX
        ls -l $INGLIB/lib(PROG0PRFX)ulf.1.$SLSFX
        echo Cleaning up ....
...
then
    ...
    [ "$config" = "ris_us5" -o "$config" = "rs4_us5" -o \
      "$config" = "ris_u64" -o "$config" = "i64_aix" ] && mkexplist
    rm -f $INGLIB/lib(PROG0PRFX)tpf.1.$SLSFX
    echo $shlink_cmd -o $INGLIB/lib(PROG0PRFX)tpf.1.$SLSFX \*.o $shlink_opts
    case $config in
    dgi_us5 | dg8_us5 | nc4_us5 | sqs_ptx | sos_us5 | pym_us5 | rmx_us5 | \
    rux_us5)
           $shlink_cmd -o $INGLIB/lib(PROG0PRFX)tpf.1.$SLSFX *.o $shlink_opts \
    ...
    usl_us5 )
           ...
           ;;
    dr6_us5)
        $shlink_cmd -o $INGLIB/lib(PROG0PRFX)tpf.1.$SLSFX *.o \
    ...
    *)
    ...
    if [ $? != 0 -o ! -r $INGLIB/lib(PROG0PRFX)tpf.1.$SLSFX ]
    then
        echo $0 Failed,  aborting !!
        exit 4
    else
	  ...
	  && archive_lib lib(PROG0PRFX)tpf.1
        # on some systems, libs being non writable may add to performance
        chmod 755 $INGLIB/lib(PROG0PRFX)tpf.1.$SLSFX
        ls -l $INGLIB/lib(PROG0PRFX)tpf.1.$SLSFX
        echo Cleaning up ....
...
then
    ...
    [ "$config" = "ris_us5" -o "$config" = "rs4_us5" -o \
      "$config" = "ris_u64" -o "$config" = "i64_aix" ] && mkexplist
    rm -f $INGLIB/lib(PROG0PRFX)rqf.1.$SLSFX
    echo $shlink_cmd -o $INGLIB/lib(PROG0PRFX)rqf.1.$SLSFX \*.o $shlink_opts
    case $config in
    dgi_us5 | dg8_us5 | nc4_us5 | sqs_ptx | sos_us5 | pym_us5 | rmx_us5 | \
    rux_us5)
           $shlink_cmd -o $INGLIB/lib(PROG0PRFX)rqf.1.$SLSFX *.o $shlink_opts \
    ...
    usl_us5 )
           ...
           ;;
    dr6_us5)
        $shlink_cmd -o $INGLIB/lib(PROG0PRFX)rqf.1.$SLSFX *.o \
    ...
    *)
    ...
    if [ $? != 0 -o ! -r $INGLIB/lib(PROG0PRFX)rqf.1.$SLSFX ]
    then
        echo $0 Failed,  aborting !!
        exit 4
    else
	  ...
	  && archive_lib lib(PROG0PRFX)rqf.1
        # on some systems, libs being non writable may add to performance
        chmod 755 $INGLIB/lib(PROG0PRFX)rqf.1.$SLSFX
        ls -l $INGLIB/lib(PROG0PRFX)rqf.1.$SLSFX
        echo Cleaning up ....
...
then
    ...
    [ "$config" = "ris_us5" -o "$config" = "rs4_us5" -o \
      "$config" = "ris_u64" -o "$config" = "i64_aix" ] && mkexplist
    rm -f $INGLIB/lib(PROG0PRFX)gcf.1.$SLSFX
    echo $shlink_cmd -o $INGLIB/lib(PROG0PRFX)gcf.1.$SLSFX \*.o $shlink_opts
    case $config in
    dgi_us5 | dg8_us5 | nc4_us5 | sqs_ptx | sos_us5 | pym_us5 | rmx_us5 | \
    rux_us5)
           $shlink_cmd -o $INGLIB/lib(PROG0PRFX)gcf.1.$SLSFX *.o $shlink_opts \
    ...
    usl_us5 )
           ...
           ;;
    dr6_us5)
        $shlink_cmd -o $INGLIB/lib(PROG0PRFX)gcf.1.$SLSFX *.o \
    ...
    *)
    ...
    if [ $? != 0 -o ! -r $INGLIB/lib(PROG0PRFX)gcf.1.$SLSFX ]
    then
        echo $0 Failed,  aborting !!
        exit 4
    else
	  ...
	  && archive_lib lib(PROG0PRFX)gcf.1
        # on some systems, libs being non writable may add to performance
        chmod 755 $INGLIB/lib(PROG0PRFX)gcf.1.$SLSFX
        ls -l $INGLIB/lib(PROG0PRFX)gcf.1.$SLSFX
        echo Cleaning up ....
...
then
    ...
    [ "$config" = "ris_us5" -o "$config" = "rs4_us5" -o \
      "$config" = "ris_u64" -o "$config" = "i64_aix" ] && mkexplist
    rm -f $INGLIB/lib(PROG0PRFX)sxf.1.$SLSFX
    echo $shlink_cmd -o $INGLIB/lib(PROG0PRFX)sxf.1.$SLSFX \*.o $shlink_opts
    case $config in
    dgi_us5 | dg8_us5 | nc4_us5 | sqs_ptx | sos_us5 | pym_us5 | rmx_us5 | \
    rux_us5)
           $shlink_cmd -o $INGLIB/lib(PROG0PRFX)sxf.1.$SLSFX *.o $shlink_opts \
    ...
    usl_us5 )
           ...
           ;;
    dr6_us5)
        $shlink_cmd -o $INGLIB/lib(PROG0PRFX)sxf.1.$SLSFX *.o \
    ...
    *)
    ...
    if [ $? != 0 -o ! -r $INGLIB/lib(PROG0PRFX)sxf.1.$SLSFX ]
    then
        echo $0 Failed,  aborting !!
        exit 4
    else
	  ...
	  && archive_lib lib(PROG0PRFX)sxf.1
        # on some systems, libs being non writable may add to performance
        chmod 755 $INGLIB/lib(PROG0PRFX)sxf.1.$SLSFX
        ls -l $INGLIB/lib(PROG0PRFX)sxf.1.$SLSFX
        echo Cleaning up ....
...
then
    ...
    [ "$config" = "ris_us5" -o "$config" = "rs4_us5" -o \
      "$config" = "ris_u64" -o "$config" = "i64_aix" ] && mkexplist
    rm -f $INGLIB/lib(PROG0PRFX)cuf.1.$SLSFX
    echo $shlink_cmd -o $INGLIB/lib(PROG0PRFX)cuf.1.$SLSFX \*.o $shlink_opts
    case $config in
    dgi_us5 | dg8_us5 | nc4_us5 | sqs_ptx | sos_us5 | pym_us5 | rmx_us5 | \
    rux_us5)
           $shlink_cmd -o $INGLIB/lib(PROG0PRFX)cuf.1.$SLSFX *.o $shlink_opts \
    ...
    usl_us5 )
           ...
           ;;
    dr6_us5)
        $shlink_cmd -o $INGLIB/lib(PROG0PRFX)cuf.1.$SLSFX *.o \
    ...
    *)
    ...
    if [ $? != 0 -o ! -r $INGLIB/lib(PROG0PRFX)cuf.1.$SLSFX ]
    then
        echo $0 Failed,  aborting !!
        exit 4
    else
	  ...
	  && archive_lib lib(PROG0PRFX)cuf.1
        # on some systems, libs being non writable may add to performance
        chmod 755 $INGLIB/lib(PROG0PRFX)cuf.1.$SLSFX
        ls -l $INGLIB/lib(PROG0PRFX)cuf.1.$SLSFX
        echo Cleaning up ....
...
then
    ...
    [ "$config" = "ris_us5" -o "$config" = "rs4_us5" -o \
      "$config" = "ris_u64" -o "$config" = "i64_aix" ] && mkexplist
    rm -f $INGLIB/lib(PROG0PRFX)malloc.1.$SLSFX
    echo $shlink_cmd -o $INGLIB/lib(PROG0PRFX)malloc.1.$SLSFX \*.o $shlink_opts
    case $config in
    dgi_us5 | dg8_us5 | nc4_us5 | sqs_ptx | sos_us5 | pym_us5 | rmx_us5 | \
    rux_us5)
           $shlink_cmd -o $INGLIB/lib(PROG0PRFX)malloc.1.$SLSFX *.o $shlink_opts \
    ...
    usl_us5 )
           ...
           ;;
    dr6_us5)
        $shlink_cmd -o $INGLIB/lib(PROG0PRFX)malloc.1.$SLSFX *.o \
    ...
    *)
    ...
    if [ $? != 0 -o ! -r $INGLIB/lib(PROG0PRFX)malloc.1.$SLSFX ]
    then
        echo $0 Failed,  aborting !!
        exit 4
    else
	  ...
	  && archive_lib lib(PROG0PRFX)malloc.1
        # on some systems, libs being non writable may add to performance
        chmod 755 $INGLIB/lib(PROG0PRFX)malloc.1.$SLSFX
        ls -l $INGLIB/lib(PROG0PRFX)malloc.1.$SLSFX
        echo Cleaning up ....
