...
/*	To select BYTE_SWAP, put an end of comment at the end of this line.

# define 	BYTE_SWAP
				/* for machines whose internal storage
				** of multi-byte ints is the opposite
				** of the vax.  That is the MSB is in
				** the low addr and the LSB is in the
				** hi addr. (Currently these are the
				** 370, 68000, pyramid, and 3b5
				** processors)
				*/
