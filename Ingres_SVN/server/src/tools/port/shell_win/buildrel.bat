...
msiversupdate "%II_CDIMAGE_DIR%\files\documentation\Ingres 2006 Documentation.msi"
if errorlevel 1 goto ERROR3
...
:ERROR
echo A build error occured with ISCmdBld.exe!!!
goto DONE
...
:ERROR3
echo An error occured updating version in one of the mergemodules or MSI projects.
goto DONE
