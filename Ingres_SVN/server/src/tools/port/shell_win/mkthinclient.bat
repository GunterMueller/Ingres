...
echo.
copy  %II_SYSTEM%\ingres\lib\iilibadfdata.dll  %ING_ROOT%\thinclient\ingres\bin   
if ERRORLEVEL 1 goto EXIT
copy  %II_SYSTEM%\ingres\lib\iilibadf.dll  %ING_ROOT%\thinclient\ingres\bin   
if ERRORLEVEL 1 goto EXIT
copy  %II_SYSTEM%\ingres\lib\iilibapi.dll  %ING_ROOT%\thinclient\ingres\bin   
if ERRORLEVEL 1 goto EXIT
copy  %II_SYSTEM%\ingres\lib\iilibcompatdata.dll  %ING_ROOT%\thinclient\ingres\bin   
if ERRORLEVEL 1 goto EXIT
copy  %II_SYSTEM%\ingres\lib\iilibcompat.dll  %ING_ROOT%\thinclient\ingres\bin   
if ERRORLEVEL 1 goto EXIT
copy  %II_SYSTEM%\ingres\lib\iilibcuf.dll  %ING_ROOT%\thinclient\ingres\bin   
if ERRORLEVEL 1 goto EXIT
copy  %II_SYSTEM%\ingres\lib\iilibembeddata.dll  %ING_ROOT%\thinclient\ingres\bin   
if ERRORLEVEL 1 goto EXIT
copy  %II_SYSTEM%\ingres\lib\iilibembed.dll  %ING_ROOT%\thinclient\ingres\bin   
if ERRORLEVEL 1 goto EXIT
copy  %II_SYSTEM%\ingres\lib\iilibqdata.dll  %ING_ROOT%\thinclient\ingres\bin   
if ERRORLEVEL 1 goto EXIT
copy  %II_SYSTEM%\ingres\lib\iilibq.dll  %ING_ROOT%\thinclient\ingres\bin   
if ERRORLEVEL 1 goto EXIT
copy  %II_SYSTEM%\ingres\lib\iilibframedata.dll  %ING_ROOT%\thinclient\ingres\bin   
if ERRORLEVEL 1 goto EXIT
copy  %II_SYSTEM%\ingres\lib\iilibframe.dll  %ING_ROOT%\thinclient\ingres\bin   
if ERRORLEVEL 1 goto EXIT
copy  %II_SYSTEM%\ingres\lib\iilibgcfdata.dll  %ING_ROOT%\thinclient\ingres\bin   
if ERRORLEVEL 1 goto EXIT
copy  %II_SYSTEM%\ingres\lib\iilibgcf.dll  %ING_ROOT%\thinclient\ingres\bin   
if ERRORLEVEL 1 goto EXIT
