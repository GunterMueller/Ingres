...
$ then	CPP="cc /prep=sys$output /noobj /noline /nowarn /stan=common"
$ endif
$!
$ digits="0123456789"
...
$		pipe cat 'bzarch', ING_SRC:[tools.port'noise'.conf]CONFIG. | -
		cat sys$pipe, 'files' | -
		'cpp' /DEF="VERS=''conf'" 'defs' 'undefs' sys$pipe | -
		sed "/^[ 	]*$/d"
$	else
$		pipe cat 'bzarch', ING_SRC:[tools.port'noise'.conf]CONFIG., -
		sys$pipe | 'cpp' /DEF="VERS=''conf'" 'defs' 'undefs' sys$pipe -
		| sed "/^[ 	]*$/d"
$	endif
$ endif
$ exit
