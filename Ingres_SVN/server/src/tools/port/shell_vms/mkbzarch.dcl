...
$ if vers .eqs. "axm_vms"
$ then	write out "# define IEEE_FLOAT"
$!	write out "# define OS_THREADS_USED"
$ else if vers .eqs. "i64_vms"
$ then	
$ endif
$ endif
...
$!
$ pipe byteswap >tmp:readvar-mkbzarch.tmp
$ gosub readvar
$ if "''varvalue'" .eqs. "" then write out "# define BYTE_SWAP"
$!
