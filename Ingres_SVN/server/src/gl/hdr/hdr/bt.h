...
/*
** # define added to take advantage of 32 bit architecture (tutto01)
*/

#if defined(su4_us5) || defined(hp8_us5)
  #define INTSIZE 4 
#endif
...
** Description -
**
**      This MACRO is used on a non byte swapped machine
**      (BYTE_SWAP defined), to obtain an equivalent byte
**      swapped value, which has sequence of bytes from the
**      highers order to the lowest order.
*/
#ifndef BYTE_SWAP
