...
if "%arg%"=="" goto ENDLOOP2
  ...
  if "%arg%"=="-debug" set nodbg_flag=false
  if "%arg%"=="-debu" set nodbg_flag=false
  if "%arg%"=="-deb" set nodbg_flag=false
  if "%arg%"=="-de" set nodbg_flag=false
  if "%arg%"=="-d" set nodbg_flag=false
