...
# define DU_B_RULE_TAB_ID 29
# define DU_I_RULE_TAB_ID 0
# define DU_B_EVENT_TAB_ID 31
...
*/
# define SERVER_VERSION	"II 9.3.0"      /* The SERVER_VERSION constant defines 
...
# define V930_LEVEL 920
# define CURRENT_LEVEL 930
/*
...
{
    char	dbname[DB_MAXNAME+1];	    /* holds a database name */
    char	ddbname[DB_MAXNAME+1];	    /* holds a DDB name */
    char	cdbname[DB_MAXNAME+1];	    /* holds a CDB name */
    char	dba[DB_MAXNAME+1];	    /* dba for database */
    char	locname[DU_LOC_SIZE+4];	    /* Database location name */
    char	areaname[DB_AREA_MAX+4];    /* Database area name */
    char	locdump[DU_LOC_SIZE+4];	    /* Dump location name */
    ...
    bool	did_bootstrap;		    /* Converted "bootstrap" catalogs */
