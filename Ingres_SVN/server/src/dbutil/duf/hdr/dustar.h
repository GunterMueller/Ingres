...
*/
static	struct	DU_dbcapabilities_struct
    {
	char	*cap_capability;
	char	*cap_value;
    }	DU_dbcapabilities[] = {
...
*/
static  struct	DU_dbcaps_value_struct
    {
	i4	ldb_id;
	char	*cap_capability;
	char	*cap_value;
	...
	1,  "DISTRIBUTED",	    "N",	1,
	1,  "INGRES",		    "Y",	1,
	1,  "INGRES/QUEL_LEVEL",    "00930",	930,
	1,  "INGRES/SQL_LEVEL",	    "00930",    930,
	1,  "OWNER_NAME",	    "QUOTED",   2,
	1,  "SAVEPOINTS",	    "Y",	1,
	1,  "UNIQUE_KEY_REQ",	    "N",	1,
	1,  "STANDARD_CATALOG_LEVEL", "00904",	904,
...
static DU_link_object_entry DU_link_object_map[] = {
...
static  DU_index_object_entry  DU_index_object_map[] = {
/* Example:
**	"ii_objects",   "ddx_                              ","ii_objects_index",
*/
	"",		"",				      ""
    }; /* secondary indexes from objects in DU_link_object_map */
static  DU_index_object_entry DU_upg_idx_map[] = {
/* Example:
**	"ii_objects",   "ddx_                              ","ii_objects_index",
*/
	"",		"",				      ""
