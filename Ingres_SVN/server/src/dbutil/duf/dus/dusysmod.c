...
*/
  static char Dus_appl_flag[DU_APPL_FLAG_MAX];
	...
	*/
	if (dus_modes.dus_gw_flag == DU_GW_RMS_FLAG)
	{
	    STpolycat(2, dus_dbenv.du_dbname, DU_RMSTAIL,
			 rms_gw_dbname);
/* # line 412 "dusysmod.qsc" */	/* ingres */
  {
    IIingopen(0,Dus_appl_flag,(char *)"-l",dus_ingwait_flag,effective_dba,
    rms_gw_dbname,(char *)0);
  }
/* # line 414 "dusysmod.qsc" */	/* host code */
	}
	else
	{
...
/* # line 422 "dusysmod.qsc" */	/* ingres */
  {
    IIingopen(0,Dus_appl_flag,(char *)"-l",dus_ingwait_flag,effective_dba,
    dus_dbenv.du_dbname,(char *)0);
  }
/* # line 424 "dusysmod.qsc" */	/* host code */
	}
	dus_dbenv.du_dbopen = TRUE;
/* # line 427 "dusysmod.qsc" */	/* set */
  {
    IIwritio(0,(short *)0,1,32,0,(char *)
"set session isolation level serializable");
    IIsyncup((char *)0,0);
  }
/* # line 429 "dusysmod.qsc" */	/* host code */
...
/* # line 462 "dusysmod.qsc" */	/* exit */
  {
    IIexit();
  }
/* # line 463 "dusysmod.qsc" */	/* host code */
...
/* # line 624 "dusysmod.qsc" */	/* ingres */
    {
      IIingopen(0,DU_DBDBNAME,Dus_appl_flag,(char *)"-Z",(char *)0);
    }
/* # line 625 "dusysmod.qsc" */	/* host code */
	dus_dbenv->du_dbopen    = TRUE;
/* # line 627 "dusysmod.qsc" */	/* set */
    {
      IIwritio(0,(short *)0,1,32,0,(char *)
"set session isolation level serializable");
      IIsyncup((char *)0,0);
    }
/* # line 629 "dusysmod.qsc" */	/* host code */
	/* Get the DBA of the database to be sysmoded and verify that
	** the database exists.
	*/
	found	= FALSE;
/* # line 633 "dusysmod.qsc" */	/* range */
    {
      IIwritio(0,(short *)0,1,32,0,(char *)"range of d=iidatabase");
      IIsyncup((char *)0,0);
    }
/* # line 634 "dusysmod.qsc" */	/* retrieve */
    {
      IIwritio(0,(short *)0,1,32,0,(char *)
"retrieve unique(du_dba=d.own, du_dbservice=d.dbservice)where d.name=");
      IIputdomio((short *)0,1,32,0,dus_dbenv->du_dbname);
      IIretinit((char *)0,0);
      if (IIerrtest() != 0) goto IIrtE1;
IIrtB1:
      while (IInextget() != 0) {
        IIgetdomio((short *)0,1,32,DU_USR_SIZE + 4-1,dus_dbenv->du_dba);
        IIgetdomio((short *)0,1,30,4,&dus_dbenv->du_dbservice);
        if (IIerrtest() != 0) goto IIrtB1;
        {
/* # line 638 "dusysmod.qsc" */	/* host code */
	    found   = TRUE;
        }
      } /* IInextget */
      IIflush((char *)0,0);
...
/* # line 640 "dusysmod.qsc" */	/* host code */
	if (found)
	...
	** name from iistar_cdbs. */
        if ((dus_dbenv->du_dbservice &DU_1SER_DDB) == DU_1SER_DDB)
	{
	    ...
	    found = FALSE;
/* # line 674 "dusysmod.qsc" */	/* range */
    {
      IIwritio(0,(short *)0,1,32,0,(char *)"range of s=iistar_cdbs");
      IIsyncup((char *)0,0);
    }
/* # line 675 "dusysmod.qsc" */	/* retrieve */
    {
      IIwritio(0,(short *)0,1,32,0,(char *)
"retrieve unique(du_dbname=s.cdb_name)where s.ddb_name=");
      IIputdomio((short *)0,1,32,0,dus_dbenv->du_ddbname);
      IIwritio(0,(short *)0,1,32,0,(char *)"and s.ddb_owner=");
      IIputdomio((short *)0,1,32,0,dus_dbenv->du_dba);
      IIretinit((char *)0,0);
      if (IIerrtest() != 0) goto IIrtE2;
IIrtB2:
      while (IInextget() != 0) {
        IIgetdomio((short *)0,1,32,DB_MAXNAME + 4-1,dus_dbenv->du_dbname);
        if (IIerrtest() != 0) goto IIrtB2;
        {
/* # line 679 "dusysmod.qsc" */	/* host code */
		found = TRUE;
        }
      } /* IInextget */
      IIflush((char *)0,0);
...
/* # line 681 "dusysmod.qsc" */	/* host code */
	...
	*/
	found	= FALSE;
/* # line 688 "dusysmod.qsc" */	/* range */
    {
      IIwritio(0,(short *)0,1,32,0,(char *)"range of u=iiuser");
      IIsyncup((char *)0,0);
    }
/* # line 689 "dusysmod.qsc" */	/* retrieve */
    {
      IIwritio(0,(short *)0,1,32,0,(char *)
"retrieve unique(du_usrstat=u.status)where u.name=");
      IIputdomio((short *)0,1,32,0,dus_dbenv->du_usrinit);
      IIretinit((char *)0,0);
      if (IIerrtest() != 0) goto IIrtE3;
IIrtB3:
      while (IInextget() != 0) {
        IIgetdomio((short *)0,1,30,4,&dus_dbenv->du_usrstat);
        if (IIerrtest() != 0) goto IIrtB3;
        {
/* # line 692 "dusysmod.qsc" */	/* host code */
	    found   = TRUE;
        }
      } /* IInextget */
      IIflush((char *)0,0);
...
/* # line 694 "dusysmod.qsc" */	/* host code */
	if (!found)
	    return(du_error(dus_errcb, E_DU3001_USER_NOT_KNOWN, 2,
			    0, dus_dbenv->du_usrinit));
/* # line 698 "dusysmod.qsc" */	/* exit */
    {
      IIexit();
    }
/* # line 699 "dusysmod.qsc" */	/* host code */
	dus_dbenv->du_dbopen	= FALSE;
	return(E_DU_OK);
  }
/*{
...
IIrtB4:
      while (IInextget() != 0) {
        ...
        {
/* # line 785 "dusysmod.qsc" */	/* host code */
		STtrmwhite(cat_name);
...
/* # line 816 "dusysmod.qsc" */	/* host code */
    }
...
*/
/* # line 826 "dusysmod.qsc" */	/* retrieve */
    {
      IIwritio(0,(short *)0,1,32,0,(char *)
...
apabilities\" or iirelation.relid=");
      IIwritio(0,(short *)0,1,32,0,(char *)
"\"iisectype\" or iirelation.relid=\"iiprivlist\" or iirelation.relid=\
\"iigw07_attribute\" or iirelation.relid=\"iigw07_index\" or iirelatio\
n.relid=\"iigw07_relation\")");
      IIretinit((char *)0,0);
...
IIrtB5:
      while (IInextget() != 0) {
        ...
        {
/* # line 842 "dusysmod.qsc" */	/* host code */
...
/* # line 874 "dusysmod.qsc" */	/* host code */
	return(E_DU_OK);
  }
/*{
...
VOID
    ...
    DU_ERROR		*dus_errcb;
  {
    ...
    */
    ...
    {
/* # line 938 "dusysmod.qsc" */	/* exit */
    {
      IIexit();
    }
/* # line 939 "dusysmod.qsc" */	/* host code */
	Dus_dbenv->du_dbopen	= FALSE;
    }
    switch(save_status)
    {
...
/* # line 1076 "dusysmod.qsc" */	/* inquire_equel */
    {
      IIeqiqio((short *)0,1,32,0,err_msg,(char *)"errortext");
    }
/* # line 1077 "dusysmod.qsc" */	/* host code */
	SIprintf("%s\n", err_msg);
...
/* # line 1210 "dusysmod.qsc" */	/* iistatement */
  {
    IIwritio(1,(short *)0,1,32,0,cp);
    IIsyncup((char *)0,0);
  }
/* # line 1211 "dusysmod.qsc" */	/* host code */
		}
...
/* # line 1230 "dusysmod.qsc" */	/* iistatement */
  {
    IIwritio(1,(short *)0,1,32,0,cp);
    IIsyncup((char *)0,0);
  }
/* # line 1231 "dusysmod.qsc" */	/* host code */
		    }
		}
		continue;
	    }
...
dus_validate_pagesize(page_size)
{
  ...
  char dbmsinfo_64k[32];
    ...
    if (page_size == 0)
	return (E_DU_OK);
/* # line 1281 "dusysmod.sc" */	/* select */
  {
    IIsqInit(&sqlca);
    IIsqMods(1);
    IIwritio(0,(short *)0,1,32,0,(char *)
"select dbmsinfo('page_size_2k'), dbmsinfo('page_size_4k'), dbmsinfo('\
page_size_8k'), dbmsinfo('page_size_16k'), dbmsinfo('page_size_32k'), \
dbmsinfo('page_size_64k')");
    IIretinit((char *)0,0);
    if (IInextget() != 0) {
      IIgetdomio((short *)0,1,32,31,dbmsinfo_2k);
      IIgetdomio((short *)0,1,32,31,dbmsinfo_4k);
      IIgetdomio((short *)0,1,32,31,dbmsinfo_8k);
      IIgetdomio((short *)0,1,32,31,dbmsinfo_16k);
      IIgetdomio((short *)0,1,32,31,dbmsinfo_32k);
      IIgetdomio((short *)0,1,32,31,dbmsinfo_64k);
    } /* IInextget */
    IIsqFlush((char *)0,0);
  }
/* # line 1286 "dusysmod.sc" */	/* host code */
    if(sqlca.sqlcode != 0)
    {
	return (E_DU_UERROR);
    }
