...
/* # line 191 "duvestar.sc" */	/* host code */
...
/* # line 203 "duvestar.sc" */	/* host code */
	duve_cb->duve_sessid = sessid;
/* # line 209 "duvestar.sc" */	/* open */
  {
    IIsqInit(&sqlca);
    IIcsOpen((char *)"ldb_cursor",6228,13947);
    IIwritio(0,(short *)0,1,32,0,(char *)
"select ldb_node, ldb_dbms, ldb_database, ldb_id from iiddb_ldbids");
    IIcsQuery((char *)"ldb_cursor",6228,13947);
    if (sqlca.sqlcode < 0) 
      Clean_Up();
  }
/* # line 211 "duvestar.sc" */	/* host code */
	for (;;)
	{
	    set_session(DUVE_MASTER_SESSION,duve_cb);
	    skip_flag = FALSE;	/* assume we will operate on this LDB */
/* # line 215 "duvestar.sc" */	/* fetch */
  {
    IIsqInit(&sqlca);
    if (IIcsRetScroll((char *)"ldb_cursor",6228,13947,-1,-1) != 0) {
      IIcsGetio((short *)0,1,32,DB_MAXNAME+1-1,node_name);
      IIcsGetio((short *)0,1,32,DB_MAXNAME+1-1,svr_type);
      IIcsGetio((short *)0,1,32,DB_MAXNAME+1-1,ldb_name);
      IIcsGetio((short *)0,1,30,4,&ldb_id);
      IIcsERetrieve();
    } /* IIcsRetrieve */
    if (sqlca.sqlcode < 0) 
      Clean_Up();
  }
/* # line 217 "duvestar.sc" */	/* host code */
	    if (sqlca.sqlcode == DU_SQL_NONE)
	    {
/* # line 219 "duvestar.sc" */	/* close */
  {
    IIsqInit(&sqlca);
    IIcsClose((char *)"ldb_cursor",6228,13947);
    if (sqlca.sqlcode < 0) 
      Clean_Up();
  }
/* # line 220 "duvestar.sc" */	/* host code */
		break;
	    }
	    else if (sqlca.sqlcode < DU_SQL_OK)
		Clean_Up();
	    set_session(DUVE_SLAVE_SESSION,duve_cb);
/* # line 227 "duvestar.sc" */	/* select */
  {
    IIsqInit(&sqlca);
    IIsqMods(1);
    IIwritio(0,(short *)0,1,32,0,(char *)
"select cap_value from iiddb_ldb_dbcaps where ldb_id=");
    IIputdomio((short *)0,1,30,4,&ldb_id);
    IIwritio(0,(short *)0,1,32,0,(char *)
"and cap_capability='DB_NAME_CASE'");
    IIretinit((char *)0,0);
    if (IInextget() != 0) {
      IIgetdomio((short *)0,1,32,DB_MAXNAME+1-1,name_case);
    } /* IInextget */
    IIsqFlush((char *)0,0);
    if (sqlca.sqlcode < 0) 
      Clean_Up();
  }
/* # line 229 "duvestar.sc" */	/* host code */
	    CVlower(name_case);
	    upper_flag = (MEcmp(name_case,"upper",5) == DU_IDENTICAL);
/* # line 232 "duvestar.sc" */	/* commit */
  {
    IIsqInit(&sqlca);
    IIxact(3);
    if (sqlca.sqlcode < 0) 
...
/* # line 234 "duvestar.sc" */	/* direct connect */
  {
    IIsqInit(&sqlca);
    IIwritio(0,(short *)0,1,32,0,(char *)"direct connect with node=");
    IIvarstrio((short *)0,1,32,0,node_name);
    IIwritio(0,(short *)0,1,32,0,(char *)", database=");
    IIvarstrio((short *)0,1,32,0,ldb_name);
    IIwritio(0,(short *)0,1,32,0,(char *)", dbms=");
    IIvarstrio((short *)0,1,32,0,svr_type);
    IIsyncup((char *)0,0);
  }
/* # line 238 "duvestar.sc" */	/* host code */
...
/* # line 260 "duvestar.sc" */	/* direct disconnect */
  {
    IIsqInit(&sqlca);
    IIwritio(0,(short *)0,1,32,0,(char *)"direct disconnect");
    IIsyncup((char *)0,0);
  }
/* # line 262 "duvestar.sc" */	/* host code */
	    /*
...
/* # line 350 "duvestar.sc" */	/* host code */
	STzapblank(capability, cap_capability);
	if (upper_flag)
	{
/* # line 354 "duvestar.sc" */	/* select */
  {
    IIsqInit(&sqlca);
    IIsqMods(1);
    IIwritio(0,(short *)0,1,32,0,(char *)
"select CAP_VALUE from IIDBCAPABILITIES where CAP_CAPABILITY=");
    IIputdomio((short *)0,1,32,0,cap_capability);
    IIretinit((char *)0,0);
    if (IInextget() != 0) {
      IIgetdomio((short *)0,1,32,DB_MAXNAME+1-1,cap_value);
    } /* IInextget */
    IIsqFlush((char *)0,0);
  }
/* # line 357 "duvestar.sc" */	/* host code */
	}
	else
	{
/* # line 360 "duvestar.sc" */	/* select */
  {
    IIsqInit(&sqlca);
    IIsqMods(1);
    IIwritio(0,(short *)0,1,32,0,(char *)
...
/* # line 363 "duvestar.sc" */	/* host code */
	}
	if (sqlca.sqlcode < 0)
	{
...
{
  i4 sessid;
/* # line 422 "duvestar.sc" */	/* host code */
    if (duve_cb->duve_sessid == sess_id)
	return;
    sessid = sess_id;
/* # line 426 "duvestar.sc" */	/* set_sql */
  {
    IILQssSetSqlio(11,(short *)0,1,30,4,&sessid);
  }
/* # line 427 "duvestar.sc" */	/* host code */
...
char		*value;
{
  char cap_capability[DB_MAXNAME+1];
  char cap_value[DB_MAXNAME+1];
  char new_value[DB_MAXNAME+1];
  i4 ldb_id;
  i4 cap_level;
/* # line 481 "duvestar.sc" */	/* host code */
    do
    {	/* control loop */
	ldb_id = ldb;
...
/* # line 513 "duvestar.sc" */	/* select */
  {
    IIsqInit(&sqlca);
    IIsqMods(1);
    IIwritio(0,(short *)0,1,32,0,(char *)
"select cap_value from iiddb_ldb_dbcaps where cap_capability=");
    IIputdomio((short *)0,1,32,0,cap_capability);
    IIwritio(0,(short *)0,1,32,0,(char *)"and ldb_id=");
    IIputdomio((short *)0,1,30,4,&ldb_id);
    IIretinit((char *)0,0);
    if (IInextget() != 0) {
      IIgetdomio((short *)0,1,32,DB_MAXNAME+1-1,cap_value);
...
/* # line 515 "duvestar.sc" */	/* host code */
	if (sqlca.sqlcode == DU_SQL_NONE)
	{
	    /* this capability was not listed in iidbcapabilities, so
	    ** add it now */
	    ...
	    if (duve_talk(DUVE_ASK, duve_cb, S_DU0430_INSERT_CAP, 2,
	       ...
	       == DUVE_YES)
	    {
/* # line 526 "duvestar.sc" */	/* insert */
  {
    IIsqInit(&sqlca);
    IIwritio(0,(short *)0,1,32,0,(char *)
"insert into iiddb_ldb_dbcaps(ldb_id, cap_capability, cap_value, cap_l\
evel)values(");
    IIputdomio((short *)0,1,30,4,&ldb_id);
    IIwritio(0,(short *)0,1,32,0,(char *)", ");
    IIputdomio((short *)0,1,32,0,cap_capability);
    IIwritio(0,(short *)0,1,32,0,(char *)", ");
    IIputdomio((short *)0,1,32,0,new_value);
    IIwritio(0,(short *)0,1,32,0,(char *)", ");
    IIputdomio((short *)0,1,30,4,&cap_level);
    IIwritio(0,(short *)0,1,32,0,(char *)")");
    IIsyncup((char *)0,0);
    if (sqlca.sqlcode < 0) 
      Clean_Up();
  }
/* # line 529 "duvestar.sc" */	/* host code */
	...
	else
	{
		...
		if (duve_talk(DUVE_ASK, duve_cb, S_DU0432_UPDATE_CAP, 2,
		   ...
		   == DUVE_YES)
		{
/* # line 547 "duvestar.sc" */	/* update */
  {
    IIsqInit(&sqlca);
    IIwritio(0,(short *)0,1,32,0,(char *)
"update iiddb_ldb_dbcaps set cap_value=");
    IIputdomio((short *)0,1,32,0,new_value);
...
/* # line 550 "duvestar.sc" */	/* host code */
