    ...
    */
	...
	if (duve_cb->duveint->integrities[ctr].du_dcons == DUVE_DROP)
 	   ...
 	   /*
           ** drop constraint.
           */
/* # line 588 "duvechk.sc" */	/* commit */
  {
    IIsqInit(&sqlca);
    IIxact(3);
  }
/* # line 590 "duvechk.sc" */	/* host code */
           statement_buffer = STpolycat(4, "set session authorization ", "\"",
                        owner, "\"", buf);
/* # line 592 "duvechk.sc" */	/* execute */
  {
    IIsqInit(&sqlca);
    IIsqExImmed(statement_buffer);
    IIsyncup((char *)0,0);
  }
/* # line 594 "duvechk.sc" */	/* host code */
           statement_buffer = STpolycat(7, "alter table ", name,
               " drop constraint ", "\"", cons, "\"", " cascade", buf);
/* # line 596 "duvechk.sc" */	/* execute */
  {
    IIsqInit(&sqlca);
    IIsqExImmed(statement_buffer);
    IIsyncup((char *)0,0);
  }
/* # line 597 "duvechk.sc" */	/* host code */
	}
	if (duve_cb->duveint->integrities[ctr].du_acons == DUVE_ADD)
	{
           ...
           ** add constraint
           */
/* # line 609 "duvechk.sc" */	/* commit */
  {
    IIsqInit(&sqlca);
    IIxact(3);
  }
/* # line 611 "duvechk.sc" */	/* host code */
           statement_buffer = STpolycat(4, "set session authorization ", "\"",
                        owner, "\"", buf);
/* # line 613 "duvechk.sc" */	/* execute */
  {
    IIsqInit(&sqlca);
    IIsqExImmed(statement_buffer);
    IIsyncup((char *)0,0);
  }
/* # line 614 "duvechk.sc" */	/* host code */
	   statement_buffer = STpolycat(4, "alter table ",
                       name, " add ", text, buf);
/* # line 616 "duvechk.sc" */	/* execute */
  {
    IIsqInit(&sqlca);
    IIsqExImmed(statement_buffer);
    IIsyncup((char *)0,0);
  }
/* # line 617 "duvechk.sc" */	/* host code */
	}
...
/* # line 626 "duvechk.sc" */	/* commit */
  {
    IIsqInit(&sqlca);
    IIxact(3);
  }
/* # line 628 "duvechk.sc" */	/* host code */
           statement_buffer = STpolycat(4, "set session authorization ", "\"",
                       rowner, "\"", buf);
/* # line 630 "duvechk.sc" */	/* execute */
  {
    IIsqInit(&sqlca);
    IIsqExImmed(statement_buffer);
    IIsyncup((char *)0,0);
  }
/* # line 632 "duvechk.sc" */	/* host code */
           statement_buffer = STpolycat(4, "alter table ",
                        rname, " add ", rtext, buf);
/* # line 634 "duvechk.sc" */	/* execute */
  {
    IIsqInit(&sqlca);
    IIsqExImmed(statement_buffer);
    IIsyncup((char *)0,0);
  }
/* # line 635 "duvechk.sc" */	/* host code */
        }
    }
    MEfree( (PTR) duve_cb->duveint);
    duve_cb->duveint = NULL;
/* # line 642 "duvechk.sc" */	/* commit */
  {
    IIsqInit(&sqlca);
    IIxact(3);
  }
/* # line 643 "duvechk.sc" */	/* set */
  {
    IIsqInit(&sqlca);
...
/* # line 725 "duvechk.sc" */	/* host code */
	...
	if (abort_flag)
	{
/* # line 817 "duvechk.sc" */	/* rollback */
  {
    IIsqInit(&sqlca);
    IIxact(2);
  }
/* # line 818 "duvechk.sc" */	/* host code */
	}
	else
	{
/* # line 821 "duvechk.sc" */	/* commit */
  {
    IIsqInit(&sqlca);
    IIxact(3);
  }
/* # line 822 "duvechk.sc" */	/* host code */
	}
/* # line 823 "duvechk.sc" */	/* disconnect */
  {
    IIsqInit(&sqlca);
    IIsqDisconnect();
  }
/* # line 824 "duvechk.sc" */	/* host code */
...
"select dbservice from iidatabase where name=");
    ...
    IIputdomio((short *)0,1,32,0,dbown);
    IIretinit((char *)0,0);
    if (IInextget() != 0) {
...
/* # line 904 "duvechk.sc" */	/* host code */
    access |= DU_FORCED_CONST;
/* # line 905 "duvechk.sc" */	/* update */
  {
    IIsqInit(&sqlca);
    IIwritio(0,(short *)0,1,32,0,(char *)"update iidatabase set dbserv\
ice=");
    IIputdomio((short *)0,1,30,4,&access);
...
/* # line 959 "duvechk.sc" */	/* host code */
    STcopy(database, dbname);
    STcopy(user,username);
/* # line 962 "duvechk.sc" */	/* connect */
  {
    IIsqInit(&sqlca);
    IIsqUser(username);
...
/* # line 1105 "duvechk.sc" */	/* host code */
    STcopy(database, dbname);
...
/* # line 1118 "duvechk.sc" */	/* connect */
  {
    IIsqInit(&sqlca);
    IIsqUser((char *)"$ingres");
    IIsqConnect(0,dbname,duve_appl_flag,(char *)"-l",(char *)0, (char *)0, 
    (char *)0, (char *)0, (char *)0, (char *)0, (char *)0, (char *)0, 
    (char *)0, (char *)0, (char *)0);
    if (sqlca.sqlcode < 0) 
      goto SQLerr;
  }
/* # line 1120 "duvechk.sc" */	/* host code */
	IIlq_Protect(TRUE);
	break;
      case DUVE_FORCED:
      	CVla((i4)DBA_NORMAL_VFDB, tmp_buf);
	(VOID)STpolycat(2, "-A",tmp_buf, duve_appl_flag);
/* # line 1125 "duvechk.sc" */	/* connect */
  {
    IIsqInit(&sqlca);
    IIsqUser((char *)"$ingres");
    IIsqConnect(0,dbname,duve_appl_flag,(char *)0, (char *)0, (char *)0, 
    (char *)0, (char *)0, (char *)0, (char *)0, (char *)0, (char *)0, 
    (char *)0, (char *)0, (char *)0);
    if (sqlca.sqlcode < 0) 
      goto SQLerr;
  }
/* # line 1127 "duvechk.sc" */	/* host code */
	IIlq_Protect(TRUE);
	break;
      case DUVE_DROPTBL:
	CVla((i4)DBA_NORMAL_VFDB, tmp_buf);
	(VOID)STpolycat(2, "-A",tmp_buf, duve_appl_flag);
/* # line 1132 "duvechk.sc" */	/* connect */
  {
    IIsqInit(&sqlca);
    IIsqUser((char *)"$ingres");
    IIsqConnect(0,dbname,duve_appl_flag,(char *)"-l",(char *)0, (char *)0, 
...
/* # line 1134 "duvechk.sc" */	/* host code */
	IIlq_Protect(TRUE);
	break;
      case DUVE_CATALOGS:
	CVla((i4)DBA_PRETEND_VFDB, tmp_buf);
	(VOID)STpolycat(2, "-A",tmp_buf, duve_appl_flag);
/* # line 1139 "duvechk.sc" */	/* connect */
  {
    IIsqInit(&sqlca);
    IIsqUser((char *)"$ingres");
    IIsqConnect(0,dbname,duve_appl_flag,(char *)"-l",(char *)0, (char *)0, 
...
/* # line 1141 "duvechk.sc" */	/* host code */
	IIlq_Protect(TRUE);
	break;
      case DUVE_TABLE:
      case DUVE_XTABLE:
...
/* # line 1149 "duvechk.sc" */	/* host code */
	IIlq_Protect(TRUE);
	break;
      case DUVE_EXPIRED:  /* expired purge */
	CVla((i4)DBA_PURGE_VFDB, tmp_buf);
	(VOID)STpolycat(2, "-A",tmp_buf, duve_appl_flag);
/* # line 1154 "duvechk.sc" */	/* connect */
  {
    IIsqInit(&sqlca);
    IIsqUser((char *)"$ingres");
    IIsqConnect(0,dbname,duve_appl_flag,(char *)0, (char *)0, (char *)0, 
...
/* # line 1156 "duvechk.sc" */	/* host code */
	IIlq_Protect(TRUE);
	break;
...
/* # line 1165 "duvechk.sc" */	/* host code */
	IIlq_Protect(TRUE);
	break;
      default:
...
/* # line 1176 "duvechk.sc" */	/* host code */
	IIlq_Protect(TRUE);
	break;
    } /* endcase */
    duve_cb->duverel = NULL;
...
/* # line 1192 "duvechk.sc" */	/* host code */
    return ( (DU_STATUS) DUVE_YES);
SQLerr:
...
char		*droptable;
{
  ...
  u_i4 tid, tidx;
/* # line 1277 "duvechk.sc" */	/* host code */
...
/* # line 1291 "duvechk.sc" */	/* select */
  {
    IIsqInit(&sqlca);
    IIsqMods(1);
    IIwritio(0,(short *)0,1,32,0,(char *)
"select reltid, reltidx from iirelation where relid=");
    IIputdomio((short *)0,1,32,0,tblname);
    IIwritio(0,(short *)0,1,32,0,(char *)"and relowner=");
    IIputdomio((short *)0,1,32,0,own);
    IIretinit((char *)0,0);
    if (IInextget() != 0) {
...
/* # line 1293 "duvechk.sc" */	/* host code */
...
/* # line 1309 "duvechk.sc" */	/* host code */
...
/* # line 1405 "duvechk.sc" */	/* open */
  {
    IIsqInit(&sqlca);
    IIcsOpen((char *)"att_cursor",6238,183);
    IIwritio(0,(short *)0,1,32,0,(char *)
"select * from iiattribute order by attrelid, attrelidx");
    IIcsQuery((char *)"att_cursor",6238,183);
  }
/* # line 1406 "duvechk.sc" */	/* host code */
    if (sqlca.sqlcode < DU_SQL_OK)
	...
	*/
/* # line 1419 "duvechk.sc" */	/* fetch */
  {
    IIsqInit(&sqlca);
    if (IIcsRetScroll((char *)"att_cursor",6238,183,-1,-1) != 0) {
      IIcsGetio((short *)0,1,30,4,&(att_tbl).attrelid);
      IIcsGetio((short *)0,1,30,4,&(att_tbl).attrelidx);
      IIcsGetio((short *)0,1,30,2,&(att_tbl).attid);
      IIcsGetio((short *)0,1,30,2,&(att_tbl).attxtra);
      IIcsGetio((short *)0,1,32,32,(att_tbl).attname);
      IIcsGetio((short *)0,1,30,4,&(att_tbl).attoff);
      IIcsGetio((short *)0,1,30,4,&(att_tbl).attfrml);
      IIcsGetio((short *)0,1,30,2,&(att_tbl).attkdom);
      IIcsGetio((short *)0,1,30,2,&(att_tbl).attflag);
      IIcsGetio((short *)0,1,30,4,&(att_tbl).attdefid1);
      IIcsGetio((short *)0,1,30,4,&(att_tbl).attdefid2);
      IIcsGetio((short *)0,1,30,2,&(att_tbl).attintl_id);
      IIcsGetio((short *)0,1,30,2,&(att_tbl).attver_added);
      IIcsGetio((short *)0,1,30,2,&(att_tbl).attver_dropped);
      IIcsGetio((short *)0,1,30,2,&(att_tbl).attval_from);
      IIcsGetio((short *)0,1,30,2,&(att_tbl).attfrmt);
      IIcsGetio((short *)0,1,30,2,&(att_tbl).attfrmp);
      IIcsGetio((short *)0,1,30,2,&(att_tbl).attver_altcol);
      IIcsGetio((short *)0,1,30,2,&(att_tbl).attcollid);
      IIcsGetio((short *)0,1,32,16,(att_tbl).attfree);
      IIcsERetrieve();
    } /* IIcsRetrieve */
  }
/* # line 1420 "duvechk.sc" */	/* host code */
	if (sqlca.sqlcode == DU_SQL_NONE)
	{	
/* # line 1422 "duvechk.sc" */	/* close */
  {
    IIsqInit(&sqlca);
    IIcsClose((char *)"att_cursor",6238,183);
  }
/* # line 1423 "duvechk.sc" */	/* host code */
	    break;
        }
	...
	*/
	...
	{
		/* delete this tuple */
/* # line 1468 "duvechk.sc" */	/* delete */
  {
    IIsqInit(&sqlca);
    IIwritio(0,(short *)0,1,32,0,(char *)
"delete from iiattribute where attrelid=");
    IIputdomio((short *)0,1,30,4,&att_tbl.attrelid);
    IIwritio(0,(short *)0,1,32,0,(char *)"and attrelidx=");
    IIputdomio((short *)0,1,30,4,&att_tbl.attrelidx);
    IIsyncup((char *)0,0);
  }
/* # line 1471 "duvechk.sc" */	/* host code */
		if (sqlca.sqlcode == DU_SQL_OK)
	...
	switch(att_tbl.attdefid1)
        {
	      ...
	      case DB_DEF_ID_UNRECOGNIZED:		
                   ...
                   */
                   break;
              default:
/* # line 1552 "duvechk.sc" */	/* repeated select */
  {
    IIsexec();
    while (IInexec() == 0) {
      IIsqInit(&sqlca);
      IIexExec(1,(char *)"duvechk1",6239,16572);
      IIputdomio((short *)0,1,30,4,&att_tbl.attdefid1);
      IIputdomio((short *)0,1,30,4,&att_tbl.attdefid2);
      IIretinit((char *)0,0);
      if (IInexec() == 0) {
        IIsqInit(&sqlca);
        IIsqMods(1);
        IIexDefine(1,(char *)"duvechk1",6239,16572);
        IIwritio(0,(short *)0,1,32,0,(char *)
"select any(defid1)from iidefault where defid1=");
        IIwritio(0,(short *)0,1,32,0,(char *)" $0=");
        IIputdomio((short *)0,1,30,4,&att_tbl.attdefid1);
        IIwritio(0,(short *)0,1,32,0,(char *)"and defid2=");
        IIwritio(0,(short *)0,1,32,0,(char *)" $1=");
        IIputdomio((short *)0,1,30,4,&att_tbl.attdefid2);
        IIexDefine(0,(char *)"duvechk1",6239,16572);
        if (IIerrtest() == 0) {
          IIsexec();
        } /* IIerrtest */
      } /* IInexec */
...
/* # line 1556 "duvechk.sc" */	/* host code */
	   	if (agg == 0)
...
# include <duvedev.h>
    /* set up to gather performance statistics */
    init_stats(duve_cb, (i4) DUVE_TEST_PERF);    
/* # line 1655 "duvechk.sc" */	/* open */
  {
    IIsqInit(&sqlca);
    IIcsOpen((char *)"dev_cursor",6240,18106);
    IIwritio(0,(short *)0,1,32,0,(char *)"select * from iidevices");
    IIcsQuery((char *)"dev_cursor",6240,18106);
  }
/* # line 1656 "duvechk.sc" */	/* host code */
    if (sqlca.sqlcode < DU_SQL_OK)
	Clean_Up();	/* Clean_Up will exit with error */
    for ( ;; )
    {
	...
	*/
/* # line 1666 "duvechk.sc" */	/* fetch */
  {
    IIsqInit(&sqlca);
    if (IIcsRetScroll((char *)"dev_cursor",6240,18106,-1,-1) != 0) {
      IIcsGetio((short *)0,1,30,4,&(dev_tbl).devrelid);
      IIcsGetio((short *)0,1,30,4,&(dev_tbl).devrelidx);
      IIcsGetio((short *)0,1,30,4,&(dev_tbl).devrelocid);
      IIcsGetio((short *)0,1,32,32,(dev_tbl).devloc);
      IIcsERetrieve();
    } /* IIcsRetrieve */
  }
/* # line 1667 "duvechk.sc" */	/* host code */
	if (sqlca.sqlcode == DU_SQL_NONE)
	{	
/* # line 1669 "duvechk.sc" */	/* close */
  {
    IIsqInit(&sqlca);
    IIcsClose((char *)"dev_cursor",6240,18106);
  }
/* # line 1670 "duvechk.sc" */	/* host code */
	    break;
        }
	else if (sqlca.sqlcode < DU_SQL_OK)
	    Clean_Up();
	...
	*/
	...
	{    
		...
		return ( (DU_STATUS) DUVE_BAD);
	     ...
	     {
		/* delete this tuple */
/* # line 1699 "duvechk.sc" */	/* delete */
  {
    IIsqInit(&sqlca);
    IIcsDelete((char *)"iidevices",(char *)"dev_cursor",6240,18106);
  }
/* # line 1700 "duvechk.sc" */	/* host code */
		if (sqlca.sqlcode == DU_SQL_OK)
	...
	*/
	...
	STcopy(dev_tbl.devloc, (char *) &dev_loc);
	if ( duve_locfind( &dev_loc, duve_cb) == DU_INVALID)
	{
		...
		return ( (DU_STATUS) DUVE_BAD);
	     duve_talk( DUVE_MODESENS, duve_cb, S_DU1620_INVALID_LOC, 6,
		  0, dev_loc.db_loc_name, 0, duve_cb->duverel->rel[base].du_tab,
		  0, duve_cb->duverel->rel[base].du_own);
	}
...
# include <duveindex.h>
  ...
  i4 stat;
    /* set up to gather performance statistics */
    init_stats(duve_cb, (i4) DUVE_TEST_PERF);    
/* # line 1883 "duvechk.sc" */	/* open */
  {
    IIsqInit(&sqlca);
    IIcsOpen((char *)"index_cursor",6241,6391);
    IIwritio(0,(short *)0,1,32,0,(char *)"select * from iiindex");
    IIcsQuery((char *)"index_cursor",6241,6391);
  }
/* # line 1884 "duvechk.sc" */	/* host code */
    if (sqlca.sqlcode < DU_SQL_OK)
	Clean_Up();	/* Clean_Up will exit with error */
    for ( ;; )
    {
	...
	*/
/* # line 1894 "duvechk.sc" */	/* fetch */
  {
    IIsqInit(&sqlca);
    if (IIcsRetScroll((char *)"index_cursor",6241,6391,-1,-1) != 0) {
      IIcsGetio((short *)0,1,30,4,&(index_tbl).baseid);
      IIcsGetio((short *)0,1,30,4,&(index_tbl).indexid);
      IIcsGetio((short *)0,1,30,2,&(index_tbl).sequence);
      IIcsGetio((short *)0,1,30,2,&(index_tbl).idom1);
      IIcsGetio((short *)0,1,30,2,&(index_tbl).idom2);
      IIcsGetio((short *)0,1,30,2,&(index_tbl).idom3);
      IIcsGetio((short *)0,1,30,2,&(index_tbl).idom4);
      IIcsGetio((short *)0,1,30,2,&(index_tbl).idom5);
      IIcsGetio((short *)0,1,30,2,&(index_tbl).idom6);
      IIcsGetio((short *)0,1,30,2,&(index_tbl).idom7);
      IIcsGetio((short *)0,1,30,2,&(index_tbl).idom8);
      IIcsGetio((short *)0,1,30,2,&(index_tbl).idom9);
      IIcsGetio((short *)0,1,30,2,&(index_tbl).idom10);
      IIcsGetio((short *)0,1,30,2,&(index_tbl).idom11);
      IIcsGetio((short *)0,1,30,2,&(index_tbl).idom12);
      IIcsGetio((short *)0,1,30,2,&(index_tbl).idom13);
      IIcsGetio((short *)0,1,30,2,&(index_tbl).idom14);
      IIcsGetio((short *)0,1,30,2,&(index_tbl).idom15);
      IIcsGetio((short *)0,1,30,2,&(index_tbl).idom16);
      IIcsGetio((short *)0,1,30,2,&(index_tbl).idom17);
      IIcsGetio((short *)0,1,30,2,&(index_tbl).idom18);
      IIcsGetio((short *)0,1,30,2,&(index_tbl).idom19);
      IIcsGetio((short *)0,1,30,2,&(index_tbl).idom20);
      IIcsGetio((short *)0,1,30,2,&(index_tbl).idom21);
      IIcsGetio((short *)0,1,30,2,&(index_tbl).idom22);
      IIcsGetio((short *)0,1,30,2,&(index_tbl).idom23);
      IIcsGetio((short *)0,1,30,2,&(index_tbl).idom24);
      IIcsGetio((short *)0,1,30,2,&(index_tbl).idom25);
      IIcsGetio((short *)0,1,30,2,&(index_tbl).idom26);
      IIcsGetio((short *)0,1,30,2,&(index_tbl).idom27);
      IIcsGetio((short *)0,1,30,2,&(index_tbl).idom28);
      IIcsGetio((short *)0,1,30,2,&(index_tbl).idom29);
      IIcsGetio((short *)0,1,30,2,&(index_tbl).idom30);
      IIcsGetio((short *)0,1,30,2,&(index_tbl).idom31);
      IIcsGetio((short *)0,1,30,2,&(index_tbl).idom32);
      IIcsERetrieve();
    } /* IIcsRetrieve */
  }
/* # line 1895 "duvechk.sc" */	/* host code */
	if (sqlca.sqlcode == DU_SQL_NONE)
	{	
/* # line 1897 "duvechk.sc" */	/* close */
  {
    IIsqInit(&sqlca);
    IIcsClose((char *)"index_cursor",6241,6391);
  }
/* # line 1898 "duvechk.sc" */	/* host code */
	    break;
        }
	else if (sqlca.sqlcode < DU_SQL_OK)
	    Clean_Up();
	...
	{    
		...
		return ( (DU_STATUS) DUVE_BAD);
	     ...
	     {
		/* delete this tuple */
/* # line 1926 "duvechk.sc" */	/* delete */
  {
    IIsqInit(&sqlca);
    IIcsDelete((char *)"iiindex",(char *)"index_cursor",6241,6391);
  }
/* # line 1927 "duvechk.sc" */	/* host code */
		if (sqlca.sqlcode == DU_SQL_OK)
...
/* # line 1958 "duvechk.sc" */	/* host code */
		    if (sqlca.sqlcode == DU_SQL_OK)
...
# include <duverel.h>
  i4 cnt;
    /* set up to gather performance statistics */
    init_stats(duve_cb, (i4) DUVE_TEST_PERF);    
/* # line 2203 "duvechk.sc" */	/* open */
  {
    IIsqInit(&sqlca);
    IIcsOpen((char *)"rel_cursor",6242,29594);
    IIwritio(0,(short *)0,1,32,0,(char *)
"select * from iirelation order by reltid, reltidx");
    IIcsQuery((char *)"rel_cursor",6242,29594);
  }
/* # line 2204 "duvechk.sc" */	/* host code */
    if (sqlca.sqlcode < DU_SQL_OK)
	Clean_Up();	/* Clean_Up will exit with error */
    /*
    ** determine number of tuples and allocate memory for duverel
    */
/* # line 2210 "duvechk.sc" */	/* select */
  {
    IIsqInit(&sqlca);
    IIsqMods(1);
    IIwritio(0,(short *)0,1,32,0,(char *)
"select count(reltid)from iirelation");
    IIretinit((char *)0,0);
    if (IInextget() != 0) {
...
/* # line 2211 "duvechk.sc" */	/* host code */
    if (sqlca.sqlcode < DU_SQL_OK)
	Clean_Up();	/* Clean_Up will exit with error */
    ...
    duve_cb->duverel = 
	(DUVE_RELINFO *) MEreqmem( (u_i4)0, size, TRUE, &mem_stat);
...
/* # line 2242 "duvechk.sc" */	/* fetch */
  {
    IIsqInit(&sqlca);
    if (IIcsRetScroll((char *)"rel_cursor",6242,29594,-1,-1) != 0) {
      IIcsGetio((short *)0,1,30,4,&(rel_tbl).reltid);
      IIcsGetio((short *)0,1,30,4,&(rel_tbl).reltidx);
      IIcsGetio((short *)0,1,32,32,(rel_tbl).relid);
      IIcsGetio((short *)0,1,32,32,(rel_tbl).relowner);
      IIcsGetio((short *)0,1,30,2,&(rel_tbl).relatts);
      IIcsGetio((short *)0,1,30,2,&(rel_tbl).reltcpri);
      IIcsGetio((short *)0,1,30,2,&(rel_tbl).relkeys);
      IIcsGetio((short *)0,1,30,2,&(rel_tbl).relspec);
      IIcsGetio((short *)0,1,30,4,&(rel_tbl).relstat);
      IIcsGetio((short *)0,1,30,4,&(rel_tbl).reltups);
      IIcsGetio((short *)0,1,30,4,&(rel_tbl).relpages);
      IIcsGetio((short *)0,1,30,4,&(rel_tbl).relprim);
      IIcsGetio((short *)0,1,30,4,&(rel_tbl).relmain);
      IIcsGetio((short *)0,1,30,4,&(rel_tbl).relsave);
      IIcsGetio((short *)0,1,30,4,&(rel_tbl).relstamp1);
      IIcsGetio((short *)0,1,30,4,&(rel_tbl).relstamp2);
      IIcsGetio((short *)0,1,32,32,(rel_tbl).relloc);
      IIcsGetio((short *)0,1,32,4,(rel_tbl).relcmptlvl);
      IIcsGetio((short *)0,1,30,4,&(rel_tbl).relcreate);
      IIcsGetio((short *)0,1,30,4,&(rel_tbl).relqid1);
      IIcsGetio((short *)0,1,30,4,&(rel_tbl).relqid2);
      IIcsGetio((short *)0,1,30,4,&(rel_tbl).relmoddate);
      IIcsGetio((short *)0,1,30,2,&(rel_tbl).relidxcount);
      IIcsGetio((short *)0,1,30,2,&(rel_tbl).relifill);
      IIcsGetio((short *)0,1,30,2,&(rel_tbl).reldfill);
      IIcsGetio((short *)0,1,30,2,&(rel_tbl).rellfill);
      IIcsGetio((short *)0,1,30,4,&(rel_tbl).relmin);
      IIcsGetio((short *)0,1,30,4,&(rel_tbl).relmax);
      IIcsGetio((short *)0,1,30,4,&(rel_tbl).relpgsize);
      IIcsGetio((short *)0,1,30,2,&(rel_tbl).relgwid);
      IIcsGetio((short *)0,1,30,2,&(rel_tbl).relgwother);
      IIcsGetio((short *)0,1,30,4,&(rel_tbl).relhigh_logkey);
      IIcsGetio((short *)0,1,30,4,&(rel_tbl).rellow_logkey);
      IIcsGetio((short *)0,1,30,4,&(rel_tbl).relfhdr);
      IIcsGetio((short *)0,1,30,4,&(rel_tbl).relallocation);
      IIcsGetio((short *)0,1,30,4,&(rel_tbl).relextend);
      IIcsGetio((short *)0,1,30,2,&(rel_tbl).relcomptype);
      IIcsGetio((short *)0,1,30,2,&(rel_tbl).relpgtype);
      IIcsGetio((short *)0,1,30,4,&(rel_tbl).relstat2);
      IIcsGetio((short *)0,1,32,8,(rel_tbl).relfree1);
      IIcsGetio((short *)0,1,30,2,&(rel_tbl).relloccount);
      IIcsGetio((short *)0,1,30,2,&(rel_tbl).relversion);
      IIcsGetio((short *)0,1,30,4,&(rel_tbl).relwid);
      IIcsGetio((short *)0,1,30,4,&(rel_tbl).reltotwid);
      IIcsGetio((short *)0,1,30,2,&(rel_tbl).relnparts);
      IIcsGetio((short *)0,1,30,2,&(rel_tbl).relnpartlevels);
      IIcsGetio((short *)0,1,32,8,(rel_tbl).relfree);
      IIcsERetrieve();
    } /* IIcsRetrieve */
  }
/* # line 2243 "duvechk.sc" */	/* host code */
	if (sqlca.sqlcode == DU_SQL_NONE) 
	    goto Close_Cursor;
	else if (sqlca.sqlcode < DU_SQL_OK)
	    Clean_Up();
	...
	MEcopy( (PTR)rel_tbl.relcmptlvl, sizeof(iirelation.relcmptlvl),
		(PTR)&iirelation.relcmptlvl);
...
Close_Cursor:
/* # line 2392 "duvechk.sc" */	/* close */
  {
    IIsqInit(&sqlca);
    IIcsClose((char *)"rel_cursor",6242,29594);
  }
/* # line 2394 "duvechk.sc" */	/* host code */
    /* report performance statistics */
...
# include <duveridx.h>
  char *name, *own;
    /* set up to gather performance statistics */
    init_stats(duve_cb, (i4) DUVE_TEST_PERF);    
/* # line 2460 "duvechk.sc" */	/* host code */
...
/* # line 2472 "duvechk.sc" */	/* open */
  {
    IIsqInit(&sqlca);
    IIcsOpen((char *)"ridx_cursor",6243,18354);
    IIwritio(0,(short *)0,1,32,0,(char *)"select * from iirel_idx");
    IIwritio(0,(short *)0,1,32,0,(char *)" for readonly ");
    IIcsQuery((char *)"ridx_cursor",6243,18354);
  }
/* # line 2473 "duvechk.sc" */	/* host code */
    if (sqlca.sqlcode < DU_SQL_OK)
	Clean_Up();	/* Clean_Up will exit with error */
    for ( ;; )
    {
	...
	*/
/* # line 2483 "duvechk.sc" */	/* fetch */
  {
    IIsqInit(&sqlca);
    if (IIcsRetScroll((char *)"ridx_cursor",6243,18354,-1,-1) != 0) {
      IIcsGetio((short *)0,1,32,32,(ridx_tbl).relid);
      IIcsGetio((short *)0,1,32,32,(ridx_tbl).relowner);
      IIcsGetio((short *)0,1,30,4,&(ridx_tbl).tidp);
      IIcsERetrieve();
    } /* IIcsRetrieve */
  }
/* # line 2484 "duvechk.sc" */	/* host code */
	if (sqlca.sqlcode == DU_SQL_NONE)
	{	
/* # line 2486 "duvechk.sc" */	/* close */
  {
    IIsqInit(&sqlca);
    IIcsClose((char *)"ridx_cursor",6243,18354);
  }
/* # line 2487 "duvechk.sc" */	/* host code */
	    break;
        }
	else if (sqlca.sqlcode < DU_SQL_OK)
	    Clean_Up();
...
/* # line 2512 "duvechk.sc" */	/* delete */
  {
    IIsqInit(&sqlca);
    IIwritio(0,(short *)0,1,32,0,(char *)
"delete from iirel_idx where relid=");
    IIputdomio((short *)0,1,32,0,name);
    IIwritio(0,(short *)0,1,32,0,(char *)"and relowner=");
    IIputdomio((short *)0,1,32,0,own);
    IIsyncup((char *)0,0);
  }
/* # line 2514 "duvechk.sc" */	/* host code */
		if (sqlca.sqlcode == DU_SQL_OK)
...
Clean_Up()
{
  ...
  i4 errnum;
/* # line 2580 "duvechk.sc" */	/* inquire_ingres */
  {
    IILQisInqSqlio((short *)0,1,30,4,&errnum,2);
  }
/* # line 2582 "duvechk.sc" */	/* inquire_ingres */
  {
    IILQisInqSqlio((short *)0,1,32,ER_MAX_LEN-1,errmsg,63);
  }
/* # line 2583 "duvechk.sc" */	/* host code */
...
fixrelstat()
{
  ...
  i4 numstat;
  u_i4 tid, tidx;
/* # line 2650 "duvechk.sc" */	/* open */
  {
    IIsqInit(&sqlca);
    IIcsOpen((char *)"r_cursor",6244,8180);
    IIwritio(0,(short *)0,1,32,0,(char *)
"select relstat, reltid, reltidx from iirelation for DEFERRED update o\
f relstat");
    IIcsQuery((char *)"r_cursor",6244,8180);
  }
/* # line 2651 "duvechk.sc" */	/* host code */
    if (sqlca.sqlcode < DU_SQL_OK)
	Clean_Up();	/* Clean_Up will exit with error */
    for ( ;; )
    {
	...
	*/
/* # line 2659 "duvechk.sc" */	/* fetch */
  {
    IIsqInit(&sqlca);
    if (IIcsRetScroll((char *)"r_cursor",6244,8180,-1,-1) != 0) {
      IIcsGetio((short *)0,1,30,4,&status);
      IIcsGetio((short *)0,1,30,4,&tid);
      IIcsGetio((short *)0,1,30,4,&tidx);
      IIcsERetrieve();
    } /* IIcsRetrieve */
  }
/* # line 2660 "duvechk.sc" */	/* host code */
	if (sqlca.sqlcode == DU_SQL_NONE)
	{	
/* # line 2662 "duvechk.sc" */	/* close */
  {
    IIsqInit(&sqlca);
    IIcsClose((char *)"r_cursor",6244,8180);
  }
/* # line 2663 "duvechk.sc" */	/* host code */
	    break;
        }
	else if (sqlca.sqlcode < DU_SQL_OK)
	    Clean_Up();
...
/* # line 2673 "duvechk.sc" */	/* repeated select */
  {
    IIsexec();
    while (IInexec() == 0) {
      IIsqInit(&sqlca);
      IIexExec(1,(char *)"duvechk2",6245,22197);
      IIputdomio((short *)0,1,30,4,&tid);
      IIputdomio((short *)0,1,30,4,&tidx);
      IIretinit((char *)0,0);
      if (IInexec() == 0) {
        IIsqInit(&sqlca);
        IIsqMods(1);
        IIexDefine(1,(char *)"duvechk2",6245,22197);
        IIwritio(0,(short *)0,1,32,0,(char *)
"select any(stabbase)from iistatistics where stabbase=");
        IIwritio(0,(short *)0,1,32,0,(char *)" $0=");
        IIputdomio((short *)0,1,30,4,&tid);
        IIwritio(0,(short *)0,1,32,0,(char *)"and stabindex=");
        IIwritio(0,(short *)0,1,32,0,(char *)" $1=");
        IIputdomio((short *)0,1,30,4,&tidx);
        IIexDefine(0,(char *)"duvechk2",6245,22197);
        if (IIerrtest() == 0) {
          IIsexec();
        } /* IIerrtest */
      } /* IInexec */
    ...
    if (IInextget() != 0) {
      IIgetdomio((short *)0,1,30,4,&numstat);
    } /* IInextget */
    IIsqFlush((char *)0,0);
  }
/* # line 2677 "duvechk.sc" */	/* host code */
	    if (numstat)
	        continue;
	    ...
	    */
	    status &= ~TCB_ZOPTSTAT;
/* # line 2684 "duvechk.sc" */	/* update */
  {
    IIsqInit(&sqlca);
    IIwritio(0,(short *)0,1,32,0,(char *)"update iirelation set relsta\
t=");
    IIputdomio((short *)0,1,30,4,&status);
    IIcsERplace((char *)"r_cursor",6244,8180);
  }
/* # line 2686 "duvechk.sc" */	/* host code */
...
u_i4		    indexid;
{
  ...
  i2 idxcnt;
    i4	base;
    DB_TAB_ID	tableid;
/* # line 2744 "duvechk.sc" */	/* host code */
    if (indexid == 0)
...
/* # line 2772 "duvechk.sc" */	/* update */
  {
    IIsqInit(&sqlca);
    IIwritio(0,(short *)0,1,32,0,(char *)"update iirelation set relsta\
t=");
    IIputdomio((short *)0,1,30,4,&relstat);
    IIwritio(0,(short *)0,1,32,0,(char *)", relidxcount=");
    IIputdomio((short *)0,1,30,2,&idxcnt);
    IIwritio(0,(short *)0,1,32,0,(char *)"where reltid=");
    IIputdomio((short *)0,1,30,4,&tid);
...
/* # line 2775 "duvechk.sc" */	/* host code */
    return;
}
/*{
...
DMP_RELATION	iirelation;
{
/* # line 2837 "duvechk.sc" */	/* host code */
...
DMP_RELATION	iirelation ;
{
  ...
  i2 null_agg =0;
  u_i4 tid, tidx;
/* # line 2969 "duvechk.sc" */	/* host code */
    tid = iirelation.reltid.db_tab_base;
    tidx = iirelation.reltid.db_tab_index;
/* # line 2972 "duvechk.sc" */	/* repeated select */
  {
    IIsexec();
    while (IInexec() == 0) {
      IIsqInit(&sqlca);
      IIexExec(1,(char *)"duvechk3",6246,19635);
      IIputdomio((short *)0,1,30,4,&tid);
      IIputdomio((short *)0,1,30,4,&tidx);
      IIretinit((char *)0,0);
      if (IInexec() == 0) {
        IIsqInit(&sqlca);
        IIsqMods(1);
        IIexDefine(1,(char *)"duvechk3",6246,19635);
        IIwritio(0,(short *)0,1,32,0,(char *)
"select max(attid)from iiattribute where attrelid=");
        IIwritio(0,(short *)0,1,32,0,(char *)" $0=");
        IIputdomio((short *)0,1,30,4,&tid);
        IIwritio(0,(short *)0,1,32,0,(char *)"and attrelidx=");
        IIwritio(0,(short *)0,1,32,0,(char *)" $1=");
        IIputdomio((short *)0,1,30,4,&tidx);
        IIexDefine(0,(char *)"duvechk3",6246,19635);
        if (IIerrtest() == 0) {
          IIsexec();
        } /* IIerrtest */
      } /* IInexec */
    ...
    if (IInextget() != 0) {
      IIgetdomio(&null_agg,1,30,2,&attid);
    } /* IInextget */
    IIsqFlush((char *)0,0);
    if (sqlca.sqlcode < 0) 
      Clean_Up();
  }
/* # line 2975 "duvechk.sc" */	/* host code */
    do		/* error control */
    {	
	/* 
	...
	*/
	...
	ctr = 0;
/* # line 3016 "duvechk.sc" */	/* repeated select */
  {
    IIsexec();
    while (IInexec() == 0) {
      IIsqInit(&sqlca);
      IIexExec(1,(char *)"duvechk4",6247,18162);
      IIputdomio((short *)0,1,30,4,&tid);
      IIputdomio((short *)0,1,30,4,&tidx);
      IIretinit((char *)0,0);
      if (IInexec() == 0) {
        IIsqInit(&sqlca);
        IIexDefine(1,(char *)"duvechk4",6247,18162);
        IIwritio(0,(short *)0,1,32,0,(char *)
"select attid, attver_dropped from iiattribute where attrelid=");
        IIwritio(0,(short *)0,1,32,0,(char *)" $0=");
        IIputdomio((short *)0,1,30,4,&tid);
        IIwritio(0,(short *)0,1,32,0,(char *)"and attrelidx=");
        IIwritio(0,(short *)0,1,32,0,(char *)" $1=");
        IIputdomio((short *)0,1,30,4,&tidx);
        IIwritio(0,(short *)0,1,32,0,(char *)"order by attid");
        IIexDefine(0,(char *)"duvechk4",6247,18162);
        if (IIerrtest() == 0) {
          IIsexec();
        } /* IIerrtest */
      } /* IInexec */
...
IIrtB1:
    while (IInextget() != 0) {
      IIgetdomio((short *)0,1,30,2,&attid);
      IIgetdomio((short *)0,1,30,2,&attver_dropped);
      if (IIerrtest() != 0) goto IIrtB1;
/* # line 3020 "duvechk.sc" */	/* host code */
	    if (attver_dropped)
		continue;
	    ctr++;
	    if (sqlca.sqlcode < DU_SQL_OK)
		...
		{
		    drop_me = TRUE;
/* # line 3039 "duvechk.sc" */	/* endselect */
      {
        IIbreak();
        if (1) goto IIrtE1;
        if (sqlca.sqlcode < 0) 
...
/* # line 3040 "duvechk.sc" */	/* host code */
		} /* endif */
		ctr = attid;
	    } /* endif */
	    else if (attid > ctr)
		...
		{
		    drop_me = TRUE;
/* # line 3057 "duvechk.sc" */	/* endselect */
      {
        IIbreak();
        if (1) goto IIrtE1;
        if (sqlca.sqlcode < 0) 
...
/* # line 3058 "duvechk.sc" */	/* host code */
		} /* endif */
		ctr = attid;
	    } /* endif */
    } /* IInextget */
...
/* # line 3080 "duvechk.sc" */	/* repeated select */
  {
    IIsexec();
    while (IInexec() == 0) {
      IIsqInit(&sqlca);
      IIexExec(1,(char *)"duvechk5",6248,13488);
      IIputdomio((short *)0,1,30,4,&tid);
      IIputdomio((short *)0,1,30,4,&tidx);
      IIretinit((char *)0,0);
      if (IInexec() == 0) {
        IIsqInit(&sqlca);
        IIsqMods(1);
        IIexDefine(1,(char *)"duvechk5",6248,13488);
        IIwritio(0,(short *)0,1,32,0,(char *)
"select sum(attfrml)from iiattribute where attrelid=");
        IIwritio(0,(short *)0,1,32,0,(char *)" $0=");
        IIputdomio((short *)0,1,30,4,&tid);
        IIwritio(0,(short *)0,1,32,0,(char *)"and attrelidx=");
        IIwritio(0,(short *)0,1,32,0,(char *)" $1=");
        IIputdomio((short *)0,1,30,4,&tidx);
        IIexDefine(0,(char *)"duvechk5",6248,13488);
        if (IIerrtest() == 0) {
          IIsexec();
        } /* IIerrtest */
      } /* IInexec */
    ...
    if (IInextget() != 0) {
      IIgetdomio(&null_agg,1,30,4,&agg);
    } /* IInextget */
    IIsqFlush((char *)0,0);
    if (sqlca.sqlcode < 0) 
      Clean_Up();
  }
/* # line 3084 "duvechk.sc" */	/* host code */
...
/* # line 3108 "duvechk.sc" */	/* host code */
...
DMP_RELATION	iirelation ;
{
  i4 agg;
  u_i4 tid, tidx;
/* # line 3171 "duvechk.sc" */	/* host code */
	tid  = iirelation.reltid.db_tab_base;
	tidx = iirelation.reltid.db_tab_index;
	/* test 3 - verify # columns in the key is correct */
/* # line 3175 "duvechk.sc" */	/* repeated select */
  {
    IIsexec();
    while (IInexec() == 0) {
      IIsqInit(&sqlca);
      IIexExec(1,(char *)"duvechk6",6249,20979);
      IIputdomio((short *)0,1,30,4,&tid);
      IIputdomio((short *)0,1,30,4,&tidx);
      IIretinit((char *)0,0);
      if (IInexec() == 0) {
        IIsqInit(&sqlca);
        IIsqMods(1);
        IIexDefine(1,(char *)"duvechk6",6249,20979);
        IIwritio(0,(short *)0,1,32,0,(char *)
"select count(attkdom)from iiattribute where attrelid=");
        IIwritio(0,(short *)0,1,32,0,(char *)" $0=");
        IIputdomio((short *)0,1,30,4,&tid);
        IIwritio(0,(short *)0,1,32,0,(char *)"and attrelidx=");
        IIwritio(0,(short *)0,1,32,0,(char *)" $1=");
        IIputdomio((short *)0,1,30,4,&tidx);
        IIwritio(0,(short *)0,1,32,0,(char *)"and attkdom!=0");
        IIexDefine(0,(char *)"duvechk6",6249,20979);
        if (IIerrtest() == 0) {
          IIsexec();
        } /* IIerrtest */
      } /* IInexec */
...
/* # line 3177 "duvechk.sc" */	/* host code */
	if (agg != iirelation.relkeys)
	{
		...
		== DUVE_YES)
	    {
/* # line 3195 "duvechk.sc" */	/* update */
  {
    IIsqInit(&sqlca);
    IIwritio(0,(short *)0,1,32,0,(char *)"update iirelation set relkey\
s=");
    IIputdomio((short *)0,1,30,4,&agg);
    IIwritio(0,(short *)0,1,32,0,(char *)"where reltid=");
    IIputdomio((short *)0,1,30,4,&tid);
...
/* # line 3197 "duvechk.sc" */	/* host code */
...
DMP_RELATION	iirelation ;
{
  i2 relspec;
  u_i4 tid, tidx;
/* # line 3263 "duvechk.sc" */	/* host code */
	tid  = iirelation.reltid.db_tab_base;
	tidx = iirelation.reltid.db_tab_index;
	     ...
	     (iirelation.relspec != TCB_BTREE) )
	{
			  ...
			  sizeof( iirelation.relspec), &iirelation.relspec);
		{
		    ...
		    {
			 relspec = TCB_HASH;
/* # line 3287 "duvechk.sc" */	/* update */
  {
    IIsqInit(&sqlca);
    IIwritio(0,(short *)0,1,32,0,(char *)"update iirelation set relspe\
c=");
    IIputdomio((short *)0,1,30,2,&relspec);
    IIwritio(0,(short *)0,1,32,0,(char *)"where reltid=");
    IIputdomio((short *)0,1,30,4,&tid);
    IIwritio(0,(short *)0,1,32,0,(char *)"and reltidx=");
    IIputdomio((short *)0,1,30,4,&tidx);
...
/* # line 3289 "duvechk.sc" */	/* host code */
			 duve_talk(DUVE_MODESENS, duve_cb, 
...
DMP_RELATION	iirelation;
{
  i4 relstat;
  u_i4 tid, tidx;
/* # line 3374 "duvechk.sc" */	/* host code */
	tid  = iirelation.reltid.db_tab_base;
	tidx = iirelation.reltid.db_tab_index;
...
/* # line 3403 "duvechk.sc" */	/* host code */
...
DMP_RELATION	iirelation;
{
  i4 relstat;
  u_i4 tid, tidx;
/* # line 3470 "duvechk.sc" */	/* host code */
    tid  = iirelation.reltid.db_tab_base;
    tidx = iirelation.reltid.db_tab_index;
...
/* # line 3496 "duvechk.sc" */	/* host code */
...
DMP_RELATION	iirelation;
{
  ...
  u_i4 tid, tidx;
  i4 agg;
/* # line 3548 "duvechk.sc" */	/* host code */
    tid  = iirelation.reltid.db_tab_base;
    tidx = iirelation.reltid.db_tab_index;
    if (iirelation.reltid.db_tab_index &&
	(iirelation.relstat2 & TCB2_PARTITION) == 0)
    {
/* # line 3554 "duvechk.sc" */	/* repeated select */
  {
    IIsexec();
    while (IInexec() == 0) {
      IIsqInit(&sqlca);
      IIexExec(1,(char *)"duvechk7",6250,30606);
      IIputdomio((short *)0,1,30,4,&tid);
      IIputdomio((short *)0,1,30,4,&tidx);
      IIretinit((char *)0,0);
      if (IInexec() == 0) {
        IIsqInit(&sqlca);
        IIsqMods(1);
        IIexDefine(1,(char *)"duvechk7",6250,30606);
        IIwritio(0,(short *)0,1,32,0,(char *)
"select any(baseid)from iiindex where baseid=");
        IIwritio(0,(short *)0,1,32,0,(char *)" $0=");
        IIputdomio((short *)0,1,30,4,&tid);
        IIwritio(0,(short *)0,1,32,0,(char *)"and indexid=");
        IIwritio(0,(short *)0,1,32,0,(char *)" $1=");
        IIputdomio((short *)0,1,30,4,&tidx);
        IIexDefine(0,(char *)"duvechk7",6250,30606);
        if (IIerrtest() == 0) {
          IIsexec();
        } /* IIerrtest */
      } /* IInexec */
...
/* # line 3556 "duvechk.sc" */	/* host code */
	if (agg==0)
	{
...
DMP_RELATION	iirelation;
{
  ...
  i4 agg;
  u_i4 tid, tidx;
/* # line 3639 "duvechk.sc" */	/* host code */
    tid  = iirelation.reltid.db_tab_base;
    tidx = iirelation.reltid.db_tab_index;
    ...
    {
/* # line 3646 "duvechk.sc" */	/* repeated select */
  {
    IIsexec();
    while (IInexec() == 0) {
      IIsqInit(&sqlca);
      IIexExec(1,(char *)"duvechk8",6251,29610);
      IIputdomio((short *)0,1,30,4,&tid);
      IIputdomio((short *)0,1,30,4,&tidx);
      IIretinit((char *)0,0);
      if (IInexec() == 0) {
        IIsqInit(&sqlca);
        IIsqMods(1);
        IIexDefine(1,(char *)"duvechk8",6251,29610);
        IIwritio(0,(short *)0,1,32,0,(char *)
"select any(protabbase)from iiprotect where protabbase=");
        ...
        IIwritio(0,(short *)0,1,32,0,(char *)" $1=");
        IIputdomio((short *)0,1,30,4,&tidx);
        IIexDefine(0,(char *)"duvechk8",6251,29610);
        if (IIerrtest() == 0) {
          IIsexec();
        } /* IIerrtest */
      } /* IInexec */
...
/* # line 3648 "duvechk.sc" */	/* host code */
	if (agg==0)
	{
...
/* # line 3666 "duvechk.sc" */	/* host code */
...
DMP_RELATION	iirelation;
{
  ...
  i4 agg;
  u_i4 tid, tidx;
/* # line 3730 "duvechk.sc" */	/* host code */
    tid  = iirelation.reltid.db_tab_base;
    tidx = iirelation.reltid.db_tab_index;
    ...
    {
/* # line 3738 "duvechk.sc" */	/* repeated select */
  {
    IIsexec();
    while (IInexec() == 0) {
      IIsqInit(&sqlca);
      IIexExec(1,(char *)"duvechk9",6252,3983);
      IIputdomio((short *)0,1,30,4,&tid);
      IIputdomio((short *)0,1,30,4,&tidx);
      IIretinit((char *)0,0);
      if (IInexec() == 0) {
        IIsqInit(&sqlca);
        IIsqMods(1);
        IIexDefine(1,(char *)"duvechk9",6252,3983);
        IIwritio(0,(short *)0,1,32,0,(char *)
"select any(inttabbase)from iiintegrity where inttabbase=");
        IIwritio(0,(short *)0,1,32,0,(char *)" $0=");
        IIputdomio((short *)0,1,30,4,&tid);
        IIwritio(0,(short *)0,1,32,0,(char *)"and inttabidx=");
        IIwritio(0,(short *)0,1,32,0,(char *)" $1=");
        IIputdomio((short *)0,1,30,4,&tidx);
        IIexDefine(0,(char *)"duvechk9",6252,3983);
        if (IIerrtest() == 0) {
          IIsexec();
        } /* IIerrtest */
      } /* IInexec */
...
/* # line 3740 "duvechk.sc" */	/* host code */
	if ( agg == 0) 
	{
...
/* # line 3758 "duvechk.sc" */	/* host code */
...
DMP_RELATION	iirelation;
{
  i4 relstat;
  u_i4 tid, tidx;
/* # line 3818 "duvechk.sc" */	/* host code */
...
/* # line 3852 "duvechk.sc" */	/* host code */
...
DMP_RELATION	iirelation;
{
  i4 relstat;
  u_i4 tid, tidx;
/* # line 3912 "duvechk.sc" */	/* host code */
    if ( (STncasecmp ("iirelation", iirelation.relid.db_tab_name,10)
         ==DU_IDENTICAL) ||
	 (STncasecmp ("iirel_idx", iirelation.relid.db_tab_name,9)
	 ==DU_IDENTICAL) ||
...
/* # line 3947 "duvechk.sc" */	/* host code */
...
DMP_RELATION	iirelation;
{
  ...
  i4 agg, mode;
  u_i4 tid, tidx;
/* # line 4016 "duvechk.sc" */	/* host code */
	...
	tidx = iirelation.reltid.db_tab_index;
	mode = DB_VIEW;
/* # line 4025 "duvechk.sc" */	/* repeated select */
  {
    IIsexec();
    while (IInexec() == 0) {
      IIsqInit(&sqlca);
      IIexExec(1,(char *)"duvechk10",6253,12490);
      IIputdomio((short *)0,1,30,4,&tid);
      IIputdomio((short *)0,1,30,4,&tidx);
      IIputdomio((short *)0,1,30,4,&mode);
      IIretinit((char *)0,0);
      if (IInexec() == 0) {
        IIsqInit(&sqlca);
        IIsqMods(1);
        IIexDefine(1,(char *)"duvechk10",6253,12490);
        IIwritio(0,(short *)0,1,32,0,(char *)
"select any(treetabbase)from iitree where treetabbase=");
        ...
        IIputdomio((short *)0,1,30,4,&mode);
        IIexDefine(0,(char *)"duvechk10",6253,12490);
        if (IIerrtest() == 0) {
          IIsexec();
        } /* IIerrtest */
      } /* IInexec */
...
/* # line 4029 "duvechk.sc" */	/* host code */
...
DMP_RELATION	iirelation;
{
  i4 agg, mode;
  u_i4 tid, tidx;
/* # line 4123 "duvechk.sc" */	/* host code */
    /* dont do this test unless this tuple describes a view */
    if ( iirelation.relstat & TCB_VIEW )
    {
	mode = DB_VIEW;
	tid  = iirelation.reltid.db_tab_base;
	tidx = iirelation.reltid.db_tab_index;
/* # line 4131 "duvechk.sc" */	/* repeated select */
  {
    IIsexec();
    while (IInexec() == 0) {
      IIsqInit(&sqlca);
      IIexExec(1,(char *)"duvechk11",6254,5355);
      IIputdomio((short *)0,1,30,4,&tid);
      IIputdomio((short *)0,1,30,4,&tidx);
      IIputdomio((short *)0,1,30,4,&mode);
      IIretinit((char *)0,0);
      if (IInexec() == 0) {
        IIsqInit(&sqlca);
        IIsqMods(1);
        IIexDefine(1,(char *)"duvechk11",6254,5355);
        IIwritio(0,(short *)0,1,32,0,(char *)
"select any(inid1)from iidbdepends where deid1=");
        IIwritio(0,(short *)0,1,32,0,(char *)" $0=");
        IIputdomio((short *)0,1,30,4,&tid);
        IIwritio(0,(short *)0,1,32,0,(char *)"and deid2=");
        IIwritio(0,(short *)0,1,32,0,(char *)" $1=");
        ...
        IIwritio(0,(short *)0,1,32,0,(char *)" $2=");
        IIputdomio((short *)0,1,30,4,&mode);
        IIexDefine(0,(char *)"duvechk11",6254,5355);
        if (IIerrtest() == 0) {
          IIsexec();
        } /* IIerrtest */
      } /* IInexec */
...
/* # line 4134 "duvechk.sc" */	/* host code */
	...
	*/
/* # line 4142 "duvechk.sc" */	/* repeated select */
  {
    IIsexec();
    while (IInexec() == 0) {
      IIsqInit(&sqlca);
      IIexExec(1,(char *)"duvechk12",6255,4746);
      IIputdomio((short *)0,1,30,4,&tid);
      IIputdomio((short *)0,1,30,4,&tidx);
      IIputdomio((short *)0,1,30,4,&mode);
      IIretinit((char *)0,0);
      if (IInexec() == 0) {
        IIsqInit(&sqlca);
        IIsqMods(1);
        IIexDefine(1,(char *)"duvechk12",6255,4746);
        IIwritio(0,(short *)0,1,32,0,(char *)
"select any(d_obj_id)from iipriv where d_obj_id=");
        IIwritio(0,(short *)0,1,32,0,(char *)" $0=");
        IIputdomio((short *)0,1,30,4,&tid);
        IIwritio(0,(short *)0,1,32,0,(char *)"and d_obj_idx=");
        IIwritio(0,(short *)0,1,32,0,(char *)" $1=");
        IIputdomio((short *)0,1,30,4,&tidx);
        IIwritio(0,(short *)0,1,32,0,(char *)"and d_obj_type=");
        IIwritio(0,(short *)0,1,32,0,(char *)" $2=");
        IIputdomio((short *)0,1,30,4,&mode);
        IIexDefine(0,(char *)"duvechk12",6255,4746);
        if (IIerrtest() == 0) {
          IIsexec();
        } /* IIerrtest */
      } /* IInexec */
...
/* # line 4145 "duvechk.sc" */	/* host code */
	/*
...
DMP_RELATION	iirelation;
{
  i4 agg, mode;
  i4 qid1, qid2;
/* # line 4244 "duvechk.sc" */	/* host code */
    /* dont do this test unless this tuple describes a view */
    if ( iirelation.relstat & TCB_VIEW )
    {
	...
	mode = DB_VIEW;
/* # line 4252 "duvechk.sc" */	/* repeated select */
  {
    IIsexec();
    while (IInexec() == 0) {
      IIsqInit(&sqlca);
      IIexExec(1,(char *)"duvechk13",6256,5800);
      IIputdomio((short *)0,1,30,4,&qid1);
      IIputdomio((short *)0,1,30,4,&qid2);
      IIputdomio((short *)0,1,30,4,&mode);
      IIretinit((char *)0,0);
      if (IInexec() == 0) {
        IIsqInit(&sqlca);
        IIsqMods(1);
        IIexDefine(1,(char *)"duvechk13",6256,5800);
        IIwritio(0,(short *)0,1,32,0,(char *)
"select any(txtid1)from iiqrytext where txtid1=");
        ...
        IIwritio(0,(short *)0,1,32,0,(char *)" $2=");
        IIputdomio((short *)0,1,30,4,&mode);
        IIexDefine(0,(char *)"duvechk13",6256,5800);
        if (IIerrtest() == 0) {
          IIsexec();
        } /* IIerrtest */
      } /* IInexec */
...
/* # line 4255 "duvechk.sc" */	/* host code */
...
DMP_RELATION	iirelation;
{
  ...
  u_i4 tid, tidx;
  i4 relstat;
/* # line 4354 "duvechk.sc" */	/* host code */
...
/* # line 4406 "duvechk.sc" */	/* host code */
	...
	*/
	tid  = iirelation.reltid.db_tab_base;
	tidx = iirelation.reltid.db_tab_index;
/* # line 4418 "duvechk.sc" */	/* repeated select */
  {
    IIsexec();
    while (IInexec() == 0) {
      IIsqInit(&sqlca);
      IIexExec(1,(char *)"duvechk14",6257,649);
      IIputdomio((short *)0,1,30,4,&tid);
      IIputdomio((short *)0,1,30,4,&tidx);
      IIretinit((char *)0,0);
      if (IInexec() == 0) {
        IIsqInit(&sqlca);
        IIsqMods(1);
        IIexDefine(1,(char *)"duvechk14",6257,649);
        IIwritio(0,(short *)0,1,32,0,(char *)
"select any(baseid)from iiindex where baseid=");
        IIwritio(0,(short *)0,1,32,0,(char *)" $0=");
        IIputdomio((short *)0,1,30,4,&tid);
        ...
        IIwritio(0,(short *)0,1,32,0,(char *)" $1=");
        IIputdomio((short *)0,1,30,4,&tidx);
        IIexDefine(0,(char *)"duvechk14",6257,649);
        if (IIerrtest() == 0) {
          IIsexec();
        } /* IIerrtest */
      } /* IInexec */
...
/* # line 4420 "duvechk.sc" */	/* host code */
	if (agg==0)
	{
...
/* # line 4479 "duvechk.sc" */	/* host code */
		    if (sqlca.sqlcode == DU_SQL_OK)
...
DMP_RELATION	iirelation;
{
  ...
  u_i4 tid, tidx;
  i4 relstat;
/* # line 4554 "duvechk.sc" */	/* host code */
    /* dont do this test unless this tuple describes a base for an index */
    if ( iirelation.relstat & TCB_IDXD )
    {
	tid  = iirelation.reltid.db_tab_base;
	tidx = iirelation.reltid.db_tab_index;
/* # line 4561 "duvechk.sc" */	/* repeated select */
  {
    IIsexec();
    while (IInexec() == 0) {
      IIsqInit(&sqlca);
      IIexExec(1,(char *)"duvechk15",6258,3206);
      IIputdomio((short *)0,1,30,4,&tid);
      IIretinit((char *)0,0);
      if (IInexec() == 0) {
        IIsqInit(&sqlca);
        IIsqMods(1);
        IIexDefine(1,(char *)"duvechk15",6258,3206);
        IIwritio(0,(short *)0,1,32,0,(char *)
"select count(baseid)from iiindex where baseid=");
        IIwritio(0,(short *)0,1,32,0,(char *)" $0=");
        IIputdomio((short *)0,1,30,4,&tid);
        IIexDefine(0,(char *)"duvechk15",6258,3206);
        if (IIerrtest() == 0) {
          IIsexec();
        } /* IIerrtest */
      } /* IInexec */
...
/* # line 4564 "duvechk.sc" */	/* host code */
...
/* # line 4588 "duvechk.sc" */	/* host code */
	...
	else /* there are none */
	{
		...
		duve_cb->duverel->rel[duve_cb->duve_cnt].du_stat = relstat;
	        iirelation.relstat = relstat;
/* # line 4607 "duvechk.sc" */	/* update */
  {
    IIsqInit(&sqlca);
    IIwritio(0,(short *)0,1,32,0,(char *)"update iirelation set relsta\
t=");
    IIputdomio((short *)0,1,30,4,&relstat);
    IIwritio(0,(short *)0,1,32,0,(char *)", relidxcount=0 where reltid\
=");
    IIputdomio((short *)0,1,30,4,&tid);
    IIwritio(0,(short *)0,1,32,0,(char *)"and reltidx=");
    IIputdomio((short *)0,1,30,4,&tidx);
...
/* # line 4609 "duvechk.sc" */	/* host code */
...
DMP_RELATION	iirelation;
{
  ...
  i4 agg;
  u_i4 tid, tidx;
/* # line 4672 "duvechk.sc" */	/* host code */
    /* dont do this test unless this tuple indicate statistics exist */
    if ( iirelation.relstat & TCB_ZOPTSTAT )
    {
	tid  = iirelation.reltid.db_tab_base;
	tidx = iirelation.reltid.db_tab_index;
/* # line 4679 "duvechk.sc" */	/* repeated select */
  {
    IIsexec();
    while (IInexec() == 0) {
      IIsqInit(&sqlca);
      IIexExec(1,(char *)"duvechk16",6259,7593);
      IIputdomio((short *)0,1,30,4,&tid);
      IIputdomio((short *)0,1,30,4,&tidx);
      IIretinit((char *)0,0);
      if (IInexec() == 0) {
        IIsqInit(&sqlca);
        IIsqMods(1);
        IIexDefine(1,(char *)"duvechk16",6259,7593);
        IIwritio(0,(short *)0,1,32,0,(char *)
"select any(stabbase)from iistatistics where stabbase=");
        IIwritio(0,(short *)0,1,32,0,(char *)" $0=");
        IIputdomio((short *)0,1,30,4,&tid);
        ...
        IIwritio(0,(short *)0,1,32,0,(char *)" $1=");
        IIputdomio((short *)0,1,30,4,&tidx);
        IIexDefine(0,(char *)"duvechk16",6259,7593);
        if (IIerrtest() == 0) {
          IIsexec();
        } /* IIerrtest */
      } /* IInexec */
...
/* # line 4682 "duvechk.sc" */	/* host code */
...
/* # line 4703 "duvechk.sc" */	/* host code */
...
DMP_RELATION	iirelation;
{
  ...
  u_i4 tid, tidx;
  i4 relstat;
/* # line 4791 "duvechk.sc" */	/* host code */
    if ( (iirelation.relstat & TCB_MULTIPLE_LOC) && 
	((iirelation.relstat & TCB_GATEWAY) ==0) )
    {
	tid  = iirelation.reltid.db_tab_base;
	tidx = iirelation.reltid.db_tab_index;
/* # line 4797 "duvechk.sc" */	/* repeated select */
  {
    IIsexec();
    while (IInexec() == 0) {
      IIsqInit(&sqlca);
      IIexExec(1,(char *)"duvechk17",6260,10886);
      IIputdomio((short *)0,1,30,4,&tid);
      IIputdomio((short *)0,1,30,4,&tidx);
      IIretinit((char *)0,0);
      if (IInexec() == 0) {
        IIsqInit(&sqlca);
        IIsqMods(1);
        IIexDefine(1,(char *)"duvechk17",6260,10886);
        IIwritio(0,(short *)0,1,32,0,(char *)
"select count(devrelid)from iidevices where devrelid=");
        IIwritio(0,(short *)0,1,32,0,(char *)" $0=");
        IIputdomio((short *)0,1,30,4,&tid);
        IIwritio(0,(short *)0,1,32,0,(char *)"and devrelidx=");
        IIwritio(0,(short *)0,1,32,0,(char *)" $1=");
        IIputdomio((short *)0,1,30,4,&tidx);
        IIwritio(0,(short *)0,1,32,0,(char *)"and devloc!=''");
        IIexDefine(0,(char *)"duvechk17",6260,10886);
        if (IIerrtest() == 0) {
          IIsexec();
        } /* IIerrtest */
      } /* IInexec */
...
/* # line 4800 "duvechk.sc" */	/* host code */
	...
	*/
	...
	== DUVE_YES)
	{
/* # line 4821 "duvechk.sc" */	/* update */
  {
    IIsqInit(&sqlca);
    IIwritio(0,(short *)0,1,32,0,(char *)
"update iirelation set relloccount=");
    IIputdomio((short *)0,1,30,4,&agg);
    IIwritio(0,(short *)0,1,32,0,(char *)"where reltid=");
    IIputdomio((short *)0,1,30,4,&tid);
    IIwritio(0,(short *)0,1,32,0,(char *)"and reltidx=");
...
/* # line 4823 "duvechk.sc" */	/* host code */
	    if (agg<=1)
	    {   
		relstat = duve_cb->duverel->rel[duve_cb->duve_cnt].du_stat 
			  & ~TCB_MULTIPLE_LOC;
...
/* # line 4831 "duvechk.sc" */	/* host code */
...
DMP_RELATION	iirelation;
{
  ...
  u_i4 tid, tidx;
  i2 fill;
/* # line 4982 "duvechk.sc" */	/* host code */
...
/* # line 5030 "duvechk.sc" */	/* host code */
    ...
    */
	      ...
	      ( iirelation.relifill > 100) || ( iirelation.rellfill > 100))  )
	{
		...
		{
		    fill = DM_FL_BTREE;
/* # line 5063 "duvechk.sc" */	/* update */
  {
    IIsqInit(&sqlca);
    IIwritio(0,(short *)0,1,32,0,(char *)"update iirelation set rellfi\
ll=");
    IIputdomio((short *)0,1,30,2,&fill);
    IIwritio(0,(short *)0,1,32,0,(char *)"where reltid=");
    IIputdomio((short *)0,1,30,4,&tid);
...
/* # line 5065 "duvechk.sc" */	/* host code */
		...
		{
		    fill = DM_FI_BTREE;
/* # line 5080 "duvechk.sc" */	/* update */
  {
    IIsqInit(&sqlca);
    IIwritio(0,(short *)0,1,32,0,(char *)"update iirelation set relifi\
ll=");
    IIputdomio((short *)0,1,30,2,&fill);
    IIwritio(0,(short *)0,1,32,0,(char *)"where reltid=");
    IIputdomio((short *)0,1,30,4,&tid);
...
/* # line 5082 "duvechk.sc" */	/* host code */
...
/* # line 5145 "duvechk.sc" */	/* host code */
    STcopy ( duve_cb->duverel->rel[duve_cb->duve_cnt].du_tab, trelid);
    STcopy ( duve_cb->duverel->rel[duve_cb->duve_cnt].du_own, trelowner);
/* # line 5148 "duvechk.sc" */	/* repeated select */
  {
    IIsexec();
    while (IInexec() == 0) {
      IIsqInit(&sqlca);
      IIexExec(1,(char *)"duvechk18",6261,20128);
      IIputdomio((short *)0,1,32,0,trelid);
      IIputdomio((short *)0,1,32,0,trelowner);
      IIretinit((char *)0,0);
      if (IInexec() == 0) {
        IIsqInit(&sqlca);
        IIsqMods(1);
        IIexDefine(1,(char *)"duvechk18",6261,20128);
        IIwritio(0,(short *)0,1,32,0,(char *)
"select any(relid)from iirel_idx where relid=");
        IIwritio(0,(short *)0,1,32,0,(char *)" $0=");
        IIputdomio((short *)0,1,32,0,trelid);
        IIwritio(0,(short *)0,1,32,0,(char *)"and relowner=");
        IIwritio(0,(short *)0,1,32,0,(char *)" $1=");
        IIputdomio((short *)0,1,32,0,trelowner);
        IIexDefine(0,(char *)"duvechk18",6261,20128);
        if (IIerrtest() == 0) {
          IIsexec();
        } /* IIerrtest */
      } /* IInexec */
...
/* # line 5151 "duvechk.sc" */	/* host code */
    if (agg==0)
...
/* # line 5165 "duvechk.sc" */	/* select */
  {
    IIsqInit(&sqlca);
    IIsqMods(1);
    IIwritio(0,(short *)0,1,32,0,(char *)
"select int4(tid)from iirelation where reltid=");
    IIputdomio((short *)0,1,30,4,&tid);
    IIwritio(0,(short *)0,1,32,0,(char *)"and reltidx=");
    IIputdomio((short *)0,1,30,4,&tidx);
    IIretinit((char *)0,0);
...
/* # line 5167 "duvechk.sc" */	/* insert */
  {
    IIsqInit(&sqlca);
    IIwritio(0,(short *)0,1,32,0,(char *)
"insert into iirel_idx(relid, relowner, tidp)values(");
    IIputdomio((short *)0,1,32,0,trelid);
    IIwritio(0,(short *)0,1,32,0,(char *)", ");
    IIputdomio((short *)0,1,32,0,trelowner);
    IIwritio(0,(short *)0,1,32,0,(char *)", ");
...
/* # line 5169 "duvechk.sc" */	/* host code */
...
DMP_RELATION	iirelation;
{
  ...
  i4 agg;
  u_i4 tid, tidx;
/* # line 5228 "duvechk.sc" */	/* host code */
    tid  = iirelation.reltid.db_tab_base;
    tidx = iirelation.reltid.db_tab_index;
    ...
    {
/* # line 5235 "duvechk.sc" */	/* repeated select */
  {
    IIsexec();
    while (IInexec() == 0) {
      IIsqInit(&sqlca);
      IIexExec(1,(char *)"duvechk19",6262,23264);
      IIputdomio((short *)0,1,30,4,&tid);
      IIputdomio((short *)0,1,30,4,&tidx);
      IIretinit((char *)0,0);
      if (IInexec() == 0) {
        IIsqInit(&sqlca);
        IIsqMods(1);
        IIexDefine(1,(char *)"duvechk19",6262,23264);
        IIwritio(0,(short *)0,1,32,0,(char *)
"select any(rule_name)from iirule where rule_tabbase=");
        IIwritio(0,(short *)0,1,32,0,(char *)" $0=");
        IIputdomio((short *)0,1,30,4,&tid);
        IIwritio(0,(short *)0,1,32,0,(char *)"and rule_tabidx=");
        IIwritio(0,(short *)0,1,32,0,(char *)" $1=");
        IIputdomio((short *)0,1,30,4,&tidx);
        IIexDefine(0,(char *)"duvechk19",6262,23264);
        if (IIerrtest() == 0) {
          IIsexec();
        } /* IIerrtest */
      } /* IInexec */
...
/* # line 5237 "duvechk.sc" */	/* host code */
	if (agg==0)
	{
...
/* # line 5255 "duvechk.sc" */	/* host code */
...
DMP_RELATION   iirelation;
{
  ...
  i4 agg;
  char trelowner[DB_MAXNAME + 1];
/* # line 5320 "duvechk.sc" */	/* host code */
    STcopy ( duve_cb->duverel->rel[duve_cb->duve_cnt].du_own, trelowner);
/* # line 5322 "duvechk.sc" */	/* repeated select */
  {
    IIsexec();
    while (IInexec() == 0) {
      IIsqInit(&sqlca);
      IIexExec(1,(char *)"duvechk20",6263,9342);
      IIputdomio((short *)0,1,32,0,trelowner);
      IIretinit((char *)0,0);
      if (IInexec() == 0) {
        IIsqInit(&sqlca);
        IIsqMods(1);
        IIexDefine(1,(char *)"duvechk20",6263,9342);
        IIwritio(0,(short *)0,1,32,0,(char *)
"select any(schema_id)from iischema where schema_name=");
        IIwritio(0,(short *)0,1,32,0,(char *)" $0=");
        IIputdomio((short *)0,1,32,0,trelowner);
        IIexDefine(0,(char *)"duvechk20",6263,9342);
        if (IIerrtest() == 0) {
          IIsexec();
        } /* IIerrtest */
      } /* IInexec */
...
/* # line 5325 "duvechk.sc" */	/* host code */
    if (agg == 0)
    {  
...
/* # line 5415 "duvechk.sc" */	/* host code */
...
DMP_RELATION	iirelation;
{
  ...
  i4 cnt, mode;
  u_i4 tid, tidx;
/* # line 5485 "duvechk.sc" */	/* host code */
    tid  = iirelation.reltid.db_tab_base;
    tidx = iirelation.reltid.db_tab_index;
    if (iirelation.relstat & TCB_VIEW)
    {
	mode = DB_VIEW;
/* # line 5492 "duvechk.sc" */	/* repeated select */
  {
    IIsexec();
    while (IInexec() == 0) {
      IIsqInit(&sqlca);
      IIexExec(1,(char *)"duvechk22",6265,6268);
      IIputdomio((short *)0,1,30,4,&tid);
      IIputdomio((short *)0,1,30,4,&tidx);
      IIputdomio((short *)0,1,30,4,&mode);
      IIretinit((char *)0,0);
      if (IInexec() == 0) {
        IIsqInit(&sqlca);
        IIsqMods(1);
        IIexDefine(1,(char *)"duvechk22",6265,6268);
        IIwritio(0,(short *)0,1,32,0,(char *)
...
"and d_priv_number=0 and d_obj_type=");
        IIwritio(0,(short *)0,1,32,0,(char *)" $2=");
        IIputdomio((short *)0,1,30,4,&mode);
        IIexDefine(0,(char *)"duvechk22",6265,6268);
        if (IIerrtest() == 0) {
          IIsexec();
        } /* IIerrtest */
      } /* IInexec */
...
/* # line 5496 "duvechk.sc" */	/* host code */
        /* 
...
/* # line 5523 "duvechk.sc" */	/* host code */
		    duve_talk(DUVE_MODESENS, duve_cb, 
...
DUVE_CB		*duve_cb;
{
  ...
  char *statement_buffer, buf[CMDBUFSIZE];
	u_i4 		   len;
/* # line 5605 "duvechk.sc" */	/* host code */
	STcopy ( duve_cb->duve_schema, sch_name);
	len = STtrmwhite(sch_name);
        /* check if this schema has already been created */
/* # line 5610 "duvechk.sc" */	/* repeated select */
  {
    IIsexec();
    while (IInexec() == 0) {
      IIsqInit(&sqlca);
      IIexExec(1,(char *)"duvechk23",6266,4220);
      IIputdomio((short *)0,1,32,0,sch_name);
      IIretinit((char *)0,0);
      if (IInexec() == 0) {
        IIsqInit(&sqlca);
        IIsqMods(1);
        IIexDefine(1,(char *)"duvechk23",6266,4220);
        IIwritio(0,(short *)0,1,32,0,(char *)
"select any(schema_id)from iischema where schema_name=");
        IIwritio(0,(short *)0,1,32,0,(char *)" $0=");
        IIputdomio((short *)0,1,32,0,sch_name);
        IIexDefine(0,(char *)"duvechk23",6266,4220);
        if (IIerrtest() == 0) {
          IIsexec();
        } /* IIerrtest */
      } /* IInexec */
...
/* # line 5614 "duvechk.sc" */	/* host code */
        if ( cnt == NULL)
        {
           /* create the schema */
/* # line 5617 "duvechk.sc" */	/* commit */
  {
    IIsqInit(&sqlca);
    IIxact(3);
    if (sqlca.sqlcode < 0) 
...
/* # line 5618 "duvechk.sc" */	/* host code */
           statement_buffer = STpolycat(4, "set session authorization ", "\"",
                       sch_name, "\"", buf);
/* # line 5620 "duvechk.sc" */	/* execute */
  {
    IIsqInit(&sqlca);
    IIsqExImmed(statement_buffer);
    IIsyncup((char *)0,0);
...
/* # line 5621 "duvechk.sc" */	/* host code */
           statement_buffer = STpolycat(2, "create schema authorization ",
                        sch_name, buf);
/* # line 5623 "duvechk.sc" */	/* execute */
  {
    IIsqInit(&sqlca);
    IIsqExImmed(statement_buffer);
    IIsyncup((char *)0,0);
...
/* # line 5624 "duvechk.sc" */	/* host code */
	}
}
/*{
...
/* # line 5673 "duvechk.sc" */	/* host code */
	...
	id2 = duve_cb->duverel->rel[duve_cb->duve_cnt].du_id.db_tab_index;
        ...
        */
/* # line 5682 "duvechk.sc" */	/* select */
  {
    IIsqInit(&sqlca);
    IIsqMods(1);
    IIwritio(0,(short *)0,1,32,0,(char *)
"select any(consschema_id1), consschema_id1, consschema_id2 from iiint\
egrity where inttabbase=");
...
"group by consschema_id1, consschema_id2");
    ...
    if (IInextget() != 0) {
      IIgetdomio((short *)0,1,30,4,&cnt);
      IIgetdomio((short *)0,1,30,4,&sch_id1);
      IIgetdomio((short *)0,1,30,4,&sch_id2);
    } /* IInextget */
    IIsqFlush((char *)0,0);
    if (sqlca.sqlcode < 0) 
      Clean_Up();
  }
/* # line 5689 "duvechk.sc" */	/* host code */
        if (cnt != NULL)
        {
/* # line 5691 "duvechk.sc" */	/* insert */
  {
    IIsqInit(&sqlca);
    IIwritio(0,(short *)0,1,32,0,(char *)
"insert into iischema(schema_name, schema_owner, schema_id, schema_idx\
    ...
    IIputdomio((short *)0,1,32,0,schname);
    IIwritio(0,(short *)0,1,32,0,(char *)", ");
    IIputdomio((short *)0,1,30,4,&sch_id1);
    IIwritio(0,(short *)0,1,32,0,(char *)", ");
    IIputdomio((short *)0,1,30,4,&sch_id2);
    IIwritio(0,(short *)0,1,32,0,(char *)")");
    IIsyncup((char *)0,0);
    if (sqlca.sqlcode < 0) 
      Clean_Up();
  }
/* # line 5695 "duvechk.sc" */	/* host code */
           return ((DU_STATUS) DUVE_YES);
        }
        else
           return ((DU_STATUS) DUVE_NO);
...
/* # line 5809 "duvechk.sc" */	/* declare */
  {
    IIsqInit(&sqlca);
    IIwritio(0,(short *)0,1,32,0,(char *)
"declare global temporary table session.cleanup_tbl(obj_id integer, ob\
j_idx integer, obj_type integer, secondary_id integer, flags integer)o\
n commit preserve rows with norecovery");
    IIsyncup((char *)0,0);
    if (sqlca.sqlcode < 0) 
      Clean_Up();
  }
/* # line 5817 "duvechk.sc" */	/* host code */
    /*
	...
	*/
/* # line 5849 "duvechk.sc" */	/* insert */
  {
    IIsqInit(&sqlca);
    IIwritio(0,(short *)0,1,32,0,(char *)
"insert into session.cleanup_tbl values(");
    IIputdomio((short *)0,1,30,4,&tid);
    IIwritio(0,(short *)0,1,32,0,(char *)", ");
    IIputdomio((short *)0,1,30,4,&tidx);
    IIwritio(0,(short *)0,1,32,0,(char *)", ");
    ...
    IIwritio(0,(short *)0,1,32,0,(char *)", 0, ");
    IIputdomio((short *)0,1,30,4,&cleanup_flag);
    IIwritio(0,(short *)0,1,32,0,(char *)")");
    IIsyncup((char *)0,0);
    if (sqlca.sqlcode < 0) 
      Clean_Up();
  }
/* # line 5851 "duvechk.sc" */	/* host code */
    }
    else
    {
	...
	*/
	...
	for (ctr = 0; ctr < duve_cb->duve_cnt; ctr++)
	{
		...
		*/
/* # line 5894 "duvechk.sc" */	/* repeated insert */
  {
    IIsexec();
    while (IInexec() == 0) {
      IIsqInit(&sqlca);
      IIexExec(1,(char *)"duvechk24",6267,5087);
      IIputdomio((short *)0,1,30,4,&tid);
      IIputdomio((short *)0,1,30,4,&tidx);
      IIputdomio((short *)0,1,30,4,&type);
      IIputdomio((short *)0,1,30,4,&cleanup_flag);
      ...
      if (IInexec() == 0) {
        IIsqInit(&sqlca);
        IIexDefine(1,(char *)"duvechk24",6267,5087);
        IIwritio(0,(short *)0,1,32,0,(char *)
"insert into session.cleanup_tbl values(");
        IIwritio(0,(short *)0,1,32,0,(char *)" $0=");
        IIputdomio((short *)0,1,30,4,&tid);
        ...
        IIputdomio((short *)0,1,30,4,&cleanup_flag);
        IIwritio(0,(short *)0,1,32,0,(char *)")");
        IIexDefine(0,(char *)"duvechk24",6267,5087);
        if (IIerrtest() == 0) {
          IIsexec();
        } /* IIerrtest */
      } /* IInexec */
...
/* # line 5896 "duvechk.sc" */	/* host code */
	    }
	     ...
	     drop_obj = drop_obj->duve_next)
	{
	    ...
	    */
		...
		(type == DB_DBP && drop_obj->duve_drop_flags & DUVE_DBP_DROP)
		    ? DROP_THIS_DBPROC
		    : 0;
/* # line 5937 "duvechk.sc" */	/* repeated insert */
  {
    IIsexec();
    while (IInexec() == 0) {
      IIsqInit(&sqlca);
      IIexExec(1,(char *)"duvechk25",6268,7392);
      IIputdomio((short *)0,1,30,4,&tid);
      IIputdomio((short *)0,1,30,4,&tidx);
      IIputdomio((short *)0,1,30,4,&type);
      ...
      if (IInexec() == 0) {
        IIsqInit(&sqlca);
        IIexDefine(1,(char *)"duvechk25",6268,7392);
        IIwritio(0,(short *)0,1,32,0,(char *)
"insert into session.cleanup_tbl values(");
        IIwritio(0,(short *)0,1,32,0,(char *)" $0=");
        IIputdomio((short *)0,1,30,4,&tid);
        ...
        IIputdomio((short *)0,1,30,4,&cleanup_flag);
        IIwritio(0,(short *)0,1,32,0,(char *)")");
        IIexDefine(0,(char *)"duvechk25",6268,7392);
        if (IIerrtest() == 0) {
          IIsexec();
        } /* IIerrtest */
      } /* IInexec */
...
/* # line 5939 "duvechk.sc" */	/* host code */
	}
    }
    if (!objects_dropped)
    {
    ...
    ** relidxcount
    */
/* # line 5986 "duvechk.sc" */	/* insert */
  {
    IIsqInit(&sqlca);
    IIwritio(0,(short *)0,1,32,0,(char *)
"insert into session.cleanup_tbl select reltid, reltidx, ");
    IIputdomio((short *)0,1,30,4,&idx_type);
    IIwritio(0,(short *)0,1,32,0,(char *)", 0, ");
    IIputdomio((short *)0,1,30,4,&cleanup_flag);
    IIwritio(0,(short *)0,1,32,0,(char *)
"from iirelation, session.cleanup_tbl where obj_id=reltid and obj_idx=\
0 and obj_type=");
    IIputdomio((short *)0,1,30,4,&tbl_type);
    IIwritio(0,(short *)0,1,32,0,(char *)
"and reltidx!=0 and not exists(select 1 from session.cleanup_tbl where\
 obj_id=reltid and obj_idx=reltidx)");
    IIsyncup((char *)0,0);
    if (sqlca.sqlcode < 0) 
      Clean_Up();
  }
/* # line 6000 "duvechk.sc" */	/* host code */
    cleanup_flag = DECREMENT_INDEX_COUNT;
    do
    {
	cnt_this_run = 0;
	...
	** yet (and if it isn't an index, no harm done)
	*/
/* # line 6027 "duvechk.sc" */	/* repeated insert */
  {
    IIsexec();
    while (IInexec() == 0) {
      IIsqInit(&sqlca);
      IIexExec(1,(char *)"duvechk26",6269,6044);
      IIputdomio((short *)0,1,30,4,&cleanup_flag);
      IIputdomio((short *)0,1,30,4,&rule_type);
      IIputdomio((short *)0,1,30,4,&cons_type);
      IIputdomio((short *)0,1,30,4,&tbl_type);
      IIputdomio((short *)0,1,30,4,&idx_type);
      IIputdomio((short *)0,1,30,4,&view_type);
      IIputdomio((short *)0,1,30,4,&cons_type);
      ...
      if (IInexec() == 0) {
        IIsqInit(&sqlca);
        IIexDefine(1,(char *)"duvechk26",6269,6044);
        IIwritio(0,(short *)0,1,32,0,(char *)
"insert into session.cleanup_tbl select deid1, deid2, dtype, qid, ");
        IIwritio(0,(short *)0,1,32,0,(char *)" $0=");
        IIputdomio((short *)0,1,30,4,&cleanup_flag);
        IIwritio(0,(short *)0,1,32,0,(char *)
"from iidbdepends, session.cleanup_tbl where inid1=obj_id and inid2=ob\
j_idx and obj_type!=");
        IIwritio(0,(short *)0,1,32,0,(char *)" $1=");
        IIputdomio((short *)0,1,30,4,&rule_type);
        IIwritio(0,(short *)0,1,32,0,(char *)"and((obj_type=");
        IIwritio(0,(short *)0,1,32,0,(char *)" $2=");
        IIputdomio((short *)0,1,30,4,&cons_type);
        IIwritio(0,(short *)0,1,32,0,(char *)
"and obj_type=itype and secondary_id=i_qid)or((obj_type=");
        IIwritio(0,(short *)0,1,32,0,(char *)" $3=");
        IIputdomio((short *)0,1,30,4,&tbl_type);
        IIwritio(0,(short *)0,1,32,0,(char *)"or obj_type=");
        IIwritio(0,(short *)0,1,32,0,(char *)" $4=");
        IIputdomio((short *)0,1,30,4,&idx_type);
        IIwritio(0,(short *)0,1,32,0,(char *)"or obj_type=");
        ...
        IIputdomio((short *)0,1,30,4,&dbp_type);
        IIwritio(0,(short *)0,1,32,0,(char *)"or dtype=");
        ...
        IIputdomio((short *)0,1,30,4,&cons_type);
        IIwritio(0,(short *)0,1,32,0,(char *)
"and(deid1!=inid1 or deid2!=inid2))))or(itype!=");
        IIwritio(0,(short *)0,1,32,0,(char *)" $10=");
        IIputdomio((short *)0,1,30,4,&cons_type);
        IIwritio(0,(short *)0,1,32,0,(char *)"and(itype=obj_type or(it\
ype=");
        ...
        IIputdomio((short *)0,1,30,4,&view_type);
        IIwritio(0,(short *)0,1,32,0,(char *)
")))))and not exists(select 1 from session.cleanup_tbl where obj_id=de\
id1 and obj_idx=deid2 and obj_type=dtype and secondary_id=qid)");
        IIexDefine(0,(char *)"duvechk26",6269,6044);
        if (IIerrtest() == 0) {
          IIsexec();
        } /* IIerrtest */
      } /* IInexec */
...
/* # line 6109 "duvechk.sc" */	/* inquire_sql */
  {
    IILQisInqSqlio((short *)0,1,30,4,&cnt,8);
  }
/* # line 6111 "duvechk.sc" */	/* host code */
	cnt_this_run += cnt;
	/*
	...
	*/
/* # line 6123 "duvechk.sc" */	/* repeated insert */
  {
    IIsexec();
    while (IInexec() == 0) {
      IIsqInit(&sqlca);
      IIexExec(1,(char *)"duvechk27",6270,10938);
      IIputdomio((short *)0,1,30,4,&perm_type);
      IIputdomio((short *)0,1,30,4,&cons_type);
      IIputdomio((short *)0,1,30,4,&rule_type);
      IIsyncup((char *)0,0);
      if (IInexec() == 0) {
        IIsqInit(&sqlca);
        IIexDefine(1,(char *)"duvechk27",6270,10938);
        IIwritio(0,(short *)0,1,32,0,(char *)
"insert into session.cleanup_tbl select d_obj_id, d_obj_idx, d_obj_typ\
e, 0, 0 from iipriv, session.cleanup_tbl where i_obj_id=obj_id and i_o\
bj_idx=obj_idx and obj_type!=");
        IIwritio(0,(short *)0,1,32,0,(char *)" $0=");
        IIputdomio((short *)0,1,30,4,&perm_type);
        IIwritio(0,(short *)0,1,32,0,(char *)"and obj_type!=");
        IIwritio(0,(short *)0,1,32,0,(char *)" $1=");
        ...
        IIputdomio((short *)0,1,30,4,&rule_type);
        IIwritio(0,(short *)0,1,32,0,(char *)
"and d_priv_number=0 and not exists(select 1 from session.cleanup_tbl \
where obj_id=d_obj_id and obj_idx=d_obj_idx and obj_type=d_obj_type an\
d secondary_id=0)");
        IIexDefine(0,(char *)"duvechk27",6270,10938);
        if (IIerrtest() == 0) {
          IIsexec();
        } /* IIerrtest */
      } /* IInexec */
...
/* # line 6154 "duvechk.sc" */	/* inquire_sql */
  {
    IILQisInqSqlio((short *)0,1,30,4,&cnt,8);
  }
/* # line 6156 "duvechk.sc" */	/* host code */
	cnt_this_run += cnt;
...
/* # line 6198 "duvechk.sc" */	/* delete */
  {
    IIsqInit(&sqlca);
    IIwritio(0,(short *)0,1,32,0,(char *)
"delete from iitree where exists(select 1 from session.cleanup_tbl, ii\
rule where obj_id=rule_id1 and obj_idx=rule_id2 and obj_type=");
    IIputdomio((short *)0,1,30,4,&rule_type);
    IIwritio(0,(short *)0,1,32,0,(char *)
"and rule_tabbase=treetabbase and rule_tabidx=treetabidx and rule_tree\
id1=treeid1 and rule_treeid2=treeid2 and treemode=");
    IIputdomio((short *)0,1,30,4,&rule_type);
    IIwritio(0,(short *)0,1,32,0,(char *)")");
    IIsyncup((char *)0,0);
    if (sqlca.sqlcode < 0) 
...
/* # line 6210 "duvechk.sc" */	/* host code */
    /* if performing DROPTBL operation, delete query text for rules as well */
    if (duve_cb->duve_operation == DUVE_DROPTBL)
    {
/* # line 6214 "duvechk.sc" */	/* delete */
  {
    IIsqInit(&sqlca);
    IIwritio(0,(short *)0,1,32,0,(char *)
"delete from iiqrytext where exists(select 1 from session.cleanup_tbl,\
 iirule where obj_id=rule_id1 and obj_idx=rule_id2 and obj_type=");
    IIputdomio((short *)0,1,30,4,&rule_type);
    IIwritio(0,(short *)0,1,32,0,(char *)
"and rule_qryid1=txtid1 and rule_qryid2=txtid2 and mode=");
    IIputdomio((short *)0,1,30,4,&rule_type);
    IIwritio(0,(short *)0,1,32,0,(char *)")");
    IIsyncup((char *)0,0);
    if (sqlca.sqlcode < 0) 
...
/* # line 6223 "duvechk.sc" */	/* host code */
    }
    /*
    ** delete IIDBDEPENDS tuples describing dependency of rules on constraints
    */
/* # line 6229 "duvechk.sc" */	/* delete */
  {
    IIsqInit(&sqlca);
    IIwritio(0,(short *)0,1,32,0,(char *)
"delete from iidbdepends where exists(select 1 from session.cleanup_tb\
l where obj_id=deid1 and obj_idx=deid2 and obj_type=");
    IIputdomio((short *)0,1,30,4,&rule_type);
    IIwritio(0,(short *)0,1,32,0,(char *)"and dtype=");
    IIputdomio((short *)0,1,30,4,&rule_type);
    IIwritio(0,(short *)0,1,32,0,(char *)")");
...
/* # line 6237 "duvechk.sc" */	/* host code */
    /* delete descriptions of rules */
/* # line 6239 "duvechk.sc" */	/* delete */
  {
    IIsqInit(&sqlca);
    IIwritio(0,(short *)0,1,32,0,(char *)
"delete from iirule where exists(select 1 from session.cleanup_tbl whe\
re obj_id=rule_id1 and obj_idx=rule_id2 and obj_type=");
    IIputdomio((short *)0,1,30,4,&rule_type);
    IIwritio(0,(short *)0,1,32,0,(char *)")");
    IIsyncup((char *)0,0);
    if (sqlca.sqlcode < 0) 
...
/* # line 6246 "duvechk.sc" */	/* host code */
    /*
    ** CONSTRAINTS
    */
    ...
    if (duve_cb->duve_operation == DUVE_DROPTBL)
    {
/* # line 6254 "duvechk.sc" */	/* delete */
  {
    IIsqInit(&sqlca);
    IIwritio(0,(short *)0,1,32,0,(char *)
"delete from iiqrytext where exists(select 1 from session.cleanup_tbl,\
 iiintegrity where obj_id=inttabbase and obj_idx=inttabidx and obj_typ\
e=");
    IIputdomio((short *)0,1,30,4,&cons_type);
    IIwritio(0,(short *)0,1,32,0,(char *)
"and secondary_id=intnumber and intqryid1=txtid1 and intqryid2=txtid2 \
and mode=");
    IIputdomio((short *)0,1,30,4,&intg_type);
    IIwritio(0,(short *)0,1,32,0,(char *)")");
    IIsyncup((char *)0,0);
    if (sqlca.sqlcode < 0) 
      Clean_Up();
  }
/* # line 6268 "duvechk.sc" */	/* host code */
    }
    /* delete IIKEY records for UNIQUE/REF constraints */
/* # line 6272 "duvechk.sc" */	/* delete */
  {
    IIsqInit(&sqlca);
    IIwritio(0,(short *)0,1,32,0,(char *)
"delete from iikey where exists(select 1 from session.cleanup_tbl, iii\
ntegrity where obj_id=inttabbase and obj_idx=inttabidx and obj_type=");
    IIputdomio((short *)0,1,30,4,&cons_type);
    IIwritio(0,(short *)0,1,32,0,(char *)
"and secondary_id=intnumber and consid1=key_consid1 and consid2=key_co\
nsid2)");
    IIsyncup((char *)0,0);
    if (sqlca.sqlcode < 0) 
      Clean_Up();
  }
/* # line 6282 "duvechk.sc" */	/* host code */
    /*
...
l where obj_id=deid1 and obj_idx=deid2 and obj_type=");
    ...
    IIwritio(0,(short *)0,1,32,0,(char *)"and dtype=");
    IIputdomio((short *)0,1,30,4,&cons_type);
    IIwritio(0,(short *)0,1,32,0,(char *)"and secondary_id=qid)");
    IIsyncup((char *)0,0);
    if (sqlca.sqlcode < 0) 
      Clean_Up();
  }
/* # line 6297 "duvechk.sc" */	/* host code */
    /* delete descriptions of constraints */
/* # line 6299 "duvechk.sc" */	/* delete */
  {
    IIsqInit(&sqlca);
    IIwritio(0,(short *)0,1,32,0,(char *)
"delete from iiintegrity where exists(select 1 from session.cleanup_tb\
l where obj_id=inttabbase and obj_idx=inttabidx and obj_type=");
    IIputdomio((short *)0,1,30,4,&cons_type);
    IIwritio(0,(short *)0,1,32,0,(char *)"and secondary_id=intnumber)");
    IIsyncup((char *)0,0);
    if (sqlca.sqlcode < 0) 
      Clean_Up();
  }
/* # line 6307 "duvechk.sc" */	/* host code */
    /*
    ** PERMITS (QUEL-style)
    */
    /* delete trees associated with permits */
/* # line 6313 "duvechk.sc" */	/* delete */
  {
    IIsqInit(&sqlca);
    IIwritio(0,(short *)0,1,32,0,(char *)
"delete from iitree where exists(select 1 from session.cleanup_tbl, ii\
protect where obj_id=protabbase and obj_idx=protabidx and obj_type=");
    IIputdomio((short *)0,1,30,4,&perm_type);
    IIwritio(0,(short *)0,1,32,0,(char *)
"and secondary_id=propermid and protabbase=treetabbase and protabidx=t\
reetabidx and protreeid1=treeid1 and protreeid2=treeid2 and treemode=");
    IIputdomio((short *)0,1,30,4,&perm_type);
    IIwritio(0,(short *)0,1,32,0,(char *)")");
    IIsyncup((char *)0,0);
    if (sqlca.sqlcode < 0) 
...
/* # line 6326 "duvechk.sc" */	/* host code */
    /* if performing DROPTBL operation, delete query text for rules as well */
    if (duve_cb->duve_operation == DUVE_DROPTBL)
    {
/* # line 6330 "duvechk.sc" */	/* delete */
  {
    IIsqInit(&sqlca);
    IIwritio(0,(short *)0,1,32,0,(char *)
"delete from iiqrytext where exists(select 1 from session.cleanup_tbl,\
 iiprotect where obj_id=protabbase and obj_idx=protabidx and obj_type=");
    IIputdomio((short *)0,1,30,4,&perm_type);
    IIwritio(0,(short *)0,1,32,0,(char *)
"and secondary_id=propermid and proqryid1=txtid1 and proqryid2=txtid2 \
and mode=");
    IIputdomio((short *)0,1,30,4,&perm_type);
    IIwritio(0,(short *)0,1,32,0,(char *)")");
    IIsyncup((char *)0,0);
...
/* # line 6340 "duvechk.sc" */	/* host code */
    }
    /* delete descriptions of permits */
/* # line 6344 "duvechk.sc" */	/* delete */
  {
    IIsqInit(&sqlca);
    IIwritio(0,(short *)0,1,32,0,(char *)
"delete from iiprotect where exists(select 1 from session.cleanup_tbl \
where obj_id=protabbase and obj_idx=protabidx and obj_type=");
    IIputdomio((short *)0,1,30,4,&perm_type);
    IIwritio(0,(short *)0,1,32,0,(char *)"and secondary_id=propermid)");
    IIsyncup((char *)0,0);
    if (sqlca.sqlcode < 0) 
      Clean_Up();
  }
/* # line 6352 "duvechk.sc" */	/* host code */
    /*
    ** TABLES/VIEWS/INDICES
    */
    /* delete descriptions of table/view/index attributes */
/* # line 6358 "duvechk.sc" */	/* delete */
  {
    IIsqInit(&sqlca);
    IIwritio(0,(short *)0,1,32,0,(char *)
"delete from iiattribute where exists(select 1 from session.cleanup_tb\
l where obj_id=attrelid and obj_idx=attrelidx and(obj_type=");
    IIputdomio((short *)0,1,30,4,&tbl_type);
    IIwritio(0,(short *)0,1,32,0,(char *)"or obj_type=");
    IIputdomio((short *)0,1,30,4,&view_type);
    IIwritio(0,(short *)0,1,32,0,(char *)"or obj_type=");
...
/* # line 6367 "duvechk.sc" */	/* host code */
    /* delete index records for indices */
/* # line 6369 "duvechk.sc" */	/* delete */
  {
    IIsqInit(&sqlca);
    IIwritio(0,(short *)0,1,32,0,(char *)
"delete from iiindex where exists(select 1 from session.cleanup_tbl wh\
ere obj_id=baseid and obj_idx=indexid and(obj_type=");
    IIputdomio((short *)0,1,30,4,&tbl_type);
    IIwritio(0,(short *)0,1,32,0,(char *)"or obj_type=");
    IIputdomio((short *)0,1,30,4,&view_type);
    IIwritio(0,(short *)0,1,32,0,(char *)"or obj_type=");
...
/* # line 6378 "duvechk.sc" */	/* host code */
    /* delete device records for tables/indices */
/* # line 6380 "duvechk.sc" */	/* delete */
  {
    IIsqInit(&sqlca);
    IIwritio(0,(short *)0,1,32,0,(char *)
"delete from iidevices where exists(select 1 from session.cleanup_tbl \
where obj_id=devrelid and obj_idx=devrelidx and(obj_type=");
    IIputdomio((short *)0,1,30,4,&tbl_type);
    IIwritio(0,(short *)0,1,32,0,(char *)"or obj_type=");
    IIputdomio((short *)0,1,30,4,&view_type);
    IIwritio(0,(short *)0,1,32,0,(char *)"or obj_type=");
...
/* # line 6389 "duvechk.sc" */	/* host code */
    /*
...
where(obj_type=");
    ...
    IIputdomio((short *)0,1,30,4,&idx_type);
    IIwritio(0,(short *)0,1,32,0,(char *)
")and(exists(select 1 from iirelation where obj_id=reltid and obj_idx=\
reltidx and relqid1=txtid1 and relqid2=txtid2 and mode=");
    IIputdomio((short *)0,1,30,4,&view_type);
    IIwritio(0,(short *)0,1,32,0,(char *)
")or exists(select 1 from iiintegrity where obj_id=inttabbase and obj_\
idx=inttabidx and intqryid1=txtid1 and intqryid2=txtid2 and mode=");
    IIputdomio((short *)0,1,30,4,&intg_type);
    IIwritio(0,(short *)0,1,32,0,(char *)
")or exists(select 1 from iiprotect where obj_id=protabbase and obj_id\
x=protabidx and proqryid1=txtid1 and proqryid2=txtid2 and mode=");
    IIputdomio((short *)0,1,30,4,&perm_type);
    IIwritio(0,(short *)0,1,32,0,(char *)
")or exists(select 1 from iirule where obj_id=rule_tabbase and obj_idx\
=rule_tabidx and rule_qryid1=txtid1 and rule_qryid2=txtid2 and mode=");
    IIputdomio((short *)0,1,30,4,&rule_type);
    IIwritio(0,(short *)0,1,32,0,(char *)")))");
    IIsyncup((char *)0,0);
    if (sqlca.sqlcode < 0) 
...
/* # line 6445 "duvechk.sc" */	/* host code */
    }
    /* delete integrity/constraint records for tables */
/* # line 6449 "duvechk.sc" */	/* delete */
  {
    IIsqInit(&sqlca);
    IIwritio(0,(short *)0,1,32,0,(char *)
"delete from iiintegrity where exists(select 1 from session.cleanup_tb\
...
/* # line 6458 "duvechk.sc" */	/* host code */
    /* delete permit/security_alarm records for tables/views */
/* # line 6460 "duvechk.sc" */	/* delete */
  {
    IIsqInit(&sqlca);
    IIwritio(0,(short *)0,1,32,0,(char *)
"delete from iiprotect where exists(select 1 from session.cleanup_tbl \
...
/* # line 6469 "duvechk.sc" */	/* host code */
    /* delete tree records for views/permits/integrities/rules */
/* # line 6471 "duvechk.sc" */	/* delete */
  {
    IIsqInit(&sqlca);
    IIwritio(0,(short *)0,1,32,0,(char *)
"delete from iitree where exists(select 1 from session.cleanup_tbl whe\
re obj_id=treetabbase and obj_idx=treetabidx and(obj_type=");
    IIputdomio((short *)0,1,30,4,&tbl_type);
    IIwritio(0,(short *)0,1,32,0,(char *)"or obj_type=");
    IIputdomio((short *)0,1,30,4,&view_type);
    IIwritio(0,(short *)0,1,32,0,(char *)"or obj_type=");
...
/* # line 6480 "duvechk.sc" */	/* host code */
    /* delete histogram records for tables/indices */
/* # line 6482 "duvechk.sc" */	/* delete */
  {
    IIsqInit(&sqlca);
    IIwritio(0,(short *)0,1,32,0,(char *)
"delete from iihistogram where exists(select 1 from session.cleanup_tb\
l where obj_id=htabbase and obj_idx=htabindex and(obj_type=");
    IIputdomio((short *)0,1,30,4,&tbl_type);
    IIwritio(0,(short *)0,1,32,0,(char *)"or obj_type=");
    IIputdomio((short *)0,1,30,4,&view_type);
    IIwritio(0,(short *)0,1,32,0,(char *)"or obj_type=");
...
/* # line 6491 "duvechk.sc" */	/* host code */
    /* delete statistics records for tables/indices */
/* # line 6493 "duvechk.sc" */	/* delete */
  {
    IIsqInit(&sqlca);
    IIwritio(0,(short *)0,1,32,0,(char *)
"delete from iistatistics where exists(select 1 from session.cleanup_t\
bl where obj_id=stabbase and obj_idx=stabindex and(obj_type=");
    IIputdomio((short *)0,1,30,4,&tbl_type);
    IIwritio(0,(short *)0,1,32,0,(char *)"or obj_type=");
    IIputdomio((short *)0,1,30,4,&view_type);
    IIwritio(0,(short *)0,1,32,0,(char *)"or obj_type=");
...
/* # line 6502 "duvechk.sc" */	/* host code */
    /* delete security alarm records for tables/views */
/* # line 6504 "duvechk.sc" */	/* delete */
  {
    IIsqInit(&sqlca);
    IIwritio(0,(short *)0,1,32,0,(char *)
"delete from iisecalarm where exists(select 1 from session.cleanup_tbl\
 where obj_id=obj_id1 and obj_idx=obj_id2 and(obj_type=");
    IIputdomio((short *)0,1,30,4,&tbl_type);
    IIwritio(0,(short *)0,1,32,0,(char *)"or obj_type=");
    IIputdomio((short *)0,1,30,4,&view_type);
    IIwritio(0,(short *)0,1,32,0,(char *)"or obj_type=");
...
/* # line 6513 "duvechk.sc" */	/* host code */
    /* delete rule records for tables/views */
/* # line 6515 "duvechk.sc" */	/* delete */
  {
    IIsqInit(&sqlca);
    IIwritio(0,(short *)0,1,32,0,(char *)
"delete from iirule where exists(select 1 from session.cleanup_tbl whe\
re obj_id=rule_tabbase and obj_idx=rule_tabidx and(obj_type=");
    IIputdomio((short *)0,1,30,4,&tbl_type);
    IIwritio(0,(short *)0,1,32,0,(char *)"or obj_type=");
    IIputdomio((short *)0,1,30,4,&view_type);
    IIwritio(0,(short *)0,1,32,0,(char *)"or obj_type=");
...
/* # line 6524 "duvechk.sc" */	/* host code */
    /* delete synonym records for tables/views/indices */
/* # line 6526 "duvechk.sc" */	/* delete */
  {
    IIsqInit(&sqlca);
    IIwritio(0,(short *)0,1,32,0,(char *)
"delete from iisynonym where exists(select 1 from session.cleanup_tbl \
where obj_id=syntabbase and obj_idx=syntabidx and(obj_type=");
    IIputdomio((short *)0,1,30,4,&tbl_type);
    IIwritio(0,(short *)0,1,32,0,(char *)"or obj_type=");
    IIputdomio((short *)0,1,30,4,&view_type);
    IIwritio(0,(short *)0,1,32,0,(char *)"or obj_type=");
...
/* # line 6535 "duvechk.sc" */	/* host code */
    /* delete comment records for tables/views/indices */
/* # line 6537 "duvechk.sc" */	/* delete */
  {
    IIsqInit(&sqlca);
    IIwritio(0,(short *)0,1,32,0,(char *)
"delete from iidbms_comment where exists(select 1 from session.cleanup\
_tbl where obj_id=comtabbase and obj_idx=comtabidx and(obj_type=");
    IIputdomio((short *)0,1,30,4,&tbl_type);
    IIwritio(0,(short *)0,1,32,0,(char *)"or obj_type=");
    IIputdomio((short *)0,1,30,4,&view_type);
    IIwritio(0,(short *)0,1,32,0,(char *)"or obj_type=");
...
/* # line 6547 "duvechk.sc" */	/* host code */
    /* 
...
/* # line 6568 "duvechk.sc" */	/* host code */
    /*
    ...
    ** depend
    */
/* # line 6574 "duvechk.sc" */	/* delete */
  {
    IIsqInit(&sqlca);
    IIwritio(0,(short *)0,1,32,0,(char *)
"delete from iipriv where exists(select 1 from session.cleanup_tbl whe\
re obj_id=d_obj_id and obj_idx=d_obj_idx and(obj_type=");
    IIputdomio((short *)0,1,30,4,&tbl_type);
    IIwritio(0,(short *)0,1,32,0,(char *)"or obj_type=");
    IIputdomio((short *)0,1,30,4,&view_type);
    IIwritio(0,(short *)0,1,32,0,(char *)"or obj_type=");
...
/* # line 6583 "duvechk.sc" */	/* host code */
    /* delete IIRELATION records for tables, views, and indices */
/* # line 6585 "duvechk.sc" */	/* delete */
  {
    IIsqInit(&sqlca);
    IIwritio(0,(short *)0,1,32,0,(char *)
"delete from iirelation where exists(select 1 from session.cleanup_tbl\
 where obj_id=reltid and obj_idx=reltidx and(obj_type=");
    IIputdomio((short *)0,1,30,4,&tbl_type);
    IIwritio(0,(short *)0,1,32,0,(char *)"or obj_type=");
    IIputdomio((short *)0,1,30,4,&view_type);
    IIwritio(0,(short *)0,1,32,0,(char *)"or obj_type=");
...
/* # line 6594 "duvechk.sc" */	/* host code */
    /*
    ...
    */
/* # line 6605 "duvechk.sc" */	/* declare */
  {
    IIsqInit(&sqlca);
    IIwritio(0,(short *)0,1,32,0,(char *)
"declare global temporary table session.idx_cnt_tbl(tbl_id integer, tb\
l_idx integer not null with default, idxcnt integer)on commit preserve\
 rows with norecovery");
    IIsyncup((char *)0,0);
    if (sqlca.sqlcode < 0) 
      Clean_Up();
  }
/* # line 6611 "duvechk.sc" */	/* host code */
    cleanup_flag = DECREMENT_INDEX_COUNT;
/* # line 6613 "duvechk.sc" */	/* insert */
  {
    IIsqInit(&sqlca);
    IIwritio(0,(short *)0,1,32,0,(char *)
"insert into session.idx_cnt_tbl(tbl_id, idxcnt)select reltid, count(r\
eltidx)from iirelation where reltidx>0 and exists(select 1 from sessio\
n.cleanup_tbl where obj_id=reltid and obj_idx>0 and obj_type=");
    IIputdomio((short *)0,1,30,4,&idx_type);
    IIwritio(0,(short *)0,1,32,0,(char *)"and mod((flags/");
    IIputdomio((short *)0,1,30,4,&cleanup_flag);
    IIwritio(0,(short *)0,1,32,0,(char *)"), (2))=1)group by reltid");
    IIsyncup((char *)0,0);
    if (sqlca.sqlcode < 0) 
      Clean_Up();
  }
/* # line 6627 "duvechk.sc" */	/* inquire_sql */
  {
    IILQisInqSqlio((short *)0,1,30,4,&cnt,8);
  }
/* # line 6629 "duvechk.sc" */	/* host code */
    if (cnt > 0)
    {
	/* relidxcount needs to change for at least one table */
/* # line 6633 "duvechk.sc" */	/* update */
  {
    IIsqInit(&sqlca);
    IIwritio(0,(short *)0,1,32,0,(char *)
"update iirelation from session.idx_cnt_tbl set relidxcount=idxcnt whe\
re reltid=tbl_id and reltidx=tbl_idx");
    IIsyncup((char *)0,0);
    if (sqlca.sqlcode < 0) 
      Clean_Up();
  }
/* # line 6637 "duvechk.sc" */	/* host code */
	/*
	** finally, if relidxcnt in some table has dropped to 0, we need to 
	** reset TCB_IDXD bit in relstat
	*/
/* # line 6652 "duvechk.sc" */	/* open */
  {
    IIsqInit(&sqlca);
    IIcsOpen((char *)"tcb_idxd_cursor",6271,25724);
    IIwritio(0,(short *)0,1,32,0,(char *)
"select relstat from iirelation where relidxcount=0 and exists(select \
1 from session.idx_cnt_tbl where tbl_id=reltid and tbl_idx=reltidx)");
    IIcsQuery((char *)"tcb_idxd_cursor",6271,25724);
    if (sqlca.sqlcode < 0) 
      Clean_Up();
  }
/* # line 6654 "duvechk.sc" */	/* host code */
    	for (;;)
    	{
/* # line 6656 "duvechk.sc" */	/* fetch */
  {
    IIsqInit(&sqlca);
    if (IIcsRetScroll((char *)"tcb_idxd_cursor",6271,25724,-1,-1) != 0) {
...
/* # line 6658 "duvechk.sc" */	/* host code */
	    if (sqlca.sqlcode == 100)
	    {
/* # line 6660 "duvechk.sc" */	/* close */
  {
    IIsqInit(&sqlca);
    IIcsClose((char *)"tcb_idxd_cursor",6271,25724);
    if (sqlca.sqlcode < 0) 
      Clean_Up();
  }
/* # line 6661 "duvechk.sc" */	/* host code */
	        break;
	    }
	    if (relstat & TCB_IDXD)
	    {
		relstat &= ~TCB_IDXD;
/* # line 6667 "duvechk.sc" */	/* update */
  {
    IIsqInit(&sqlca);
    IIwritio(0,(short *)0,1,32,0,(char *)"update iirelation set relsta\
t=");
    IIputdomio((short *)0,1,30,4,&relstat);
    IIcsERplace((char *)"tcb_idxd_cursor",6271,25724);
    if (sqlca.sqlcode < 0) 
      Clean_Up();
  }
/* # line 6670 "duvechk.sc" */	/* host code */
	    }
        }
    }
    /*
...
/* # line 6699 "duvechk.sc" */	/* host code */
    /*
    ** delete IIPRIV records comprising privilege descriptors representing 
    ** privileges on which dbprocs depend
    */
/* # line 6704 "duvechk.sc" */	/* delete */
  {
    IIsqInit(&sqlca);
    IIwritio(0,(short *)0,1,32,0,(char *)
"delete from iipriv where exists(select 1 from session.cleanup_tbl whe\
...
/* # line 6710 "duvechk.sc" */	/* host code */
    /*
    ...
    ** zeroed out
    */
/* # line 6729 "duvechk.sc" */	/* open */
  {
    IIsqInit(&sqlca);
    IIcsOpen((char *)"dbp_cleanup_cursor",6272,19158);
    IIwritio(0,(short *)0,1,32,0,(char *)
"select dbp_id, dbp_idx, dbp_txtid1, dbp_txtid2, dbp_mask1 from iiproc\
edure where exists(select 1 from session.cleanup_tbl where obj_id=dbp_\
id and obj_idx=dbp_idx and obj_type=");
    IIputdomio((short *)0,1,30,4,&dbp_type);
    IIwritio(0,(short *)0,1,32,0,(char *)")");
    IIcsQuery((char *)"dbp_cleanup_cursor",6272,19158);
    if (sqlca.sqlcode < 0) 
      Clean_Up();
  }
/* # line 6731 "duvechk.sc" */	/* host code */
    for (;;)
    {
	bool		dbproc_must_go;
/* # line 6735 "duvechk.sc" */	/* fetch */
  {
    IIsqInit(&sqlca);
    if (IIcsRetScroll((char *)"dbp_cleanup_cursor",6272,19158,-1,-1) != 0) {
      IIcsGetio((short *)0,1,30,4,&tid);
      IIcsGetio((short *)0,1,30,4,&tidx);
      IIcsGetio((short *)0,1,30,4,&qtxtid1);
      IIcsGetio((short *)0,1,30,4,&qtxtid2);
      IIcsGetio((short *)0,1,30,4,&dbp_mask);
      IIcsERetrieve();
    } /* IIcsRetrieve */
    if (sqlca.sqlcode < 0) 
      Clean_Up();
  }
/* # line 6738 "duvechk.sc" */	/* host code */
	if (sqlca.sqlcode == 100)
	{
/* # line 6740 "duvechk.sc" */	/* close */
  {
    IIsqInit(&sqlca);
    IIcsClose((char *)"dbp_cleanup_cursor",6272,19158);
    if (sqlca.sqlcode < 0) 
      Clean_Up();
  }
/* # line 6741 "duvechk.sc" */	/* host code */
	    break;
	}
	...
	{
/* # line 6750 "duvechk.sc" */	/* repeated select */
  {
    IIsexec();
    while (IInexec() == 0) {
      IIsqInit(&sqlca);
      IIexExec(1,(char *)"duvechk28",6273,30137);
      IIputdomio((short *)0,1,30,4,&tid);
      IIputdomio((short *)0,1,30,4,&tidx);
      IIputdomio((short *)0,1,30,4,&dbp_type);
      IIretinit((char *)0,0);
      if (IInexec() == 0) {
        IIsqInit(&sqlca);
        IIsqMods(1);
        IIexDefine(1,(char *)"duvechk28",6273,30137);
        IIwritio(0,(short *)0,1,32,0,(char *)
"select flags from session.cleanup_tbl where obj_id=");
        IIwritio(0,(short *)0,1,32,0,(char *)" $0=");
        IIputdomio((short *)0,1,30,4,&tid);
        IIwritio(0,(short *)0,1,32,0,(char *)"and obj_idx=");
        IIwritio(0,(short *)0,1,32,0,(char *)" $1=");
        IIputdomio((short *)0,1,30,4,&tidx);
        IIwritio(0,(short *)0,1,32,0,(char *)"and obj_type=");
        IIwritio(0,(short *)0,1,32,0,(char *)" $2=");
        IIputdomio((short *)0,1,30,4,&dbp_type);
        IIexDefine(0,(char *)"duvechk28",6273,30137);
        if (IIerrtest() == 0) {
          IIsexec();
        } /* IIerrtest */
      } /* IInexec */
    ...
    if (IInextget() != 0) {
      IIgetdomio((short *)0,1,30,4,&cleanup_flag);
    } /* IInextget */
    IIsqFlush((char *)0,0);
    if (sqlca.sqlcode < 0) 
      Clean_Up();
  }
/* # line 6757 "duvechk.sc" */	/* host code */
...
/* # line 6769 "duvechk.sc" */	/* delete */
  {
    IIsqInit(&sqlca);
    IIwritio(0,(short *)0,1,32,0,(char *)
"delete from iiprocedure_parameter where pp_procid1=");
    IIputdomio((short *)0,1,30,4,&tid);
    IIwritio(0,(short *)0,1,32,0,(char *)"and pp_procid2=");
    IIputdomio((short *)0,1,30,4,&tidx);
    IIsyncup((char *)0,0);
    if (sqlca.sqlcode < 0) 
      Clean_Up();
  }
/* # line 6771 "duvechk.sc" */	/* host code */
	    /* delete dbproc's query text */
/* # line 6773 "duvechk.sc" */	/* delete */
  {
    IIsqInit(&sqlca);
    IIwritio(0,(short *)0,1,32,0,(char *)
"delete from iiqrytext where txtid1=");
    IIputdomio((short *)0,1,30,4,&qtxtid1);
    IIwritio(0,(short *)0,1,32,0,(char *)"and txtid2=");
    IIputdomio((short *)0,1,30,4,&qtxtid2);
    IIsyncup((char *)0,0);
    if (sqlca.sqlcode < 0) 
      Clean_Up();
  }
/* # line 6775 "duvechk.sc" */	/* host code */
	    /* delete the description of the dbproc itself */
/* # line 6777 "duvechk.sc" */	/* delete */
  {
    IIsqInit(&sqlca);
    IIcsDelete((char *)"iiprocedure",(char *)"dbp_cleanup_cursor",6272,19158);
    if (sqlca.sqlcode < 0) 
      Clean_Up();
  }
/* # line 6778 "duvechk.sc" */	/* host code */
	}
	else
	{
	    dbp_mask &= ~(DB_DBPGRANT_OK | DB_ACTIVE_DBP | DB_DBP_INDEP_LIST);
/* # line 6782 "duvechk.sc" */	/* update */
  {
    IIsqInit(&sqlca);
    IIwritio(0,(short *)0,1,32,0,(char *)
"update iiprocedure set dbp_mask1=");
    IIputdomio((short *)0,1,30,4,&dbp_mask);
    IIwritio(0,(short *)0,1,32,0,(char *)", dbp_ubt_id=0, dbp_ubt_idx=\
0");
    IIcsERplace((char *)"dbp_cleanup_cursor",6272,19158);
    if (sqlca.sqlcode < 0) 
      Clean_Up();
  }
/* # line 6785 "duvechk.sc" */	/* host code */
	}
    }
    /*
    ** DBEVENTS
...
/* # line 6794 "duvechk.sc" */	/* delete */
  {
    IIsqInit(&sqlca);
    IIwritio(0,(short *)0,1,32,0,(char *)
"delete from iiprotect where exists(select 1 from session.cleanup_tbl \
where obj_id=protabbase and obj_idx=protabidx and obj_type=");
    IIputdomio((short *)0,1,30,4,&event_type);
    IIwritio(0,(short *)0,1,32,0,(char *)")");
    IIsyncup((char *)0,0);
    if (sqlca.sqlcode < 0) 
      Clean_Up();
  }
/* # line 6801 "duvechk.sc" */	/* host code */
    /* delete descriptions of dbevents */
/* # line 6803 "duvechk.sc" */	/* delete */
  {
    IIsqInit(&sqlca);
    IIwritio(0,(short *)0,1,32,0,(char *)
"delete from iievent where exists(select 1 from session.cleanup_tbl wh\
ere obj_id=event_idbase and obj_idx=event_idx and obj_type=");
    IIputdomio((short *)0,1,30,4,&event_type);
    IIwritio(0,(short *)0,1,32,0,(char *)")");
    IIsyncup((char *)0,0);
    if (sqlca.sqlcode < 0) 
...
/* # line 6810 "duvechk.sc" */	/* host code */
    /*
    ** some objects were dropped - flush the RDF cache
    */
/* # line 6813 "duvechk.sc" */	/* set */
  {
    IIsqInit(&sqlca);
    IIwritio(0,(short *)0,1,32,0,(char *)"set trace point rd2");
    IIsyncup((char *)0,0);
    if (sqlca.sqlcode < 0) 
      Clean_Up();
  }
/* # line 6814 "duvechk.sc" */	/* host code */
}
/*
[@function_definition@]...
*/
