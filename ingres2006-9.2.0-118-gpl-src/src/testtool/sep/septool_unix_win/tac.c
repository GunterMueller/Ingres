#ifndef lint
static char sccsid[] = "@(#)tac.c	1.4 6/5/86";
#endif
 ...
 *
 * 28-jan-1994 (donj)
 *    implemented (rcs)'s change to tac.c in ingres63p (271888)
 * 28-Feb-1994 (fredv)
 *    Replaced bcopy() by strncpy().
 * 16-Oct-1995 (somsa01)
 *    Ported to NT_GENERIC platforms - added definition of SIGHUP.
 */
