...
if 
	...
	cp $II_SYSTEM/ingres/files/eqsqlcag.a $scratch &&
...
then
    ...
    if
    	...
    	ada $II_SYSTEM/ingres/files/eqsqlcag.a &&
    	ada $II_SYSTEM/ingres/files/eqsqlda.a
    then :
    else
        echo "ERROR: 'ada' could not compile eqdef.a, eqsqlca.a, eqsqlcag.a, or eqsqlda.a"
        exit 1
    fi
else
if (
