...
#if defined(su4_us5)	/* plus solaris */
#include <fcntl.h>
#include <sgtty.h>
#include <termios.h>
#include <eti.h>
...
#else
#if defined(nc4_us5) || defined(hp3_us5) || defined(hp8_us5)
	/* We want to setup the proper Handlers just before we unblock. */
	extern VOID alarm_handler();
	ACsetupHandlers();
	signal(SIGALRM, alarm_handler);
#endif /* nc4_us5 ... */
#if defined(su4_us5) || defined(sui_us5) || defined(sos_us5) || \
...
i4  flags;
{
#if defined(hp3_us5) || defined(hp8_us5)
	long newmask = 0;
#else
#if defined(su4_us5) || defined(sui_us5) || defined(sos_us5) || \
    defined(a64_sol)
	...
	if (flags & CHILD)
#if defined(su4_us5) || defined(sui_us5) || defined(a64_sol)
...
#endif
#if defined(sqs_ptx) || defined(su4_us5) || defined(sui_us5) \
 || defined(sos_us5) || defined(rmx_us5) || defined(rux_us5) \
 || defined(usl_us5) || defined(a64_sol)
	sigprocmask(SIG_BLOCK, &newmask, 0);
#else
	sigblock(newmask);
#endif /* not sqs_ptx nor su4_us5 nor sui_us5 nor sos_us5 */
} /* ACblock */

# if defined(su4_us5) || defined(a64_sol)
...
#if defined(sqs_ptx) || defined(ts2_us5)
	while( (pid=(int)wait(&status)) > 0 )
#define	GOT_WAIT
#endif /* sqs_ptx ts2_us5 */
#if defined(su4_us5) || defined(ris_us5) || defined(rs4_us5) \
 || defined(hp8_us5) || defined(sui_us5) || defined(rmx_us5) \
 || defined(rux_us5) || defined(ris_u64) || defined(a64_sol)
...
#if defined(hp3_us5) || defined(hp8_us5) || defined(LNX)
