...
$ wrs "$ !"
$ wrs "$ run		:== @ii_system:[tools.utility]run.com"
$ wrs "$ ferun		:== @ii_system:[tools.utility]run.com"
$ wrs "$ tmrun		:== @ii_system:[tools.utility]run.com"
$ wrs "$ qasetuser	:== $ii_system:[tools.bin]setuser.exe"
$ wrs "$ qasetuserfe	:== $ii_system:[tools.bin]setuser.exe"
$ wrs "$ qasetusertm	:== $ii_system:[tools.bin]setuser.exe"
$ wrs "$ !"
$ !
$ return
$ !
