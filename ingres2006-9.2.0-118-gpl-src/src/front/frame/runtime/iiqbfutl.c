...
*/
bool
IIrvalid(formname, bffunc, bfvalue, dml_level)
char	*formname;
STATUS	(*bffunc)();
PTR	bfvalue;
i4	dml_level;
...
STATUS
IIrngget(fieldname, colname, dbtblname, dbcolname, dml_level, prefix,
	func, func_param)
char	*fieldname;
char	*colname;
char	*dbtblname;
