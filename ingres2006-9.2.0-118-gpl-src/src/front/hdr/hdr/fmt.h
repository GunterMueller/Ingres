...
/* function prototypes */
/* dateutil.c */
FUNC_EXTERN	i4  f_dayofyear(i4, i4  ,nat);
FUNC_EXTERN	i4 f_daysince1582(i4 ,nat ,nat) ;
FUNC_EXTERN	i4 f_monthdayofmonth(i4 ,nat ,PTR,PTR);
FUNC_EXTERN	    f_yearmonthdayofmonth(i4 ,PTR,PTR,PTR);
/* fmcvt.c */
FUNC_EXTERN	STATUS fmt_cvt(PTR,PTR,PTR,PTR,bool,nat);
FUNC_EXTERN	STATUS fcvt_sql(PTR,PTR,PTR,PTR,bool,nat,nat,PTR);
/* fmdeffmt.c */
FUNC_EXTERN	STATUS fmt_ideffmt(PTR,PTR,nat,bool,PTR,PTR,PTR);
FUNC_EXTERN	STATUS fmt_sdeffmt(PTR,PTR,nat,bool,PTR,PTR,PTR);
FUNC_EXTERN	STATUS fmt_deffmt(PTR,PTR,nat,bool,PTR);
/* fmtutil.c */
FUNC_EXTERN	i4 f_getword(PTR,nat,PTR);
FUNC_EXTERN	i4 f_getnumber(PTR,nat,PTR);
FUNC_EXTERN	i4 f_formnumber(i4 ,nat ,PTR);
/* fmvcentr.c */
FUNC_EXTERN	void f_strctr(PTR,nat,PTR,nat);
/* fmvleft.c */
FUNC_EXTERN	void f_strlft(PTR,nat,PTR,nat);
/* fmvright.c */
FUNC_EXTERN	     f_strrgt(PTR,nat,PTR,nat);
/* fnt.c */
FUNC_EXTERN	i4 fmt_ntposition(PTR,nat,nat,nat);
/* fstring.c */
FUNC_EXTERN	i4  fmt_stvalid(PTR,PTR,nat,nat,PTR);
FUNC_EXTERN	i4  fmt_stposition(PTR,nat,nat);
FUNC_EXTERN	bool fmt_stmand(PTR,PTR,nat);
/* strutil.c */
FUNC_EXTERN	i4 f_lentrmwhite(PTR,nat);
FUNC_EXTERN	i4 f_Tstr(PTR,nat,PTR,nat);
FUNC_EXTERN	i4 f_strCformat(PTR,PTR,PTR,nat,bool);
FUNC_EXTERN	    f_revrsbuf(i4,bool,PTR);
FUNC_EXTERN	    f_wildcard(PTR,nat,nat,PTR);
#endif /* WIN16 */
