...
*/
static READONLY char ii_space[]           = ERx(" ");
static READONLY char ii_and[]             = ERx(" AND ");
static READONLY char ii_comma[]           = ERx(", ");
static READONLY char ii_semicolon[]       = ERx("; ");
static READONLY char ii_equals[]          = ERx("=");
static READONLY char ii_open[]           = ERx("(");
static READONLY char ii_close[]           = ERx(") ");
