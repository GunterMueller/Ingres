...
static READONLY char _and[] 		= ERx("AND");
static READONLY char _delete[] 		= ERx("delete");
static READONLY char _detail[] 		= ERx("detail");
static READONLY char _insert[] 		= ERx("insert");
static READONLY char _select[] 		= ERx("select");
static READONLY char _master[] 		= ERx("master");
static READONLY char _master_detail[] 	= ERx("master_detail");
static READONLY char _null[]   		= ERx("");
static READONLY char _repeat[] 		= ERx("repeated");
static READONLY char _noterm[] 		= ERx("noterm");
static READONLY char _repeated[] 	= ERx("REPEATED ");
static READONLY char _update[] 		= ERx("update");
