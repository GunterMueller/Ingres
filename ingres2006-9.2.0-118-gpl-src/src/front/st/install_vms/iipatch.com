...
##     08-jun-3005 (horda03) Bug 114647/INGINS323
##          Add JDBC package
...
$  THEN
$     ! Patching a GA installation, so remove the VERSION.REL and PATCH.DOC
$
$     WRITE open_file "$ DELETE II_SYSTEM:[INGRES]VERSION.REL;*
$     WRITE open_file "$ DELETE II_SYSTEM:[INGRES]PATCH.DOC;*
$  ENDIF
$
$  del_dir = ""
$
...
$  IF (F$SEARCH( "II_SYSTEM:[INGRES.UTILITY]IIMANINF.EXE" ) .EQS. "") .OR. -
      ( (mandir .EQS. "") .AND. (F$SEARCH( "II_SYSTEM:[INGRES.INSTALL]RELEASE.DAT") .EQS. "") )
$  THEN
...
$
$  IF F$EXTRACT(licensed_offset, 3, "''record'") .EQS. "YES"
$  THEN
...
$     file_open = 1
$     READ open_file ingres_version
$     READ open_file patch_level
$     CLOSE open_file
$     file_open = 0
$   ELSE
$
...
$   iigetres ii.'F$GETSYI("NODENAME").lnm.ii_installation ii_installation_value
$
$   say "Obtaining Ingres Installation ID..."
...
$
$   valid_pkgs   = "#BRIDGE#C2AUDIT#DBMS#ESQL#JDBC#NET#OLDMSG#OME#ORACLE#QR_RUN#QR_TOOLS#REP#RMS#SPATIAL#STAR#TM#VISPRO#"
...
$   pkg_VISPRO   = "[INGRES.UTILITY]VISIONTUTOR.COM"
$
$   always_copy = "[INGRES]PATCH.DOC,[INGRES]VERSION.REL,[INGRES.INSTALL]RELEASE.DAT"
$
