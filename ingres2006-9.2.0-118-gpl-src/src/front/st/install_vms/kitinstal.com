...
$ !
$ acnt_qualifiers="/pass=welcome/tq=40/prc=15/by=500000/pgfl=250000"
$ acnt_qualifiers=acnt_qualifiers+"/dio=200/bio=400/fillm=1000/astlm=200"
$ acnt_qualifiers=acnt_qualifiers+"/en=2048/jt=20000/maxd=0/priv=all"
...
$ VMI$CALLBACK ASK ingres_ok "Do you accept this license agreement" "Yes" B
$ if .not. ingres_ok
$ then
$    VMI$CALLBACK MESSAGE I NOLICENSE "You must answer 'yes' to continue with the Ingres r3 product install"
$    verbose=0
$    ok=0
$    s=VMI$_FAILURE
$    RETURN
...
$	GOSUB press_return
$ ENDIF
$ vms_ver=F$EXTRACT(F$LOCATE(",",VMI$VMS_VERSION)+1,3,VMI$VMS_VERSION)
$ IF "''vms_ver'".GES."''min_vms'" THEN RETURN
$ ! version too low - reformat version to "human" form for error message
$ min_vms="V"+F$EXTRACT(1,1,min_vms)+"."+F$EXTRACT(2,2,min_vms)
