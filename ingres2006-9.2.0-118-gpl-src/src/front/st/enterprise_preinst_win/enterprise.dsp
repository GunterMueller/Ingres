...
# ADD LINK32 lic98mt.lib msi.lib version.lib /nologo /subsystem:windows /machine:I386 /out:"Release/install.exe" /libpath:"$(ING_SRC)\treasure\NT\CA_LIC\98\utils"
...
# ADD LINK32 lic98mtdbg.lib msi.lib version.lib /nologo /subsystem:windows /debug /machine:I386 /out:"Debug/install.exe" /pdbtype:sept /libpath:"$(ING_SRC)\treasure\NT\CA_LIC\98\utils"
...
# ADD BSC32 /nologo
LINK32=link.exe
# ADD BASE LINK32 msi.lib lic98mtdbg.lib /nologo /subsystem:windows /debug /machine:I386 /out:"Debug/install.exe" /pdbtype:sept /libpath:"$(ING_SRC)\treasure\NT\CA_LIC\98\utils"
# ADD LINK32 lic98mtdbg.lib msi.lib version.lib /nologo /subsystem:windows /debug /machine:I386 /out:"Debug64/install.exe" /libpath:"$(ING_SRC)\treasure\NT\CA_LIC\98\i64_win\utils" /machine:IA64
...
# ADD BSC32 /nologo
LINK32=link.exe
# ADD BASE LINK32 msi.lib lic98mt.lib /nologo /subsystem:windows /machine:I386 /out:"Release/install.exe" /libpath:"$(ING_SRC)\treasure\NT\CA_LIC\98\utils"
# ADD LINK32 lic98mt.lib msi.lib version.lib /nologo /subsystem:windows /machine:I386 /out:"Release64/install.exe" /libpath:"$(ING_SRC)\treasure\NT\CA_LIC\98\i64_win\utils" /machine:IA64
...
# ADD BSC32 /nologo
LINK32=link.exe
# ADD BASE LINK32 lic98mt.lib msi.lib version.lib /nologo /subsystem:windows /machine:I386 /out:"Release/install.exe" /libpath:"$(ING_SRC)\treasure\NT\CA_LIC\98\i64_win\utils" /machine:IA64
# ADD LINK32 lic98mt.lib msi.lib version.lib /nologo /subsystem:windows /machine:I386 /out:"ReleaseAMD64/install.exe" /libpath:"$(ING_SRC)\treasure\NT\CA_LIC\98\a64_win\utils" /machine:AMD64
...
# ADD BSC32 /nologo
LINK32=link.exe
# ADD BASE LINK32 lic98mtdbg.lib msi.lib version.lib /nologo /subsystem:windows /debug /machine:I386 /out:"Debug/install.exe" /libpath:"$(ING_SRC)\treasure\NT\CA_LIC\98\i64_win\utils" /machine:IA64
# ADD LINK32 lic98mtdbg.lib msi.lib version.lib /nologo /subsystem:windows /debug /machine:I386 /out:"DebugAMD64/install.exe" /libpath:"$(ING_SRC)\treasure\NT\CA_LIC\98\a64_win\utils" /machine:AMD64
# SUBTRACT LINK32 /pdb:none
