...
**	02-may-2002 (somsa01)
**	    In CSplashWnd::ShowSplashScreen(), Update the copyright static
**	    control. Otherwise, the copyright notice static control will
**	    not show itself on Windows 98 / ME when first created.
**	26-jul-2004 (penga03)
...
CSplashWnd::OnCtlColor(CDC* pDC, CWnd* pWnd, UINT nCtlColor) 
{
    ...
    /* Set the background mode transparent. */
