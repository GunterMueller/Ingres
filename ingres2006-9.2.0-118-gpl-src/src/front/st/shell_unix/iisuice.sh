...
# Need to setup II_CHARSETxx, so createdb can pick up the value. 
II_INSTALLATION=`ingprenv II_INSTALLATION`
CHARSET_VALUE=`ingprenv II_CHARSET$II_INSTALLATION`
export "II_CHARSET$II_INSTALLATION"="$CHARSET_VALUE"
