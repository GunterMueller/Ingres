...
# if defined(hp3_us5) || defined(hp8_us5) || defined(hp8_bls) || \
...
# if !(defined(ds3_ulx) || defined(hp3_us5) ||  defined(ris_u64) || \
	defined(hp8_us5) || defined(ris_us5) || defined (sqs_ptx) || \
        defined(rs4_us5) || defined(sgi_us5) || defined(usl_us5) || \
	defined(i64_aix) || defined(LNX) || defined(mg5_osx))
...
# if defined(hp3_us5) \
	|| defined(ds3_ulx) || defined(ris_us5) || defined(ris_u64) \
	|| defined(dr6_us5) || defined(usl_us5) || defined(i64_aix) \
	|| defined(axp_osf) || defined(su4_us5) || defined(hp8_us5) \
	|| defined(hp8_bls) || defined(rs4_us5) || defined(dg8_us5) \
...
/* Define semaphore and shared memory structures */
GLOBALDEF struct shminfo shminfo;
...
# if defined(dr6_us5) || defined(usl_us5) || defined(su4_us5) || \
...
# if defined(ris_u64) || defined(rs4_us5) || defined(i64_aix)
/*
...
struct _aix_shminfo
{
  ...
  i8    shmmax_p64;               /*  64-bit process for 32-bit kernel */
...
# define AIX_SHM_MAXSEG_REL3_K64       1048576
# define AIX_SEM_MAXSEMID              	 65535
# define AIX_SEM_MAXSET	        	131072
# define AIX_SEM_MAXSET_REL3_K64       1048576

# endif /* ris_u64 || rs4_us5 || i64_aix */

# if defined(su4_u42) || defined(axp_osf) || defined (a64_sol)
...
# if !(defined(hp3_us5) || defined(ds3_ulx) || \
      defined(hp8_us5) || defined(hp8_bls)  || \
...
# if !defined(su4_us5) && !defined(sos_us5) && !defined(sqs_ptx)
...
{
# if !defined(hp3_us5) && defined(RLIMIT_RSS) && !defined(hp8_us5) && \
     !defined(hp8_bls)
...
{
# if !defined(hp3_us5) && !defined(hp8_us5) && defined(RLIMIT_RSS) && \
     !defined(hp8_bls)
...
/* Vectors describing shared memory and semaphore info required */
static int shmmax[] = { CTL_KERN, KERN_SYSV, KSYSV_SHMMAX };
static int shmmni[] = { CTL_KERN, KERN_SYSV, KSYSV_SHMMNI };
static int shmall[] = { CTL_KERN, KERN_SYSV, KSYSV_SHMALL };
static int semmni[] = { CTL_KERN, KERN_SYSV, KSYSV_SEMMNI };
static int semmns[] = { CTL_KERN, KERN_SYSV, KSYSV_SEMMNS };
static int semmsl[] = { CTL_KERN, KERN_SYSV, KSYSV_SEMMSL };
...
find_symbols()
{
    ...
    if (sysctl(shmmax, VSIZE(shmmax), &(shminfo.shmmax), &len, 0, 0) )
    {
    ...
    len=sizeof(shminfo.shmmni);
    if (sysctl(shmmni, VSIZE(shmmni), &(shminfo.shmmni), &len, 0, 0) )
    {
    ...
    if (sysctl(shmall, VSIZE(shmall), &(shminfo.shmall), &len, 0, 0) )
    {
    ...
    if (sysctl(semmni, VSIZE(semmni), &(seminfo.semmni), &len, 0, 0) )
    {
    ...
    if (sysctl(semmni, VSIZE(semmns), &(seminfo.semmns), &len, 0, 0) )
    {
    ...
    if (sysctl(semmni, VSIZE(semmsl), &(seminfo.semmsl), &len, 0, 0) )
    {
 ...
 if ( !found )
  {
   ...
   /* for OS 5.3 and 64-bit kernel  */
 if(  aix_uname.release[0] == '3' && running_kernel == 64 )
   {
     shminfo.shmmni = AIX_SHM_MAXSEG_REL3_K64 ; 
     seminfo.semmni = AIX_SEM_MAXSET_REL3_K64 ; 
   }
 else
   {
...
}  /* end of find_symbols() for rs4_us5 */       
...
# elif defined(su4_us5) || defined(sui_us5)
...
# if defined(ris_us5) || defined(dr6_us5) || defined(usl_us5) || \
     defined(su4_us5) || defined(hp8_us5) || defined(hp8_bls) || \
...
find_symbols( void )
{
	...
	uint64_t   info = 0;
		...
		{       
			...
			shminfo.shmmax = (int)shminfo64.shmmax64;
			shminfo.shmmin = (int)shminfo64.shmmin64;
...
# if defined(ris_u64) || defined(rs4_us5) || defined(i64_aix) || \
     defined(LNX) || defined(a64_sol) || defined(su4_us5)
...
# if defined(rs4_us5) || defined(ris_u64) || defined(i64_aix) || \
     defined(LNX) ||  defined(a64_sol) || defined(su4_us5)
...
# endif /* ris_us5 || rs4_us5 || ris_u64 || i64_aix */
...
RLsysSharedNumSoft( char *buf )
{
	...
	STprintf(command,ERx("%ssyslim -used_segs"), SystemCfgPrefix);
...
RLsysSemaphoresSoft( char *buf )
{
	...
	STprintf(command,ERx("%ssyslim -used_sems"), SystemCfgPrefix);
	if( RLexec( command, buf ) != OK )
	{
		kmem_no_read = TRUE;
		return( FAIL );
...
# if defined(ris_us5) || defined(rs4_us5) || defined(ris_u64) || \
     defined(i64_aix) || defined(a64_sol) || defined(su4_us5) || \
     defined(LNX)

        CVla8( seminfo.semmni, buf);

# else /* ris_us5 || rs4_us5 || ris_u64 || i64_aix */
...
RLsysSemSetsSoft( char *buf )
{
	...
	STprintf(command,ERx("%ssyslim -used_sets"), SystemCfgPrefix);
	if( RLexec( command, buf ) != OK )
	{
		kmem_no_read = TRUE;
		return( FAIL );
...
#elif defined(a64_sol) || defined(su4_us5) || defined(LNX)
...
RLsysSwapSpaceHard( char *buf )
{
	...
	STprintf(command,ERx("%ssyslim -total_swap"), SystemCfgPrefix);
	if( RLexec( command, buf ) != OK )
	{
		kmem_no_read = TRUE;
		return( FAIL );
...
RLsysSwapSpaceSoft( char *buf )
{
	...
	STprintf(command,ERx("%ssyslim -free_swap"), SystemCfgPrefix);
	if( RLexec( command, buf ) != OK )
	{
		kmem_no_read = TRUE;
		return( FAIL );
...
# if !defined(ris_us5) && !defined(rs4_us5) && !defined(ris_u64) && \
     !defined(i64_aix) && !defined(a64_sol) && !defined(dg8_us5) && \
