...
# if defined(hpb_us5) || defined(sgi_us5)
# include <unistd.h>
# endif /* hpb_us5 */
...
char **argv;
{
	...
	bool bitsin = FALSE;
	bool genconf = FALSE;
#if defined(su4_us5) && !defined(LP64) && !defined(conf_ADD_ON64)
	bool bits32_64 = FALSE;
#endif /* su4_us5 && !LP64 && !conf_ADD_ON64 */
	LOCATION outloc;
...
#if defined(su4_us5) && !defined(LP64)
	if(BitsInKernel() == 64 )
        {
#if defined(conf_ADD_ON64)
    ...
    */
    ...
    else
    {
      bitsin = 32;
        ...
        defined(i64_hp2) ||  defined(axp_lnx) || \
	defined(a64_win)
