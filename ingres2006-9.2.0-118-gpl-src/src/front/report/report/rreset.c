...
i2	type;
{
	...
	case RP_RESET_CALL:
		...
		Err_ingres = NULL;	/* INGRES or EQUEL error number */
	...
	case RP_RESET_RELMEM4:
		...
		En_n_attribs = NULL;	/* number of attributes in data relation */
		En_n_sorted = NULL;	/* number of attributes in sort list */
		En_n_breaks = NULL;	/* number of breaks in report */
		En_lc_bottom = NULL;	/* number of lines in page footer */
		En_lc_top = NULL;	/* number of lines in page header */
	...
	case RP_RESET_RELMEM5:
		...
		St_brk_ordinal = NULL;	/* break order of current break. */
		...
		St_c_rblk = NULL;	/* report level of nesting of .BLK */
		St_c_pblk = NULL;	/* page level of nesting of .BLK */
		St_c_cblk = NULL;	/* current level of nesting of .BLK */
