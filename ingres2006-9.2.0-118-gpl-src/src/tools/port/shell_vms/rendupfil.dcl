...
$!
$   DNAME == P1
$   FDNAM =  f$getdvi(P1,"FULLDEVNAM")
$ Get_Loop:
$   if f$locate(f$extract(0,f$locate(":",DNAME),DNAME),FDNAM) .ne. f$length(FDNAM)
$   then
$       DEVNAME == "''f$extract(0,f$length(DNAME)-1,DNAME)'."
$       goto End_Get_Loop
$   else
$       RTSTR = f$trnlnm("''f$extract(0, f$locate(":",DNAME), DNAME)'")
$       DNAME = f$extract(f$locate("[",DNAME)+1, f$length(DNAME), DNAME)
$       DNAME = "''f$extract(0,f$length(RTSTR)-2,RTSTR)'.''DNAME'"
$       goto Get_Loop
$   endif
$ End_Get_Loop:
$   EXIT
