...
#include <aio.h>
#else
#if defined(su4_us5) || defined(usl_us5) || defined(rs4_us5) || \
  defined(axp_osf)  || defined(sui_us5) || defined(ris_u64) || \
  defined (sgi_us5) || defined(i64_aix) || defined(LNX) || \
  defined(a64_sol)
#include <aio.h>
#else
#if !defined(dgi_us5) && !defined(sgi_us5) && !defined(dg8_us5) && \
    !defined(rux_us5) && !defined(LNX) && !defined(mg5_osx)
union      notifyinfo {
...
# if defined(_ICLAIO_H) || defined(hpb_us5) || defined(LNX)
typedef struct aiocb aiocb_t;
#ifdef LARGEFILE64
...
#endif /* rs4_us5 ris_u64 i64_aix */

#if (defined(AIO_LISTIO_MAX) && (defined(ris_u64) || defined(rs4_us5) || \
     defined(axp_osf) || defined(i64_aix) ))
