...
# ifndef LNX
	...
	{
	    Cs_srv_block.cs_mt = FALSE;
#if defined (su9_us5) || defined(i64_hpu) || (defined(sgi_us5) && defined(LP64)) || (defined(rs4_us5) && defined(LP64)) || defined(a64_sol)
	    {
    	        /*
...
# define got1
            Cs_admin_scb.csa_scb.cs_pc = (long)CS_su4_setup - 4;
# endif
# if defined(sur_u42) || defined(sqs_ptx) || \
...
# if (defined(hp8_us5) || defined(hp8_bls)) && !defined(i64_hpu)
# define got1
...
# if defined(ris_us5) || defined(rs4_us5) || defined(ris_u64) || \
     defined(i64_aix) || defined(i64_lnx) || defined(a64_lnx)
...
#if defined(i64_hpu)
/* Internal threads not supported on HP Itanium 64-bit */
# define got1   /* nothing needed */
# endif /* i64_hpu */
...
*/
STATUS
CSdefine_lrregion(lrr_id, thread_count)
i4		   lrr_id;
i4		   thread_count;
{
    [@block_decl@]...
...
**	If there are threads awaiting this region, then they are restarted.
**
** Inputs:
...
# if !defined(xCL_011_USE_SIGVEC) && !defined(i64_aix)
    ...
    i4 offset, i4 size, PTR object, i4 lsbuf, char *sbuf )
{
    return (MOulongout( MO_VALUE_TRUNCATED,
		(u_i4) (Cs_srv_block.cs_wtstatistics.cs_bior_time +
		        Cs_srv_block.cs_wtstatistics.cs_biow_time),
		lsbuf, sbuf));
}
static STATUS
...
{
    return (MOulongout( MO_VALUE_TRUNCATED,
		(u_i4) (Cs_srv_block.cs_wtstatistics.cs_bior_waits +
		        Cs_srv_block.cs_wtstatistics.cs_biow_waits),
		lsbuf, sbuf));
}
static STATUS
...
{
    return (MOulongout( MO_VALUE_TRUNCATED,
		(u_i4) (Cs_srv_block.cs_wtstatistics.cs_bior_done +
		        Cs_srv_block.cs_wtstatistics.cs_biow_done),
		lsbuf, sbuf));
}

...
{
    return (MOulongout( MO_VALUE_TRUNCATED,
		(u_i4) (Cs_srv_block.cs_wtstatistics.cs_dior_time +
		        Cs_srv_block.cs_wtstatistics.cs_diow_time),
		lsbuf, sbuf));
}
static STATUS
...
{
    return (MOulongout( MO_VALUE_TRUNCATED,
		(u_i4) (Cs_srv_block.cs_wtstatistics.cs_dior_waits +
		        Cs_srv_block.cs_wtstatistics.cs_diow_waits),
		lsbuf, sbuf));
}
static STATUS
...
{
    return (MOulongout( MO_VALUE_TRUNCATED,
		(u_i4) (Cs_srv_block.cs_wtstatistics.cs_dior_done +
		        Cs_srv_block.cs_wtstatistics.cs_diow_done),
		lsbuf, sbuf));
}

...
{
    return (MOulongout( MO_VALUE_TRUNCATED,
		(u_i4) (Cs_srv_block.cs_wtstatistics.cs_lior_time +
		        Cs_srv_block.cs_wtstatistics.cs_liow_time),
		lsbuf, sbuf));
}
static STATUS
...
{
    return (MOulongout( MO_VALUE_TRUNCATED,
		(u_i4) (Cs_srv_block.cs_wtstatistics.cs_lior_waits +
		        Cs_srv_block.cs_wtstatistics.cs_liow_waits),
		lsbuf, sbuf));
}
static STATUS
...
{
    return (MOulongout( MO_VALUE_TRUNCATED,
		(u_i4) (Cs_srv_block.cs_wtstatistics.cs_lior_done +
		        Cs_srv_block.cs_wtstatistics.cs_liow_done),
		lsbuf, sbuf));
}

