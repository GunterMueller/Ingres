...
struct _CX_GLC_CTX
{
    ...
    CS_ASET		cx_glc_ready; 	 /* Cleared if CTX needs resume */
...
#   define	DLM_RD_VALIDATE \
    ...
    CS_SEMAPHORE	 cxvms_bli_sem;	/* Sem to single thread CXdlm_getbli. */
    PTR			 cxvms_bli_buf; /* Pointer to LKIDEF buffer. */
    i4			 cxvms_bli_size; /* Size of buffer in bytes */
