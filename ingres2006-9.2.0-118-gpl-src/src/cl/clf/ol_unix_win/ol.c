...
*/
/*
NO_OPTIM=ris_us5 rs4_us5 ris_u64 i64_aix
*/
...
# define	FSTRFAKE	8
    ...
    defined(hp8_us5) || defined(ris_us5) || \
    defined(sqs_ptx) || defined(pym_us5) || defined(su4_us5) || \
    defined(hp8_bls) || defined(rs4_us5) || defined(sui_us5) || \
    defined(rmx_us5) || defined(ner_us5) || defined(ts2_us5) || \
    defined(rux_us5) || defined(ris_u64) || defined(i64_aix)
# define	FSTR_RET		FSTRFAKE
#endif
...
# if defined (hp8_us5) || defined (dg8_us5) || defined(hp8_bls) || defined(dgi_us5)
	/* XXX Not sure if this is right XXX */
# define FLEN_BUNCHED_AT_END
#	define gotit
# endif

# if defined (x3b2_us5)		/* XXX Not sure this is right XXX */
	struct struct x3b_fchar
	{
		char *s;
		long len;
	}
#	define FLEN_STRUCT	struct x3b_fchar
#	define gotit
# endif
...
# if defined(ris_us5) || defined(ds3_ulx) || defined(rs4_us5) || \
     defined(ris_u64) || defined(i64_aix)
void load_float_reg()
{
}
...
# if defined(axp_osf) || defined(i64_hpu) || defined (i64_lnx)
	/*
...
# if defined(BYTE_ALIGN) && !defined(rs4_us5)	
			ap = (SCALARP *) ME_ALIGN_MACRO(ap, sizeof(ALIGN_RESTRICT));
# endif

# if (defined (hp5_us5) || defined (hp8_us5) || defined(hp8_bls)) && \
     !defined(i64_hpu)
...
# endif /* ris_us5 || ds3_ulx || rs4_us5 || ris_u64 || i64_aix */
...
# endif /* i64_hpu || i64_lnx */
	            ...
	            case 3:
	            case 4:
# if defined(ris_us5)|| defined(rs4_us5) || defined(ris_u64) || defined(i64_aix)
