...
static READONLY char sysin[] = ERx("SYS$INPUT");
static READONLY char sysout[] = ERx("SYS$OUTPUT");
static READONLY char syserr[] = ERx("SYS$ERROR");
...
*/
VOID
IIcompatmain(ifd_file, main_rtn)
...
int	*argc;		/* Number of words found (output) */
...
*/
static VOID except_handler(signal_array, mechanism_array)
i4 	signal_array[];
i4 	mechanism_array[];
{
