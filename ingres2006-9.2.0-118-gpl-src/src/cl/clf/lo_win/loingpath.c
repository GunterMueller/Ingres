...
i4	perms;
{
	...
	*/
	...
	if (!(*pfnAddAccessAllowedAceEx)(pACL, ACL_REVISION2,
	    CONTAINER_INHERIT_ACE, GENERIC_ALL, pSIDAdmins))
	{
	    status = GetLastError();
	    goto cleanup;
	}
    ...
    */
	...
	{
	    if (!(*pfnAddAccessAllowedAceEx)(pACL, ACL_REVISION2,
		CONTAINER_INHERIT_ACE, GENERIC_EXECUTE, pSIDOwner))
	    {
		status = GetLastError();
		goto cleanup;
	    }
	...
	{
	    if (!(*pfnAddAccessAllowedAceEx)(pACL, ACL_REVISION2,
		CONTAINER_INHERIT_ACE, GENERIC_READ, pSIDOwner))
	    {
		status = GetLastError();
		goto cleanup;
	    }
	...
	{
	    if (!(*pfnAddAccessAllowedAceEx)(pACL, ACL_REVISION2,
		CONTAINER_INHERIT_ACE, GENERIC_WRITE, pSIDOwner))
	    {
		status = GetLastError();
		goto cleanup;
	    }
    ...
    */
	...
	{
	    if (!(*pfnAddAccessAllowedAceEx)(pACL, ACL_REVISION2,
		CONTAINER_INHERIT_ACE, GENERIC_EXECUTE, pSIDEveryone))
	    {
		status = GetLastError();
		goto cleanup;
	    }
	...
	{
	    if (!(*pfnAddAccessAllowedAceEx)(pACL, ACL_REVISION2,
		CONTAINER_INHERIT_ACE, GENERIC_READ, pSIDEveryone))
	    {
		status = GetLastError();
		goto cleanup;
	    }
	...
	{
	    if (!(*pfnAddAccessAllowedAceEx)(pACL, ACL_REVISION2,
		CONTAINER_INHERIT_ACE, GENERIC_WRITE, pSIDEveryone))
	    {
		status = GetLastError();
		goto cleanup;
	    }
