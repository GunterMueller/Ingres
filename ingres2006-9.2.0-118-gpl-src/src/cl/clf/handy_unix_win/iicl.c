...
# if defined(hpb_us5) || defined(su4_us5)
# include   <netdb.h>
# endif /* hpb_us5 */
# if defined(hpb_us5)
	extern int h_errno;
...
# if defined(axp_osf) || defined(hpb_us5) || defined(mg5_osx)
# define have_readdir_r
    int status;
    struct dirent *return_dirent;
    status = readdir_r(dirp, readdir_buf, &return_dirent);
...
# if defined(axp_osf) || defined(hpb_us5) || defined(ris_u64) || \
     defined(rs4_us5) || defined(i64_aix) || defined(mg5_osx)
# define have_getpwnam_r
...
# if defined(axp_osf) || defined(hpb_us5) || defined(ris_u64) || \
     defined(rs4_us5) || defined(i64_aix) || defined(i64_lnx) || \
     defined(mg5_osx)
# define have_getpwuid_r
    int status;
    struct passwd *return_pwd;
...
# if defined(usl_us5) || defined(dg8_us5) || defined(dgi_us5) || \
     defined(sgi_us5) || defined(mg5_osx)
{ 
# define have_gethostbyname_r
...
# if defined(rs4_us5) || defined(axp_osf) || defined(ris_u64) || \
  defined(i64_aix)
# define have_fcvt_r
    int status;
    ...
    return(buf);
#endif /* rs4_us5 || axp_osf || ris_u64 || i64_aix */
...
# define have_fcvt_r
    {
    gen_Psem(&CL_misc_sem);
    buf = (char *)fcvt(value, ndigit, decpt, sign);
    gen_Vsem(&CL_misc_sem);
...
# if defined(ris_u64) || defined(i64_aix) || defined(rs4_us5) || \
     defined(LNX) || defined(mg5_osx)
     if ( ttyname_r (filedes, buf, size) == 0 )
#  else
    if ((retbuf = (char*)ttyname_r (filedes, buf, size)) != NULL) 
#  endif  /* ris_u64 || i64_aix */
    {
        status = OK;
    }
# else
