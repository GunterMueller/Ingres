...
deprecated_funcs:
    ...
    */        
    hp = iiCLgethostbyname( hostname, &lhostent, &hostbuf,
...
# if defined(su4_us5) || defined(rs4_us5) || defined(ris_u64) || \
  defined(i64_aix) || defined(su9_us5)
...
# else
                hp1 = gethostbyaddr((const char *)&addr, sizeof(struct in_addr),
                    AF_INET);
# endif /* defined(su4_us5) || defined(rs4_us5) || defined(ris_u64) || */
/*         defined(i64_aix) || defined(su9_us5) */
