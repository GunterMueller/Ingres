...
# include   <clsigs.h>
# include   <cs.h>
# if defined(ris_us5) || defined(ts2_us5) || defined(sgi_us5) || defined(sui_us5)
# include   <fdset.h>
# endif /* ris_us5 ts2_us5 ... */
# include   <csev.h>
# include   <cssminfo.h>
# include   <di.h>
# include   <me.h>
...
# if !defined(LARGEFILE64) && ( defined(su4_us5) || defined(sui_us5) )
...
# endif /* OS_THREADS_USED */
    ...
    if ( aioFreeList == (DI_AIOCB *)NULL )
    {
        ...
        newspace = (DI_AIOCB *)MEreqmem(NULL, 
    ...
    CL_ERR_DESC *err_code)
{
    ...
    DI_AIOCB * aio;
#if !defined(rs4_us5) && !defined(sui_us5)
    char *iobuf = buf;
    ...
    */
    /* lint truncation warning if size of ptr > int, but code valid */
    if (fisraw((i4)diop->di_fd) && ((i4)buf & (IO_ALIGN - 1)) )
    {
...
# endif /* OS_THREADS_USED */
    ...
    if ( tptr == NULL)
    {
        ...
        newone = (DI_LISTIOCB *)MEreqmem(NULL, 
