...
# endif /* rux_us5*/
# if defined(rs4_us5) || defined(sgi_us5) || defined(hpb_us5) || \
     defined(rux_us5) || defined(ris_u64) || defined(i64_aix) || \
     defined(axp_osf) || defined(LNX) || defined(mg5_osx)
...
#if defined (su4_us5) || defined(hp8_us5) || defined (sui_us5) || \
    defined (su9_us5) || defined (DGUX) || defined (axp_osf) || \
    defined(a64_sol)
