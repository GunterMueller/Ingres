...
# include <thread.h>
# endif /* SYS_V_THREADS */
# if defined(su4_us5) || defined(a64_sol) || (defined(hpb_us5) && !defined(i64_hpu) && !defined(ADD_ON64))
# include    <sys/lwp.h>
# endif /* need lwp.h */
# ifdef POSIX_THREADS
# include <mecl.h>
...
**	    hhFor axm_vms use __ATOMIC_EXCH_LONG for CS_TAS, CS_ACLR.
...
*/
#define			CS_THREAD_MIN_STACK	131072
...
#if defined(su4_us5) || defined(axp_osf) || defined(dg8_us5) \
 || defined(dgi_us5) || defined(sgi_us5) || defined(hpb_us5) \
 || defined(rs4_us5) || defined(ris_u64) || defined(LNX) \
 || defined(i64_aix) || defined(a64_sol) || defined(mg5_osx)
...
#endif /* DCE_THREADS */
#endif /* su4_us5 axp_osf dg8_us5 dgi_us5 sgi_us5 hpb_us5 rs4_us5 ris_u64 Linux */
...
*/
#if defined(xCL_SYS_PAGE_MAP) || !defined(OS_THREADS_USED)
...
# if defined(su4_us5) || defined(rs4_us5)
#   define CS_yield_thread()    sleep(0)
# else /* su4_us5 */
# if defined(axp_osf) || defined(hpb_us5) || defined(ris_u64) || \
     defined(i64_aix) || defined(a64_sol) || defined(LNX) || \
     defined(mg5_osx)
...
#if defined(LNX) && defined(OS_THREADS_USED)
...
# if defined(ris_us5) || ( defined(rs4_us5) && !defined(ADD_ON64) ) || \
     defined(mg5_osx) || defined(ppc_lnx)
...
#if defined(ris_u64) || ( defined(rs4_us5) && defined(ADD_ON64) )
    PTR         cs_exsp;                /* exception stack pointer */
    long        cs_pc;                  /* aka LR (link register)  */
...
# if defined(su4_u42) || defined(dr6_us5) || \
     defined(su4_us5) || defined(su4_cmw) || defined(i64_aix)
...
# if defined(sun_u42) || defined(hp3_us5)
    short	    cs_psl;		/* 680x0 Processor status word */
    short	    cs_dummy;		/* we want to align things */
    long	    cs_pc;		/* 680x0 PC - information only */
    long            cs_registers[16];   /* 680x0 register set */
#define                 CS_DO	0	/* really exception stack */
#define			CS_D1	1
#define			CS_D2	2
#define			CS_D3	3
#define			CS_D4	4
...
# if defined(sco_us5) || defined(sqs_ptx) || defined(usl_us5) || \
     ...
     defined(a64_lnx) || defined(int_rpl)
...
#define			CS_CLEANUP_MASK    0x1000   /* Must cleanup user
    ...
    i4	    	    cs_cputime;		/* cputime of this thread (10ms) */
...
# if defined(su4_u42) || defined(su4_us5) || defined(su4_cmw) || \
     defined(a64_sol)
# define cs_aset_type
...
# if defined(rs4_us5) || defined(ris_u64)
# define cs_aset_type
typedef int                    		CS_ASET;
# endif /* rs4_us5 ris_u64 */
...
# if defined(axp_osf) || defined(axp_lnx) || defined(a64_lnx) || \
     defined(i64_lnx) || defined(ppc_lnx) || defined(int_lnx) || \
     defined(int_rpl)
# define cs_aset_type
...
# if defined(su4_us5) || defined(sui_us5) || defined(usl_us5)
...
# define        CS_SPININIT(s)          (MEfill(sizeof(*s),'\0',(char *)s))
# endif /* OS_THREADS_USED */
# endif /* su4_us5 usl_us5 */

# if defined(su4_u42) || defined(sqs_ptx) || ((defined(int_lnx)  || \
     defined(int_rpl)) && !defined(a64_lnx)) || \
...
# if defined(rs4_us5) || defined(ris_u64)          /* AIX 4.1 SMP */
# define cs_aset_op
...
# endif /* rs4_us5 ris_u64 */    /* AIX 4.1 SMP */

/* Note that the assembler CS_tas return code value is flipped !! */
# if defined(i64_aix) || defined(i64_lnx)
# define cs_aset_op
...
# elif defined(axp_osf) || defined(su4_us5) || defined(su9_us5) || defined(a64_sol) || defined(a64_lnx)
...
{
#if defined(axm_vms) || defined(dgi_us5) || defined(dg8_us5)
    QUEUE	    cs_sem_list;	/* known sem list - must be first */
#endif /* axm_vms || dgi_us5 || dg8_us5 */
