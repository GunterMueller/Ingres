...
/* Allow this incorrect 0L in this one special case for convenience (fredv) */
#ifdef LARGE_MODEL
# define	NULL		0L
# define	NULLFUNC	0L
#endif

/* 0 is right everywhere else (fredv) */
#ifndef	NULL
# define	NULL		0
# define	NULLFUNC	0
#endif
...
/*
** In this CL, NULL is correctly defined as 0.  If you are on a machine
** with 16 bit ints and 32 bit pointers, 0L may be more convenient (daveb).
*/
...
/*
 * casting of addresses into u_i4 gives a bzillion lint errors on 
 * machines where size of ptr > nat.
 * 64-bit sgi reports a compile error when converting a PTR to an i4, but is ok
 * if the PTR is cast to long then to i4.
 */
# ifndef LINT 
# if defined(sgi_us5)
# define    CL_OFFSETOF(s_type,m_name) ((u_i4)(long)&(((s_type *) NULL)->m_name))
# else
# define    CL_OFFSETOF(s_type,m_name) ((u_i4)&(((s_type *) NULL)->m_name))
# endif /* sgi_us5 */
# else
# define    CL_OFFSETOF(s_type,m_name) 0
# endif /* LINT */
