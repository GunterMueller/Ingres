...
/* #defined above       LK_MULTITHREAD          0x8000L */
...
struct _LK_DSM
{
	...
	u_i4		    lock_cum_mode;  /* Cummulative request mode
	                                    ** for this request, and all
					    ** requests ahead of it on 
					    ** the resource. */
	i4		    lock_state;	    /* The state of the lock. */
	LK_UNIQUE    	    lockid;	    /* Distributed lockid of blocker */
	/* Info about the lock which triggered the search */
	u_i4		    o_lkb_id;	    /* LKB id of waiting resource. */
	LK_UNIQUE    	    o_lockid;	    /* Distributed lockid. */
	...
	LK_UNIQUE	    o_tran_id;	    /* The original transaction
					    ...
					    ** the deadlock search. */
	i4		    o_node;         /* The cluster node id of the 
					    ** original transaction. 
					    */
	u_i4		    o_stamp;	    /* The stamp of original 
					    ** transaction that starts the
					    ** original transaction. 
					    */
