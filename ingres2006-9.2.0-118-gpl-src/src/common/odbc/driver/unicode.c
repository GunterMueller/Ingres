...
#define CATALOG_NAME_WORK_NAME_LEN   100
    ...
    if (szWideName)
    {
        rc = ConvertWCharToChar(NULL,
           szWideName, (SQLINTEGER)cbWideName,              /* source */
              (char*)*szName, CATALOG_NAME_WORK_NAME_LEN,  /* target */
                       cbName, NULL, NULL);
        if (rc != SQL_SUCCESS)
        {
             *szName = NULL;
    ...
    SQLUSMALLINT     field3)
{
    ...
    SQLCHAR          szName1Buf[CATALOG_NAME_WORK_NAME_LEN];
    SQLCHAR          *szName1 = szName1Buf;
    SQLSMALLINT      cbName1 = 0;
    SQLCHAR          szName2Buf[CATALOG_NAME_WORK_NAME_LEN];
    SQLCHAR         *szName2 = szName2Buf;
    SQLSMALLINT      cbName2 = 0;
    SQLCHAR          szName3Buf[CATALOG_NAME_WORK_NAME_LEN];
    SQLCHAR         *szName3 = szName3Buf;
    SQLSMALLINT      cbName3 = 0;
    SQLCHAR          szName4Buf[CATALOG_NAME_WORK_NAME_LEN];
    SQLCHAR         *szName4 = szName4Buf;
    SQLSMALLINT      cbName4 = 0;
    SQLCHAR          szName5Buf[CATALOG_NAME_WORK_NAME_LEN];
    SQLCHAR         *szName5 = szName5Buf;
    SQLSMALLINT      cbName5 = 0;
    SQLCHAR          szName6Buf[CATALOG_NAME_WORK_NAME_LEN];
    ...
    SQLINTEGER       fFunction)
{
    ...
    if (fFunction == SQL_API_SQLPREPARE)
        rc = SQLPrepare_InternalCall(hstmt, (SQLCHAR*)szValue, (SDWORD)cbValue,
            FALSE);
...
{
    LPSTMT           pstmt = (LPSTMT)hstmt;
    char             szNameWk[CATALOG_NAME_WORK_NAME_LEN];
    SQLRETURN        rc, rc2;
    ...
    SQLUINTEGER          vParam)
{
    ...
    return(SQLSetConnectAttr_InternalCall(hdbc, fOption, 
                 (SQLPOINTER)vParam, StringLength));
}
