    ...
    SQLINTEGER  *pStringLength)
{
    ...
    case SQL_ATTR_KEYSET_SIZE:
            ...
            /* Number of rows in the keyset for a keyset-driven cursor */
        *pvParamulen = (SQLUINTEGER)pstmt->cKeysetSize;   /* SQLExtendedFetch option ignored */
        break;
...
/*  case SQL_ATTR_MAX_ROWS: */
    ...
    case SQL_ROWSET_SIZE:
        ...
        *pvParamuint = (SQLUINTEGER)pstmt->cRowsetSize;  
        break;
...
{
    LPDBC         pdbc   = (LPDBC)hdbc;
    SQLUINTEGER       vParamulen = (SQLUINTEGER)    pValue;
...
*/
    ...
    case SQL_MAX_LENGTH:
        /*
        **  Truncation of DBCS data embedded in CHAR types can
        **  make the data unusable, so disable truncation:
        */
        if (pdbc->fOptions & OPT_DBCS)
            return ErrUnlockDbc(SQL_HYC00, pdbc); /* optional feature not implemented */
    ...
    case SQL_ROWSET_SIZE:               /* kludge for VInterdev, per thoda04... */
        pdbc->cRowsetSize   = vParamuint;   /* ignored... */
        break;
    ...
    case SQL_BIND_TYPE:                 /* SQLExtendedFetch option ignored */
        pdbc->cBindType     = vParamuint;
        break;

    case SQL_KEYSET_SIZE:               /* SQLExtendedFetch option ignored */
        pdbc->cKeysetSize   = vParamulen;
        break;
    ...
    case SQL_CURSOR_TYPE:
        if (vParamuint != SQL_CURSOR_FORWARD_ONLY)
            return ErrUnlockDbc (SQL_01S02, pdbc);
        break;
    ...
    SQLUINTEGER vParam)
{
    ...
    return(SQLSetConnectAttr_InternalCall(hdbc, fOption, 
                 (SQLPOINTER)(SQLUINTEGER)vParam, StringLength));
}
...
/*          SQL_OV_ODBC2
            ...
            SQL_OV_ODBC3
               ...
               The CatalogName argument in a call to SQLTables 
                  accepts a search pattern. */
        penv->ODBCVersion = (i2)(SQLINTEGER)ValuePtr;
        break;
    ...
    SQLINTEGER StringLength)
{
    ...
    SQLUINTEGER      vParamulen = (SQLUINTEGER)ValuePtr;
    RETCODE      rc     = SQL_SUCCESS;
    LPDESC       pdesc;
    ...
    case SQL_ATTR_CURSOR_SCROLLABLE:
            ...
            /* SQL_NONSCROLLABLE - scrollable cursors are not required (default)
               SQL_SCROLLABLE    - scrollable cursors are required */
        if (vParamulen != SQL_NONSCROLLABLE)
    ...
    case SQL_ATTR_CURSOR_TYPE:
            ...
            /* SQL_CURSOR_FORWARD_ONLY - cursor only scrolls forward (default)
               ...
               SQL_CURSOR_DYNAMIC      - driver saves/uses only keys of rowset
               SQL_CURSOR_STATIC       -result set data static  */
        if (vParamulen != SQL_CURSOR_FORWARD_ONLY)
            return ErrUnlockStmt (SQL_01S02, pstmt);
        break;
...
/*  case SQL_ATTR_IMP_ROW_DESC:             cannot set, only get */
    ...
    case SQL_ATTR_KEYSET_SIZE:
            ...
            /* Number of rows in the keyset for a keyset-driven cursor */
        pstmt->cKeysetSize   = vParamulen;   /* SQLExtendedFetch option ingnored */
        break;
    ...
    case SQL_ROWSET_SIZE:
            ...
            /* number of rows in 2.x SQLExtendedFetch rowset (default=1) */
        pstmt->cRowsetSize   = vParamulen;  /* ignored... */
        break;
