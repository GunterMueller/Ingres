...
*/
static const char INI_ACCESSIBLE[]    = KEY_ACCESSIBLE;
static const char INI_ACCT_PROMPT[]   = KEY_ACCT_PROMPT;
static const char INI_AUTOCOMMIT[]    = KEY_AUTOCOMMIT;
static const char INI_CACHE[]         = KEY_CACHE_TABLES;
static const char INI_CATTABLE[]      = KEY_VIEW;
static const char INI_COMMIT[]        = KEY_COMMIT_BEHAVIOR;
static const char INI_CUSTOM[]        = KEY_CUSTOM;
static const char INI_DBCS[]          = KEY_DBCS_TYPE;
static const char INI_DESCRIPTION[]   = KEY_DESCRIPTION;
static const char INI_DICTIONARY[]    = KEY_DICTIONARY;
static const char INI_ENABLE_ENSURE[] = KEY_ENABLE_ENSURE;
static const char INI_FETCH[]         = KEY_ROWS;
static const char INI_FETCHDOUBLE[]   = KEY_DOUBLE;
static const char INI_NODE[]          = KEY_NODE;
static const char INI_READONLY[]      = KEY_READONLY;
static const char INI_RESOURCE[]      = KEY_RESOURCE;
static const char INI_SERVER[]        = KEY_SERVER;
static const char INI_SERVERS[]       = KEY_SERVERS;
static const char INI_TASK[]          = KEY_TASK;
static const char INI_TIMEOUT[]       = KEY_TIMEOUT;
static const char INI_TEMP_DSN[]      = KEY_TEMP_DSN;
static const char INI_TEMP_SERVER[]   = KEY_TEMP_SERVER;
static const char INI_TXNISOLATION[]  = KEY_TXNISOLATION;
...
RETCODE AllocConnect(LPENV  penv, LPDBC  *ppdbc)
{
    ...
    */
    ...
    pdbc->cRowsetSize   = SQL_ROWSET_SIZE_DEFAULT;
    pdbc->cBindType     = SQL_BIND_TYPE_DEFAULT;
    pdbc->cKeysetSize   = SQL_KEYSET_SIZE_DEFAULT;
    pdbc->cRetrieveData = SQL_RD_DEFAULT;
/*  pdbc->fMetadataID   = SQL_FALSE; */
/*  pdbc->fAsyncEnable  = SQL_ASYNC_ENABLE_DEFAULT; (default=OFF=0) */
