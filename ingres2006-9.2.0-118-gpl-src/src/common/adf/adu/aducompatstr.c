...
DB_DATA_VALUE       *rdv)
{
    ...
    */
	...
	db_stat = adu_movestring(adf_scb, &buf[0], outlen, rdv);
...
DB_DATA_VALUE	    *rdv)
{
    ...
    */
    localstatus = adu_movestring(adf_scb, buf, outlength, rdv);
...
DB_DATA_VALUE	    *rdv)
{
    ...
    return (adu_movestring(adf_scb, (u_char *) instart, len, rdv));
}
