...
**	in ADF. 
**
**          adu_error() -	format an error msg for an ADF error code
...

/*{
** Name: adu_error()	-   format an error message for an ADF error code and
...
/*VARARGS3*/
DB_STATUS
adu_error(adf_scb, adf_errorcode, pcnt, p1, p2, p3, p4, p5, p6)
ADF_CB		    *adf_scb;
i4             adf_errorcode;
i4		    pcnt;
i4		    p1;
...
PTR		    p6;
{
    ...
    */
	...
	return (adu_error(adf_scb, E_AD1025_BAD_ERROR_NUM, 2,
