...
#define ADFI_164_LOCATE_STR_STR       (ADI_FI_ID)164 /* locate(str,str) */
...
#define ADFI_371_HEX_C                (ADI_FI_ID)371 /* hex(c) */
...
#define ADFI_831_UNHEX_C              (ADI_FI_ID)831 /* unhex(c) */
...
#define ADFI_845_STDDEV_SAMP_FLT      (ADI_FI_ID)845 /* stddev_samp(flt, flt) */
...
#define ADFI_1058_NVCHAR_TO_LONGTEXT    (ADI_FI_ID)1058 /* longtext(nvarchar) */
#define ADFI_1059_LONGTEXT_TO_NVCHAR    (ADI_FI_ID)1059 /* nvarchar(longtext) */
...
#define ADFI_1070_LONGNVCHAR_TO_LONGTEXT (ADI_FI_ID)1070 /* longtext(long_nvarchar) */
#define ADFI_1071_LONGTEXT_TO_LONGNVCHAR (ADI_FI_ID)1071 /* long_nvarchar(longtext) */
