...
#define		AD_3LIKE_LBRAC  ((u_char)'[')  /* If escaped, use for range */
#define		AD_4LIKE_RBRAC  ((u_char)']')  /* If escaped, use for range */
...
typedef struct _ADI_DATATYPE
{
    ...
    i4		    unused;		/* Unused. */
    ADI_DT_BITMASK  adi_dtcoerce;       /* Datatypes this datatype can be
					** coerced to.
					*/
...
FUNC_EXTERN DB_STATUS adu_error();      /* Routine used internally by ADF to
					** error handling, including message
					** formatting.  This routine is 
