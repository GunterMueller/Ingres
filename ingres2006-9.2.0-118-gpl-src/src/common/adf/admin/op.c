...
static IIADD_DT_DFN   datatypes[] =
	...
	{ II_O_DATATYPE,
	    ...
	    0, usop_tmlen, usop_tmcvt, usop_dbtoev, 0, 0, 0
	},
	{ II_O_DATATYPE,
	    {"intlist"},
	    ...
	    0, usi4_tmlen, usi4_tmcvt, usi4_dbtoev, 0, 0, 0
	},
	{ II_O_DATATYPE,
	    {"complex"},
	    ...
	    0, uscpx_tmlen, uscpx_tmcvt, uscpx_dbtoev, 0, 0, 0
	},
	{ II_O_DATATYPE,
	    {"zchar"},
	    ZCHAR_TYPE, II_NODT,
	    ...
	    0, usz_tmlen, usz_tmcvt, usz_dbtoev, 0, 0, 0
	},
	{ II_O_DATATYPE,
	    {"pnum"},
	    PNUM_TYPE, II_NODT,
	    ...
	    0, usnum_tmlen, usnum_tmcvt, usnum_dbtoev, 0, 0, 0
	},
	{ II_O_DATATYPE,
	    {"long zchar"},
...
#ifdef __STDC__
	      (II_XFORM_FUNC *) uslz_xform, uslz_seglen
#else
	      uslz_xform, uslz_seglen
#endif
	},
	{ II_O_DATATYPE,
	    {"nvarchar"},
	    ...
	    0, vucs2_tmlen, vucs2_tmcvt, vucs2_dbtoev, 0, 0, 0
	},
    };

/*
