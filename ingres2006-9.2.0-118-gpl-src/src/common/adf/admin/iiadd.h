...
*/
#if !defined(ris_u64) && !defined(rs4_us5)
#ifndef INT_MIN
...
#endif
#endif   /* !defined(ris_u64) && !defined(rs4_us5) */
...
*/
#define			II_BOOLEAN	((II_DT_ID)  1)
    /*
    **  Boolean is used when a function returns merely an indicator
    **	of whether something worked or not...
    */
#define			II_DECIMAL	((II_DT_ID) 10)	 /* packed decimal */
...
#define			II_LVCH	    	((II_DT_ID) 22)  /* "long varchar" */
# define                II_BYTE     	((II_DT_ID) 23)  /* Byte */
# define                II_VBYTE    	((II_DT_ID) 24)  /* byte varying */
# define                II_LBYTE    	((II_DT_ID) 25)  /* Long byte */
# define                II_ALL_TYPE    	((II_DT_ID) 39)  /* All type */

    /* Internal datatype which looks like varchar.  All datatypes must be   */
    /* coercable to/from this datatype					    */
...
*/
#define       II_EQ_OP       (II_OP_ID)  8  /* Equal to "="                   */
#define       II_NE_OP       (II_OP_ID)  0  /* Not equal to "!="              */
#define       II_LT_OP       (II_OP_ID)  6  /* Less than "<"                  */
#define       II_LE_OP       (II_OP_ID)  7  /* Less than or equal to "<="     */
#define       II_GT_OP       (II_OP_ID)  9  /* Greater than ">"               */
#define       II_GE_OP       (II_OP_ID) 10  /* Greater than or equal to ">="  */
#define       II_PLUS_OP     (II_OP_ID) 74  /* Unary "+"                      */
#define       II_MINUS_OP    (II_OP_ID) 75  /* Unary "-"                      */
#define       II_ADD_OP      (II_OP_ID)  3  /* Binary "+"                     */
#define       II_SUB_OP      (II_OP_ID)  4  /* Binary "-"                     */
#define       II_MUL_OP      (II_OP_ID)  1  /* Binary "*"                     */
#define       II_DIV_OP      (II_OP_ID)  5  /* Binary "/"                     */
#define       II_POW_OP      (II_OP_ID)  2  /* Binary "**"                    */
...
#define	      II_COUNT_OP    (II_OP_ID)	38    /* "count"	*/
...
#define       II_LVCHAR_OP   (II_OP_ID) 131   /* "long_varchar"	*/
...
#define                 II_KALLMATCH   7    /* The value given will match    */
    ...
    II_DATA_VALUE    adc_hikey;		/* If adc_tykey = II_KHIGHKEY, this
                                        ...
                                        ** undefined.
                                        */
    unsigned char   adc_escape;		/* adc_escape is the escape char that
					** the user has specified for the LIKE
					** (or NOT LIKE) operator.  adc_escape
					** has valid info in it *ONLY* if
					** adc_isescape == TRUE.
                                        */
    char	    adc_isescape;	/* If adc_isescape is TRUE, then
					** adc_escape holds the escape char
					** that the user specified for the LIKE
					** (or NOT LIKE) operator.  If this is
					** FALSE, then the user either has not
					** given an escape clause for the LIKE
					** (or NOT LIKE) operator, or this is
					** not the LIKE (or NOT LIKE) op.
					*/
}   II_KEY_BLK;

/*}
...
**  	integral length followed by that number of characters.  For
