	...
	*/
	...
	break;
      ...
      case DB_UTF8_TYPE:
        ...
        /*
        ** For NVCHR data type, To calculate the internal size based on
...

/*
** Name: adc_2lenchk_bool() - Check validity of ADF internal datatype "boolean".
**
** Description:
**       This function is an internal implementation of the ADF call
**	"adc_lenchk".  It performs the same function as the external 
...
DB_DATA_VALUE	    *adc_rdv)
{
    ...
    if (adc_dv->db_datatype != DB_BOO_TYPE  ||  adc_is_usr)
	db_stat = adu_error(adf_scb, E_AD9999_INTERNAL_ERROR, 0);
    else if (adc_dv->db_length != sizeof(bool))
	db_stat = adu_error(adf_scb, E_AD2005_BAD_DTLEN, 0);
