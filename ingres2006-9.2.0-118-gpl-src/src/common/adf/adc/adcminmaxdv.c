...
DB_DATA_VALUE	    *adc_maxdv)
{
	...
	if (len == ADE_LEN_UNKNOWN)
	{
	    ...
	    {
	      case DB_BOO_TYPE:
		adc_mindv->db_length = sizeof(bool);
		break;
	...
	if (len == ADE_LEN_UNKNOWN)
	{
	    ...
	    {
	      case DB_BOO_TYPE:
		adc_maxdv->db_length = sizeof(bool);
		break;
		...
		break;
	      ...
	      case DB_NCHR_TYPE:
		case DB_NVCHR_TYPE:
		adc_mindv->db_length = DB_MAXSTRING;
		break;
	      ...
	      case DB_TMWO_TYPE:
       	      ...
       	      case DB_TME_TYPE:
        	{
	   	    AD_TIME *adtm = (AD_TIME *) data;
	     	    ...
	     	    adtm->dn_time = AD_40DTE_SECPERDAY;
	     	    adtm->dn_nsecond = AD_33DTE_MAX_NSEC;
	     	    adtm->dn_tzhour = AD_35DTE_MAX_TZ_HR;
	     	    adtm->dn_tzminute = AD_37DTE_MAX_TZ_MN;
        	}
        	break;
              ...
              case DB_TSTMP_TYPE:
               {
	            ...
	            atstmp->dn_month = 12;
	            atstmp->dn_day = 31;
	            atstmp->dn_time = AD_40DTE_SECPERDAY;
	            atstmp->dn_nsecond = AD_33DTE_MAX_NSEC;
	            atstmp->dn_tzhour = AD_35DTE_MAX_TZ_HR;
	            atstmp->dn_tzminute = AD_37DTE_MAX_TZ_MN;
               }
               break;
              ...
              case DB_INDS_TYPE:
               {
	            ...
	            aintds->dn_time = AD_40DTE_SECPERDAY;
