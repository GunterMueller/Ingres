...
i4		    *adc_outlen)
{
      ...
      case  DB_FLT_TYPE:
	{
	      ...
	      case 4:
		{
		    ...
		    CVfa((f8)f4tmp, adf_scb->adf_outarg.ad_f4width,
       ...
       case DB_NCHR_TYPE:
	{
	    ...
	    /* local_dv.db_data = adc_tmdv->db_data; */
	    ...
	    local_dv.db_prec = 0;
	    local_dv.db_datatype = DB_CHA_TYPE;

	    db_stat = adu_nvchr_coerce (adf_scb, adc_dv, &local_dv);

	    p = (u_char *) local_dv.db_data;
	    endp = (u_char *) local_dv.db_data + length;
