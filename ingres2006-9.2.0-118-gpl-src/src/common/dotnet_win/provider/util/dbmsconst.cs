...
namespace Ca.Ingres.Utility
{
	...
	**
	** Description:
	**	Interface defining the DBMS constants.
	**
	**  Constants:
	**
	...
	*/
	...
	internal class DbmsConst : GcfErr
	{
		...
		*/
		...
		public const byte  DBMS_PROTO_0 = 0;    	// Base level.
		public const byte  DBMS_PROTO_1 = 1;    	// Added decimal, byte, varbyte
		public const byte  DBMS_PROTO_2 = 2;    	// Added nchar, nvarchar
		public const short DBMS_TYPE_DATE = 3;
		...
		*/
		...
		{
			typeMap = new IdMap[]
			{	new IdMap(DbmsConst.DBMS_TYPE_DATE,       "date"),
				new IdMap(DbmsConst.DBMS_TYPE_MONEY,      "money"),
				new IdMap(DbmsConst.DBMS_TYPE_DECIMAL,    "decimal"),
				new IdMap(DbmsConst.DBMS_TYPE_CHAR,       "char"),
				new IdMap(DbmsConst.DBMS_TYPE_VARCHAR,    "varchar"),
				new IdMap(DbmsConst.DBMS_TYPE_LONG_CHAR,  "long varchar"),
				new IdMap(DbmsConst.DBMS_TYPE_BYTE,       "byte"),
				new IdMap(DbmsConst.DBMS_TYPE_VARBYTE,    "byte varying"),
				new IdMap(DbmsConst.DBMS_TYPE_LONG_BYTE,  "long byte"),
				new IdMap(DbmsConst.DBMS_TYPE_NCHAR,      "nchar"),
				new IdMap(DbmsConst.DBMS_TYPE_NVARCHAR,   "nvarchar"),
				new IdMap(DbmsConst.DBMS_TYPE_LONG_NCHAR, "long nvarchar"),
				new IdMap(DbmsConst.DBMS_TYPE_C,          "c"),
				new IdMap(DbmsConst.DBMS_TYPE_TEXT,       "text"),
				new IdMap(DbmsConst.DBMS_TYPE_LONG_TEXT,  "long text")
			};
			intMap = new IdMap[]
			{
