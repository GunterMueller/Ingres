...
# define IIAPI_EV_CANCEL_FUNC		((IIAPI_EVENT)  1)
# define IIAPI_EV_CATCHEVENT_FUNC	((IIAPI_EVENT)  2)
# define IIAPI_EV_CLOSE_FUNC		((IIAPI_EVENT)  3)
# define IIAPI_EV_COMMIT_FUNC		((IIAPI_EVENT)  4)
# define IIAPI_EV_CONNECT_FUNC		((IIAPI_EVENT)  5)
# define IIAPI_EV_DISCONN_FUNC		((IIAPI_EVENT)  6)
# define IIAPI_EV_GETCOLUMN_FUNC	((IIAPI_EVENT)  7)
# define IIAPI_EV_GETCOPYMAP_FUNC	((IIAPI_EVENT)  8)
# define IIAPI_EV_GETDESCR_FUNC		((IIAPI_EVENT)  9)
# define IIAPI_EV_GETEVENT_FUNC		((IIAPI_EVENT) 10)
# define IIAPI_EV_GETQINFO_FUNC		((IIAPI_EVENT) 11)
# define IIAPI_EV_MODCONN_FUNC		((IIAPI_EVENT) 12)
# define IIAPI_EV_POSITION_FUNC		((IIAPI_EVENT) 13)
# define IIAPI_EV_PRECOMMIT_FUNC	((IIAPI_EVENT) 14)
# define IIAPI_EV_PUTCOLUMN_FUNC	((IIAPI_EVENT) 15)
# define IIAPI_EV_PUTPARM_FUNC		((IIAPI_EVENT) 16)
# define IIAPI_EV_QUERY_FUNC		((IIAPI_EVENT) 17)
# define IIAPI_EV_ROLLBACK_FUNC		((IIAPI_EVENT) 18)
# define IIAPI_EV_SAVEPOINT_FUNC	((IIAPI_EVENT) 19)
# define IIAPI_EV_SCROLL_FUNC		((IIAPI_EVENT) 20)
# define IIAPI_EV_SETCONNPARM_FUNC	((IIAPI_EVENT) 21)
# define IIAPI_EV_SETDESCR_FUNC		((IIAPI_EVENT) 22)
# define IIAPI_EV_ABORT_FUNC		((IIAPI_EVENT) 23)
# define IIAPI_EV_XASTART_FUNC		((IIAPI_EVENT) 24)
# define IIAPI_EV_XAEND_FUNC		((IIAPI_EVENT) 25)
# define IIAPI_EV_XAPREP_FUNC		((IIAPI_EVENT) 26)
# define IIAPI_EV_XACOMMIT_FUNC		((IIAPI_EVENT) 27)
# define IIAPI_EV_XAROLL_FUNC		((IIAPI_EVENT) 28)
...
# define IIAPI_EV_ACCEPT_RCVD		((IIAPI_EVENT) 29)
# define IIAPI_EV_CFROM_RCVD		((IIAPI_EVENT) 30)
# define IIAPI_EV_CINTO_RCVD		((IIAPI_EVENT) 31)
# define IIAPI_EV_DONE_RCVD		((IIAPI_EVENT) 32)
# define IIAPI_EV_ERROR_RCVD		((IIAPI_EVENT) 33)
# define IIAPI_EV_EVENT_RCVD		((IIAPI_EVENT) 34)
# define IIAPI_EV_IACK_RCVD		((IIAPI_EVENT) 35)
# define IIAPI_EV_NPINTERUPT_RCVD	((IIAPI_EVENT) 36)
# define IIAPI_EV_PROMPT_RCVD           ((IIAPI_EVENT) 37)
# define IIAPI_EV_QCID_RCVD		((IIAPI_EVENT) 38)
# define IIAPI_EV_REFUSE_RCVD		((IIAPI_EVENT) 39)
# define IIAPI_EV_REJECT_RCVD		((IIAPI_EVENT) 40)
# define IIAPI_EV_RELEASE_RCVD		((IIAPI_EVENT) 41)
# define IIAPI_EV_RESPONSE_RCVD		((IIAPI_EVENT) 42)
# define IIAPI_EV_RETPROC_RCVD		((IIAPI_EVENT) 43)
# define IIAPI_EV_TDESCR_RCVD		((IIAPI_EVENT) 44)
# define IIAPI_EV_TRACE_RCVD		((IIAPI_EVENT) 45)
# define IIAPI_EV_TUPLE_RCVD		((IIAPI_EVENT) 46)
# define IIAPI_EV_GCN_RESULT_RCVD	((IIAPI_EVENT) 47)
# define IIAPI_EV_UNEXPECTED_RCVD       ((IIAPI_EVENT) 48)
...
# define IIAPI_EV_RESUME		((IIAPI_EVENT) 49)
# define IIAPI_EV_CONNECT_CMPL		((IIAPI_EVENT) 50)
# define IIAPI_EV_DISCONN_CMPL		((IIAPI_EVENT) 51)
# define IIAPI_EV_SEND_CMPL		((IIAPI_EVENT) 52)
# define IIAPI_EV_SEND_ERROR		((IIAPI_EVENT) 53)
# define IIAPI_EV_RECV_ERROR		((IIAPI_EVENT) 54)

# define IIAPI_EVENT_MAX		IIAPI_EV_RECV_ERROR
# define IIAPI_EVENT_CNT		(IIAPI_EV_RECV_ERROR + 1)
