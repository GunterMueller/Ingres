...
IIapi_deleteConnHndl( IIAPI_CONNHNDL *connHndl )
{
	...
	*/
    ...
    if ( connHndl->ch_target_display )  MEfree( (PTR)connHndl->ch_target_display );
...
IIapi_getConnIdHndl(IIAPI_CONNHNDL *connHndl, II_LONG type,  GCD_ID *gcaID)
{
    IIAPI_IDHNDL	*idHndl;
