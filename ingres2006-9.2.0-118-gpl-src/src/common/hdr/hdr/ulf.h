...
/* ule_format takes a variable number of arguments */
/*
** This prototype is here for checking that ule_format is called 
** in a way that is type correct for the first nine arguments. It should
** not be used for compiling code which is to be executed.
*/
...
#define ule_format TRdisplay("(%s, %d) ", __FILE__, __LINE__), ule_doformat
