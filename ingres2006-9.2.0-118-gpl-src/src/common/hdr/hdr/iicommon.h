...
**      contains two (2) members.  err_code will contain the code which 
**      identifies the error to the calling facility.  err_data can contain
**      other information which may be useful to the calling facility or to
**      the calling facility's programmer.
**
** History:
**     09-Dec-1985 (fred)
**          Created.
...
*/
#define	DB_NOCOLLATION		0
#define	DB_UNICODE_COLL		1
#define	DB_UNICODE_CASEINSENSITIVE_COLL	2
#define	DB_SQLCHAR_COLL		3
#define	DB_MULTI_COLL		4
#define	DB_SPANISH_COLL		5
#define DB_UNICODE_FRENCH_COLL	6

/*}
...
**
**        DB_BOO_TYPE         1        "boolean"
**                Datatype ID 1 is used for the internal "boolean" type.  This is
**                only used as the result type of the comparison function instances,
**                when executed via the adf_func() call.
**
...
**           Quel      Rank     SQL
**       ============  ====  ==========
**    -    Abstract     1    Abstract \__Managed in adirslv.c
**   /|\      UDT       2       UDT   /
**    |      Float      3      Float
**    |     Decimal     4     Decimal
**    |       Int       5       Int
...
**    |       char      10       C
**    |     varchar     11      Text
**    |     longtext    12    longtext
**    |       byte      13      byte
**    |     varbyte     14    varbyte
**    |   long varchar  15  long varchar
**    |   long nvarchar 17  long nvarchar
**    Least Preferable
...
** char/c/text form. If quel, then bias coersions to C/Text but
...
_DEFINE(BOO,     1, BOOL, BASE,  0,  0,  0,  0  /* "boolean" */)\
_DEFINE(DIF,     2, NONE, BASE,  0,  0,  0,  0  /* "Different" */)\
_DEFINE(DTE,     3, DATE, BASE,  0,  0,  0,  0  /* "date" */)\
_DEFINE(ADTE,    4, NONE, BASE,  0,  0,  0,  0  /* ANSI date type */)\
_DEFINE(MNY,     5, NUMB, BASE,  0,  0,  0,  0  /* "money" */)\
...
_DEFINE(DEC,    10, NUMB, BASE,  4,  4,  4,  4  /* "decimal" */)\
...
_DEFINE(13,     13, NONE, BASE,  0,  0,  0,  0  /* Unused */)\
...
_DEFINE(CPN,    17, BYTE, LOC,   0,  0,  0,  0  /* Coupon -- temporary */)\
...
_DEFINE(CHA,    20, CHAR, PAD,  10, 11,  8,  9  /* "char" */)\
_DEFINE(VCH,    21, CHAR, VAR,  11, 10,  9,  8  /* "varchar" */)\
_DEFINE(LVCH,   22, CHAR, LV,   15, 15, 15, 15  /* "long varchar" */)\
_DEFINE(BYTE,   23, BYTE, PAD,  13, 13, 13, 13  /* Byte */)\
_DEFINE(VBYTE,  24, BYTE, VAR,  14, 14, 14, 14  /* byte varying */)\
_DEFINE(LBYTE,  25, BYTE, LV,    0,  0,  0,  0  /* Long byte */)\
_DEFINE(NCHR,   26, NCHAR,PAD,   6,  7,  6,  7  /* unicode nchar */)\
_DEFINE(NVCHR,  27, NCHAR,VAR,   7,  6,  7,  6  /* unicode nvarchar */)\
_DEFINE(LNVCHR, 28, NCHAR,LV,   17, 17, 17, 17  /* unicode long nvarchar */)\
_DEFINE(LNLOC,  29, NCHAR, BASE,  0,  0,  0,  0 /* unicode locator */)\
_DEFINE(INT,    30, NUMB, BASE,  5,  5,  5,  5  /* "i" */)\
_DEFINE(FLT,    31, NUMB, BASE,  3,  3,  3,  3  /* "f" */)\
_DEFINE(CHR,    32, C,    VAR,   8,  8, 10, 10  /* "c" */)\
_DEFINE(INYM,   33, NONE, BASE,  0,  0,  0,  0  /* interval (year-month) */)\
_DEFINE(INDS,   34, NONE, BASE,  0,  0,  0,  0  /* interval (day-second) */)\
_DEFINE(LBLOC,  35, NONE, BASE,  0,  0,  0,  0  /* lbyte locator */)\
_DEFINE(LCLOC,  36, NONE, BASE,  0,  0,  0,  0  /* lvchar locator */)\
_DEFINE(TXT,    37, CHAR, VAR,   9,  9, 11, 11  /* "text" */)\
_DEFINE(38,     38, NONE, BASE,  0,  0,  0,  0  /* Unused */)\
_DEFINE(ALL,    39, ALL,  BASE, 99, 99, 99, 99  /* All datatypes! */)\
_DEFINE(DYC,    40, CHAR, VAR,   0,  0,  0,  0  /* dynamic char string */)\
_DEFINE(LTXT,   41, CHAR, VAR,  12, 12, 12, 12  /* "longtext"      */)\
...
#define DB_MAX_NVARCHARLEN     ((DB_MAXSTRING - DB_CNTSIZE) / DB_ELMSZ)
...
*/
#define 	DB_TAB_MASK 	      0x03FFFFFF	/* Maximum table ID / mask */
