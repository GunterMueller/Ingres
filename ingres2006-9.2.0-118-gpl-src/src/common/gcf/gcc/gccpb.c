/*
** Copyright (C) 1994, 2004 Ingres Corporation All Rights Reserved. 
*/
    ...
    */
	...
	continue;
          ...
          if (! gcb_pm_reso.cmd_line) 
	  {
		...
		{
	           if ( *( gcb_pm_reso.pm_vnode[ k ]) != NULL )
	           {
	             /*
...
# endif /* GCXDEBUG */
		...
		*/
		...
		if ( ! STcompare( pce->pce_port,
		    ...
		    STprintf( port, "%s (%s)", p_list->function_parms.listen.port_id,
			      p_list->function_parms.open.lsn_port );
