...
#elif defined(su4_us5) || defined(VMS)
#include <inttypes.h>
...
static  GCS_MECH_INFO   mech_info =
{
    ...
    GCS_MECH_KERBEROS,
    GCS_MECH_VERSION_1,
    GCS_CAP_ENCRYPT | GCS_CAP_USR_AUTH | GCS_CAP_REM_AUTH,
...
static  bool	init_crypt = FALSE;    	/* bool for encryption initiator */
