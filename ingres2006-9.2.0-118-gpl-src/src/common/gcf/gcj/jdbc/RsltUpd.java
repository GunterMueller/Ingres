...
public void
updateAsciiStream( int index, InputStream value, int length ) 
    throws SQLException
{ 
    if ( trace.enabled() )  
...
public void
updateCharacterStream( int index, Reader value, int length ) 
    throws SQLException
{ 
...
{ 
	...
	*/
	if ( value == null )
	{
	    ...
	    */
	    params.init( index, Types.LONGVARBINARY );
		   ...
		   ((JdbcBlob)value).isValidLocator( conn ) )
	{
	    ...
	    */
	    params.init( index, Types.BLOB );
	    params.setBlob( index, (DrvBlob)(((JdbcBlob)value).getLOB()) );
	}
	else
	{
	    /*
...
{ 
	...
	*/
	if ( value == null )
	{
	    ...
	    ** type supports coercion of the parameter value.
	    */
	    params.init( index, Types.LONGVARCHAR );
		   ...
		   ((JdbcClob)value).isValidLocator( conn ) )
	{
	    ...
	    */
	    ...
	    {
		params.init( index, Types.CLOB, false );
		params.setClob( index, (DrvNlob)lob );
	    }
	    else
	    {
		params.init( index, Types.CLOB, true );
