...
protected
MsgOut( String target, byte msg_cp[], TraceLog log )
    throws SqlEx
{
    super( target, log );
    title = "MsgOut[" + connID() + "]";
...
begin( byte msg_id )
    throws SqlEx
{
    if ( isClosed() )  throw SqlEx.get( ERR_GC4004_CONNECTION_CLOSED );
    ...
    throws SqlEx
{
	...
	out.write( out_hdr_pos + 7, 
		   (byte)(MSG_HDR_EOD | (flush ? MSG_HDR_EOG : 0)) );
    }
