...
static  READONLY i4  namemap[] =	/* Maps permit bits to query modes */
    {
...
#ifdef    xDEBUG
static  READONLY char opstring[] = "URAQ"; /* Operation indicators for debug */
#endif
	...
	i4		    qmode)
{
	...
	*/
	if (qmode == PSQ_DEFCURS && rngvar == cb->pss_resrng)
	{
    ...
    */
	...
	else if (qmode == PSQ_DEFCURS && cb->pss_lang == DB_QUEL)
	{
	    /*
...
saw_the_perms:
	...
	*/
	if (qmode == PSQ_DEFCURS && noperm == DB_REPLACE)
	{
	    PST_QNODE	    *tree_node;
