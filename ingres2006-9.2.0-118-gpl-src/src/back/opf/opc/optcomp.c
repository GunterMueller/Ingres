		...
		QEF_QP_CB	*qp)
{
    ...
    TRformat(opt_scc, (i4*)NULL, global->ops_cstate.opc_prbuf, OPT_PBLEN,
	"qp_ahd_cnt: %5d \t\tqp_qmode: %5d\n\n", 
	qp->qp_ahd_cnt, qp->qp_qmode);
    TRformat(opt_scc, (i4*)NULL, global->ops_cstate.opc_prbuf, OPT_PBLEN,
	"qp_rrowcnt_row: %5d \tqp_orowcnt_offset: %5d\tqp_hash_cnt: %5d\n\n",
	qp->qp_rrowcnt_row, qp->qp_orowcnt_offset, qp->qp_hash_cnt);
    TRformat(opt_scc, (i4*)NULL, global->ops_cstate.opc_prbuf, OPT_PBLEN,
	"qp_rerrorno_row: %5d \tqp_oerrorno_offset: %5d\n\n",
	qp->qp_rerrorno_row, qp->qp_oerrorno_offset);

    TRformat(opt_scc, (i4*)NULL, global->ops_cstate.opc_prbuf, OPT_PBLEN,
	"qp_res_row_sz: %5d \tqp_sqlda: %p\n\n", 
	qp->qp_res_row_sz, qp->qp_sqlda);
	...
	DB_PART_DEF	*partdp)
{
    ...
    TRformat(opt_scc, (i4*)NULL, global->ops_cstate.opc_prbuf,
	OPT_PBLEN, "(ahd/dmu)_part_def: 0x%x\n\n", partdp);
	...
	char		*title)
{
	...
	TRformat(opt_scc, NULL, global->ops_cstate.opc_prbuf, OPT_PBLEN,
		"    break[%3d]: oper: %5w  partseq: %5d  val_base: 0x%x\n\n",
	...
	i4		ahd_no )
{
    ...
    TRformat(opt_scc, (i4*)NULL, global->ops_cstate.opc_prbuf, OPT_PBLEN,
	"%s QEF_AHD: #%2d \t addr: %x \t ahd_atype: ", label, ahd_no, ahd);
    switch(ahd->ahd_atype)
    {
     case QEA_DMU:
	TRformat(opt_scc, (i4*)NULL, global->ops_cstate.opc_prbuf,
	...
	break;
     ...
     case QEA_COMMIT:
	TRformat(opt_scc, (i4*)NULL, global->ops_cstate.opc_prbuf,
	    OPT_PBLEN, "QEA_COMMIT\n\n");
	break;

     case QEA_ROLLBACK:
	TRformat(opt_scc, (i4*)NULL, global->ops_cstate.opc_prbuf,
	    OPT_PBLEN, "QEA_ROLLBACK\n\n");
	break;

     case QEA_CALLPROC:
	TRformat(opt_scc, (i4*)NULL, global->ops_cstate.opc_prbuf,
	    OPT_PBLEN, "QEA_CALLPROC\n\n");
	break;
	...
	TRformat(opt_scc, (i4*)NULL, global->ops_cstate.opc_prbuf,
	    OPT_PBLEN, "QEA_PROC_INSERT\n\n"); 
        break;

     case QEA_CLOSETEMP:
	TRformat(opt_scc, (i4*)NULL, global->ops_cstate.opc_prbuf,
	    OPT_PBLEN, "QEA_CLOSETEMP\n\n"); 
	break;

     case QEA_INVOKE_RULE:
	TRformat(opt_scc, (i4*)NULL, global->ops_cstate.opc_prbuf,
	    OPT_PBLEN, "QEA_INVOKE_RULE\n\n");
	break;
	...
	break;
     ...
     case QEA_RETURN:
	TRformat(opt_scc, (i4*)NULL, global->ops_cstate.opc_prbuf,
	    OPT_PBLEN, "QEA_RETURN\n\n");
	break;

     case QEA_MESSAGE:
	TRformat(opt_scc, (i4*)NULL, global->ops_cstate.opc_prbuf,
	    OPT_PBLEN, "QEA_MESSAGE\n\n");
	break;

     case QEA_EMESSAGE:
	TRformat(opt_scc, (i4*)NULL, global->ops_cstate.opc_prbuf,
	    OPT_PBLEN, "QEA_EMESSAGE\n\n");
	break;

     case QEA_EVREGISTER:
	TRformat(opt_scc, (i4*)NULL, global->ops_cstate.opc_prbuf, 
	    OPT_PBLEN, "QEA_EVREGISTER\n\n");
	break;

     case QEA_EVDEREG:
	TRformat(opt_scc, (i4*)NULL, global->ops_cstate.opc_prbuf,
	    OPT_PBLEN, "QEA_EVDEREG\n\n");
	break;

     case QEA_EVRAISE:
	TRformat(opt_scc, (i4*)NULL, global->ops_cstate.opc_prbuf,
	    OPT_PBLEN, "QEA_EVRAISE\n\n");
	break;

     case QEA_CREATE_TABLE:
	TRformat(opt_scc, (i4*)NULL, global->ops_cstate.opc_prbuf,
	    OPT_PBLEN, "QEA_CREATE_TABLE\n\n");
	break;

     case QEA_CREATE_INTEGRITY:
	TRformat(opt_scc, (i4*)NULL, global->ops_cstate.opc_prbuf,
	    OPT_PBLEN, "QEA_CREATE_INTEGRITY\n\n");
	break;

     case QEA_EXEC_IMM:
	TRformat(opt_scc, (i4*)NULL, global->ops_cstate.opc_prbuf,
	    OPT_PBLEN, "QEA_EXECUTE_IMMEDIATE\n\n");
	break;

     case QEA_D0_NIL:
	TRformat(opt_scc, (i4*)NULL, global->ops_cstate.opc_prbuf,
	    OPT_PBLEN, "QEA_D0_NIL\n\n");
	break;

     case QEA_D1_QRY:
	TRformat(opt_scc, (i4*)NULL, global->ops_cstate.opc_prbuf,
	    OPT_PBLEN, "QEA_D1_QRY\n\n");
	break;

     case QEA_D2_GET:
	TRformat(opt_scc, (i4*)NULL, global->ops_cstate.opc_prbuf,
	    OPT_PBLEN, "QEA_D2_GET\n\n");
	break;

     case QEA_D3_XFR:
	TRformat(opt_scc, (i4*)NULL, global->ops_cstate.opc_prbuf,
	    OPT_PBLEN, "QEA_D3_XFR\n\n");
	break;

     case QEA_D4_LNK:
	TRformat(opt_scc, (i4*)NULL, global->ops_cstate.opc_prbuf,
	    OPT_PBLEN, "QEA_D4_LNK\n\n");
	break;

     case QEA_D5_DEF:
	TRformat(opt_scc, (i4*)NULL, global->ops_cstate.opc_prbuf,
	    OPT_PBLEN, "QEA_D5_DEF\n\n");
	break;

     case QEA_D6_AGG:
	TRformat(opt_scc, (i4*)NULL, global->ops_cstate.opc_prbuf,
	    OPT_PBLEN, "QEA_D6_AGG\n\n");
	break;

     case QEA_D7_OPN:
	TRformat(opt_scc, (i4*)NULL, global->ops_cstate.opc_prbuf,
	    OPT_PBLEN, "QEA_D7_OPN\n\n");
	break;

     case QEA_D8_CRE:
	TRformat(opt_scc, (i4*)NULL, global->ops_cstate.opc_prbuf,
	    OPT_PBLEN, "QEA_D8_CRE\n\n");
	break;

     case QEA_D9_UPD:
	TRformat(opt_scc, (i4*)NULL, global->ops_cstate.opc_prbuf,
	    OPT_PBLEN, "QEA_D9_UPD\n\n");
	break;

     case QEA_D10_REGPROC:
	TRformat(opt_scc, (i4*)NULL, global->ops_cstate.opc_prbuf,
	    OPT_PBLEN, "QEA_D10_REGPROC\n\n");
	break;

     default:
	TRformat(opt_scc, (i4*)NULL, global->ops_cstate.opc_prbuf,
	    OPT_PBLEN, "Unknown Action Type: %d", ahd->ahd_atype);
    }
    TRformat(opt_scc, (i4*)NULL, global->ops_cstate.opc_prbuf, OPT_PBLEN,
	...
	TRformat(opt_scc, (i4*)NULL, global->ops_cstate.opc_prbuf,
  	    OPT_PBLEN, "ahd_proj: %5d \t ahd_qepflag: %5d \t ahd_duphandle:", 
	    ahd->qhd_obj.qhd_qep.ahd_proj,
	    ahd->qhd_obj.qhd_qep.ahd_qepflag);

	switch (ahd->qhd_obj.qhd_qep.ahd_duphandle)
	{
	 case QEF_SKIP_DUP:
	    TRformat(opt_scc, (i4*)NULL, global->ops_cstate.opc_prbuf,
		OPT_PBLEN, " QEF_SKIP_DUP\n\n\n");
	    break;

	 case QEF_ERR_DUP:
	    TRformat(opt_scc, (i4*)NULL, global->ops_cstate.opc_prbuf,
		OPT_PBLEN, " QEF_ERR_DUP\n\n\n");
	    break;

	 default:
	    TRformat(opt_scc, (i4*)NULL, global->ops_cstate.opc_prbuf,
		OPT_PBLEN, " Unknown Dup Flag\n\n\n");
	    break;
		...
		(ahd->qhd_obj.qhd_qep.ahd_qepflag & AHD_SCROLL))
	{
	    ...
	    TRformat(opt_scc, (i4*)NULL, global->ops_cstate.opc_prbuf,
	      OPT_PBLEN, "ahd_rssplix:%5d\tahd_rsrsize:%5d\tahd_rspsize:%5d\n\n",
	      ahd->qhd_obj.qhd_qep.ahd_scroll->ahd_rssplix,
		    ...
		    i++, attp++, off1++, off2++)
		{
			...
			attp->attr_precision, attp->attr_flags, *off1, *off2);
		}
	...
	if (ahd->ahd_atype == QEA_HAGGF)
	{
	    ...
	    */
	    ...
	    TRformat(opt_scc, (i4*)NULL, global->ops_cstate.opc_prbuf,
	      OPT_PBLEN, "\n\n");
	    opt_satts(global, 0, (DMT_ATTR_ENTRY **) NULL, 1,
	...
	TRformat(opt_scc, (i4*)NULL, global->ops_cstate.opc_prbuf,
	    OPT_PBLEN, "ahd_firstn: %5d\t ahd_seq: %p\n\n",
	...
	switch (ahd->qhd_obj.qhd_dmu.ahd_func)
	{
	 ...
	 case DMT_CREATE_TEMP:
	 {
	    ...
	    atts = (DMT_ATTR_ENTRY **) dmtcb->dmt_attr_array.ptr_address;
	...
	for (i = 0; i < ahd->qhd_obj.qhd_callproc.ahd_pcount; i++)
	{
	    ...
	    aparm = ahd->qhd_obj.qhd_callproc.ahd_params + i;
            TRformat(opt_scc, (i4*)NULL, global->ops_cstate.opc_prbuf,
		OPT_PBLEN, "  ahd_params[%d]: parm_name: %16s, parm_index: %d\n\n",
        	i, aparm->ahd_parm.parm_name, aparm->ahd_parm.parm_index);
            TRformat(opt_scc, (i4*)NULL, global->ops_cstate.opc_prbuf,
	...
	break;
     ...
     case QEA_D2_GET:
        TRformat(opt_scc, (i4*)NULL, global->ops_cstate.opc_prbuf,
	  OPT_PBLEN, "qeq_g1_firstn: %d\n\n",
	    ahd->qhd_obj.qhd_d2_get.qeq_g1_firstn);
     case QEA_D1_QRY:
     case QEA_D3_XFR:
     case QEA_D4_LNK:
     case QEA_D5_DEF:
...
opt_dmucb(OPS_STATE *global, DMU_CB *dmucb)
{
    ...
    atts = (DMU_ATTR_ENTRY **) dmucb->dmu_attr_array.ptr_address;
...
opt_lpchar_list(OPS_STATE *global, QEU_LOGPART_CHAR *qeu_lpl_ptr)
{
    ...
    {
	TRformat(opt_scc, NULL, global->ops_cstate.opc_prbuf,
		OPT_PBLEN, "qeu_logpart_char at 0x%x: dim %2d, partseq %5d, nparts %5d\n\n",
	...
	char	    *title )
{
	...
	TRformat(opt_scc, (i4*)NULL, global->ops_cstate.opc_prbuf,
	    OPT_PBLEN, "index: %5d \t fid: %5d \t ag_len: %5d\n\n", 
	    adf->qen_base[baseno].qen_index,
	    adf->qen_base[baseno].u.qen_fid,
	    adf->qen_base[baseno].qen_ag_len);
    }
    TRformat(opt_scc, (i4*)NULL, global->ops_cstate.opc_prbuf,
	OPT_PBLEN, "\n\n");
}
	...
	OPT_AHDQEN  *paq )
{
    ...
    TRformat(opt_scc, (i4*)NULL, global->ops_cstate.opc_prbuf, OPT_PBLEN,
	" \t qen_num: %5d \t qen_flags: %5d\n\n", 
	qn->qen_num, qn->qen_flags);
    ...
    */
	...
	TRformat(opt_scc, (i4*)NULL, global->ops_cstate.opc_prbuf,
  	    OPT_PBLEN, "orig_flag: %5d\t orig_ordcnt: %5d\t orig_qualrows: %5d\n\n", 
  	    orig->orig_flag, orig->orig_ordcnt, orig->orig_qualrows);
	...
	TRformat(opt_scc, (i4*)NULL, global->ops_cstate.opc_prbuf,
	    OPT_PBLEN, "kjoin_tid: %5d \t kjoin_tqual: %x\tkjoin_krow: %5d\n\n",
	...
	TRformat(opt_scc, (i4*)NULL, global->ops_cstate.opc_prbuf,
	    OPT_PBLEN, "sejn_seltype: ");
	switch (sejn->sejn_seltype)
	{
	 case SEL_ALL:
	    TRformat(opt_scc, (i4*)NULL, global->ops_cstate.opc_prbuf,
		OPT_PBLEN, "SEL_ALL");
	 ...
	 default:
	    TRformat(opt_scc, (i4*)NULL, global->ops_cstate.opc_prbuf,
		OPT_PBLEN, "UNKNOWN SUBSELECT TYPE");
	    break;
	}
	...
	switch (sejn->sejn_junc)
	{
	 case QESE1_CONT_AND:
	    TRformat(opt_scc, (i4*)NULL, global->ops_cstate.opc_prbuf,
		OPT_PBLEN, "QESE1_CONT_AND\n\n");
	    break;

	 case QESE2_CONT_OR:
	    TRformat(opt_scc, (i4*)NULL, global->ops_cstate.opc_prbuf,
		OPT_PBLEN, "QESE2_CONT_OR\n\n");
	    break;

	 case QESE3_RETURN_OR:
	    TRformat(opt_scc, (i4*)NULL, global->ops_cstate.opc_prbuf,
		OPT_PBLEN, "QESE3_RETURN_OR\n\n");
	    break;

	 case QESE4_RETURN_AND:
	    TRformat(opt_scc, (i4*)NULL, global->ops_cstate.opc_prbuf,
		OPT_PBLEN, "QESE4_RETURN_AND\n\n");
	    break;

	 default:
	    TRformat(opt_scc, (i4*)NULL, global->ops_cstate.opc_prbuf,
		OPT_PBLEN, "UNKNOWN JUNCTION TYPE\n\n");
	    break;
	}
	TRformat(opt_scc, (i4*)NULL, global->ops_cstate.opc_prbuf,
	    OPT_PBLEN, "sejn_correlated: %5d \t sejn_oper: ", 
	    sejn->sejn_correlated);
...

{
	...
	if (partp->part_qpix >= 0)
	{
	    QEN_PART_QUAL *pqualp;

	    /* doing partition qual, dump out all the part-qual's */
	    TRformat(opt_scc, (i4*)NULL, global->ops_cstate.opc_prbuf,
	      OPT_PBLEN, "part_qpix: %d\t part_qpwlix: %d\t part_qpwpix: %d\n\n", 
	      partp->part_qpix, partp->part_qpwlix, partp->part_qpwpix);
	    pqualp = &partp->part_qual;
	    do
	    {
		opt_adf(global, pqualp->part_qpart, "part_qpart");
		if (pqualp->part_qdim != (DB_PART_DIM *) NULL)
		    opt_part_dim(global, pqualp->part_qdim, "part_qdim");
		TRformat(opt_scc, (i4*)NULL, global->ops_cstate.opc_prbuf,
		  OPT_PBLEN, "part_qpcix: %d\t part_prowcnt: %d\t part_qflags: %x\n\n", 
		  pqualp->part_qpcix, pqualp->part_prowcnt, pqualp->part_qflags);
	...
	QEF_KEY	    *key )
{
	...
	{
	    TRformat(opt_scc, (i4*)NULL, global->ops_cstate.opc_prbuf,
		OPT_PBLEN,  "\t    QEF_KAND: kand_attno: %5d \t kand_type: ",
		kand->kand_attno);
	    switch (kand->kand_type)
	    {
	     case QEK_EQ:
		TRformat(opt_scc, (i4*)NULL, global->ops_cstate.opc_prbuf,
		    OPT_PBLEN, "QEK_EQ\n\n");
	    ...
	    {
		TRformat(opt_scc, (i4*)NULL, global->ops_cstate.opc_prbuf,
		    OPT_PBLEN, "\t\tQEF_KATT: attr_value: %5d\n\n", 
		    katt->attr_value);
		TRformat(opt_scc, (i4*)NULL, global->ops_cstate.opc_prbuf,
		    OPT_PBLEN, "\t\tattr_attno: %5d \t attr_operator: ",
		    katt->attr_attno);
		switch (katt->attr_operator)
		{
		 ...
		 default:
	        ...
	        TRformat(opt_scc, (i4*)NULL, global->ops_cstate.opc_prbuf,
		     OPT_PBLEN,
	       "\t\tattr_type: %5d \t attr_prec: %5d \t attr_length: %5d\n\n\n",
		    katt->attr_type,
		    katt->attr_prec,
		    katt->attr_length);
	    }
	...
	DB_CMP_LIST	*cmp)
{
	...
	for (i = 0; i < acount; i += 1)
	{
		...
		att->attr_precision, att->attr_collID, att->attr_flags);
	}
    }
