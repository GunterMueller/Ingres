...
DB_ERROR        *errcb)
{
    ...
    */
	...
	| DM2U_2_TO_TABLE_PRIORITY | DM2U_2_PERSISTS_OVER_MODIFIES
...

	...
	*/
	if (mcb->mcb_omcb)
	{
		...
		status = dm0l_modify(log_id, dm0l_jnlflag,
				...
				mcb->mcb_l_count, orig_locnArray, dm0l_structure, 
	...
	*/
	if ((logging) && (!already_logged))
	{
	    ...
	    status = dm0l_modify(log_id, dm0l_jnlflag,
		mcb->mcb_tbl_id, &table_name, &owner_name, 
		mcb->mcb_l_count, orig_locnArray,
