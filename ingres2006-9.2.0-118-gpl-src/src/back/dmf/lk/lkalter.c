...
CL_ERR_DESC	    *sys_err)
{
	...
	if (value <= 0)
	{
	    ule_format(E_DMA02A_LKALTER_NEGATIVE_ARG, (CL_ERR_DESC *)0,
    ...
    case LK_A_INTERRUPT:
	{
	    ...
	    */
	    ...
	    {
		ule_format(E_CL1025_LK_NOINTERRUPT_ALTER, (CL_ERR_DESC *)0,
	    ...
	    {
		ule_format(E_CL1026_LK_NOINTERRUPT_ALTER, (CL_ERR_DESC *)0,
			ULE_LOG,
    ...
    case LK_A_REASSOC:
	{
	    ...
	    */
		...
		(i4) llb_id.id_id > lkd->lkd_lbk_count)
	    {
		ule_format(E_CL1027_LK_BAD_ALTER_REQUEST, (CL_ERR_DESC *)0,
			    ULE_LOG, NULL, (char *)0, 0L, (i4 *)0,
			    &err_code, 1, 0, flag);
		return (LK_BADPARAM);
	    }
	...
	*/
	...
	if (value == 0)
	{
	    ule_format(E_DMA02C_LKALTER_MISSING_ARG, (CL_ERR_DESC *)0,
...
{	
    ...
    {
	ule_format(E_DMA000_LK_LLB_TOO_MANY, (CL_ERR_DESC *)0, ULE_LOG,
    ...
    {
	ule_format(E_DMA018_LK_LLB_TOO_FEW, (CL_ERR_DESC *)0, ULE_LOG,
		    NULL, (char *)0, 0L, (i4 *)0, &err_code, 2,
    ...
    {
	ule_format(E_CL1020_LK_BUSY_ALTER, (CL_ERR_DESC *)0, ULE_LOG,
    ...
    if (ext == NULL)
    {
	ule_format(E_CL1021_LK_LLB_ALLOC_FAILED, (CL_ERR_DESC *)0, ULE_LOG,
		    NULL, (char *)0, 0L, (i4 *)0, &err_code, 1,
		    0, value);
	return (LK_NOLOCKS);
    }
...
{	
    ...
    {
	ule_format(E_DMA022_LK_RSB_TOO_MANY, (CL_ERR_DESC *)0, ULE_LOG,
		    NULL, (char *)0, 0L, (i4 *)0, &err_code, 2,
    ...
    {
	ule_format(E_DMA023_LK_RSB_TOO_FEW, (CL_ERR_DESC *)0, ULE_LOG,
		    NULL, (char *)0, 0L, (i4 *)0, &err_code, 2,
    ...
    if (ext == NULL)
    {
	ule_format(E_CL1022_LK_LOCK_ALLOC_FAILED, (CL_ERR_DESC *)0, ULE_LOG,
		    NULL, (char *)0, 0L, (i4 *)0, &err_code, 1,
		    0, value);
	return (LK_NOLOCKS);
    }
...
{	
    ...
    {
	ule_format(E_DMA001_LK_BLK_TOO_MANY, (CL_ERR_DESC *)0, ULE_LOG,
		    NULL, (char *)0, 0L, (i4 *)0, &err_code, 2,
    ...
    {
	ule_format(E_DMA019_LK_BLK_TOO_FEW, (CL_ERR_DESC *)0, ULE_LOG,
		    NULL, (char *)0, 0L, (i4 *)0, &err_code, 2,
...
set_lock_hash_size(LKD *lkd, u_i4 value)
{
    ...
    {
	ule_format(E_DMA002_LK_LKH_TOO_MANY, (CL_ERR_DESC *)0, ULE_LOG,
		    NULL, (char *)0, 0L, (i4 *)0, &err_code, 2,
    ...
    {
	ule_format(E_DMA020_LK_LKH_TOO_FEW, (CL_ERR_DESC *)0, ULE_LOG,
		    NULL, (char *)0, 0L, (i4 *)0, &err_code, 2,
    ...
    if (lkh == NULL)
    {
	ule_format(E_CL1023_LK_LKH_ALLOC_FAILED, (CL_ERR_DESC *)0, ULE_LOG,
		    NULL, (char *)0, 0L, (i4 *)0, &err_code, 1,
		    0, value);
	return (LK_NOLOCKS);
    }
...
set_resource_hash_size(LKD *lkd, u_i4 value)
{
    ...
    {
	ule_format(E_DMA003_LK_RSH_TOO_MANY, (CL_ERR_DESC *)0, ULE_LOG,
		    NULL, (char *)0, 0L, (i4 *)0, &err_code, 2,
    ...
    {
	ule_format(E_DMA021_LK_RSH_TOO_FEW, (CL_ERR_DESC *)0, ULE_LOG,
		    NULL, (char *)0, 0L, (i4 *)0, &err_code, 2,
    ...
    if (rsh == NULL)
    {
	ule_format(E_CL1024_LK_RSH_ALLOC_FAILED, (CL_ERR_DESC *)0, ULE_LOG,
		    NULL, (char *)0, 0L, (i4 *)0, &err_code, 1,
		    0, value);
	return (LK_NOLOCKS);
    }
...
resume_stalled_requests(i4 stall_state)
{
	...
	lkb = (LKB *)((char *)llbq -
			CL_OFFSETOF(LKB,lkb_lkreq.lkreq_stall_wait));
	lkreq = &lkb->lkb_lkreq;

	if (filter && ((lkreq->result_flags & filter) == 0))
	    continue;
	...
	*/
	...
	TRdisplay(
    "%@ Resume stalled LKB %x on LLB %x state %2w KEY %s for PID %d (0x%x) SID %x, flags %v\n",
	    lkb->lkb_id,
	    *(u_i4*)&llb->llb_id,
	    ...
	    lkreq->cpid.pid,
	    lkreq->cpid.sid,
	    "UPD_VALUE,UPD_LOCKID,VALADDR_PROVIDED,CHECK_STATUS,PHYS,\
STALL_RQ,STALL_CV",
	    lkreq->result_flags);

	LKcp_resume( &lkreq->cpid );
    }
...
LK_dump_stall_queue( char *message )
{
	...
	TRdisplay("At %x, LKB %x LLB %x flags %v -- n/p=(%x/%x)\n",
		llbq_offset,
		lkb->lkb_id,
		*(i4 *)&llb->llb_id,
		"UPD_VALUE,UPD_LOCKID,VALADDR_PROVIDED,CHECK_STATUS,P\
HYS,STALL_RQ,STALL_CV",
		lkreq->result_flags,
