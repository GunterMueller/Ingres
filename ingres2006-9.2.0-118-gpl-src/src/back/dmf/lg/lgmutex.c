	 ...
	 i4 	line)
{
	...
	if (status)
	{
	    ...
	    */
	    ...
	    ule_format(E_DMA42E_LG_MUTEX, (CL_ERR_DESC *)0, ULE_LOG,
	...
	i4 	line)
{
	...
	if (status)
	{
	    ...
	    */
	    ...
	    ule_format(status, (CL_ERR_DESC *)0, ULE_LOG,
			    NULL, (char *)0, 0L, (i4 *)0, &err_code, 0);
	    ule_format(E_DMA42F_LG_UNMUTEX, (CL_ERR_DESC *)0, ULE_LOG,
			    NULL, (char *)0, 0L, (i4 *)0, &err_code, 3,
			    0, sstat.name,
			    0, file,
			    0, line);
...
LG_imutex(CS_SEMAPHORE *mutex, char *mutex_name)
{
	...
	ule_format(status, (CL_ERR_DESC *)0, ULE_LOG,
			NULL, (char *)0, 0L, (i4 *)0, &err_code, 0);
	ule_format(E_DMA430_LG_IMUTEX, (CL_ERR_DESC *)0, ULE_LOG,
			NULL, (char *)0, 0L, (i4 *)0, &err_code, 0);
    }
    return(status);
}
