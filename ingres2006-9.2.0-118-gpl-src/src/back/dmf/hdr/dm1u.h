...
#define		    DM1U_S_ORPHAN   0x01
    ...
    DMPP_PAGE	*dm1u_index_pg_ptr; /* place to fix index pages to */
    DMPP_PAGE	*dm1u_data_pg_ptr;  /* place to fix data pages to */
    DMPP_PAGE	*dm1u_leaf_pg_ptr;  /* place to fix leaf pages to */
    DMPP_PAGE	*dm1u_ovfl_pg_ptr;  /* place to fix leaf overflow pages to */
    DMPP_PAGE	*dm1u_temp_pg_ptr;  /* temp place to fix pages to */
