...
*/
typedef struct _DM2T_ATTR_ENTRY
{
    DB_ATT_NAME     attr_name;              /* Column name. */
    i4         attr_type;              /* Column type. */
    i4         attr_size;              /* Column type size. */
    i4         attr_prec;              /* Column type precision. */
    i4         attr_flags;             /* Reserved for future use. */
...
FUNC_EXTERN DB_STATUS   dm2t_convert_tcb_lock(    
                                        DMP_TCB         *tcb,     
                                        i4         lock_mode,
                                        i4         *err_code);

FUNC_EXTERN DB_STATUS    dm2t_xlock_tcb(           
                                        i4         db_id,    
                                        DMP_TCB         *tcb,     
                                        DMP_RCB         *rcb,     
                                        i4         *err_code);
FUNC_EXTERN DB_STATUS   dm2t_convert_bumplock_tcb(
					DMP_TCB         *tcb,
					i4         lock_mode,
					i4         *err_code);
