...
#define                 DMPP_FREEBYTES         18
    char           page_hdr_freespace[DMPP_FREEBYTES]; /* future expansion */
...
typedef struct _DMPP_PAGETYPE
{
    ...
    i4  dmpp_row_locking;	/* True if page type supports row locking */
    i4	dmpp_has_versions;	/* True if page type supports alter table */
    i4  dmpp_has_seghdr;	/* True if page type supports rows span pages*/
} DMPP_PAGETYPE;
...
typedef struct _DMPP_TUPLE_HDR_V2
{
    ...
    char	low_tran[sizeof (u_i4)];
    char        spare1[sizeof (u_i4)];     /* future expansion */
...
#define DMPP_V1_GET_PAGE_STAT_MACRO(pgptr) 	 \
        	((DMPP_V1_PAGE *)pgptr)->page_stat
 
#define DMPP_V2_GET_PAGE_STAT_MACRO(pgptr) 	 \
		((DMPP_V2_PAGE *)pgptr)->page_stat 
...
#define DMPP_V1_SET_PAGE_STAT_MACRO(pgptr, value) 	 \
    {						 	 \
	((DMPP_V1_PAGE *)pgptr)->page_stat |= (u_i2)value;	\
    }
 
#define DMPP_V2_SET_PAGE_STAT_MACRO(pgptr, value) 	 \
    {							 \
        ((DMPP_V2_PAGE *)pgptr)->page_stat |= value;	 \
    }
...
#define DMPP_V1_GET_PAGE_MAIN_MACRO(pgptr) 			\
        ((DMPP_V1_PAGE *)pgptr)->page_main
 
#define DMPP_V2_GET_PAGE_MAIN_MACRO(pgptr) 			\
	((DMPP_V2_PAGE *)pgptr)->page_main
...
#define DMPP_V1_SET_PAGE_MAIN_MACRO(pgptr, value) 		\
    {							 	\
	((DMPP_V1_PAGE *)pgptr)->page_main = value;	 	\
    }

#define DMPP_V2_SET_PAGE_MAIN_MACRO(pgptr, value) 		\
    {							 	\
        ((DMPP_V2_PAGE *)pgptr)->page_main = value;	 	\
    }
...
#define DMPP_VPT_SIZEOF_PAGE_MAIN_MACRO(page_type, pgptr)	\
        (page_type != DM_COMPAT_PGTYPE ? 	  		\
	(i4)(sizeof(((DMPP_V2_PAGE *)pgptr)->page_main)) :	\
        (i4)(sizeof(((DMPP_V1_PAGE *)pgptr)->page_main)))
...
#define DMPP_VPT_GET_PAGE_OVFL_MACRO(page_type, pgptr) 		\
        (page_type != DM_COMPAT_PGTYPE ? 			\
	((DMPP_V2_PAGE *)pgptr)->page_ovfl : 			\
        ((DMPP_V1_PAGE *)pgptr)->page_ovfl)
 
#define DMPP_VPT_SET_PAGE_OVFL_MACRO(page_type, pgptr, value) \
     {								\
        if (page_type != DM_COMPAT_PGTYPE) 			\
          ((DMPP_V2_PAGE *)pgptr)->page_ovfl = value; 		\
        else 							\
	  ((DMPP_V1_PAGE *)pgptr)->page_ovfl = value;		\
     }
...
#define DMPP_V1_GET_PAGE_PAGE_MACRO(pgptr) 			\
        	((DMPP_V1_PAGE *)pgptr)->page_page
 
#define DMPP_V2_GET_PAGE_PAGE_MACRO(pgptr) 			\
		((DMPP_V2_PAGE *)pgptr)->page_page 
...
#define DMPP_V1_SET_PAGE_PAGE_MACRO(pgptr, value)		\
     {								\
	((DMPP_V1_PAGE *)pgptr)->page_page = value;		\
     }
 
#define DMPP_V2_SET_PAGE_PAGE_MACRO(pgptr, value)		\
     {								\
        ((DMPP_V2_PAGE *)pgptr)->page_page = value; 		\
     }
...
#define DMPP_V2_GET_PAGE_SZTYPE_MACRO(pgptr)			\
	((DMPP_V2_PAGE *)pgptr)->page_sztype

#define DMPP_V2_SET_PAGE_SZTYPE_MACRO(page_type, page_size, pgptr)\
     {								\
        ((DMPP_V2_PAGE *)pgptr)->page_sztype = page_size + page_type;\
     } 
...
#define DMPP_V1_GET_PAGE_SEQNO_MACRO(pgptr) 			\
        ((DMPP_V1_PAGE *)pgptr)->page_seq_number
 
#define DMPP_V2_GET_PAGE_SEQNO_MACRO(pgptr) 			\
        ((DMPP_V2_PAGE *)pgptr)->page_seq_number 
...
#define DMPP_V1_SET_PAGE_SEQNO_MACRO(pgptr, value) 		\
     {								\
	 ((DMPP_V1_PAGE *)pgptr)->page_seq_number = value;	\
     }
 
#define DMPP_V2_SET_PAGE_SEQNO_MACRO(pgptr, value) 		\
     {								\
         ((DMPP_V2_PAGE *)pgptr)->page_seq_number = value; 	\
     }
...
#define DMPP_VPT_GET_PAGE_CHKSUM_MACRO(page_type, pgptr) 	\
        (page_type != DM_COMPAT_PGTYPE ? 			\
        ((DMPP_V2_PAGE *)pgptr)->page_checksum : 		\
        ((DMPP_V1_PAGE *)pgptr)->page_checksum)

#define DMPP_VPT_SET_PAGE_CHKSUM_MACRO(page_type, pgptr, value) 	\
     {								\
        if (page_type != DM_COMPAT_PGTYPE) 			\
          ((DMPP_V2_PAGE *)pgptr)->page_checksum = value; 	\
        else 							\
	  ((DMPP_V1_PAGE *)pgptr)->page_checksum = value;	\
     }
 
#define DMPP_VPT_GET_PAGE_TRAN_ID_MACRO(page_type, pgptr)	\
        (page_type != DM_COMPAT_PGTYPE ? 			\
        ((DMPP_V2_PAGE *)pgptr)->page_tran_id :			\
        ((DMPP_V1_PAGE *)pgptr)->page_tran_id)
 
#define DMPP_V1_SET_PAGE_TRAN_ID_MACRO(pgptr, tran_id) 		\
     {								\
        STRUCT_ASSIGN_MACRO(tran_id, ((DMPP_V1_PAGE *)pgptr)->page_tran_id); \
     }
 
#define DMPP_V2_SET_PAGE_TRAN_ID_MACRO(pgptr, tran_id) 		\
     {								\
        STRUCT_ASSIGN_MACRO(tran_id, ((DMPP_V2_PAGE *)pgptr)->page_tran_id); \
     }
...
#define DMPP_V1_GET_TRAN_ID_LOW_MACRO(pgptr)			\
	((DMPP_V1_PAGE *)pgptr)->page_tran_id.db_low_tran

#define DMPP_V2_GET_TRAN_ID_LOW_MACRO(pgptr)			\
	((DMPP_V2_PAGE *)pgptr)->page_tran_id.db_low_tran 
...
#define DMPP_V1_GET_TRAN_ID_HIGH_MACRO(pgptr)			\
	((DMPP_V1_PAGE *)pgptr)->page_tran_id.db_high_tran

#define DMPP_V2_GET_TRAN_ID_HIGH_MACRO(pgptr)			\
	((DMPP_V2_PAGE *)pgptr)->page_tran_id.db_high_tran 
...
#define DMPP_VPT_GET_PAGE_LOG_ADDR_MACRO(page_type, pgptr, log_addr) \
        (page_type != DM_COMPAT_PGTYPE ? 			\
	STRUCT_ASSIGN_MACRO(((DMPP_V2_PAGE *)pgptr)->page_log_addr,log_addr): \
        STRUCT_ASSIGN_MACRO(((DMPP_V1_PAGE *)pgptr)->page_log_addr,log_addr))
 
#define DMPP_VPT_SET_PAGE_LOG_ADDR_MACRO(page_type, pgptr, log_addr) \
     {								\
        if (page_type != DM_COMPAT_PGTYPE) 			\
          STRUCT_ASSIGN_MACRO(log_addr,((DMPP_V2_PAGE *)pgptr)->page_log_addr);\
        else    						\
          STRUCT_ASSIGN_MACRO(log_addr,((DMPP_V1_PAGE *)pgptr)->page_log_addr);\
     } 
...
#define DMPP_VPT_GET_LOG_ADDR_LOW_MACRO(page_type, pgptr)	\
	(page_type != DM_COMPAT_PGTYPE ?				\
	((DMPP_V2_PAGE *)pgptr)->page_log_addr.lsn_low :	\
	((DMPP_V1_PAGE *)pgptr)->page_log_addr.lsn_low)

#define DMPP_VPT_GET_LOG_ADDR_HIGH_MACRO(page_type, pgptr)	\
	(page_type != DM_COMPAT_PGTYPE ?				\
	((DMPP_V2_PAGE *)pgptr)->page_log_addr.lsn_high :	\
	((DMPP_V1_PAGE *)pgptr)->page_log_addr.lsn_high)

#define DMPP_VPT_ADDR_PAGE_LOG_ADDR_MACRO(page_type, pgptr) 	\
        (page_type != DM_COMPAT_PGTYPE ? 			\
        (LG_LSN *)&(((DMPP_V2_PAGE *)pgptr)->page_log_addr) : 	\
        (LG_LSN *)&(((DMPP_V1_PAGE *)pgptr)->page_log_addr))
 
#define DMPP_V1_GET_PAGE_NEXT_LINE_MACRO(pgptr)			\
        	((DMPP_V1_PAGE *)pgptr)->page_next_line
 
#define DMPP_V2_GET_PAGE_NEXT_LINE_MACRO(pgptr)			\
        	((DMPP_V2_PAGE *)pgptr)->page_next_line 
...
#define DMPP_V1_SET_PAGE_NEXT_LINE_MACRO(pgptr, value)		\
     {								\
         ((DMPP_V1_PAGE *)pgptr)->page_next_line = value;	\
     } 

#define DMPP_V2_SET_PAGE_NEXT_LINE_MACRO(pgptr, value)		\
     {								\
         ((DMPP_V2_PAGE *)pgptr)->page_next_line = value;	\
     } 
...
#define DMPP_V1_PAGE_CONTENTS_MACRO(pgptr) 			\
          	((DMPP_V1_PAGE *)pgptr)->page_contents
 
#define DMPP_V2_PAGE_CONTENTS_MACRO(pgptr) 			\
                ((DMPP_V2_PAGE *)pgptr)->page_contents 
...
#define  DMPP_VPT_GET_PAGE_1STFREE_MACRO(page_type, page)	\
    ((page_type != DM_COMPAT_PGTYPE) ?                  		\
    ((DMPPC_V2_CONTENTS *)(((DMPP_V2_PAGE *)page)->page_contents))->temp_1stfree: \
    ((DMPPC_V1_CONTENTS *)(((DMPP_V1_PAGE *)page)->page_contents))->temp_1stfree)
 
#define  DMPP_VPT_SET_PAGE_1STFREE_MACRO(page_type, page, value)	\
     {								\
	if (page_type != DM_COMPAT_PGTYPE)                         	\
	  ((DMPPC_V2_CONTENTS *)					\
		(((DMPP_V2_PAGE *)page)->page_contents))->temp_1stfree = value;\
	else                                                	\
	  ((DMPPC_V1_CONTENTS *)					\
		(((DMPP_V1_PAGE *)page)->page_contents))->temp_1stfree = value;\
     }
...
#define DMPP_SKIP_DELETED_ROW_MACRO(r, page, low_tran)		\
...
/* any change to this macro will probably require change to DM1B counterpart */
#define DMPP_DUPCHECK_NEED_ROW_LOCK_MACRO(r, page, low_tran)	\
	(!row_locking(r) || !low_tran 				\
	|| low_tran == r->rcb_tran_id.db_low_tran		\
	|| !(LSN_GTE(DMPP_VPT_ADDR_PAGE_LOG_ADDR_MACRO(		\
	r->rcb_tcb_ptr->tcb_rel.relpgtype, page), &r->rcb_oldest_lsn)) ? \
