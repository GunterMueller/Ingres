...
#define	CPP_TBLCB_ASCII_ID		 CV_C_CONST_MACRO('#', 'T', 'B', 'L')
    ...
    DMP_RELATION    *tblcb_rel_ptr;          /* PTR to tuple data */
...
#define	       CPP_SYSTEM_CATALOG      0x0008L  /* System Catalog table */
#define	       CPP_USER_SPECIFIED      0x0010L  /* User specified table */
#define        CPP_VIEW_TABLE          0x0020L  /* View                 */
#define        CPP_GATEWAY_TABLE       0x0040L  /* Gateway table        */
