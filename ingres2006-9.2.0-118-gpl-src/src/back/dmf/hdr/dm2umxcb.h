...
#define		MX_SYMMETRIC	0x00010000
    ...
    DB_ATTS         *mx_atts_ptr;       /* Pointer to attributes for index 
					** table. */
    DB_ATTS	    **mx_data_atts;	/* Pointer to a list of pointers to the
					** data attributes in the index or
					** table. This list of attributes is
					** used to perform compression.
					*/
    ...
    i4	    	    mx_compressed;	/* ALL: Compressed records. */
    i4	    	    mx_index_comp;	/* specifies index compression info */
    i4	    	    mx_comp_katts_count;/* overhead added for compressed key
    ...
    i4		    mx_readonly;	/* Make table a readonly table */
#define		MXCB_SET_READONLY	1L
