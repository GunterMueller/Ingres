...
# endif
    ...
    */
	...
	TRdisplay("(created by either the iibuild program or the csinstall \n");
	TRdisplay("utility).\n");
#endif /* UNIX */
	...
	if ( ret_status != OK)
	{
	    ule_format(ret_status, (CL_ERR_DESC *)&cl_err,
			ULE_LOG, NULL, 0, 0, 0, &err_code, 0);
