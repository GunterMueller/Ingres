...
# endif  /* LP64 */
    ...
    { "CURRENT_DATE",	SCI_CURDATE,		0,	0,
			4,	DB_INT_TYPE },

    { "CURRENT_TIME",	SCI_CURTIME,		0,	0,
			4,	DB_INT_TYPE },

    { "CURRENT_TIMESTAMP",SCI_CURTSTMP,		0,	0,
			4,	DB_INT_TYPE },

    { "LOCAL_TIME",	SCI_LCLTIME,		0,	0,
			4,	DB_INT_TYPE },

    { "LOCAL_TIMESTAMP",SCI_LCLTSTMP,		0,	0,
			4,	DB_INT_TYPE },
...
GLOBALREF WSCREADONLY char	Version[];
...
scd_initiate( CS_INFO_CB  *csib )
{
    ...
    DMC_CHAR_ENTRY      dmc_char[DB_MAX_CACHE];
    SCF_CB		scf_cb;
    GCA_IN_PARMS	gca_cb;
    GCA_RG_PARMS	gcr_cb;
    SCD_CB		scd_cb;
...
# if !defined(conf_CAS_ENABLED) || !defined(conf_CLUSTER_BUILD)
	...
	*/
	sc0e_put(E_SC0394_CLUSTER_NOT_SUPPORTED, 0, 0,
		 0, (PTR)0,
		 0, (PTR)0,
		 0, (PTR)0,
		 0, (PTR)0,
...
# endif /* !int_lnx */
    ...
    */
    ...
    rdf_ccb.rdf_max_tbl	    = NULL;
    rdf_ccb.rdf_colavg	    = NULL;
    rdf_ccb.rdf_multicache  = NULL;
    rdf_ccb.rdf_cachesiz    = NULL;
    ...
    ** init CUT
    */
    status = cut_init((STATUS (*)())ule_doformat);
    if (status != E_DB_OK)
    {
        sc0e_0_put(E_SC0392_CUT_INIT, 0);
        return(E_SC0124_SERVER_INITIATE);
    }
    /*
...

	...
	gca_cb.gca_api_version = GCA_API_LEVEL_4;
        gca_cb.gca_local_protocol = GCA_PROTOCOL_LEVEL_67;
	...
	Sc_main_cb->sc_gchdr_size = gca_cb.gca_header_length;
	...
	*/
	...
	gw_rcb.gwr_gchdr_size = Sc_main_cb->sc_gchdr_size;
	...
	*/
	...
	if (!(Sc_main_cb->sc_capabilities & SC_STAR_SERVER))
	{
	  /* Find out about page types that are configured */
          ...
          dmc.dmc_char_array.data_out_size = sizeof(DMC_CHAR_ENTRY) * 4;
...
# if 0
	...
	local_crb.gca_user_name = DB_SYSINIT_NAME;
...
# endif
	...
	*/
	if (!(Sc_main_cb->sc_capabilities & SC_STAR_SERVER))
	{
	    ...
	    local_crb.gca_assoc_id = 0;
	    local_crb.gca_size_advise = 0;
	    local_crb.gca_user_name = DB_BCPTHREAD_NAME;
	    local_crb.gca_account_name = 0;
	    local_crb.gca_access_point_identifier = "NONE";
	    local_crb.gca_application_id = 0;
	...
	if (Sc_main_cb->sc_events > 0)
	{
	    ...
	    */
		...
		local_crb.gca_assoc_id = 0;
		local_crb.gca_size_advise = 0;
		local_crb.gca_user_name = DB_EVENTTHREAD_NAME;
		local_crb.gca_account_name = 0;
		local_crb.gca_access_point_identifier = "NONE";
		local_crb.gca_application_id = 0;
	...
	*/
	if (Sc_main_cb->sc_rep_qman)
	{
	    ...
	    local_crb.gca_assoc_id = 0;
	    local_crb.gca_size_advise = 0;
	    local_crb.gca_user_name = DB_REP_QMAN_NAME;
	    local_crb.gca_account_name = 0;
	    local_crb.gca_access_point_identifier = "NONE";
	    local_crb.gca_application_id = 0;
	...
	*/
	    ...
	    (Sc_main_cb->sc_nostar_recovr == FALSE))
	{
	    ...
	    local_crb.gca_size_advise = 0;
	    local_crb.gca_user_name = DB_DXRECOVERY_NAME;
	...
	*/
	if ( secaudit_writer )
	{
	    ...
	    local_crb.gca_assoc_id = 0;
	    local_crb.gca_size_advise = 0;
	    local_crb.gca_user_name = DB_AUDITTHREAD_NAME;
	    local_crb.gca_account_name = 0;
	    local_crb.gca_access_point_identifier = "NONE";
	    local_crb.gca_application_id = 0;
	...
	if(term_thread)
	{
	    ...
	    local_crb.gca_assoc_id = 0;
	    local_crb.gca_size_advise = 0;
	    local_crb.gca_user_name = DB_TERMTHREAD_NAME;
	    local_crb.gca_account_name = 0;
	    local_crb.gca_access_point_identifier = "NONE";
	    local_crb.gca_application_id = 0;
	...
	if(secaudit_writer)
	{
	    ...
	    local_crb.gca_assoc_id = 0;
	    local_crb.gca_size_advise = 0;
	    local_crb.gca_user_name = DB_SECAUD_WRITER_NAME;
	    local_crb.gca_account_name = 0;
	    local_crb.gca_access_point_identifier = "NONE";
	    local_crb.gca_application_id = 0;
	...
	*/
	if (Sc_main_cb->sc_writealong) 
	{
	    ...
	    local_crb.gca_assoc_id = 0;
	    local_crb.gca_size_advise = 0;
	    local_crb.gca_user_name = DB_BWRITALONG_NAME;   
	    local_crb.gca_account_name = 0;
	    local_crb.gca_access_point_identifier = "NONE";
	    local_crb.gca_application_id = 0;
	...
	*/
	if (Sc_main_cb->sc_readahead)  
	{
	    ...
	    local_crb.gca_assoc_id = 0;
	    local_crb.gca_size_advise = 0;
	    local_crb.gca_user_name = DB_BREADAHEAD_NAME;   
	    local_crb.gca_account_name = 0;
	    local_crb.gca_access_point_identifier = "NONE";
	    local_crb.gca_application_id = 0;
	...
	if (Sc_main_cb->sc_capabilities & SC_CSP_SERVER)
	{
	    ...
	    */
	    ...
	    local_crb.gca_assoc_id = 0;
	    local_crb.gca_size_advise = 0;
	    local_crb.gca_user_name = DB_CSP_MAIN_NAME;
	    local_crb.gca_account_name = 0;
	    local_crb.gca_access_point_identifier = "NONE";
	    local_crb.gca_application_id = 0;
	    ...
	    */
	    ...
	    {
		sc0e_0_put(stat, 0);
		sc0e_0_put(E_SC02C0_CSP_MAIN_ADD, 0);
		status = E_DB_ERROR;
		break;
	    }
	    ...
	    local_crb.gca_assoc_id = 0;
	    local_crb.gca_size_advise = 0;
	    local_crb.gca_user_name = DB_CSP_MSGMON_NAME;
	    local_crb.gca_account_name = 0;
	    local_crb.gca_access_point_identifier = "NONE";
	    local_crb.gca_application_id = 0;
	    ...
	    {
		sc0e_0_put(stat, 0);
		sc0e_0_put(E_SC02C2_CSP_MSGMON_ADD, 0);
		status = E_DB_ERROR;
		break;
	    }
	    ...
	    local_crb.gca_assoc_id = 0;
	    local_crb.gca_size_advise = 0;
	    local_crb.gca_user_name = DB_CSP_MSGTHR_NAME;
	    local_crb.gca_account_name = 0;
	    local_crb.gca_access_point_identifier = "NONE";
	    local_crb.gca_application_id = 0;
	    ...
	    {
		sc0e_0_put(stat, 0);
		sc0e_0_put(E_SC02C4_CSP_MSGTHR_ADD, 0);
		status = E_DB_ERROR;
		break;
	    }
	}
...
scd_terminate(void)
{
	...
	status = psq_call(PSQ_SHUTDOWN, &psq_cb, (PTR) 0);
	if (status)
	{
	    sc0e_0_put(psq_cb.psq_error.err_code, 0);
	    error++;
	...
	if (Sc_main_cb->sc_capabilities & SC_STAR_SERVER)
	    ...
	    qef_cb.qef_s1_distrib = DB_1_LOCAL_SVR;
	status = qef_call(QEC_SHUTDOWN, ( PTR ) &qef_cb);
	if (status)
	{
	    sc0e_0_put(qef_cb.error.err_code, 0);
	    error++;
	...
	if (status != E_DB_OK)
	{
	    sc0e_0_put(sxf_rcb.sxf_error.err_code, 0);
	    error++;
	}
	Sc_main_cb->sc_facilities &= ~(1 << DB_SXF_ID);
    }
...
Deadlock Detector,Sampler,Sort,Factotum", i,
	...
	avg = (Sc_main_cb->sc_selcnt
		    ? Sc_main_cb->sc_avgrows / Sc_main_cb->sc_selcnt
		    : 0);
	       ...
	       DB_ERROR *error )
{
	...
	case SC_ROWCNT_INFO:
	    ...
	    qef_cb->qef_eflag = QEF_INTERNAL;
	    qef_cb->qef_cb = (QEF_CB *) scb->scb_sscb.sscb_qescb;
	    qef_cb->qef_sess_id = scb->cs_scb.cs_self;
	    status = qef_call(QEC_INFO, ( PTR ) qef_cb);
	...
	case SC_DB_COUNT:
	    status = E_DB_ERROR;
	    if (error->err_code =
	        CSp_semaphore(0, &Sc_main_cb->sc_kdbl.kdb_semaphore))
	    {
		break;
	    }
...
i4	start_lkcback_thread)
{
	...
	*/
	if (recovery_server)
	{
	    ...
	    local_crb.gca_assoc_id = 0;
	    local_crb.gca_size_advise = 0;
	    local_crb.gca_user_name = DB_RECTHREAD_NAME;
	    local_crb.gca_account_name = 0;
	    local_crb.gca_access_point_identifier = "NONE";
	    local_crb.gca_application_id = 0;
	    ...
	    */
	    ...
	    {
		sc0e_0_put(stat, 0);
		sc0e_0_put(E_SC031D_RECOVERY_ADD, 0);
		status = E_DB_ERROR;
		break;
	    }
		...
		*/
		...
		local_crb.gca_assoc_id = 0;
		local_crb.gca_size_advise = 0;
		local_crb.gca_user_name = DB_CP_TIMER_NAME;
		local_crb.gca_account_name = 0;
		local_crb.gca_access_point_identifier = "NONE";
		local_crb.gca_application_id = 0;
		...
		*/
		...
		{
		    sc0e_0_put(stat, 0);
		    sc0e_0_put(E_SC032F_CP_TIMER_ADD, 0);
		    status = E_DB_ERROR;
		    break;
		}
	    }
	    ...
	    */
	    ...
	    local_crb.gca_assoc_id = 0;
	    local_crb.gca_size_advise = 0;
	    local_crb.gca_user_name = DB_DEADLOCK_NAME;
	    local_crb.gca_account_name = 0;
	    local_crb.gca_access_point_identifier = "NONE";
	    local_crb.gca_application_id = 0;
	    ...
	    */
	    ...
	    {
		sc0e_0_put(stat, 0);
		sc0e_0_put(E_SC0371_DEADLOCK_THREAD_ADD, 0); 
		status = E_DB_ERROR;
		break;
	    }
		...
		*/
		...
		local_crb.gca_assoc_id = 0;
		local_crb.gca_size_advise = 0;
		local_crb.gca_user_name = DB_DIST_DEADLOCK_NAME;
		local_crb.gca_account_name = 0;
		local_crb.gca_access_point_identifier = "NONE";
		local_crb.gca_application_id = 0;
		...
		{
		    sc0e_0_put(stat, 0);
		    sc0e_0_put(E_SC0396_DIST_DEADLOCK_THR_ADD, 0); 
		    status = E_DB_ERROR;
		    break;
		}
	    }
	     ...
	     !CXconfig_settings( CX_HAS_DLM_GLC ) )
	{
	    ...
	    */
	    ...
	    local_crb.gca_assoc_id = 0;
	    local_crb.gca_size_advise = 0;
	    local_crb.gca_user_name = DB_GLC_SUPPORT_NAME;
	    local_crb.gca_account_name = 0;
	    local_crb.gca_access_point_identifier = "NONE";
	    local_crb.gca_application_id = 0;
	    ...
	    {
		sc0e_0_put(stat, 0);
		sc0e_0_put(E_SC0398_GLC_SUPPORT_THR_ADD, 0); 
		status = E_DB_ERROR;
		break;
	    }
	}
	...
	*/
	...
	local_crb.gca_assoc_id = 0;
	local_crb.gca_size_advise = 0;
	local_crb.gca_user_name = DB_DEADPROC_NAME;
	local_crb.gca_account_name = 0;
	local_crb.gca_access_point_identifier = "NONE";
	local_crb.gca_application_id = 0;
	...
	*/
	...
	{
	    sc0e_0_put(stat, 0);
	    sc0e_0_put(E_SC0321_CHECK_DEAD_ADD, 0);
	    status = E_DB_ERROR;
	    break;
	}
	...
	*/
	...
	local_crb.gca_assoc_id = 0;
	local_crb.gca_size_advise = 0;
	local_crb.gca_user_name = DB_FORCEABORT_NAME;
	local_crb.gca_account_name = 0;
	local_crb.gca_access_point_identifier = "NONE";
	local_crb.gca_application_id = 0;
	...
	*/
	...
	{
	    sc0e_0_put(stat, 0);
	    sc0e_0_put(E_SC0325_FORCE_ABORT_ADD, 0);
	    status = E_DB_ERROR;
	    break;
	}
	...
	if (start_gc_thread)
	{
	    ...
	    */
	    ...
	    local_crb.gca_assoc_id = 0;
	    local_crb.gca_size_advise = 0;
	    local_crb.gca_user_name = DB_GROUPCOMMIT_NAME;
	    local_crb.gca_account_name = 0;
	    local_crb.gca_access_point_identifier = "NONE";
	    local_crb.gca_application_id = 0;
	    ...
	    */
	    ...
	    {
		sc0e_0_put(stat, 0);
		sc0e_0_put(E_SC0323_GROUP_COMMIT_ADD, 0);
		status = E_DB_ERROR;
		break;
	    }
	}
	...
	while (num_logwriters > 0)
	{
	    ...
	    */
	    ...
	    local_crb.gca_assoc_id = 0;
	    local_crb.gca_size_advise = 0;
	    local_crb.gca_user_name = DB_LOGWRITE_NAME;
	    local_crb.gca_account_name = 0;
	    local_crb.gca_access_point_identifier = "NONE";
	    local_crb.gca_application_id = 0;
	    ...
	    */
	    ...
	    {
		sc0e_0_put(stat, 0);
		sc0e_0_put(E_SC031F_LOGWRITER_ADD, 0); /* need new msg */
		status = E_DB_ERROR;
		break;
	    }
	    num_logwriters--;
	...
	if (start_lkcback_thread)
	{
            ...
            */
            ...
            local_crb.gca_assoc_id = 0;
            local_crb.gca_size_advise = 0;
            local_crb.gca_user_name = DB_LK_CALLBACK_NAME;
            local_crb.gca_account_name = 0;
            local_crb.gca_access_point_identifier = "NONE";
            local_crb.gca_application_id = 0;
            ...
            */
            ...
            {
                sc0e_0_put(stat, 0);
                sc0e_0_put(E_SC037E_LK_CALLBACK_THREAD_ADD, 0); 
                status = E_DB_ERROR;
                break;
            }
	}
...
)
{
	...
	if (PMget("II.$.SECURE.ROW_AUDIT_KEY", &pmvalue) == OK)
	{
		...
		{
		        sc0e_put(E_SC0339_SECURE_INVALID_PARM, 0, 1,
