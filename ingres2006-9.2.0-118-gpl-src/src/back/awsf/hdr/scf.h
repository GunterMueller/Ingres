...
#define			SCS_MAXSESSTYPE	    29	    /* Highest session type */
...
**	29-sep-2006 (gupsh01)
**	    Added SCI_DTTYPE_ALIAS for resolving whether date keyword
**	    refers to Ingresdate or Ansidate.
*/
...
#define			SCI_LAST_QBUF	    117 /* Return last query */
#define			SCI_LAST_QLEN	    118 /* Return last query len */
...
#else
#if defined(UNIX) || defined(NT_IA64)
...
#define SDC_CHK_INT	2
  ...
  PTR		sdc_it;		/* interpreted LDB message */
