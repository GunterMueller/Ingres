...
/* I/O parameters for OPF_ALTER                                               */
    bool            opf_level;          /* users affected by this alter       */
#define                 OPF_SERVER     1
...
** dump the query tree on entry to the OPF                                
** the following two flags are related and provide information on the     
** building of the variable map for a query tree.  This variable map is   
** a bit vector which represents which attributes are referenced in the   
** subtree below the node.  The attributes which are referenced are       
** assigned numbers 0 to n-1 where n is the total number of attributes    
** referenced in the query */                                              
#define                 OPT_F002_SKIPCONSISTENCY	2
/* SET TRACE POINT OP130
** skip non-critical consistency checking
*/
#define                 OPT_OUTMAPVAR   3
/* SET TRACE POINT OP131
** dump the var map on exit  (after update) of the query node             
*/
...
#define                 OPT_F008_GLOBAL_VAR 20
/* SET TRACE POINT OP148
** print message when a global range table variable is created 
*/
...
/* note that currently only 9 trace points can take values */
