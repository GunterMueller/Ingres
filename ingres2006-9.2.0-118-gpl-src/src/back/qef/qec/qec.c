...
QEF_SRCB       *qef_srcb )
{
	...
	*/
    ...
    /* print the qef memory pools */
    TRdisplay("%@ QEF_TRACE_IMMEDIATE_ULM sort memory before ulm shutdown\n");
    STRUCT_ASSIGN_MACRO(Qef_s_cb->qef_s_ulmcb, ulm_rcb);
    ulm_print_pool(&ulm_rcb);
    TRdisplay("%@ QEF_TRACE_IMMEDIATE_ULM DSH memory before ulm shutdown\n");
    STRUCT_ASSIGN_MACRO(Qef_s_cb->qef_d_ulmcb, ulm_rcb);
    ulm_print_pool(&ulm_rcb);
