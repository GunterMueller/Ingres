...
QEC_LINK	*v_lnk_p )
{
    ...
    char	    *cat_name_p = NULL,		/* must initialize to NULL */
		    ...
		    *where_p = NULL,		/* force case setting */
		    ...
		    base_where[QEK_200_LEN],	/* BASE_NAME and BASE_OWNER
						** WHERE clause */
		    obj_where[QEK_200_LEN],	/* OBJECT_NAME and OBJECT_OWNER
						** where clause */
		    tab_where[QEK_200_LEN],	/* TABLE_NAME and TABLE_OWNER
						** WHERE clause */
		    proc_where[QEK_200_LEN],	/* PROCEDURE_NAME and 
						** PROCEDURE_OWNER
						** WHERE clause */
		    qrytxt[QEK_900_LEN];
