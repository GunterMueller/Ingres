...
##     Created from sql.h.
##  29-Oct-2004 (bonro01)
##     <stdlib.h> typedef of u_char conflict with compat.h #define u_char
##
*/
#ifndef __SQLTYPES
#define __SQLTYPES
...
#if !defined(hp2_us5) && !defined(hpb_us5)
#include <stdlib.h>
#endif
...
typedef long int           SQLLEN;
typedef unsigned long int  SQLULEN;
typedef unsigned long int  SQLSETPOSIROW;
#else
